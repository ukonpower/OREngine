...
export const MATERIALLIST: {[key: string]: any} = {
	ChromaPillarMat: {"vert":"ChromaPillar/vert","frag":"ChromaPillar/frag","phase":["deferred"],"useLight":true,"depthTest":true,"depthWrite":true,"cullFace":false},
	...
	NeonWireMat: {"vert":"NeonWire/vert","frag":"NeonWire/frag","phase":["deferred"],"useLight":true,"depthTest":true,"depthWrite":true,"cullFace":false},
	...
	PulseGlowMat: {"vert":"PulseGlow/vert","frag":"PulseGlow/frag","phase":["deferred"],"useLight":true,"depthTest":true,"depthWrite":true,"cullFace":false},
	...
	VortexMat: {"vert":"VortexDisplace/vert","frag":"VortexDisplace/frag","phase":["deferred"],"useLight":true,"depthTest":true,"depthWrite":true,"cullFace":false},
};
