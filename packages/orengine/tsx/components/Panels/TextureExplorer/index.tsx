...
import { TextureResource } from 'packages/orengine/ts/Engine/Resources';
...
export const TextureExplorer = () => {
	...
	const onContextMenu = useCallback( ( e: MouseEvent, item: TextureResource ) => {
