...
}`})))()}var xn;function Sn(){return(Sn=t((()=>{nt(),k(),P(),Ke(),bn(),xn=class extends Qe{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA,magFilter:A.LINEAR,minFilter:A.LINEAR,wrapS:A.CLAMP_TO_EDGE,wrapT:A.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new D(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA})])});let m=1/4*l,h=new N(e,{renderTarget:s[l].rt1,frag:yn,uniforms:M.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new D(d,f));let g=new N(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new fn({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}}})))()}var Cn;function wn(){return(wn=t((()=>{Cn=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}}})))()}var Tn;function En(){return(En=t((()=>{Tn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Xn;function Zn(){return(Zn=t((()=>{Xn=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`})))()}var Qn;function $n(){return($n=t((()=>{Qn=`// https://qiita.com/aa_debdeb/items/26ab808de6745611df53
...
}`})))()}var er;function tr(){return(tr=t((()=>{er=`in vec2 vUv;
...
}`})))()}var nr;function rr(){return(rr=t((()=>{nr=`in vec2 vUv;
uniform sampler2D uBackBuffer0;
uniform sampler2D uVelTex;
uniform vec2 uPPPixelSize;
...
}`})))()}var ir;function ar(){return(ar=t((()=>{ir=`in vec2 vUv;
uniform sampler2D uBackBuffer0;
uniform sampler2D uVelTex;
uniform vec2 uPPPixelSize;
...
\r
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}var Jv,Yv,Xv;function Zv(){return(Zv=t((()=>{Jv=`RendererSettings__renderer___LnJlb`,Yv=`RendererSettings__renderer_inner___LnJlb`,Xv={renderer:Jv,renderer_inner:Yv}})))()}var Qv,$v;function ey(){return(ey=t((()=>{w(),L(),Sh(),Zv(),Qv=o(),$v=()=>{let{editor:e}=I(),t=e.engine.renderer;return(0,Qv.jsx)(`div`,{className:Xv.renderer,children:(0,Qv.jsxs)(`div`,{className:Xv.renderer_inner,children:[(0,Qv.jsx)(s,{label:`Resolution`,accordion:!0,children:(0,Qv.jsx)(xh,{target:e,filter:`resolution`})}),(0,Qv.jsx)(s,{label:`Pipeline`,accordion:!0,children:(0,Qv.jsx)(xh,{target:t,filter:`pipeline`})}),(0,Qv.jsx)(s,{label:`Sky`,accordion:!0,children:(0,Qv.jsx)(xh,{target:t,filter:`sky`})})]})})},$v.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var ty,ny,ry,iy,ay,oy;function sy(){return(sy=t((()=>{ty=`SceneControl__sceneControl___LnNjZ`,ny=`SceneControl__sceneControl_inner___LnNjZ`,ry=`SceneControl__select___LnNjZ`,iy=`SceneControl__select_name___LnNjZ`,ay=`SceneControl__save___LnNjZ`,oy={sceneControl:ty,sceneControl_inner:ny,select:ry,select_name:iy,save:ay}})))()}var cy,ly,uy;function dy(){return(dy=t((()=>{cy=i(),w(),L(),le(),sy(),ly=o(),uy=()=>{let{editor:e,projectName:t,scenes:n}=I(),[r,i]=(0,cy.useState)(null),o=null;return n&&(o=(0,ly.jsx)(T,{title:`scene`,children:(0,ly.jsxs)(`button`,{className:oy.select,onClick:e=>{i(ne(e.clientX,e.clientY))},children:[(0,ly.jsx)(`span`,{className:oy.select_name,children:n.current??`-`}),(0,ly.jsx)(a,{open:!0})]})})),(0,ly.jsxs)(`div`,{className:oy.sceneControl,children:[(0,ly.jsx)(`div`,{className:oy.sceneControl_inner,children:(0,ly.jsxs)(s,{label:t,accordion:!0,children:[o,(0,ly.jsx)(`div`,{className:oy.save,children:(0,ly.jsx)(c,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,ly.jsx)(ue,{scenes:n,projectName:t,anchor:r,onClose:()=>{i(null)}})]})},uy.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var fy,py,my,hy,gy,_y,vy;function yy(){return(yy=t((()=>{fy=`Textures__textures___LnRle`,py=`Textures__item___LnRle`,my=`Textures__preview___LnRle`,hy=`Textures__img___LnRle`,gy=`Textures__placeholder___LnRle`,_y=`Textures__name___LnRle`,vy={textures:fy,item:py,preview:my,img:hy,placeholder:gy,name:_y}})))()}var by,xy,Sy;function Cy(){return(Cy=t((()=>{by=i(),ii(),L(),yy(),xy=o(),Sy=()=>{let{engine:e,editor:t}=I(),[,n]=(0,by.useState)(0);(0,by.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return F.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{F.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=F.resources.textureList;return(0,xy.jsx)(`div`,{className:vy.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,xy.jsxs)(`div`,{className:vy.item,children:[(0,xy.jsx)(`div`,{className:vy.preview,children:n?(0,xy.jsx)(`img`,{src:n,className:vy.img}):(0,xy.jsx)(`div`,{className:vy.placeholder})}),(0,xy.jsx)(`div`,{className:vy.name,children:e.name})]},e.name)})})},Sy.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var wy,Ty;function Ey(){return(Ey=t((()=>{wy=i(),Ty=(0,wy.createContext)(null)})))()}var Dy,Oy;function ky(){return(ky=t((()=>{Dy=i(),Ey(),Oy=()=>{let e=(0,Dy.useContext)(Ty);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var Ay;function jy(){return(jy=t((()=>{Ay=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
...
}`})))()}var My;function Ny(){return(Ny=t((()=>{nt(),We(),k(),P(),jy(),My=class extends Qe{wrapperElm;glCanvas;backend;gl;canvasTexture;canvas;canvasCtx;glRenderer;postProcess;viewPort;viewPortRange;viewPortScale;frameSetting;loopSetting;musicBuffer;musicTexture;resizeObserver;canvasSize;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.glCanvas=document.createElement(`canvas`),this.backend=new Ge(this.glCanvas.getContext(`webgl2`)),this.gl=this.backend.gl,this.canvasSize=new D(this.glCanvas.width,this.glCanvas.height),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0],this.viewPortScale=50,this.frameSetting=null,this.loopSetting={enabled:!1,start:0,end:0},this.resizeObserver=new ResizeObserver(this.onResize.bind(this));let e={renderer:null,createEntity:t=>new Wt({...t,engine:e})};this.glRenderer=new jr(this.backend,e),e.renderer=this.glRenderer,this.canvasTexture=new Ie(this.gl),this.musicBuffer=null,this.musicTexture=new Ie(this.gl),this.musicTexture.setting({type:this.gl.UNSIGNED_BYTE,internalFormat:this.gl.LUMINANCE,format:this.gl.LUMINANCE,magFilter:this.gl.LINEAR,minFilter:this.gl.LINEAR,wrapS:this.gl.MIRRORED_REPEAT}),this.postProcess=new fn({passes:[new N(this.backend,{frag:Ay,uniforms:{uCanvasTex:{type:`1i`,value:null},uMusicTex:{type:`1i`,value:this.musicTexture}},renderTarget:null})]})}onResize(){if(this.wrapperElm){let e=new D(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);if(e.x===0||e.y===0)return;this.glCanvas.width=this.canvas.width=e.x,this.glCanvas.height=this.canvas.height=e.y,this.canvasSize.set(this.glCanvas.width,this.glCanvas.height),this.postProcess.resize(e),this.render()}}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.frameSetting){this.canvasCtx.fillStyle=`#181818`;let e=this.frameToPx(0),t=this.frameToPx(this.frameSetting.duration);this.canvasCtx.fillRect(e,0,t-e,this.canvas.height)}let e=(e,t,n)=>{let r=Math.ceil(this.viewPort[0]/e)*e;this.canvasCtx.beginPath();let i=0;for(;r<this.viewPort[2]&&i<100;){let n=this.frameToPx(r+t);this.canvasCtx.moveTo(n,0),this.canvasCtx.lineTo(n,this.canvas.height),r+=e,i++}this.canvasCtx.strokeStyle=n,this.canvasCtx.lineWidth=1,this.canvasCtx.stroke()};if(e(this.viewPortScale,0,`#555`),e(this.viewPortScale,this.viewPortScale/2,`#333`),this.musicBuffer&&this.frameSetting){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)],s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}if(this.loopSetting.enabled){this.canvasCtx.fillStyle=`#0009`;let e=this.frameToPx(this.loopSetting.start),t=this.frameToPx(this.loopSetting.end);this.canvasCtx.fillRect(0,0,e,this.canvas.height),this.canvasCtx.fillRect(t,0,this.canvas.width-t,this.canvas.height)}this.canvasTexture.attach(this.canvas),this.postProcess.passes&&(this.postProcess.passes[0].uniforms.uCanvasTex.value=this.canvasTexture),this.glRenderer.renderPostProcess(this.postProcess,void 0,this.canvasSize)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.glCanvas),this.onResize()}setViewPort(e,t){this.viewPort=e,this.viewPortRange=[e[2]-e[0],e[3]-e[1]],this.viewPortScale=t,this.render()}setFrameSetting(e){this.frameSetting={duration:Math.round(e.duration),fps:Math.round(e.fps)},this.render()}setMusicBuffer(e){this.musicBuffer=e,setTimeout(()=>{this.render()},100)}setLoopSetting(e,t,n){this.loopSetting={enabled:e,start:t,end:n},this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.glCanvas),this.resizeObserver.disconnect()}},My.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setViewPort`,docblock:null,modifiers:[],params:[{name:`viewPort`,optional:!1,type:{name:`Array`,elements:[{name:`number`}],raw:`number[]`}},{name:`scale`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`setLoopSetting`,docblock:null,modifiers:[],params:[{name:`enabled`,optional:!1,type:{name:`boolean`}},{name:`start`,optional:!1,type:{name:`number`}},{name:`end`,optional:!1,type:{name:`number`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`TimelineCanvasRenderer`}})))()}var Py,Fy;function Iy(){return(Iy=t((()=>{Py=`TimelineCanvas__timelineCanvas___LnRpb`,Fy={timelineCanvas:Py}})))()}var Ly,Ry,zy;function By(){return(By=t((()=>{Ly=i(),Ch(),ky(),Ny(),Iy(),Ry=o(),zy=()=>{let{viewPort:e,viewPortScale:t,musicBuffer:n,musicBufferVersion:r,glEditor:i}=Oy(),[a,o]=(0,Ly.useState)(),s=(0,Ly.useRef)(null);(0,Ly.useEffect)(()=>{let e=new My;return o(e),s.current&&e.setWrapperElm(s.current),()=>{e.dispose()}},[]),(0,Ly.useEffect)(()=>{a&&e&&t&&a.setViewPort(e,t)},[a,e,t]);let[c]=Y(i?.engine,`timeline/duration`),[l]=Y(i?.engine,`timeline/fps`);(0,Ly.useEffect)(()=>{a&&c&&l&&a.setFrameSetting({duration:c||0,fps:l||0})},[a,c,l]);let[u]=Y(i,`frameLoop/enabled`),[d]=Y(i,`frameLoop/start`),[f]=Y(i,`frameLoop/end`);return(0,Ly.useEffect)(()=>{a&&a.setLoopSetting(u||!1,d||0,f||0)},[a,u,d,f]),(0,Ly.useEffect)(()=>{a&&n&&a.setMusicBuffer(n)},[a,n,r]),(0,Ry.jsx)(`div`,{className:Fy.timelineCanvas,ref:s})},zy.__docgenInfo={description:``,methods:[],displayName:`TimelineCanvas`}})))()}var Vy,Hy;function Uy(){return(Uy=t((()=>{Vy=`TimelineControls__controls___LmNvb`,Hy={controls:Vy}})))()}var Wy,Gy,Ky;function qy(){return(qy=t((()=>{Wy=e(i(),1),ky(),Uy(),Gy=o(),Ky=e=>{let{viewPort:t,setCurrentFrame:n,getFrameViewPort:r,zoom:i,scroll:a,setViewPortCenter:o}=Oy(),s=(0,Wy.useRef)([0,0,0,0]),c=(0,Wy.useRef)([0,0]);t&&(s.current=t,c.current=[t[2]-t[0],t[3]-t[1]]);let l=(0,Wy.useRef)(null),u=(0,Wy.useRef)(null),d=(0,Wy.useRef)(null),f=(0,Wy.useRef)(null),p=(0,Wy.useRef)(null),m=(0,Wy.useCallback)(e=>{let t=l.current&&l.current.clientWidth||1;if(d.current==0){if(n&&r&&u.current){let i=(e.clientX-u.current.left)/t;n(r(i))}}else if(d.current==1){let n=[e.clientX,e.clientY];if(f.current&&p.current){let e=-(n[0]-f.current[0])/t*c.current[0];o&&o(p.current+e)}}},[n,r,o]),h=(0,Wy.useCallback)(e=>{d.current=e.button,p.current=(s.current[2]+s.current[0])/2,f.current=[e.clientX,e.clientY],u.current=e.currentTarget.getBoundingClientRect();let t=(e.clientX-u.current.left)/e.currentTarget.clientWidth;d.current==0&&n&&r&&n(r(t)),window.addEventListener(`pointermove`,m);let i=()=>{f.current=null,d.current=null,p.current=null,window.removeEventListener(`pointermove`,m)};return window.addEventListener(`pointerup`,i),()=>{window.removeEventListener(`pointerup`,i),window.removeEventListener(`pointermove`,m)}},[r,n,m]),g=(0,Wy.useCallback)(e=>{if(d.current!==null||!i||!a)return;e.preventDefault();let t=e.target&&e.target.clientWidth||1,n=Math.abs(e.deltaY);Math.abs(e.deltaX)<n?i(n>50?e.deltaY<0?.9:1.1:1+e.deltaY*.005):a(e.deltaX/t*.5)},[i,a]);return(0,Wy.useEffect)(()=>{let e=l.current;return e&&e.addEventListener(`wheel`,g,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,g)}},[g]),t?(0,Gy.jsx)(`div`,{className:Hy.controls,onPointerDown:h,ref:l,children:e.children}):null},Ky.__docgenInfo={description:``,methods:[],displayName:`TimelineControls`,props:{children:{required:!1,tsType:{name:`ReactReactNode`,raw:`React.ReactNode`},description:``}}}})))()}var Jy,Yy,Xy;function Zy(){return(Zy=t((()=>{Jy=`TimelineCursor__cursor___LmN1c`,Yy=`TimelineCursor__frame___LmN1c`,Xy={cursor:Jy,frame:Yy}})))()}var Qy,$y;function eb(){return(eb=t((()=>{ky(),Zy(),Qy=o(),$y=()=>{let{viewPort:e,framePlay:t}=Oy();if(!e||!t)return null;let n=e[2]-e[0],r=(t.current-e[0])/n;return(0,Qy.jsx)(`div`,{className:Xy.cursor,style:{left:r*100+`%`},children:(0,Qy.jsx)(`div`,{className:Xy.frame})})},$y.__docgenInfo={description:``,methods:[],displayName:`TimelineCursor`}})))()}var tb,nb,rb,ib;function ab(){return(ab=t((()=>{tb=`TimelineLoop__timelineLoop___LnRpb`,nb=`TimelineLoop__start___LnRpb`,rb=`TimelineLoop__end___LnRpb`,ib={timelineLoop:tb,start:nb,end:rb}})))()}var ob,sb;function cb(){return(cb=t((()=>{ob=`TimelineLoopCursor__cursor___LmN1c`,sb={cursor:ob}})))()}var lb,ub,db;function fb(){return(fb=t((()=>{lb=i(),cb(),ub=o(),db=({onMove:e})=>{let t=(0,lb.useRef)(!1);return(0,ub.jsx)(`div`,{className:sb.cursor,onPointerDown:e=>{e.buttons==1&&(t.current=!0,e.stopPropagation())},onPointerMove:n=>{let r=n.target;t.current!==!1&&n.buttons==1&&(r.setPointerCapture(n.pointerId),n.buttons==1&&e&&e(n.clientX),n.nativeEvent.preventDefault(),n.nativeEvent.stopPropagation())},onPointerUp:()=>{t.current=!1}})},db.__docgenInfo={description:``,methods:[],displayName:`TimelineLoopCursor`}})))()}var pb,mb,hb;function gb(){return(gb=t((()=>{pb=i(),Ch(),Jm(),ky(),ab(),fb(),mb=o(),hb=()=>{let{viewPort:e,framePlay:t,glEditor:n}=Oy(),r=(0,pb.useRef)(null);qm(n,[`frameLoop/enabled`,`frameLoop/start`,`frameLoop/end`]);let[i]=Y(n,`frameLoop/enabled`),[a,o]=Y(n,`frameLoop/start`),[s,c]=Y(n,`frameLoop/end`);if(i!==!0||!e||!t||a===void 0||s===void 0)return null;let l=e[2]-e[0],u=(a-e[0])/l,d=(s-e[0])/l,f=(t,n)=>{let r=t.getBoundingClientRect();return(n-r.x)/r.width*(e[2]-e[0])+e[0]};return(0,mb.jsx)(`div`,{className:ib.timelineLoop,ref:r,children:(0,mb.jsxs)(`div`,{className:ib.timelineLoop_inner,children:[(0,mb.jsx)(`div`,{className:ib.start,style:{left:u*100+`%`},children:(0,mb.jsx)(db,{onMove:e=>{r.current&&o&&o(f(r.current,e))}})}),(0,mb.jsx)(`div`,{className:ib.end,style:{left:d*100+`%`},children:(0,mb.jsx)(db,{onMove:e=>{r.current&&c&&c(f(r.current,e))}})})]})})},hb.__docgenInfo={description:``,methods:[],displayName:`TimelineLoop`}})))()}var _b,vb,yb,bb,xb,Sb;function Cb(){return(Cb=t((()=>{_b=`TimelineScale__scale___LnNjY`,vb=`TimelineScale__scale_inner___LnNjY`,yb=`TimelineScale__scale_item___LnNjY`,bb=`TimelineScale__scale_item_frame___LnNjY`,xb=`TimelineScale__scale_item_time___LnNjY`,Sb={scale:_b,scale_inner:vb,scale_item:yb,scale_item_frame:bb,scale_item_time:xb}})))()}var wb,Tb,Eb;function Db(){return(Db=t((()=>{Ch(),ky(),Cb(),wb=o(),Tb=e=>`${(`00`+Math.floor(e%3600/60)).slice(-2)}:${(`00`+Math.floor(e%60)).slice(-2)}`,Eb=()=>{let{glEditor:e,viewPort:t,viewPortScale:n}=Oy(),[r,i]=Y(e?.engine,`timeline/fps`);if(!t||!n||r===void 0)return null;let a=[],o=Math.ceil(t[0]/n)*n,s=0;for(;o<t[2]&&s<100;){let e=(o-t[0])/(t[2]-t[0]),i=o/(r||0);a.push((0,wb.jsxs)(`div`,{className:Sb.scale_item,style:{left:e*100+`%`},children:[(0,wb.jsx)(`div`,{className:Sb.scale_item_frame,children:o}),(0,wb.jsx)(`div`,{className:Sb.scale_item_time,children:Tb(i)})]},o)),o+=n,s++}return(0,wb.jsx)(`div`,{className:Sb.scale,children:(0,wb.jsx)(`div`,{className:Sb.scale_inner,children:a})})},Eb.__docgenInfo={description:``,methods:[],displayName:`TimelineScale`}})))()}var Ob,kb;function Ab(){return(Ab=t((()=>{Ob=`TimelineSetting__timelineSetting___LnRpb`,kb={timelineSetting:Ob}})))()}var jb,Mb,Nb;function Pb(){return(Pb=t((()=>{jb=i(),w(),Oi(),Ch(),ky(),Ab(),Mb=o(),Nb=()=>{let{framePlay:e,glEditor:t}=Oy(),n=(0,jb.useCallback)((e,t)=>{t&&t(e)},[]),[r,i]=Y(t,`frameLoop/enabled`),[a,o]=Y(t?.engine,`timeline/duration`),[s,c]=Y(t?.engine,`timeline/fps`);return(0,Mb.jsx)(`div`,{className:kb.timelineSetting,children:(0,Mb.jsxs)(ae,{children:[(0,Mb.jsx)(T,{title:`current`,children:(0,Mb.jsx)(Di,{value:Math.floor(e?.current||0),readOnly:!0})}),(0,Mb.jsx)(T,{title:`duration`,children:(0,Mb.jsx)(Di,{value:a,onChange:e=>n(e,o)})}),(0,Mb.jsx)(T,{title:`fps`,children:(0,Mb.jsx)(Di,{value:s,onChange:e=>n(e,c)})}),(0,Mb.jsx)(T,{title:`loop`,children:(0,Mb.jsx)(Di,{value:r||!1,onChange:e=>n(e,i)})})]})})},Nb.__docgenInfo={description:``,methods:[],displayName:`TimelineSetting`}})))()}var Fb,Ib,Lb,Rb,zb;function Bb(){return(Bb=t((()=>{Fb=`Timeline__timeline___LnRpb`,Ib=`Timeline__inner___LnRpb`,Lb=`Timeline__content___LnRpb`,Rb=`Timeline__setting___LnRpb`,zb={timeline:Fb,inner:Ib,content:Lb,setting:Rb}})))()}var Vb,Hb;function Ub(){return(Ub=t((()=>{Vb=i(),L(),Hb=()=>{let{editor:e}=I(),[t,n]=(0,Vb.useState)({current:0,playing:!1}),[r,i]=(0,Vb.useState)([0,0,100,0]),a=(0,Vb.useRef)([0,0,0,0]);a.current=r;let o=r[2]-r[0],s=10*2**(0+Math.floor(Math.log2(o/100)));s=Math.max(1,Math.floor(s));let c=e?.audioBuffer,[l,u]=(0,Vb.useState)();(0,Vb.useEffect)(()=>{if(e){let t=e.engine,r=e=>{n({...e})};r(t.frame);let a=0,o=()=>{u(a++)},s=()=>{i([0,0,t.frameSetting.duration,0])};return s(),t.on(`update/frame/play`,r),t.on(`update/music`,o),t.on(`loaded`,s),()=>{t.off(`update/frame/play`,r),t.off(`update/music`,o),t.off(`loaded`,s)}}},[e]);let d=(0,Vb.useCallback)(t=>{e&&e.engine.seek(t)},[e]),f=(0,Vb.useCallback)(e=>{let t=r[2]-r[0];return Math.floor(r[0]+t*e)},[r]),p=(0,Vb.useCallback)(e=>{let t=a.current,n=(t[2]+t[0])/2,r=(t[0]-n)*e+n,o=(t[2]-n)*e+n;i([r,t[1],o,t[3]])},[]),m=(0,Vb.useCallback)(e=>{let t=a.current,n=e*(t[2]-t[0]);i([t[0]+n,t[1],t[2]+n,t[3]])},[]),h=(0,Vb.useCallback)(e=>{let t=a.current,n=t[2]-t[0];i([e-n/2,t[1],e+n/2,t[3]])},[]);return{glEditor:e,framePlay:t,viewPort:r,viewPortScale:s,musicBuffer:c,musicBufferVersion:l,setCurrentFrame:d,getFrameViewPort:f,zoom:p,scroll:m,setViewPortCenter:h}}})))()}var Wb,Gb;function Kb(){return(Kb=t((()=>{Ey(),Ub(),Wb=o(),Gb=e=>{let t=Hb();return(0,Wb.jsx)(Ty.Provider,{value:t,children:e.children})},Gb.__docgenInfo={description:``,methods:[],displayName:`TimelineProvider`}})))()}var qb,Jb;function Yb(){return(Yb=t((()=>{By(),qy(),eb(),gb(),Db(),Pb(),Bb(),Kb(),qb=o(),Jb=()=>(0,qb.jsx)(Gb,{children:(0,qb.jsx)(`div`,{className:zb.timeline,children:(0,qb.jsxs)(`div`,{className:zb.inner,children:[(0,qb.jsx)(`div`,{className:zb.setting,children:(0,qb.jsx)(Nb,{})}),(0,qb.jsxs)(`div`,{className:zb.content,children:[(0,qb.jsx)(zy,{}),(0,qb.jsx)($y,{}),(0,qb.jsx)(Ky,{children:(0,qb.jsx)(hb,{})}),(0,qb.jsx)(Eb,{})]})]})})}),Jb.__docgenInfo={description:``,methods:[],displayName:`Timeline`}})))()}var Xb,Zb;function Qb(){return(Qb=t((()=>{Xb=`OREditor__editor___LmVka`,Zb={editor:Xb}})))()}var $b,ex;function tx(){return(tx=t((()=>{$b=e(i(),1),Fm(),mg(),ex=e=>{let{engine:t}=pg(),[n,r]=(0,$b.useState)(()=>new Nm(t)),i=$b.useRef(n);return i.current=n,(0,$b.useEffect)(()=>{if(!i.current.disposed&&i.current.engine.uuid==t.uuid)return;let e=new Nm(t);r(e)},[t]),(0,$b.useEffect)(()=>()=>{n.dispose()},[n]),{engine:t,editor:n,projectName:e}}})))()}var nx,rx,ix;function ax(){return(ax=t((()=>{nx=i(),Fm(),si(),tx(),rx=o(),ix=e=>{let t=ex(e.projectName);(0,nx.useEffect)(()=>{if(!(!t.editor||!e.onSave))return t.editor.on(`save`,e.onSave),()=>{t.editor.off(`save`,e.onSave)}},[t.editor,e.onSave]);let n=(0,nx.useRef)(null),r=e.scenes?.current??null;return(0,nx.useEffect)(()=>{n.current=r},[r]),(0,nx.useEffect)(()=>yo({editor:t.editor,getSceneName:()=>n.current}),[t.editor]),(0,nx.useEffect)(()=>{t.editor&&t.editor.bootstrap(e.editorData)},[e.editorData,t.editor]),(0,rx.jsx)(oi.Provider,{value:{...t,scenes:e.scenes},children:e.children})},ix.__docgenInfo={description:``,methods:[],displayName:`OREditorProvider`}})))()}var ox,$,sx,cx,lx;function ux(){return(ux=t((()=>{ox=e(i(),1),ge(),w(),be(),Wi(),Hm(),eg(),cg(),Ug(),g_(),qv(),ey(),dy(),dv(),Cy(),Yb(),Qb(),ax(),$=o(),sx=[{id:`hierarchy`,title:`Hierarchy`,category:`General`,content:(0,$.jsx)(ae,{children:(0,$.jsx)(h_,{})})},{id:`timer`,title:`Timer`,category:`Rendering`,content:(0,$.jsx)(ae,{noPadding:!0,children:(0,$.jsx)(Hg,{})})},{id:lv,title:`Screen`,category:`General`,multiple:!0,content:e=>(0,$.jsx)(uv,{viewportId:e})},{id:`property`,title:`Property`,category:`General`,content:(0,$.jsx)(ae,{children:(0,$.jsx)($h,{})})},{id:`textures`,title:`Textures`,category:`Rendering`,content:(0,$.jsx)(ae,{noPadding:!0,children:(0,$.jsx)(Sy,{})})},{id:`scene`,title:`Scene`,category:`General`,content:(0,$.jsx)(ae,{children:(0,$.jsx)(uy,{})})},{id:`export`,title:`Export`,category:`Project`,content:(0,$.jsx)(ae,{children:(0,$.jsx)(sg,{})})},{id:`renderer`,title:`Renderer`,category:`Rendering`,content:(0,$.jsx)(ae,{children:(0,$.jsx)($v,{})})},{id:`editor-settings`,title:`Editor`,category:`Project`,content:(0,$.jsx)(ae,{children:(0,$.jsx)(Ui,{})})},{id:`timeline`,title:`Timeline`,category:`Animation`,content:(0,$.jsx)(ae,{noPadding:!0,children:(0,$.jsx)(Jb,{})})}],cx=e=>{let t=[];for(let n of e)n.multiple||n.id!==`hierarchy`&&n.id!==`property`&&n.id!==`timeline`&&t.push({id:n.id,title:n.title,content:n.content});return t},lx=e=>{let t=ye(),n=(0,ox.useMemo)(()=>e.panels?[...sx,...e.panels]:sx,[e.panels]),r=null;return r=t.isPC?(0,$.jsx)(Kv,{panels:n}):(0,$.jsx)($.Fragment,{children:(0,$.jsxs)(E,{direction:`vertical`,storageKey:`orengine-editor-sp-main`,children:[(0,$.jsx)(E.Item,{size:`calc( min( 56.25vw, 55vh ) + 77px )`,minSize:200,style:{minHeight:`200px`},children:(0,$.jsx)(uv,{viewportId:`main`})}),(0,$.jsx)(E.Item,{flex:1,minSize:200,children:(0,$.jsxs)(oe,{storageKey:`orengine-panel-sp-main`,children:[(0,$.jsx)(oe.Tab,{title:`Hierarchy / Property`,children:(0,$.jsxs)(E,{direction:`horizontal`,storageKey:`orengine-editor-sp-hierarchyProp`,children:[(0,$.jsx)(E.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,$.jsx)(h_,{})}),(0,$.jsx)(E.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,$.jsx)($h,{})})]})}),cx(n).map(e=>(0,$.jsx)(oe.Tab,{title:e.title,children:e.content},e.id))]})}),(0,$.jsx)(E.Item,{size:`120px`,minSize:80,children:(0,$.jsx)(oe,{storageKey:`orengine-panel-sp-timeline`,children:(0,$.jsx)(oe.Tab,{title:`Timeline`,children:(0,$.jsx)(ae,{noPadding:!0,children:(0,$.jsx)(he,{fallback:(0,$.jsx)(`div`,{children:`エラーだよ`}),children:(0,$.jsx)(Jb,{})})})})})})]})}),(0,$.jsx)(ix,{projectName:e.projectName,onSave:e.onSave,editorData:e.editorData,scenes:e.scenes,children:(0,$.jsx)(y,{children:(0,$.jsxs)(ee,{children:[(0,$.jsx)(`div`,{className:Zb.editor,children:r}),(0,$.jsx)(Vm,{}),(0,$.jsx)(_,{}),(0,$.jsx)(C,{})]})})})},lx.__docgenInfo={description:``,methods:[],displayName:`OREditor`,props:{onSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( projectData: OREngineProjectData, editorData: MXP.SerializeField ) => void`,signature:{arguments:[{type:{name:`OREngineProjectData`},name:`projectData`},{type:{name:`MXP.SerializeField`},name:`editorData`}],return:{name:`void`}}},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},projectName:{required:!1,tsType:{name:`string`},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},scenes:{required:!1,tsType:{name:`SceneSelection`},description:``}}}})))()}var dx,fx;function px(){return(px=t((()=>{dx=e(i(),1),Po(),Qr(),fx=()=>{let[e,t]=dx.useState(()=>new F(Mo)),n=dx.useRef(e);return n.current=e,(0,dx.useEffect)(()=>{n.current.disposed&&t(new F(Mo))},[]),(0,dx.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,dx.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var mx,hx,gx;function _x(){return(_x=t((()=>{mx=i(),dg(),px(),hx=o(),gx=e=>{let t=fx(),{engine:n}=t,r=(0,mx.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,mx.useEffect)(()=>{r.current?.(n)},[n]),(0,mx.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,hx.jsx)(ug.Provider,{value:t,children:e.children})},gx.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var vx,yx,bx,xx,Sx,Cx,wx;function Tx(){return(Tx=t((()=>{vx=i(),ux(),_x(),yx=o(),bx=`scene`,xx=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},Sx=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),Cx=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),wx=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,vx.useState)(e.sceneData),[a,o]=(0,vx.useState)(e.editorData),[s,c]=(0,vx.useState)([]),[l,u]=(0,vx.useState)(null),d=(0,vx.useCallback)(async e=>{let t=await xx(`${n}/scenes/${e}`);t&&(u(e),i(t))},[n]);(0,vx.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([xx(`${n}/editor`),xx(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[bx]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]);let f={names:s,current:l,onSelect:d,onCreate:(0,vx.useCallback)(async e=>{if(!(await Sx(`${n}/scenes/${e}`,Cx(e))).ok)return;let t=await xx(`${n}/scenes`);t&&c(t),await d(e)},[n,d]),onDelete:(0,vx.useCallback)(async e=>{if(!(await fetch(`${n}/scenes/${e}`,{method:`DELETE`})).ok)return;let t=await xx(`${n}/scenes`)??[];c(t),e===l&&t.length>0&&await d(t[0])},[n,l,d])};return(0,yx.jsx)(gx,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,yx.jsx)(lx,{editorData:a,projectName:t,panels:e.panels,scenes:f,onSave:(t,r)=>{e.onBeforeSave?.(),l&&Sx(`${n}/scenes/${l}`,t),Sx(`${n}/editor`,{...r,[bx]:l})}})})},wx.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var Ex,Dx;function Ox(){return(Ox=t((()=>{ux(),_x(),Ex=o(),Dx=e=>(0,Ex.jsx)(gx,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,Ex.jsx)(lx,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),Dx.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}var kx,Ax,jx;function Mx(){return(Mx=t((()=>{kx=`InputGroup__group___Lmdyb`,Ax=`InputGroup__submit___Lmdyb`,jx={group:kx,submit:Ax}})))()}var Nx,Px,Fx;function Ix(){return(Ix=t((()=>{Nx=i(),w(),Oi(),Mx(),Px=o(),Fx=e=>{let t=e.initialValues,n=[],[r,i]=(0,Nx.useState)(t);(0,Nx.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,Px.jsx)(Di,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,Nx.useRef)(null);return(0,Nx.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,Px.jsx)(`div`,{className:jx.group,ref:o,children:(0,Px.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,Px.jsx)(s,{label:e.title,noMargin:!0,children:n}),(0,Px.jsx)(`div`,{className:jx.submit,children:(0,Px.jsx)(c,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},Fx.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}function Lx(){return(Lx=t((()=>{Tx(),Ox(),ux(),ax(),L(),_x(),mg(),g_(),eg(),dv(),M_(),z_(),Yb(),ky(),dy(),cg(),Ug(),ey(),Wi(),Li(),Cy(),Sh(),C_(),Oi(),ah(),Ix(),fi(),gi(),Ti(),Ch(),Jm(),$m(),be()})))()}var Rx;function zx(){return(zx=t((()=>{Rx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Bx;function Vx(){return(Vx=t((()=>{Bx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Hx=n({EyeRings:()=>Ux}),Ux;function Wx(){return(Wx=t((()=>{P(),zx(),Vx(),Ux=class extends bt{constructor(e){super(e);let t=this.engine,n=new Jt({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new un({phase:[`deferred`,`shadowMap`],frag:Rx,vert:Bx,uniforms:t.uniforms});this.entity.addComponent(j,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(j)}}})))()}var Gx;function Kx(){return(Kx=t((()=>{Gx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Yx=n({FlashLine:()=>Xx}),Xx;function Zx(){return(Zx=t((()=>{k(),P(),Kx(),Jx(),Xx=class extends bt{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new Et({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=De.randomVector().multiply(new D(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new un({phase:[`forward`,`envMap`],frag:Zt(`flFrag`,Gx),vert:Zt(`flVert`,qx),uniforms:M.merge(t.uniforms)}),this.entity.addComponent(j,{material:this.material,geometry:this.geometry})}}})))()}var Qx;function $x(){return($x=t((()=>{Qx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var eS=n({SkyBox:()=>tS}),tS;function nS(){return(nS=t((()=>{P(),$x(),tS=class extends bt{material;constructor(e){super(e);let t=this.engine;this.material=new un({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:Zt(`SkyBoxFrag`,Qx),uniforms:M.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}}})))()}var rS;function iS(){return(iS=t((()=>{rS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var aS;function oS(){return(oS=t((()=>{aS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var sS=n({GridCross:()=>cS}),cS;function lS(){return(lS=t((()=>{k(),P(),iS(),oS(),cS=class extends bt{constructor(e){super(e);let t=new wt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new D(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new un({frag:Zt(`gridCrossFrag`,rS),vert:Zt(`gridCrossVert`,aS),phase:[`forward`]});this.entity.addComponent(j,{geometry:t,material:a})}}})))()}var uS;function dS(){return(dS=t((()=>{uS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var mS=n({GridDots:()=>hS}),hS;function gS(){return(gS=t((()=>{k(),P(),dS(),pS(),hS=class extends bt{constructor(e){super(e);let t=new At({radius:.1}),n=[],r=[],i=new D(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new un({frag:Zt(`gridDotsFrag`,uS),vert:Zt(`gridDotsVert`,fS),phase:[`forward`]});this.entity.addComponent(j,{geometry:t,material:a})}}})))()}var _S;function vS(){return(vS=t((()=>{_S=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
#endif\r
\r
}`})))()}var yS;function bS(){return(bS=t((()=>{yS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var xS=n({WireCube:()=>SS}),SS;function CS(){return(CS=t((()=>{P(),vS(),bS(),SS=class extends bt{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new wt({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new un({phase:[`deferred`],frag:_S,vert:yS,uniforms:M.merge(t.uniforms)});this.entity.addComponent(j,{geometry:i,material:s})}}})))()}var wS;function TS(){return(TS=t((()=>{wS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ES;function DS(){return(DS=t((()=>{ES=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var OS=n({OREngineCube:()=>kS}),kS;function AS(){return(AS=t((()=>{P(),ii(),TS(),DS(),kS=class extends bt{material;constructor(e){super(e);let t=this.engine;this.material=new un({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:Zt(`OREngineCubeVert`,ES),frag:Zt(`OREngineCubeFrag`,wS),uniforms:M.merge(t.uniforms,{uNoiseTex:{value:F.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(j);n&&(n.material=this.material)}}})))()}var jS;function MS(){return(MS=t((()=>{jS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var NS;function PS(){return(PS=t((()=>{NS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var FS=n({OREngineLogo:()=>IS}),IS;function LS(){return(LS=t((()=>{P(),MS(),PS(),IS=class extends bt{material;constructor(e){super(e);let t=this.engine;this.material=new un({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:Zt(`OREngineLogoVert`,NS),frag:Zt(`OREngineLogoFrag`,jS),uniforms:M.merge(t.uniforms)});let n=this.entity.getComponent(j);n&&(n.material=this.material)}}})))()}var RS;function zS(){return(zS=t((()=>{RS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var HS=n({Dust:()=>US}),US;function WS(){return(WS=t((()=>{k(),P(),zS(),VS(),US=class extends bt{constructor(e){super(e);let t=this.engine,n=new St,r=e.args?.num||2048,i=new D(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new un({phase:[`forward`],drawType:`POINTS`,frag:RS,vert:BS,uniforms:M.merge(t.uniforms)});this.entity.addComponent(j,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(j)}}})))()}var GS;function KS(){return(KS=t((()=>{GS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `})))()}var ZS=n({YakiSoba:()=>QS}),QS;function $S(){return($S=t((()=>{k(),P(),KS(),JS(),XS(),QS=class extends bt{_gpu;constructor(e){super(e);let t=this.engine,n=new D(64,512);this._gpu=new Ir({passes:[new zr(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:Zt(`yakiSobaCompute`,YS),uniforms:M.merge({},t.uniforms,t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new wt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new un({frag:Zt(`chainFrag`,GS),vert:Zt(`chainVert`,qS),phase:[`deferred`,`shadowMap`],uniforms:M.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(j,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(j),this._gpu.dispose()}}})))()}var eC;function tC(){return(tC=t((()=>{eC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var LC;function RC(){return(RC=t((()=>{IC(),LC={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:FC}})))()}var zC;function BC(){return(BC=t((()=>{zC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var VC;function HC(){return(HC=t((()=>{BC(),VC={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:zC}})))()}var UC;function WC(){return(WC=t((()=>{UC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var GC;function KC(){return(KC=t((()=>{WC(),GC={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:UC}})))()}var qC;function JC(){return(JC=t((()=>{WC(),qC={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:UC}})))()}var YC,XC,ZC;function QC(){return(QC=t((()=>{RC(),HC(),KC(),JC(),ii(),YC=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":LC,"/demo-webgl/Resources/Textures/noise.tex":VC,"/demo-webgl/Resources/Textures/noiseCyclic.tex":GC,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":qC}),XC=()=>{for(let e of Object.values(YC))e&&F.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},ZC=e=>{F.resources.buildTextureInstances(e.renderer,e.uniforms)}})))()}var $C,ew,tw,nw,rw;function iw(){return(iw=t((()=>{Wx(),Zx(),nS(),lS(),gS(),CS(),AS(),LS(),WS(),$S(),iC(),Po(),ii(),PC(),QC(),$C=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":Hx,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":Yx,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":eS,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":sS,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":mS,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":xS,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":OS,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":FS,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":HS,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":ZS,"/demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":nC}),ew=Object.assign({}),tw=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);tw(a,e)}}},nw=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);nw(a,e)}}},rw=()=>{gt.gltfLoaderFactory=e=>new Eo(e),F.resources.clear();let e=F.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,It),e.addComponent(`Camera`,Mt),e.addComponent(`Mesh`,j);let t=Object.keys(MC);for(let e=0;e<t.length;e++){let n=t[e],r=MC[n],i=F.resources.addComponentGroup(n);tw(r,i)}let n=Object.keys(NC);for(let e=0;e<n.length;e++){let t=n[e],r=NC[t],i=F.resources.addGeometryGroup(t);nw(r,i)}let r=qr($C,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=F.resources.addComponentGroup(t);tw(n,a)}let a=qr(ew,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=F.resources.addGeometryGroup(t);nw(n,r)}XC()}})))()}var aw,ow,sw,cw,lw,uw;function dw(){return(dw=t((()=>{aw=i(),Lx(),w(),iw(),ow=o(),rw(),sw=({setup:e})=>{let{editor:t}=I();return(0,aw.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},cw=e=>(0,ow.jsx)(gx,{project:e.fixture.scene,onEngineInit:ZC,children:(0,ow.jsx)(ix,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,ow.jsx)(y,{children:(0,ow.jsxs)(ee,{children:[e.children,e.fixture.setup&&(0,ow.jsx)(sw,{setup:e.fixture.setup}),(0,ow.jsx)(_,{}),(0,ow.jsx)(C,{})]})})})}),lw=e=>t=>(0,ow.jsx)(cw,{fixture:e,children:(0,ow.jsx)(t,{})}),uw=e=>t=>(0,ow.jsx)(gx,{project:e,onEngineInit:ZC,children:(0,ow.jsx)(t,{})}),cw.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var fw,pw,mw,hw,gw;function _w(){return(_w=t((()=>{fw={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`CameraController`,uuid:`sb-camera-controller`}]},pw={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[fw,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},mw={...pw,scene:{name:`root`,uuid:`0`,childs:[fw]}},hw={enableRender:!0,resolutionScale:.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},gw={scene:pw,editorData:hw}})))()}export{Ui as A,L as B,cg as C,Sh as D,xh as E,Ti as F,ii as H,hi as I,gi as L,Di as M,Oi as N,ih as O,wi as P,di as R,sg as S,eg as T,F as U,I as V,Qr as W,dy as _,pw as a,h_ as b,lw as c,Ix as d,lx as f,uy as g,Yb as h,gw as i,Wi as j,ah as k,uw as l,Jb as m,hw as n,cw as o,ux as p,mw as r,dw as s,_w as t,Fx as u,$v as v,$h as w,g_ as x,ey as y,fi as z};