...
}`,vf=s({EyeRings:()=>yf}),yf=class extends P{constructor(e){super(e);let t=this.engine,n=new Gt({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new Qt({phase:[`deferred`,`shadowMap`],frag:gf,vert:_f,uniforms:t.uniforms});this.entity.addComponent(I,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(I)}},bf=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Sf=s({FlashLine:()=>Cf}),Cf=class extends P{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new It({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=dt.randomVector().multiply(new j(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new Qt({phase:[`forward`,`envMap`],frag:qt(`flFrag`,bf),vert:qt(`flVert`,xf),uniforms:Xt.merge(t.uniforms)}),this.entity.addComponent(I,{material:this.material,geometry:this.geometry})}},wf=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Tf=s({SkyBox:()=>Ef}),Ef=class extends P{material;constructor(e){super(e);let t=this.engine;this.material=new Qt({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:qt(`SkyBoxFrag`,wf),uniforms:Xt.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}},Df=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,kf=s({GridCross:()=>Af}),Af=class extends P{constructor(e){super(e);let t=new Ft({width:.05,height:.5,depth:.05}),n=[],r=[],i=new j(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new Qt({frag:qt(`gridCrossFrag`,Df),vert:qt(`gridCrossVert`,Of),phase:[`forward`]});this.entity.addComponent(I,{geometry:t,material:a})}},jf=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Nf=s({GridDots:()=>Pf}),Pf=class extends P{constructor(e){super(e);let t=new Rt({radius:.1}),n=[],r=[],i=new j(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new Qt({frag:qt(`gridDotsFrag`,jf),vert:qt(`gridDotsVert`,Mf),phase:[`forward`]});this.entity.addComponent(I,{geometry:t,material:a})}},Ff=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,Lf=s({WireCube:()=>Rf}),Rf=class extends P{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new Ft({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new Qt({phase:[`deferred`],frag:Ff,vert:If,uniforms:Xt.merge(t.uniforms)});this.entity.addComponent(I,{geometry:i,material:s})}},zf=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Vf=s({OREngineCube:()=>Hf}),Hf=class extends P{material;constructor(e){super(e);let t=this.engine;this.material=new Qt({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:qt(`OREngineCubeVert`,Bf),frag:qt(`OREngineCubeFrag`,zf),uniforms:Xt.merge(t.uniforms,{uNoiseTex:{value:br.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(I);n&&(n.material=this.material)}},Uf=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Gf=s({OREngineLogo:()=>Kf}),Kf=class extends P{material;constructor(e){super(e);let t=this.engine;this.material=new Qt({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:qt(`OREngineLogoVert`,Wf),frag:qt(`OREngineLogoFrag`,Uf),uniforms:Xt.merge(t.uniforms)});let n=this.entity.getComponent(I);n&&(n.material=this.material)}},qf=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Yf=s({Dust:()=>Xf}),Xf=class extends P{constructor(e){super(e);let t=this.engine,n=new F,r=e.args?.num||2048,i=new j(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new Qt({phase:[`forward`],drawType:`POINTS`,frag:qf,vert:Jf,uniforms:Xt.merge(t.uniforms)});this.entity.addComponent(I,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(I)}},Zf=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `},Cp={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `,Tp=Object.assign({"../../demo-webgl/Resources/Textures/hash.tex":Sp,"../../demo-webgl/Resources/Textures/noise.tex":Cp,"../../demo-webgl/Resources/Textures/noiseCyclic.tex":{name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:wp},"../../demo-webgl/Resources/Textures/noiseCyclicAnime.tex":{name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:wp}}),Ep=()=>{for(let e of Object.values(Tp))e&&br.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},Dp=e=>{br.resources.buildTextureInstances(e.renderer,e.uniforms)},Op=Object.assign({"../../demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":vf,"../../demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":Sf,"../../demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":Tf,"../../demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":kf,"../../demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":Nf,"../../demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":Lf,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":Vf,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":Gf,"../../demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":Yf,"../../demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":ep}),kp=Object.assign({}),Ap=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addComponent(i,a):Ap(a,t.createGroup(i))}},jp=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addGeometry(i,a):jp(a,t.createGroup(i))}};document.title=`demo-webgl`,(()=>{Nt.gltfLoaderFactory=e=>new ir(e),br.resources.clear();let e=br.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Vt),e.addComponent(`Camera`,zt),e.addComponent(`Mesh`,I);let t=Object.keys(bp);for(let e=0;e<t.length;e++){let n=t[e],r=bp[n];Ap(r,br.resources.addComponentGroup(n))}let n=Object.keys(xp);for(let e=0;e<n.length;e++){let t=n[e],r=xp[t];jp(r,br.resources.addGeometryGroup(t))}let r=vr(Op,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t];Ap(n,br.resources.addComponentGroup(t))}let a=vr(kp,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t];jp(n,br.resources.addGeometryGroup(t))}Ep()})(),_.createRoot(document.getElementById(`root`)).render((0,E.jsx)(hf,{projectName:`demo-webgl`,sceneData:y,editorData:v,initResourceInstances:Dp}));