...
}`,Nf=class extends Nt{wrapperElm;glCanvas;backend;gl;canvasTexture;canvas;canvasCtx;glRenderer;postProcess;viewPort;viewPortRange;viewPortScale;frameSetting;loopSetting;musicBuffer;musicTexture;resizeObserver;canvasSize;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.glCanvas=document.createElement(`canvas`),this.backend=new Ot(this.glCanvas.getContext(`webgl2`)),this.gl=this.backend.gl,this.canvasSize=new A(this.glCanvas.width,this.glCanvas.height),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0],this.viewPortScale=50,this.frameSetting=null,this.loopSetting={enabled:!1,start:0,end:0},this.resizeObserver=new ResizeObserver(this.onResize.bind(this));let e={renderer:null,createEntity:t=>new en({...t,engine:e})};this.glRenderer=new Kn(this.backend,e),e.renderer=this.glRenderer,this.canvasTexture=new wt(this.gl),this.musicBuffer=null,this.musicTexture=new wt(this.gl),this.musicTexture.setting({type:this.gl.UNSIGNED_BYTE,internalFormat:this.gl.LUMINANCE,format:this.gl.LUMINANCE,magFilter:this.gl.LINEAR,minFilter:this.gl.LINEAR,wrapS:this.gl.MIRRORED_REPEAT}),this.postProcess=new un({passes:[new P(this.backend,{frag:Mf,uniforms:{uCanvasTex:{type:`1i`,value:null},uMusicTex:{type:`1i`,value:this.musicTexture}},renderTarget:null})]})}onResize(){if(this.wrapperElm){let e=new A(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);if(e.x===0||e.y===0)return;this.glCanvas.width=this.canvas.width=e.x,this.glCanvas.height=this.canvas.height=e.y,this.canvasSize.set(this.glCanvas.width,this.glCanvas.height),this.postProcess.resize(e),this.render()}}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.frameSetting){this.canvasCtx.fillStyle=`#181818`;let e=this.frameToPx(0),t=this.frameToPx(this.frameSetting.duration);this.canvasCtx.fillRect(e,0,t-e,this.canvas.height)}let e=(e,t,n)=>{let r=Math.ceil(this.viewPort[0]/e)*e;this.canvasCtx.beginPath();let i=0;for(;r<this.viewPort[2]&&i<100;){let n=this.frameToPx(r+t);this.canvasCtx.moveTo(n,0),this.canvasCtx.lineTo(n,this.canvas.height),r+=e,i++}this.canvasCtx.strokeStyle=n,this.canvasCtx.lineWidth=1,this.canvasCtx.stroke()};if(e(this.viewPortScale,0,`#555`),e(this.viewPortScale,this.viewPortScale/2,`#333`),this.musicBuffer&&this.frameSetting){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)],s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}if(this.loopSetting.enabled){this.canvasCtx.fillStyle=`#0009`;let e=this.frameToPx(this.loopSetting.start),t=this.frameToPx(this.loopSetting.end);this.canvasCtx.fillRect(0,0,e,this.canvas.height),this.canvasCtx.fillRect(t,0,this.canvas.width-t,this.canvas.height)}this.canvasTexture.attach(this.canvas),this.postProcess.passes&&(this.postProcess.passes[0].uniforms.uCanvasTex.value=this.canvasTexture),this.glRenderer.renderPostProcess(this.postProcess,void 0,this.canvasSize)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.glCanvas),this.onResize()}setViewPort(e,t){this.viewPort=e,this.viewPortRange=[e[2]-e[0],e[3]-e[1]],this.viewPortScale=t,this.render()}setFrameSetting(e){this.frameSetting={duration:Math.round(e.duration),fps:Math.round(e.fps)},this.render()}setMusicBuffer(e){this.musicBuffer=e,setTimeout(()=>{this.render()},100)}setLoopSetting(e,t,n){this.loopSetting={enabled:e,start:t,end:n},this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.glCanvas),this.resizeObserver.disconnect()}},Pf={timelineCanvas:`TimelineCanvas__timelineCanvas___LnRpb`},Ff=()=>{let{viewPort:e,viewPortScale:t,musicBuffer:n,musicBufferVersion:r,glEditor:i}=jf(),[a,o]=(0,b.useState)(),s=(0,b.useRef)(null);(0,b.useEffect)(()=>{let e=new Nf;return o(e),s.current&&e.setWrapperElm(s.current),()=>{e.dispose()}},[]),(0,b.useEffect)(()=>{a&&e&&t&&a.setViewPort(e,t)},[a,e,t]);let[c]=Z(i?.engine,`timeline/duration`),[l]=Z(i?.engine,`timeline/fps`);(0,b.useEffect)(()=>{a&&c&&l&&a.setFrameSetting({duration:c||0,fps:l||0})},[a,c,l]);let[u]=Z(i,`frameLoop/enabled`),[d]=Z(i,`frameLoop/start`),[f]=Z(i,`frameLoop/end`);return(0,b.useEffect)(()=>{a&&a.setLoopSetting(u||!1,d||0,f||0)},[a,u,d,f]),(0,b.useEffect)(()=>{a&&n&&a.setMusicBuffer(n)},[a,n,r]),(0,T.jsx)(`div`,{className:Pf.timelineCanvas,ref:s})},If={controls:`TimelineControls__controls___LmNvb`},Lf=e=>{let{viewPort:t,setCurrentFrame:n,getFrameViewPort:r,zoom:i,scroll:a,setViewPortCenter:o}=jf(),s=(0,b.useRef)([0,0,0,0]),c=(0,b.useRef)([0,0]);t&&(s.current=t,c.current=[t[2]-t[0],t[3]-t[1]]);let l=(0,b.useRef)(null),u=(0,b.useRef)(null),d=(0,b.useRef)(null),f=(0,b.useRef)(null),p=(0,b.useRef)(null),m=(0,b.useCallback)(e=>{let t=l.current&&l.current.clientWidth||1;if(d.current==0){if(n&&r&&u.current){let i=(e.clientX-u.current.left)/t;n(r(i))}}else if(d.current==1){let n=[e.clientX,e.clientY];if(f.current&&p.current){let e=-(n[0]-f.current[0])/t*c.current[0];o&&o(p.current+e)}}},[n,r,o]),h=(0,b.useCallback)(e=>{d.current=e.button,p.current=(s.current[2]+s.current[0])/2,f.current=[e.clientX,e.clientY],u.current=e.currentTarget.getBoundingClientRect();let t=(e.clientX-u.current.left)/e.currentTarget.clientWidth;d.current==0&&n&&r&&n(r(t)),window.addEventListener(`pointermove`,m);let i=()=>{f.current=null,d.current=null,p.current=null,window.removeEventListener(`pointermove`,m)};return window.addEventListener(`pointerup`,i),()=>{window.removeEventListener(`pointerup`,i),window.removeEventListener(`pointermove`,m)}},[r,n,m]),g=(0,b.useCallback)(e=>{if(d.current!==null||!i||!a)return;e.preventDefault();let t=e.target&&e.target.clientWidth||1,n=Math.abs(e.deltaY);Math.abs(e.deltaX)<n?i(n>50?e.deltaY<0?.9:1.1:1+e.deltaY*.005):a(e.deltaX/t*.5)},[i,a]);return(0,b.useEffect)(()=>{let e=l.current;return e&&e.addEventListener(`wheel`,g,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,g)}},[g]),t?(0,T.jsx)(`div`,{className:If.controls,onPointerDown:h,ref:l,children:e.children}):null},Rf={cursor:`TimelineCursor__cursor___LmN1c`,frame:`TimelineCursor__frame___LmN1c`},zf=()=>{let{viewPort:e,framePlay:t}=jf();if(!e||!t)return null;let n=e[2]-e[0],r=(t.current-e[0])/n;return(0,T.jsx)(`div`,{className:Rf.cursor,style:{left:r*100+`%`},children:(0,T.jsx)(`div`,{className:Rf.frame})})},Bf={timelineLoop:`TimelineLoop__timelineLoop___LnRpb`,start:`TimelineLoop__start___LnRpb`,end:`TimelineLoop__end___LnRpb`},Vf={cursor:`TimelineLoopCursor__cursor___LmN1c`},Hf=({onMove:e})=>{let t=(0,b.useRef)(!1);return(0,T.jsx)(`div`,{className:Vf.cursor,onPointerDown:e=>{e.buttons==1&&(t.current=!0,e.stopPropagation())},onPointerMove:n=>{let r=n.target;t.current!==!1&&n.buttons==1&&(r.setPointerCapture(n.pointerId),n.buttons==1&&e&&e(n.clientX),n.nativeEvent.preventDefault(),n.nativeEvent.stopPropagation())},onPointerUp:()=>{t.current=!1}})},Uf=()=>{let{viewPort:e,framePlay:t,glEditor:n}=jf(),r=(0,b.useRef)(null);Qu(n,[`frameLoop/enabled`,`frameLoop/start`,`frameLoop/end`]);let[i]=Z(n,`frameLoop/enabled`),[a,o]=Z(n,`frameLoop/start`),[s,c]=Z(n,`frameLoop/end`);if(i!==!0||!e||!t||a===void 0||s===void 0)return null;let l=e[2]-e[0],u=(a-e[0])/l,d=(s-e[0])/l,f=(t,n)=>{let r=t.getBoundingClientRect();return(n-r.x)/r.width*(e[2]-e[0])+e[0]};return(0,T.jsx)(`div`,{className:Bf.timelineLoop,ref:r,children:(0,T.jsxs)(`div`,{className:Bf.timelineLoop_inner,children:[(0,T.jsx)(`div`,{className:Bf.start,style:{left:u*100+`%`},children:(0,T.jsx)(Hf,{onMove:e=>{r.current&&o&&o(f(r.current,e))}})}),(0,T.jsx)(`div`,{className:Bf.end,style:{left:d*100+`%`},children:(0,T.jsx)(Hf,{onMove:e=>{r.current&&c&&c(f(r.current,e))}})})]})})},Wf={scale:`TimelineScale__scale___LnNjY`,scale_inner:`TimelineScale__scale_inner___LnNjY`,scale_item:`TimelineScale__scale_item___LnNjY`,scale_item_frame:`TimelineScale__scale_item_frame___LnNjY`,scale_item_time:`TimelineScale__scale_item_time___LnNjY`},Gf=e=>`${(`00`+Math.floor(e%3600/60)).slice(-2)}:${(`00`+Math.floor(e%60)).slice(-2)}`,Kf=()=>{let{glEditor:e,viewPort:t,viewPortScale:n}=jf(),[r,i]=Z(e?.engine,`timeline/fps`);if(!t||!n||r===void 0)return null;let a=[],o=Math.ceil(t[0]/n)*n,s=0;for(;o<t[2]&&s<100;){let e=(o-t[0])/(t[2]-t[0]),i=o/(r||0);a.push((0,T.jsxs)(`div`,{className:Wf.scale_item,style:{left:e*100+`%`},children:[(0,T.jsx)(`div`,{className:Wf.scale_item_frame,children:o}),(0,T.jsx)(`div`,{className:Wf.scale_item_time,children:Gf(i)})]},o)),o+=n,s++}return(0,T.jsx)(`div`,{className:Wf.scale,children:(0,T.jsx)(`div`,{className:Wf.scale_inner,children:a})})},qf={timelineSetting:`TimelineSetting__timelineSetting___LnRpb`},Jf=()=>{let{framePlay:e,glEditor:t}=jf(),n=(0,b.useCallback)((e,t)=>{t&&t(e)},[]),[r,i]=Z(t,`frameLoop/enabled`),[a,o]=Z(t?.engine,`timeline/duration`),[s,c]=Z(t?.engine,`timeline/fps`);return(0,T.jsx)(`div`,{className:qf.timelineSetting,children:(0,T.jsxs)(et,{children:[(0,T.jsx)(Be,{title:`current`,children:(0,T.jsx)(Hr,{value:Math.floor(e?.current||0),readOnly:!0})}),(0,T.jsx)(Be,{title:`duration`,children:(0,T.jsx)(Hr,{value:a,onChange:e=>n(e,o)})}),(0,T.jsx)(Be,{title:`fps`,children:(0,T.jsx)(Hr,{value:s,onChange:e=>n(e,c)})}),(0,T.jsx)(Be,{title:`loop`,children:(0,T.jsx)(Hr,{value:r||!1,onChange:e=>n(e,i)})})]})})},Yf={timeline:`Timeline__timeline___LnRpb`,inner:`Timeline__inner___LnRpb`,content:`Timeline__content___LnRpb`,setting:`Timeline__setting___LnRpb`},Xf=()=>{let{editor:e}=Lr(),[t,n]=(0,b.useState)({current:0,playing:!1}),[r,i]=(0,b.useState)([0,0,100,0]),a=(0,b.useRef)([0,0,0,0]);a.current=r;let o=r[2]-r[0],s=10*2**(0+Math.floor(Math.log2(o/100)));s=Math.max(1,Math.floor(s));let c=e?.audioBuffer,[l,u]=(0,b.useState)();(0,b.useEffect)(()=>{if(e){let t=e.engine,r=e=>{n({...e})};r(t.frame);let a=0,o=()=>{u(a++)},s=()=>{i([0,0,t.frameSetting.duration,0])};return s(),t.on(`update/frame/play`,r),t.on(`update/music`,o),t.on(`loaded`,s),()=>{t.off(`update/frame/play`,r),t.off(`update/music`,o),t.off(`loaded`,s)}}},[e]);let d=(0,b.useCallback)(t=>{e&&e.engine.seek(t)},[e]),f=(0,b.useCallback)(e=>{let t=r[2]-r[0];return Math.floor(r[0]+t*e)},[r]),p=(0,b.useCallback)(e=>{let t=a.current,n=(t[2]+t[0])/2,r=(t[0]-n)*e+n,o=(t[2]-n)*e+n;i([r,t[1],o,t[3]])},[]),m=(0,b.useCallback)(e=>{let t=a.current,n=e*(t[2]-t[0]);i([t[0]+n,t[1],t[2]+n,t[3]])},[]),h=(0,b.useCallback)(e=>{let t=a.current,n=t[2]-t[0];i([e-n/2,t[1],e+n/2,t[3]])},[]);return{glEditor:e,framePlay:t,viewPort:r,viewPortScale:s,musicBuffer:c,musicBufferVersion:l,setCurrentFrame:d,getFrameViewPort:f,zoom:p,scroll:m,setViewPortCenter:h}},Zf=e=>{let t=Xf();return(0,T.jsx)(Af.Provider,{value:t,children:e.children})},Qf=()=>(0,T.jsx)(Zf,{children:(0,T.jsx)(`div`,{className:Yf.timeline,children:(0,T.jsxs)(`div`,{className:Yf.inner,children:[(0,T.jsx)(`div`,{className:Yf.setting,children:(0,T.jsx)(Jf,{})}),(0,T.jsxs)(`div`,{className:Yf.content,children:[(0,T.jsx)(Ff,{}),(0,T.jsx)(zf,{}),(0,T.jsx)(Lf,{children:(0,T.jsx)(Uf,{})}),(0,T.jsx)(Kf,{})]})]})})}),$f={editor:`OREditor__editor___LmVka`},ep=e=>{let{engine:t}=Q(),[n,r]=(0,b.useState)(()=>new qu(t)),i=b.useRef(n);return i.current=n,(0,b.useEffect)(()=>{if(!i.current.disposed&&i.current.engine.uuid==t.uuid)return;let e=new qu(t);r(e)},[t]),(0,b.useEffect)(()=>()=>{n.dispose()},[n]),{engine:t,editor:n,projectName:e}},tp=e=>{let t=ep(e.projectName);return(0,b.useEffect)(()=>{if(!(!t.editor||!e.onSave))return t.editor.on(`save`,e.onSave),()=>{t.editor.off(`save`,e.onSave)}},[t.editor,e.onSave]),(0,b.useEffect)(()=>{t.editor&&t.editor.bootstrap(e.editorData)},[e.editorData,t.editor]),(0,T.jsx)(Ir.Provider,{value:{...t,scenes:e.scenes},children:e.children})},np=[{id:`hierarchy`,title:`Hierarchy`,category:`General`,content:(0,T.jsx)(et,{children:(0,T.jsx)(Nd,{})})},{id:`timer`,title:`Timer`,category:`Rendering`,content:(0,T.jsx)(et,{noPadding:!0,children:(0,T.jsx)(Ed,{})})},{id:Vd,title:`Screen`,category:`General`,multiple:!0,content:e=>(0,T.jsx)(Hd,{viewportId:e})},{id:`property`,title:`Property`,category:`General`,content:(0,T.jsx)(et,{children:(0,T.jsx)(gd,{})})},{id:`textures`,title:`Textures`,category:`Rendering`,content:(0,T.jsx)(et,{noPadding:!0,children:(0,T.jsx)(kf,{})})},{id:`scene`,title:`Scene`,category:`General`,content:(0,T.jsx)(et,{children:(0,T.jsx)(Df,{})})},{id:`export`,title:`Export`,category:`Project`,content:(0,T.jsx)(et,{children:(0,T.jsx)(vd,{})})},{id:`renderer`,title:`Renderer`,category:`Rendering`,content:(0,T.jsx)(et,{children:(0,T.jsx)(Sf,{})})},{id:`editor-settings`,title:`Editor`,category:`Project`,content:(0,T.jsx)(et,{children:(0,T.jsx)(Xr,{})})},{id:`timeline`,title:`Timeline`,category:`Animation`,content:(0,T.jsx)(et,{noPadding:!0,children:(0,T.jsx)(Qf,{})})}],rp=e=>{let t=[];for(let n of e)n.multiple||n.id!==`hierarchy`&&n.id!==`property`&&n.id!==`timeline`&&t.push({id:n.id,title:n.title,content:n.content});return t},ip=e=>{let t=gt(),n=(0,b.useMemo)(()=>e.panels?[...np,...e.panels]:np,[e.panels]),r=null;return r=t.isPC?(0,T.jsx)(bf,{panels:n}):(0,T.jsx)(T.Fragment,{children:(0,T.jsxs)(Ge,{direction:`vertical`,storageKey:`orengine-editor-sp-main`,children:[(0,T.jsx)(Ge.Item,{size:`calc( min( 56.25vw, 55vh ) + 77px )`,minSize:200,style:{minHeight:`200px`},children:(0,T.jsx)(Hd,{viewportId:`main`})}),(0,T.jsx)(Ge.Item,{flex:1,minSize:200,children:(0,T.jsxs)(rt,{storageKey:`orengine-panel-sp-main`,children:[(0,T.jsx)(rt.Tab,{title:`Hierarchy / Property`,children:(0,T.jsxs)(Ge,{direction:`horizontal`,storageKey:`orengine-editor-sp-hierarchyProp`,children:[(0,T.jsx)(Ge.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,T.jsx)(Nd,{})}),(0,T.jsx)(Ge.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,T.jsx)(gd,{})})]})}),rp(n).map(e=>(0,T.jsx)(rt.Tab,{title:e.title,children:e.content},e.id))]})}),(0,T.jsx)(Ge.Item,{size:`120px`,minSize:80,children:(0,T.jsx)(rt,{storageKey:`orengine-panel-sp-timeline`,children:(0,T.jsx)(rt.Tab,{title:`Timeline`,children:(0,T.jsx)(et,{noPadding:!0,children:(0,T.jsx)(C,{fallback:(0,T.jsx)(`div`,{children:`エラーだよ`}),children:(0,T.jsx)(Qf,{})})})})})})]})}),(0,T.jsx)(tp,{projectName:e.projectName,onSave:e.onSave,editorData:e.editorData,scenes:e.scenes,children:(0,T.jsx)(dt,{children:(0,T.jsxs)(Re,{children:[(0,T.jsx)(`div`,{className:$f.editor,children:r}),(0,T.jsx)(Xu,{}),(0,T.jsx)(Ie,{}),(0,T.jsx)(ct,{})]})})})},ap=()=>{let[e,t]=b.useState(()=>new F(qn)),n=b.useRef(e);return n.current=e,(0,b.useEffect)(()=>{n.current.disposed&&t(new F(qn))},[]),(0,b.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,b.useCallback)(t=>{t&&e.load(t)},[e])}},op=e=>{let t=ap(),{engine:n}=t,r=(0,b.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,b.useEffect)(()=>{r.current?.(n)},[n]),(0,b.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,T.jsx)(yd.Provider,{value:t,children:e.children})},sp=e=>(0,T.jsx)(op,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,T.jsx)(ip,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),cp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,up=s({EyeRings:()=>dp}),dp=class extends Ut{constructor(e){super(e);let t=this.engine,n=new tn({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new ln({phase:[`deferred`,`shadowMap`],frag:cp,vert:lp,uniforms:t.uniforms});this.entity.addComponent(N,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(N)}},fp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,mp=s({FlashLine:()=>hp}),hp=class extends Ut{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new Kt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=yt.randomVector().multiply(new A(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new ln({phase:[`forward`,`envMap`],frag:rn(`flFrag`,fp),vert:rn(`flVert`,pp),uniforms:sn.merge(t.uniforms)}),this.entity.addComponent(N,{material:this.material,geometry:this.geometry})}},gp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,_p=s({SkyBox:()=>vp}),vp=class extends Ut{material;constructor(e){super(e);let t=this.engine;this.material=new ln({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:rn(`SkyBoxFrag`,gp),uniforms:sn.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}},yp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,xp=s({GridCross:()=>Sp}),Sp=class extends Ut{constructor(e){super(e);let t=new Gt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new A(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new ln({frag:rn(`gridCrossFrag`,yp),vert:rn(`gridCrossVert`,bp),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},Cp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Tp=s({GridDots:()=>Ep}),Ep=class extends Ut{constructor(e){super(e);let t=new Jt({radius:.1}),n=[],r=[],i=new A(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new ln({frag:rn(`gridDotsFrag`,Cp),vert:rn(`gridDotsVert`,wp),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},Dp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,kp=s({WireCube:()=>Ap}),Ap=class extends Ut{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new Gt({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new ln({phase:[`deferred`],frag:Dp,vert:Op,uniforms:sn.merge(t.uniforms)});this.entity.addComponent(N,{geometry:i,material:s})}},jp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Np=s({OREngineCube:()=>Pp}),Pp=class extends Ut{material;constructor(e){super(e);let t=this.engine;this.material=new ln({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:rn(`OREngineCubeVert`,Mp),frag:rn(`OREngineCubeFrag`,jp),uniforms:sn.merge(t.uniforms,{uNoiseTex:{value:F.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(N);n&&(n.material=this.material)}},Fp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Lp=s({OREngineLogo:()=>Rp}),Rp=class extends Ut{material;constructor(e){super(e);let t=this.engine;this.material=new ln({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:rn(`OREngineLogoVert`,Ip),frag:rn(`OREngineLogoFrag`,Fp),uniforms:sn.merge(t.uniforms)});let n=this.entity.getComponent(N);n&&(n.material=this.material)}},zp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Vp=s({Dust:()=>Hp}),Hp=class extends Ut{constructor(e){super(e);let t=this.engine,n=new Wt,r=e.args?.num||2048,i=new A(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new ln({phase:[`forward`],drawType:`POINTS`,frag:zp,vert:Bp,uniforms:sn.merge(t.uniforms)});this.entity.addComponent(N,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(N)}},Up=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `},hm={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `,_m=Object.assign({"../../demo-webgl/Resources/Textures/hash.tex":mm,"../../demo-webgl/Resources/Textures/noise.tex":hm,"../../demo-webgl/Resources/Textures/noiseCyclic.tex":{name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:gm},"../../demo-webgl/Resources/Textures/noiseCyclicAnime.tex":{name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:gm}}),vm=()=>{for(let e of Object.values(_m))e&&F.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},ym=e=>{F.resources.buildTextureInstances(e.renderer,e.uniforms)},bm=Object.assign({"../../demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":up,"../../demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":mp,"../../demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":_p,"../../demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":xp,"../../demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":Tp,"../../demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":kp,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":Np,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":Lp,"../../demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":Vp,"../../demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":Kp}),xm=Object.assign({}),Sm=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addComponent(i,a):Sm(a,t.createGroup(i))}},Cm=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addGeometry(i,a):Cm(a,t.createGroup(i))}},wm=()=>{Vt.gltfLoaderFactory=e=>new _r(e),F.resources.clear();let e=F.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Zt),e.addComponent(`Camera`,Yt),e.addComponent(`Mesh`,N);let t=Object.keys(fm);for(let e=0;e<t.length;e++){let n=t[e],r=fm[n];Sm(r,F.resources.addComponentGroup(n))}let n=Object.keys(pm);for(let e=0;e<n.length;e++){let t=n[e],r=pm[t];Cm(r,F.resources.addGeometryGroup(t))}let r=jr(bm,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t];Sm(n,F.resources.addComponentGroup(t))}let a=jr(xm,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t];Cm(n,F.resources.addGeometryGroup(t))}vm()},Tm=s({panel:()=>Em}),Em={id:`sample`,title:`Sample`,category:`Tools`,content:(0,T.jsx)(()=>{let{editor:e,engine:t}=Lr(),[n]=Z(e,`selectedEntityId`),[r,i]=(0,b.useState)(``),a=n?t.root.findEntityByUUID(n):void 0;return(0,T.jsxs)(et,{children:[(0,T.jsx)(re,{label:`Selected Entity`,children:a?a.name:`-`}),(0,T.jsxs)(re,{label:`Server`,children:[(0,T.jsx)(ae,{onClick:async()=>{try{let e=await(await fetch(`/api/ext/hello`)).json();i(e.message)}catch{i(`failed`)}},children:`GET /api/ext/hello`}),r&&(0,T.jsx)(`p`,{children:r})]})]})},{})},Dm=Object.assign({"../../demo-webgl/editor/Panels/Sample/index.tsx":Tm}),Om=(()=>{let e=[],t=Object.keys(Dm);for(let n=0;n<t.length;n++){let r=Dm[t[n]].panel;r&&e.push(r)}return e})();document.title=`demo-webgl`,wm(),_.createRoot(document.getElementById(`root`)).render((0,T.jsx)(sp,{projectName:`demo-webgl`,sceneData:y,editorData:v,initResourceInstances:ym,panels:Om}));