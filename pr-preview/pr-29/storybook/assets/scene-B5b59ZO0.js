import{a as e,i as t,s as n}from"./preload-helper-BdFrVu1K.js";import{n as r}from"./iframe-iIKVfHB9.js";import{t as i}from"./jsx-runtime-BYwl_lCr.js";import{B as a,Dt as o,E as s,Et as c,Ft as l,G as u,J as ee,K as te,Nt as ne,O as re,Q as d,Qt as ie,S as ae,St as f,U as p,V as m,W as oe,X as h,bt as se,c as ce,ct as le,d as ue,et as g,f as de,ft as fe,gt as pe,h as me,i as he,it as _,jt as ge,kt as v,l as _e,mt as ve,n as ye,nt as be,o as xe,ot as y,s as Se,t as Ce,u as b,ut as we,vt as x,w as Te,wt as S}from"./react-BOSJoq71.js";var C,Ee=t((()=>{C=`#define PI 3.14159265359\r
...
}`})),w,De=t((()=>{w=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),Oe=e({EyeRings:()=>T}),T,ke=t((()=>{u(),Ee(),De(),T=class extends f{constructor(e){super(e);let t=this.engine,n=new be({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new h({phase:[`deferred`,`shadowMap`],frag:C,vert:w,uniforms:t.uniforms});this.entity.addComponent(y,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(y)}}})),E,Ae=t((()=>{E=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),D,je=t((()=>{D=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),Me=e({FlashLine:()=>O}),O,Ne=t((()=>{c(),u(),Ae(),je(),O=class extends f{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new pe({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=o.randomVector().multiply(new l(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new h({phase:[`forward`,`envMap`],frag:g(`flFrag`,E),vert:g(`flVert`,D),uniforms:d.merge(t.uniforms)}),this.entity.addComponent(y,{material:this.material,geometry:this.geometry})}}})),k,Pe=t((()=>{k=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),Fe=e({SkyBox:()=>A}),A,Ie=t((()=>{u(),Pe(),A=class extends f{material;constructor(e){super(e);let t=this.engine;this.material=new h({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:g(`SkyBoxFrag`,k),uniforms:d.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}}})),j,Le=t((()=>{j=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),M,Re=t((()=>{M=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),ze=e({GridCross:()=>N}),N,Be=t((()=>{c(),u(),Le(),Re(),N=class extends f{constructor(e){super(e);let t=new x({width:.05,height:.5,depth:.05}),n=[],r=[],i=new l(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new h({frag:g(`gridCrossFrag`,j),vert:g(`gridCrossVert`,M),phase:[`forward`]});this.entity.addComponent(y,{geometry:t,material:a})}}})),P,Ve=t((()=>{P=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),F,He=t((()=>{F=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),Ue=e({GridDots:()=>I}),I,We=t((()=>{c(),u(),Ve(),He(),I=class extends f{constructor(e){super(e);let t=new fe({radius:.1}),n=[],r=[],i=new l(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new h({frag:g(`gridDotsFrag`,P),vert:g(`gridDotsVert`,F),phase:[`forward`]});this.entity.addComponent(y,{geometry:t,material:a})}}})),L,Ge=t((()=>{L=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
#endif\r
\r
}`})),R,Ke=t((()=>{R=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})),qe=e({WireCube:()=>z}),z,Je=t((()=>{u(),Ge(),Ke(),z=class extends f{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new x({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new h({phase:[`deferred`],frag:L,vert:R,uniforms:d.merge(t.uniforms)});this.entity.addComponent(y,{geometry:i,material:s})}}})),B,Ye=t((()=>{B=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),V,Xe=t((()=>{V=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),Ze=e({OREngineCube:()=>Qe}),Qe,$e=t((()=>{u(),a(),Ye(),Xe(),Qe=class extends f{material;constructor(e){super(e);let t=this.engine;this.material=new h({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:g(`OREngineCubeVert`,V),frag:g(`OREngineCubeFrag`,B),uniforms:d.merge(t.uniforms,{uNoiseTex:{value:m.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(y);n&&(n.material=this.material)}}})),et,tt=t((()=>{et=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),nt,rt=t((()=>{nt=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),it=e({OREngineLogo:()=>at}),at,ot=t((()=>{u(),tt(),rt(),at=class extends f{material;constructor(e){super(e);let t=this.engine;this.material=new h({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:g(`OREngineLogoVert`,nt),frag:g(`OREngineLogoFrag`,et),uniforms:d.merge(t.uniforms)});let n=this.entity.getComponent(y);n&&(n.material=this.material)}}})),st,ct=t((()=>{st=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),lt,ut=t((()=>{lt=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),dt=e({Dust:()=>ft}),ft,pt=t((()=>{c(),u(),ct(),ut(),ft=class extends f{constructor(e){super(e);let t=this.engine,n=new se,r=e.args?.num||2048,i=new l(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new h({phase:[`forward`],drawType:`POINTS`,frag:st,vert:lt,uniforms:d.merge(t.uniforms)});this.entity.addComponent(y,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(y)}}})),mt,ht=t((()=>{mt=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),gt,_t=t((()=>{gt=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),vt,yt=t((()=>{vt=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})),$t,en=t((()=>{Qt(),$t={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:Zt}})),tn,nn=t((()=>{tn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})),rn,an=t((()=>{nn(),rn={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:tn}})),W,on=t((()=>{W=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})),sn,cn=t((()=>{on(),sn={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:W}})),ln,un=t((()=>{on(),ln={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:W}})),dn,fn,pn,mn=t((()=>{en(),an(),cn(),un(),a(),dn=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":$t,"/demo-webgl/Resources/Textures/noise.tex":rn,"/demo-webgl/Resources/Textures/noiseCyclic.tex":sn,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":ln}),fn=()=>{for(let e of Object.values(dn))e&&m.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},pn=e=>{m.resources.buildTextureInstances(e.renderer,e.uniforms)}})),hn,gn,G,K,_n,vn=t((()=>{ke(),Ne(),Ie(),Be(),We(),Je(),$e(),ot(),pt(),St(),ue(),a(),Xt(),mn(),hn=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":Oe,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":Me,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":Fe,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":ze,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":Ue,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":qe,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":Ze,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":it,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":dt,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":bt}),gn=Object.assign({}),G=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);G(a,e)}}},K=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);K(a,e)}}},_n=()=>{S.gltfLoaderFactory=e=>new de(e),m.resources.clear();let e=m.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,le),e.addComponent(`Camera`,we),e.addComponent(`Mesh`,y);let t=Object.keys(H);for(let e=0;e<t.length;e++){let n=t[e],r=H[n],i=m.resources.addComponentGroup(n);G(r,i)}let n=Object.keys(U);for(let e=0;e<n.length;e++){let t=n[e],r=U[t],i=m.resources.addGeometryGroup(t);K(r,i)}let r=p(hn,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=m.resources.addComponentGroup(t);G(n,a)}let a=p(gn,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=m.resources.addGeometryGroup(t);K(n,r)}fn()}})),yn,q,J,Y,bn,xn=t((()=>{yn=n(r(),1),Ce(),vn(),q=i(),_n(),J=({setup:e})=>{let{editor:t}=ie();return(0,yn.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},Y=e=>(0,q.jsx)(ye,{project:e.fixture.scene,onEngineInit:pn,children:(0,q.jsx)(he,{projectName:`storybook`,editorData:e.fixture.editorData,children:(0,q.jsx)(ae,{children:(0,q.jsxs)(s,{children:[e.children,e.fixture.setup&&(0,q.jsx)(J,{setup:e.fixture.setup}),(0,q.jsx)(re,{}),(0,q.jsx)(Te,{})]})})})}),bn=e=>t=>(0,q.jsx)(Y,{fixture:e,children:(0,q.jsx)(t,{})}),Y.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})),X,Z,Sn,Q,$,Cn=t((()=>{X={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`CameraController`,uuid:`sb-camera-controller`}]},Z={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[X,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},Sn={...Z,scene:{name:`root`,uuid:`0`,childs:[X]}},Q={enableRender:!0,resolutionScale:.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},$={scene:Z,editorData:Q}}));export{Z as a,bn as c,$ as i,Q as n,Y as o,Sn as r,xn as s,Cn as t};