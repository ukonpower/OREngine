...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}}})),bi,xi=t((()=>{xr(),bi=class extends br{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}}})),Si=t((()=>{})),Ci=t((()=>{})),I,wi=t((()=>{N(),qn(),yi(),Si(),Ci(),I=class extends vi{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
}`})),ki,Ai=t((()=>{ki=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),ji,Mi=t((()=>{ji=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),Ni,Pi=t((()=>{Ni=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),Fi,Ii=t((()=>{Fi=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),Li,Ri,zi=t((()=>{ir(),N(),L(),qn(),Oi(),Ai(),Mi(),Pi(),Ii(),Li=e=>{let t=[];for(let n=0;n<e;n++){let r=new j;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},Ri=class extends $n{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;ssaoBlurUni;shading;constructor(e){super();let t=e.backend,n=new I(t,{name:`normalSelector`,frag:ji,renderTarget:null,uniforms:di.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),r=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:P.LINEAR,minFilter:P.LINEAR})]),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:P.LINEAR,minFilter:P.LINEAR})]),a=new I(t,{name:`lightShaft`,frag:ki,renderTarget:r,uniforms:di.merge({uLightShaftBackBuffer:{value:i.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:P.LINEAR,minFilter:P.LINEAR})]),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:P.LINEAR,minFilter:P.LINEAR})]),c=new I(t,{name:`ssao`,frag:Ni,renderTarget:ai(`ssao`,o),uniforms:di.merge({uSSAOBackBuffer:{value:s.textures[0],type:`1i`},uSSAOKernel:{value:Li(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),l=di.merge({uSSAOTexture:{value:s.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:Dn.gaussWeights(8)}}),u=new I(t,{name:`ssaoBlur/h`,frag:ai(`ssaoBlur`,Fi),uniforms:l,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),d=new I(t,{name:`ssaoBlur/v`,frag:ai(`ssaoBlur`,Fi),uniforms:di.merge(l,{uSSAOTexture:{value:u.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),f=new I(t,{name:`deferredShading`,frag:ai(`deferredShading`,Di),uniforms:di.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:c.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})});this.postprocess=new bi({passes:[n,a,c,u,d,f]}),this.shading=f,this.lightShaft=a,this.ssao=c,this.rtSSAO1=o,this.rtSSAO2=s,this.ssaoBlur=u,this.ssaoBlurV=d,this.ssaoBlurUni=l,this.rtLightShaft1=r,this.rtLightShaft2=i,this.normalSelector_=n}update(e){let t=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=t,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],t=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=t,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}setRenderCamera(e,t){for(let e=0;e<t.gBuffer.textures.length;e++){let n=t.gBuffer.textures[e];e===1&&(n=t.normalBuffer.textures[0]),this.shading.uniforms[`sampler`+e]=this.ssao.uniforms[`sampler`+e]={type:`1i`,value:n}}this.ssaoBlur.uniforms.uDepthTexture.value=t.gBuffer.textures[0],this.lightShaft.uniforms.uDepthTexture.value=t.gBuffer.depthTexture,this.shading.renderTarget=t.shadingBuffer,this.normalSelector_.renderTarget=t.normalBuffer,this.normalSelector_.uniforms.uNormalTexture.value=t.gBuffer.textures[1],this.normalSelector_.uniforms.uPosTexture.value=t.gBuffer.textures[0],this.normalSelector_.uniforms.uSelectorTexture.value=t.gBuffer.textures[3],this.ssaoBlurUni.uNormalTexture.value=t.normalBuffer.textures[0]}resize(e){this.postprocess.resize(e)}}})),Bi,Vi=t((()=>{Bi=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
}`})),Hi,Ui=t((()=>{Hi=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),Wi,Gi=t((()=>{Wi=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})),Ki,qi=t((()=>{Ki=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),ea,ta=t((()=>{ea=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
}`})),na,ra=t((()=>{na=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),ia,aa=t((()=>{N(),L(),qn(),Vi(),Ui(),Gi(),qi(),Yi(),Zi(),$i(),ta(),ra(),ia=class{dofCoc;dofBokeh;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;_camera;constructor(e){let t=new I(e,{name:`collection`,frag:Bi}),n=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:P.LINEAR,minFilter:P.LINEAR})]),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:P.LINEAR,minFilter:P.LINEAR})]),i=new I(e,{name:`ssr`,frag:ai(`ssr`,na),renderTarget:n,uniforms:di.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`},uSSRBackBuffer:{value:r.textures[0],type:`1i`}}),resolutionRatio:.5,passThrough:!0}),a=new I(e,{name:`ssComposite`,frag:ai(`ssComposite`,ea),uniforms:di.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSSRTexture:{value:r.textures[0],type:`1i`}})}),o=new j(10,.05,20,.05),s=new I(e,{name:`dof/coc`,frag:Wi,uniforms:di.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:o,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:P.LINEAR,minFilter:P.LINEAR,internalFormat:P.RGBA16F,type:P.HALF_FLOAT,format:P.RGBA})]),passThrough:!0,resolutionRatio:.5}),c=new I(e,{name:`dof/bokeh`,frag:Hi,uniforms:di.merge({uCocTex:{value:s.renderTarget.textures[0],type:`1i`},uParams:{value:o,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:P.LINEAR,minFilter:P.LINEAR})]),passThrough:!0,resolutionRatio:.5}),l=new I(e,{name:`dof/composite`,frag:Ki,uniforms:di.merge({uBokeTex:{value:c.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:P.LINEAR,minFilter:P.LINEAR,internalFormat:P.RGBA16F,type:P.HALF_FLOAT,format:P.RGBA})])}),u=new I(e,{name:`motionBlurTile`,frag:Qi,uniforms:di.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:P.FLOAT,internalFormat:P.RGBA32F,format:P.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),d=new I(e,{name:`motionBlurNeighbor`,frag:Xi,uniforms:di.merge({uVelTex:{value:u.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:P.FLOAT,internalFormat:P.RGBA32F,format:P.RGBA})]),resolutionRatio:1/16,passThrough:!0}),f=new I(e,{name:`motionBlur`,frag:Ji,uniforms:di.merge({uVelNeighborTex:{value:d.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16}});this.postprocess=new bi({passes:[t,i,a,s,c,l,u,d,f]}),this._ssr=i,this._ssComposite=a,this.dofCoc=s,this.dofBokeh=c,this.dofComposite=l,this._motionBlur=f,this._motionBlurTile=u,this._motionBlurNeighbor=d,this._dofParams=o,this.rtSSR1=n,this.rtSSR2=r,this._camera=null}update(e){if(!this._camera)return;let t=this._camera.fov,n=this._camera.dofParams.focusDistance,r=this._camera.dofParams.kFilmHeight,i=r/Math.tan(.5*(t/180*Math.PI)),a=1/this.dofBokeh.renderTarget.size.y*5,o=1/a,s=i*i/(this._camera.dofParams.fNumber*(n-i)*r*2);this._dofParams.set(n,a,o,s);let c=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=c,this._ssr.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssr.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}setRenderCamera(e,t){this._camera=e,this.postprocess.passes[0]&&(this.postprocess.passes[0].backBufferOverride=t.shadingBuffer.textures),this._ssr.uniforms.uGbufferPos.value=t.gBuffer.textures[0],this._ssr.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],this._ssr.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],this._ssComposite.uniforms.uGbufferPos.value=t.gBuffer.textures[0],this._ssComposite.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],this.dofCoc.uniforms.uGbufferPos.value=t.gBuffer.textures[0],this._motionBlurTile.uniforms.uVelTex.value=t.gBuffer.textures[4],this._motionBlur.uniforms.uVelTex.value=t.gBuffer.textures[4],this._motionBlur.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}}})),oa,sa=t((()=>{oa=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})),ca,la=t((()=>{ir(),N(),L(),qn(),sa(),ca=class extends $n{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:P.FLOAT,internalFormat:P.RGBA16F,format:P.RGBA,magFilter:P.LINEAR,minFilter:P.LINEAR,wrapS:P.CLAMP_TO_EDGE,wrapT:P.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new j(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:P.FLOAT,internalFormat:P.RGBA16F,format:P.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:P.FLOAT,internalFormat:P.RGBA16F,format:P.RGBA})])});let m=1/4*l,h=new I(e,{renderTarget:s[l].rt1,frag:oa,uniforms:di.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new j(d,f));let g=new I(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new bi({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}}})),ua,da=t((()=>{ua=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}}})),fa,pa=t((()=>{fa=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	vUv = uv;\r
\r
}`,renderTarget:r,uniforms:di.merge(t.uniforms,a,{uDeltaTime:{value:0,type:`1f`}})}),this.size=t.size,this.layerCnt=t.dataLayerCount,this.rt1=r,this.rt2=i,this.renderTarget=this.rt1,this.clearColor=t.clearColor??null,this.outputUniforms=a}onAfterRender(){super.onAfterRender();for(let e=0;e<this.layerCnt;e++)this.outputUniforms[`uGPUSampler`+e].value=this.renderTarget.textures[e];let e=this.rt1;this.rt1=this.rt2,this.rt2=e,this.renderTarget=this.rt1}initTexture(e){for(let t=0;t<this.layerCnt;t++){let n=[];for(let r=0;r<this.size.y;r++)for(let i=0;i<this.size.x;i++){let a=i,o=r;n.push(...e(t,a,o))}this.rt2.textures[t].subImage(new Float32Array(n),this.size.x,this.size.y)}}}})),Fa=t((()=>{Gn(),N(),Vr(),qn(),yi(),xi(),wi()})),Ia=t((()=>{ir(),Vr(),Tr(),yi()})),La=t((()=>{N(),xi(),qn(),wi()})),Ra=t((()=>{xi(),wi()})),za=t((()=>{xi(),wi()})),Ba=t((()=>{xi(),wi()})),Va=t((()=>{hi(),La(),Ra(),za(),Ba()})),L=t((()=>{qn(),Qn(),pi(),ka(),yi(),ja(),Pa(),hi(),zi(),da(),Fa(),Ia(),xi(),wi(),Va(),Ei()})),Ha,Ua=t((()=>{Ha=class{static serializeEntity(e,t){let n=e=>{let r=[];e.children.forEach(e=>{e.initiator!=`script`&&r.push(n(e))});let i=[];e.components.forEach(e=>{let n=e.serialize({mode:`export`}),r=Object.keys(n).length>0;if(e.initiator!==`user`)return;let a={name:t.getName(e),uuid:e.uuid};r&&(a.props=n),i.push(a)});for(let t of e.unresolvedComponents)i.push({name:t.name,uuid:t.uuid,props:t.props});return{name:e.name,uuid:e.uuid,pos:e.position.x==0&&e.position.y==0&&e.position.z==0?void 0:e.position.getElm(`vec3`),rot:e.euler.x==0&&e.euler.y==0&&e.euler.z==0?void 0:e.euler.getElm(`vec3`),scale:e.scale.x==1&&e.scale.y==1&&e.scale.z==1?void 0:e.scale.getElm(`vec3`),components:i.length>0?i:void 0,childs:r.length>0?r:void 0}};return n(e)}static deserializeEntity(e,t,n,r){let i=(e,t)=>{let a=t||r.createEntity();a.initiator=`user`,a.name=e.name,a.restoreUUID(e.uuid);let o=e.pos||[0,0,0];a.position.x=o[0],a.position.y=o[1],a.position.z=o[2];let s=e.rot||[0,0,0];a.euler.x=s[0],a.euler.y=s[1],a.euler.z=s[2];let c=e.scale||[1,1,1];return a.scale.x=c[0],a.scale.y=c[1],a.scale.z=c[2],a.unresolvedComponents=[],e.components&&e.components.forEach(e=>{let t=n.resolve(e.name);if(t){let n=a.getComponent(t.component);n||(n=a.addComponent(t.component),n.initiator=`user`),n.restoreUUID(e.uuid),e.props&&n.deserialize(e.props)}else console.warn(`[ProjectSerializer] Component "${e.name}" not found in resolver. Preserving data for round-trip.`),a.unresolvedComponents.push({name:e.name,uuid:e.uuid,props:e.props})}),e.childs&&([...a.children].forEach(e=>{e.initiator!==`script`&&a.remove(e)}),e.childs.forEach(e=>{a.add(i(e))})),a};e&&i(e,t),t.initiator=`god`}}})),Wa,Ga=t((()=>{L(),Wa=class extends br{name;_frag;_resolution;_filter;_updateEveryFrame;_textures;constructor(e,t){super(),this.name=e;let n=t.data;this._frag=n?.frag||``,this._resolution=n?.resolution||[1024,1024],this._filter=n?.filter||`linear`,this._updateEveryFrame=n?.updateEveryFrame??!1,this._textures=n?.textures||{}}get frag(){return this._frag}get resolution(){return this._resolution}get filter(){return this._filter}get updateEveryFrame(){return this._updateEveryFrame}get textures(){return this._textures}}})),Ka,qa=t((()=>{Ka=(e,t)=>{let n={},r=`/${t}/`;for(let[t,i]of Object.entries(e)){let e=t.slice(t.lastIndexOf(r)+r.length).split(`/`).slice(0,-2),a=Object.entries(i).find(([e,t])=>typeof t==`function`&&/^[A-Z]/.test(e));if(!a)continue;let o=n;for(let t of e)o=o[t]=o[t]||{};o[a[0]]=a[1]}return n}})),Ja,Ya=t((()=>{ir(),N(),Ga(),qa(),Ja=class extends $n{_componentList;_componentGroups;_geometryList;_geometryGroups;_textureResources;_textures;_updateEveryFrameTextures;constructor(){super(),this._componentList=[],this._textures=new Map,this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources=new Map,this._updateEveryFrameTextures=[]}get componentList(){return this._componentList}get componentGroups(){return this._componentGroups}get geometryList(){return this._geometryList}get geometryGroups(){return this._geometryGroups}get textureList(){return Array.from(this._textureResources.values())}get textures(){return this._textures}get updateEveryFrameTextures(){return this._updateEveryFrameTextures}clear(){this._componentList=[],this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources.clear(),this._textures.clear(),this._updateEveryFrameTextures=[],this.emit(`update`)}getComponent(e){return this._componentList.find(t=>t.name==e)}addComponentGroup(e){let t=this._componentGroups.find(t=>t.name==e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addComponent:(e,n)=>{let r={name:e,component:n};t.push(r),this._componentList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._componentGroups.push(t),this.emit(`update`),t}getGeometry(e){return this._geometryList.find(t=>t.name===e)}addGeometryGroup(e){let t=this._geometryGroups.find(t=>t.name===e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addGeometry:(e,n)=>{let r={name:e,geometryClass:n};t.push(r),this._geometryList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._geometryGroups.push(t),this.emit(`update`),t}addTextureResource(e,t){let n=new Wa(e,{data:t});this._textureResources.set(e,n),this.emit(`update`)}getTextureResource(e){return this._textureResources.get(e)}removeTextureResource(e){this._textureResources.delete(e);let t=this._textures.get(e);t&&(t.dispose(),this._textures.delete(e)),this.emit(`update`)}addTexture(e,t){return this._textures.set(e,t),t}getTexture(e){return this._textures.get(e)}_buildTexture(e,t,n,r){let i=e.frag;return i?t.createTexProcedural({name:e.name,frag:i,resolution:new j(e.resolution[0]||1024,e.resolution[1]||1024),filter:e.filter,textures:n,uniforms:e.updateEveryFrame?r:void 0}):null}_ensureTexture(e,t,n,r){let i=this._textures.get(e.name);if(i)return i;if(r.has(e.name))return null;r.add(e.name);let a={},o=e.textures,s=Object.keys(o);for(let e=0;e<s.length;e++){let i=s[e],c=o[i],l=this._textureResources.get(c),u=l?this._ensureTexture(l,t,n,r):this._textures.get(c);u&&(a[i]=u)}let c=this._buildTexture(e,t,a,n);return c?(this._textures.set(e.name,c),e.updateEveryFrame&&this._updateEveryFrameTextures.push(c),c):null}buildTextureInstances(e,t){this._updateEveryFrameTextures=[];let n=new Set;this._textureResources.forEach(r=>{this._ensureTexture(r,e,t,n)}),this.emit(`update`)}}})),Xa,Za=t((()=>{N(),L(),Ua(),Ya(),Xa=class e extends br{static resources;name;enableRender;_renderer;_root;_uniforms;_time;_frame;_frameSetting;_disposed;_cameraEntity;constructor(e){super(),this.name=`OREngine`,this._disposed=!1,this._uniforms={uEnvMapIntensity:{value:1,type:`1f`}},this._renderer=e(this),this._renderer.globalUniforms={uTime:{value:0,type:`1f`},uTimeF:{value:0,type:`1f`},uTimeE:{value:0,type:`1f`},uTimeEF:{value:0,type:`1f`},uDeltaTime:{value:0,type:`1f`},uResolution:{value:new j,type:`2fv`},uAspectRatio:{value:1,type:`1f`}},this._time={current:new Date().getTime(),engine:0,delta:0,code:0},this._frameSetting={duration:600,fps:30},this._frame={current:0,playing:!1},this.seek(0),this.enableRender=!0,this._cameraEntity=null,this._root=this.createEntity({name:`root`}),this._root.initiator=`god`,this.field(`name`,()=>this.name,e=>this.name=e),this.field(`scene`,()=>Ha.serializeEntity(this._root,this._createComponentResolver()),e=>{Ha.deserializeEntity(e,this._root,this._createComponentResolver(),this)}),this.field(`renderer`,()=>this._renderer.serialize({mode:`export`}),e=>this._renderer.deserialize(e));let t=this.fieldDir(`timeline`);t.field(`duration`,()=>this._frameSetting.duration,e=>this._frameSetting.duration=e),t.field(`fps`,()=>this._frameSetting.fps,e=>this._frameSetting.fps=e)}createEntity(e){return new Qr({engine:this,...e})}get canvas(){return this._renderer.canvas}get renderer(){return this._renderer}get root(){return this._root}get frame(){return this._frame}get time(){return this._time}get frameSetting(){return this._frameSetting}get uniforms(){return this._uniforms}get disposed(){return this._disposed}set cameraEntity(e){this._cameraEntity=e}get cameraEntity(){return this._cameraEntity}resolveCameraEntity(){return this._cameraEntity||this.findSceneCameraEntity()}_createComponentResolver(){return{resolve:t=>e.resources.getComponent(t),getName:t=>{let n=e.resources.componentList.find(e=>t instanceof e.component);return n?n.name:t.constructor.name}}}init(){this._root.disposeRecursive(),this._root.position.set(0,0,0),this._root.euler.set(0,0,0),this._root.scale.set(1,1,1),this.name=`New Project`}async load(e){this.init(),this.deserialize(e),this.emit(`update/graph`),this.emit(`loaded`)}update(t){let n=new Date().getTime();this._time.delta=(n-this._time.current)/1e3,this._time.current=n,this._time.engine+=this._time.delta,this._time.code+=this._time.delta*+!!this._frame.playing,this._frame.current=this._time.code*60;let r=this.createEntityUpdateEvent({forceDraw:t?.forceDraw});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1,this._renderer.globalUniforms.uDeltaTime.value=Math.min(this._time.delta,1/60);let i=e.resources.updateEveryFrameTextures;for(let e=0;e<i.length;e++)i[e].render();if(this._root.update(r),this._root.postUpdate(r),this._root.updateMatrixRecursive(),this._root.prepareRender(r),this.enableRender){let e=this.resolveCameraEntity();e&&this._renderer.render(this._root,e,r)}return this._root.commitFrame(r),this._frame.playing&&this.emit(`update/frame/play`,[this._frame]),this._time.delta}createEntityUpdateEvent(e){let t={playing:this._frame.playing,timeElapsed:this._time.engine,timeDelta:this._time.delta,timeCode:this._time.code,timeCodeFrame:this._frame.current,resolution:this.renderer.resolution,renderer:this.renderer,forceDraw:!1};return e?{...t,...e}:t}setSize(e){this._renderer.resize(e),this._renderer.canvas.width=e.x,this._renderer.canvas.height=e.y,this._renderer.globalUniforms.uResolution.value.copy(e),this._renderer.globalUniforms.uAspectRatio.value=e.x/Math.max(e.y,1)}play(){this._frame.playing=!0,this._time.current=new Date().getTime()}stop(){this._frame.playing=!1}seek(e){this._time.code=e/60,this._frame.current=e,this.emit(`update/frame/play`,[this._frame])}updateOffline(t,n){let r=t/n,i=1/n;this._time.delta=i,this._time.current=new Date().getTime(),this._time.engine+=i,this._time.code=r,this._frame.current=r*60,this._frame.playing=!0;let a=this.createEntityUpdateEvent({forceDraw:!0});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1;let o=e.resources.updateEveryFrameTextures;for(let e=0;e<o.length;e++)o[e].render();if(this._root.update(a),this._root.postUpdate(a),this._root.updateMatrixRecursive(),this._root.prepareRender(a),this.enableRender){let e=this.resolveCameraEntity();e&&this._renderer.render(this._root,e,a)}this._root.commitFrame(a)}compileShaders(e){let t=this.createEntityUpdateEvent({forceDraw:!0}),n=this.resolveCameraEntity();return n?this.renderer.compileShaders(this._root,n,t,e):Promise.resolve()}findSceneCameraEntity(){let e=null;return this._root.traverse(t=>{if(e)return;let n=t.getComponentsByTag(`camera`);for(let r=0;r<n.length;r++)if(n[r].displayOut){e=t;return}}),e}dispose(){this._disposed=!0,this._root.disposeRecursive()}},Xa.resources=new Ja})),Qa,$a=t((()=>{ir(),Qa=class extends $n{_pressedKeys;constructor(){super(),this._pressedKeys={};let e=this._onKeyDown.bind(this),t=this._onKeyUp.bind(this);window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,t),this.once(`dispose`,()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,t)})}get pressedKeys(){return this._pressedKeys}_onKeyDown(e){this._pressedKeys[e.key]=!0,this.emit(`keydown`,[e,this._pressedKeys])}_onKeyUp(e){if(this._pressedKeys[e.key]=!1,e.key==`Meta`||e.key==`Control`){let e=Object.keys(this._pressedKeys);for(let t=0;t<e.length;t++)this._pressedKeys[e[t]]=!1}this.emit(`keyup`,[e,this._pressedKeys])}dispose(){this.emit(`dispose`)}}})),eo,to=t((()=>{ir(),N(),eo=class extends $n{_isTouching;element=null;position;delta;constructor(){super(),this.position=new j(NaN,NaN),this.delta=new j(NaN,NaN),this._isTouching=!1;let e=this._onPointer.bind(this,`move`),t=this._onPointer.bind(this,`end`);window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`dragend`,t);let n=()=>{this.element&&this.removeElement(this.element),window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`dragend`,t),this.off(`dispose`,n)};this.on(`dispose`,n)}setElement(e){this.element&&this.removeElement(this.element),this.element=e;let t=this._onPointer.bind(this,`start`);e.addEventListener(`pointerdown`,t);let n=r=>{e.isEqualNode(r.elm)&&(e.removeEventListener(`pointerdown`,t),this.off(`unregister`,n))};this.on(`unregister`,n)}removeElement(e){this.emit(`unregister`,[e])}getScreenPosition(e){if(this.position.x!=this.position.x)return new j(NaN,NaN);let t=this.position.clone().divide(e).multiply(2).sub(1);return t.y*=-1,t}getRelativePosition(e,t){let n=e.getClientRects()[0],r=this.position.x-n.left,i=this.position.y-n.top;return t&&(r/=n.width,i/=n.height),new j(r,i)}_setPos(e,t){this.position.x!==this.position.x||this.position.y!==this.position.y?this.delta.set(0,0):this.delta.set(e-this.position.x,t-this.position.y),this.position.set(e,t)}_onPointer(e,t){let n=t.pointerType;(n==null||n==`mouse`&&(t.button==-1||t.button==0)||n==`touch`)&&this._touchEventHandler(t.pageX,t.pageY,e,t)}_touchEventHandler(e,t,n,r){let i=!1,a=e-window.pageXOffset,o=t-window.pageYOffset;n==`start`?(this._isTouching=!0,this._setPos(a,o),this.delta.set(0,0),i=!0):n==`move`?(this._setPos(a,o),this._isTouching&&(i=!0)):n==`end`&&(`targetTouches`in r?r.targetTouches.length==0&&(this._isTouching=!1):this._isTouching=!1,i=!0),i&&this.emit(n,[{pointerEvent:r,position:this.position.clone(),delta:this.delta.clone()}])}dispose(){this.emit(`dispose`)}}})),no=t((()=>{Za(),Ya(),Ua(),$a(),to()})),ro=t((()=>{no()})),io,ao,oo=t((()=>{io=r(i(),1),ao=(0,io.createContext)(null)})),so,co,lo=t((()=>{so=r(i(),1),oo(),co=()=>{let e=(0,so.useContext)(ao);if(e===null)throw Error(`useMouseMenu must be used within a MouseMenuProvider`);return e}})),uo,fo,po=t((()=>{uo=r(i(),1),fo=(0,uo.createContext)(void 0)})),mo,ho,go=t((()=>{mo=r(i(),1),po(),ho=()=>(0,mo.useContext)(fo)})),_o,vo,yo,bo,xo,So=t((()=>{_o=`ComponentAdd__compoAdd___LmNvb`,vo=`ComponentAdd__directory___LmNvb`,yo=`ComponentAdd__subDirectory___LmNvb`,bo=`ComponentAdd__picker___LmNvb`,xo={compoAdd:_o,directory:vo,subDirectory:yo,picker:bo}})),Co,wo,To,Eo,Do=t((()=>{Co=r(i(),1),ro(),d(),O(),lo(),go(),So(),wo=c(),To=({group:e,onClickAdd:t})=>{let n=ho(),[r,i]=(0,Co.useState)(!1),a=null,o,s=`dir`,c=e.name.startsWith(`_`)?e.name.slice(1):e.name;`child`in e?a=(0,wo.jsx)(wo.Fragment,{children:e.child.map((e,n)=>(0,wo.jsx)(To,{group:e,onClickAdd:t},n))}):(o=()=>t(e),s=`item`);let l=window.matchMedia(`(hover: hover)`).matches;return(0,wo.jsxs)(`div`,{className:xo.directory,onPointerEnter:l?()=>i(!0):void 0,onPointerLeave:l?()=>i(!1):void 0,onClick:e=>{o?o():(e.stopPropagation(),i(!r))},"data-type":s,"data-direction":n?.direction,children:[c,r&&(0,wo.jsx)(`div`,{className:xo.subDirectory,children:a})]})},Eo=e=>{let{editor:t}=D(),{pushContent:n,closeAll:r}=co(),i=Xa.resources,a=(0,Co.useCallback)(a=>{if(!i||!n||!r)return;let o=[],s=n=>{t.api.addComponent(e.entity,n.component),r()};i.componentGroups.forEach((e,t)=>{o.push((0,wo.jsx)(To,{group:e,onClickAdd:s},t))}),n((0,wo.jsx)(`div`,{className:xo.picker,children:o}))},[n,i,e.entity,r,t]);return(0,wo.jsx)(`div`,{className:xo.compAdd,children:(0,wo.jsx)(f,{onClick:a,children:`Add Component`})})},Eo.__docgenInfo={description:``,methods:[],displayName:`ComponentAdd`,props:{entity:{required:!0,tsType:{name:`MXP.Entity`},description:``}}}})),Oo,ko,Ao,jo,Mo,No,Po=t((()=>{Oo=`ComponentView__compoView___LmNvb`,ko=`ComponentView__head___LmNvb`,Ao=`ComponentView__name___LmNvb`,jo=`ComponentView__check___LmNvb`,Mo=`ComponentView__propertyBlock___LmNvb`,No={compoView:Oo,head:ko,name:Ao,check:jo,delete:`ComponentView__delete___LmNvb`,propertyBlock:Mo}})),Fo,Io,Lo,Ro,zo=t((()=>{Fo=r(i(),1),l(),te(),O(),yn(),bn(),Po(),Io=c(),Lo=e=>{let t=Object.keys(e.childs);for(let n=0;n<t.length;n++){let r=e.childs[t[n]],{opt:i}=r,a=!1;if(i&&(a=typeof i.hidden==`function`?i.hidden(r.type===`value`?r.value:null):i.hidden||!1),!a&&(r.type===`value`||Lo(r)))return!0}return!1},Ro=({component:e})=>{let{editor:t}=D(),[n,r]=A(e,`enabled`),i=e.initiator!==`user`,a=Lo(e.serializeToDirectory()),o=(0,Fo.useCallback)(n=>{n.stopPropagation();let r=e.entity;if(r){for(let[n,i]of r.components)if(i.uuid===e.uuid){t.api.removeComponent(r,n,e);break}}},[e,t]),s=(0,Io.jsxs)(`div`,{className:No.head,children:[(0,Io.jsx)(`div`,{className:No.name,children:e.constructor.name}),(0,Io.jsx)(`div`,{className:No.delete,children:(0,Io.jsx)(`button`,{onClick:o,children:(0,Io.jsx)(ee,{})})})]});return(0,Io.jsx)(`div`,{className:No.compoView,"data-disable_component":i,children:(0,Io.jsx)(`div`,{className:No.content,children:(0,Io.jsx)(u,{label:s,accordion:a,bg:!0,defaultClose:!1,children:a&&(0,Io.jsx)(vn,{target:e})})})})},Ro.__docgenInfo={description:``,methods:[],displayName:`ComponentView`,props:{component:{required:!0,tsType:{name:`MXP.Component`},description:``}}}})),Bo,Vo,Ho=t((()=>{Bo=`ComponentList__container___LmNvb`,Vo={container:Bo}})),Uo,Wo,Go,Ko=t((()=>{Uo=r(i(),1),bn(),zo(),Ho(),Wo=c(),Go=({entity:e})=>{let[t]=A(e,`components`),n=(0,Uo.useMemo)(()=>{let n=[];return t?(t.forEach(t=>{let r=e.getComponentByUUID(t);r&&n.push((0,Wo.jsx)(Ro,{component:r},r.uuid))}),n):null},[t,e]);return(0,Wo.jsx)(`div`,{className:Vo.container,children:n})},Go.__docgenInfo={description:``,methods:[],displayName:`ComponentList`}})),qo,Jo,Yo,Xo=t((()=>{qo=r(i(),1),l(),O(),yn(),bn(),Do(),Ko(),Jo=c(),Yo=()=>{let{editor:e,engine:t}=D(),[n]=A(e,`selectedEntityId`),r=(0,qo.useMemo)(()=>{if(n)return t.root.findEntityByUUID(n)},[t,n]);return r?(0,Jo.jsxs)(Jo.Fragment,{children:[(0,Jo.jsx)(u,{label:`Fields`,accordion:!0,children:(0,Jo.jsx)(vn,{target:r})}),(0,Jo.jsxs)(u,{label:`Components`,accordion:!0,children:[(0,Jo.jsx)(Go,{entity:r}),(0,Jo.jsx)(Eo,{entity:r})]})]}):null},Yo.__docgenInfo={description:``,methods:[],displayName:`EntityProperty`}})),Zo,Qo,$o=t((()=>{Zo=r(i(),1),Qo=(0,Zo.createContext)(null)})),es,ts,ns=t((()=>{es=r(i(),1),$o(),ts=()=>{let e=(0,es.useContext)(Qo);if(e===null)throw Error(`useOREngine must be used within a OREngineProvider`);return e}})),rs,is,as,os,ss,cs,ls,us,ds,fs,ps,ms,hs,gs,_s,vs,ys,bs,R,xs=t((()=>{rs=`GPUTimer__container___LmNvb`,is=`GPUTimer__headerRow___LmNvb`,as=`GPUTimer__totalTime___LmNvb`,os=`GPUTimer__toggleButton___LmNvb`,ss=`GPUTimer__controls___LmNvb`,cs=`GPUTimer__control___LmNvb`,ls=`GPUTimer__controlLabel___LmNvb`,us=`GPUTimer__select___LmNvb`,ds=`GPUTimer__input___LmNvb`,fs=`GPUTimer__group___LmNvb`,ps=`GPUTimer__item___LmNvb`,ms=`GPUTimer__clickable___LmNvb`,hs=`GPUTimer__itemRow___LmNvb`,gs=`GPUTimer__itemName___LmNvb`,_s=`GPUTimer__itemTime___LmNvb`,vs=`GPUTimer__itemStats___LmNvb`,ys=`GPUTimer__progressBar___LmNvb`,bs=`GPUTimer__progressFill___LmNvb`,R={container:rs,headerRow:is,totalTime:as,toggleButton:os,controls:ss,control:cs,controlLabel:ls,select:us,input:ds,group:fs,item:ps,clickable:ms,itemRow:hs,itemName:gs,itemTime:_s,itemStats:vs,progressBar:ys,progressFill:bs}})),Ss,Cs,ws=t((()=>{Ss=class{buffer;index;size;filled;constructor(e){this.size=e,this.buffer=Array(e),this.index=0,this.filled=!1}push(e){this.buffer[this.index]=e,this.index=(this.index+1)%this.size,!this.filled&&this.index===0&&(this.filled=!0)}getAverage(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=0;for(let n=0;n<e;n++)t+=this.buffer[n];return t/e}getMax(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]>t&&(t=this.buffer[n]);return t}getMin(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]<t&&(t=this.buffer[n]);return t}getCount(){return this.filled?this.size:this.index}},Cs=class{buffers;windowSize;currentData;constructor(e=30){this.windowSize=e,this.buffers=new Map,this.currentData=new Map}update(e){let t=performance.now();for(let n=0;n<e.length;n++){let r=e[n],i=r.name.split(`/`),a=i[0]||`unknown`,o,s=i[i.length-1],c=s&&s.match(/\[([^\]]+)\]/);c&&(o=c[1]);let l={name:r.name,duration:r.duration,timestamp:t,renderType:a},u=this.buffers.get(r.name);u||(u=new Ss(this.windowSize),this.buffers.set(r.name,u)),u.push(r.duration),this.currentData.set(r.name,{...l,entityId:o})}}getStatistics(){let e=[],t=0,n=performance.now(),r=[];return this.currentData.forEach((e,t)=>{n-e.timestamp>1e3&&r.push(t)}),r.forEach(e=>{this.currentData.delete(e)}),this.currentData.forEach(e=>{t+=e.duration}),this.currentData.forEach(n=>{let r=this.buffers.get(n.name);r&&e.push({name:n.name,renderType:n.renderType,entityId:n.entityId,current:n.duration,avg:r.getAverage(),max:r.getMax(),min:r.getMin(),samples:r.getCount(),percentage:t>0?n.duration/t*100:0})}),e}getTotalTime(){let e=0;return this.currentData.forEach(t=>{e+=t.duration}),e}}})),Ts,z,Es,Ds,Os,ks,As=t((()=>{Ts=r(i(),1),ns(),O(),xs(),ws(),z=c(),Es=e=>{if(e<2){let t=e/2;return`rgb(${Math.floor(100+t*100)}, 200, 100)`}else if(e<5){let t=(e-2)/3;return`rgb(200, ${Math.floor(200-t*50)}, 100)`}else if(e<10){let t=(e-5)/5;return`rgb(200, ${Math.floor(150-t*80)}, ${Math.floor(100-t*50)})`}else return`rgb(200, 70, 50)`},Ds=e=>e>=10?e.toFixed(1):e>=1?e.toFixed(2):e.toFixed(3),Os=e=>e.replace(/\[([^\]]{4,})\]/g,(e,t)=>`[${t.slice(0,3)}]`),ks=()=>{let{editor:e}=D(),{engine:t}=ts(),[n,r]=(0,Ts.useState)([]),[i,a]=(0,Ts.useState)(0),[o,s]=(0,Ts.useState)(`all`),[c,l]=(0,Ts.useState)(0),[u,d]=(0,Ts.useState)(`time`),[f,p]=(0,Ts.useState)(!1),m=(0,Ts.useRef)(new Cs(30)),h=(0,Ts.useRef)(0),g=(0,Ts.useRef)(!1),_=(0,Ts.useRef)(0),v=(0,Ts.useCallback)(n=>{if(!n)return;let r=t.root.findEntityByUUID(n);r&&e.selectEntity(r)},[t,e]);(0,Ts.useEffect)(()=>{let e=t.renderer,n=m.current,i=e=>{f&&(n.update(e),g.current=!0)},o=e=>{g.current&&e-_.current>=300&&(r(n.getStatistics()),a(n.getTotalTime()),g.current=!1,_.current=e),h.current=requestAnimationFrame(o)};return e.on(`timer`,i),h.current=requestAnimationFrame(o),()=>{e.off(`timer`,i),cancelAnimationFrame(h.current)}},[t,f]);let y=n.filter(e=>!(o!==`all`&&e.renderType!==o||e.avg<c)),b=Array.from(new Set(n.map(e=>e.renderType))),x=[...y].sort((e,t)=>u===`time`?t.avg-e.avg:e.name.localeCompare(t.name)),S=i>0?Math.floor(1e3/i):0;return(0,z.jsxs)(`div`,{className:R.container,children:[(0,z.jsxs)(`div`,{className:R.headerRow,children:[(0,z.jsxs)(`span`,{className:R.totalTime,children:[Ds(i),`ms (`,S,`fps)`]}),(0,z.jsx)(`button`,{className:R.toggleButton,onClick:()=>p(!f),title:f?`Stop timer`:`Start timer`,children:f?`⏸`:`▶`})]}),(0,z.jsxs)(`div`,{className:R.controls,children:[(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Type`}),(0,z.jsxs)(`select`,{className:R.select,value:o,onChange:e=>s(e.target.value),children:[(0,z.jsx)(`option`,{value:`all`,children:`All`}),b.map(e=>(0,z.jsx)(`option`,{value:e,children:e},e))]})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Min`}),(0,z.jsx)(`input`,{className:R.input,type:`number`,min:`0`,step:`0.1`,value:c,onChange:e=>l(parseFloat(e.target.value)||0)})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Sort`}),(0,z.jsxs)(`select`,{className:R.select,value:u,onChange:e=>d(e.target.value),children:[(0,z.jsx)(`option`,{value:`time`,children:`Time`}),(0,z.jsx)(`option`,{value:`name`,children:`Name`})]})]})]}),(0,z.jsx)(`div`,{className:R.group,children:x.map((e,t)=>{let n=Es(e.avg),r=i>0?e.avg/i*100:0,a=!!e.entityId;return(0,z.jsxs)(`div`,{className:`${R.item} ${a?R.clickable:``}`,onClick:()=>v(e.entityId),children:[(0,z.jsxs)(`div`,{className:R.itemRow,children:[(0,z.jsx)(`span`,{className:R.itemName,title:e.name,children:Os(e.name)}),(0,z.jsx)(`span`,{className:R.itemTime,style:{color:n},children:Ds(e.avg)}),(0,z.jsx)(`span`,{className:R.itemStats,children:Ds(e.max)})]}),(0,z.jsx)(`div`,{className:R.progressBar,children:(0,z.jsx)(`div`,{className:R.progressFill,style:{width:`${r}%`,backgroundColor:n}})})]},e.name+t)})})]})},ks.__docgenInfo={description:``,methods:[],displayName:`Timer`}})),js,Ms,Ns,Ps,Fs,Is,Ls=t((()=>{js=`Picker__picker___LnBpY`,Ms=`Picker__picker_label___LnBpY`,Ns=`Picker__picker_list___LnBpY`,Ps=`Picker__picker_list_inner___LnBpY`,Fs=`Picker__item___LnBpY`,Is={picker:js,picker_label:Ms,picker_list:Ns,picker_list_inner:Ps,item:Fs}})),Rs,zs,Bs=t((()=>{Ls(),Rs=c(),zs=e=>(0,Rs.jsxs)(`div`,{className:Is.picker,"data-no_bg":e.noBg,children:[e.label&&(0,Rs.jsx)(`div`,{className:Is.picker_label,children:e.label}),(0,Rs.jsx)(`div`,{className:Is.picker_list,children:(0,Rs.jsx)(`div`,{className:Is.picker_list_inner,children:e.list.map((e,t)=>(0,Rs.jsx)(`div`,{className:Is.item,onClick:e.onClick,children:e.label},t))})})]}),zs.__docgenInfo={description:``,methods:[],displayName:`Picker`,props:{label:{required:!1,tsType:{name:`string`},description:``},list:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
	label: string,
	onClick?: () => void
}`,signature:{properties:[{key:`label`,value:{name:`string`,required:!0}},{key:`onClick`,value:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}},required:!1}}]}}],raw:`SelectListItem[]`},description:``},noBg:{required:!1,tsType:{name:`boolean`},description:``}}}})),Vs,Hs,Us,Ws=t((()=>{Vs=`InputGroup__group___Lmdyb`,Hs=`InputGroup__submit___Lmdyb`,Us={group:Vs,submit:Hs}})),Gs,Ks,qs,Js=t((()=>{Gs=r(i(),1),l(),d(),Tt(),Ws(),Ks=c(),qs=e=>{let t=e.initialValues,n=[],[r,i]=(0,Gs.useState)(t);(0,Gs.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,Ks.jsx)(k,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,Gs.useRef)(null);return(0,Gs.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,Ks.jsx)(`div`,{className:Us.group,ref:o,children:(0,Ks.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,Ks.jsx)(u,{label:e.title,noMargin:!0,children:n}),(0,Ks.jsx)(`div`,{className:Us.submit,children:(0,Ks.jsx)(f,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},qs.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})),Ys,Xs,Zs,Qs,$s,ec,tc,nc,rc,ic,ac,oc,sc=t((()=>{Ys=`HierarchyNode__node___Lm5vZ`,Xs=`HierarchyNode__self___Lm5vZ`,Zs=`HierarchyNode__self_name___Lm5vZ`,Qs=`HierarchyNode__icon___Lm5vZ`,$s=`HierarchyNode__selectable___Lm5vZ`,ec=`HierarchyNode__visibility___Lm5vZ`,tc=`HierarchyNode__menu___Lm5vZ`,nc=`HierarchyNode__fold___Lm5vZ`,rc=`HierarchyNode__fold_button___Lm5vZ`,ic=`HierarchyNode__child___Lm5vZ`,ac=`HierarchyNode__child_line___Lm5vZ`,oc={node:Ys,self:Xs,self_name:Zs,icon:Qs,selectable:$s,visibility:ec,menu:tc,fold:nc,fold_button:rc,child:ic,child_line:ac}})),cc,B,lc,uc=t((()=>{cc=r(i(),1),L(),o(),p(),h(),v(),g(),x(),O(),Bs(),lo(),Js(),bn(),sc(),B=c(),lc=e=>{let{editor:t,engine:n}=D(),[r]=A(t,`selectedEntityId`),i=r!==void 0&&n.root.findEntityByUUID(r),[a,o]=A(e.entity,`visible`),[c,l]=A(t,`unselectableEntityIds`),[u]=A(e.entity,`children`),d=!(c||[]).includes(e.entity.uuid),f=(u||[]).map(e=>n.root.findEntityByUUID(e)).filter(e=>e!==void 0),p=e.depth||0,h=f&&f.concat().sort((e,t)=>e.name.localeCompare(t.name))||[],g=h.length>0,v=p*20,x=e.entity.initiator==`script`,S=(0,cc.useMemo)(()=>e.entity.getComponent(Rr)?(0,B.jsx)(C,{size:14}):e.entity.getComponent(Pr)?(0,B.jsx)(m,{size:14}):e.entity.getComponent(F)?(0,B.jsx)(b,{size:14}):null,[e.entity]),ee=e.openNodes.has(e.entity.uuid),te=(0,cc.useCallback)(t=>{e.setNodeOpen(e.entity.uuid,!ee),t.stopPropagation()},[ee,e]),ne=(0,cc.useCallback)(()=>{t&&t.selectEntity(e.entity)},[t,e.entity]),re=(0,cc.useCallback)(e=>{e.stopPropagation(),o&&o(!a)},[a,o]),ie=(0,cc.useCallback)(t=>{t.stopPropagation();let n=new Set(c||[]);d?n.add(e.entity.uuid):n.delete(e.entity.uuid),l(Array.from(n))},[d,c,l,e.entity.uuid]),{pushContent:w,closeAll:ae}=co(),T=(0,cc.useCallback)(n=>{n.preventDefault(),!(!t||!w||!ae||x)&&(t.selectEntity(e.entity),w((0,B.jsx)(zs,{label:e.entity.name,list:[{label:`Add Entity`,onClick:()=>{w((0,B.jsx)(qs,{initialValues:{name:``},onSubmit:n=>{let r=t.api.createEntity(e.entity,n.name);t.api.selectEntity(r),ae()}}))}},{label:`Delete Entity`,onClick:()=>{t.api.deleteEntity(e.entity),ae()}}]})))},[t,e.entity,w,ae,x]);return(0,B.jsxs)(`div`,{className:oc.node,"data-no_export":x,children:[(0,B.jsxs)(`div`,{className:oc.self,style:{paddingLeft:v},onClick:ne,onContextMenu:T,"data-selected":i&&i.uuid==e.entity.uuid,children:[(0,B.jsx)(`div`,{className:oc.fold,"data-hnode_open":ee,children:g&&(0,B.jsx)(`button`,{className:oc.fold_button,onClick:te,children:(0,B.jsx)(s,{open:ee})})}),S&&(0,B.jsx)(`div`,{className:oc.icon,children:S}),(0,B.jsx)(`div`,{className:oc.self_name,children:(0,B.jsx)(`p`,{children:e.entity.name||`-`})}),(0,B.jsx)(`button`,{className:oc.selectable,onClick:ie,"data-selectable":d,children:(0,B.jsx)(_,{size:14,selectable:d})}),(0,B.jsx)(`button`,{className:oc.visibility,onClick:re,"data-visible":a!==!1,children:(0,B.jsx)(y,{size:14,visible:a!==!1})}),!x&&(0,B.jsx)(`button`,{className:oc.menu,onClick:T,children:`⋯`})]}),g&&(0,B.jsxs)(`div`,{className:oc.child,"data-open":ee,children:[h.map(t=>(0,B.jsx)(lc,{entity:t,depth:p+1,openNodes:e.openNodes,setNodeOpen:e.setNodeOpen},t.uuid)),(0,B.jsx)(`div`,{className:oc.child_line,style:{marginLeft:v+4}})]})]})},lc.__docgenInfo={description:``,methods:[],displayName:`HierarchyNode`,props:{depth:{required:!1,tsType:{name:`number`},description:``},entity:{required:!0,tsType:{name:`MXP.Entity`},description:``},openNodes:{required:!0,tsType:{name:`Set`,elements:[{name:`string`}],raw:`Set<string>`},description:``},setNodeOpen:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( uuid: string, open: boolean ) => void`,signature:{arguments:[{type:{name:`string`},name:`uuid`},{type:{name:`boolean`},name:`open`}],return:{name:`void`}}},description:``}}}})),dc,fc=t((()=>{dc={}})),pc,mc,hc,gc,_c,vc,yc=t((()=>{pc=r(i(),1),O(),bn(),uc(),fc(),mc=c(),hc=`hierarchyOpenNodes`,gc=()=>{try{let e=localStorage.getItem(hc);if(e)return new Set(JSON.parse(e))}catch{}return new Set},_c=e=>{localStorage.setItem(hc,JSON.stringify(Array.from(e)))},vc=()=>{let{editor:e,engine:t}=D(),[n]=A(e,`selectedEntityId`),r=t.root,[i,a]=(0,pc.useState)(gc),o=(0,pc.useCallback)((e,t)=>{a(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),_c(r),r})},[]);return(0,pc.useEffect)(()=>{if(!n)return;let e=r.findEntityByUUID(n);if(!e)return;let t=[],i=e.parent;for(;i;)t.push(i.uuid),i=i.parent;a(e=>{if(t.every(t=>e.has(t)))return e;let n=new Set(e);return t.forEach(e=>n.add(e)),_c(n),n})},[n,r]),(0,mc.jsx)(`div`,{className:dc.hierarchy,children:r&&(0,mc.jsx)(lc,{entity:r,openNodes:i,setNodeOpen:o})})},vc.__docgenInfo={description:``,methods:[],displayName:`Hierarchy`}})),bc,xc,Sc,Cc,wc,Tc,Ec,Dc,Oc,kc=t((()=>{bc=`InputWindow__inputWindow___Lmluc`,xc=`InputWindow__overlay___Lmluc`,Sc=`InputWindow__window___Lmluc`,Cc=`InputWindow__label___Lmluc`,wc=`InputWindow__input___Lmluc`,Tc=`InputWindow__buttons___Lmluc`,Ec=`InputWindow__cancelBtn___Lmluc`,Dc=`InputWindow__okBtn___Lmluc`,Oc={inputWindow:bc,overlay:xc,window:Sc,label:Cc,input:wc,buttons:Tc,cancelBtn:Ec,okBtn:Dc}})),Ac,jc,Mc,Nc=t((()=>{Ac=r(i(),1),Ae(),kc(),jc=c(),Mc=()=>{let{config:e,close:t}=ke(),n=(0,Ac.useRef)(null),[r,i]=(0,Ac.useState)(``),a=(0,Ac.useRef)(!1);(0,Ac.useEffect)(()=>{e&&(i(String(e.value)),a.current=!0)},[e]),(0,Ac.useEffect)(()=>{a.current&&(a.current=!1,n.current?.focus(),n.current?.select())},[r]);let o=(0,Ac.useCallback)(()=>{e&&(e.type===`number`?e.onChange(Number(r)):e.onChange(r),t())},[e,r,t]),s=(0,Ac.useCallback)(()=>{t()},[t]);return e?(0,jc.jsxs)(`div`,{className:Oc.inputWindow,children:[(0,jc.jsx)(`div`,{className:Oc.overlay,onClick:s}),(0,jc.jsxs)(`div`,{className:Oc.window,children:[e.label&&(0,jc.jsx)(`div`,{className:Oc.label,children:e.label}),(0,jc.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),o()},children:[(0,jc.jsx)(`input`,{ref:n,className:Oc.input,type:`text`,inputMode:e.type===`number`?`decimal`:`text`,value:r,step:e.step,min:e.min,max:e.max,onChange:e=>i(e.target.value),onKeyDown:e=>{e.key===`Escape`&&s()}}),(0,jc.jsxs)(`div`,{className:Oc.buttons,children:[(0,jc.jsx)(`button`,{type:`button`,className:Oc.cancelBtn,onClick:s,children:`Cancel`}),(0,jc.jsx)(`button`,{type:`submit`,className:Oc.okBtn,children:`OK`})]})]})]})]}):null},Mc.__docgenInfo={description:``,methods:[],displayName:`InputWindow`}})),Pc,Fc,Ic=t((()=>{Pc=r(i(),1),Fc=()=>{let[e,t]=(0,Pc.useState)(null);return{config:e,open:(0,Pc.useCallback)(e=>{t(e)},[]),close:(0,Pc.useCallback)(()=>{t(null)},[])}}})),Lc,Rc,zc=t((()=>{De(),Ic(),Lc=c(),Rc=e=>{let t=Fc();return(0,Lc.jsx)(Ee.Provider,{value:t,children:e.children})},Rc.__docgenInfo={description:``,methods:[],displayName:`InputWindowProvider`}})),Bc,Vc,Hc,Uc,Wc,Gc,Kc=t((()=>{Bc=`MouseMenu__mouseMenu___Lm1vd`,Vc=`MouseMenu__hide___Lm1vd`,Hc=`MouseMenu__menuItem___Lm1vd`,Uc=`MouseMenu__menuItem_inner___Lm1vd`,Wc=`MouseMenu__menuItem_inner_inner___Lm1vd`,Gc={mouseMenu:Bc,hide:Vc,menuItem:Hc,menuItem_inner:Uc,menuItem_inner_inner:Wc}})),qc,Jc,Yc=t((()=>{po(),lo(),Kc(),qc=c(),Jc=()=>{let{itemList:e,containerRef:t,closeAll:n}=co();return(0,qc.jsxs)(`div`,{className:Gc.mouseMenu,ref:t,children:[e&&e.length>0&&(0,qc.jsx)(`div`,{className:Gc.hide,onClick:()=>{n&&n()}}),e&&e.map(e=>{let t=e.pos;return(0,qc.jsx)(fo.Provider,{value:e,children:(0,qc.jsx)(`div`,{className:Gc.menuItem,style:{left:0,top:0,transform:`translate(${t.x}px, ${t.y}px)`},children:(0,qc.jsx)(`div`,{className:Gc.menuItem_inner,children:(0,qc.jsx)(`div`,{className:Gc.menuItem_inner_inner,"data-direction":e.direction,children:e.elm})})})},e.id)})]})},Jc.__docgenInfo={description:``,methods:[],displayName:`MouseMenu`}})),Xc,Zc,Qc,$c=t((()=>{Xc=r(i(),1),Zc=0,Qc=()=>{let e=(0,Xc.useRef)(null),t=(0,Xc.useRef)({x:0,y:0}),n=(0,Xc.useCallback)(e=>{t.current.x=e.clientX,t.current.y=e.clientY},[]);(0,Xc.useEffect)(()=>(window.addEventListener(`pointermove`,n),()=>{window.removeEventListener(`pointermove`,n)}),[n]);let[r,i]=(0,Xc.useState)([]),a=(0,Xc.useRef)(r);a.current=r;let o=(0,Xc.useCallback)(e=>{a.current=a.current.filter(t=>t.id!==e),i(a.current)},[]),s=(0,Xc.useCallback)(()=>{i([])},[]);return{itemList:r,pushContent:(0,Xc.useCallback)(e=>{let n=Zc++,r={x:t.current.x,y:t.current.y},s={id:n,elm:e,pos:r,direction:(r.x<window.innerWidth/2?`right`:`left`)+`-`+(r.y<window.innerHeight/2?`bottom`:`top`),close:()=>o(n)};return i([...a.current,s]),s},[o]),closeAll:s,containerRef:e}}})),el,tl,nl=t((()=>{oo(),$c(),el=c(),tl=e=>{let t=Qc();return(0,el.jsx)(ao.Provider,{value:t,children:e.children})},tl.__docgenInfo={description:``,methods:[],displayName:`MouseMenuProvider`}})),rl,il,al,ol,sl,cl,ll=t((()=>{rl=`ProjectControl__project___LnByb`,il=`ProjectControl__project_inner___LnByb`,al=`ProjectControl__projectSelector___LnByb`,ol=`ProjectControl__row___LnByb`,sl=`ProjectControl__rowItem___LnByb`,cl={project:rl,project_inner:il,projectSelector:al,row:ol,rowItem:sl,export:`ProjectControl__export___LnByb`}})),ul,dl,fl,pl,ml=t((()=>{ul=r(i(),1),l(),d(),o(),O(),ll(),dl=c(),fl=new URLSearchParams(location.search).get(`project`)||`default`,pl=()=>{let{editor:e}=D(),[t,n]=(0,ul.useState)(null);if((0,ul.useEffect)(()=>{if(!e)return;let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),!e)return null;let r=e.isExporting;return(0,dl.jsx)(`div`,{className:cl.project,children:(0,dl.jsx)(`div`,{className:cl.project_inner,children:(0,dl.jsxs)(u,{label:fl,accordion:!0,children:[(0,dl.jsx)(f,{onClick:()=>{e&&e.save()},children:`Save`}),(0,dl.jsx)(f,{onClick:()=>{window.location.href=`/`},children:`Projects`}),(0,dl.jsxs)(`div`,{className:cl.export,children:[(0,dl.jsxs)(f,{onClick:()=>{e&&(e.save(),window.open(`/player`,`_blank`))},children:[`Play `,(0,dl.jsx)(s,{})]}),(0,dl.jsx)(f,{onClick:()=>{e&&!r&&e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})]})]})})})},pl.__docgenInfo={description:``,methods:[],displayName:`ProjectControl`}})),hl,gl,_l,vl=t((()=>{hl=`RendererSettings__renderer___LnJlb`,gl=`RendererSettings__renderer_inner___LnJlb`,_l={renderer:hl,renderer_inner:gl}})),yl,bl,xl=t((()=>{l(),O(),yn(),vl(),yl=c(),bl=()=>{let{editor:e}=D(),t=e.engine.renderer;return(0,yl.jsx)(`div`,{className:_l.renderer,children:(0,yl.jsxs)(`div`,{className:_l.renderer_inner,children:[(0,yl.jsx)(u,{label:`Resolution`,accordion:!0,children:(0,yl.jsx)(vn,{target:e,filter:`resolution`})}),(0,yl.jsx)(u,{label:`Pipeline`,accordion:!0,children:(0,yl.jsx)(vn,{target:t,filter:`pipeline`})}),(0,yl.jsx)(u,{label:`Sky`,accordion:!0,children:(0,yl.jsx)(vn,{target:t,filter:`sky`})})]})})},bl.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})),Sl,Cl,wl=t((()=>{Sl=`Canvas__container___LmNvb`,Cl={container:Sl}})),Tl,El,Dl,Ol=t((()=>{Tl=r(i(),1),O(),wl(),El=c(),Dl=()=>{let{engine:e}=D(),t=(0,Tl.useRef)(null);return(0,Tl.useEffect)(()=>{let n=t.current;if(!e||!n)return;let r=e.canvas;if(!r){console.error(`Canvas element not found in engine`);return}return n.appendChild(r),()=>{n.contains(r)&&n.removeChild(r)}},[e]),(0,El.jsx)(`div`,{className:Cl.container,ref:t,role:`presentation`,"aria-label":`3D Canvas`})},Dl.__docgenInfo={description:``,methods:[],displayName:`Canvas`}})),kl,Al,jl=t((()=>{kl=`AudioView__audioView___LmF1Z`,Al={audioView:kl}})),Ml,Nl=t((()=>{ir(),N(),Ml=class extends $n{wrapperElm;canvas;canvasCtx;viewRangeFrame;viewPort;viewPortRange;musicBuffer;resizeObserver;frameSetting;framePlay;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0];let e=window.localStorage.getItem(`audioViweRange`);this.viewRangeFrame=e?Number(e):2,this.frameSetting={duration:0,fps:60},this.framePlay={current:0,playing:!1},this.musicBuffer=null,this.resizeObserver=new ResizeObserver(this.onResize.bind(this))}onResize(){if(this.wrapperElm){let e=new j(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);this.canvas.width=e.x,this.canvas.height=e.y}this.render()}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.musicBuffer){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)]*1,s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]*1+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}this.canvasCtx.fillStyle=`#555`,this.canvasCtx.fillRect(this.canvas.width/2,0,1,this.canvas.height)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.canvas),this.onResize()}setFramePlaying(e){this.framePlay=e,this.viewPort=[this.framePlay.current-this.viewRangeFrame,0,this.framePlay.current+this.viewRangeFrame,0],this.viewPortRange=[this.viewPort[2]-this.viewPort[0],this.viewPort[3]-this.viewPort[1]],this.render()}setViewRangeFrame(e){this.viewRangeFrame=e,this.setFramePlaying(this.framePlay),localStorage.setItem(`audioViweRange`,String(this.viewRangeFrame))}setFrameSetting(e){this.frameSetting=e,this.render()}setMusicBuffer(e){this.musicBuffer=e,this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.canvas),this.resizeObserver.disconnect()}},Ml.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setFramePlaying`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`FramePlay`,alias:`FramePlay`}}],returns:null},{name:`setViewRangeFrame`,docblock:null,modifiers:[],params:[{name:`rangeFrame`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frameSetting`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`AudioViewRenderer`}})),Pl,Fl,Il,Ll=t((()=>{Pl=r(i(),1),O(),jl(),Nl(),Fl=c(),Il=()=>{let{editor:e}=D(),t=(0,Pl.useRef)(null),[n,r]=(0,Pl.useState)();(0,Pl.useEffect)(()=>{let e=new Ml;if(r(e),t.current)return e.setWrapperElm(t.current),()=>{e.dispose()}},[]);let i=e&&e.audioBuffer,[a,o]=(0,Pl.useState)(),[s,c]=(0,Pl.useState)({duration:0,fps:0}),[l,u]=(0,Pl.useState)({current:0,playing:!1});(0,Pl.useEffect)(()=>{if(!e)return;let t=e.engine,n=e=>{c({duration:e[`timeline/duration`],fps:e[`timeline/fps`]})},r=0,i=()=>{o(r++)},a=e=>{u({...e})};return n(t.serialize()),a(t.frame),t.on(`fields/update`,n),t.on(`update/music`,i),t.on(`update/frame/play`,a),()=>{t.off(`update/frame/setting`,n),t.off(`update/music`,i),t.off(`update/frame/play`,a)}},[e]),(0,Pl.useEffect)(()=>{n&&i&&n.setMusicBuffer(i)},[n,i,a]),(0,Pl.useEffect)(()=>{n&&l&&n.setFramePlaying(l)},[n,l]),(0,Pl.useEffect)(()=>{n&&s&&n.setFrameSetting(s)},[n,s]);let d=(0,Pl.useCallback)(e=>{if(n){let t=e.deltaY>0?1.1:.9;n.setViewRangeFrame(n.viewRangeFrame*t)}e.preventDefault()},[n]);return(0,Pl.useEffect)(()=>{let e=t.current;return e&&e.addEventListener(`wheel`,d,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,d)}},[d]),(0,Fl.jsx)(`div`,{className:Al.audioView,ref:t})},Il.__docgenInfo={description:``,methods:[],displayName:`AudioView`}})),Rl,zl,Bl,Vl=t((()=>{Rl=`CameraPad__cameraPad___LmNhb`,zl=`CameraPad__btn___LmNhb`,Bl={cameraPad:Rl,btn:zl}})),Hl,Ul,Wl=t((()=>{O(),bn(),Vl(),Hl=c(),Ul=()=>{let{editor:e}=D(),[t]=A(e,`selectedEntityId`);return(0,Hl.jsxs)(`div`,{className:Bl.cameraPad,children:[(0,Hl.jsx)(`div`,{className:Bl.btn,"data-disabled":!t,onClick:()=>{t&&e.focusSelected()},title:`Focus selected ( . )`,children:`Focus`}),(0,Hl.jsx)(`div`,{className:Bl.btn,onClick:()=>{e.syncToSceneCamera()},title:`Move to scene camera ( Esc )`,children:`Scene Cam`})]})},Ul.__docgenInfo={description:``,methods:[],displayName:`CameraPad`}})),Gl,Kl,ql,Jl,Yl,Xl,Zl,Ql,$l,eu,tu,nu,ru,iu,au,ou,su,cu,lu,uu,du,V,fu=t((()=>{Gl=`Screen__screen___LnNjc`,Kl=`Screen__header___LnNjc`,ql=`Screen__header_tabs___LnNjc`,Jl=`Screen__header_tab___LnNjc`,Yl=`Screen__header_right___LnNjc`,Xl=`Screen__header_item___LnNjc`,Zl=`Screen__content___LnNjc`,Ql=`Screen__gizmoMode___LnNjc`,$l=`Screen__gizmoMode_btn___LnNjc`,eu=`Screen__gizmoMode_separator___LnNjc`,tu=`Screen__modalStatus___LnNjc`,nu=`Screen__canvas___LnNjc`,ru=`Screen__audioViewHandle___LnNjc`,iu=`Screen__audioView___LnNjc`,au=`Screen__displayOptions___LnNjc`,ou=`Screen__displayOptions_btn___LnNjc`,su=`Screen__overlay___LnNjc`,cu=`Screen__overlay_field___LnNjc`,lu=`Screen__overlay_label___LnNjc`,uu=`Screen__overlay_separator___LnNjc`,du=`Screen__externalBtn___LnNjc`,V={screen:Gl,header:Kl,header_tabs:ql,header_tab:Jl,header_right:Yl,header_item:Xl,content:Zl,gizmoMode:Ql,gizmoMode_btn:$l,gizmoMode_separator:eu,modalStatus:tu,canvas:nu,audioViewHandle:ru,audioView:iu,displayOptions:au,displayOptions_btn:ou,overlay:su,overlay_field:cu,overlay_label:lu,overlay_separator:uu,externalBtn:du}})),pu,H,mu,hu=t((()=>{pu=r(i(),1),d(),le(),we(),O(),Pt(),Ol(),Tt(),bn(),Ll(),Wl(),fu(),H=c(),mu=()=>{let{editor:e}=D(),t=Ce(),[n,r]=A(e,`enableRender`),[i,a]=A(e,`preview`),[o,s]=A(e,`viewType`),[c,l]=A(e,`resolutionScale`),[u,d]=A(e,`gizmoMode`),[p,m]=A(e,`transformOrientation`),[h]=A(e,`modalStatus`),[g,_]=A(e,`helpers/show`),[v,y]=A(e,`helpers/empty`),[b,x]=A(e,`helpers/camera`),[S,C]=A(e,`helpers/light`),[ee,te]=A(e,`helpers/grid`),[ne,re]=A(e,`helpers/wireframe`),[ie,w]=A(e,`helpers/gizmo`),[ae,T]=A(e,`helpers/outline`),[oe]=Nt(`showAudioView`),[se,ce]=(0,pu.useState)(50),E=(0,pu.useRef)(null),[le,de]=(0,pu.useState)(!1),fe=(0,pu.useRef)(null),pe=(0,pu.useCallback)(e=>{fe.current&&!fe.current.contains(e.target)&&de(!1)},[]);return(0,pu.useEffect)(()=>(le&&document.addEventListener(`pointerdown`,pe),()=>{document.removeEventListener(`pointerdown`,pe)}),[le,pe]),(0,H.jsxs)(`div`,{className:V.screen,children:[(0,H.jsxs)(`div`,{className:V.header,children:[(0,H.jsx)(`div`,{className:V.header_tabs,children:(0,H.jsx)(`div`,{className:V.header_tab,"data-active":!!i,onClick:()=>a&&a(!i),title:`Camera Render`,children:(0,H.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 512 512`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,H.jsx)(`path`,{d:`M32 144 H336 V368 H32 Z M368 224 L480 152 V360 L368 288 Z`})})})}),(0,H.jsxs)(`div`,{className:V.header_right,children:[(0,H.jsx)(`div`,{className:V.header_item,children:(0,H.jsx)(ue,{title:`View`,children:(0,H.jsx)(k,{value:o,format:{type:`select`,list:[`render`,`debug`]},onChange:e=>s&&s(e)})})}),(0,H.jsx)(`div`,{className:V.header_item,children:(0,H.jsx)(ue,{title:`Res`,children:(0,H.jsx)(k,{value:c,format:{type:`select`,list:[,,,,,,].fill(0).map((e,t)=>{let n=2**t,r=1/n;return{value:r,label:r==1?`1`:`1/`+n}})},onChange:e=>l&&l(e)})})}),t.isPC&&(0,H.jsx)(`div`,{className:V.externalBtn,children:(0,H.jsx)(f,{onClick:()=>{e.openInExternalWindow()},children:(0,H.jsxs)(`svg`,{width:`32`,height:`12`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,H.jsxs)(`g`,{clipPath:`url(#clip0_224_2)`,children:[(0,H.jsx)(`path`,{d:`M96 0V416H512V0H96ZM472 376H136V40H472V376Z`,fill:`#aaa`}),(0,H.jsx)(`path`,{d:`M40 472V296V136V96H0V512H416V472H376H40Z`,fill:`#aaa`}),(0,H.jsx)(`path`,{d:`M232.812 312.829L350.671 194.969V279.766H390.671V126.688H237.594V166.688H322.39L204.531 284.547L232.812 312.829Z`,fill:`#aaa`})]}),(0,H.jsx)(`defs`,{children:(0,H.jsx)(`clipPath`,{id:`clip0_224_2`,children:(0,H.jsx)(`rect`,{width:`512`,height:`512`,fill:`white`})})})]})})})]})]}),(0,H.jsxs)(`div`,{className:V.content,children:[(0,H.jsxs)(`div`,{className:V.displayOptions,ref:fe,children:[(0,H.jsx)(`div`,{className:V.displayOptions_btn,"data-active":le,onClick:()=>de(!le),title:`Display Options`,children:`⚙`}),le&&(0,H.jsxs)(`div`,{className:V.overlay,children:[(0,H.jsx)(`div`,{className:V.overlay_label,children:`Rendering`}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(ue,{title:`Render`,children:(0,H.jsx)(k,{value:n,onChange:e=>r&&r(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_separator}),(0,H.jsx)(`div`,{className:V.overlay_label,children:`Helpers`}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(ue,{title:`Show`,children:(0,H.jsx)(k,{value:g,onChange:e=>_&&_(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(ue,{title:`Empty`,children:(0,H.jsx)(k,{value:v,onChange:e=>y&&y(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(ue,{title:`Camera`,children:(0,H.jsx)(k,{value:b,onChange:e=>x&&x(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(ue,{title:`Light`,children:(0,H.jsx)(k,{value:S,onChange:e=>C&&C(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_separator}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(ue,{title:`Grid`,children:(0,H.jsx)(k,{value:ee,onChange:e=>te&&te(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(ue,{title:`Wireframe`,children:(0,H.jsx)(k,{value:ne,onChange:e=>re&&re(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(ue,{title:`Gizmo`,children:(0,H.jsx)(k,{value:ie,onChange:e=>w&&w(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(ue,{title:`Outline`,children:(0,H.jsx)(k,{value:ae,onChange:e=>T&&T(e)})})})]})]}),(0,H.jsxs)(`div`,{className:V.gizmoMode,children:[[`select`,`translate`,`rotate`,`scale`].map(e=>(0,H.jsx)(`div`,{className:V.gizmoMode_btn,"data-active":u===e,onClick:()=>d&&d(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`select`?`↖`:e===`translate`?`T`:e===`rotate`?`R`:`S`},e)),(0,H.jsx)(`div`,{className:V.gizmoMode_separator}),[`global`,`local`].map(e=>(0,H.jsx)(`div`,{className:V.gizmoMode_btn,"data-active":p===e,onClick:()=>m&&m(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`global`?`G`:`L`},e))]}),h&&(0,H.jsx)(`div`,{className:V.modalStatus,children:h}),(0,H.jsx)(`div`,{className:V.canvas,children:(0,H.jsx)(Dl,{})}),t.isSP&&(0,H.jsx)(Ul,{}),t.isPC&&oe&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{className:V.audioViewHandle,onPointerDown:e=>{e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),E.current={startY:e.clientY,startHeight:se}},onPointerMove:e=>{if(!E.current)return;let t=E.current.startY-e.clientY,n=Math.max(20,Math.min(400,E.current.startHeight+t));ce(n)},onPointerUp:()=>{E.current=null}}),(0,H.jsx)(`div`,{className:V.audioView,style:{height:se},children:(0,H.jsx)(Il,{})})]})]})]})},mu.__docgenInfo={description:``,methods:[],displayName:`Screen`}})),gu,_u,vu,yu,bu,xu,Su,Cu=t((()=>{gu=`Textures__textures___LnRle`,_u=`Textures__item___LnRle`,vu=`Textures__preview___LnRle`,yu=`Textures__img___LnRle`,bu=`Textures__placeholder___LnRle`,xu=`Textures__name___LnRle`,Su={textures:gu,item:_u,preview:vu,img:yu,placeholder:bu,name:xu}})),wu,Tu,Eu,Du=t((()=>{wu=r(i(),1),ro(),O(),Cu(),Tu=c(),Eu=()=>{let{engine:e,editor:t}=D(),[,n]=(0,wu.useState)(0);(0,wu.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return Xa.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{Xa.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=Xa.resources.textureList;return(0,Tu.jsx)(`div`,{className:Su.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,Tu.jsxs)(`div`,{className:Su.item,children:[(0,Tu.jsx)(`div`,{className:Su.preview,children:n?(0,Tu.jsx)(`img`,{src:n,className:Su.img}):(0,Tu.jsx)(`div`,{className:Su.placeholder})}),(0,Tu.jsx)(`div`,{className:Su.name,children:e.name})]},e.name)})})},Eu.__docgenInfo={description:``,methods:[],displayName:`Textures`}})),Ou,ku,Au=t((()=>{Ou=r(i(),1),ku=(0,Ou.createContext)(null)})),ju,Mu,Nu=t((()=>{ju=r(i(),1),Au(),Mu=()=>{let e=(0,ju.useContext)(ku);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})),Pu,Fu=t((()=>{Pu=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
