...
\r
    // outColor = vec4( 0.0 );\r
\r
}`,lr=class extends Gt{constructor(e){super({name:`FXAA`,passes:[new P(e,{name:`fxaa`,frag:cr})]})}},ur=(e,t)=>{let n=t.addComponent(Ut),r=e.renderer.backend,i=new rr(r);return i.threshold=1,i.brightness=1,n.add(new lr(r)),n.add(i),n.add(new ar(r)),n.add(new sr(r)),()=>{t.removeComponent(Ut)}},dr=class{static serializeEntity(e,t){let n=e=>{let r=[];e.children.forEach(e=>{e.initiator!=`script`&&r.push(n(e))});let i=[];e.components.forEach(e=>{let n=e.serialize({mode:`export`}),r=Object.keys(n).length>0;if(e.initiator!==`user`)return;let a={name:t.getName(e),uuid:e.uuid};r&&(a.props=n),i.push(a)});for(let t of e.unresolvedComponents)i.push({name:t.name,uuid:t.uuid,props:t.props});return{name:e.name,uuid:e.uuid,pos:e.position.x==0&&e.position.y==0&&e.position.z==0?void 0:e.position.getElm(`vec3`),rot:e.euler.x==0&&e.euler.y==0&&e.euler.z==0?void 0:e.euler.getElm(`vec3`),scale:e.scale.x==1&&e.scale.y==1&&e.scale.z==1?void 0:e.scale.getElm(`vec3`),components:i.length>0?i:void 0,childs:r.length>0?r:void 0}};return n(e)}static deserializeEntity(e,t,n,r){let i=(e,t)=>{let a=t||r.createEntity();a.initiator=`user`,a.name=e.name,a.restoreUUID(e.uuid);let o=e.pos||[0,0,0];a.position.x=o[0],a.position.y=o[1],a.position.z=o[2];let s=e.rot||[0,0,0];a.euler.x=s[0],a.euler.y=s[1],a.euler.z=s[2];let c=e.scale||[1,1,1];return a.scale.x=c[0],a.scale.y=c[1],a.scale.z=c[2],a.unresolvedComponents=[],e.components&&e.components.forEach(e=>{let t=n.resolve(e.name);if(t){let n=a.getComponent(t.component);n||(n=a.addComponent(t.component),n.initiator=`user`),n.restoreUUID(e.uuid),e.props&&n.deserialize(e.props)}else console.warn(`[ProjectSerializer] Component "${e.name}" not found in resolver. Preserving data for round-trip.`),a.unresolvedComponents.push({name:e.name,uuid:e.uuid,props:e.props})}),e.childs&&([...a.children].forEach(e=>{e.initiator!==`script`&&a.remove(e)}),e.childs.forEach(e=>{a.add(i(e))})),a};e&&i(e,t),t.initiator=`god`}},fr=class extends Tt{name;_frag;_resolution;_filter;_updateEveryFrame;_textures;constructor(e,t){super(),this.name=e;let n=t.data;this._frag=n?.frag||``,this._resolution=n?.resolution||[1024,1024],this._filter=n?.filter||`linear`,this._updateEveryFrame=n?.updateEveryFrame??!1,this._textures=n?.textures||{}}get frag(){return this._frag}get resolution(){return this._resolution}get filter(){return this._filter}get updateEveryFrame(){return this._updateEveryFrame}get textures(){return this._textures}},pr=(e,t)=>{let n={},r=`/${t}/`;for(let[t,i]of Object.entries(e)){let e=t.slice(t.lastIndexOf(r)+r.length).split(`/`).slice(0,-2),a=Object.entries(i).find(([e,t])=>typeof t==`function`&&/^[A-Z]/.test(e));if(!a)continue;let o=n;for(let t of e)o=o[t]=o[t]||{};o[a[0]]=a[1]}return n},mr=class extends gt{_componentList;_componentGroups;_geometryList;_geometryGroups;_textureResources;_textures;_updateEveryFrameTextures;constructor(){super(),this._componentList=[],this._textures=new Map,this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources=new Map,this._updateEveryFrameTextures=[]}get componentList(){return this._componentList}get componentGroups(){return this._componentGroups}get geometryList(){return this._geometryList}get geometryGroups(){return this._geometryGroups}get textureList(){return Array.from(this._textureResources.values())}get textures(){return this._textures}get updateEveryFrameTextures(){return this._updateEveryFrameTextures}clear(){this._componentList=[],this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources.clear(),this._textures.clear(),this._updateEveryFrameTextures=[],this.emit(`update`)}getComponent(e){return this._componentList.find(t=>t.name==e)}getComponentName(e){let t=this._componentList.find(t=>e instanceof t.component);return t?t.name:e.constructor.name}addComponentGroup(e){let t=this._componentGroups.find(t=>t.name==e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addComponent:(e,n)=>{let r={name:e,component:n};t.push(r),this._componentList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._componentGroups.push(t),this.emit(`update`),t}getGeometry(e){return this._geometryList.find(t=>t.name===e)}addGeometryGroup(e){let t=this._geometryGroups.find(t=>t.name===e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addGeometry:(e,n)=>{let r={name:e,geometryClass:n};t.push(r),this._geometryList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._geometryGroups.push(t),this.emit(`update`),t}addTextureResource(e,t){let n=new fr(e,{data:t});this._textureResources.set(e,n),this.emit(`update`)}getTextureResource(e){return this._textureResources.get(e)}removeTextureResource(e){this._textureResources.delete(e);let t=this._textures.get(e);t&&(t.dispose(),this._textures.delete(e)),this.emit(`update`)}addTexture(e,t){return this._textures.set(e,t),t}getTexture(e){return this._textures.get(e)}_buildTexture(e,t,n,r){let i=e.frag;return i?t.createTexProcedural({name:e.name,frag:i,resolution:new k(e.resolution[0]||1024,e.resolution[1]||1024),filter:e.filter,textures:n,uniforms:e.updateEveryFrame?r:void 0}):null}_ensureTexture(e,t,n,r){let i=this._textures.get(e.name);if(i)return i;if(r.has(e.name))return null;r.add(e.name);let a={},o=e.textures,s=Object.keys(o);for(let e=0;e<s.length;e++){let i=s[e],c=o[i],l=this._textureResources.get(c),u=l?this._ensureTexture(l,t,n,r):this._textures.get(c);u&&(a[i]=u)}let c=this._buildTexture(e,t,a,n);return c?(this._textures.set(e.name,c),e.updateEveryFrame&&this._updateEveryFrameTextures.push(c),c):null}buildTextureInstances(e,t){this._updateEveryFrameTextures=[];let n=new Set;this._textureResources.forEach(r=>{this._ensureTexture(r,e,t,n)}),this.emit(`update`)}},hr={duration:600,fps:30},F=class e extends Tt{static resources;name;_renderer;_root;_uniforms;_time;_frame;_frameSetting;_disposed;_frameEvent;constructor(e){super(),this.name=`OREngine`,this._disposed=!1,this._uniforms={uEnvMapIntensity:{value:1,type:`1f`}},this._renderer=e(this),this._renderer.globalUniforms={uTime:{value:0,type:`1f`},uTimeF:{value:0,type:`1f`},uTimeE:{value:0,type:`1f`},uTimeEF:{value:0,type:`1f`},uDeltaTime:{value:0,type:`1f`},uResolution:{value:new k,type:`2fv`},uAspectRatio:{value:1,type:`1f`}},this._time={current:new Date().getTime(),engine:0,delta:0,code:0},this._frameSetting={...hr},this._frame={current:0,playing:!1},this.seek(0),this._frameEvent=null,this._root=this.createEntity({name:`root`}),this._root.initiator=`god`,this.field(`name`,()=>this.name,e=>this.name=e),this.field(`scene`,()=>dr.serializeEntity(this._root,this._createComponentResolver()),e=>{dr.deserializeEntity(e,this._root,this._createComponentResolver(),this)}),this.field(`renderer`,()=>this._renderer.serialize({mode:`export`}),e=>this._renderer.deserialize(e));let t=this.fieldDir(`timeline`);t.field(`duration`,()=>this._frameSetting.duration,e=>this._frameSetting.duration=e),t.field(`fps`,()=>this._frameSetting.fps,e=>this._frameSetting.fps=e)}createEntity(e){return new It({engine:this,...e})}get canvas(){return this._renderer.canvas}get renderer(){return this._renderer}get root(){return this._root}get frame(){return this._frame}get time(){return this._time}get frameSetting(){return this._frameSetting}get uniforms(){return this._uniforms}get disposed(){return this._disposed}createView(e){return this._renderer.createView(e)}_createComponentResolver(){return{resolve:t=>e.resources.getComponent(t),getName:t=>e.resources.getComponentName(t)}}init(){this._root.disposeRecursive(),this._root.position.set(0,0,0),this._root.euler.set(0,0,0),this._root.scale.set(1,1,1),this.name=`New Project`,this._renderer.reset(),Object.assign(this._frameSetting,hr),this.stop(),this.seek(0)}async load(e){this.init(),this.deserialize(e),this.emit(`update/graph`),this.emit(`loaded`)}update(t){let n=new Date().getTime();this._time.delta=(n-this._time.current)/1e3,this._time.current=n,this._time.engine+=this._time.delta,this._time.code+=this._time.delta*+!!this._frame.playing,this._frame.current=this._time.code*60;let r=this.createEntityUpdateEvent({forceDraw:t?.forceDraw});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1,this._renderer.globalUniforms.uDeltaTime.value=Math.min(this._time.delta,1/60);let i=e.resources.updateEveryFrameTextures;for(let e=0;e<i.length;e++)i[e].render();return this._step(r),this._frame.playing&&this.emit(`update/frame/play`,[this._frame]),this._time.delta}_step(e){this._root.commitFrame(e),this._root.update(e),this._root.postUpdate(e),this._root.updateMatrixRecursive(),this._root.prepareRender(e),this._renderer.prepareScene(this._root,e),this._frameEvent=e}render(e){this._frameEvent&&this._renderer.render(e,this._frameEvent)}createEntityUpdateEvent(e){let t={playing:this._frame.playing,timeElapsed:this._time.engine,timeDelta:this._time.delta,timeCode:this._time.code,timeCodeFrame:this._frame.current,resolution:this.renderer.resolution,renderer:this.renderer,forceDraw:!1};return e?{...t,...e}:t}setSize(e){this._renderer.resize(e),this._renderer.canvas.width=e.x,this._renderer.canvas.height=e.y,this._renderer.globalUniforms.uResolution.value.copy(e),this._renderer.globalUniforms.uAspectRatio.value=e.x/Math.max(e.y,1)}play(){this._frame.playing=!0,this._time.current=new Date().getTime()}stop(){this._frame.playing=!1}seek(e){this._time.code=e/60,this._frame.current=e,this.emit(`update/frame/play`,[this._frame])}updateOffline(t,n){let r=t/n,i=1/n;this._time.delta=i,this._time.current=new Date().getTime(),this._time.engine+=i,this._time.code=r,this._frame.current=r*60,this._frame.playing=!0;let a=this.createEntityUpdateEvent({forceDraw:!0});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1;let o=e.resources.updateEveryFrameTextures;for(let e=0;e<o.length;e++)o[e].render();this._step(a)}compileShaders(e,t){let n=this.createEntityUpdateEvent({forceDraw:!0});return this.renderer.compileShaders(this._root,e,n,t)}dispose(){this._disposed=!0,this._root.disposeRecursive()}};F.resources=new mr;var gr=class extends gt{_pressedKeys;constructor(){super(),this._pressedKeys={};let e=this._onKeyDown.bind(this),t=this._onKeyUp.bind(this);window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,t),this.once(`dispose`,()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,t)})}get pressedKeys(){return this._pressedKeys}_onKeyDown(e){this._pressedKeys[e.key]=!0,this.emit(`keydown`,[e,this._pressedKeys])}_onKeyUp(e){if(this._pressedKeys[e.key]=!1,e.key==`Meta`||e.key==`Control`){let e=Object.keys(this._pressedKeys);for(let t=0;t<e.length;t++)this._pressedKeys[e[t]]=!1}this.emit(`keyup`,[e,this._pressedKeys])}dispose(){this.emit(`dispose`)}},_r=class extends gt{_isTouching;element=null;position;delta;constructor(){super(),this.position=new k(NaN,NaN),this.delta=new k(NaN,NaN),this._isTouching=!1;let e=this._onPointer.bind(this,`move`),t=this._onPointer.bind(this,`end`);window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`dragend`,t);let n=()=>{this.element&&this.removeElement(this.element),window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`dragend`,t),this.off(`dispose`,n)};this.on(`dispose`,n)}setElement(e){this.element&&this.removeElement(this.element),this.element=e;let t=this._onPointer.bind(this,`start`);e.addEventListener(`pointerdown`,t);let n=r=>{e.isEqualNode(r.elm)&&(e.removeEventListener(`pointerdown`,t),this.off(`unregister`,n))};this.on(`unregister`,n)}removeElement(e){this.emit(`unregister`,[e])}getScreenPosition(e){if(this.position.x!=this.position.x)return new k(NaN,NaN);let t=this.position.clone().divide(e).multiply(2).sub(1);return t.y*=-1,t}getRelativePosition(e,t){let n=e.getClientRects()[0],r=this.position.x-n.left,i=this.position.y-n.top;return t&&(r/=n.width,i/=n.height),new k(r,i)}_setPos(e,t){this.position.x!==this.position.x||this.position.y!==this.position.y?this.delta.set(0,0):this.delta.set(e-this.position.x,t-this.position.y),this.position.set(e,t)}_onPointer(e,t){let n=t.pointerType;(n==null||n==`mouse`&&(t.button==-1||t.button==0)||n==`touch`)&&this._touchEventHandler(t.pageX,t.pageY,e,t)}_touchEventHandler(e,t,n,r){let i=!1,a=e-window.pageXOffset,o=t-window.pageYOffset;n==`start`?(this._isTouching=!0,this._setPos(a,o),this.delta.set(0,0),i=!0):n==`move`?(this._setPos(a,o),this._isTouching&&(i=!0)):n==`end`&&(`targetTouches`in r?r.targetTouches.length==0&&(this._isTouching=!1):this._isTouching=!1,i=!0),i&&this.emit(n,[{pointerEvent:r,position:this.position.clone(),delta:this.delta.clone()}])}dispose(){this.emit(`dispose`)}},vr=(0,b.createContext)(null),yr=()=>{let e=(0,b.useContext)(vr);if(e===null)throw Error(`useEditor must be used within a EditorProvider`);return e},br=e=>{let{engine:t}=yr(),n=(0,b.useCallback)(()=>{let e=[{label:`(None)`,value:``}];return t.root.traverse(n=>{n.components.forEach(r=>{e.push({label:`${n.getScenePath(t.root)} > ${F.resources.getComponentName(r)}`,value:r.uuid})})}),e},[t]),[r,i]=(0,b.useState)(n);return(0,b.useEffect)(()=>{let e=()=>i(n());return t.on(`update/graph`,e),()=>{t.off(`update/graph`,e)}},[t,n]),(0,T.jsx)(Ee,{value:e.value||``,selectList:r,onChange:t=>{e.onChange&&e.onChange(t||null)}})},xr=e=>{let{engine:t}=yr(),n=(0,b.useCallback)(()=>{let e=[{label:`(None)`,value:``}];return t.root.traverse(n=>{e.push({label:n.getScenePath(t.root),value:n.uuid})}),e},[t]),[r,i]=(0,b.useState)(n);return(0,b.useEffect)(()=>{let e=()=>i(n());return t.on(`update/graph`,e),()=>{t.off(`update/graph`,e)}},[t,n]),(0,T.jsx)(Ee,{value:e.value||``,selectList:r,onChange:t=>{e.onChange&&e.onChange(t||null)}})},Sr={inputResourceSelect:`InputResourceSelect__inputResourceSelect___Lmluc`,select:`InputResourceSelect__select___Lmluc`,editButton:`InputResourceSelect__editButton___Lmluc`},Cr=e=>{let{editor:t}=yr(),n=(0,b.useCallback)(()=>{e.value&&(t.setField(`navigateAsset`,{assetType:e.resourceType,name:String(e.value)}),t.setField(`selectedAsset`,{name:String(e.value),assetType:e.resourceType}))},[t,e.value,e.resourceType]);return(0,T.jsxs)(`div`,{className:Sr.inputResourceSelect,children:[(0,T.jsx)(`div`,{className:Sr.select,children:(0,T.jsx)(Ee,{value:e.value,selectList:e.selectList,onChange:e.onChange})}),e.value&&(0,T.jsx)(`button`,{className:Sr.editButton,onClick:n,title:`Edit resource`,children:`✎`})]})},wr=e=>{let t=null,n=e.onChange,r=e.value,i=e.format,a=e=>{n&&n(e)};if(i&&(i.type==`entity`?t=(0,T.jsx)(xr,{value:r,onChange:a}):i.type==`component`?t=(0,T.jsx)(br,{value:r,onChange:a}):i.type==`vector`&&Array.isArray(r)?t=(0,T.jsx)(Ze,{value:r,onChange:a}):i.type==`color`&&Array.isArray(r)?t=(0,T.jsx)(_e,{value:r,onChange:a}):i.type==`select`?t=(0,T.jsx)(Ee,{value:r,onChange:a,selectList:i.list}):i.type==`resource`&&(t=(0,T.jsx)(Cr,{value:r,onChange:a,selectList:i.list,resourceType:i.resourceType}))),r==null)return t;if(!t){if(typeof r==`number`)t=(0,T.jsx)(we,{...e,value:r,onChange:a});else if(typeof r==`string`)t=(0,T.jsx)(Oe,{...e,value:r,onChange:a});else if(typeof r==`boolean`)t=(0,T.jsx)(pe,{...e,checked:r,onChange:a});else if(typeof r==`function`){let n=e.label||`Run`;t=(0,T.jsx)(ae,{onClick:()=>{r()},children:n})}else t=(0,T.jsx)(Oe,{...e,value:JSON.stringify(r),onChange:()=>{}})}return t},Tr={showAudioView:!0},Er=`orengine-editor-ui-settings`,Dr=(()=>{try{let e=localStorage.getItem(Er);if(e)return{...Tr,...JSON.parse(e)}}catch{}return{...Tr}})(),Or=new Set,kr=e=>(Or.add(e),()=>{Or.delete(e)}),Ar=e=>[(0,b.useSyncExternalStore)(kr,()=>Dr[e]),(0,b.useCallback)(t=>{Dr={...Dr,[e]:t};try{localStorage.setItem(Er,JSON.stringify(Dr))}catch{}Or.forEach(e=>e())},[e])],jr={editorSettings:`EditorSettings__editorSettings___LmVka`,editorSettings_inner:`EditorSettings__editorSettings_inner___LmVka`},Mr=()=>{let[e,t]=Ar(`showAudioView`);return(0,T.jsx)(`div`,{className:jr.editorSettings,children:(0,T.jsx)(`div`,{className:jr.editorSettings_inner,children:(0,T.jsx)(re,{label:`View`,accordion:!0,children:(0,T.jsx)(Ie,{title:`AudioView`,children:(0,T.jsx)(wr,{value:e,onChange:e=>t(e)})})})})})},Nr=(0,b.createContext)(void 0),Pr=(e,t)=>{let[n,r]=(0,b.useState)(()=>e?e.serialize():{}),i=t?[...t]:[],a=(0,b.useMemo)(()=>i,i);return(0,b.useEffect)(()=>{if(e===void 0)return;r(e.serialize());let t=t=>{let n=a.length==0;for(let e=0;e<a.length;e++)if(t.find(t=>t==a[e])){n=!0;break}n&&r(e.serialize())};return e.on(`fields/update`,t),()=>{e.off(`fields/update`,t)}},[e,a]),{fields:n}},Fr=e=>(Pr(e.target),{target:e.target}),Ir=()=>{let e=(0,b.useContext)(Nr);if(!e)throw Error(`SerializeFieldViewContext is not defined`);return e},Lr={container:`ValueArray__container___LmNvb`},Rr=e=>{let t=[],n=e.value,r=e.format,i=r?.type==`array`?r.labels:void 0;if(n===void 0)return null;for(let r=0;r<n.length;r++){let a=n[r],o=r.toString();i&&(o+=`/ `+i(a,r)),t.push((0,T.jsx)(Ie,{title:o,children:(0,T.jsx)(wr,{...e,value:a,onChange:t=>{let i=n.concat();i[r]=t,e.onChange&&e.onChange(i)}})},r))}return(0,T.jsx)(`div`,{className:Lr.container,children:t})},zr={action:`SerializeFieldViewValue__action___LmFjd`},Br=e=>{let{editor:t}=yr(),{target:n}=Ir(),r=e.field.value,i=typeof r,a=e.field.opt,o=a?.format,s=a?.label||e.path.split(`/`).pop(),c=o&&o.type==`vector`,l=null;if(Array.isArray(r))l=o?.type==`vector`?(0,T.jsx)(Ze,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}}):o?.type==`color`?(0,T.jsx)(_e,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}}):(0,T.jsx)(Rr,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}});else if(l=(0,T.jsx)(wr,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}}),i===`function`)return(0,T.jsx)(`div`,{className:zr.action,children:l});return(0,T.jsx)(Ie,{title:s,vertical:c,children:l})},Vr={container:`SerializeFieldViewDir__container___LmNvb`,field:`SerializeFieldViewDir__field___LmNvb`,block:`SerializeFieldViewDir__block___LmNvb`},Hr=e=>{let t=[],n=Object.keys(e.fields.childs);for(let r=0;r<n.length;r++){let i=n[r],a=e.fields.childs[i],{opt:o}=a,s=!1;if(o&&(s=typeof o.hidden==`function`?o.hidden(a.type==`value`?a.value:null):o.hidden||!1),s)continue;let c=`field`+i,l=(e.basePath?e.basePath+`/`:``)+i,u=null;u=a.type===`value`?(0,T.jsx)(Br,{path:l,field:a},c):(0,T.jsx)(`div`,{className:Vr.block,children:(0,T.jsx)(re,{accordion:!0,label:i,children:(0,T.jsx)(Hr,{fields:a,basePath:l})},c)},c),u&&t.push(u)}return(0,T.jsx)(`div`,{className:Vr.container,children:t})},Ur=e=>{let t=Fr(e),n=t.target.serializeToDirectory();if(e.filter){let t=n.childs[e.filter];t&&t.type===`folder`&&(n=t)}return(0,T.jsx)(Nr.Provider,{value:t,children:(0,T.jsx)(Hr,{fields:n,basePath:e.filter})})},I=(e,t)=>{let n=n=>{e?.setField(t,n)},{fields:r}=Pr(e,[t]);return[r&&r[t],n]},Wr=(0,b.createContext)(null),Gr=()=>{let e=(0,b.useContext)(Wr);if(e===null)throw Error(`useMouseMenu must be used within a MouseMenuProvider`);return e},Kr=(0,b.createContext)(void 0),qr=()=>(0,b.useContext)(Kr),Jr={compAdd:`ComponentAdd__compAdd___LmNvb`,directory:`ComponentAdd__directory___LmNvb`,subDirectory:`ComponentAdd__subDirectory___LmNvb`,picker:`ComponentAdd__picker___LmNvb`},Yr=({group:e,onClickAdd:t})=>{let n=qr(),[r,i]=(0,b.useState)(!1),a=null,o,s=`dir`,c=e.name.startsWith(`_`)?e.name.slice(1):e.name;`child`in e?a=(0,T.jsx)(T.Fragment,{children:e.child.map((e,n)=>(0,T.jsx)(Yr,{group:e,onClickAdd:t},n))}):(o=()=>t(e),s=`item`);let l=window.matchMedia(`(hover: hover)`).matches;return(0,T.jsxs)(`div`,{className:Jr.directory,onPointerEnter:l?()=>i(!0):void 0,onPointerLeave:l?()=>i(!1):void 0,onClick:e=>{o?o():(e.stopPropagation(),i(!r))},"data-type":s,"data-direction":n?.direction,children:[c,r&&(0,T.jsx)(`div`,{className:Jr.subDirectory,children:a})]})},Xr=e=>{let{editor:t}=yr(),{pushContent:n,closeAll:r}=Gr(),i=F.resources,a=(0,b.useCallback)(a=>{if(!i||!n||!r)return;let o=[],s=n=>{t.api.addComponent(e.entity,n.component),r()};i.componentGroups.forEach((e,t)=>{o.push((0,T.jsx)(Yr,{group:e,onClickAdd:s},t))}),n((0,T.jsx)(`div`,{className:Jr.picker,children:o}))},[n,i,e.entity,r,t]);return(0,T.jsx)(`div`,{className:Jr.compAdd,children:(0,T.jsx)(ae,{onClick:a,children:`Add Component`})})},Zr={compoView:`ComponentView__compoView___LmNvb`,head:`ComponentView__head___LmNvb`,name:`ComponentView__name___LmNvb`,check:`ComponentView__check___LmNvb`,delete:`ComponentView__delete___LmNvb`,propertyBlock:`ComponentView__propertyBlock___LmNvb`},Qr=e=>{let t=Object.keys(e.childs);for(let n=0;n<t.length;n++){let r=e.childs[t[n]],{opt:i}=r,a=!1;if(i&&(a=typeof i.hidden==`function`?i.hidden(r.type===`value`?r.value:null):i.hidden||!1),!a&&(r.type===`value`||Qr(r)))return!0}return!1},$r=({component:e})=>{let{editor:t}=yr(),[n,r]=I(e,`enabled`),i=e.initiator!==`user`,a=Qr(e.serializeToDirectory()),o=(0,b.useCallback)(n=>{n.stopPropagation();let r=e.entity;if(r){for(let[n,i]of r.components)if(i.uuid===e.uuid){t.api.removeComponent(r,n,e);break}}},[e,t]),s=(0,T.jsxs)(`div`,{className:Zr.head,children:[(0,T.jsx)(`div`,{className:Zr.name,children:F.resources.getComponentName(e)}),(0,T.jsx)(`div`,{className:Zr.delete,children:(0,T.jsx)(`button`,{onClick:o,children:(0,T.jsx)(D,{})})})]});return(0,T.jsx)(`div`,{className:Zr.compoView,"data-disable_component":i,children:(0,T.jsx)(`div`,{className:Zr.content,children:(0,T.jsx)(re,{label:s,accordion:a,bg:!0,defaultClose:!1,children:a&&(0,T.jsx)(Ur,{target:e})})})})},ei={container:`ComponentList__container___LmNvb`},ti=({entity:e})=>{let[t]=I(e,`components`),n=(0,b.useMemo)(()=>{let n=[];return t?(t.forEach(t=>{let r=e.getComponentByUUID(t);r&&n.push((0,T.jsx)($r,{component:r},r.uuid))}),n):null},[t,e]);return(0,T.jsx)(`div`,{className:ei.container,children:n})},ni=()=>{let{editor:e,engine:t}=yr(),[n]=I(e,`selectedEntityId`),r=(0,b.useMemo)(()=>{if(n)return t.root.findEntityByUUID(n)},[t,n]);return r?(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(re,{label:`Fields`,accordion:!0,children:(0,T.jsx)(Ur,{target:r})}),(0,T.jsxs)(re,{label:`Components`,accordion:!0,children:[(0,T.jsx)(ti,{entity:r}),(0,T.jsx)(Xr,{entity:r})]})]}):null},ri={exportControl:`ExportControl__exportControl___LmV4c`,exportControl_inner:`ExportControl__exportControl_inner___LmV4c`,export:`ExportControl__export___LmV4c`},ii=()=>{let{editor:e}=yr(),[t,n]=(0,b.useState)(null);return(0,b.useEffect)(()=>{let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),(0,T.jsx)(`div`,{className:ri.exportControl,children:(0,T.jsx)(`div`,{className:ri.exportControl_inner,children:(0,T.jsx)(re,{label:`MP4`,accordion:!0,children:(0,T.jsx)(`div`,{className:ri.export,children:(0,T.jsx)(ae,{onClick:()=>{e.isExporting||e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})})})})})},ai=(0,b.createContext)(null),oi=()=>{let e=(0,b.useContext)(ai);if(e===null)throw Error(`useOREngine must be used within a OREngineProvider`);return e},si={container:`GPUTimer__container___LmNvb`,headerRow:`GPUTimer__headerRow___LmNvb`,totalTime:`GPUTimer__totalTime___LmNvb`,toggleButton:`GPUTimer__toggleButton___LmNvb`,controls:`GPUTimer__controls___LmNvb`,control:`GPUTimer__control___LmNvb`,controlLabel:`GPUTimer__controlLabel___LmNvb`,select:`GPUTimer__select___LmNvb`,input:`GPUTimer__input___LmNvb`,group:`GPUTimer__group___LmNvb`,item:`GPUTimer__item___LmNvb`,clickable:`GPUTimer__clickable___LmNvb`,itemRow:`GPUTimer__itemRow___LmNvb`,itemName:`GPUTimer__itemName___LmNvb`,itemTime:`GPUTimer__itemTime___LmNvb`,itemStats:`GPUTimer__itemStats___LmNvb`,progressBar:`GPUTimer__progressBar___LmNvb`,progressFill:`GPUTimer__progressFill___LmNvb`},ci=class{buffer;index;size;filled;constructor(e){this.size=e,this.buffer=Array(e),this.index=0,this.filled=!1}push(e){this.buffer[this.index]=e,this.index=(this.index+1)%this.size,!this.filled&&this.index===0&&(this.filled=!0)}getAverage(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=0;for(let n=0;n<e;n++)t+=this.buffer[n];return t/e}getMax(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]>t&&(t=this.buffer[n]);return t}getMin(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]<t&&(t=this.buffer[n]);return t}getCount(){return this.filled?this.size:this.index}},li=class{buffers;windowSize;currentData;constructor(e=30){this.windowSize=e,this.buffers=new Map,this.currentData=new Map}update(e){let t=performance.now();for(let n=0;n<e.length;n++){let r=e[n],i=r.name.split(`/`),a=i[0]||`unknown`,o,s=i[i.length-1],c=s&&s.match(/\[([^\]]+)\]/);c&&(o=c[1]);let l={name:r.name,duration:r.duration,timestamp:t,renderType:a},u=this.buffers.get(r.name);u||(u=new ci(this.windowSize),this.buffers.set(r.name,u)),u.push(r.duration),this.currentData.set(r.name,{...l,entityId:o})}}getStatistics(){let e=[],t=0,n=performance.now(),r=[];return this.currentData.forEach((e,t)=>{n-e.timestamp>1e3&&r.push(t)}),r.forEach(e=>{this.currentData.delete(e)}),this.currentData.forEach(e=>{t+=e.duration}),this.currentData.forEach(n=>{let r=this.buffers.get(n.name);r&&e.push({name:n.name,renderType:n.renderType,entityId:n.entityId,current:n.duration,avg:r.getAverage(),max:r.getMax(),min:r.getMin(),samples:r.getCount(),percentage:t>0?n.duration/t*100:0})}),e}getTotalTime(){let e=0;return this.currentData.forEach(t=>{e+=t.duration}),e}},ui=e=>{if(e<2){let t=e/2;return`rgb(${Math.floor(100+t*100)}, 200, 100)`}if(e<5){let t=(e-2)/3;return`rgb(200, ${Math.floor(200-t*50)}, 100)`}if(e<10){let t=(e-5)/5;return`rgb(200, ${Math.floor(150-t*80)}, ${Math.floor(100-t*50)})`}return`rgb(200, 70, 50)`},di=e=>e>=10?e.toFixed(1):e>=1?e.toFixed(2):e.toFixed(3),fi=e=>e.replace(/\[([^\]]{4,})\]/g,(e,t)=>`[${t.slice(0,3)}]`),pi=()=>{let{editor:e}=yr(),{engine:t}=oi(),[n,r]=(0,b.useState)([]),[i,a]=(0,b.useState)(0),[o,s]=(0,b.useState)(`all`),[c,l]=(0,b.useState)(0),[u,d]=(0,b.useState)(`time`),[f,p]=(0,b.useState)(!1),m=(0,b.useRef)(new li(30)),h=(0,b.useRef)(0),g=(0,b.useRef)(!1),_=(0,b.useRef)(0),v=(0,b.useCallback)(n=>{if(!n)return;let r=t.root.findEntityByUUID(n);r&&e.selectEntity(r)},[t,e]);(0,b.useEffect)(()=>{let e=t.renderer,n=m.current,i=e=>{f&&(n.update(e),g.current=!0)},o=e=>{g.current&&e-_.current>=300&&(r(n.getStatistics()),a(n.getTotalTime()),g.current=!1,_.current=e),h.current=requestAnimationFrame(o)};return e.on(`timer`,i),h.current=requestAnimationFrame(o),()=>{e.off(`timer`,i),cancelAnimationFrame(h.current)}},[t,f]);let y=n.filter(e=>!(o!==`all`&&e.renderType!==o||e.avg<c)),x=Array.from(new Set(n.map(e=>e.renderType))),S=[...y].sort((e,t)=>u===`time`?t.avg-e.avg:e.name.localeCompare(t.name)),C=i>0?Math.floor(1e3/i):0;return(0,T.jsxs)(`div`,{className:si.container,children:[(0,T.jsxs)(`div`,{className:si.headerRow,children:[(0,T.jsxs)(`span`,{className:si.totalTime,children:[di(i),`ms (`,C,`fps)`]}),(0,T.jsx)(`button`,{className:si.toggleButton,onClick:()=>p(!f),title:f?`Stop timer`:`Start timer`,children:f?`⏸`:`▶`})]}),(0,T.jsxs)(`div`,{className:si.controls,children:[(0,T.jsxs)(`div`,{className:si.control,children:[(0,T.jsx)(`span`,{className:si.controlLabel,children:`Type`}),(0,T.jsxs)(`select`,{className:si.select,value:o,onChange:e=>s(e.target.value),children:[(0,T.jsx)(`option`,{value:`all`,children:`All`}),x.map(e=>(0,T.jsx)(`option`,{value:e,children:e},e))]})]}),(0,T.jsxs)(`div`,{className:si.control,children:[(0,T.jsx)(`span`,{className:si.controlLabel,children:`Min`}),(0,T.jsx)(`input`,{className:si.input,type:`number`,min:`0`,step:`0.1`,value:c,onChange:e=>l(parseFloat(e.target.value)||0)})]}),(0,T.jsxs)(`div`,{className:si.control,children:[(0,T.jsx)(`span`,{className:si.controlLabel,children:`Sort`}),(0,T.jsxs)(`select`,{className:si.select,value:u,onChange:e=>d(e.target.value),children:[(0,T.jsx)(`option`,{value:`time`,children:`Time`}),(0,T.jsx)(`option`,{value:`name`,children:`Name`})]})]})]}),(0,T.jsx)(`div`,{className:si.group,children:S.map((e,t)=>{let n=ui(e.avg),r=i>0?e.avg/i*100:0,a=!!e.entityId;return(0,T.jsxs)(`div`,{className:`${si.item} ${a?si.clickable:``}`,onClick:()=>v(e.entityId),children:[(0,T.jsxs)(`div`,{className:si.itemRow,children:[(0,T.jsx)(`span`,{className:si.itemName,title:e.name,children:fi(e.name)}),(0,T.jsx)(`span`,{className:si.itemTime,style:{color:n},children:di(e.avg)}),(0,T.jsx)(`span`,{className:si.itemStats,children:di(e.max)})]}),(0,T.jsx)(`div`,{className:si.progressBar,children:(0,T.jsx)(`div`,{className:si.progressFill,style:{width:`${r}%`,backgroundColor:n}})})]},e.name+t)})})]})},mi={picker:`Picker__picker___LnBpY`,picker_label:`Picker__picker_label___LnBpY`,picker_list:`Picker__picker_list___LnBpY`,picker_list_inner:`Picker__picker_list_inner___LnBpY`,item:`Picker__item___LnBpY`},hi=e=>(0,T.jsxs)(`div`,{className:mi.picker,"data-no_bg":e.noBg,children:[e.label&&(0,T.jsx)(`div`,{className:mi.picker_label,children:e.label}),(0,T.jsx)(`div`,{className:mi.picker_list,children:(0,T.jsx)(`div`,{className:mi.picker_list_inner,children:e.list.map((e,t)=>(0,T.jsx)(Ue,{className:mi.item,onClick:e.onClick,children:e.label},t))})})]}),gi={group:`InputGroup__group___Lmdyb`,submit:`InputGroup__submit___Lmdyb`},_i=e=>{let t=e.initialValues,n=[],[r,i]=(0,b.useState)(t);(0,b.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,T.jsx)(wr,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,b.useRef)(null);return(0,b.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,T.jsx)(`div`,{className:gi.group,ref:o,children:(0,T.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,T.jsx)(re,{label:e.title,noMargin:!0,children:n}),(0,T.jsx)(`div`,{className:gi.submit,children:(0,T.jsx)(ae,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},vi={node:`HierarchyNode__node___Lm5vZ`,self_name:`HierarchyNode__self_name___Lm5vZ`,icon:`HierarchyNode__icon___Lm5vZ`,selectable:`HierarchyNode__selectable___Lm5vZ`,self:`HierarchyNode__self___Lm5vZ`,visibility:`HierarchyNode__visibility___Lm5vZ`,menu:`HierarchyNode__menu___Lm5vZ`,fold:`HierarchyNode__fold___Lm5vZ`,fold_button:`HierarchyNode__fold_button___Lm5vZ`,child:`HierarchyNode__child___Lm5vZ`,child_line:`HierarchyNode__child_line___Lm5vZ`},yi=e=>{let{editor:t,engine:n}=yr(),[r]=I(t,`selectedEntityId`),i=r!==void 0&&n.root.findEntityByUUID(r),a=!!(i&&i.uuid==e.entity.uuid),[o,s]=I(e.entity,`visible`),[c,l]=I(t,`unselectableEntityIds`),[u]=I(e.entity,`children`),d=!(c||[]).includes(e.entity.uuid),f=(u||[]).map(e=>n.root.findEntityByUUID(e)).filter(e=>e!==void 0),p=e.depth||0,m=f&&f.concat().sort((e,t)=>e.name.localeCompare(t.name))||[],h=m.length>0,g=p*20,_=e.entity.initiator==`script`,v=(0,b.useMemo)(()=>e.entity.getComponent(Nt)?(0,T.jsx)(ue,{size:14}):e.entity.getComponent(jt)?(0,T.jsx)(oe,{size:14}):e.entity.getComponent(N)?(0,T.jsx)(de,{size:14}):null,[e.entity]),y=e.openNodes.has(e.entity.uuid),x=(0,b.useCallback)(t=>{e.setNodeOpen(e.entity.uuid,!y),t.stopPropagation()},[y,e]),S=(0,b.useCallback)(()=>{t&&t.selectEntity(e.entity)},[t,e.entity]),C=(0,b.useCallback)(e=>{e.stopPropagation(),s&&s(!o)},[o,s]),w=(0,b.useCallback)(t=>{t.stopPropagation();let n=new Set(c||[]);d?n.add(e.entity.uuid):n.delete(e.entity.uuid),l(Array.from(n))},[d,c,l,e.entity.uuid]),{pushContent:ee,closeAll:te}=Gr(),E=(0,b.useCallback)(n=>{n.preventDefault(),!(!t||!ee||!te||_)&&(t.selectEntity(e.entity),ee((0,T.jsx)(hi,{label:e.entity.name,list:[{label:`Add Entity`,onClick:()=>{ee((0,T.jsx)(_i,{initialValues:{name:``},onSubmit:n=>{let r=t.api.createEntity(e.entity,n.name);t.api.selectEntity(r),te()}}))}},{label:`Delete Entity`,onClick:()=>{t.api.deleteEntity(e.entity),te()}}]})))},[t,e.entity,ee,te,_]);return(0,T.jsxs)(`div`,{className:vi.node,"data-no_export":_,children:[(0,T.jsxs)(Ue,{className:vi.self,style:{paddingLeft:g},onClick:S,onContextMenu:E,selected:a,children:[(0,T.jsx)(`div`,{className:vi.fold,"data-hnode_open":y,children:h&&(0,T.jsx)(`button`,{className:vi.fold_button,onClick:x,children:(0,T.jsx)(ne,{open:y})})}),v&&(0,T.jsx)(`div`,{className:vi.icon,children:v}),(0,T.jsx)(`div`,{className:vi.self_name,children:(0,T.jsx)(`p`,{children:e.entity.name||`-`})}),(0,T.jsx)(`button`,{className:vi.selectable,onClick:w,"data-selectable":d,children:(0,T.jsx)(O,{size:14,selectable:d})}),(0,T.jsx)(`button`,{className:vi.visibility,onClick:C,"data-visible":o!==!1,children:(0,T.jsx)(le,{size:14,visible:o!==!1})}),!_&&(0,T.jsx)(`button`,{className:vi.menu,onClick:E,children:`⋯`})]}),h&&(0,T.jsxs)(`div`,{className:vi.child,"data-open":y,children:[m.map(t=>(0,T.jsx)(yi,{entity:t,depth:p+1,openNodes:e.openNodes,setNodeOpen:e.setNodeOpen},t.uuid)),(0,T.jsx)(`div`,{className:vi.child_line,style:{marginLeft:g+4}})]})]})},bi={},xi=`hierarchyOpenNodes`,Si=()=>{try{let e=localStorage.getItem(xi);if(e)return new Set(JSON.parse(e))}catch{}return new Set},Ci=e=>{localStorage.setItem(xi,JSON.stringify(Array.from(e)))},wi=()=>{let{editor:e,engine:t}=yr(),[n]=I(e,`selectedEntityId`),r=t.root,[i,a]=(0,b.useState)(Si),o=(0,b.useCallback)((e,t)=>{a(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),Ci(r),r})},[]);return(0,b.useEffect)(()=>{if(!n)return;let e=r.findEntityByUUID(n);if(!e)return;let t=[],i=e.parent;for(;i;)t.push(i.uuid),i=i.parent;a(e=>{if(t.every(t=>e.has(t)))return e;let n=new Set(e);return t.forEach(e=>n.add(e)),Ci(n),n})},[n,r]),(0,T.jsx)(`div`,{className:bi.hierarchy,children:r&&(0,T.jsx)(yi,{entity:r,openNodes:i,setNodeOpen:o})})},Ti={mouseMenu:`MouseMenu__mouseMenu___Lm1vd`,hide:`MouseMenu__hide___Lm1vd`,menuItem:`MouseMenu__menuItem___Lm1vd`,menuItem_inner:`MouseMenu__menuItem_inner___Lm1vd`,menuItem_inner_inner:`MouseMenu__menuItem_inner_inner___Lm1vd`},Ei=()=>{let{itemList:e,containerRef:t,closeAll:n}=Gr();return(0,T.jsxs)(`div`,{className:Ti.mouseMenu,ref:t,children:[e&&e.length>0&&(0,T.jsx)(`div`,{className:Ti.hide,onClick:()=>{n&&n()}}),e&&e.map(e=>{let t=e.pos;return(0,T.jsx)(Kr.Provider,{value:e,children:(0,T.jsx)(`div`,{className:Ti.menuItem,style:{left:0,top:0,transform:`translate(${t.x}px, ${t.y}px)`},children:(0,T.jsx)(`div`,{className:Ti.menuItem_inner,children:(0,T.jsx)(`div`,{className:Ti.menuItem_inner_inner,"data-direction":e.direction,children:e.elm})})})},e.id)})]})},Di=0,Oi=()=>{let e=(0,b.useRef)(null),t=(0,b.useRef)({x:0,y:0}),n=(0,b.useCallback)(e=>{t.current.x=e.clientX,t.current.y=e.clientY},[]);(0,b.useEffect)(()=>(window.addEventListener(`pointermove`,n),()=>{window.removeEventListener(`pointermove`,n)}),[n]);let[r,i]=(0,b.useState)([]),a=(0,b.useRef)(r);a.current=r;let o=(0,b.useCallback)(e=>{a.current=a.current.filter(t=>t.id!==e),i(a.current)},[]),s=(0,b.useCallback)(()=>{i([])},[]);return{itemList:r,pushContent:(0,b.useCallback)(e=>{let n=Di++,r={x:t.current.x,y:t.current.y},s={id:n,elm:e,pos:r,direction:(r.x<window.innerWidth/2?`right`:`left`)+`-`+(r.y<window.innerHeight/2?`bottom`:`top`),close:()=>o(n)};return i([...a.current,s]),s},[o]),closeAll:s,containerRef:e}},ki=e=>{let t=Oi();return(0,T.jsx)(Wr.Provider,{value:t,children:e.children})},Ai={container:`Canvas__container___LmNvb`},ji=({viewportId:e})=>{let{engine:t,editor:n}=yr(),r=(0,b.useRef)(null);return(0,b.useEffect)(()=>{let i=r.current;if(!t||!i)return;let a=n.createViewport(e,i);return()=>{a.dispose()}},[t,n,e]),(0,T.jsx)(`div`,{className:Ai.container,role:`presentation`,"aria-label":`3D Canvas`,children:(0,T.jsx)(`canvas`,{ref:r})})},Mi={audioView:`AudioView__audioView___LmF1Z`},Ni=class extends gt{wrapperElm;canvas;canvasCtx;viewRangeFrame;viewPort;viewPortRange;musicBuffer;resizeObserver;frameSetting;framePlay;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0];let e=window.localStorage.getItem(`audioViweRange`);this.viewRangeFrame=e?Number(e):2,this.frameSetting={duration:0,fps:60},this.framePlay={current:0,playing:!1},this.musicBuffer=null,this.resizeObserver=new ResizeObserver(this.onResize.bind(this))}onResize(){if(this.wrapperElm){let e=new k(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);this.canvas.width=e.x,this.canvas.height=e.y}this.render()}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.musicBuffer){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)]*1,s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]*1+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}this.canvasCtx.fillStyle=`#555`,this.canvasCtx.fillRect(this.canvas.width/2,0,1,this.canvas.height)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.canvas),this.onResize()}setFramePlaying(e){this.framePlay=e,this.viewPort=[this.framePlay.current-this.viewRangeFrame,0,this.framePlay.current+this.viewRangeFrame,0],this.viewPortRange=[this.viewPort[2]-this.viewPort[0],this.viewPort[3]-this.viewPort[1]],this.render()}setViewRangeFrame(e){this.viewRangeFrame=e,this.setFramePlaying(this.framePlay),localStorage.setItem(`audioViweRange`,String(this.viewRangeFrame))}setFrameSetting(e){this.frameSetting=e,this.render()}setMusicBuffer(e){this.musicBuffer=e,this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.canvas),this.resizeObserver.disconnect()}},Pi=()=>{let{editor:e}=yr(),t=(0,b.useRef)(null),[n,r]=(0,b.useState)();(0,b.useEffect)(()=>{let e=new Ni;if(r(e),t.current)return e.setWrapperElm(t.current),()=>{e.dispose()}},[]);let i=e&&e.audioBuffer,[a,o]=(0,b.useState)(),[s,c]=(0,b.useState)({duration:0,fps:0}),[l,u]=(0,b.useState)({current:0,playing:!1});(0,b.useEffect)(()=>{if(!e)return;let t=e.engine,n=e=>{c({duration:e[`timeline/duration`],fps:e[`timeline/fps`]})},r=0,i=()=>{o(r++)},a=e=>{u({...e})};return n(t.serialize()),a(t.frame),t.on(`fields/update`,n),t.on(`update/music`,i),t.on(`update/frame/play`,a),()=>{t.off(`update/frame/setting`,n),t.off(`update/music`,i),t.off(`update/frame/play`,a)}},[e]),(0,b.useEffect)(()=>{n&&i&&n.setMusicBuffer(i)},[n,i,a]),(0,b.useEffect)(()=>{n&&l&&n.setFramePlaying(l)},[n,l]),(0,b.useEffect)(()=>{n&&s&&n.setFrameSetting(s)},[n,s]);let d=(0,b.useCallback)(e=>{if(n){let t=e.deltaY>0?1.1:.9;n.setViewRangeFrame(n.viewRangeFrame*t)}e.preventDefault()},[n]);return(0,b.useEffect)(()=>{let e=t.current;return e&&e.addEventListener(`wheel`,d,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,d)}},[d]),(0,T.jsx)(`div`,{className:Mi.audioView,ref:t})},Fi={cameraPad:`CameraPad__cameraPad___LmNhb`,btn:`CameraPad__btn___LmNhb`},Ii=()=>{let{editor:e}=yr(),[t]=I(e,`selectedEntityId`);return(0,T.jsxs)(`div`,{className:Fi.cameraPad,children:[(0,T.jsx)(`div`,{className:Fi.btn,"data-disabled":!t,onClick:()=>{t&&e.focusSelected()},title:`Focus selected ( . )`,children:`Focus`}),(0,T.jsx)(`div`,{className:Fi.btn,onClick:()=>{e.syncToSceneCamera()},title:`Move to scene camera ( Esc )`,children:`Scene Cam`})]})},L={screen:`Screen__screen___LnNjc`,header:`Screen__header___LnNjc`,header_tabs:`Screen__header_tabs___LnNjc`,header_tab:`Screen__header_tab___LnNjc`,header_right:`Screen__header_right___LnNjc`,header_item:`Screen__header_item___LnNjc`,content:`Screen__content___LnNjc`,gizmoMode:`Screen__gizmoMode___LnNjc`,gizmoMode_btn:`Screen__gizmoMode_btn___LnNjc`,gizmoMode_separator:`Screen__gizmoMode_separator___LnNjc`,modalStatus:`Screen__modalStatus___LnNjc`,canvas:`Screen__canvas___LnNjc`,audioViewHandle:`Screen__audioViewHandle___LnNjc`,audioView:`Screen__audioView___LnNjc`,displayOptions:`Screen__displayOptions___LnNjc`,displayOptions_btn:`Screen__displayOptions_btn___LnNjc`,overlay:`Screen__overlay___LnNjc`,overlay_field:`Screen__overlay_field___LnNjc`,overlay_label:`Screen__overlay_label___LnNjc`,overlay_separator:`Screen__overlay_separator___LnNjc`,externalBtn:`Screen__externalBtn___LnNjc`},Li=`viewport`,Ri=({viewportId:e})=>{let{editor:t}=yr(),n=$e(),[r,i]=I(t,`enableRender`),[a,o]=I(t,`viewports/${e}/preview`),[s,c]=I(t,`viewType`),[l,u]=I(t,`resolutionScale`),[d,f]=I(t,`gizmoMode`),[p,m]=I(t,`transformOrientation`),[h]=I(t,`modalStatus`),[g,_]=I(t,`helpers/show`),[v,y]=I(t,`helpers/empty`),[x,S]=I(t,`helpers/camera`),[C,w]=I(t,`helpers/light`),[ee,te]=I(t,`helpers/grid`),[ne,E]=I(t,`helpers/wireframe`),[re,ie]=I(t,`helpers/gizmo`),[oe,se]=I(t,`helpers/outline`),[ce]=Ar(`showAudioView`),[D,O]=(0,b.useState)(50),le=(0,b.useRef)(null),[ue,de]=(0,b.useState)(!1),fe=(0,b.useRef)(null),pe=(0,b.useCallback)(e=>{fe.current&&!fe.current.contains(e.target)&&de(!1)},[]);return(0,b.useEffect)(()=>(ue&&document.addEventListener(`pointerdown`,pe),()=>{document.removeEventListener(`pointerdown`,pe)}),[ue,pe]),(0,T.jsxs)(`div`,{className:L.screen,children:[(0,T.jsxs)(`div`,{className:L.header,children:[(0,T.jsx)(`div`,{className:L.header_tabs,children:(0,T.jsx)(`div`,{className:L.header_tab,"data-active":!!a,onClick:()=>o&&o(!a),title:`Camera Render`,children:(0,T.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 512 512`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,T.jsx)(`path`,{d:`M32 144 H336 V368 H32 Z M368 224 L480 152 V360 L368 288 Z`})})})}),(0,T.jsxs)(`div`,{className:L.header_right,children:[(0,T.jsx)(`div`,{className:L.header_item,children:(0,T.jsx)(Ie,{title:`View`,children:(0,T.jsx)(wr,{value:s,format:{type:`select`,list:[`render`,`debug`]},onChange:e=>c&&c(e)})})}),(0,T.jsx)(`div`,{className:L.header_item,children:(0,T.jsx)(Ie,{title:`Res`,children:(0,T.jsx)(wr,{value:l,format:{type:`select`,list:[,,,,,,].fill(0).map((e,t)=>{let n=2**t,r=1/n;return{value:r,label:r==1?`1`:`1/`+n}})},onChange:e=>u&&u(e)})})}),n.isPC&&(0,T.jsx)(`div`,{className:L.externalBtn,children:(0,T.jsx)(ae,{onClick:()=>{t.openInExternalWindow()},children:(0,T.jsxs)(`svg`,{width:`32`,height:`12`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,T.jsxs)(`g`,{clipPath:`url(#clip0_224_2)`,children:[(0,T.jsx)(`path`,{d:`M96 0V416H512V0H96ZM472 376H136V40H472V376Z`,fill:`#aaa`}),(0,T.jsx)(`path`,{d:`M40 472V296V136V96H0V512H416V472H376H40Z`,fill:`#aaa`}),(0,T.jsx)(`path`,{d:`M232.812 312.829L350.671 194.969V279.766H390.671V126.688H237.594V166.688H322.39L204.531 284.547L232.812 312.829Z`,fill:`#aaa`})]}),(0,T.jsx)(`defs`,{children:(0,T.jsx)(`clipPath`,{id:`clip0_224_2`,children:(0,T.jsx)(`rect`,{width:`512`,height:`512`,fill:`white`})})})]})})})]})]}),(0,T.jsxs)(`div`,{className:L.content,children:[(0,T.jsxs)(`div`,{className:L.displayOptions,ref:fe,children:[(0,T.jsx)(`div`,{className:L.displayOptions_btn,"data-active":ue,onClick:()=>de(!ue),title:`Display Options`,children:`⚙`}),ue&&(0,T.jsxs)(`div`,{className:L.overlay,children:[(0,T.jsx)(`div`,{className:L.overlay_label,children:`Rendering`}),(0,T.jsx)(`div`,{className:L.overlay_field,children:(0,T.jsx)(Ie,{title:`Render`,children:(0,T.jsx)(wr,{value:r,onChange:e=>i&&i(e)})})}),(0,T.jsx)(`div`,{className:L.overlay_separator}),(0,T.jsx)(`div`,{className:L.overlay_label,children:`Helpers`}),(0,T.jsx)(`div`,{className:L.overlay_field,children:(0,T.jsx)(Ie,{title:`Show`,children:(0,T.jsx)(wr,{value:g,onChange:e=>_&&_(e)})})}),(0,T.jsx)(`div`,{className:L.overlay_field,"data-indent":`true`,children:(0,T.jsx)(Ie,{title:`Empty`,children:(0,T.jsx)(wr,{value:v,onChange:e=>y&&y(e)})})}),(0,T.jsx)(`div`,{className:L.overlay_field,"data-indent":`true`,children:(0,T.jsx)(Ie,{title:`Camera`,children:(0,T.jsx)(wr,{value:x,onChange:e=>S&&S(e)})})}),(0,T.jsx)(`div`,{className:L.overlay_field,"data-indent":`true`,children:(0,T.jsx)(Ie,{title:`Light`,children:(0,T.jsx)(wr,{value:C,onChange:e=>w&&w(e)})})}),(0,T.jsx)(`div`,{className:L.overlay_separator}),(0,T.jsx)(`div`,{className:L.overlay_field,children:(0,T.jsx)(Ie,{title:`Grid`,children:(0,T.jsx)(wr,{value:ee,onChange:e=>te&&te(e)})})}),(0,T.jsx)(`div`,{className:L.overlay_field,children:(0,T.jsx)(Ie,{title:`Wireframe`,children:(0,T.jsx)(wr,{value:ne,onChange:e=>E&&E(e)})})}),(0,T.jsx)(`div`,{className:L.overlay_field,children:(0,T.jsx)(Ie,{title:`Gizmo`,children:(0,T.jsx)(wr,{value:re,onChange:e=>ie&&ie(e)})})}),(0,T.jsx)(`div`,{className:L.overlay_field,children:(0,T.jsx)(Ie,{title:`Outline`,children:(0,T.jsx)(wr,{value:oe,onChange:e=>se&&se(e)})})})]})]}),(0,T.jsxs)(`div`,{className:L.gizmoMode,children:[[`select`,`translate`,`rotate`,`scale`].map(e=>(0,T.jsx)(`div`,{className:L.gizmoMode_btn,"data-active":d===e,onClick:()=>f&&f(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`select`?`↖`:e===`translate`?`T`:e===`rotate`?`R`:`S`},e)),(0,T.jsx)(`div`,{className:L.gizmoMode_separator}),[`global`,`local`].map(e=>(0,T.jsx)(`div`,{className:L.gizmoMode_btn,"data-active":p===e,onClick:()=>m&&m(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`global`?`G`:`L`},e))]}),h&&(0,T.jsx)(`div`,{className:L.modalStatus,children:h}),(0,T.jsx)(`div`,{className:L.canvas,children:(0,T.jsx)(ji,{viewportId:e})}),n.isSP&&(0,T.jsx)(Ii,{}),n.isPC&&ce&&(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(`div`,{className:L.audioViewHandle,onPointerDown:e=>{e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),le.current={startY:e.clientY,startHeight:D}},onPointerMove:e=>{if(!le.current)return;let t=le.current.startY-e.clientY,n=Math.max(20,Math.min(400,le.current.startHeight+t));O(n)},onPointerUp:()=>{le.current=null}}),(0,T.jsx)(`div`,{className:L.audioView,style:{height:D},children:(0,T.jsx)(Pi,{})})]})]})]})},zi={overlay:`DragOverlay__overlay___Lm92Z`,zone:`DragOverlay__zone___Lm92Z`,insert:`DragOverlay__insert___Lm92Z`,ghost:`DragOverlay__ghost___Lm92Z`},Bi=12,Vi=e=>{let t=(0,b.useRef)(null),n=e.drag.startX,r=e.drag.startY;(0,b.useEffect)(()=>{let e=(e,n)=>{let r=t.current;r&&(r.style.transform=`translate(${e+Bi}px, ${n+Bi}px)`)};e(n,r);let i=t=>e(t.clientX,t.clientY);window.addEventListener(`pointermove`,i);let a=document.body.style.userSelect;return document.body.style.userSelect=`none`,()=>{window.removeEventListener(`pointermove`,i),document.body.style.userSelect=a}},[n,r]);let i=e.drag.target;return(0,T.jsxs)(`div`,{className:zi.overlay,children:[i&&(0,T.jsx)(`div`,{className:i.kind===`tabs`?zi.insert:zi.zone,style:{left:`${i.rect.left}px`,top:`${i.rect.top}px`,width:`${i.rect.width}px`,height:`${i.rect.height}px`}}),(0,T.jsx)(`div`,{className:zi.ghost,ref:t,children:e.drag.title})]})};function Hi(e,t){let n=e.get(t);if(n)return n;let r=t.indexOf(`:`);if(r===-1)return;let i=e.get(t.slice(0,r));return i?.multiple?i:void 0}function Ui(e){return e.slice(e.indexOf(`:`)+1)}function Wi(e){return e.multiple?`${e.id}:${_t.genUUID()}`:e.id}function Gi(e,t){return e.multiple?e.content(Ui(t)):e.content}var Ki=(e,t)=>({type:`split`,id:_t.genUUID(),direction:e,children:t}),qi=e=>({type:`pane`,id:_t.genUUID(),tabs:e,active:e[0]});function Ji(){return Ki(`vertical`,[{ratio:916/1076,node:Ki(`horizontal`,[{ratio:300/1912,node:Ki(`vertical`,[{ratio:696/912,node:qi([`hierarchy`,`scene`])},{ratio:216/912,node:qi([`timer`])}])},{ratio:1312/1912,node:qi([`viewport:main`])},{ratio:300/1912,node:qi([`property`,`textures`,`renderer`,`editor-settings`])}])},{ratio:160/1076,node:qi([`timeline`,`export`])}])}function Yi(e){return e.type===`pane`?[e]:e.children.flatMap(e=>Yi(e.node))}var Xi=e=>{if(e.type===`pane`)return e.tabs.length>0?e:null;let t=[];if(e.children.forEach(n=>{let r=Xi(n.node);r&&(r.type===`split`&&r.direction===e.direction?r.children.forEach(e=>t.push({ratio:n.ratio*e.ratio,node:e.node})):t.push(r===n.node?n:{...n,node:r}))}),t.length===0)return null;if(t.length===1)return t[0].node;let n=t.reduce((e,t)=>e+t.ratio,0);return Math.abs(n-1)>1e-6?{...e,children:t.map(e=>({...e,ratio:e.ratio/n}))}:t.length!==e.children.length||t.some((t,n)=>t!==e.children[n])?{...e,children:t}:e};function Zi(e,t){let n=new Set,r=new Set,i=e=>{let t=typeof e==`string`&&e!==``&&!n.has(e)?e:_t.genUUID();return n.add(t),t},a=e=>{if(typeof e!=`object`||!e)return null;let n=e;if(n.type===`pane`){if(!Array.isArray(n.tabs))return null;let e=[...new Set(n.tabs.filter(e=>typeof e==`string`))].filter(e=>{let n=t(e);return n?!n.multiple||!r.has(e)&&(r.add(e),!0):!1});if(e.length===0)return null;let a=typeof n.active==`string`&&e.includes(n.active)?n.active:e[0];return{type:`pane`,id:i(n.id),tabs:e,active:a}}if(n.type===`split`){if(n.direction!==`horizontal`&&n.direction!==`vertical`||!Array.isArray(n.children))return null;let e=[];return n.children.forEach(t=>{if(typeof t!=`object`||!t)return;let n=t,r=a(n.node);if(!r)return;let i=typeof n.ratio==`number`&&isFinite(n.ratio)&&n.ratio>0?n.ratio:1;e.push({ratio:i,node:r})}),e.length===0?null:e.length===1?e[0].node:{type:`split`,id:i(n.id),direction:n.direction,children:e}}return null},o=a(e);return o?Xi(o):null}var Qi=(e,t,n)=>{if(e.id===t)return n(e);if(e.type===`split`){let r=!1,i=e.children.map(e=>{let i=Qi(e.node,t,n);return i===e.node?e:(r=!0,{...e,node:i})});if(r)return{...e,children:i}}return e};function $i(e,t,n){return Qi(e,t,e=>e.type!==`pane`||!e.tabs.includes(n)?e:{...e,active:n})}function ea(e,t,n,r){return Qi(e,t,e=>{if(e.type!==`pane`||e.tabs.includes(n))return e;let t=[...e.tabs];return t.splice(Math.max(0,Math.min(r??t.length,t.length)),0,n),{...e,tabs:t,active:n}})}function ta(e,t,n,r,i){if(t===r)return Qi(e,t,e=>{if(e.type!==`pane`)return e;let t=e.tabs.indexOf(n);if(t===-1)return e;let r=e.tabs.filter(e=>e!==n),a=i??e.tabs.length,o=Math.max(0,Math.min(t<a?a-1:a,r.length));return o===t?e:(r.splice(o,0,n),{...e,tabs:r,active:n})});let a=Yi(e),o=a.find(e=>e.id===t),s=a.find(e=>e.id===r);return!o||!s||!o.tabs.includes(n)||s.tabs.includes(n)?e:ea(ra(e,t,n),r,n,i)}function na(e,t,n,r,i){let a=Yi(e),o=a.find(e=>e.id===r);if(!o||!o.tabs.includes(i)||!a.some(e=>e.id===t)||r===t&&o.tabs.length===1)return e;let s=ra(e,r,i),c={type:`pane`,id:_t.genUUID(),tabs:[i],active:i},l=Qi(s,t,e=>{let t=[{ratio:.5,node:c},{ratio:.5,node:e}];return(n===`right`||n===`bottom`)&&t.reverse(),{type:`split`,id:_t.genUUID(),direction:n===`left`||n===`right`?`horizontal`:`vertical`,children:t}});return l===s?e:Xi(l)??e}function ra(e,t,n){let r=Qi(e,t,e=>{if(e.type!==`pane`||!e.tabs.includes(n))return e;let t=e.tabs.indexOf(n),r=e.tabs.filter(e=>e!==n),i=e.active!==n||r.length===0?e.active:r[Math.min(t,r.length-1)];return{...e,tabs:r,active:i}});return r===e?e:Xi(r)??e}function ia(e,t,n){return Qi(e,t,e=>e.type!==`split`||e.children.length!==n.length?e:{...e,children:e.children.map((e,t)=>({...e,ratio:n[t]}))})}var aa=4,oa=.25,sa=(e,t)=>{let n={left:e.left,top:e.top,width:e.width,height:e.height};return(t===`left`||t===`right`)&&(n.width/=2),t===`right`&&(n.left+=n.width),(t===`top`||t===`bottom`)&&(n.height/=2),t===`bottom`&&(n.top+=n.height),n},ca=(e,t,n,r,i)=>{if(n.id!==r&&n.tabs.includes(i))return null;let a=[...t.querySelectorAll(`[data-panel-tab-id]`)].filter(e=>e instanceof HTMLElement),o=a.length;for(let t=0;t<a.length;t++){let n=a[t].getBoundingClientRect();if(e<n.left+n.width/2){o=t;break}}let s=t.getBoundingClientRect(),c=o<a.length?a[o].getBoundingClientRect().left:a.length>0?a[a.length-1].getBoundingClientRect().right:s.left;return{kind:`tabs`,paneId:n.id,index:o,rect:{left:c-1,top:s.top,width:2,height:s.height}}},la=(e,t,n,r,i)=>{let a=document.elementFromPoint(e,t);if(!a)return null;let o=a.closest(`[data-pane-id]`);if(!(o instanceof HTMLElement))return null;let s=Yi(n).find(e=>e.id===o.dataset.paneId);if(!s)return null;let c=a.closest(`[data-panel-tab-header]`);if(c instanceof HTMLElement)return ca(e,c,s,r,i);let l=o.querySelector(`[data-panel-content]`);if(!(l instanceof HTMLElement))return null;let u=l.getBoundingClientRect();if(u.width<=0||u.height<=0)return null;let d=(e-u.left)/u.width,f=(t-u.top)/u.height;if(d<0||d>1||f<0||f>1)return null;if(Math.min(d,1-d)>oa&&Math.min(f,1-f)>oa)return s.id===r||s.tabs.includes(i)?null:{kind:`zone`,paneId:s.id,zone:`center`,rect:sa(u,`center`)};if(s.id===r&&s.tabs.length===1)return null;let p=d-.5,m=f-.5,h=Math.abs(p)>=Math.abs(m)?p<0?`left`:`right`:m<0?`top`:`bottom`;return{kind:`zone`,paneId:s.id,zone:h,rect:sa(u,h)}},ua=(e,t)=>e===null||t===null?e===t:e.paneId===t.paneId?e.kind===`tabs`&&t.kind===`tabs`?e.index===t.index:e.kind===`zone`&&t.kind===`zone`&&e.zone===t.zone:!1;function da(e,t,n){let[r,i]=(0,b.useState)(null),a=(0,b.useRef)(e);a.current=e;let o=(0,b.useRef)(t);o.current=t;let s=(0,b.useRef)(null);return(0,b.useEffect)(()=>()=>s.current?.(),[]),{dragState:r,onTabPointerDown:(e,t,r)=>{if(r.button!==0||s.current)return;let c=r.clientX,l=r.clientY,u=!1,d=null,f=r=>{if(r.buttons===0){p(!1);return}if(!u){if(Math.hypot(r.clientX-c,r.clientY-l)<aa)return;u=!0,i({panelId:t,title:n(t)?.title??t,startX:r.clientX,startY:r.clientY,target:null})}let o=la(r.clientX,r.clientY,a.current,e,t);ua(o,d)||(d=o,i(e=>e&&{...e,target:o}))},p=n=>{if(g(),n&&u&&d){let n=a.current;d.kind===`tabs`?o.current(ta(n,e,t,d.paneId,d.index)):d.zone===`center`?o.current(ta(n,e,t,d.paneId)):o.current(na(n,d.paneId,d.zone,e,t))}u&&i(null)},m=()=>p(!0),h=()=>p(!1),g=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),s.current=null};s.current=g,window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h)}}}var fa={pane:`PanelLayout__pane___LnBhb`},pa=e=>{let t=e.node;if(t.type===`split`)return(0,T.jsx)(Ve,{direction:t.direction,ratios:t.children.map(e=>e.ratio),onRatiosChange:n=>e.onRatiosChange(t.id,n),children:t.children.map(t=>(0,T.jsx)(Ve.Item,{children:(0,T.jsx)(pa,{...e,node:t.node})},t.node.id))});let n=t.tabs.flatMap(t=>{let n=e.resolve(t);return n?[{id:t,title:n.title,content:Gi(n,t)}]:[]});if(n.length===0)return null;let r=e.hasAddable(t);return(0,T.jsx)(`div`,{className:fa.pane,"data-pane-id":t.id,children:(0,T.jsx)(Je,{tabs:n,active:t.active,onSelect:n=>e.onSelectTab(t.id,n),onTabContextMenu:(n,r)=>e.onTabContextMenu(t.id,n,r),onTabPointerDown:(n,r)=>e.onTabPointerDown(t.id,n,r),onAddClick:r?()=>e.onAddTab(t.id):void 0})})},ma=e=>{let{editor:t}=yr(),{pushContent:n,closeAll:r}=Gr(),i=(0,b.useMemo)(()=>{let t=new Map;return e.panels.forEach(e=>t.set(e.id,e)),t},[e.panels]),a=(0,b.useMemo)(()=>e=>Hi(i,e),[i]),[o,s]=I(t,`panelLayout`),c=(0,b.useMemo)(()=>Zi(o,a)??Ji(),[o,a]);(0,b.useEffect)(()=>{let e=new Set(Yi(c).flatMap(e=>e.tabs).filter(e=>a(e)?.id===Li).map(Ui));t.pruneViewportSettings(e)},[c,a,t]);let l=e=>{e!==c&&s(e)},u=(e,t)=>l($i(c,e,t)),d=(e,t)=>l(ia(c,e,t)),{dragState:f,onTabPointerDown:p}=da(c,l,a),m=e=>[...i.values()].filter(t=>t.multiple||!e.tabs.includes(t.id));return(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(pa,{node:c,resolve:a,onSelectTab:u,onRatiosChange:d,onTabContextMenu:(e,t,i)=>{i.preventDefault(),Yi(c).reduce((e,t)=>e+t.tabs.length,0)>1&&n((0,T.jsx)(hi,{label:a(t)?.title,list:[{label:`Close Tab`,onClick:()=>{l(ra(c,e,t)),r()}}]}))},onTabPointerDown:p,onAddTab:e=>{let t=Yi(c).find(t=>t.id===e);if(!t)return;let i=m(t);i.length!==0&&n((0,T.jsx)(hi,{list:i.map(t=>({label:t.title,onClick:()=>{l(ea(c,e,Wi(t))),r()}}))}))},hasAddable:e=>m(e).length>0}),f&&(0,T.jsx)(Vi,{drag:f})]})},ha={renderer:`RendererSettings__renderer___LnJlb`,renderer_inner:`RendererSettings__renderer_inner___LnJlb`},ga=()=>{let{editor:e}=yr(),t=e.engine.renderer;return(0,T.jsx)(`div`,{className:ha.renderer,children:(0,T.jsxs)(`div`,{className:ha.renderer_inner,children:[(0,T.jsx)(re,{label:`Resolution`,accordion:!0,children:(0,T.jsx)(Ur,{target:e,filter:`resolution`})}),(0,T.jsx)(re,{label:`Pipeline`,accordion:!0,children:(0,T.jsx)(Ur,{target:t,filter:`pipeline`})}),(0,T.jsx)(re,{label:`Sky`,accordion:!0,children:(0,T.jsx)(Ur,{target:t,filter:`sky`})})]})})},_a={list:`SceneWindow__list___Lmxpc`,item:`SceneWindow__item___Lmxpc`,item_name:`SceneWindow__item_name___Lmxpc`,item_badge:`SceneWindow__item_badge___Lmxpc`,newItem:`SceneWindow__newItem___Lmxpc`,newItem_input:`SceneWindow__newItem_input___Lmxpc`,newItem_error:`SceneWindow__newItem_error___Lmxpc`,footer_message:`SceneWindow__footer_message___Lmxpc`,footer_spacer:`SceneWindow__footer_spacer___Lmxpc`},va=/^[A-Za-z0-9_-]+$/,ya=e=>{let{scenes:t,onClose:n}=e,[r,i]=(0,b.useState)(t.current),[a,o]=(0,b.useState)(null),[s,c]=(0,b.useState)(null),[l,u]=(0,b.useState)(!1),d=(0,b.useCallback)(e=>{e!==t.current&&t.onSelect(e),n()},[t,n]);(0,b.useEffect)(()=>{let e=e=>{if(e.key===`Escape`){if(a!==null){o(null),c(null);return}if(l){u(!1);return}n()}};return window.addEventListener(`keydown`,e),()=>{window.removeEventListener(`keydown`,e)}},[a,l,n]);let f=()=>{let e=(a??``).trim();if(!va.test(e)){c(`A-Z a-z 0-9 - _ のみ使えます`);return}if(t.names.includes(e)){c(`"${e}" は既にあります`);return}t.onCreate(e),n()},p=()=>{r&&(t.onDelete(r),i(null),u(!1))},m=[];for(let e of t.names){let n=e===t.current;m.push((0,T.jsxs)(Ue,{className:_a.item,selected:e===r,onClick:()=>{i(e),u(!1)},onDoubleClick:()=>{d(e)},children:[(0,T.jsx)(`span`,{className:_a.item_name,children:e}),n&&(0,T.jsx)(`span`,{className:_a.item_badge,children:`opened`})]},e))}let h=null;a!==null&&(h=(0,T.jsxs)(`div`,{className:_a.newItem,children:[(0,T.jsx)(`form`,{onSubmit:e=>{e.preventDefault(),f()},children:(0,T.jsx)(`input`,{className:_a.newItem_input,autoFocus:!0,value:a,placeholder:`scene name`,onChange:e=>{o(e.target.value),c(null)}})}),s&&(0,T.jsx)(`div`,{className:_a.newItem_error,children:s})]}));let g=null;if(l&&r)g=(0,T.jsxs)(T.Fragment,{children:[(0,T.jsxs)(`span`,{className:_a.footer_message,children:[`Delete "`,r,`" ?`]}),(0,T.jsx)(ae,{onClick:()=>{u(!1)},children:`Cancel`}),(0,T.jsx)(ae,{onClick:p,children:`Delete`})]});else{let e=r!==null&&t.names.length>1,n=r!==null&&r!==t.current;g=(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(ae,{onClick:()=>{o(``),c(null),u(!1)},children:`+ New`}),(0,T.jsx)(`div`,{className:_a.footer_spacer}),(0,T.jsx)(ae,{disabled:!e,onClick:()=>{u(!0)},children:`Delete`}),(0,T.jsx)(ae,{disabled:!n,onClick:()=>{r&&d(r)},children:`Open`})]})}return(0,T.jsx)(Ae,{title:`Scenes`,note:e.projectName,width:360,onClose:n,footer:g,children:(0,T.jsxs)(`div`,{className:_a.list,children:[m,h]})})},ba={sceneControl:`SceneControl__sceneControl___LnNjZ`,sceneControl_inner:`SceneControl__sceneControl_inner___LnNjZ`,select:`SceneControl__select___LnNjZ`,select_name:`SceneControl__select_name___LnNjZ`,save:`SceneControl__save___LnNjZ`},xa=()=>{let{editor:e,projectName:t,scenes:n}=yr(),[r,i]=(0,b.useState)(!1),a=null;return n&&(a=(0,T.jsx)(Ie,{title:`scene`,children:(0,T.jsxs)(`button`,{className:ba.select,onClick:()=>{i(!0)},children:[(0,T.jsx)(`span`,{className:ba.select_name,children:n.current??`-`}),(0,T.jsx)(ne,{open:!0})]})})),(0,T.jsxs)(`div`,{className:ba.sceneControl,children:[(0,T.jsx)(`div`,{className:ba.sceneControl_inner,children:(0,T.jsxs)(re,{label:t,accordion:!0,children:[a,(0,T.jsx)(`div`,{className:ba.save,children:(0,T.jsx)(ae,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,T.jsx)(ya,{scenes:n,projectName:t,onClose:()=>{i(!1)}})]})},Sa={textures:`Textures__textures___LnRle`,item:`Textures__item___LnRle`,preview:`Textures__preview___LnRle`,img:`Textures__img___LnRle`,placeholder:`Textures__placeholder___LnRle`,name:`Textures__name___LnRle`},Ca=()=>{let{engine:e,editor:t}=yr(),[,n]=(0,b.useState)(0);(0,b.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return F.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{F.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=F.resources.textureList;return(0,T.jsx)(`div`,{className:Sa.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,T.jsxs)(`div`,{className:Sa.item,children:[(0,T.jsx)(`div`,{className:Sa.preview,children:n?(0,T.jsx)(`img`,{src:n,className:Sa.img}):(0,T.jsx)(`div`,{className:Sa.placeholder})}),(0,T.jsx)(`div`,{className:Sa.name,children:e.name})]},e.name)})})},wa=(0,b.createContext)(null),Ta=()=>{let e=(0,b.useContext)(wa);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e},Ea=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,ep=s({EyeRings:()=>tp}),tp=class extends M{constructor(e){super(e);let t=this.engine,n=new Lt({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new Wt({phase:[`deferred`,`shadowMap`],frag:Qf,vert:$f,uniforms:t.uniforms});this.entity.addComponent(N,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(N)}},np=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,sp=s({SkyBox:()=>cp}),cp=class extends M{material;constructor(e){super(e);let t=this.engine;this.material=new Wt({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:zt(`SkyBoxFrag`,op),uniforms:Ht.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}},lp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,dp=s({GridCross:()=>fp}),fp=class extends M{constructor(e){super(e);let t=new Dt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new k(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new Wt({frag:zt(`gridCrossFrag`,lp),vert:zt(`gridCrossVert`,up),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},pp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,hp=s({GridDots:()=>gp}),gp=class extends M{constructor(e){super(e);let t=new At({radius:.1}),n=[],r=[],i=new k(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new Wt({frag:zt(`gridDotsFrag`,pp),vert:zt(`gridDotsVert`,mp),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},_p=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,yp=s({WireCube:()=>bp}),bp=class extends M{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new Dt({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new Wt({phase:[`deferred`],frag:_p,vert:vp,uniforms:Ht.merge(t.uniforms)});this.entity.addComponent(N,{geometry:i,material:s})}},xp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Cp=s({OREngineCube:()=>wp}),wp=class extends M{material;constructor(e){super(e);let t=this.engine;this.material=new Wt({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:zt(`OREngineCubeVert`,Sp),frag:zt(`OREngineCubeFrag`,xp),uniforms:Ht.merge(t.uniforms,{uNoiseTex:{value:F.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(N);n&&(n.material=this.material)}},Tp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Dp=s({OREngineLogo:()=>Op}),Op=class extends M{material;constructor(e){super(e);let t=this.engine;this.material=new Wt({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:zt(`OREngineLogoVert`,Ep),frag:zt(`OREngineLogoFrag`,Tp),uniforms:Ht.merge(t.uniforms)});let n=this.entity.getComponent(N);n&&(n.material=this.material)}},kp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,jp=s({Dust:()=>Mp}),Mp=class extends M{constructor(e){super(e);let t=this.engine,n=new Et,r=e.args?.num||2048,i=new k(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new Wt({phase:[`forward`],drawType:`POINTS`,frag:kp,vert:Ap,uniforms:Ht.merge(t.uniforms)});this.entity.addComponent(N,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(N)}},Np=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
