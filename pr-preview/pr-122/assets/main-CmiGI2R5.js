...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}},fn=class extends Wt{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}},P=class extends dn{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,hn=class extends Ft{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA,magFilter:M.LINEAR,minFilter:M.LINEAR,wrapS:M.CLAMP_TO_EDGE,wrapT:M.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new A(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA})])});let m=1/4*l,h=new P(e,{renderTarget:s[l].rt1,frag:mn,uniforms:ln.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new A(d,f));let g=new P(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new fn({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}},gn=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}},_n=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`,jn=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`,Mn=`// https://qiita.com/aa_debdeb/items/26ab808de6745611df53
...
}`,Rn=4,zn=8,Bn=14,Vn=.05,Hn=class{dofCoc;dofBokeh;dofBlur;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;_colorCollection;_bloomBright;_bloomPasses;constructor(e,t){let n=new P(e,{name:`collection`,frag:En}),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),i=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),a=new P(e,{name:`ssr`,frag:on(`ssr`,Ln),renderTarget:r,uniforms:ln.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`},uSSRBackBuffer:{value:i.textures[0],type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=new P(e,{name:`ssComposite`,frag:on(`ssComposite`,In),uniforms:ln.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSSRTexture:{value:i.textures[0],type:`1i`}})}),s=new A(10,.05,20,.05),c=new P(e,{name:`dof/coc`,frag:kn,uniforms:ln.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR,internalFormat:M.RGBA16F,type:M.HALF_FLOAT,format:M.RGBA})]),passThrough:!0,resolutionRatio:.5}),l=new P(e,{name:`dof/bokeh`,frag:On,uniforms:ln.merge({uCocTex:{value:c.renderTarget.textures[0],type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),passThrough:!0,resolutionRatio:.5}),u=new P(e,{name:`dof/blur`,frag:Dn,uniforms:ln.merge({uBokeTex:{value:l.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),passThrough:!0,resolutionRatio:.5}),d=new P(e,{name:`dof/composite`,frag:An,uniforms:ln.merge({uBokeTex:{value:u.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR,internalFormat:M.RGBA16F,type:M.HALF_FLOAT,format:M.RGBA})])}),f=new P(e,{name:`motionBlurTile`,frag:Fn,uniforms:ln.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),p=new P(e,{name:`motionBlurNeighbor`,frag:Pn,uniforms:ln.merge({uVelTex:{value:f.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]),resolutionRatio:1/16,passThrough:!0}),m=new P(e,{name:`motionBlur`,frag:Nn,uniforms:ln.merge({uVelNeighborTex:{value:p.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16}}),h=new P(e,{name:`fxaa`,frag:jn}),g=new P(e,{name:`bloom/bright`,frag:wn,uniforms:{uShadingTexture:{value:t.shadingBuffer.textures[0],type:`1i`},uThreshold:{value:1,type:`1f`},uBrightness:{value:1,type:`1f`}},resolutionRatio:.5,passThrough:!0}),_=[g],v=[],y=g.renderTarget.textures[0],b=2;for(let t=0;t<Rn;t++){let n=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),i={name:`bloom/blur/`+t+`/v`,renderTarget:n,frag:Mn,uniforms:{uBackBlurTex:{value:y,type:`1i`},uIsVertical:{type:`1i`,value:!0},uWeights:{type:`1fv`,value:xt.gaussWeights(zn)},uBlurRange:{value:2,type:`1f`}},defines:{GAUSS_WEIGHTS:zn.toString(),USE_BACKBLURTEX:``},passThrough:!0,resolutionRatio:1/b};_.push(new P(e,i)),_.push(new P(e,{...i,name:`bloom/blur/`+t+`/h`,renderTarget:r,uniforms:{...i.uniforms,uBackBlurTex:{value:n.textures[0],type:`1i`},uIsVertical:{type:`1i`,value:!1}}})),v.push(r.textures[0]),y=r.textures[0],b*=2}_.push(new P(e,{name:`bloom/composite`,frag:Tn,uniforms:{uBloomTexture:{value:v,type:`1iv`}}})),this.postprocess=new fn({passes:[n,a,o,c,l,u,d,f,p,m,h,..._]}),this._ssr=a,this._ssComposite=o,this.dofCoc=c,this.dofBokeh=l,this.dofBlur=u,this.dofComposite=d,this._motionBlur=m,this._motionBlurTile=f,this._motionBlurNeighbor=p,this._colorCollection=n,this._bloomBright=g,this._bloomPasses=_,this._dofParams=s,this.rtSSR1=r,this.rtSSR2=i,a.uniforms.uGbufferPos.value=t.gBuffer.textures[0],a.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],a.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],o.uniforms.uGbufferPos.value=t.gBuffer.textures[0],o.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],c.uniforms.uGbufferPos.value=t.gBuffer.textures[0],f.uniforms.uVelTex.value=t.gBuffer.textures[4],m.uniforms.uVelTex.value=t.gBuffer.textures[4],m.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}update(e){let t=e.dofParams.kFilmHeight,n=.5*t/Math.tan(.5*(e.fov/180*Math.PI)),r=Math.max(e.dofParams.focusDistance,n),i=Math.min(Vn,Bn/this.dofComposite.renderTarget.size.y),a=1/i,o=n*n/(e.dofParams.fNumber*(r-n)*t*2);this._dofParams.set(r,i,a,o);let s=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=s,this._ssr.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssr.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){if(e.toneMap!==void 0&&(this._colorCollection.enabled=e.toneMap),e.bloom!==void 0)for(let t of this._bloomPasses)t.enabled=e.bloom;e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofBlur.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofBlur.renderTarget&&this.dofBlur.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}setBloomParams(e,t){this._bloomBright.uniforms.uThreshold.value=e,this._bloomBright.uniforms.uBrightness.value=t}dispose(){this.postprocess.dispose(),this.rtSSR1.dispose(),this.rtSSR2.dispose()}},Un=e=>{let t=e.createFrameBuffer();t.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA,magFilter:M.NEAREST,minFilter:M.NEAREST}),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA}),e.createTexture(),e.createTexture(),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]);let n=e.createFrameBuffer({disableDepthBuffer:!0});n.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA}),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA})]);let r=e.createFrameBuffer({disableDepthBuffer:!0});r.setDepthTexture(t.depthTexture),r.setTexture([n.textures[0],t.textures[0],t.textures[4]]);let i=e.createFrameBuffer({disableDepthBuffer:!0});i.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA,magFilter:M.LINEAR,minFilter:M.LINEAR})]);let a=e.createFrameBuffer({disableDepthBuffer:!0});a.setDepthTexture(t.depthTexture),a.setTexture([e.createTexture()]);let o=e.createFrameBuffer();return o.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA,magFilter:M.NEAREST,minFilter:M.NEAREST})]),{gBuffer:t,shadingBuffer:n,forwardBuffer:r,refractionBuffer:i,uiBuffer:a,normalBuffer:o}},Wn=class{camera;offscreen;renderTarget;deferredRenderer;pipelinePostProcess;_pipelineOverride;_sceneConfig;_onDispose;constructor(e){this.camera=null,this.offscreen=e.offscreen,this._pipelineOverride=null,this._sceneConfig=e.sceneConfig,this._onDispose=e.onDispose,this.renderTarget=Un(e.backend),this.deferredRenderer=new Cn({backend:e.backend,envMap:e.envMap,envMapCube:e.envMapCube,renderTarget:this.renderTarget}),this.pipelinePostProcess=new Hn(e.backend,this.renderTarget),e.resolution.x>0&&e.resolution.y>0&&this.resize(e.resolution),this.applyPipelineConfig()}get pipelineOverride(){return this._pipelineOverride}set pipelineOverride(e){this._pipelineOverride=e,this.applyPipelineConfig()}applyPipelineConfig(){let e={...this._sceneConfig,...this._pipelineOverride};this.deferredRenderer.setPassEnabled({ssao:e.ssao,lightShaft:e.lightShaft}),this.pipelinePostProcess.setPassEnabled({toneMap:e.toneMap,motionBlur:e.motionBlur,ssr:e.ssr,dof:e.dof,bloom:e.bloom}),this.pipelinePostProcess.setMotionBlurPower(e.motionBlurPower??1),this.pipelinePostProcess.setBloomParams(e.bloomThreshold??1,e.bloomBrightness??1)}resize(e){let t=this.renderTarget;t.gBuffer.setSize(e),t.shadingBuffer.setSize(e),t.forwardBuffer.setSize(e),t.refractionBuffer.setSize(e),t.uiBuffer.setSize(e),t.normalBuffer.setSize(e),this.deferredRenderer.resize(e),this.pipelinePostProcess.resize(e)}dispose(){this._onDispose(this);let e=this.renderTarget;e.forwardBuffer.dispose();let t=[e.gBuffer,e.shadingBuffer,e.refractionBuffer,e.uiBuffer,e.normalBuffer];for(let e=0;e<t.length;e++){let n=t[e];for(let e=0;e<n.textures.length;e++)n.textures[e].dispose();n.dispose()}e.gBuffer.depthTexture&&e.gBuffer.depthTexture.dispose(),this.deferredRenderer.dispose(),this.pipelinePostProcess.dispose()}},Gn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`,hr=`uniform sampler2D uBackBuffer0;
...
`,_r=class{isEditorFrame=!0;texture;textarget;constructor(e,t){this.texture=e,this.textarget=t}},vr=class extends _r{isEditorTarget=!0;frameBuffer;autoResize;constructor(e,t){super(e.textures[0],M.TEXTURE_2D),this.frameBuffer=e,this.autoResize=t}},yr=class{isEditorRecipe=!0;postprocess;pass;constructor(e,t){this.pass=t,this.postprocess=new fn({name:e,passes:[t]})}},br=class{_renderer;_gl;_targets;_recipes;_readFrameBuffer;_fullscreenBuffer;_texturePass;_texturePostProcess;_viewTarget;constructor(e){this._renderer=e,this._gl=e.backend.gl,this._targets=[],this._recipes=[],this._readFrameBuffer=new Dt(this._gl,{disableDepthBuffer:!0}),this._fullscreenBuffer=new Dt(this._gl,{disableDepthBuffer:!0}).setTexture([new Et(this._gl).setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),this._fullscreenBuffer.setSize(e.resolution),this._texturePass=new P(e.backend,{frag:gr,renderTarget:null}),this._texturePostProcess=new fn({name:`editorTexture`,passes:[this._texturePass]}),this._viewTarget=null}renderEntities(e){let t=this._renderer,n=e.view,r=e.target?e.target.frameBuffer:n.renderTarget.uiBuffer,i=e.materialOverride,a=[];if(e.target&&e.useSceneDepth&&r.setDepthTexture(n.renderTarget.gBuffer.depthTexture),i)for(let t=0;t<e.entities.length;t++){let n=e.entities[t].getComponent(N);a.push(n?n.material:null),n&&(n.material=i)}if(e.depthCompare===`lequal`&&this._gl.depthFunc(M.LEQUAL),t.backend.setBlendEnabled(!0),t.renderCamera(`forward`,e.camera,e.entities,r,t.resolution,{disableClear:e.target===null}),t.backend.setBlendEnabled(!1),e.depthCompare===`lequal`&&this._gl.depthFunc(M.LESS),i)for(let t=0;t<e.entities.length;t++){let n=e.entities[t].getComponent(N);n&&(n.material=a[t])}}renderFullscreen(e,t,n){let r=t,i=this._renderer;if(n){let e=n.frameBuffer;r.pass.renderTarget=e,i.renderPostProcess(r.postprocess,void 0,e.size);return}let a=e.renderTarget.uiBuffer,o=i.resolution;r.pass.renderTarget=this._fullscreenBuffer,i.renderPostProcess(r.postprocess,a,o),i.backend.blit(this._fullscreenBuffer,a,o.x,o.y)}blit(e,t,n,r){let i=this._gl,a=t,o=n?n.frameBuffer:e.renderTarget.uiBuffer,s=o.size,c=r||{x:0,y:0,width:s.x,height:s.y};this._readFrameBuffer.setSize(a.texture.size),i.bindFramebuffer(i.FRAMEBUFFER,this._readFrameBuffer.getFrameBuffer()),i.framebufferTexture2D(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0,a.textarget,a.texture.getTexture(),0),i.bindFramebuffer(i.READ_FRAMEBUFFER,this._readFrameBuffer.getFrameBuffer()),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,o.getFrameBuffer()),i.blitFramebuffer(0,0,a.texture.size.x,a.texture.size.y,c.x,s.y-c.y-c.height,c.x+c.width,s.y-c.y,i.COLOR_BUFFER_BIT,i.NEAREST),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null)}drawToCanvas(e,t){let n=this._renderer,r=n.resolution;n.backend.blit(e.renderTarget.uiBuffer,null,r.x,r.y),t!==n.canvas&&t.getContext(`2d`).drawImage(n.canvas,0,0)}drawTexture(e,t){let n=t.frameBuffer;this._texturePass.uniforms.uSrcTexture={value:e,type:`1i`},this._texturePass.renderTarget=n,this._renderer.renderPostProcess(this._texturePostProcess,void 0,n.size)}async readPixels(e){let t=this._gl,n=e.frameBuffer,r=n.size,i=new Uint8Array(r.x*r.y*4);return t.bindFramebuffer(t.FRAMEBUFFER,n.getFrameBuffer()),t.readPixels(0,0,r.x,r.y,t.RGBA,t.UNSIGNED_BYTE,i),t.bindFramebuffer(t.FRAMEBUFFER,null),i}readView(e){return this._viewTarget||=this.createTarget(),this.blit(e,new _r(e.renderTarget.uiBuffer.textures[0],M.TEXTURE_2D),this._viewTarget),this.readPixels(this._viewTarget)}createTarget(e){let t=new Dt(this._gl,{disableDepthBuffer:!0}).setTexture([new Et(this._gl).setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]);t.setSize(e&&e.size||this._renderer.resolution);let n=new vr(t,!(e&&e.size));return this._targets.push(n),n}resize(e){this._fullscreenBuffer.setSize(e);for(let t=0;t<this._targets.length;t++){let n=this._targets[t];n.autoResize&&n.frameBuffer.setSize(e)}for(let t=0;t<this._recipes.length;t++)this._recipes[t].postprocess.resize(e)}onDrawPass(e){let t=(t,n)=>{if(!t)return;let r=t.textures,i=`currentFace`in t?t.currentFace:M.TEXTURE_2D;for(let t=0;t<r.length;t++){let a=n?n+(r.length>1?`_`+t:``):``;e(new _r(r[t],i),a)}};return this._renderer.on(`drawPass`,t),()=>this._renderer.off(`drawPass`,t)}materials={flat:e=>new dn({vert:dr,frag:ur,phase:[`forward`],drawType:e.lines?`LINES`:`TRIANGLES`,depthTest:e.depthTest??!0,depthWrite:e.depthWrite??!0,uniforms:{uColor:{value:e.color,type:`3fv`}}}),mask:()=>new dn({vert:mr,frag:pr,phase:[`forward`],depthTest:!1}),grid:e=>new dn({vert:dr,frag:fr,phase:[`forward`],depthWrite:!1,uniforms:{uColor:{value:e.color,type:`3fv`},uParams:{value:e.params,type:`3fv`}}})};recipes={outline:(e,t)=>{let n=new yr(`editorOutline`,new P(this._renderer.backend,{frag:hr,renderTarget:null,uniforms:{uMaskTexture:{value:e.texture,type:`1i`},uOutlineColor:{value:new A(t[0],t[1],t[2]),type:`3fv`}}}));return this._recipes.push(n),n}}},xr=e=>new br(e.renderer),Sr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Xp=class extends Ft{wrapperElm;glCanvas;backend;gl;canvasTexture;canvas;canvasCtx;glRenderer;postProcess;viewPort;viewPortRange;viewPortScale;frameSetting;loopSetting;musicBuffer;musicTexture;resizeObserver;canvasSize;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.glCanvas=document.createElement(`canvas`),this.backend=new At(this.glCanvas.getContext(`webgl2`)),this.gl=this.backend.gl,this.canvasSize=new A(this.glCanvas.width,this.glCanvas.height),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0],this.viewPortScale=50,this.frameSetting=null,this.loopSetting={enabled:!1,start:0,end:0},this.resizeObserver=new ResizeObserver(this.onResize.bind(this));let e={renderer:null,createEntity:t=>new nn({...t,engine:e})};this.glRenderer=new rr(this.backend,e),e.renderer=this.glRenderer,this.canvasTexture=new Et(this.gl),this.musicBuffer=null,this.musicTexture=new Et(this.gl),this.musicTexture.setting({type:this.gl.UNSIGNED_BYTE,internalFormat:this.gl.LUMINANCE,format:this.gl.LUMINANCE,magFilter:this.gl.LINEAR,minFilter:this.gl.LINEAR,wrapS:this.gl.MIRRORED_REPEAT}),this.postProcess=new fn({passes:[new P(this.backend,{frag:Yp,uniforms:{uCanvasTex:{type:`1i`,value:null},uMusicTex:{type:`1i`,value:this.musicTexture}},renderTarget:null})]})}onResize(){if(this.wrapperElm){let e=new A(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);if(e.x===0||e.y===0)return;this.glCanvas.width=this.canvas.width=e.x,this.glCanvas.height=this.canvas.height=e.y,this.canvasSize.set(this.glCanvas.width,this.glCanvas.height),this.postProcess.resize(e),this.render()}}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.frameSetting){this.canvasCtx.fillStyle=`#181818`;let e=this.frameToPx(0),t=this.frameToPx(this.frameSetting.duration);this.canvasCtx.fillRect(e,0,t-e,this.canvas.height)}let e=(e,t,n)=>{let r=Math.ceil(this.viewPort[0]/e)*e;this.canvasCtx.beginPath();let i=0;for(;r<this.viewPort[2]&&i<100;){let n=this.frameToPx(r+t);this.canvasCtx.moveTo(n,0),this.canvasCtx.lineTo(n,this.canvas.height),r+=e,i++}this.canvasCtx.strokeStyle=n,this.canvasCtx.lineWidth=1,this.canvasCtx.stroke()};if(e(this.viewPortScale,0,`#555`),e(this.viewPortScale,this.viewPortScale/2,`#333`),this.musicBuffer&&this.frameSetting){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)],s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}if(this.loopSetting.enabled){this.canvasCtx.fillStyle=`#0009`;let e=this.frameToPx(this.loopSetting.start),t=this.frameToPx(this.loopSetting.end);this.canvasCtx.fillRect(0,0,e,this.canvas.height),this.canvasCtx.fillRect(t,0,this.canvas.width-t,this.canvas.height)}this.canvasTexture.attach(this.canvas),this.postProcess.passes&&(this.postProcess.passes[0].uniforms.uCanvasTex.value=this.canvasTexture),this.glRenderer.renderPostProcess(this.postProcess,void 0,this.canvasSize)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.glCanvas),this.onResize()}setViewPort(e,t){this.viewPort=e,this.viewPortRange=[e[2]-e[0],e[3]-e[1]],this.viewPortScale=t,this.render()}setFrameSetting(e){this.frameSetting={duration:Math.round(e.duration),fps:Math.round(e.fps)},this.render()}setMusicBuffer(e){this.musicBuffer=e,setTimeout(()=>{this.render()},100)}setLoopSetting(e,t,n){this.loopSetting={enabled:e,start:t,end:n},this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.glCanvas),this.resizeObserver.disconnect()}},Zp={timelineCanvas:`TimelineCanvas__timelineCanvas___LnRpb`},Qp=()=>{let{viewPort:e,viewPortScale:t,musicBuffer:n,musicBufferVersion:r,glEditor:i}=Jp(),[a,o]=(0,b.useState)(),s=(0,b.useRef)(null);(0,b.useEffect)(()=>{let e=new Xp;return o(e),s.current&&e.setWrapperElm(s.current),()=>{e.dispose()}},[]),(0,b.useEffect)(()=>{a&&e&&t&&a.setViewPort(e,t)},[a,e,t]);let[c]=Q(i?.engine,`timeline/duration`),[l]=Q(i?.engine,`timeline/fps`);(0,b.useEffect)(()=>{a&&c&&l&&a.setFrameSetting({duration:c||0,fps:l||0})},[a,c,l]);let[u]=Q(i,`frameLoop/enabled`),[d]=Q(i,`frameLoop/start`),[f]=Q(i,`frameLoop/end`);return(0,b.useEffect)(()=>{a&&a.setLoopSetting(u||!1,d||0,f||0)},[a,u,d,f]),(0,b.useEffect)(()=>{a&&n&&a.setMusicBuffer(n)},[a,n,r]),(0,T.jsx)(`div`,{className:Zp.timelineCanvas,ref:s})},$p={controls:`TimelineControls__controls___LmNvb`},em=e=>{let{viewPort:t,setCurrentFrame:n,getFrameViewPort:r,zoom:i,scroll:a,setViewPortCenter:o}=Jp(),s=(0,b.useRef)([0,0,0,0]),c=(0,b.useRef)([0,0]);t&&(s.current=t,c.current=[t[2]-t[0],t[3]-t[1]]);let l=(0,b.useRef)(null),u=(0,b.useRef)(null),d=(0,b.useRef)(null),f=(0,b.useRef)(null),p=(0,b.useRef)(null),m=(0,b.useCallback)(e=>{let t=l.current&&l.current.clientWidth||1;if(d.current==0){if(n&&r&&u.current){let i=(e.clientX-u.current.left)/t;n(r(i))}}else if(d.current==1){let n=[e.clientX,e.clientY];if(f.current&&p.current){let e=-(n[0]-f.current[0])/t*c.current[0];o&&o(p.current+e)}}},[n,r,o]),h=(0,b.useCallback)(e=>{d.current=e.button,p.current=(s.current[2]+s.current[0])/2,f.current=[e.clientX,e.clientY],u.current=e.currentTarget.getBoundingClientRect();let t=(e.clientX-u.current.left)/e.currentTarget.clientWidth;d.current==0&&n&&r&&n(r(t)),window.addEventListener(`pointermove`,m);let i=()=>{f.current=null,d.current=null,p.current=null,window.removeEventListener(`pointermove`,m)};return window.addEventListener(`pointerup`,i),()=>{window.removeEventListener(`pointerup`,i),window.removeEventListener(`pointermove`,m)}},[r,n,m]),g=(0,b.useCallback)(e=>{if(d.current!==null||!i||!a)return;e.preventDefault();let t=e.target&&e.target.clientWidth||1,n=Math.abs(e.deltaY);Math.abs(e.deltaX)<n?i(n>50?e.deltaY<0?.9:1.1:1+e.deltaY*.005):a(e.deltaX/t*.5)},[i,a]);return(0,b.useEffect)(()=>{let e=l.current;return e&&e.addEventListener(`wheel`,g,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,g)}},[g]),t?(0,T.jsx)(`div`,{className:$p.controls,onPointerDown:h,ref:l,children:e.children}):null},tm={cursor:`TimelineCursor__cursor___LmN1c`,frame:`TimelineCursor__frame___LmN1c`},nm=()=>{let{viewPort:e,framePlay:t}=Jp();if(!e||!t)return null;let n=e[2]-e[0],r=(t.current-e[0])/n;return(0,T.jsx)(`div`,{className:tm.cursor,style:{left:r*100+`%`},children:(0,T.jsx)(`div`,{className:tm.frame})})},rm={timelineLoop:`TimelineLoop__timelineLoop___LnRpb`,start:`TimelineLoop__start___LnRpb`,end:`TimelineLoop__end___LnRpb`},im={cursor:`TimelineLoopCursor__cursor___LmN1c`},am=({onMove:e})=>{let t=(0,b.useRef)(!1);return(0,T.jsx)(`div`,{className:im.cursor,onPointerDown:e=>{e.buttons==1&&(t.current=!0,e.stopPropagation())},onPointerMove:n=>{let r=n.target;t.current!==!1&&n.buttons==1&&(r.setPointerCapture(n.pointerId),n.buttons==1&&e&&e(n.clientX),n.nativeEvent.preventDefault(),n.nativeEvent.stopPropagation())},onPointerUp:()=>{t.current=!1}})},om=()=>{let{viewPort:e,framePlay:t,glEditor:n}=Jp(),r=(0,b.useRef)(null);hf(n,[`frameLoop/enabled`,`frameLoop/start`,`frameLoop/end`]);let[i]=Q(n,`frameLoop/enabled`),[a,o]=Q(n,`frameLoop/start`),[s,c]=Q(n,`frameLoop/end`);if(i!==!0||!e||!t||a===void 0||s===void 0)return null;let l=e[2]-e[0],u=(a-e[0])/l,d=(s-e[0])/l,f=(t,n)=>{let r=t.getBoundingClientRect();return(n-r.x)/r.width*(e[2]-e[0])+e[0]};return(0,T.jsx)(`div`,{className:rm.timelineLoop,ref:r,children:(0,T.jsxs)(`div`,{className:rm.timelineLoop_inner,children:[(0,T.jsx)(`div`,{className:rm.start,style:{left:u*100+`%`},children:(0,T.jsx)(am,{onMove:e=>{r.current&&o&&o(f(r.current,e))}})}),(0,T.jsx)(`div`,{className:rm.end,style:{left:d*100+`%`},children:(0,T.jsx)(am,{onMove:e=>{r.current&&c&&c(f(r.current,e))}})})]})})},sm={scale:`TimelineScale__scale___LnNjY`,scale_inner:`TimelineScale__scale_inner___LnNjY`,scale_item:`TimelineScale__scale_item___LnNjY`,scale_item_frame:`TimelineScale__scale_item_frame___LnNjY`,scale_item_time:`TimelineScale__scale_item_time___LnNjY`},cm=e=>`${(`00`+Math.floor(e%3600/60)).slice(-2)}:${(`00`+Math.floor(e%60)).slice(-2)}`,lm=()=>{let{glEditor:e,viewPort:t,viewPortScale:n}=Jp(),[r,i]=Q(e?.engine,`timeline/fps`);if(!t||!n||r===void 0)return null;let a=[],o=Math.ceil(t[0]/n)*n,s=0;for(;o<t[2]&&s<100;){let e=(o-t[0])/(t[2]-t[0]),i=o/(r||0);a.push((0,T.jsxs)(`div`,{className:sm.scale_item,style:{left:e*100+`%`},children:[(0,T.jsx)(`div`,{className:sm.scale_item_frame,children:o}),(0,T.jsx)(`div`,{className:sm.scale_item_time,children:cm(i)})]},o)),o+=n,s++}return(0,T.jsx)(`div`,{className:sm.scale,children:(0,T.jsx)(`div`,{className:sm.scale_inner,children:a})})},um={timelineSetting:`TimelineSetting__timelineSetting___LnRpb`,play:`TimelineSetting__play___LnRpb`},dm=()=>{let{framePlay:e,glEditor:t}=Jp(),n=(0,b.useCallback)((e,t)=>{t&&t(e)},[]),[r,i]=Q(t,`frameLoop/enabled`),[a]=Q(t?.engine,`timeline/duration`),[o]=Q(t?.engine,`timeline/fps`),s=(0,b.useCallback)((e,n)=>{t&&t.api.setField(t.engine,e,n)},[t]),c=(0,b.useCallback)(()=>{t&&t.togglePlay()},[t]);return(0,T.jsx)(`div`,{className:um.timelineSetting,children:(0,T.jsxs)(nt,{children:[(0,T.jsx)(`div`,{className:um.play,children:(0,T.jsx)(ae,{onClick:c,children:e.playing?(0,T.jsx)(fe,{size:14}):(0,T.jsx)(pe,{size:14})})}),(0,T.jsx)(He,{title:`current`,children:(0,T.jsx)(Hr,{value:Math.floor(e?.current||0),readOnly:!0})}),(0,T.jsx)(He,{title:`duration`,children:(0,T.jsx)(Hr,{value:a,onChange:e=>s(`timeline/duration`,e)})}),(0,T.jsx)(He,{title:`fps`,children:(0,T.jsx)(Hr,{value:o,onChange:e=>s(`timeline/fps`,e)})}),(0,T.jsx)(He,{title:`loop`,children:(0,T.jsx)(Hr,{value:r||!1,onChange:e=>n(e,i)})})]})})},fm={timeline:`Timeline__timeline___LnRpb`,inner:`Timeline__inner___LnRpb`,content:`Timeline__content___LnRpb`,setting:`Timeline__setting___LnRpb`},pm=()=>{let{editor:e}=Lr(),[t,n]=(0,b.useState)({current:0,playing:!1}),[r,i]=(0,b.useState)([0,0,100,0]),a=(0,b.useRef)([0,0,0,0]);a.current=r;let o=r[2]-r[0],s=10*2**(0+Math.floor(Math.log2(o/100)));s=Math.max(1,Math.floor(s));let c=e?.audioBuffer,[l,u]=(0,b.useState)();(0,b.useEffect)(()=>{if(e){let t=e.engine,r=e=>{n({...e})};r(t.frame);let a=0,o=()=>{u(a++)},s=()=>{i([0,0,t.frameSetting.duration,0])};return s(),t.on(`update/frame/play`,r),t.on(`update/music`,o),t.on(`loaded`,s),()=>{t.off(`update/frame/play`,r),t.off(`update/music`,o),t.off(`loaded`,s)}}},[e]);let d=(0,b.useCallback)(t=>{e&&e.engine.seek(t)},[e]),f=(0,b.useCallback)(e=>{let t=r[2]-r[0];return Math.floor(r[0]+t*e)},[r]),p=(0,b.useCallback)(e=>{let t=a.current,n=(t[2]+t[0])/2,r=(t[0]-n)*e+n,o=(t[2]-n)*e+n;i([r,t[1],o,t[3]])},[]),m=(0,b.useCallback)(e=>{let t=a.current,n=e*(t[2]-t[0]);i([t[0]+n,t[1],t[2]+n,t[3]])},[]),h=(0,b.useCallback)(e=>{let t=a.current,n=t[2]-t[0];i([e-n/2,t[1],e+n/2,t[3]])},[]);return{glEditor:e,framePlay:t,viewPort:r,viewPortScale:s,musicBuffer:c,musicBufferVersion:l,setCurrentFrame:d,getFrameViewPort:f,zoom:p,scroll:m,setViewPortCenter:h}},mm=e=>{let t=pm();return(0,T.jsx)(qp.Provider,{value:t,children:e.children})},hm=()=>(0,T.jsx)(mm,{children:(0,T.jsx)(`div`,{className:fm.timeline,children:(0,T.jsxs)(`div`,{className:fm.inner,children:[(0,T.jsx)(`div`,{className:fm.setting,children:(0,T.jsx)(dm,{})}),(0,T.jsxs)(`div`,{className:fm.content,children:[(0,T.jsx)(Qp,{}),(0,T.jsx)(nm,{}),(0,T.jsx)(em,{children:(0,T.jsx)(om,{})}),(0,T.jsx)(lm,{})]})]})})}),gm={editor:`OREditor__editor___LmVka`},_m=e=>{let{engine:t}=Lf(),[n,r]=(0,b.useState)(()=>new df(t)),i=b.useRef(n);return i.current=n,(0,b.useEffect)(()=>{if(!i.current.disposed&&i.current.engine.uuid==t.uuid)return;let e=new df(t);r(e)},[t]),(0,b.useEffect)(()=>()=>{n.dispose()},[n]),{engine:t,editor:n,projectName:e}},vm=e=>{let t=_m(e.projectName),n=(0,b.useRef)(Promise.resolve());(0,b.useEffect)(()=>{if(!t.editor||!e.onSave)return;let r=e.onSave,i=(e,t)=>{n.current=Promise.resolve(r(e,t))};return t.editor.on(`save`,i),()=>{t.editor.off(`save`,i)}},[t.editor,e.onSave]);let r=(0,b.useRef)(null),i=e.scenes??null;return(0,b.useEffect)(()=>{r.current=i},[i]),(0,b.useEffect)(()=>Ca({editor:t.editor,getScenes:()=>r.current,waitForSave:()=>n.current}),[t.editor]),(0,b.useEffect)(()=>{t.editor&&t.editor.bootstrap(e.editorData)},[e.editorData,t.editor]),(0,T.jsx)(Ir.Provider,{value:{...t,scenes:e.scenes},children:e.children})},ym=[{id:`hierarchy`,title:`Hierarchy`,category:`General`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(Zf,{})})},{id:`timer`,title:`Timer`,category:`Rendering`,content:(0,T.jsx)(nt,{noPadding:!0,children:(0,T.jsx)(Wf,{})})},{id:ap,title:`Screen`,category:`General`,multiple:!0,content:e=>(0,T.jsx)(op,{viewportId:e})},{id:`property`,title:`Property`,category:`General`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(Nf,{})})},{id:`textures`,title:`Textures`,category:`Rendering`,content:(0,T.jsx)(nt,{noPadding:!0,children:(0,T.jsx)(Kp,{})})},{id:`scene`,title:`Scene`,category:`General`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(Wp,{})})},{id:`export`,title:`Export`,category:`Project`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(Ff,{})})},{id:`renderer`,title:`Renderer`,category:`Rendering`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(zp,{})})},{id:`editor-settings`,title:`Editor`,category:`Project`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(Xr,{})})},{id:`timeline`,title:`Timeline`,category:`Animation`,content:(0,T.jsx)(nt,{noPadding:!0,children:(0,T.jsx)(hm,{})})}],bm=e=>{let t=[];for(let n of e)n.multiple||n.id!==`hierarchy`&&n.id!==`property`&&n.id!==`timeline`&&t.push({id:n.id,title:n.title,content:n.content});return t},xm=e=>{let t=vt(),n=(0,b.useMemo)(()=>e.panels?[...ym,...e.panels]:ym,[e.panels]),r=null;return r=t.isPC?(0,T.jsx)(Lp,{panels:n}):(0,T.jsx)(T.Fragment,{children:(0,T.jsxs)(qe,{direction:`vertical`,storageKey:`orengine-editor-sp-main`,children:[(0,T.jsx)(qe.Item,{size:`calc( min( 56.25vw, 55vh ) + 77px )`,minSize:200,style:{minHeight:`200px`},children:(0,T.jsx)(op,{viewportId:`main`})}),(0,T.jsx)(qe.Item,{flex:1,minSize:200,children:(0,T.jsxs)(at,{storageKey:`orengine-panel-sp-main`,children:[(0,T.jsx)(at.Tab,{title:`Hierarchy / Property`,children:(0,T.jsxs)(qe,{direction:`horizontal`,storageKey:`orengine-editor-sp-hierarchyProp`,children:[(0,T.jsx)(qe.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,T.jsx)(Zf,{})}),(0,T.jsx)(qe.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,T.jsx)(Nf,{})})]})}),bm(n).map(e=>(0,T.jsx)(at.Tab,{title:e.title,children:e.content},e.id))]})}),(0,T.jsx)(qe.Item,{size:`120px`,minSize:80,children:(0,T.jsx)(at,{storageKey:`orengine-panel-sp-timeline`,children:(0,T.jsx)(at.Tab,{title:`Timeline`,children:(0,T.jsx)(nt,{noPadding:!0,children:(0,T.jsx)(C,{fallback:(0,T.jsx)(`div`,{children:`エラーだよ`}),children:(0,T.jsx)(hm,{})})})})})})]})}),(0,T.jsx)(vm,{projectName:e.projectName,onSave:e.onSave,editorData:e.editorData,scenes:e.scenes,children:(0,T.jsx)(pt,{children:(0,T.jsxs)(Be,{children:[(0,T.jsx)(`div`,{className:gm.editor,children:r}),(0,T.jsx)(pf,{}),(0,T.jsx)(Re,{}),(0,T.jsx)(ut,{})]})})})},Sm=()=>{let[e,t]=b.useState(()=>new F(ir)),n=b.useRef(e);return n.current=e,(0,b.useEffect)(()=>{n.current.disposed&&t(new F(ir))},[]),(0,b.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,b.useCallback)(t=>{t&&e.load(t)},[e])}},Cm=e=>{let t=Sm(),{engine:n}=t,r=(0,b.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,b.useEffect)(()=>{r.current?.(n)},[n]),(0,b.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,T.jsx)(If.Provider,{value:t,children:e.children})},wm=e=>(0,T.jsx)(Cm,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,T.jsx)(xm,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),Tm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Dm=s({EyeRings:()=>Om}),Om=class extends Gt{constructor(e){super(e);let t=new rn({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new dn({phase:[`deferred`,`shadowMap`],frag:Tm,vert:Em});this.entity.addComponent(N,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(N)}},km=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,jm=s({FlashLine:()=>Mm}),Mm=class extends Gt{geometry;material;constructor(e){super(e),this.geometry=new Jt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=xt.randomVector().multiply(new A(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new dn({phase:[`forward`,`envMap`],frag:on(`flFrag`,km),vert:on(`flVert`,Am)}),this.entity.addComponent(N,{material:this.material,geometry:this.geometry})}},Nm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Pm=s({SkyBox:()=>Fm}),Fm=class extends Gt{material;constructor(e){super(e);let t=this.engine;this.material=new dn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:on(`SkyBoxFrag`,Nm),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}},Im=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Rm=s({GridCross:()=>zm}),zm=class extends Gt{constructor(e){super(e);let t=new qt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new A(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new dn({frag:on(`gridCrossFrag`,Im),vert:on(`gridCrossVert`,Lm),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},Bm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Hm=s({GridDots:()=>Um}),Um=class extends Gt{constructor(e){super(e);let t=new Xt({radius:.1}),n=[],r=[],i=new A(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new dn({frag:on(`gridDotsFrag`,Bm),vert:on(`gridDotsVert`,Vm),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},Wm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,Km=s({WireCube:()=>qm}),qm=class extends Gt{constructor(e){super(e);let t=3.3,n=t/2,r=new qt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new dn({phase:[`deferred`],frag:Wm,vert:Gm});this.entity.addComponent(N,{geometry:r,material:o})}},Jm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Xm=s({OREngineCube:()=>Zm}),Zm=class extends Gt{material;constructor(e){super(e),this.material=new dn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:on(`OREngineCubeVert`,Ym),frag:on(`OREngineCubeFrag`,Jm),uniforms:{uNoiseTex:{value:F.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(N);t&&(t.material=this.material)}},Qm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,eh=s({OREngineLogo:()=>th}),th=class extends Gt{material;constructor(e){super(e),this.material=new dn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:on(`OREngineLogoVert`,$m),frag:on(`OREngineLogoFrag`,Qm)});let t=this.entity.getComponent(N);t&&(t.material=this.material)}},nh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,ih=s({Dust:()=>ah}),ah=class extends Gt{constructor(e){super(e);let t=new Kt,n=e.args?.num||2048,r=new A(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new dn({phase:[`forward`],drawType:`POINTS`,frag:nh,vert:rh});this.entity.addComponent(N,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(N)}},oh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `,lh=s({YakiSoba:()=>uh}),uh=class extends Gt{_gpu;constructor(e){super(e);let t=this.engine,n=new A(64,512);this._gpu=new cr({passes:[new lr(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:on(`yakiSobaCompute`,ch),uniforms:ln.merge({},t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new qt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new dn({frag:on(`chainFrag`,oh),vert:on(`chainVert`,sh),phase:[`deferred`,`shadowMap`],uniforms:ln.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(N,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(N),this._gpu.dispose()}},dh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `,Lh=Object.assign({"../../demo-webgl/Resources/Textures/hash.tex":Ph,"../../demo-webgl/Resources/Textures/noise.tex":Fh,"../../demo-webgl/Resources/Textures/noiseCyclic.tex":{name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:Ih},"../../demo-webgl/Resources/Textures/noiseCyclicAnime.tex":{name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:Ih}}),Rh=()=>{for(let e of Object.values(Lh))e&&F.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},zh=e=>{F.resources.buildTextureInstances(e.renderer)},Bh=Object.assign({"../../demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":Dm,"../../demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":jm,"../../demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":Pm,"../../demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":Rm,"../../demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":Hm,"../../demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":Km,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":Xm,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":eh,"../../demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":ih,"../../demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":lh,"../../demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":fh}),Vh=Object.assign({}),Hh=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addComponent(i,a):Hh(a,t.createGroup(i))}},Uh=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addGeometry(i,a):Uh(a,t.createGroup(i))}},Wh=()=>{Ut.gltfLoaderFactory=e=>new Or(e),F.resources.clear();let e=F.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,$t),e.addComponent(`Camera`,Zt),e.addComponent(`Mesh`,N);let t=Object.keys(Mh);for(let e=0;e<t.length;e++){let n=t[e],r=Mh[n];Hh(r,F.resources.addComponentGroup(n))}let n=Object.keys(Nh);for(let e=0;e<n.length;e++){let t=n[e],r=Nh[t];Uh(r,F.resources.addGeometryGroup(t))}let r=jr(Bh,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t];Hh(n,F.resources.addComponentGroup(t))}let a=jr(Vh,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t];Uh(n,F.resources.addGeometryGroup(t))}Rh()},Gh=s({panel:()=>Kh}),Kh={id:`sample`,title:`Sample`,category:`Tools`,content:(0,T.jsx)(()=>{let{editor:e,engine:t}=Lr(),[n]=Q(e,`selectedEntityId`),[r,i]=(0,b.useState)(``),a=n?t.root.findEntityByUUID(n):void 0;return(0,T.jsxs)(nt,{children:[(0,T.jsx)(re,{label:`Selected Entity`,children:a?a.name:`-`}),(0,T.jsxs)(re,{label:`Server`,children:[(0,T.jsx)(ae,{onClick:async()=>{try{let e=await(await fetch(`/api/ext/hello`)).json();i(e.message)}catch{i(`failed`)}},children:`GET /api/ext/hello`}),r&&(0,T.jsx)(`p`,{children:r})]})]})},{})},qh=Object.assign({"../../demo-webgl/editor/Panels/Sample/index.tsx":Gh}),Jh=(()=>{let e=[],t=Object.keys(qh);for(let n=0;n<t.length;n++){let r=qh[t[n]].panel;r&&e.push(r)}return e})();document.title=`demo-webgl`,Wh(),_.createRoot(document.getElementById(`root`)).render((0,T.jsx)(wm,{projectName:`demo-webgl`,sceneData:y,editorData:v,initResourceInstances:zh,panels:Jh}));