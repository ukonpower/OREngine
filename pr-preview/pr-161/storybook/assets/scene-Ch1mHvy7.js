...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}}})))()}var gn;function _n(){return(_n=t((()=>{wt(),gn=class extends Ct{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}}})))()}function vn(){return(vn=t((()=>{})))()}function yn(){return(yn=t((()=>{})))()}var M;function bn(){return(bn=t((()=>{D(),Xe(),hn(),vn(),yn(),M=class extends mn{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Tn;function En(){return(En=t((()=>{ot(),D(),N(),Xe(),wn(),Tn=class extends nt{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA,magFilter:O.LINEAR,minFilter:O.LINEAR,wrapS:O.CLAMP_TO_EDGE,wrapT:O.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new T(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA})])});let m=1/4*l,h=new M(e,{renderTarget:s[l].rt1,frag:Cn,uniforms:sn.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new T(d,f));let g=new M(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new gn({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}}})))()}var Dn;function On(){return(On=t((()=>{Dn=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}}})))()}var kn,An,jn,Mn,Nn,Pn;function Fn(){return(Fn=t((()=>{kn=[[.1,.0484],[.118,.187],[.113,.567],[.358,1.99],[.078,7.41]],An=[1,.37,.3],jn=[.48,.41,.28],Mn=2,Nn=(e,t)=>{let n=e/(.001+An[t]),r=0;for(let[e,t]of kn)r+=e*Math.exp(-(n*n)/(2*t))/(2*Math.PI*t);return r},Pn=e=>{let t=[];for(let n=0;n<e;n++){let r=Mn*n/(e-1);t.push(r*r/Mn)}let n=[];for(let r=0;r<e;r++){let i=0;i=r===0?t[1]:r===e-1?(t[r]-t[r-1])/2:(t[r+1]-t[r-1])/2,n.push(i)}let r=[];for(let i=0;i<3;i++){let a=[],o=0;for(let r=0;r<e;r++){let e=n[r]*Nn(t[r],i);a.push(e),o+=r===0?e:e*2}let s=jn[i];for(let t=0;t<e;t++){let e=a[t]/o*s;t===0&&(e+=1-s),r[t*4+i]=e}}for(let n=0;n<e;n++)r[n*4+3]=t[n]/Mn;return r}})))()}var In;function Ln(){return(Ln=t((()=>{In=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Bn;function Vn(){return(Vn=t((()=>{Bn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})))()}var Jn,Yn,Xn;function Zn(){return(Zn=t((()=>{ot(),D(),N(),Fn(),Xe(),Ln(),zn(),Vn(),Un(),Gn(),qn(),Jn=e=>{let t=[];for(let n=0;n<e;n++){let r=new T;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},Yn=9,Xn=class extends nt{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;shading;sssH;sssV;sssCopy;constructor(e){super();let t=e.backend,n=e.renderTarget,r=new M(t,{name:`normalSelector`,frag:Bn,renderTarget:null,uniforms:sn.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),a=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),o=new M(t,{name:`lightShaft`,frag:Rn,renderTarget:i,uniforms:sn.merge({uLightShaftBackBuffer:{value:a.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),c=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),l=new M(t,{name:`ssao`,frag:Hn,renderTarget:j(`ssao`,s),uniforms:sn.merge({uSSAOBackBuffer:{value:c.textures[0],type:`1i`},uSSAOKernel:{value:Jn(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),u=sn.merge({uSSAOTexture:{value:c.textures[0],type:`1i`},uPosTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:je.gaussWeights(8)}}),d=new M(t,{name:`ssaoBlur/h`,frag:j(`ssaoBlur`,Wn),uniforms:u,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),f=new M(t,{name:`ssaoBlur/v`,frag:j(`ssaoBlur`,Wn),uniforms:sn.merge(u,{uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),p=new M(t,{name:`deferredShading`,frag:j(`deferredShading`,In),uniforms:sn.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:f.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:l.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})}),m=()=>t.createFrameBuffer({disableDepthBuffer:!0}).setTexture([t.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA,magFilter:O.LINEAR,minFilter:O.LINEAR})]),h=sn.merge({uDiffuseTexture:{value:n.shadingBuffer.textures[1],type:`1i`},uAlbedoTexture:{value:n.gBuffer.textures[2],type:`1i`},uPosTexture:{value:n.gBuffer.textures[0],type:`1i`},uNormalTexture:{value:n.normalBuffer.textures[0],type:`1i`},uSSSRadius:{value:.05,type:`1f`},uKernel:{value:Pn(Yn),type:`4fv`}}),g=new M(t,{name:`sss/h`,frag:j(`sss`,Kn),uniforms:h,renderTarget:m(),passThrough:!0,defines:{SSS_SAMPLES:Yn}}),_=new M(t,{name:`sss/v`,frag:j(`sss`,Kn),uniforms:sn.merge(h,{uDiffuseTexture:{value:g.renderTarget.textures[0],type:`1i`},uShadingTexture:{value:n.shadingBuffer.textures[0],type:`1i`},uShadingDiffuseTexture:{value:n.shadingBuffer.textures[1],type:`1i`}}),renderTarget:m(),defines:{SSS_SAMPLES:Yn,IS_VIRT:``}}),v=new M(t,{name:`sss/copy`,renderTarget:t.createFrameBuffer({disableDepthBuffer:!0}).setTexture([n.shadingBuffer.textures[0]])});this.postprocess=new gn({passes:[r,o,l,d,f,p,g,_,v]}),this.shading=p,this.lightShaft=o,this.ssao=l,this.rtSSAO1=s,this.rtSSAO2=c,this.ssaoBlur=d,this.ssaoBlurV=f,this.sssH=g,this.sssV=_,this.sssCopy=v,this.rtLightShaft1=i,this.rtLightShaft2=a,this.normalSelector_=r;for(let e=0;e<n.gBuffer.textures.length;e++){let t=n.gBuffer.textures[e];e===1&&(t=n.normalBuffer.textures[0]),p.uniforms[`sampler`+e]=l.uniforms[`sampler`+e]={type:`1i`,value:t}}o.uniforms.uDepthTexture.value=n.gBuffer.depthTexture,p.renderTarget=n.shadingBuffer,r.renderTarget=n.normalBuffer,r.uniforms.uNormalTexture.value=n.gBuffer.textures[1],r.uniforms.uPosTexture.value=n.gBuffer.textures[0],r.uniforms.uSelectorTexture.value=n.gBuffer.textures[3],u.uPosTexture.value=n.gBuffer.textures[0],u.uNormalTexture.value=n.normalBuffer.textures[0]}update(){let e=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=e,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],e=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=e,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.sss!==void 0&&(this.sssH.enabled=e.sss,this.sssV.enabled=e.sss,this.sssCopy.enabled=e.sss),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}setSSSRadius(e){this.sssH.uniforms.uSSSRadius.value=e}resize(e){this.postprocess.resize(e)}dispose(){this.postprocess.dispose(),this.rtLightShaft1.dispose(),this.rtLightShaft2.dispose(),this.rtSSAO1.dispose(),this.rtSSAO2.dispose();for(let e of[this.sssH,this.sssV])e.renderTarget.textures[0].dispose(),e.renderTarget.dispose();this.sssCopy.renderTarget.dispose()}}})))()}var Qn;function $n(){return($n=t((()=>{Qn=`uniform sampler2D uShadingTexture;
...
}`})))()}var nr;function rr(){return(rr=t((()=>{nr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})))()}var fr;function pr(){return(pr=t((()=>{fr=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`})))()}var mr;function hr(){return(hr=t((()=>{mr=`// https://qiita.com/aa_debdeb/items/26ab808de6745611df53
...
}`})))()}var gr;function _r(){return(_r=t((()=>{gr=`in vec2 vUv;
...
}`})))()}var vr;function yr(){return(yr=t((()=>{vr=`in vec2 vUv;
uniform sampler2D uBackBuffer0;
uniform sampler2D uVelTex;
uniform vec2 uPPPixelSize;
...
}`})))()}var Sr;function Cr(){return(Cr=t((()=>{Sr=`// フレネルと粗さで重み付けして反射色を足す
...
`})))()}var wr;function Tr(){return(Tr=t((()=>{wr=`// 反射方向へレイマーチしてシーンを引く。今フレームの結果だけを出し、時間方向の蓄積は ssrTemporal.fs が行う
...
}`})))()}var Er;function Dr(){return(Dr=t((()=>{Er=`// ssr.fs の今フレームの結果を、前フレームの結果と混ぜて均す。
...
}`})))()}var GS=n({EyeRings:()=>KS}),KS;function qS(){return(qS=t((()=>{N(),HS(),WS(),KS=class extends k{constructor(e){super(e);let t=new Qt({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new mn({phase:[`deferred`,`shadowMap`],frag:VS,vert:US});this.entity.addComponent(A,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var JS;function YS(){return(YS=t((()=>{JS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var QS=n({FlashLine:()=>$S}),$S;function eC(){return(eC=t((()=>{D(),N(),YS(),ZS(),$S=class extends k{geometry;material;constructor(e){super(e),this.geometry=new At({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=je.randomVector().multiply(new T(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new mn({phase:[`forward`,`envMap`],frag:j(`flFrag`,JS),vert:j(`flVert`,XS)}),this.entity.addComponent(A,{material:this.material,geometry:this.geometry})}}})))()}var tC;function nC(){return(nC=t((()=>{tC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var uC=n({GridCross:()=>dC}),dC;function fC(){return(fC=t((()=>{D(),N(),sC(),lC(),dC=class extends k{constructor(e){super(e);let t=new Ot({width:.05,height:.5,depth:.05}),n=[],r=[],i=new T(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new mn({frag:j(`gridCrossFrag`,oC),vert:j(`gridCrossVert`,cC),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var pC;function mC(){return(mC=t((()=>{pC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var _C=n({GridDots:()=>vC}),vC;function yC(){return(yC=t((()=>{D(),N(),mC(),gC(),vC=class extends k{constructor(e){super(e);let t=new Pt({radius:.1}),n=[],r=[],i=new T(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new mn({frag:j(`gridDotsFrag`,pC),vert:j(`gridDotsVert`,hC),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var bC;function xC(){return(xC=t((()=>{bC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var VC=n({OREngineLogo:()=>HC}),HC;function UC(){return(UC=t((()=>{N(),RC(),BC(),HC=class extends k{material;constructor(e){super(e),this.material=new mn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:j(`OREngineLogoVert`,zC),frag:j(`OREngineLogoFrag`,LC)});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var WC;function GC(){return(GC=t((()=>{WC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var JC=n({Dust:()=>YC}),YC;function XC(){return(XC=t((()=>{D(),N(),GC(),qC(),YC=class extends k{constructor(e){super(e);let t=new Et,n=e.args?.num||2048,r=new T(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new mn({phase:[`forward`],drawType:`POINTS`,frag:WC,vert:KC});this.entity.addComponent(A,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var ZC;function QC(){return(QC=t((()=>{ZC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
