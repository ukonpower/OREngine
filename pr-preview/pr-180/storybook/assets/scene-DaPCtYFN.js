...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}}})))()}var bn;function xn(){return(xn=t((()=>{Tt(),bn=class extends wt{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}}})))()}function Sn(){return(Sn=t((()=>{})))()}function Cn(){return(Cn=t((()=>{})))()}var M;function wn(){return(wn=t((()=>{D(),Xe(),yn(),Sn(),Cn(),M=class extends vn{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var kn;function An(){return(An=t((()=>{ot(),D(),N(),Xe(),On(),kn=class extends nt{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA,magFilter:O.LINEAR,minFilter:O.LINEAR,wrapS:O.CLAMP_TO_EDGE,wrapT:O.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new T(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA})])});let m=1/4*l,h=new M(e,{renderTarget:s[l].rt1,frag:Dn,uniforms:dn.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new T(d,f));let g=new M(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new bn({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}}})))()}var jn;function Mn(){return(Mn=t((()=>{jn=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}}})))()}var Nn,Pn,Fn,In,Ln,Rn;function zn(){return(zn=t((()=>{Nn=[[.1,.0484],[.118,.187],[.113,.567],[.358,1.99],[.078,7.41]],Pn=[1,.37,.3],Fn=[.48,.41,.28],In=2,Ln=(e,t)=>{let n=e/(.001+Pn[t]),r=0;for(let[e,t]of Nn)r+=e*Math.exp(-(n*n)/(2*t))/(2*Math.PI*t);return r},Rn=e=>{let t=[];for(let n=0;n<e;n++){let r=In*n/(e-1);t.push(r*r/In)}let n=[];for(let r=0;r<e;r++){let i=0;i=r===0?t[1]:r===e-1?(t[r]-t[r-1])/2:(t[r+1]-t[r-1])/2,n.push(i)}let r=[];for(let i=0;i<3;i++){let a=[],o=0;for(let r=0;r<e;r++){let e=n[r]*Ln(t[r],i);a.push(e),o+=r===0?e:e*2}let s=Fn[i];for(let t=0;t<e;t++){let e=a[t]/o*s;t===0&&(e+=1-s),r[t*4+i]=e}}for(let n=0;n<e;n++)r[n*4+3]=t[n]/In;return r}})))()}var Bn;function Vn(){return(Vn=t((()=>{Bn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
}`})))()}var Hn;function Un(){return(Un=t((()=>{Hn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})))()}var Qn,$n,er;function tr(){return(tr=t((()=>{ot(),D(),N(),zn(),Xe(),Vn(),Un(),Gn(),qn(),Yn(),Zn(),Qn=e=>{let t=[];for(let n=0;n<e;n++){let r=new T;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},$n=9,er=class extends nt{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;shading;sssH;sssV;sssCopy;constructor(e){super();let t=e.backend,n=e.renderTarget,r=new M(t,{name:`normalSelector`,frag:Wn,renderTarget:null,uniforms:dn.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),a=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),o=new M(t,{name:`lightShaft`,frag:Hn,renderTarget:i,uniforms:dn.merge({uLightShaftBackBuffer:{value:a.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),c=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),l=new M(t,{name:`ssao`,frag:Kn,renderTarget:j(`ssao`,s),uniforms:dn.merge({uSSAOBackBuffer:{value:c.textures[0],type:`1i`},uSSAOKernel:{value:Qn(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),u=dn.merge({uSSAOTexture:{value:c.textures[0],type:`1i`},uPosTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:je.gaussWeights(8)}}),d=new M(t,{name:`ssaoBlur/h`,frag:j(`ssaoBlur`,Jn),uniforms:u,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),f=new M(t,{name:`ssaoBlur/v`,frag:j(`ssaoBlur`,Jn),uniforms:dn.merge(u,{uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),p=new M(t,{name:`deferredShading`,frag:j(`deferredShading`,Bn),uniforms:dn.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:f.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:l.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})}),m=()=>t.createFrameBuffer({disableDepthBuffer:!0}).setTexture([t.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA,magFilter:O.LINEAR,minFilter:O.LINEAR})]),h=dn.merge({uDiffuseTexture:{value:n.shadingBuffer.textures[1],type:`1i`},uAlbedoTexture:{value:n.gBuffer.textures[2],type:`1i`},uPosTexture:{value:n.gBuffer.textures[0],type:`1i`},uNormalTexture:{value:n.normalBuffer.textures[0],type:`1i`},uSSSRadius:{value:.05,type:`1f`},uKernel:{value:Rn($n),type:`4fv`}}),g=new M(t,{name:`sss/h`,frag:j(`sss`,Xn),uniforms:h,renderTarget:m(),passThrough:!0,defines:{SSS_SAMPLES:$n}}),_=new M(t,{name:`sss/v`,frag:j(`sss`,Xn),uniforms:dn.merge(h,{uDiffuseTexture:{value:g.renderTarget.textures[0],type:`1i`},uShadingTexture:{value:n.shadingBuffer.textures[0],type:`1i`},uShadingDiffuseTexture:{value:n.shadingBuffer.textures[1],type:`1i`}}),renderTarget:m(),defines:{SSS_SAMPLES:$n,IS_VIRT:``}}),v=new M(t,{name:`sss/copy`,renderTarget:t.createFrameBuffer({disableDepthBuffer:!0}).setTexture([n.shadingBuffer.textures[0]])});this.postprocess=new bn({passes:[r,o,l,d,f,p,g,_,v]}),this.shading=p,this.lightShaft=o,this.ssao=l,this.rtSSAO1=s,this.rtSSAO2=c,this.ssaoBlur=d,this.ssaoBlurV=f,this.sssH=g,this.sssV=_,this.sssCopy=v,this.rtLightShaft1=i,this.rtLightShaft2=a,this.normalSelector_=r;for(let e=0;e<n.gBuffer.textures.length;e++){let t=n.gBuffer.textures[e];e===1&&(t=n.normalBuffer.textures[0]),p.uniforms[`sampler`+e]=l.uniforms[`sampler`+e]={type:`1i`,value:t}}o.uniforms.uDepthTexture.value=n.gBuffer.depthTexture,p.renderTarget=n.shadingBuffer,r.renderTarget=n.normalBuffer,r.uniforms.uNormalTexture.value=n.gBuffer.textures[1],r.uniforms.uPosTexture.value=n.gBuffer.textures[0],r.uniforms.uSelectorTexture.value=n.gBuffer.textures[3],u.uPosTexture.value=n.gBuffer.textures[0],u.uNormalTexture.value=n.normalBuffer.textures[0]}update(){let e=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=e,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],e=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=e,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.sss!==void 0&&(this.sssH.enabled=e.sss,this.sssV.enabled=e.sss,this.sssCopy.enabled=e.sss),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}setSSSRadius(e){this.sssH.uniforms.uSSSRadius.value=e}resize(e){this.postprocess.resize(e)}dispose(){this.postprocess.dispose(),this.rtLightShaft1.dispose(),this.rtLightShaft2.dispose(),this.rtSSAO1.dispose(),this.rtSSAO2.dispose();for(let e of[this.sssH,this.sssV])e.renderTarget.textures[0].dispose(),e.renderTarget.dispose();this.sssCopy.renderTarget.dispose()}}})))()}var nr;function rr(){return(rr=t((()=>{nr=`uniform sampler2D uShadingTexture;
...
}`})))()}var ir;function ar(){return(ar=t((()=>{ir=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})))()}var gr;function _r(){return(_r=t((()=>{gr=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`})))()}var vr;function yr(){return(yr=t((()=>{vr=`// https://qiita.com/aa_debdeb/items/26ab808de6745611df53
...
}`})))()}var br;function xr(){return(xr=t((()=>{br=`in vec2 vUv;
...
}`})))()}var Er;function Dr(){return(Dr=t((()=>{Er=`// フレネルと粗さで重み付けして反射色を足す
...
`})))()}var Or;function kr(){return(kr=t((()=>{Or=`// 反射方向へレイマーチしてシーンを引く。今フレームの結果だけを出し、時間方向の蓄積は ssrTemporal.fs が行う
...
}`})))()}var Ar;function jr(){return(jr=t((()=>{Ar=`// ssr.fs の今フレームの結果を、前フレームの結果と混ぜて均す。
...
`})))()}var Mr,Nr,Pr,Fr,Ir;function Lr(){return(Lr=t((()=>{D(),N(),Xe(),rr(),ar(),sr(),lr(),dr(),pr(),hr(),_r(),yr(),xr(),Cr(),Tr(),Dr(),kr(),jr(),Mr=4,Nr=8,Pr=14/1080,Fr=e=>e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA,magFilter:O.LINEAR,minFilter:O.LINEAR})]),Ir=class{dofCoc;dofBokeh;dofBlur;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssrTemporal;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;_colorCollection;_bloomBright;_bloomPasses;constructor(e,t){let n=new M(e,{name:`collection`,frag:or,uniforms:{uToneMap:{value:1,type:`1f`},uExposure:{value:1,type:`1f`}}}),r=new M(e,{name:`ssr`,frag:j(`ssr`,Or),renderTarget:Fr(e),uniforms:dn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),i=Fr(e),a=Fr(e),o=new M(e,{name:`ssrTemporal`,frag:j(`ssrTemporal`,Ar),renderTarget:i,uniforms:dn.merge({uSSRCurrent:{value:r.renderTarget.textures[0],type:`1i`},uSSRBackBuffer:{value:a.textures[0],type:`1i`},uGbufferPos:{value:null,type:`1i`},uVelTex:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),s=new M(e,{name:`ssComposite`,frag:j(`ssComposite`,Er),uniforms:dn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uGbufferMaterial:{value:null,type:`1i`},uSSRTexture:{value:i.textures[0],type:`1i`}}),renderTarget:Fr(e)}),c=new T(10,.05,20,.05),l=new M(e,{name:`dof/coc`,frag:fr,uniforms:dn.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:c,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR,internalFormat:O.RGBA16F,type:O.HALF_FLOAT,format:O.RGBA})]),passThrough:!0,resolutionRatio:.5}),u=new M(e,{name:`dof/bokeh`,frag:ur,uniforms:dn.merge({uCocTex:{value:l.renderTarget.textures[0],type:`1i`},uParams:{value:c,type:`4f`}}),renderTarget:Fr(e),passThrough:!0,resolutionRatio:.5}),d=new M(e,{name:`dof/blur`,frag:cr,uniforms:dn.merge({uBokeTex:{value:u.renderTarget.textures[0],type:`1i`}}),renderTarget:Fr(e),passThrough:!0,resolutionRatio:.5}),f=new M(e,{name:`dof/composite`,frag:mr,uniforms:dn.merge({uBokeTex:{value:d.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR,internalFormat:O.RGBA16F,type:O.HALF_FLOAT,format:O.RGBA})])}),p=new M(e,{name:`motionBlurTile`,frag:wr,uniforms:dn.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),m=new M(e,{name:`motionBlurNeighbor`,frag:Sr,uniforms:dn.merge({uVelTex:{value:p.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA})]),resolutionRatio:1/16,passThrough:!0}),h=new M(e,{name:`motionBlur`,frag:br,uniforms:dn.merge({uVelNeighborTex:{value:m.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16},renderTarget:Fr(e)}),g=new M(e,{name:`fxaa`,frag:gr}),_=new M(e,{name:`bloom/bright`,frag:nr,uniforms:{uShadingTexture:{value:t.shadingBuffer.textures[0],type:`1i`},uThreshold:{value:1,type:`1f`},uBrightness:{value:1,type:`1f`}},renderTarget:Fr(e),resolutionRatio:.5,passThrough:!0}),v=[_],y=[],b=_.renderTarget.textures[0],x=2;for(let t=0;t<Mr;t++){let n=Fr(e),r=Fr(e),i={name:`bloom/blur/`+t+`/v`,renderTarget:n,frag:vr,uniforms:{uBackBlurTex:{value:b,type:`1i`},uIsVertical:{type:`1i`,value:!0},uWeights:{type:`1fv`,value:je.gaussWeights(Nr)},uBlurRange:{value:2,type:`1f`}},defines:{GAUSS_WEIGHTS:Nr.toString(),USE_BACKBLURTEX:``},passThrough:!0,resolutionRatio:1/x};v.push(new M(e,i)),v.push(new M(e,{...i,name:`bloom/blur/`+t+`/h`,renderTarget:r,uniforms:{...i.uniforms,uBackBlurTex:{value:n.textures[0],type:`1i`},uIsVertical:{type:`1i`,value:!1}}})),y.push(r.textures[0]),b=r.textures[0],x*=2}v.push(new M(e,{name:`bloom/composite`,frag:ir,uniforms:{uBloomTexture:{value:y,type:`1iv`}},renderTarget:Fr(e)})),this.postprocess=new bn({passes:[r,o,s,l,u,d,f,p,m,h,...v,n,g]}),this._ssr=r,this._ssrTemporal=o,this._ssComposite=s,this.dofCoc=l,this.dofBokeh=u,this.dofBlur=d,this.dofComposite=f,this._motionBlur=h,this._motionBlurTile=p,this._motionBlurNeighbor=m,this._colorCollection=n,this._bloomBright=_,this._bloomPasses=v,this._dofParams=c,this.rtSSR1=i,this.rtSSR2=a,r.uniforms.uGbufferPos.value=t.gBuffer.textures[0],r.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],r.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],o.uniforms.uGbufferPos.value=t.gBuffer.textures[0],o.uniforms.uVelTex.value=t.gBuffer.textures[4],s.uniforms.uGbufferPos.value=t.gBuffer.textures[0],s.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],s.uniforms.uGbufferMaterial.value=t.gBuffer.textures[3],l.uniforms.uGbufferPos.value=t.gBuffer.textures[0],p.uniforms.uVelTex.value=t.gBuffer.textures[4],h.uniforms.uVelTex.value=t.gBuffer.textures[4],h.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}update(e){let t=e.dofParams.kFilmHeight,n=.5*t/Math.tan(.5*(e.fov/180*Math.PI)),r=Math.max(e.dofParams.focusDistance,n),i=Pr,a=1/i,o=n*n/(e.dofParams.fNumber*(r-n)*t*2);this._dofParams.set(r,i,a,o);let s=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=s,this._ssrTemporal.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssrTemporal.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){if(e.toneMap!==void 0&&(this._colorCollection.uniforms.uToneMap.value=+!!e.toneMap),e.bloom!==void 0)for(let t of this._bloomPasses)t.enabled=e.bloom;e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssrTemporal.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofBlur.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofBlur.renderTarget&&this.dofBlur.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}setExposure(e){this._colorCollection.uniforms.uExposure.value=2**e}setBloomParams(e,t){this._bloomBright.uniforms.uThreshold.value=e,this._bloomBright.uniforms.uBrightness.value=t}dispose(){this.postprocess.dispose(),this.rtSSR1.dispose(),this.rtSSR2.dispose()}}})))()}var Rr,zr;function Br(){return(Br=t((()=>{D(),Xe(),tr(),Lr(),Rr=e=>{let t=e.createFrameBuffer();t.setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA,magFilter:O.NEAREST,minFilter:O.NEAREST}),e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA}),e.createTexture().setting({internalFormat:O.SRGB8_ALPHA8}),e.createTexture(),e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA})]);let n=e.createFrameBuffer({disableDepthBuffer:!0});n.setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA}),e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA})]);let r=e.createFrameBuffer({disableDepthBuffer:!0});r.setDepthTexture(t.depthTexture),r.setTexture([n.textures[0],t.textures[0],t.textures[4]]);let i=e.createFrameBuffer({disableDepthBuffer:!0});i.setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA,magFilter:O.LINEAR,minFilter:O.LINEAR})]);let a=e.createFrameBuffer({disableDepthBuffer:!0});a.setDepthTexture(t.depthTexture),a.setTexture([e.createTexture()]);let o=e.createFrameBuffer();return o.setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA,magFilter:O.NEAREST,minFilter:O.NEAREST})]),{gBuffer:t,shadingBuffer:n,forwardBuffer:r,refractionBuffer:i,uiBuffer:a,normalBuffer:o}},zr=class{camera;size;resolution;offscreen;renderTarget;deferredRenderer;pipelinePostProcess;_pipelineOverride;_sceneConfig;_onDispose;constructor(e){this.camera=null,this.size=null,this.resolution=new T,this.offscreen=e.offscreen,this._pipelineOverride=null,this._sceneConfig=e.sceneConfig,this._onDispose=e.onDispose,this.renderTarget=Rr(e.backend),this.deferredRenderer=new er({backend:e.backend,envMap:e.envMap,envMapCube:e.envMapCube,renderTarget:this.renderTarget}),this.pipelinePostProcess=new Ir(e.backend,this.renderTarget),this.fit(e.resolution),this.applyPipelineConfig()}get pipelineOverride(){return this._pipelineOverride}set pipelineOverride(e){this._pipelineOverride=e,this.applyPipelineConfig()}applyPipelineConfig(){let e={...this._sceneConfig,...this._pipelineOverride};this.deferredRenderer.setPassEnabled({ssao:e.ssao,lightShaft:e.lightShaft,sss:e.sss}),this.deferredRenderer.setSSSRadius(e.sssRadius??.05),this.pipelinePostProcess.setPassEnabled({toneMap:e.toneMap,motionBlur:e.motionBlur,ssr:e.ssr,dof:e.dof,bloom:e.bloom}),this.pipelinePostProcess.setMotionBlurPower(e.motionBlurPower??1),this.pipelinePostProcess.setExposure(e.exposure??0),this.pipelinePostProcess.setBloomParams(e.bloomThreshold??1,e.bloomBrightness??1)}fit(e){e.x<=0||e.y<=0||(this.resolution.x!==e.x||this.resolution.y!==e.y)&&this.resize(e)}resize(e){this.resolution.copy(e);let t=this.renderTarget;t.gBuffer.setSize(e),t.shadingBuffer.setSize(e),t.forwardBuffer.setSize(e),t.refractionBuffer.setSize(e),t.uiBuffer.setSize(e),t.normalBuffer.setSize(e),this.deferredRenderer.resize(e),this.pipelinePostProcess.resize(e)}dispose(){this._onDispose(this);let e=this.renderTarget;e.forwardBuffer.dispose();let t=[e.gBuffer,e.shadingBuffer,e.refractionBuffer,e.uiBuffer,e.normalBuffer];for(let e=0;e<t.length;e++){let n=t[e];for(let e=0;e<n.textures.length;e++)n.textures[e].dispose();n.dispose()}e.gBuffer.depthTexture&&e.gBuffer.depthTexture.dispose(),this.deferredRenderer.dispose(),this.pipelinePostProcess.dispose()}}})))()}var Vr;function Hr(){return(Hr=t((()=>{Vr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	vUv = uv;\r
\r
}`,renderTarget:r,uniforms:dn.merge(t.uniforms,a,{uDeltaTime:{value:0,type:`1f`}})}),this.size=t.size,this.layerCnt=t.dataLayerCount,this.rt1=r,this.rt2=i,this.renderTarget=this.rt1,this.clearColor=t.clearColor??null,this.outputUniforms=a}onAfterRender(){super.onAfterRender();for(let e=0;e<this.layerCnt;e++)this.outputUniforms[`uGPUSampler`+e].value=this.renderTarget.textures[e];let e=this.rt1;this.rt1=this.rt2,this.rt2=e,this.renderTarget=this.rt1}initTexture(e){for(let t=0;t<this.layerCnt;t++){let n=[];for(let r=0;r<this.size.y;r++)for(let i=0;i<this.size.x;i++){let a=i,o=r;n.push(...e(t,a,o))}this.rt2.textures[t].subImage(new Float32Array(n),this.size.x,this.size.y)}}}})))()}function di(){return(di=t((()=>{Je(),D(),Wt(),Xe(),yn(),xn(),wn()})))()}function fi(){return(fi=t((()=>{ot(),Wt(),Ot(),Xe(),yn()})))()}function N(){return(N=t((()=>{Xe(),pn(),ai(),yn(),si(),ui(),hn(),tr(),Br(),di(),fi(),xn(),wn(),En()})))()}var pi;function mi(){return(mi=t((()=>{pi=class{static serializeEntity(e,t){let n=e=>{let r=[];e.children.forEach(e=>{e.initiator!=`script`&&r.push(n(e))});let i=[];e.components.forEach(e=>{let n=e.serialize({mode:`export`}),r=Object.keys(n).length>0;if(e.initiator!==`user`)return;let a={name:t.getName(e),uuid:e.uuid};r&&(a.props=n),i.push(a)});for(let t of e.unresolvedComponents)i.push({name:t.name,uuid:t.uuid,props:t.props});return{name:e.name,uuid:e.uuid,pos:e.position.x==0&&e.position.y==0&&e.position.z==0?void 0:e.position.getElm(`vec3`),rot:e.euler.x==0&&e.euler.y==0&&e.euler.z==0?void 0:e.euler.getElm(`vec3`),scale:e.scale.x==1&&e.scale.y==1&&e.scale.z==1?void 0:e.scale.getElm(`vec3`),components:i.length>0?i:void 0,childs:r.length>0?r:void 0}};return n(e)}static deserializeEntity(e,t,n,r){let i=(e,t)=>{let a=t||r.createEntity();a.initiator=`user`,a.setField(`name`,e.name),a.restoreUUID(e.uuid);let o=e.pos||[0,0,0];a.position.x=o[0],a.position.y=o[1],a.position.z=o[2];let s=e.rot||[0,0,0];a.euler.x=s[0],a.euler.y=s[1],a.euler.z=s[2];let c=e.scale||[1,1,1];return a.scale.x=c[0],a.scale.y=c[1],a.scale.z=c[2],a.unresolvedComponents=[],e.components&&e.components.forEach(e=>{let t=n.resolve(e.name);if(t){let n=a.getComponent(t.component);n||(n=a.addComponent(t.component),n.initiator=`user`),n.restoreUUID(e.uuid),e.props&&n.deserialize(e.props)}else console.warn(`[ProjectSerializer] Component "${e.name}" not found in resolver. Preserving data for round-trip.`),a.unresolvedComponents.push({name:e.name,uuid:e.uuid,props:e.props})}),e.childs&&([...a.children].forEach(e=>{e.initiator!==`script`&&a.remove(e)}),e.childs.forEach(e=>{a.add(i(e))})),a};e&&i(e,t),t.initiator=`god`}}})))()}var hi;function gi(){return(gi=t((()=>{N(),hi=class extends wt{name;_frag;_resolution;_filter;_updateEveryFrame;_textures;constructor(e,t){super(),this.name=e;let n=t.data;this._frag=n?.frag||``,this._resolution=n?.resolution||[1024,1024],this._filter=n?.filter||`linear`,this._updateEveryFrame=n?.updateEveryFrame??!1,this._textures=n?.textures||{}}get frag(){return this._frag}get resolution(){return this._resolution}get filter(){return this._filter}get updateEveryFrame(){return this._updateEveryFrame}get textures(){return this._textures}}})))()}var _i;function vi(){return(vi=t((()=>{_i=(e,t)=>{let n={},r=`/${t}/`;for(let[t,i]of Object.entries(e)){let e=t.slice(t.lastIndexOf(r)+r.length).split(`/`).slice(0,-2),a=Object.entries(i).find(([e,t])=>typeof t==`function`&&/^[A-Z]/.test(e));if(!a)continue;let o=n;for(let t of e)o=o[t]=o[t]||{};o[a[0]]=a[1]}return n}})))()}var yi;function bi(){return(bi=t((()=>{ot(),D(),gi(),vi(),yi=class extends nt{_componentList;_componentGroups;_geometryList;_geometryGroups;_textureResources;_textures;_updateEveryFrameTextures;constructor(){super(),this._componentList=[],this._textures=new Map,this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources=new Map,this._updateEveryFrameTextures=[]}get componentList(){return this._componentList}get componentGroups(){return this._componentGroups}get geometryList(){return this._geometryList}get geometryGroups(){return this._geometryGroups}get textureList(){return Array.from(this._textureResources.values())}get textures(){return this._textures}get updateEveryFrameTextures(){return this._updateEveryFrameTextures}clear(){this._componentList=[],this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources.clear(),this._textures.clear(),this._updateEveryFrameTextures=[],this.emit(`update`)}getComponent(e){return this._componentList.find(t=>t.name==e)}getComponentName(e){let t=this._componentList.find(t=>e instanceof t.component);return t?t.name:e.constructor.name}addComponentGroup(e){let t=this._componentGroups.find(t=>t.name==e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addComponent:(e,n)=>{let r={name:e,component:n};t.push(r),this._componentList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._componentGroups.push(t),this.emit(`update`),t}getGeometry(e){return this._geometryList.find(t=>t.name===e)}addGeometryGroup(e){let t=this._geometryGroups.find(t=>t.name===e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addGeometry:(e,n)=>{let r={name:e,geometryClass:n};t.push(r),this._geometryList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._geometryGroups.push(t),this.emit(`update`),t}addTextureResource(e,t){let n=new hi(e,{data:t});this._textureResources.set(e,n),this.emit(`update`)}getTextureResource(e){return this._textureResources.get(e)}removeTextureResource(e){this._textureResources.delete(e);let t=this._textures.get(e);t&&(t.dispose(),this._textures.delete(e)),this.emit(`update`)}addTexture(e,t){return this._textures.set(e,t),t}getTexture(e){return this._textures.get(e)}_buildTexture(e,t,n){let r=e.frag;return r?t.createTexProcedural({name:e.name,frag:r,resolution:new T(e.resolution[0]||1024,e.resolution[1]||1024),filter:e.filter,textures:n}):null}_ensureTexture(e,t,n){let r=this._textures.get(e.name);if(r)return r;if(n.has(e.name))return null;n.add(e.name);let i={},a=e.textures,o=Object.keys(a);for(let e=0;e<o.length;e++){let r=o[e],s=a[r],c=this._textureResources.get(s),l=c?this._ensureTexture(c,t,n):this._textures.get(s);l&&(i[r]=l)}let s=this._buildTexture(e,t,i);return s?(this._textures.set(e.name,s),e.updateEveryFrame&&this._updateEveryFrameTextures.push(s),s):null}buildTextureInstances(e){this._updateEveryFrameTextures=[];let t=new Set;this._textureResources.forEach(n=>{this._ensureTexture(n,e,t)}),this.emit(`update`)}}})))()}var xi,P;function Si(){return(Si=t((()=>{D(),N(),mi(),bi(),xi={duration:600,fps:30},P=class e extends wt{static resources;name;_renderer;_root;_time;_frame;_frameSetting;_disposed;_frameEvent;constructor(e){super(),this.name=`OREngine`,this._disposed=!1,this._renderer=e(this),this._renderer.globalUniforms={uTime:{value:0,type:`1f`},uTimeF:{value:0,type:`1f`},uTimeE:{value:0,type:`1f`},uTimeEF:{value:0,type:`1f`},uDeltaTime:{value:0,type:`1f`},uResolution:{value:new T,type:`2fv`},uAspectRatio:{value:1,type:`1f`}},this._time={current:new Date().getTime(),engine:0,delta:0,code:0},this._frameSetting={...xi},this._frame={current:0,playing:!1},this.seek(0),this._frameEvent=null,this._root=this.createEntity({name:`root`}),this._root.initiator=`god`,this.field(`name`,()=>this.name,e=>this.name=e),this.field(`scene`,()=>pi.serializeEntity(this._root,this._createComponentResolver()),e=>{pi.deserializeEntity(e,this._root,this._createComponentResolver(),this)}),this.field(`renderer`,()=>this._renderer.serialize({mode:`export`}),e=>this._renderer.deserialize(e));let t=this.fieldDir(`timeline`);t.field(`duration`,()=>this._frameSetting.duration,e=>this._frameSetting.duration=e),t.field(`fps`,()=>this._frameSetting.fps,e=>this._frameSetting.fps=e)}createEntity(e){return new Yt({engine:this,...e})}get canvas(){return this._renderer.canvas}get renderer(){return this._renderer}get root(){return this._root}get frame(){return this._frame}get time(){return this._time}get frameSetting(){return this._frameSetting}get disposed(){return this._disposed}createView(e){return this._renderer.createView(e)}_createComponentResolver(){return{resolve:t=>e.resources.getComponent(t),getName:t=>e.resources.getComponentName(t)}}init(){this._root.disposeRecursive(),this._root.position.set(0,0,0),this._root.euler.set(0,0,0),this._root.scale.set(1,1,1),this.name=`New Project`,this._renderer.reset(),Object.assign(this._frameSetting,xi),this.stop(),this.seek(0)}async load(e){this.init(),this.deserialize(e),this.emit(`update/graph`),this.emit(`loaded`)}update(t){let n=new Date().getTime();this._time.delta=(n-this._time.current)/1e3,this._time.current=n,this._time.engine+=this._time.delta,this._time.code+=this._time.delta*+!!this._frame.playing,this._frame.current=this._time.code*60;let r=this.createEntityUpdateEvent({forceDraw:t?.forceDraw});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1,this._renderer.globalUniforms.uDeltaTime.value=Math.min(this._time.delta,1/60);let i=e.resources.updateEveryFrameTextures;for(let e=0;e<i.length;e++)i[e].render();return this.step(r),this._frame.playing&&this.emit(`update/frame/play`,[this._frame]),this._time.delta}step(e){this._root.commitFrame(e),this._root.update(e),this._root.postUpdate(e),this._root.updateMatrixRecursive(),this._root.prepareRender(e),this._renderer.prepareScene(this._root,e),this._frameEvent=e}render(e){this._frameEvent&&this._renderer.render(e,this._frameEvent)}createEntityUpdateEvent(e){let t={playing:this._frame.playing,timeElapsed:this._time.engine,timeDelta:this._time.delta,timeCode:this._time.code,timeCodeFrame:this._frame.current,resolution:this.renderer.resolution,renderer:this.renderer,forceDraw:!1};return e?{...t,...e}:t}setSize(e){this._renderer.resize(e),this._renderer.canvas.width=e.x,this._renderer.canvas.height=e.y,this._renderer.globalUniforms.uResolution.value.copy(e),this._renderer.globalUniforms.uAspectRatio.value=e.x/Math.max(e.y,1)}play(){this._frame.playing=!0,this._time.current=new Date().getTime()}stop(){this._frame.playing=!1}seek(e){this._time.code=e/60,this._frame.current=e,this.emit(`update/frame/play`,[this._frame])}updateOffline(t,n){let r=t/n,i=1/n;this._time.delta=i,this._time.current=new Date().getTime(),this._time.engine+=i,this._time.code=r,this._frame.current=r*60,this._frame.playing=!0;let a=this.createEntityUpdateEvent({forceDraw:!0,offline:!0});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1;let o=e.resources.updateEveryFrameTextures;for(let e=0;e<o.length;e++)o[e].render();this.step(a)}compileShaders(e,t){let n=this.createEntityUpdateEvent({forceDraw:!0});return this.renderer.compileShaders(this._root,e,n,t)}dispose(){this._disposed=!0,this._root.disposeRecursive()}},P.resources=new yi,P.__docgenInfo={description:``,methods:[{name:`createEntity`,docblock:null,modifiers:[],params:[{name:`params`,optional:!0,type:{name:`Omit`,elements:[{name:`MXP.EntityParams`},{name:`literal`,value:`'engine'`}],raw:`Omit<MXP.EntityParams, 'engine'>`,alias:`Omit`}}],returns:{type:{name:`MXP.Entity`}}},{name:`canvas`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`renderer`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`root`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`frame`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`time`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`frameSetting`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`disposed`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`createView`,docblock:null,modifiers:[],params:[{name:`opt`,optional:!0,type:{name:`MXP.RenderViewOptions`,alias:`MXP.RenderViewOptions`}}],returns:null},{name:`init`,docblock:null,modifiers:[],params:[],returns:null},{name:`load`,docblock:null,modifiers:[`async`],params:[{name:`project`,optional:!1,type:{name:`OREngineProjectData`,alias:`OREngineProjectData`}}],returns:null},{name:`update`,docblock:null,modifiers:[],params:[{name:`param`,optional:!0,type:{name:`Partial`,elements:[{name:`MXP.EntityUpdateEvent`}],raw:`Partial<MXP.EntityUpdateEvent>`,alias:`Partial`}}],returns:null},{name:`step`,docblock:null,modifiers:[],params:[{name:`event`,optional:!1,type:{name:`MXP.EntityUpdateEvent`,alias:`MXP.EntityUpdateEvent`}}],returns:null},{name:`createEntityUpdateEvent`,docblock:null,modifiers:[],params:[{name:`overrideParams`,optional:!0,type:{name:`Partial`,elements:[{name:`MXP.EntityUpdateEvent`}],raw:`Partial<MXP.EntityUpdateEvent>`,alias:`Partial`}}],returns:{type:{name:`MXP.EntityUpdateEvent`}}},{name:`setSize`,docblock:null,modifiers:[],params:[{name:`resolution`,optional:!1,type:{name:`MTP.Vector`,alias:`MTP.Vector`}}],returns:null},{name:`play`,docblock:null,modifiers:[],params:[],returns:null},{name:`stop`,docblock:null,modifiers:[],params:[],returns:null},{name:`seek`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`number`}}],returns:null},{name:`updateOffline`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`number`}},{name:`fps`,optional:!1,type:{name:`number`}}],returns:null},{name:`compileShaders`,docblock:null,modifiers:[],params:[{name:`view`,optional:!1,type:{name:`MXP.RenderViewContract`,alias:`MXP.RenderViewContract`}},{name:`onProgress`,optional:!0,type:{name:`signature`,type:`function`,raw:`( label: string, loaded: number, total: number ) => void`,signature:{arguments:[{type:{name:`string`},name:`label`},{type:{name:`number`},name:`loaded`},{type:{name:`number`},name:`total`}],return:{name:`void`}}}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`Engine`}})))()}var Ci;function wi(){return(wi=t((()=>{ot(),Ci=class extends nt{_pressedKeys;constructor(){super(),this._pressedKeys={};let e=this._onKeyDown.bind(this),t=this._onKeyUp.bind(this);window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,t),this.once(`dispose`,()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,t)})}get pressedKeys(){return this._pressedKeys}_onKeyDown(e){this._pressedKeys[e.key]=!0,this.emit(`keydown`,[e,this._pressedKeys])}_onKeyUp(e){if(this._pressedKeys[e.key]=!1,e.key==`Meta`||e.key==`Control`){let e=Object.keys(this._pressedKeys);for(let t=0;t<e.length;t++)this._pressedKeys[e[t]]=!1}this.emit(`keyup`,[e,this._pressedKeys])}dispose(){this.emit(`dispose`)}}})))()}var Ti;function Ei(){return(Ei=t((()=>{ot(),D(),Ti=class extends nt{_isTouching;element=null;position;delta;constructor(){super(),this.position=new T(NaN,NaN),this.delta=new T(NaN,NaN),this._isTouching=!1;let e=this._onPointer.bind(this,`move`),t=this._onPointer.bind(this,`end`);window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`dragend`,t);let n=()=>{this.element&&this.removeElement(this.element),window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`dragend`,t),this.off(`dispose`,n)};this.on(`dispose`,n)}setElement(e){this.element&&this.removeElement(this.element),this.element=e;let t=this._onPointer.bind(this,`start`);e.addEventListener(`pointerdown`,t);let n=r=>{e.isEqualNode(r.elm)&&(e.removeEventListener(`pointerdown`,t),this.off(`unregister`,n))};this.on(`unregister`,n)}removeElement(e){this.emit(`unregister`,[e])}getScreenPosition(e){if(this.position.x!=this.position.x)return new T(NaN,NaN);let t=this.position.clone().divide(e).multiply(2).sub(1);return t.y*=-1,t}getRelativePosition(e,t){let n=e.getClientRects()[0],r=this.position.x-n.left,i=this.position.y-n.top;return t&&(r/=n.width,i/=n.height),new T(r,i)}_setPos(e,t){this.position.x!==this.position.x||this.position.y!==this.position.y?this.delta.set(0,0):this.delta.set(e-this.position.x,t-this.position.y),this.position.set(e,t)}_onPointer(e,t){let n=t.pointerType;(n==null||n==`mouse`&&(t.button==-1||t.button==0)||n==`touch`)&&this._touchEventHandler(t.pageX,t.pageY,e,t)}_touchEventHandler(e,t,n,r){let i=!1,a=e-window.pageXOffset,o=t-window.pageYOffset;n==`start`?(this._isTouching=!0,this._setPos(a,o),this.delta.set(0,0),i=!0):n==`move`?(this._setPos(a,o),this._isTouching&&(i=!0)):n==`end`&&(`targetTouches`in r?r.targetTouches.length==0&&(this._isTouching=!1):this._isTouching=!1,i=!0),i&&this.emit(n,[{pointerEvent:r,position:this.position.clone(),delta:this.delta.clone()}])}dispose(){this.emit(`dispose`)}}})))()}function Di(){return(Di=t((()=>{Si(),bi(),wi(),Ei()})))()}function Oi(){return(Oi=t((()=>{Di()})))()}var ki,Ai;function ji(){return(ji=t((()=>{ki=i(),Ai=(0,ki.createContext)(null)})))()}var Mi,F;function I(){return(I=t((()=>{Mi=i(),ji(),F=()=>{let e=(0,Mi.useContext)(Ai);if(e===null)throw Error(`useEditor must be used within a EditorProvider`);return e}})))()}var Ni,Pi,Fi;function Ii(){return(Ii=t((()=>{Ni=i(),Oi(),w(),I(),Pi=o(),Fi=e=>{let{engine:t}=F(),n=(0,Ni.useCallback)(()=>{let e=[{label:`(None)`,value:``}];return t.root.traverse(n=>{n.components.forEach(r=>{e.push({label:`${n.getScenePath(t.root)} > ${P.resources.getComponentName(r)}`,value:r.uuid})})}),e},[t]),[r,i]=(0,Ni.useState)(n);return(0,Ni.useEffect)(()=>{let e=()=>i(n());return t.on(`update/graph`,e),()=>{t.off(`update/graph`,e)}},[t,n]),(0,Pi.jsx)(re,{value:e.value||``,selectList:r,onChange:t=>{e.onChange&&e.onChange(t||null)}})},Fi.__docgenInfo={description:``,methods:[],displayName:`InputComponentRef`,props:{value:{required:!0,tsType:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: string | null ) => void`,signature:{arguments:[{type:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},name:`value`}],return:{name:`void`}}},description:``}}}})))()}var Li,Ri,zi;function Bi(){return(Bi=t((()=>{Li=i(),w(),I(),Ri=o(),zi=e=>{let{engine:t}=F(),n=(0,Li.useCallback)(()=>{let e=[{label:`(None)`,value:``}];return t.root.traverse(n=>{e.push({label:n.getScenePath(t.root),value:n.uuid})}),e},[t]),[r,i]=(0,Li.useState)(n);return(0,Li.useEffect)(()=>{let e=()=>i(n());return t.on(`update/graph`,e),()=>{t.off(`update/graph`,e)}},[t,n]),(0,Ri.jsx)(re,{value:e.value||``,selectList:r,onChange:t=>{e.onChange&&e.onChange(t||null)}})},zi.__docgenInfo={description:``,methods:[],displayName:`InputEntityRef`,props:{value:{required:!0,tsType:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: string | null ) => void`,signature:{arguments:[{type:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},name:`value`}],return:{name:`void`}}},description:``}}}})))()}var Vi,Hi,Ui,Wi;function Gi(){return(Gi=t((()=>{Vi=`InputResourceSelect__inputResourceSelect___Lmluc`,Hi=`InputResourceSelect__select___Lmluc`,Ui=`InputResourceSelect__editButton___Lmluc`,Wi={inputResourceSelect:Vi,select:Hi,editButton:Ui}})))()}var Ki,qi,Ji;function Yi(){return(Yi=t((()=>{Ki=i(),w(),I(),Gi(),qi=o(),Ji=e=>{let{editor:t}=F(),n=(0,Ki.useCallback)(()=>{e.value&&(t.setField(`navigateAsset`,{assetType:e.resourceType,name:String(e.value)}),t.setField(`selectedAsset`,{name:String(e.value),assetType:e.resourceType}))},[t,e.value,e.resourceType]);return(0,qi.jsxs)(`div`,{className:Wi.inputResourceSelect,children:[(0,qi.jsx)(`div`,{className:Wi.select,children:(0,qi.jsx)(re,{value:e.value,selectList:e.selectList,onChange:e.onChange})}),e.value&&(0,qi.jsx)(`button`,{className:Wi.editButton,onClick:n,title:`Edit resource`,children:`✎`})]})},Ji.__docgenInfo={description:``,methods:[],displayName:`InputResourceSelect`,props:{value:{required:!0,tsType:{name:`T`},description:``},selectList:{required:!0,tsType:{name:`union`,raw:`SelectList | ( () => SelectList )`,elements:[{name:`SelectList`},{name:`unknown`}]},description:``},resourceType:{required:!0,tsType:{name:`union`,raw:`"material" | "texture" | "shader"`,elements:[{name:`literal`,value:`"material"`},{name:`literal`,value:`"texture"`},{name:`literal`,value:`"shader"`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}}},description:``}}}})))()}var Xi,Zi;function Qi(){return(Qi=t((()=>{i(),w(),Ii(),Bi(),Yi(),Xi=o(),Zi=e=>{let t=null,n=e.onChange,r=e.value,i=e.format,a=e=>{n&&n(e)};if(i&&(i.type==`entity`?t=(0,Xi.jsx)(zi,{value:r,onChange:a}):i.type==`component`?t=(0,Xi.jsx)(Fi,{value:r,onChange:a}):i.type==`vector`&&Array.isArray(r)?t=(0,Xi.jsx)(ee,{value:r,onChange:a,onDragStart:e.onDragStart,onDragEnd:e.onDragEnd,onDragCancel:e.onDragCancel}):i.type==`color`&&Array.isArray(r)?t=(0,Xi.jsx)(v,{value:r,onChange:a}):i.type==`select`?t=(0,Xi.jsx)(re,{value:r,onChange:a,selectList:i.list}):i.type==`resource`&&(t=(0,Xi.jsx)(Ji,{value:r,onChange:a,selectList:i.list,resourceType:i.resourceType}))),r==null)return t;if(!t){if(typeof r==`number`)t=(0,Xi.jsx)(b,{...e,value:r,onChange:a});else if(typeof r==`string`)t=(0,Xi.jsx)(C,{...e,value:r,onChange:a});else if(typeof r==`boolean`)t=(0,Xi.jsx)(_,{...e,checked:r,onChange:a});else if(typeof r==`function`){let n=e.label||`Run`;t=(0,Xi.jsx)(c,{onClick:()=>{r()},children:n})}else t=(0,Xi.jsx)(C,{...e,value:JSON.stringify(r),onChange:()=>{}})}return t}})))()}var $i,ea,ta,na,ra,ia,aa,oa;function sa(){return(sa=t((()=>{$i=i(),ea={showAudioView:!0},ta=`orengine-editor-ui-settings`,na=()=>{try{let e=localStorage.getItem(ta);if(e)return{...ea,...JSON.parse(e)}}catch{}return{...ea}},ra=na(),ia=new Set,aa=e=>(ia.add(e),()=>{ia.delete(e)}),oa=e=>[(0,$i.useSyncExternalStore)(aa,()=>ra[e]),(0,$i.useCallback)(t=>{ra={...ra,[e]:t};try{localStorage.setItem(ta,JSON.stringify(ra))}catch{}ia.forEach(e=>e())},[e])]})))()}var ca,la,ua;function da(){return(da=t((()=>{ca=`EditorSettings__editorSettings___LmVka`,la=`EditorSettings__editorSettings_inner___LmVka`,ua={editorSettings:ca,editorSettings_inner:la}})))()}var fa,pa;function ma(){return(ma=t((()=>{w(),Qi(),sa(),da(),fa=o(),pa=()=>{let[e,t]=oa(`showAudioView`);return(0,fa.jsx)(`div`,{className:ua.editorSettings,children:(0,fa.jsx)(`div`,{className:ua.editorSettings_inner,children:(0,fa.jsx)(s,{label:`View`,accordion:!0,children:(0,fa.jsx)(ae,{title:`AudioView`,children:(0,fa.jsx)(Zi,{value:e,onChange:e=>t(e)})})})})})},pa.__docgenInfo={description:``,methods:[],displayName:`EditorSettings`}})))()}var ha,ga;function _a(){return(_a=t((()=>{Oi(),ha=(e,t,n)=>{let r=e.name;if(r.startsWith(`_`)&&(r=r.slice(1)),`child`in e){let i=[];for(let r of e.child){let e=ha(r,t,n);e&&i.push(e)}return{label:r,children:i}}return n.includes(e.component)?null:{label:r,onClick:()=>t(e)}},ga=(e,t=[])=>{let n=[];for(let r of P.resources.componentGroups){let i=ha(r,e,t);i&&n.push(i)}return n}})))()}var va,ya;function ba(){return(ba=t((()=>{N(),w(),_a(),I(),va=[A],ya=e=>{let{editor:t}=F(),{closeAll:n}=S(),r=(r,i)=>{let a=t.api.createEntity(e,{name:r,components:i});t.api.selectEntity(a),n()},i=ga(e=>{r(e.name,[e.component])},va),a=[{label:`Empty`,onClick:()=>r(`Empty`,[])}];for(let e of i)a.push(e);return a}})))()}var xa,Sa,Ca;function wa(){return(wa=t((()=>{xa=i(),w(),ba(),I(),Sa=o(),Ca=()=>{let{editor:e,engine:t}=F(),{open:n,closeAll:r}=S(),i=ya(t.root),a=(0,xa.useRef)({x:0,y:0});return(0,xa.useEffect)(()=>{let e=e=>{a.current.x=e.clientX,a.current.y=e.clientY};return window.addEventListener(`pointermove`,e),()=>{window.removeEventListener(`pointermove`,e)}},[]),(0,xa.useEffect)(()=>{let t=()=>{r(),n((0,Sa.jsx)(ce,{title:`Add Entity`,items:i}),ie(a.current.x,a.current.y))};return e.on(`request/addEntity`,t),()=>{e.off(`request/addEntity`,t)}},[e,t,n,r,i]),null}})))()}var Ta,Ea;function Da(){return(Da=t((()=>{Ta=i(),Ea=(0,Ta.createContext)(void 0)})))()}var Oa,ka;function Aa(){return(Aa=t((()=>{Oa=i(),ka=(e,t)=>{let[n,r]=(0,Oa.useState)(()=>e?e.serialize():{}),i=t?[...t]:[],a=(0,Oa.useMemo)(()=>i,i);return(0,Oa.useEffect)(()=>{if(e===void 0)return;r(e.serialize());let t=t=>{let n=a.length==0;for(let e=0;e<a.length;e++)if(t.find(t=>t==a[e])){n=!0;break}n&&r(e.serialize())};return e.on(`fields/update`,t),()=>{e.off(`fields/update`,t)}},[e,a]),{fields:n}}})))()}var ja;function Ma(){return(Ma=t((()=>{Aa(),ja=e=>(ka(e.target),{target:e.target})})))()}var Na;function Pa(){return(Pa=t((()=>{Na=(e,t,n)=>{if(!e)return null;for(let r of e){if(t.constructor!==r.target)continue;let e=r.fields[n];if(e)return e}return null}})))()}var Fa,Ia;function La(){return(La=t((()=>{Fa=i(),I(),Ia=(e,t)=>{let{editor:n}=F(),r=(0,Fa.useRef)(null);return{onChange:i=>{r.current?r.current.set(i):n.api.setField(e,t,i)},onDragStart:()=>{r.current=n.api.beginEdit(e,t)},onDragEnd:()=>{r.current&&r.current.commit(),r.current=null},onDragCancel:()=>{r.current&&r.current.cancel(),r.current=null}}}})))()}var Ra,za;function Ba(){return(Ba=t((()=>{Ra=i(),Da(),za=()=>{let e=(0,Ra.useContext)(Ea);if(!e)throw Error(`SerializeFieldViewContext is not defined`);return e}})))()}var Va,Ha;function Ua(){return(Ua=t((()=>{Va=`ValueArray__container___LmNvb`,Ha={container:Va}})))()}var Wa,Ga;function Ka(){return(Ka=t((()=>{i(),w(),Qi(),Ua(),Wa=o(),Ga=e=>{let t=[],n=e.value,r=e.format,i=r?.type==`array`?r.labels:void 0;if(n===void 0)return null;for(let r=0;r<n.length;r++){let a=n[r],o=r.toString();i&&(o+=`/ `+i(a,r)),t.push((0,Wa.jsx)(ae,{title:o,children:(0,Wa.jsx)(Zi,{...e,value:a,onChange:t=>{let i=n.concat();i[r]=t,e.onChange&&e.onChange(i)}})},r))}return(0,Wa.jsx)(`div`,{className:Ha.container,children:t})},Ga.__docgenInfo={description:``,methods:[],displayName:`ValueArray`,props:{value:{required:!0,tsType:{name:`union`,raw:`T | undefined`,elements:[{name:`T`},{name:`undefined`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}}},description:``},onDragStart:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},onDragEnd:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},onDragCancel:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},format:{required:!1,tsType:{name:`SerializableFieldFormat`},description:``},label:{required:!1,tsType:{name:`union`,raw:`string | React.ReactNode`,elements:[{name:`string`},{name:`ReactReactNode`,raw:`React.ReactNode`}]},description:``},readOnly:{required:!1,tsType:{name:`boolean`},description:``},step:{required:!1,tsType:{name:`number`},description:``},min:{required:!1,tsType:{name:`number`},description:``},max:{required:!1,tsType:{name:`number`},description:``},int:{required:!1,tsType:{name:`boolean`},description:``},disabled:{required:!1,tsType:{name:`boolean`},description:``}}}})))()}var qa,Ja;function Ya(){return(Ya=t((()=>{qa=`SerializeFieldViewValue__action___LmFjd`,Ja={action:qa}})))()}var Xa,Za,Qa;function $a(){return($a=t((()=>{Xa=e(i(),1),w(),I(),Pa(),La(),Ba(),Qi(),Ka(),Ya(),Za=o(),Qa=e=>{let{editor:t,engine:n,fieldUIs:r}=F(),{target:i}=za(),a=Ia(i,e.path),o=e.field.value,s=typeof o,c=e.field.opt,l=c?.format,u=c?.label||e.path.split(`/`).pop(),d=l&&l.type==`vector`,f=Na(r,i,e.path);if(f){let r=(0,Xa.createElement)(f.ui,{value:o,setValue:n=>t.api.setField(i,e.path,n),beginEdit:()=>t.api.beginEdit(i,e.path),target:i,path:e.path,opt:c,engine:n,editor:t});return(0,Za.jsx)(ae,{title:u,vertical:f.layout===`block`,children:r})}let p=null;if(Array.isArray(o))p=l?.type==`vector`?(0,Za.jsx)(ee,{value:o,...c,...a}):l?.type==`color`?(0,Za.jsx)(v,{value:o,...c,onChange:n=>{t.api.setField(i,e.path,n)}}):(0,Za.jsx)(Ga,{value:o,...c,...a});else if(p=(0,Za.jsx)(Zi,{value:o,...c,...a}),s===`function`)return(0,Za.jsx)(`div`,{className:Ja.action,children:p});return(0,Za.jsx)(ae,{title:u,vertical:d,children:p})},Qa.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldViewValue`,props:{path:{required:!0,tsType:{name:`string`},description:``},field:{required:!0,tsType:{name:`SerializeFieldDirectoryValue`},description:``}}}})))()}var eo,to,no,ro;function io(){return(io=t((()=>{eo=`SerializeFieldViewDir__container___LmNvb`,to=`SerializeFieldViewDir__field___LmNvb`,no=`SerializeFieldViewDir__block___LmNvb`,ro={container:eo,field:to,block:no}})))()}var ao,oo;function so(){return(so=t((()=>{i(),w(),$a(),io(),ao=o(),oo=e=>{let t=[],n=Object.keys(e.fields.childs);for(let r=0;r<n.length;r++){let i=n[r],a=e.fields.childs[i],{opt:o}=a,c=!1;if(o&&(c=typeof o.hidden==`function`?o.hidden(a.type==`value`?a.value:null):o.hidden||!1),c)continue;let l=`field`+i,u=(e.basePath?e.basePath+`/`:``)+i,d=null;d=a.type===`value`?(0,ao.jsx)(Qa,{path:u,field:a},l):(0,ao.jsx)(`div`,{className:ro.block,children:(0,ao.jsx)(s,{accordion:!0,label:i,children:(0,ao.jsx)(oo,{fields:a,basePath:u})},l)},l),d&&t.push(d)}return(0,ao.jsx)(`div`,{className:ro.container,children:t})},oo.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldViewDir`,props:{fields:{required:!0,tsType:{name:`MXP.SerializeFieldDirectoryFolder`},description:``},basePath:{required:!1,tsType:{name:`string`},description:``}}}})))()}var co,lo;function uo(){return(uo=t((()=>{Da(),Ma(),so(),co=o(),lo=e=>{let t=ja(e),n=t.target.serializeToDirectory();if(e.filter){let t=n.childs[e.filter];t&&t.type===`folder`&&(n=t)}return(0,co.jsx)(Ea.Provider,{value:t,children:(0,co.jsx)(oo,{fields:n,basePath:e.filter})})},lo.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldView`}})))()}var L;function fo(){return(fo=t((()=>{Aa(),L=(e,t)=>{let n=n=>{e?.setField(t,n)},{fields:r}=ka(e,[t]);return[r&&r[t],n]}})))()}var po,mo;function ho(){return(ho=t((()=>{po=`ComponentAdd__compAdd___LmNvb`,mo={compAdd:po}})))()}var go,_o;function vo(){return(vo=t((()=>{w(),_a(),I(),ho(),go=o(),_o=e=>{let{editor:t}=F(),{open:n,closeAll:r}=S(),i=ga(n=>{t.api.addComponent(e.entity,n.component),r()});return(0,go.jsx)(`div`,{className:mo.compAdd,children:(0,go.jsx)(c,{onClick:e=>{n((0,go.jsx)(ce,{items:i}),ie(e.clientX,e.clientY))},children:`Add Component`})})},_o.__docgenInfo={description:``,methods:[],displayName:`ComponentAdd`,props:{entity:{required:!0,tsType:{name:`MXP.Entity`},description:``}}}})))()}var yo,bo,xo,So,Co,wo;function To(){return(To=t((()=>{yo=`ComponentView__compoView___LmNvb`,bo=`ComponentView__head___LmNvb`,xo=`ComponentView__name___LmNvb`,So=`ComponentView__check___LmNvb`,Co=`ComponentView__propertyBlock___LmNvb`,wo={compoView:yo,head:bo,name:xo,check:So,delete:`ComponentView__delete___LmNvb`,propertyBlock:Co}})))()}var Eo,Do,Oo,ko;function Ao(){return(Ao=t((()=>{Eo=i(),Oi(),w(),I(),uo(),fo(),To(),Do=o(),Oo=e=>{let t=Object.keys(e.childs);for(let n=0;n<t.length;n++){let r=e.childs[t[n]],{opt:i}=r,a=!1;if(i&&(a=typeof i.hidden==`function`?i.hidden(r.type===`value`?r.value:null):i.hidden||!1),!a&&(r.type===`value`||Oo(r)))return!0}return!1},ko=({component:e})=>{let{editor:t}=F(),[n,r]=L(e,`enabled`),i=e.initiator!==`user`,a=Oo(e.serializeToDirectory()),o=(0,Eo.useCallback)(n=>{n.stopPropagation();let r=e.entity;if(r){for(let[n,i]of r.components)if(i.uuid===e.uuid){t.api.removeComponent(r,n,e);break}}},[e,t]),c=(0,Do.jsxs)(`div`,{className:wo.head,children:[(0,Do.jsx)(`div`,{className:wo.name,children:P.resources.getComponentName(e)}),(0,Do.jsx)(`div`,{className:wo.delete,children:(0,Do.jsx)(`button`,{onClick:o,children:(0,Do.jsx)(u,{})})})]});return(0,Do.jsx)(`div`,{className:wo.compoView,"data-disable_component":i,children:(0,Do.jsx)(`div`,{className:wo.content,children:(0,Do.jsx)(s,{label:c,accordion:a,bg:!0,defaultClose:!1,children:a&&(0,Do.jsx)(lo,{target:e})})})})},ko.__docgenInfo={description:``,methods:[],displayName:`ComponentView`,props:{component:{required:!0,tsType:{name:`MXP.Component`},description:``}}}})))()}var jo,Mo;function No(){return(No=t((()=>{jo=`ComponentList__container___LmNvb`,Mo={container:jo}})))()}var Po,Fo,Io;function Lo(){return(Lo=t((()=>{Po=i(),fo(),Ao(),No(),Fo=o(),Io=({entity:e})=>{let[t]=L(e,`components`),n=(0,Po.useMemo)(()=>{let n=[];return t?(t.forEach(t=>{let r=e.getComponentByUUID(t);r&&n.push((0,Fo.jsx)(ko,{component:r},r.uuid))}),n):null},[t,e]);return(0,Fo.jsx)(`div`,{className:Mo.container,children:n})},Io.__docgenInfo={description:``,methods:[],displayName:`ComponentList`}})))()}var Ro,zo,Bo;function Vo(){return(Vo=t((()=>{Ro=i(),w(),I(),uo(),fo(),vo(),Lo(),zo=o(),Bo=()=>{let{editor:e,engine:t}=F(),[n]=L(e,`selectedEntityId`),r=(0,Ro.useMemo)(()=>{if(n)return t.root.findEntityByUUID(n)},[t,n]);return r?(0,zo.jsxs)(zo.Fragment,{children:[(0,zo.jsx)(s,{label:`Fields`,accordion:!0,children:(0,zo.jsx)(lo,{target:r})}),(0,zo.jsxs)(s,{label:`Components`,accordion:!0,children:[(0,zo.jsx)(Io,{entity:r}),(0,zo.jsx)(_o,{entity:r})]})]}):null},Bo.__docgenInfo={description:``,methods:[],displayName:`EntityProperty`}})))()}var Ho,Uo,Wo;function Go(){return(Go=t((()=>{Ho=`ExportControl__exportControl___LmV4c`,Uo=`ExportControl__exportControl_inner___LmV4c`,Wo={exportControl:Ho,exportControl_inner:Uo,export:`ExportControl__export___LmV4c`}})))()}var Ko,qo,Jo;function Yo(){return(Yo=t((()=>{Ko=i(),w(),I(),Go(),qo=o(),Jo=()=>{let{editor:e}=F(),[t,n]=(0,Ko.useState)(null);return(0,Ko.useEffect)(()=>{let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),(0,qo.jsx)(`div`,{className:Wo.exportControl,children:(0,qo.jsx)(`div`,{className:Wo.exportControl_inner,children:(0,qo.jsx)(s,{label:`MP4`,accordion:!0,children:(0,qo.jsx)(`div`,{className:Wo.export,children:(0,qo.jsx)(c,{onClick:()=>{e.isExporting||e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})})})})})},Jo.__docgenInfo={description:``,methods:[],displayName:`ExportControl`}})))()}var Xo,Zo;function Qo(){return(Qo=t((()=>{Xo=i(),Zo=(0,Xo.createContext)(null)})))()}var $o,es;function ts(){return(ts=t((()=>{$o=i(),Qo(),es=()=>{let e=(0,$o.useContext)(Zo);if(e===null)throw Error(`useOREngine must be used within a OREngineProvider`);return e}})))()}var ns,rs,is,as,os,ss,cs,ls,us,ds,fs,ps,ms,hs,gs,_s,vs,ys,R;function bs(){return(bs=t((()=>{ns=`GPUTimer__container___LmNvb`,rs=`GPUTimer__headerRow___LmNvb`,is=`GPUTimer__totalTime___LmNvb`,as=`GPUTimer__toggleButton___LmNvb`,os=`GPUTimer__controls___LmNvb`,ss=`GPUTimer__control___LmNvb`,cs=`GPUTimer__controlLabel___LmNvb`,ls=`GPUTimer__select___LmNvb`,us=`GPUTimer__input___LmNvb`,ds=`GPUTimer__group___LmNvb`,fs=`GPUTimer__item___LmNvb`,ps=`GPUTimer__clickable___LmNvb`,ms=`GPUTimer__itemRow___LmNvb`,hs=`GPUTimer__itemName___LmNvb`,gs=`GPUTimer__itemTime___LmNvb`,_s=`GPUTimer__itemStats___LmNvb`,vs=`GPUTimer__progressBar___LmNvb`,ys=`GPUTimer__progressFill___LmNvb`,R={container:ns,headerRow:rs,totalTime:is,toggleButton:as,controls:os,control:ss,controlLabel:cs,select:ls,input:us,group:ds,item:fs,clickable:ps,itemRow:ms,itemName:hs,itemTime:gs,itemStats:_s,progressBar:vs,progressFill:ys}})))()}var xs,Ss;function Cs(){return(Cs=t((()=>{xs=class{buffer;index;size;filled;constructor(e){this.size=e,this.buffer=Array(e),this.index=0,this.filled=!1}push(e){this.buffer[this.index]=e,this.index=(this.index+1)%this.size,!this.filled&&this.index===0&&(this.filled=!0)}getAverage(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=0;for(let n=0;n<e;n++)t+=this.buffer[n];return t/e}getMax(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]>t&&(t=this.buffer[n]);return t}getMin(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]<t&&(t=this.buffer[n]);return t}getCount(){return this.filled?this.size:this.index}},Ss=class{buffers;windowSize;currentData;constructor(e=30){this.windowSize=e,this.buffers=new Map,this.currentData=new Map}update(e){let t=performance.now();for(let n=0;n<e.length;n++){let r=e[n],i=r.name.split(`/`),a=i[0]||`unknown`,o,s=i[i.length-1],c=s&&s.match(/\[([^\]]+)\]/);c&&(o=c[1]);let l={name:r.name,duration:r.duration,timestamp:t,renderType:a},u=this.buffers.get(r.name);u||(u=new xs(this.windowSize),this.buffers.set(r.name,u)),u.push(r.duration),this.currentData.set(r.name,{...l,entityId:o})}}getStatistics(){let e=[],t=0,n=performance.now(),r=[];return this.currentData.forEach((e,t)=>{n-e.timestamp>1e3&&r.push(t)}),r.forEach(e=>{this.currentData.delete(e)}),this.currentData.forEach(e=>{t+=e.duration}),this.currentData.forEach(n=>{let r=this.buffers.get(n.name);r&&e.push({name:n.name,renderType:n.renderType,entityId:n.entityId,current:n.duration,avg:r.getAverage(),max:r.getMax(),min:r.getMin(),samples:r.getCount(),percentage:t>0?n.duration/t*100:0})}),e}getTotalTime(){let e=0;return this.currentData.forEach(t=>{e+=t.duration}),e}}})))()}var ws,z,Ts,Es,Ds,Os;function ks(){return(ks=t((()=>{ws=i(),ts(),I(),bs(),Cs(),z=o(),Ts=e=>{if(e<2){let t=e/2;return`rgb(${Math.floor(100+t*100)}, 200, 100)`}if(e<5){let t=(e-2)/3;return`rgb(200, ${Math.floor(200-t*50)}, 100)`}if(e<10){let t=(e-5)/5;return`rgb(200, ${Math.floor(150-t*80)}, ${Math.floor(100-t*50)})`}return`rgb(200, 70, 50)`},Es=e=>e>=10?e.toFixed(1):e>=1?e.toFixed(2):e.toFixed(3),Ds=e=>e.replace(/\[([^\]]{4,})\]/g,(e,t)=>`[${t.slice(0,3)}]`),Os=()=>{let{editor:e}=F(),{engine:t}=es(),[n,r]=(0,ws.useState)([]),[i,a]=(0,ws.useState)(0),[o,s]=(0,ws.useState)(`all`),[c,l]=(0,ws.useState)(0),[u,d]=(0,ws.useState)(`time`),[f,p]=(0,ws.useState)(!1),m=(0,ws.useRef)(new Ss(30)),h=(0,ws.useRef)(0),g=(0,ws.useRef)(!1),_=(0,ws.useRef)(0),v=(0,ws.useCallback)(n=>{if(!n)return;let r=t.root.findEntityByUUID(n);r&&e.selectEntity(r)},[t,e]);(0,ws.useEffect)(()=>{let e=t.renderer,n=m.current,i=e=>{f&&(n.update(e),g.current=!0)},o=e=>{g.current&&e-_.current>=300&&(r(n.getStatistics()),a(n.getTotalTime()),g.current=!1,_.current=e),h.current=requestAnimationFrame(o)};return e.on(`timer`,i),h.current=requestAnimationFrame(o),()=>{e.off(`timer`,i),cancelAnimationFrame(h.current)}},[t,f]);let y=n.filter(e=>!(o!==`all`&&e.renderType!==o||e.avg<c)),b=Array.from(new Set(n.map(e=>e.renderType))),x=[...y].sort((e,t)=>u===`time`?t.avg-e.avg:e.name.localeCompare(t.name)),S=i>0?Math.floor(1e3/i):0;return(0,z.jsxs)(`div`,{className:R.container,children:[(0,z.jsxs)(`div`,{className:R.headerRow,children:[(0,z.jsxs)(`span`,{className:R.totalTime,children:[Es(i),`ms (`,S,`fps)`]}),(0,z.jsx)(`button`,{className:R.toggleButton,onClick:()=>p(!f),title:f?`Stop timer`:`Start timer`,children:f?`⏸`:`▶`})]}),(0,z.jsxs)(`div`,{className:R.controls,children:[(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Type`}),(0,z.jsxs)(`select`,{className:R.select,value:o,onChange:e=>s(e.target.value),children:[(0,z.jsx)(`option`,{value:`all`,children:`All`}),b.map(e=>(0,z.jsx)(`option`,{value:e,children:e},e))]})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Min`}),(0,z.jsx)(`input`,{className:R.input,type:`number`,min:`0`,step:`0.1`,value:c,onChange:e=>l(parseFloat(e.target.value)||0)})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Sort`}),(0,z.jsxs)(`select`,{className:R.select,value:u,onChange:e=>d(e.target.value),children:[(0,z.jsx)(`option`,{value:`time`,children:`Time`}),(0,z.jsx)(`option`,{value:`name`,children:`Name`})]})]})]}),(0,z.jsx)(`div`,{className:R.group,children:x.map((e,t)=>{let n=Ts(e.avg),r=i>0?e.avg/i*100:0,a=!!e.entityId;return(0,z.jsxs)(`div`,{className:`${R.item} ${a?R.clickable:``}`,onClick:()=>v(e.entityId),children:[(0,z.jsxs)(`div`,{className:R.itemRow,children:[(0,z.jsx)(`span`,{className:R.itemName,title:e.name,children:Ds(e.name)}),(0,z.jsx)(`span`,{className:R.itemTime,style:{color:n},children:Es(e.avg)}),(0,z.jsx)(`span`,{className:R.itemStats,children:Es(e.max)})]}),(0,z.jsx)(`div`,{className:R.progressBar,children:(0,z.jsx)(`div`,{className:R.progressFill,style:{width:`${r}%`,backgroundColor:n}})})]},e.name+t)})})]})},Os.__docgenInfo={description:``,methods:[],displayName:`Timer`}})))()}var As,js,Ms,Ns,Ps,Fs,Is,Ls,Rs,zs,Bs,Vs,Hs;function Us(){return(Us=t((()=>{As=`HierarchyNode__node___Lm5vZ`,js=`HierarchyNode__self_name___Lm5vZ`,Ms=`HierarchyNode__self_name_input___Lm5vZ`,Ns=`HierarchyNode__icon___Lm5vZ`,Ps=`HierarchyNode__selectable___Lm5vZ`,Fs=`HierarchyNode__self___Lm5vZ`,Is=`HierarchyNode__visibility___Lm5vZ`,Ls=`HierarchyNode__menu___Lm5vZ`,Rs=`HierarchyNode__fold___Lm5vZ`,zs=`HierarchyNode__fold_button___Lm5vZ`,Bs=`HierarchyNode__child___Lm5vZ`,Vs=`HierarchyNode__child_line___Lm5vZ`,Hs={node:As,self_name:js,self_name_input:Ms,icon:Ns,selectable:Ps,self:Fs,visibility:Is,menu:Ls,fold:Rs,fold_button:zs,child:Bs,child_line:Vs}})))()}var Ws,Gs,Ks;function qs(){return(qs=t((()=>{Ws=i(),N(),w(),ba(),I(),fo(),Us(),Gs=o(),Ks=e=>{let{editor:t,engine:n}=F(),[r]=L(t,`selectedEntityId`),i=r!==void 0&&n.root.findEntityByUUID(r),o=!!(i&&i.uuid==e.entity.uuid),[s]=L(e.entity,`name`),[c,u]=L(e.entity,`visible`),[f,m]=L(t,`unselectableEntityIds`),[_]=L(e.entity,`children`),v=!(f||[]).includes(e.entity.uuid),y=(_||[]).map(e=>n.root.findEntityByUUID(e)).filter(e=>e!==void 0),b=e.depth||0,x=y&&y.concat().sort((e,t)=>e.name.localeCompare(t.name))||[],C=x.length>0,ee=b*20,te=e.entity.initiator==`script`,w=(0,Ws.useMemo)(()=>e.entity.getComponent(Vt)?(0,Gs.jsx)(p,{size:14}):e.entity.getComponent(Lt)?(0,Gs.jsx)(l,{size:14}):e.entity.getComponent(A)?(0,Gs.jsx)(h,{size:14}):null,[e.entity]),ne=e.openNodes.has(e.entity.uuid),re=(0,Ws.useCallback)(t=>{e.setNodeOpen(e.entity.uuid,!ne),t.stopPropagation()},[ne,e]),ae=(0,Ws.useCallback)(()=>{t&&t.selectEntity(e.entity)},[t,e.entity]),oe=(0,Ws.useCallback)(e=>{e.stopPropagation(),u&&u(!c)},[c,u]),le=(0,Ws.useCallback)(t=>{t.stopPropagation();let n=new Set(f||[]);v?n.add(e.entity.uuid):n.delete(e.entity.uuid),m(Array.from(n))},[v,f,m,e.entity.uuid]),[ue,de]=(0,Ws.useState)(null),fe=(0,Ws.useRef)(!1),pe=(0,Ws.useCallback)(()=>{te||de(e.entity.name)},[te,e.entity]);(0,Ws.useEffect)(()=>{let n=t=>{t===e.entity&&pe()};return t.on(`request/renameEntity`,n),()=>{t.off(`request/renameEntity`,n)}},[t,e.entity,pe]);let me=(0,Ws.useCallback)(e=>{e.key===`Enter`&&e.currentTarget.blur(),e.key===`Escape`&&(fe.current=!0,e.currentTarget.blur())},[]),he=(0,Ws.useCallback)(()=>{let n=fe.current;if(fe.current=!1,de(null),n||ue===null)return;let r=ue.trim();r!==``&&r!==e.entity.name&&t.api.setField(e.entity,`name`,r)},[ue,t,e.entity]),{open:ge,closeAll:_e}=S(),ve=ya(e.entity),ye=(0,Ws.useCallback)(n=>{if(n.preventDefault(),!t||te)return;t.selectEntity(e.entity);let r=[{label:`Add Entity`,children:ve}];e.entity.parent&&r.push({label:`Duplicate`,onClick:()=>{let n=t.api.duplicateEntity(e.entity);t.selectEntity(n),_e()}}),r.push({label:`Rename`,onClick:()=>{t.emit(`request/renameEntity`,[e.entity]),_e()}},{label:`Delete Entity`,onClick:()=>{t.api.deleteEntity(e.entity),_e()}}),ge((0,Gs.jsx)(ce,{title:e.entity.name,items:r}),ie(n.clientX,n.clientY))},[t,e.entity,ge,_e,te,ve]),be=(0,Gs.jsx)(`p`,{children:s||`-`});return ue!==null&&(be=(0,Gs.jsx)(`input`,{className:Hs.self_name_input,value:ue,autoFocus:!0,onChange:e=>de(e.target.value),onFocus:e=>e.currentTarget.select(),onKeyDown:me,onBlur:he,onClick:e=>e.stopPropagation()})),(0,Gs.jsxs)(`div`,{className:Hs.node,"data-no_export":te,children:[(0,Gs.jsxs)(se,{className:Hs.self,style:{paddingLeft:ee},onClick:ae,onContextMenu:ye,selected:o,children:[(0,Gs.jsx)(`div`,{className:Hs.fold,"data-hnode_open":ne,children:C&&(0,Gs.jsx)(`button`,{className:Hs.fold_button,onClick:re,children:(0,Gs.jsx)(a,{open:ne})})}),w&&(0,Gs.jsx)(`div`,{className:Hs.icon,children:w}),(0,Gs.jsx)(`div`,{className:Hs.self_name,onDoubleClick:pe,children:be}),(0,Gs.jsx)(`button`,{className:Hs.selectable,onClick:le,"data-selectable":v,children:(0,Gs.jsx)(d,{size:14,selectable:v})}),(0,Gs.jsx)(`button`,{className:Hs.visibility,onClick:oe,"data-visible":c!==!1,children:(0,Gs.jsx)(g,{size:14,visible:c!==!1})}),!te&&(0,Gs.jsx)(`button`,{className:Hs.menu,onClick:ye,children:`⋯`})]}),C&&(0,Gs.jsxs)(`div`,{className:Hs.child,"data-open":ne,children:[x.map(t=>(0,Gs.jsx)(Ks,{entity:t,depth:b+1,openNodes:e.openNodes,setNodeOpen:e.setNodeOpen},t.uuid)),(0,Gs.jsx)(`div`,{className:Hs.child_line,style:{marginLeft:ee+4}})]})]})},Ks.__docgenInfo={description:``,methods:[],displayName:`HierarchyNode`,props:{depth:{required:!1,tsType:{name:`number`},description:``},entity:{required:!0,tsType:{name:`MXP.Entity`},description:``},openNodes:{required:!0,tsType:{name:`Set`,elements:[{name:`string`}],raw:`Set<string>`},description:``},setNodeOpen:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( uuid: string, open: boolean ) => void`,signature:{arguments:[{type:{name:`string`},name:`uuid`},{type:{name:`boolean`},name:`open`}],return:{name:`void`}}},description:``}}}})))()}var Js;function Ys(){return(Ys=t((()=>{Js={}})))()}var Xs,Zs,Qs,$s,ec,tc;function nc(){return(nc=t((()=>{Xs=i(),I(),fo(),qs(),Ys(),Zs=o(),Qs=`hierarchyOpenNodes`,$s=()=>{try{let e=localStorage.getItem(Qs);if(e)return new Set(JSON.parse(e))}catch{}return new Set},ec=e=>{localStorage.setItem(Qs,JSON.stringify(Array.from(e)))},tc=()=>{let{editor:e,engine:t}=F(),[n]=L(e,`selectedEntityId`),r=t.root,[i,a]=(0,Xs.useState)($s),o=(0,Xs.useCallback)((e,t)=>{a(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),ec(r),r})},[]);return(0,Xs.useEffect)(()=>{if(!n)return;let e=r.findEntityByUUID(n);if(!e)return;let t=[],i=e.parent;for(;i;)t.push(i.uuid),i=i.parent;a(e=>{if(t.every(t=>e.has(t)))return e;let n=new Set(e);return t.forEach(e=>n.add(e)),ec(n),n})},[n,r]),(0,Zs.jsx)(`div`,{className:Js.hierarchy,children:r&&(0,Zs.jsx)(Ks,{entity:r,openNodes:i,setNodeOpen:o})})},tc.__docgenInfo={description:``,methods:[],displayName:`Hierarchy`}})))()}var rc,ic;function ac(){return(ac=t((()=>{rc=`Canvas__container___LmNvb`,ic={container:rc}})))()}var oc,sc,cc;function lc(){return(lc=t((()=>{oc=i(),I(),ac(),sc=o(),cc=({viewportId:e})=>{let{engine:t,editor:n}=F(),r=(0,oc.useRef)(null);return(0,oc.useEffect)(()=>{let i=r.current;if(!t||!i)return;let a=n.createViewport(e,i);return()=>{a.dispose()}},[t,n,e]),(0,sc.jsx)(`div`,{className:ic.container,role:`presentation`,"aria-label":`3D Canvas`,children:(0,sc.jsx)(`canvas`,{ref:r})})},cc.__docgenInfo={description:``,methods:[],displayName:`Canvas`}})))()}var uc,dc;function fc(){return(fc=t((()=>{uc=`AudioView__audioView___LmF1Z`,dc={audioView:uc}})))()}var pc;function mc(){return(mc=t((()=>{ot(),D(),pc=class extends nt{wrapperElm;canvas;canvasCtx;viewRangeFrame;viewPort;viewPortRange;musicBuffer;resizeObserver;frameSetting;framePlay;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0];let e=window.localStorage.getItem(`audioViweRange`);this.viewRangeFrame=e?Number(e):2,this.frameSetting={duration:0,fps:60},this.framePlay={current:0,playing:!1},this.musicBuffer=null,this.resizeObserver=new ResizeObserver(this.onResize.bind(this))}onResize(){if(this.wrapperElm){let e=new T(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);this.canvas.width=e.x,this.canvas.height=e.y}this.render()}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.musicBuffer){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)]*1,s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]*1+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}this.canvasCtx.fillStyle=`#555`,this.canvasCtx.fillRect(this.canvas.width/2,0,1,this.canvas.height)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.canvas),this.onResize()}setFramePlaying(e){this.framePlay=e,this.viewPort=[this.framePlay.current-this.viewRangeFrame,0,this.framePlay.current+this.viewRangeFrame,0],this.viewPortRange=[this.viewPort[2]-this.viewPort[0],this.viewPort[3]-this.viewPort[1]],this.render()}setViewRangeFrame(e){this.viewRangeFrame=e,this.setFramePlaying(this.framePlay),localStorage.setItem(`audioViweRange`,String(this.viewRangeFrame))}setFrameSetting(e){this.frameSetting=e,this.render()}setMusicBuffer(e){this.musicBuffer=e,this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.canvas),this.resizeObserver.disconnect()}},pc.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setFramePlaying`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`FramePlay`,alias:`FramePlay`}}],returns:null},{name:`setViewRangeFrame`,docblock:null,modifiers:[],params:[{name:`rangeFrame`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frameSetting`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`AudioViewRenderer`}})))()}var hc,gc,_c;function vc(){return(vc=t((()=>{hc=i(),I(),fc(),mc(),gc=o(),_c=()=>{let{editor:e}=F(),t=(0,hc.useRef)(null),[n,r]=(0,hc.useState)();(0,hc.useEffect)(()=>{let e=new pc;if(r(e),t.current)return e.setWrapperElm(t.current),()=>{e.dispose()}},[]);let i=e&&e.audioBuffer,[a,o]=(0,hc.useState)(),[s,c]=(0,hc.useState)({duration:0,fps:0}),[l,u]=(0,hc.useState)({current:0,playing:!1});(0,hc.useEffect)(()=>{if(!e)return;let t=e.engine,n=e=>{c({duration:e[`timeline/duration`],fps:e[`timeline/fps`]})},r=0,i=()=>{o(r++)},a=e=>{u({...e})};return n(t.serialize()),a(t.frame),t.on(`fields/update`,n),t.on(`update/music`,i),t.on(`update/frame/play`,a),()=>{t.off(`update/frame/setting`,n),t.off(`update/music`,i),t.off(`update/frame/play`,a)}},[e]),(0,hc.useEffect)(()=>{n&&i&&n.setMusicBuffer(i)},[n,i,a]),(0,hc.useEffect)(()=>{n&&l&&n.setFramePlaying(l)},[n,l]),(0,hc.useEffect)(()=>{n&&s&&n.setFrameSetting(s)},[n,s]);let d=(0,hc.useCallback)(e=>{if(n){let t=e.deltaY>0?1.1:.9;n.setViewRangeFrame(n.viewRangeFrame*t)}e.preventDefault()},[n]);return(0,hc.useEffect)(()=>{let e=t.current;return e&&e.addEventListener(`wheel`,d,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,d)}},[d]),(0,gc.jsx)(`div`,{className:dc.audioView,ref:t})},_c.__docgenInfo={description:``,methods:[],displayName:`AudioView`}})))()}var yc,bc,xc;function Sc(){return(Sc=t((()=>{yc=`CameraPad__cameraPad___LmNhb`,bc=`CameraPad__btn___LmNhb`,xc={cameraPad:yc,btn:bc}})))()}var Cc,wc;function Tc(){return(Tc=t((()=>{I(),fo(),Sc(),Cc=o(),wc=({viewportId:e})=>{let{editor:t}=F(),[n]=L(t,`selectedEntityId`),[r]=L(t,`viewports/${e}/cameraView`);return(0,Cc.jsxs)(`div`,{className:xc.cameraPad,children:[(0,Cc.jsx)(`div`,{className:xc.btn,"data-disabled":!n,onClick:()=>{n&&t.focusSelected()},title:`Focus selected ( . )`,children:`Focus`}),(0,Cc.jsx)(`div`,{className:xc.btn,"data-active":r===`camera`,onClick:()=>{t.toggleCameraView()},title:`Toggle scene camera view ( 0 )`,children:`Scene Cam`})]})},wc.__docgenInfo={description:``,methods:[],displayName:`CameraPad`}})))()}var Ec,Dc,Oc,kc,Ac,jc,Mc,Nc,Pc,Fc,Ic,Lc,Rc,zc,Bc,Vc,Hc,Uc,Wc,Gc,Kc,B;function qc(){return(qc=t((()=>{Ec=`Screen__screen___LnNjc`,Dc=`Screen__header___LnNjc`,Oc=`Screen__header_tabs___LnNjc`,kc=`Screen__header_tab___LnNjc`,Ac=`Screen__header_right___LnNjc`,jc=`Screen__header_item___LnNjc`,Mc=`Screen__content___LnNjc`,Nc=`Screen__gizmoMode___LnNjc`,Pc=`Screen__gizmoMode_btn___LnNjc`,Fc=`Screen__gizmoMode_separator___LnNjc`,Ic=`Screen__modalStatus___LnNjc`,Lc=`Screen__canvas___LnNjc`,Rc=`Screen__audioViewHandle___LnNjc`,zc=`Screen__audioView___LnNjc`,Bc=`Screen__displayOptions___LnNjc`,Vc=`Screen__displayOptions_btn___LnNjc`,Hc=`Screen__overlay___LnNjc`,Uc=`Screen__overlay_field___LnNjc`,Wc=`Screen__overlay_label___LnNjc`,Gc=`Screen__overlay_separator___LnNjc`,Kc=`Screen__externalBtn___LnNjc`,B={screen:Ec,header:Dc,header_tabs:Oc,header_tab:kc,header_right:Ac,header_item:jc,content:Mc,gizmoMode:Nc,gizmoMode_btn:Pc,gizmoMode_separator:Fc,modalStatus:Ic,canvas:Lc,audioViewHandle:Rc,audioView:zc,displayOptions:Bc,displayOptions_btn:Vc,overlay:Hc,overlay_field:Uc,overlay_label:Wc,overlay_separator:Gc,externalBtn:Kc}})))()}var Jc,V,Yc,Xc;function Zc(){return(Zc=t((()=>{Jc=i(),w(),we(),I(),sa(),lc(),Qi(),fo(),vc(),Tc(),qc(),V=o(),Yc=`viewport`,Xc=({viewportId:e})=>{let{editor:t}=F(),n=Ce(),[r,i]=L(t,`enableRender`),[a,o]=L(t,`viewports/${e}/preview`),[s,l]=L(t,`viewType`),[u,d]=L(t,`viewports/${e}/resolutionScale`),[f,p]=L(t,`gizmoMode`),[m,h]=L(t,`transformOrientation`),[g]=L(t,`modalStatus`),[_,v]=L(t,`viewports/${e}/helpers/show`),[y,b]=L(t,`viewports/${e}/helpers/empty`),[x,S]=L(t,`viewports/${e}/helpers/camera`),[C,ee]=L(t,`viewports/${e}/helpers/light`),[te,w]=L(t,`viewports/${e}/helpers/grid`),[ne,re]=L(t,`viewports/${e}/helpers/wireframe`),[ie,oe]=L(t,`viewports/${e}/helpers/gizmo`),[se,ce]=L(t,`viewports/${e}/helpers/outline`),[le]=oa(`showAudioView`),[ue,de]=(0,Jc.useState)(50),fe=(0,Jc.useRef)(null),[pe,me]=(0,Jc.useState)(!1),he=(0,Jc.useRef)(null),ge=(0,Jc.useCallback)(e=>{he.current&&!he.current.contains(e.target)&&me(!1)},[]);return(0,Jc.useEffect)(()=>(pe&&document.addEventListener(`pointerdown`,ge),()=>{document.removeEventListener(`pointerdown`,ge)}),[pe,ge]),(0,V.jsxs)(`div`,{className:B.screen,children:[(0,V.jsxs)(`div`,{className:B.header,children:[(0,V.jsx)(`div`,{className:B.header_tabs,children:(0,V.jsx)(`div`,{className:B.header_tab,"data-active":!!a,onClick:()=>o&&o(!a),title:`Camera Render`,children:(0,V.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 512 512`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,V.jsx)(`path`,{d:`M32 144 H336 V368 H32 Z M368 224 L480 152 V360 L368 288 Z`})})})}),(0,V.jsxs)(`div`,{className:B.header_right,children:[(0,V.jsx)(`div`,{className:B.header_item,children:(0,V.jsx)(ae,{title:`View`,children:(0,V.jsx)(Zi,{value:s,format:{type:`select`,list:[`render`,`debug`]},onChange:e=>l&&l(e)})})}),(0,V.jsx)(`div`,{className:B.header_item,children:(0,V.jsx)(ae,{title:`Res`,children:(0,V.jsx)(Zi,{value:u,format:{type:`select`,list:[,,,,,,].fill(0).map((e,t)=>{let n=2**t,r=1/n;return{value:r,label:r==1?`1`:`1/`+n}})},onChange:e=>d&&d(e)})})}),n.isPC&&(0,V.jsx)(`div`,{className:B.externalBtn,children:(0,V.jsx)(c,{onClick:()=>{t.openInExternalWindow()},children:(0,V.jsxs)(`svg`,{width:`32`,height:`12`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,V.jsxs)(`g`,{clipPath:`url(#clip0_224_2)`,children:[(0,V.jsx)(`path`,{d:`M96 0V416H512V0H96ZM472 376H136V40H472V376Z`,fill:`#aaa`}),(0,V.jsx)(`path`,{d:`M40 472V296V136V96H0V512H416V472H376H40Z`,fill:`#aaa`}),(0,V.jsx)(`path`,{d:`M232.812 312.829L350.671 194.969V279.766H390.671V126.688H237.594V166.688H322.39L204.531 284.547L232.812 312.829Z`,fill:`#aaa`})]}),(0,V.jsx)(`defs`,{children:(0,V.jsx)(`clipPath`,{id:`clip0_224_2`,children:(0,V.jsx)(`rect`,{width:`512`,height:`512`,fill:`white`})})})]})})})]})]}),(0,V.jsxs)(`div`,{className:B.content,children:[(0,V.jsxs)(`div`,{className:B.displayOptions,ref:he,children:[(0,V.jsx)(`div`,{className:B.displayOptions_btn,"data-active":pe,onClick:()=>me(!pe),title:`Display Options`,children:`⚙`}),pe&&(0,V.jsxs)(`div`,{className:B.overlay,children:[(0,V.jsx)(`div`,{className:B.overlay_label,children:`Rendering`}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Render`,children:(0,V.jsx)(Zi,{value:r,onChange:e=>i&&i(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_separator}),(0,V.jsx)(`div`,{className:B.overlay_label,children:`Helpers`}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Show`,children:(0,V.jsx)(Zi,{value:_,onChange:e=>v&&v(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,"data-indent":`true`,children:(0,V.jsx)(ae,{title:`Empty`,children:(0,V.jsx)(Zi,{value:y,onChange:e=>b&&b(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,"data-indent":`true`,children:(0,V.jsx)(ae,{title:`Camera`,children:(0,V.jsx)(Zi,{value:x,onChange:e=>S&&S(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,"data-indent":`true`,children:(0,V.jsx)(ae,{title:`Light`,children:(0,V.jsx)(Zi,{value:C,onChange:e=>ee&&ee(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_separator}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Grid`,children:(0,V.jsx)(Zi,{value:te,onChange:e=>w&&w(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Wireframe`,children:(0,V.jsx)(Zi,{value:ne,onChange:e=>re&&re(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Gizmo`,children:(0,V.jsx)(Zi,{value:ie,onChange:e=>oe&&oe(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Outline`,children:(0,V.jsx)(Zi,{value:se,onChange:e=>ce&&ce(e)})})})]})]}),(0,V.jsxs)(`div`,{className:B.gizmoMode,children:[[`select`,`translate`,`rotate`,`scale`].map(e=>(0,V.jsx)(`div`,{className:B.gizmoMode_btn,"data-active":f===e,onClick:()=>p&&p(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`select`?`↖`:e===`translate`?`T`:e===`rotate`?`R`:`S`},e)),(0,V.jsx)(`div`,{className:B.gizmoMode_separator}),[`global`,`local`].map(e=>(0,V.jsx)(`div`,{className:B.gizmoMode_btn,"data-active":m===e,onClick:()=>h&&h(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`global`?`G`:`L`},e))]}),g&&(0,V.jsx)(`div`,{className:B.modalStatus,children:g}),(0,V.jsx)(`div`,{className:B.canvas,children:(0,V.jsx)(cc,{viewportId:e})}),n.isSP&&(0,V.jsx)(wc,{viewportId:e}),n.isPC&&le&&(0,V.jsxs)(V.Fragment,{children:[(0,V.jsx)(`div`,{className:B.audioViewHandle,onPointerDown:e=>{e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),fe.current={startY:e.clientY,startHeight:ue}},onPointerMove:e=>{if(!fe.current)return;let t=fe.current.startY-e.clientY,n=Math.max(20,Math.min(400,fe.current.startHeight+t));de(n)},onPointerUp:()=>{fe.current=null}}),(0,V.jsx)(`div`,{className:B.audioView,style:{height:ue},children:(0,V.jsx)(_c,{})})]})]})]})},Xc.__docgenInfo={description:``,methods:[],displayName:`Screen`}})))()}function Qc(e,t){let n=e.get(t);if(n)return n;let r=t.indexOf(`:`);if(r===-1)return;let i=e.get(t.slice(0,r));return i?.multiple?i:void 0}function $c(e){return e.slice(e.indexOf(`:`)+1)}function el(e){return e.multiple?`${e.id}:${it.genUUID()}`:e.id}function tl(e,t){return e.multiple?e.content($c(t)):e.content}function nl(){return fl(`vertical`,[{ratio:916/1076,node:fl(`horizontal`,[{ratio:300/1912,node:fl(`vertical`,[{ratio:696/912,node:pl([`hierarchy`,`scene`])},{ratio:216/912,node:pl([`timer`])}])},{ratio:1312/1912,node:pl([`viewport:main`])},{ratio:300/1912,node:pl([`property`,`textures`,`renderer`,`editor-settings`])}])},{ratio:160/1076,node:pl([`timeline`,`export`])}])}function rl(e){return e.type===`pane`?[e]:e.children.flatMap(e=>rl(e.node))}function il(e,t){let n=new Set,r=new Set,i=e=>{let t=typeof e==`string`&&e!==``&&!n.has(e)?e:it.genUUID();return n.add(t),t},a=e=>{if(typeof e!=`object`||!e)return null;let n=e;if(n.type===`pane`){if(!Array.isArray(n.tabs))return null;let e=[...new Set(n.tabs.filter(e=>typeof e==`string`))].filter(e=>{let n=t(e);return n?!n.multiple||!r.has(e)&&(r.add(e),!0):!1});if(e.length===0)return null;let a=typeof n.active==`string`&&e.includes(n.active)?n.active:e[0];return{type:`pane`,id:i(n.id),tabs:e,active:a}}if(n.type===`split`){if(n.direction!==`horizontal`&&n.direction!==`vertical`||!Array.isArray(n.children))return null;let e=[];return n.children.forEach(t=>{if(typeof t!=`object`||!t)return;let n=t,r=a(n.node);if(!r)return;let i=typeof n.ratio==`number`&&isFinite(n.ratio)&&n.ratio>0?n.ratio:1;e.push({ratio:i,node:r})}),e.length===0?null:e.length===1?e[0].node:{type:`split`,id:i(n.id),direction:n.direction,children:e}}return null},o=a(e);return o?ml(o):null}function al(e,t,n){return hl(e,t,e=>e.type!==`pane`||!e.tabs.includes(n)?e:{...e,active:n})}function ol(e,t){let n=e;for(let r of rl(e))for(let e of t)r.tabs.includes(e)&&r.active!==e&&(n=al(n,r.id,e));return n}function sl(e,t,n,r){return hl(e,t,e=>{if(e.type!==`pane`||e.tabs.includes(n))return e;let t=[...e.tabs];return t.splice(Math.max(0,Math.min(r??t.length,t.length)),0,n),{...e,tabs:t,active:n}})}function cl(e,t,n,r,i){if(t===r)return hl(e,t,e=>{if(e.type!==`pane`)return e;let t=e.tabs.indexOf(n);if(t===-1)return e;let r=e.tabs.filter(e=>e!==n),a=i??e.tabs.length,o=Math.max(0,Math.min(t<a?a-1:a,r.length));return o===t?e:(r.splice(o,0,n),{...e,tabs:r,active:n})});let a=rl(e),o=a.find(e=>e.id===t),s=a.find(e=>e.id===r);return!o||!s||!o.tabs.includes(n)||s.tabs.includes(n)?e:sl(ul(e,t,n),r,n,i)}function ll(e,t,n,r,i){let a=rl(e),o=a.find(e=>e.id===r);if(!o||!o.tabs.includes(i)||!a.some(e=>e.id===t)||r===t&&o.tabs.length===1)return e;let s=ul(e,r,i),c={type:`pane`,id:it.genUUID(),tabs:[i],active:i},l=hl(s,t,e=>{let t=[{ratio:.5,node:c},{ratio:.5,node:e}];return(n===`right`||n===`bottom`)&&t.reverse(),{type:`split`,id:it.genUUID(),direction:n===`left`||n===`right`?`horizontal`:`vertical`,children:t}});return l===s?e:ml(l)??e}function ul(e,t,n){let r=hl(e,t,e=>{if(e.type!==`pane`||!e.tabs.includes(n))return e;let t=e.tabs.indexOf(n),r=e.tabs.filter(e=>e!==n),i=e.active!==n||r.length===0?e.active:r[Math.min(t,r.length-1)];return{...e,tabs:r,active:i}});return r===e?e:ml(r)??e}function dl(e,t,n){return hl(e,t,e=>e.type!==`split`||e.children.length!==n.length?e:{...e,children:e.children.map((e,t)=>({...e,ratio:n[t]}))})}var fl,pl,ml,hl;function gl(){return(gl=t((()=>{ot(),fl=(e,t)=>({type:`split`,id:it.genUUID(),direction:e,children:t}),pl=e=>({type:`pane`,id:it.genUUID(),tabs:e,active:e[0]}),ml=e=>{if(e.type===`pane`)return e.tabs.length>0?e:null;let t=[];if(e.children.forEach(n=>{let r=ml(n.node);r&&(r.type===`split`&&r.direction===e.direction?r.children.forEach(e=>t.push({ratio:n.ratio*e.ratio,node:e.node})):t.push(r===n.node?n:{...n,node:r}))}),t.length===0)return null;if(t.length===1)return t[0].node;let n=t.reduce((e,t)=>e+t.ratio,0);return Math.abs(n-1)>1e-6?{...e,children:t.map(e=>({...e,ratio:e.ratio/n}))}:t.length!==e.children.length||t.some((t,n)=>t!==e.children[n])?{...e,children:t}:e},hl=(e,t,n)=>{if(e.id===t)return n(e);if(e.type===`split`){let r=!1,i=e.children.map(e=>{let i=hl(e.node,t,n);return i===e.node?e:(r=!0,{...e,node:i})});if(r)return{...e,children:i}}return e}})))()}function _l(e,t,n){let[r,i]=(0,vl.useState)(null),a=(0,vl.useRef)(e);a.current=e;let o=(0,vl.useRef)(t);o.current=t;let s=(0,vl.useRef)(null);return(0,vl.useEffect)(()=>()=>s.current?.(),[]),{dragState:r,onTabPointerDown:(e,t,r)=>{if(r.button!==0||s.current)return;let c=r.clientX,l=r.clientY,u=!1,d=null,f=r=>{if(r.buttons===0){p(!1);return}if(!u){if(Math.hypot(r.clientX-c,r.clientY-l)<yl)return;u=!0,i({panelId:t,title:n(t)?.title??t,startX:r.clientX,startY:r.clientY,target:null})}let o=Cl(r.clientX,r.clientY,a.current,e,t);wl(o,d)||(d=o,i(e=>e&&{...e,target:o}))},p=n=>{if(g(),n&&u&&d){let n=a.current;d.kind===`tabs`?o.current(cl(n,e,t,d.paneId,d.index)):d.zone===`center`?o.current(cl(n,e,t,d.paneId)):o.current(ll(n,d.paneId,d.zone,e,t))}u&&i(null)},m=()=>p(!0),h=()=>p(!1),g=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),s.current=null};s.current=g,window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h)}}}var vl,yl,bl,xl,Sl,Cl,wl;function Tl(){return(Tl=t((()=>{vl=i(),gl(),yl=4,bl=.25,xl=(e,t)=>{let n={left:e.left,top:e.top,width:e.width,height:e.height};return(t===`left`||t===`right`)&&(n.width/=2),t===`right`&&(n.left+=n.width),(t===`top`||t===`bottom`)&&(n.height/=2),t===`bottom`&&(n.top+=n.height),n},Sl=(e,t,n,r,i)=>{if(n.id!==r&&n.tabs.includes(i))return null;let a=[...t.querySelectorAll(`[data-panel-tab-id]`)].filter(e=>e instanceof HTMLElement),o=a.length;for(let t=0;t<a.length;t++){let n=a[t].getBoundingClientRect();if(e<n.left+n.width/2){o=t;break}}let s=t.getBoundingClientRect(),c=o<a.length?a[o].getBoundingClientRect().left:a.length>0?a[a.length-1].getBoundingClientRect().right:s.left;return{kind:`tabs`,paneId:n.id,index:o,rect:{left:c-1,top:s.top,width:2,height:s.height}}},Cl=(e,t,n,r,i)=>{let a=document.elementFromPoint(e,t);if(!a)return null;let o=a.closest(`[data-pane-id]`);if(!(o instanceof HTMLElement))return null;let s=rl(n).find(e=>e.id===o.dataset.paneId);if(!s)return null;let c=a.closest(`[data-panel-tab-header]`);if(c instanceof HTMLElement)return Sl(e,c,s,r,i);let l=o.querySelector(`[data-panel-content]`);if(!(l instanceof HTMLElement))return null;let u=l.getBoundingClientRect();if(u.width<=0||u.height<=0)return null;let d=(e-u.left)/u.width,f=(t-u.top)/u.height;if(d<0||d>1||f<0||f>1)return null;if(Math.min(d,1-d)>bl&&Math.min(f,1-f)>bl)return s.id===r||s.tabs.includes(i)?null:{kind:`zone`,paneId:s.id,zone:`center`,rect:xl(u,`center`)};if(s.id===r&&s.tabs.length===1)return null;let p=d-.5,m=f-.5,h=Math.abs(p)>=Math.abs(m)?p<0?`left`:`right`:m<0?`top`:`bottom`;return{kind:`zone`,paneId:s.id,zone:h,rect:xl(u,h)}},wl=(e,t)=>e===null||t===null?e===t:e.paneId===t.paneId?e.kind===`tabs`&&t.kind===`tabs`?e.index===t.index:e.kind===`zone`&&t.kind===`zone`&&e.zone===t.zone:!1})))()}var El,Dl;function Ol(){return(Ol=t((()=>{El=`PanelLayout__pane___LnBhb`,Dl={pane:El}})))()}function kl(e,t){let n=[];for(let r of e){let e=n;if(r.category)for(let t of r.category.split(`/`)){if(t===``)continue;let n;for(let r of e)if(r.label===t&&`children`in r){n=r;break}n||(n={label:t,children:[]},e.push(n)),e=n.children}e.push({label:r.title,onClick:()=>t(r)})}return n}var Al,jl,Ml,Nl;function Pl(){return(Pl=t((()=>{Al=i(),w(),I(),Zc(),fo(),de(),Tl(),Ol(),gl(),jl=o(),Ml=e=>{let t=e.node;if(t.type===`split`)return(0,jl.jsx)(oe,{direction:t.direction,ratios:t.children.map(e=>e.ratio),onRatiosChange:n=>e.onRatiosChange(t.id,n),children:t.children.map(t=>(0,jl.jsx)(oe.Item,{children:(0,jl.jsx)(Ml,{...e,node:t.node})},t.node.id))});let n=t.tabs.flatMap(t=>{let n=e.resolve(t);return n?[{id:t,title:n.title,content:tl(n,t)}]:[]});if(n.length===0)return null;let r=e.hasAddable(t);return(0,jl.jsx)(`div`,{className:Dl.pane,"data-pane-id":t.id,children:(0,jl.jsx)(ue,{tabs:n,active:t.active,onSelect:n=>e.onSelectTab(t.id,n),onTabContextMenu:(n,r)=>e.onTabContextMenu(t.id,n,r),onTabPointerDown:(n,r)=>e.onTabPointerDown(t.id,n,r),onAddClick:r?n=>e.onAddTab(t.id,n):void 0})})},Nl=e=>{let{editor:t}=F(),{open:n,closeAll:r}=S(),i=(0,Al.useMemo)(()=>{let t=new Map;return e.panels.forEach(e=>t.set(e.id,e)),t},[e.panels]),a=(0,Al.useMemo)(()=>e=>Qc(i,e),[i]),[o,s]=L(t,`panelLayout`),c=(0,Al.useMemo)(()=>il(o,a)??nl(),[o,a]);(0,Al.useEffect)(()=>{let e=new Set(rl(c).flatMap(e=>e.tabs).filter(e=>a(e)?.id===Yc).map($c));t.pruneViewportSettings(e)},[c,a,t]);let[l,u]=(0,Al.useState)(()=>!!t.getField(`selectedEntityId`));(0,Al.useEffect)(()=>{let e=()=>{t.getField(`selectedEntityId`)&&u(!0)};return t.on(`fields/update/selectedEntityId`,e),()=>{t.off(`fields/update/selectedEntityId`,e)}},[t]);let d=e=>{e!==c&&s(e)},f=e.activateOnSelect;(0,Al.useEffect)(()=>{if(!l||(u(!1),!f))return;let e=ol(c,f);e!==c&&t.setField(`panelLayout`,e)},[l,f,c,t]);let p=(e,t)=>d(al(c,e,t)),m=(e,t)=>d(dl(c,e,t)),{dragState:h,onTabPointerDown:g}=_l(c,d,a),_=e=>[...i.values()].filter(t=>t.multiple||!e.tabs.includes(t.id));return(0,jl.jsxs)(jl.Fragment,{children:[(0,jl.jsx)(Ml,{node:c,resolve:a,onSelectTab:p,onRatiosChange:m,onTabContextMenu:(e,t,i)=>{i.preventDefault(),rl(c).reduce((e,t)=>e+t.tabs.length,0)>1&&n((0,jl.jsx)(ce,{title:a(t)?.title,items:[{label:`Close Tab`,onClick:()=>{d(ul(c,e,t)),r()}}]}),ie(i.clientX,i.clientY))},onTabPointerDown:g,onAddTab:(e,t)=>{let i=rl(c).find(t=>t.id===e);if(!i)return;let a=_(i);if(a.length===0)return;let o=kl(a,t=>{d(sl(c,e,el(t))),r()});n((0,jl.jsx)(ce,{items:o}),ie(t.clientX,t.clientY))},hasAddable:e=>_(e).length>0}),h&&(0,jl.jsx)(fe,{drag:h})]})},Nl.__docgenInfo={description:``,methods:[],displayName:`PanelLayout`,props:{panels:{required:!0,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},activateOnSelect:{required:!1,tsType:{name:`Array`,elements:[{name:`string`}],raw:`PanelId[]`},description:``}}}})))()}var Fl,Il,Ll;function Rl(){return(Rl=t((()=>{Fl=`RendererSettings__renderer___LnJlb`,Il=`RendererSettings__renderer_inner___LnJlb`,Ll={renderer:Fl,renderer_inner:Il}})))()}var zl,Bl;function Vl(){return(Vl=t((()=>{w(),I(),uo(),Rl(),zl=o(),Bl=()=>{let{editor:e}=F(),t=e.engine.renderer;return(0,zl.jsx)(`div`,{className:Ll.renderer,children:(0,zl.jsxs)(`div`,{className:Ll.renderer_inner,children:[(0,zl.jsx)(s,{label:`Resolution`,accordion:!0,children:(0,zl.jsx)(lo,{target:e,filter:`resolution`})}),(0,zl.jsx)(s,{label:`Pipeline`,accordion:!0,children:(0,zl.jsx)(lo,{target:t,filter:`pipeline`})}),(0,zl.jsx)(s,{label:`Sky`,accordion:!0,children:(0,zl.jsx)(lo,{target:t,filter:`sky`})})]})})},Bl.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var Hl,Ul,Wl,Gl,Kl,ql;function Jl(){return(Jl=t((()=>{Hl=`SceneControl__sceneControl___LnNjZ`,Ul=`SceneControl__sceneControl_inner___LnNjZ`,Wl=`SceneControl__select___LnNjZ`,Gl=`SceneControl__select_name___LnNjZ`,Kl=`SceneControl__save___LnNjZ`,ql={sceneControl:Hl,sceneControl_inner:Ul,select:Wl,select_name:Gl,save:Kl}})))()}var Yl,Xl,Zl;function Ql(){return(Ql=t((()=>{Yl=i(),w(),I(),pe(),Jl(),Xl=o(),Zl=()=>{let{editor:e,projectName:t,scenes:n}=F(),[r,i]=(0,Yl.useState)(null),o=null;return n&&(o=(0,Xl.jsx)(ae,{title:`scene`,children:(0,Xl.jsxs)(`button`,{className:ql.select,onClick:e=>{i(ie(e.clientX,e.clientY))},children:[(0,Xl.jsx)(`span`,{className:ql.select_name,children:n.current??`-`}),(0,Xl.jsx)(a,{open:!0})]})})),(0,Xl.jsxs)(`div`,{className:ql.sceneControl,children:[(0,Xl.jsx)(`div`,{className:ql.sceneControl_inner,children:(0,Xl.jsxs)(s,{label:t,accordion:!0,children:[o,(0,Xl.jsx)(`div`,{className:ql.save,children:(0,Xl.jsx)(c,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,Xl.jsx)(me,{scenes:n,projectName:t,anchor:r,onClose:()=>{i(null)}})]})},Zl.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var $l,eu,tu,nu,ru,iu,au;function ou(){return(ou=t((()=>{$l=`Textures__textures___LnRle`,eu=`Textures__item___LnRle`,tu=`Textures__preview___LnRle`,nu=`Textures__img___LnRle`,ru=`Textures__placeholder___LnRle`,iu=`Textures__name___LnRle`,au={textures:$l,item:eu,preview:tu,img:nu,placeholder:ru,name:iu}})))()}var su,cu,lu;function uu(){return(uu=t((()=>{su=i(),Oi(),I(),ou(),cu=o(),lu=()=>{let{engine:e,editor:t}=F(),[,n]=(0,su.useState)(0);(0,su.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return P.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{P.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=P.resources.textureList;return(0,cu.jsx)(`div`,{className:au.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,cu.jsxs)(`div`,{className:au.item,children:[(0,cu.jsx)(`div`,{className:au.preview,children:n?(0,cu.jsx)(`img`,{src:n,className:au.img}):(0,cu.jsx)(`div`,{className:au.placeholder})}),(0,cu.jsx)(`div`,{className:au.name,children:e.name})]},e.name)})})},lu.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var du,fu;function pu(){return(pu=t((()=>{du=i(),fu=(0,du.createContext)(null)})))()}var mu,hu;function gu(){return(gu=t((()=>{mu=i(),pu(),hu=()=>{let e=(0,mu.useContext)(fu);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var _u;function vu(){return(vu=t((()=>{_u=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}},{key:`layout`,value:{name:`union`,raw:`'inline' | 'block'`,elements:[{name:`literal`,value:`'inline'`},{name:`literal`,value:`'block'`}],required:!0}}]},required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}var xS,SS;function CS(){return(CS=t((()=>{xS=e(i(),1),$p(),Si(),SS=()=>{let[e,t]=xS.useState(()=>new P(Zp)),n=xS.useRef(e);return n.current=e,(0,xS.useEffect)(()=>{n.current.disposed&&t(new P(Zp))},[]),(0,xS.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,xS.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var wS,TS,ES;function DS(){return(DS=t((()=>{wS=i(),Qo(),CS(),TS=o(),ES=e=>{let t=SS(),{engine:n}=t,r=(0,wS.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,wS.useEffect)(()=>{r.current?.(n)},[n]),(0,wS.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,TS.jsx)(Zo.Provider,{value:t,children:e.children})},ES.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var OS,kS,AS,jS,MS,NS,PS;function FS(){return(FS=t((()=>{OS=i(),bS(),DS(),kS=o(),AS=`scene`,jS=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},MS=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),NS=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),PS=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,OS.useState)(e.sceneData),[a,o]=(0,OS.useState)(e.editorData),[s,c]=(0,OS.useState)([]),[l,u]=(0,OS.useState)(null),d=(0,OS.useCallback)(async e=>{let t=await jS(`${n}/scenes/${e}`);if(!t)throw Error(`シーンを読み込めません: ${e}`);u(e),i(t)},[n]);(0,OS.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([jS(`${n}/editor`),jS(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[AS]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]),(0,OS.useEffect)(()=>{l&&(document.title=`${l} | OREngine`)},[l]);let f={names:s,current:l,onSelect:d,onCreate:(0,OS.useCallback)(async(e,t)=>{let r=NS(e);if(t!==void 0){let i=await jS(`${n}/scenes/${t}`);if(!i)throw Error(`複製元のシーンを読み込めません: ${t}`);r={...i,name:e}}let i=await MS(`${n}/scenes/${e}`,r);if(!i.ok)throw Error(`シーンを作成できません: ${e}（HTTP ${i.status}）`);let a=await jS(`${n}/scenes`);a&&c(a)},[n]),onDelete:(0,OS.useCallback)(async e=>{let t=await fetch(`${n}/scenes/${e}`,{method:`DELETE`});if(!t.ok)throw Error(`シーンを削除できません: ${e}（HTTP ${t.status}）`);let r=await jS(`${n}/scenes`)??[];c(r),e===l&&r.length>0&&await d(r[0])},[n,l,d])};return(0,kS.jsx)(ES,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,kS.jsx)(yS,{editorData:a,projectName:t,panels:e.panels,fieldUIs:e.fieldUIs,scenes:f,onSave:async(t,r)=>{e.onBeforeSave?.();let i=[MS(`${n}/editor`,{...r,[AS]:l})];l&&i.push(MS(`${n}/scenes/${l}`,t));for(let e of await Promise.all(i))if(!e.ok)throw Error(`保存に失敗しました（POST ${new URL(e.url).pathname}: HTTP ${e.status}）`)}})})},PS.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}},{key:`layout`,value:{name:`union`,raw:`'inline' | 'block'`,elements:[{name:`literal`,value:`'inline'`},{name:`literal`,value:`'block'`}],required:!0}}]},required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var IS,LS;function RS(){return(RS=t((()=>{bS(),DS(),IS=o(),LS=e=>(0,IS.jsx)(ES,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,IS.jsx)(yS,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,fieldUIs:e.fieldUIs,onSave:()=>{}})}),LS.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}},{key:`layout`,value:{name:`union`,raw:`'inline' | 'block'`,elements:[{name:`literal`,value:`'inline'`},{name:`literal`,value:`'block'`}],required:!0}}]},required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}function zS(){return(zS=t((()=>{i(),I()})))()}var BS,VS,HS;function US(){return(US=t((()=>{BS=`InputGroup__group___Lmdyb`,VS=`InputGroup__submit___Lmdyb`,HS={group:BS,submit:VS}})))()}var WS,GS,KS;function qS(){return(qS=t((()=>{WS=i(),w(),Qi(),US(),GS=o(),KS=e=>{let t=e.initialValues,n=[],[r,i]=(0,WS.useState)(t);(0,WS.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,GS.jsx)(Zi,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,WS.useRef)(null);return(0,WS.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,GS.jsx)(`div`,{className:HS.group,ref:o,children:(0,GS.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,GS.jsx)(s,{label:e.title,noMargin:!0,children:n}),(0,GS.jsx)(`div`,{className:HS.submit,children:(0,GS.jsx)(c,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},KS.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}function JS(){return(JS=t((()=>{FS(),RS(),bS(),mS(),I(),zS(),DS(),ts(),nc(),Vo(),Zc(),vc(),Tc(),Ld(),gu(),Ql(),Yo(),ks(),Vl(),ma(),sa(),uu(),uo(),lc(),Qi(),Ka(),qS(),Ii(),Bi(),Yi(),fo(),Aa(),Ba(),we()})))()}var YS;function XS(){return(XS=t((()=>{YS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ZS;function QS(){return(QS=t((()=>{ZS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var $S=n({EyeRings:()=>eC}),eC;function tC(){return(tC=t((()=>{N(),XS(),QS(),eC=class extends k{constructor(e){super(e);let t=new $t({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new vn({phase:[`deferred`,`shadowMap`],frag:YS,vert:ZS});this.entity.addComponent(A,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var nC;function rC(){return(rC=t((()=>{nC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var iC;function aC(){return(aC=t((()=>{iC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var oC=n({FlashLine:()=>sC}),sC;function cC(){return(cC=t((()=>{D(),N(),rC(),aC(),sC=class extends k{geometry;material;constructor(e){super(e),this.geometry=new jt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=je.randomVector().multiply(new T(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new vn({phase:[`forward`,`envMap`],frag:j(`flFrag`,nC),vert:j(`flVert`,iC)}),this.entity.addComponent(A,{material:this.material,geometry:this.geometry})}}})))()}var lC;function uC(){return(uC=t((()=>{lC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var dC=n({SkyBox:()=>fC}),fC;function pC(){return(pC=t((()=>{N(),uC(),fC=class extends k{material;constructor(e){super(e);let t=this.engine;this.material=new vn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:j(`SkyBoxFrag`,lC),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}}})))()}var mC;function hC(){return(hC=t((()=>{mC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var vC=n({GridCross:()=>yC}),yC;function bC(){return(bC=t((()=>{D(),N(),hC(),_C(),yC=class extends k{constructor(e){super(e);let t=new kt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new T(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new vn({frag:j(`gridCrossFrag`,mC),vert:j(`gridCrossVert`,gC),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var xC;function SC(){return(SC=t((()=>{xC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var TC=n({GridDots:()=>EC}),EC;function DC(){return(DC=t((()=>{D(),N(),SC(),wC(),EC=class extends k{constructor(e){super(e);let t=new Ft({radius:.1}),n=[],r=[],i=new T(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new vn({frag:j(`gridDotsFrag`,xC),vert:j(`gridDotsVert`,CC),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var OC;function kC(){return(kC=t((()=>{OC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var MC=n({WireCube:()=>NC}),NC;function PC(){return(PC=t((()=>{N(),kC(),jC(),NC=class extends k{constructor(e){super(e);let t=3.3,n=t/2,r=new kt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new vn({phase:[`deferred`],frag:OC,vert:AC});this.entity.addComponent(A,{geometry:r,material:o})}}})))()}var FC=n({FieldUISample:()=>IC}),IC;function LC(){return(LC=t((()=>{D(),N(),IC=class extends k{speed;wave;rotQuaternion;constructor(e){super(e),this.speed=1,this.wave=.5,this.rotQuaternion=new ke,this.field(`speed`,()=>this.speed,e=>this.speed=e,{step:.1}),this.field(`wave`,()=>this.wave,e=>this.wave=e,{step:.05,min:0})}updateImpl(e){this.rotQuaternion.setFromEuler(new De(0,e.timeDelta*this.speed,0)),this.entity.quaternion.multiply(this.rotQuaternion),this.entity.position.y=Math.sin(e.timeElapsed*2)*this.wave}}})))()}var RC;function zC(){return(zC=t((()=>{RC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var BC;function VC(){return(VC=t((()=>{BC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var HC=n({OREngineCube:()=>UC}),UC;function WC(){return(WC=t((()=>{N(),Oi(),zC(),VC(),UC=class extends k{material;constructor(e){super(e),this.material=new vn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:j(`OREngineCubeVert`,BC),frag:j(`OREngineCubeFrag`,RC),uniforms:{uNoiseTex:{value:P.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var GC;function KC(){return(KC=t((()=>{GC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var qC;function JC(){return(JC=t((()=>{qC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var YC=n({OREngineLogo:()=>XC}),XC;function ZC(){return(ZC=t((()=>{N(),KC(),JC(),XC=class extends k{material;constructor(e){super(e),this.material=new vn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:j(`OREngineLogoVert`,qC),frag:j(`OREngineLogoFrag`,GC)});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var QC;function $C(){return($C=t((()=>{QC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ew;function tw(){return(tw=t((()=>{ew=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var nw=n({Dust:()=>rw}),rw;function iw(){return(iw=t((()=>{D(),N(),$C(),tw(),rw=class extends k{constructor(e){super(e);let t=new Dt,n=e.args?.num||2048,r=new T(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new vn({phase:[`forward`],drawType:`POINTS`,frag:QC,vert:ew});this.entity.addComponent(A,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var aw;function ow(){return(ow=t((()=>{aw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var sw;function cw(){return(cw=t((()=>{sw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var lw;function uw(){return(uw=t((()=>{lw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `})))()}var dw=n({YakiSoba:()=>fw}),fw;function pw(){return(pw=t((()=>{D(),N(),ow(),cw(),uw(),fw=class extends k{_gpu;constructor(e){super(e);let t=this.engine,n=new T(64,512);this._gpu=new oi({passes:[new li(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:j(`yakiSobaCompute`,lw),uniforms:dn.merge({},t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new kt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new vn({frag:j(`chainFrag`,aw),vert:j(`chainVert`,sw),phase:[`deferred`,`shadowMap`],uniforms:dn.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(A,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(A),this._gpu.dispose()}}})))()}var mw;function hw(){return(hw=t((()=>{mw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var Jw;function Yw(){return(Yw=t((()=>{qw(),Jw={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:Kw}})))()}var Xw;function Zw(){return(Zw=t((()=>{Xw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var Qw;function $w(){return($w=t((()=>{Zw(),Qw={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:Xw}})))()}var eT;function tT(){return(tT=t((()=>{eT=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var nT;function rT(){return(rT=t((()=>{tT(),nT={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:eT}})))()}var iT;function aT(){return(aT=t((()=>{tT(),iT={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:eT}})))()}var oT,sT,cT;function lT(){return(lT=t((()=>{Yw(),$w(),rT(),aT(),Oi(),oT=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":Jw,"/demo-webgl/Resources/Textures/noise.tex":Qw,"/demo-webgl/Resources/Textures/noiseCyclic.tex":nT,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":iT}),sT=()=>{for(let e of Object.values(oT))e&&P.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},cT=e=>{P.resources.buildTextureInstances(e.renderer)}})))()}var uT,dT,fT,pT,mT;function hT(){return(hT=t((()=>{tC(),cC(),pC(),bC(),DC(),PC(),LC(),WC(),ZC(),iw(),pw(),vw(),$p(),Oi(),Gw(),lT(),uT=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":$S,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":oC,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":dC,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":vC,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":TC,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":MC,"/demo-webgl/Resources/Components/Samples/Objects/FieldUISample/index.ts":FC,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":HC,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":YC,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":nw,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":dw,"/demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":gw}),dT=Object.assign({}),fT=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);fT(a,e)}}},pT=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);pT(a,e)}}},mT=()=>{xt.gltfLoaderFactory=e=>new Gp(e),P.resources.clear();let e=P.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Vt),e.addComponent(`Camera`,Lt),e.addComponent(`Mesh`,A);let t=Object.keys(Uw);for(let e=0;e<t.length;e++){let n=t[e],r=Uw[n],i=P.resources.addComponentGroup(n);fT(r,i)}let n=Object.keys(Ww);for(let e=0;e<n.length;e++){let t=n[e],r=Ww[t],i=P.resources.addGeometryGroup(t);pT(r,i)}let r=_i(uT,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=P.resources.addComponentGroup(t);fT(n,a)}let a=_i(dT,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=P.resources.addGeometryGroup(t);pT(n,r)}sT()}})))()}var gT,_T,vT,yT,bT,xT;function ST(){return(ST=t((()=>{gT=i(),JS(),w(),hT(),_T=o(),mT(),vT=({setup:e})=>{let{editor:t}=F();return(0,gT.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},yT=e=>(0,_T.jsx)(ES,{project:e.fixture.scene,onEngineInit:cT,children:(0,_T.jsx)(pS,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,_T.jsx)(x,{children:(0,_T.jsxs)(ne,{children:[e.children,e.fixture.setup&&(0,_T.jsx)(vT,{setup:e.fixture.setup}),(0,_T.jsx)(y,{}),(0,_T.jsx)(te,{})]})})})}),bT=e=>t=>(0,_T.jsx)(yT,{fixture:e,children:(0,_T.jsx)(t,{})}),xT=e=>t=>(0,_T.jsx)(ES,{project:e,onEngineInit:cT,children:(0,_T.jsx)(t,{})}),yT.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var CT,wT,TT,ET,DT;function OT(){return(OT=t((()=>{CT={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`LookAt`,uuid:`sb-camera-lookat`}]},wT={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[CT,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},TT={...wT,scene:{name:`root`,uuid:`0`,childs:[CT]}},ET={enableRender:!0,"viewports/main/resolutionScale":.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},DT={scene:wT,editorData:ET}})))()}export{pa as A,I as B,Yo as C,uo as D,lo as E,Yi as F,Oi as H,zi as I,Bi as L,Zi as M,Qi as N,Ga as O,Ji as P,Fi as R,Jo as S,Vo as T,P as U,F as V,Si as W,Ql as _,wT as a,tc as b,bT as c,qS as d,yS as f,Zl as g,Ld as h,DT as i,ma as j,Ka as k,xT as l,Id as m,ET as n,yT as o,bS as p,TT as r,ST as s,OT as t,KS as u,Bl as v,Bo as w,nc as x,Vl as y,Ii as z};