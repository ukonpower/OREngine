...
\r
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}var Ol,kl,Al;function jl(){return(jl=t((()=>{Ol=`RendererSettings__renderer___LnJlb`,kl=`RendererSettings__renderer_inner___LnJlb`,Al={renderer:Ol,renderer_inner:kl}})))()}var Ml,Nl;function Pl(){return(Pl=t((()=>{w(),I(),io(),jl(),Ml=o(),Nl=()=>{let{editor:e}=F(),t=e.engine.renderer;return(0,Ml.jsx)(`div`,{className:Al.renderer,children:(0,Ml.jsxs)(`div`,{className:Al.renderer_inner,children:[(0,Ml.jsx)(s,{label:`Resolution`,accordion:!0,children:(0,Ml.jsx)(ro,{target:e,filter:`resolution`})}),(0,Ml.jsx)(s,{label:`Pipeline`,accordion:!0,children:(0,Ml.jsx)(ro,{target:t,filter:`pipeline`})}),(0,Ml.jsx)(s,{label:`Sky`,accordion:!0,children:(0,Ml.jsx)(ro,{target:t,filter:`sky`})})]})})},Nl.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var Fl,Il,Ll,Rl,zl,Bl;function Vl(){return(Vl=t((()=>{Fl=`SceneControl__sceneControl___LnNjZ`,Il=`SceneControl__sceneControl_inner___LnNjZ`,Ll=`SceneControl__select___LnNjZ`,Rl=`SceneControl__select_name___LnNjZ`,zl=`SceneControl__save___LnNjZ`,Bl={sceneControl:Fl,sceneControl_inner:Il,select:Ll,select_name:Rl,save:zl}})))()}var Hl,Ul,Wl;function Gl(){return(Gl=t((()=>{Hl=i(),w(),I(),pe(),Vl(),Ul=o(),Wl=()=>{let{editor:e,projectName:t,scenes:n}=F(),[r,i]=(0,Hl.useState)(null),o=null;return n&&(o=(0,Ul.jsx)(ae,{title:`scene`,children:(0,Ul.jsxs)(`button`,{className:Bl.select,onClick:e=>{i(ie(e.clientX,e.clientY))},children:[(0,Ul.jsx)(`span`,{className:Bl.select_name,children:n.current??`-`}),(0,Ul.jsx)(a,{open:!0})]})})),(0,Ul.jsxs)(`div`,{className:Bl.sceneControl,children:[(0,Ul.jsx)(`div`,{className:Bl.sceneControl_inner,children:(0,Ul.jsxs)(s,{label:t,accordion:!0,children:[o,(0,Ul.jsx)(`div`,{className:Bl.save,children:(0,Ul.jsx)(c,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,Ul.jsx)(me,{scenes:n,projectName:t,anchor:r,onClose:()=>{i(null)}})]})},Wl.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var Kl,ql,Jl,Yl,Xl,Zl,Ql;function $l(){return($l=t((()=>{Kl=`Textures__textures___LnRle`,ql=`Textures__item___LnRle`,Jl=`Textures__preview___LnRle`,Yl=`Textures__img___LnRle`,Xl=`Textures__placeholder___LnRle`,Zl=`Textures__name___LnRle`,Ql={textures:Kl,item:ql,preview:Jl,img:Yl,placeholder:Xl,name:Zl}})))()}var eu,tu,nu;function ru(){return(ru=t((()=>{eu=i(),Ti(),I(),$l(),tu=o(),nu=()=>{let{engine:e,editor:t}=F(),[,n]=(0,eu.useState)(0);(0,eu.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return P.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{P.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=P.resources.textureList;return(0,tu.jsx)(`div`,{className:Ql.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,tu.jsxs)(`div`,{className:Ql.item,children:[(0,tu.jsx)(`div`,{className:Ql.preview,children:n?(0,tu.jsx)(`img`,{src:n,className:Ql.img}):(0,tu.jsx)(`div`,{className:Ql.placeholder})}),(0,tu.jsx)(`div`,{className:Ql.name,children:e.name})]},e.name)})})},nu.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var iu,au;function ou(){return(ou=t((()=>{iu=i(),au=(0,iu.createContext)(null)})))()}var su,cu;function lu(){return(lu=t((()=>{su=i(),ou(),cu=()=>{let e=(0,su.useContext)(au);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var uu;function du(){return(du=t((()=>{uu=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}var pS,mS;function hS(){return(hS=t((()=>{pS=e(i(),1),Kp(),yi(),mS=()=>{let[e,t]=pS.useState(()=>new P(Wp)),n=pS.useRef(e);return n.current=e,(0,pS.useEffect)(()=>{n.current.disposed&&t(new P(Wp))},[]),(0,pS.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,pS.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var gS,_S,vS;function yS(){return(yS=t((()=>{gS=i(),Ko(),hS(),_S=o(),vS=e=>{let t=mS(),{engine:n}=t,r=(0,gS.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,gS.useEffect)(()=>{r.current?.(n)},[n]),(0,gS.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,_S.jsx)(Go.Provider,{value:t,children:e.children})},vS.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var bS,xS,SS,CS,wS,TS,ES;function DS(){return(DS=t((()=>{bS=i(),fS(),yS(),xS=o(),SS=`scene`,CS=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},wS=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),TS=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),ES=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,bS.useState)(e.sceneData),[a,o]=(0,bS.useState)(e.editorData),[s,c]=(0,bS.useState)([]),[l,u]=(0,bS.useState)(null),d=(0,bS.useCallback)(async e=>{let t=await CS(`${n}/scenes/${e}`);if(!t)throw Error(`シーンを読み込めません: ${e}`);u(e),i(t)},[n]);(0,bS.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([CS(`${n}/editor`),CS(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[SS]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]),(0,bS.useEffect)(()=>{l&&(document.title=`${l} | OREngine`)},[l]);let f={names:s,current:l,onSelect:d,onCreate:(0,bS.useCallback)(async(e,t)=>{let r=TS(e);if(t!==void 0){let i=await CS(`${n}/scenes/${t}`);if(!i)throw Error(`複製元のシーンを読み込めません: ${t}`);r={...i,name:e}}let i=await wS(`${n}/scenes/${e}`,r);if(!i.ok)throw Error(`シーンを作成できません: ${e}（HTTP ${i.status}）`);let a=await CS(`${n}/scenes`);a&&c(a)},[n]),onDelete:(0,bS.useCallback)(async e=>{let t=await fetch(`${n}/scenes/${e}`,{method:`DELETE`});if(!t.ok)throw Error(`シーンを削除できません: ${e}（HTTP ${t.status}）`);let r=await CS(`${n}/scenes`)??[];c(r),e===l&&r.length>0&&await d(r[0])},[n,l,d])};return(0,xS.jsx)(vS,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,xS.jsx)(dS,{editorData:a,projectName:t,panels:e.panels,fieldUIs:e.fieldUIs,scenes:f,onSave:async(t,r)=>{e.onBeforeSave?.();let i=[wS(`${n}/editor`,{...r,[SS]:l})];l&&i.push(wS(`${n}/scenes/${l}`,t));for(let e of await Promise.all(i))if(!e.ok)throw Error(`保存に失敗しました（POST ${new URL(e.url).pathname}: HTTP ${e.status}）`)}})})},ES.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var OS,kS;function AS(){return(AS=t((()=>{fS(),yS(),OS=o(),kS=e=>(0,OS.jsx)(vS,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,OS.jsx)(dS,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,fieldUIs:e.fieldUIs,onSave:()=>{}})}),kS.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}function jS(){return(jS=t((()=>{i(),I()})))()}var MS,NS,PS;function FS(){return(FS=t((()=>{MS=`InputGroup__group___Lmdyb`,NS=`InputGroup__submit___Lmdyb`,PS={group:MS,submit:NS}})))()}var IS,LS,RS;function zS(){return(zS=t((()=>{IS=i(),w(),Yi(),FS(),LS=o(),RS=e=>{let t=e.initialValues,n=[],[r,i]=(0,IS.useState)(t);(0,IS.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,LS.jsx)(Ji,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,IS.useRef)(null);return(0,IS.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,LS.jsx)(`div`,{className:PS.group,ref:o,children:(0,LS.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,LS.jsx)(s,{label:e.title,noMargin:!0,children:n}),(0,LS.jsx)(`div`,{className:PS.submit,children:(0,LS.jsx)(c,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},RS.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}function BS(){return(BS=t((()=>{DS(),AS(),fS(),sS(),I(),jS(),yS(),Yo(),Xs(),Fo(),Gc(),fc(),yc(),Ad(),lu(),Gl(),Uo(),Cs(),Pl(),da(),ia(),ru(),io(),rc(),Yi(),Ba(),zS(),Ni(),Li(),Ki(),ao(),Da(),Pa(),we()})))()}var VS;function HS(){return(HS=t((()=>{VS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var GS=n({EyeRings:()=>KS}),KS;function qS(){return(qS=t((()=>{N(),HS(),WS(),KS=class extends k{constructor(e){super(e);let t=new $t({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new hn({phase:[`deferred`,`shadowMap`],frag:VS,vert:US});this.entity.addComponent(A,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var JS;function YS(){return(YS=t((()=>{JS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var XS;function ZS(){return(ZS=t((()=>{XS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var QS=n({FlashLine:()=>$S}),$S;function eC(){return(eC=t((()=>{D(),N(),YS(),ZS(),$S=class extends k{geometry;material;constructor(e){super(e),this.geometry=new jt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=je.randomVector().multiply(new T(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new hn({phase:[`forward`,`envMap`],frag:j(`flFrag`,JS),vert:j(`flVert`,XS)}),this.entity.addComponent(A,{material:this.material,geometry:this.geometry})}}})))()}var tC;function nC(){return(nC=t((()=>{tC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var rC=n({SkyBox:()=>iC}),iC;function aC(){return(aC=t((()=>{N(),nC(),iC=class extends k{material;constructor(e){super(e);let t=this.engine;this.material=new hn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:j(`SkyBoxFrag`,tC),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}}})))()}var oC;function sC(){return(sC=t((()=>{oC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var cC;function lC(){return(lC=t((()=>{cC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var uC=n({GridCross:()=>dC}),dC;function fC(){return(fC=t((()=>{D(),N(),sC(),lC(),dC=class extends k{constructor(e){super(e);let t=new kt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new T(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new hn({frag:j(`gridCrossFrag`,oC),vert:j(`gridCrossVert`,cC),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var pC;function mC(){return(mC=t((()=>{pC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var hC;function gC(){return(gC=t((()=>{hC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var _C=n({GridDots:()=>vC}),vC;function yC(){return(yC=t((()=>{D(),N(),mC(),gC(),vC=class extends k{constructor(e){super(e);let t=new Ft({radius:.1}),n=[],r=[],i=new T(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new hn({frag:j(`gridDotsFrag`,pC),vert:j(`gridDotsVert`,hC),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var bC;function xC(){return(xC=t((()=>{bC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
#endif\r
\r
}`})))()}var SC;function CC(){return(CC=t((()=>{SC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var wC=n({WireCube:()=>TC}),TC;function EC(){return(EC=t((()=>{N(),xC(),CC(),TC=class extends k{constructor(e){super(e);let t=3.3,n=t/2,r=new kt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new hn({phase:[`deferred`],frag:bC,vert:SC});this.entity.addComponent(A,{geometry:r,material:o})}}})))()}var DC=n({FieldUISample:()=>OC}),OC;function kC(){return(kC=t((()=>{D(),N(),OC=class extends k{speed;wave;rotQuaternion;constructor(e){super(e),this.speed=1,this.wave=.5,this.rotQuaternion=new ke,this.field(`speed`,()=>this.speed,e=>this.speed=e,{step:.1}),this.field(`wave`,()=>this.wave,e=>this.wave=e,{step:.05,min:0})}updateImpl(e){this.rotQuaternion.setFromEuler(new De(0,e.timeDelta*this.speed,0)),this.entity.quaternion.multiply(this.rotQuaternion),this.entity.position.y=Math.sin(e.timeElapsed*2)*this.wave}}})))()}var AC;function jC(){return(jC=t((()=>{AC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var PC=n({OREngineCube:()=>FC}),FC;function IC(){return(IC=t((()=>{N(),Ti(),jC(),NC(),FC=class extends k{material;constructor(e){super(e),this.material=new hn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:j(`OREngineCubeVert`,MC),frag:j(`OREngineCubeFrag`,AC),uniforms:{uNoiseTex:{value:P.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var LC;function RC(){return(RC=t((()=>{LC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var zC;function BC(){return(BC=t((()=>{zC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var VC=n({OREngineLogo:()=>HC}),HC;function UC(){return(UC=t((()=>{N(),RC(),BC(),HC=class extends k{material;constructor(e){super(e),this.material=new hn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:j(`OREngineLogoVert`,zC),frag:j(`OREngineLogoFrag`,LC)});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var WC;function GC(){return(GC=t((()=>{WC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var KC;function qC(){return(qC=t((()=>{KC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var JC=n({Dust:()=>YC}),YC;function XC(){return(XC=t((()=>{D(),N(),GC(),qC(),YC=class extends k{constructor(e){super(e);let t=new Dt,n=e.args?.num||2048,r=new T(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new hn({phase:[`forward`],drawType:`POINTS`,frag:WC,vert:KC});this.entity.addComponent(A,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var ZC;function QC(){return(QC=t((()=>{ZC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var $C;function ew(){return(ew=t((()=>{$C=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var tw;function nw(){return(nw=t((()=>{tw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `})))()}var rw=n({YakiSoba:()=>iw}),iw;function aw(){return(aw=t((()=>{D(),N(),QC(),ew(),nw(),iw=class extends k{_gpu;constructor(e){super(e);let t=this.engine,n=new T(64,512);this._gpu=new ri({passes:[new oi(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:j(`yakiSobaCompute`,tw),uniforms:cn.merge({},t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new kt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new hn({frag:j(`chainFrag`,ZC),vert:j(`chainVert`,$C),phase:[`deferred`,`shadowMap`],uniforms:cn.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(A,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(A),this._gpu.dispose()}}})))()}var ow;function sw(){return(sw=t((()=>{ow=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var Bw;function Vw(){return(Vw=t((()=>{zw(),Bw={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:Rw}})))()}var Hw;function Uw(){return(Uw=t((()=>{Hw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var Ww;function Gw(){return(Gw=t((()=>{Uw(),Ww={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:Hw}})))()}var Kw;function qw(){return(qw=t((()=>{Kw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var Jw;function Yw(){return(Yw=t((()=>{qw(),Jw={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:Kw}})))()}var Xw;function Zw(){return(Zw=t((()=>{qw(),Xw={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:Kw}})))()}var Qw,$w,eT;function tT(){return(tT=t((()=>{Vw(),Gw(),Yw(),Zw(),Ti(),Qw=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":Bw,"/demo-webgl/Resources/Textures/noise.tex":Ww,"/demo-webgl/Resources/Textures/noiseCyclic.tex":Jw,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":Xw}),$w=()=>{for(let e of Object.values(Qw))e&&P.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},eT=e=>{P.resources.buildTextureInstances(e.renderer)}})))()}var nT,rT,iT,aT,oT;function sT(){return(sT=t((()=>{qS(),eC(),aC(),fC(),yC(),EC(),kC(),IC(),UC(),XC(),aw(),uw(),Kp(),Ti(),Lw(),tT(),nT=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":GS,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":QS,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":rC,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":uC,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":_C,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":wC,"/demo-webgl/Resources/Components/Samples/Objects/FieldUISample/index.ts":DC,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":PC,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":VC,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":JC,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":rw,"/demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":cw}),rT=Object.assign({}),iT=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);iT(a,e)}}},aT=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);aT(a,e)}}},oT=()=>{xt.gltfLoaderFactory=e=>new Rp(e),P.resources.clear();let e=P.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Vt),e.addComponent(`Camera`,Lt),e.addComponent(`Mesh`,A);let t=Object.keys(Fw);for(let e=0;e<t.length;e++){let n=t[e],r=Fw[n],i=P.resources.addComponentGroup(n);iT(r,i)}let n=Object.keys(Iw);for(let e=0;e<n.length;e++){let t=n[e],r=Iw[t],i=P.resources.addGeometryGroup(t);aT(r,i)}let r=mi(nT,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=P.resources.addComponentGroup(t);iT(n,a)}let a=mi(rT,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=P.resources.addGeometryGroup(t);aT(n,r)}$w()}})))()}var cT,lT,uT,dT,fT,pT;function mT(){return(mT=t((()=>{cT=i(),BS(),w(),sT(),lT=o(),oT(),uT=({setup:e})=>{let{editor:t}=F();return(0,cT.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},dT=e=>(0,lT.jsx)(vS,{project:e.fixture.scene,onEngineInit:eT,children:(0,lT.jsx)(oS,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,lT.jsx)(x,{children:(0,lT.jsxs)(ne,{children:[e.children,e.fixture.setup&&(0,lT.jsx)(uT,{setup:e.fixture.setup}),(0,lT.jsx)(y,{}),(0,lT.jsx)(te,{})]})})})}),fT=e=>t=>(0,lT.jsx)(dT,{fixture:e,children:(0,lT.jsx)(t,{})}),pT=e=>t=>(0,lT.jsx)(vS,{project:e,onEngineInit:eT,children:(0,lT.jsx)(t,{})}),dT.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var hT,gT,_T,vT,yT;function bT(){return(bT=t((()=>{hT={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`LookAt`,uuid:`sb-camera-lookat`}]},gT={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[hT,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},_T={...gT,scene:{name:`root`,uuid:`0`,childs:[hT]}},vT={enableRender:!0,"viewports/main/resolutionScale":.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},yT={scene:gT,editorData:vT}})))()}export{ua as A,I as B,Uo as C,io as D,ro as E,Ki as F,Ti as H,Ii as I,Li as L,Ji as M,Yi as N,za as O,Gi as P,Mi as R,Ho as S,Fo as T,P as U,F as V,yi as W,Gl as _,gT as a,Ys as b,fT as c,zS as d,dS as f,Wl as g,Ad as h,yT as i,da as j,Ba as k,pT as l,kd as m,vT as n,dT as o,fS as p,_T as r,mT as s,bT as t,RS as u,Nl as v,Po as w,Xs as x,Pl as y,Ni as z};