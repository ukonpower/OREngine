...
\r
	...
	default?: boolean;
}`,signature:{properties:[{key:`title`,value:{name:`string`,required:!0}},{key:`content`,value:{name:`ReactReactNode`,raw:`React.ReactNode`,required:!0}},{key:`default`,value:{name:`boolean`,required:!1}}]}}],raw:`CustomTab[]`}],raw:`Record<PanelSlot, CustomTab[]>`}],raw:`Partial<Record<PanelSlot, CustomTab[]>>`},description:``}}}})))()}var Mu,Nu,Pu,Fu,Iu,Lu;function Ru(){return(Ru=t((()=>{Mu=`ProjectControl__project___LnByb`,Nu=`ProjectControl__project_inner___LnByb`,Pu=`ProjectControl__projectSelector___LnByb`,Fu=`ProjectControl__row___LnByb`,Iu=`ProjectControl__rowItem___LnByb`,Lu={project:Mu,project_inner:Nu,projectSelector:Pu,row:Fu,rowItem:Iu,export:`ProjectControl__export___LnByb`}})))()}var zu,Bu,Vu,Hu;function Uu(){return(Uu=t((()=>{zu=i(),c(),u(),a(),E(),Ru(),Bu=s(),Vu=new URLSearchParams(location.search).get(`project`)||`default`,Hu=()=>{let{editor:e}=T(),[t,n]=(0,zu.useState)(null);if((0,zu.useEffect)(()=>{if(!e)return;let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),!e)return null;let r=e.isExporting;return(0,Bu.jsx)(`div`,{className:Lu.project,children:(0,Bu.jsx)(`div`,{className:Lu.project_inner,children:(0,Bu.jsxs)(l,{label:Vu,accordion:!0,children:[(0,Bu.jsx)(d,{onClick:()=>{e&&e.save()},children:`Save`}),(0,Bu.jsx)(d,{onClick:()=>{window.location.href=`/`},children:`Projects`}),(0,Bu.jsxs)(`div`,{className:Lu.export,children:[(0,Bu.jsxs)(d,{onClick:()=>{e&&(e.save(),window.open(`/player`,`_blank`))},children:[`Play `,(0,Bu.jsx)(o,{})]}),(0,Bu.jsx)(d,{onClick:()=>{e&&!r&&e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})]})]})})})},Hu.__docgenInfo={description:``,methods:[],displayName:`ProjectControl`}})))()}var Wu,Gu,Ku;function qu(){return(qu=t((()=>{Wu=`RendererSettings__renderer___LnJlb`,Gu=`RendererSettings__renderer_inner___LnJlb`,Ku={renderer:Wu,renderer_inner:Gu}})))()}var Ju,Yu;function Xu(){return(Xu=t((()=>{c(),E(),Tn(),qu(),Ju=s(),Yu=()=>{let{editor:e}=T(),t=e.engine.renderer;return(0,Ju.jsx)(`div`,{className:Ku.renderer,children:(0,Ju.jsxs)(`div`,{className:Ku.renderer_inner,children:[(0,Ju.jsx)(l,{label:`Resolution`,accordion:!0,children:(0,Ju.jsx)(wn,{target:e,filter:`resolution`})}),(0,Ju.jsx)(l,{label:`Pipeline`,accordion:!0,children:(0,Ju.jsx)(wn,{target:t,filter:`pipeline`})}),(0,Ju.jsx)(l,{label:`Sky`,accordion:!0,children:(0,Ju.jsx)(wn,{target:t,filter:`sky`})})]})})},Yu.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var Zu,Qu,$u,ed,td,nd,rd;function id(){return(id=t((()=>{Zu=`Textures__textures___LnRle`,Qu=`Textures__item___LnRle`,$u=`Textures__preview___LnRle`,ed=`Textures__img___LnRle`,td=`Textures__placeholder___LnRle`,nd=`Textures__name___LnRle`,rd={textures:Zu,item:Qu,preview:$u,img:ed,placeholder:td,name:nd}})))()}var ad,od,sd;function cd(){return(cd=t((()=>{ad=i(),eo(),E(),id(),od=s(),sd=()=>{let{engine:e,editor:t}=T(),[,n]=(0,ad.useState)(0);(0,ad.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return qa.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{qa.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=qa.resources.textureList;return(0,od.jsx)(`div`,{className:rd.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,od.jsxs)(`div`,{className:rd.item,children:[(0,od.jsx)(`div`,{className:rd.preview,children:n?(0,od.jsx)(`img`,{src:n,className:rd.img}):(0,od.jsx)(`div`,{className:rd.placeholder})}),(0,od.jsx)(`div`,{className:rd.name,children:e.name})]},e.name)})})},sd.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var ld,ud;function dd(){return(dd=t((()=>{ld=i(),ud=(0,ld.createContext)(null)})))()}var fd,pd;function md(){return(md=t((()=>{fd=i(),dd(),pd=()=>{let e=(0,fd.useContext)(ud);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var hd;function gd(){return(gd=t((()=>{hd=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
