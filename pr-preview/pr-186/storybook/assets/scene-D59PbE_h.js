...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}}})))()}var Sn;function Cn(){return(Cn=t((()=>{Dt(),Sn=class extends Et{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}}})))()}function wn(){return(wn=t((()=>{})))()}function Tn(){return(Tn=t((()=>{})))()}var P;function En(){return(En=t((()=>{k(),Xe(),xn(),wn(),Tn(),P=class extends bn{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var jn;function Mn(){return(Mn=t((()=>{ot(),k(),F(),Xe(),An(),jn=class extends nt{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA,magFilter:A.LINEAR,minFilter:A.LINEAR,wrapS:A.CLAMP_TO_EDGE,wrapT:A.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new D(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA})])});let m=1/4*l,h=new P(e,{renderTarget:s[l].rt1,frag:kn,uniforms:pn.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new D(d,f));let g=new P(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new Sn({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}}})))()}var Nn;function Pn(){return(Pn=t((()=>{Nn=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}}})))()}var Fn,In,Ln,Rn,zn,Bn;function Vn(){return(Vn=t((()=>{Fn=[[.1,.0484],[.118,.187],[.113,.567],[.358,1.99],[.078,7.41]],In=[1,.37,.3],Ln=[.48,.41,.28],Rn=2,zn=(e,t)=>{let n=e/(.001+In[t]),r=0;for(let[e,t]of Fn)r+=e*Math.exp(-(n*n)/(2*t))/(2*Math.PI*t);return r},Bn=e=>{let t=[];for(let n=0;n<e;n++){let r=Rn*n/(e-1);t.push(r*r/Rn)}let n=[];for(let r=0;r<e;r++){let i=0;i=r===0?t[1]:r===e-1?(t[r]-t[r-1])/2:(t[r+1]-t[r-1])/2,n.push(i)}let r=[];for(let i=0;i<3;i++){let a=[],o=0;for(let r=0;r<e;r++){let e=n[r]*zn(t[r],i);a.push(e),o+=r===0?e:e*2}let s=Ln[i];for(let t=0;t<e;t++){let e=a[t]/o*s;t===0&&(e+=1-s),r[t*4+i]=e}}for(let n=0;n<e;n++)r[n*4+3]=t[n]/Rn;return r}})))()}var Hn;function Un(){return(Un=t((()=>{Hn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})))()}var er,tr,nr;function rr(){return(rr=t((()=>{ot(),k(),F(),Vn(),Xe(),Un(),Gn(),qn(),Yn(),Zn(),$n(),er=e=>{let t=[];for(let n=0;n<e;n++){let r=new D;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},tr=9,nr=class extends nt{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;shading;sssH;sssV;sssCopy;constructor(e){super();let t=e.backend,n=e.renderTarget,r=new P(t,{name:`normalSelector`,frag:Kn,renderTarget:null,uniforms:pn.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:A.LINEAR,minFilter:A.LINEAR})]),a=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:A.LINEAR,minFilter:A.LINEAR})]),o=new P(t,{name:`lightShaft`,frag:Wn,renderTarget:i,uniforms:pn.merge({uLightShaftBackBuffer:{value:a.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:A.LINEAR,minFilter:A.LINEAR})]),c=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:A.LINEAR,minFilter:A.LINEAR})]),l=new P(t,{name:`ssao`,frag:Jn,renderTarget:N(`ssao`,s),uniforms:pn.merge({uSSAOBackBuffer:{value:c.textures[0],type:`1i`},uSSAOKernel:{value:er(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),u=pn.merge({uSSAOTexture:{value:c.textures[0],type:`1i`},uPosTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:je.gaussWeights(8)}}),d=new P(t,{name:`ssaoBlur/h`,frag:N(`ssaoBlur`,Xn),uniforms:u,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),f=new P(t,{name:`ssaoBlur/v`,frag:N(`ssaoBlur`,Xn),uniforms:pn.merge(u,{uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),p=new P(t,{name:`deferredShading`,frag:N(`deferredShading`,Hn),uniforms:pn.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:f.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:l.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})}),m=()=>t.createFrameBuffer({disableDepthBuffer:!0}).setTexture([t.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA,magFilter:A.LINEAR,minFilter:A.LINEAR})]),h=pn.merge({uDiffuseTexture:{value:n.shadingBuffer.textures[1],type:`1i`},uAlbedoTexture:{value:n.gBuffer.textures[2],type:`1i`},uPosTexture:{value:n.gBuffer.textures[0],type:`1i`},uNormalTexture:{value:n.normalBuffer.textures[0],type:`1i`},uSSSRadius:{value:.05,type:`1f`},uKernel:{value:Bn(tr),type:`4fv`}}),g=new P(t,{name:`sss/h`,frag:N(`sss`,Qn),uniforms:h,renderTarget:m(),passThrough:!0,defines:{SSS_SAMPLES:tr}}),_=new P(t,{name:`sss/v`,frag:N(`sss`,Qn),uniforms:pn.merge(h,{uDiffuseTexture:{value:g.renderTarget.textures[0],type:`1i`},uShadingTexture:{value:n.shadingBuffer.textures[0],type:`1i`},uShadingDiffuseTexture:{value:n.shadingBuffer.textures[1],type:`1i`}}),renderTarget:m(),defines:{SSS_SAMPLES:tr,IS_VIRT:``}}),v=new P(t,{name:`sss/copy`,renderTarget:t.createFrameBuffer({disableDepthBuffer:!0}).setTexture([n.shadingBuffer.textures[0]])});this.postprocess=new Sn({passes:[r,o,l,d,f,p,g,_,v]}),this.shading=p,this.lightShaft=o,this.ssao=l,this.rtSSAO1=s,this.rtSSAO2=c,this.ssaoBlur=d,this.ssaoBlurV=f,this.sssH=g,this.sssV=_,this.sssCopy=v,this.rtLightShaft1=i,this.rtLightShaft2=a,this.normalSelector_=r;for(let e=0;e<n.gBuffer.textures.length;e++){let t=n.gBuffer.textures[e];e===1&&(t=n.normalBuffer.textures[0]),p.uniforms[`sampler`+e]=l.uniforms[`sampler`+e]={type:`1i`,value:t}}o.uniforms.uDepthTexture.value=n.gBuffer.depthTexture,p.renderTarget=n.shadingBuffer,r.renderTarget=n.normalBuffer,r.uniforms.uNormalTexture.value=n.gBuffer.textures[1],r.uniforms.uPosTexture.value=n.gBuffer.textures[0],r.uniforms.uSelectorTexture.value=n.gBuffer.textures[3],u.uPosTexture.value=n.gBuffer.textures[0],u.uNormalTexture.value=n.normalBuffer.textures[0]}update(){let e=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=e,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],e=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=e,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.sss!==void 0&&(this.sssH.enabled=e.sss,this.sssV.enabled=e.sss,this.sssCopy.enabled=e.sss),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}setSSSRadius(e){this.sssH.uniforms.uSSSRadius.value=e}resize(e){this.postprocess.resize(e)}dispose(){this.postprocess.dispose(),this.rtLightShaft1.dispose(),this.rtLightShaft2.dispose(),this.rtSSAO1.dispose(),this.rtSSAO2.dispose();for(let e of[this.sssH,this.sssV])e.renderTarget.textures[0].dispose(),e.renderTarget.dispose();this.sssCopy.renderTarget.dispose()}}})))()}var ir;function ar(){return(ar=t((()=>{ir=`uniform sampler2D uShadingTexture;
...
}`})))()}var or;function sr(){return(sr=t((()=>{or=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})))()}var vr;function yr(){return(yr=t((()=>{vr=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`})))()}var br;function xr(){return(xr=t((()=>{br=`// https://qiita.com/aa_debdeb/items/26ab808de6745611df53
...
}`})))()}var Or;function kr(){return(kr=t((()=>{Or=`// フレネルと粗さで重み付けして反射色を足す
...
`})))()}var Ar;function jr(){return(jr=t((()=>{Ar=`// 反射方向へレイマーチしてシーンを引く。今フレームの結果だけを出し、時間方向の蓄積は ssrTemporal.fs が行う
...
}`})))()}var Mr;function Nr(){return(Nr=t((()=>{Mr=`// ssr.fs の今フレームの結果を、前フレームの結果と混ぜて均す。
...
`})))()}var Pr,Fr,Ir,Lr,Rr;function zr(){return(zr=t((()=>{k(),F(),Xe(),ar(),sr(),lr(),dr(),pr(),hr(),_r(),yr(),xr(),Cr(),Tr(),Dr(),kr(),jr(),Nr(),Pr=4,Fr=8,Ir=14/1080,Lr=e=>e.createFrameBuffer().setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA,magFilter:A.LINEAR,minFilter:A.LINEAR})]),Rr=class{dofCoc;dofBokeh;dofBlur;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssrTemporal;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;_colorCollection;_bloomBright;_bloomPasses;constructor(e,t){let n=new P(e,{name:`collection`,frag:cr,uniforms:{uToneMap:{value:1,type:`1f`},uExposure:{value:1,type:`1f`}}}),r=new P(e,{name:`ssr`,frag:N(`ssr`,Ar),renderTarget:Lr(e),uniforms:pn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),i=Lr(e),a=Lr(e),o=new P(e,{name:`ssrTemporal`,frag:N(`ssrTemporal`,Mr),renderTarget:i,uniforms:pn.merge({uSSRCurrent:{value:r.renderTarget.textures[0],type:`1i`},uSSRBackBuffer:{value:a.textures[0],type:`1i`},uGbufferPos:{value:null,type:`1i`},uVelTex:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),s=new P(e,{name:`ssComposite`,frag:N(`ssComposite`,Or),uniforms:pn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uGbufferMaterial:{value:null,type:`1i`},uSSRTexture:{value:i.textures[0],type:`1i`}}),renderTarget:Lr(e)}),c=new D(10,.05,20,.05),l=new P(e,{name:`dof/coc`,frag:mr,uniforms:pn.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:c,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:A.LINEAR,minFilter:A.LINEAR,internalFormat:A.RGBA16F,type:A.HALF_FLOAT,format:A.RGBA})]),passThrough:!0,resolutionRatio:.5}),u=new P(e,{name:`dof/bokeh`,frag:fr,uniforms:pn.merge({uCocTex:{value:l.renderTarget.textures[0],type:`1i`},uParams:{value:c,type:`4f`}}),renderTarget:Lr(e),passThrough:!0,resolutionRatio:.5}),d=new P(e,{name:`dof/blur`,frag:ur,uniforms:pn.merge({uBokeTex:{value:u.renderTarget.textures[0],type:`1i`}}),renderTarget:Lr(e),passThrough:!0,resolutionRatio:.5}),f=new P(e,{name:`dof/composite`,frag:gr,uniforms:pn.merge({uBokeTex:{value:d.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:A.LINEAR,minFilter:A.LINEAR,internalFormat:A.RGBA16F,type:A.HALF_FLOAT,format:A.RGBA})])}),p=new P(e,{name:`motionBlurTile`,frag:Er,uniforms:pn.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA32F,format:A.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),m=new P(e,{name:`motionBlurNeighbor`,frag:wr,uniforms:pn.merge({uVelTex:{value:p.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA32F,format:A.RGBA})]),resolutionRatio:1/16,passThrough:!0}),h=new P(e,{name:`motionBlur`,frag:Sr,uniforms:pn.merge({uVelNeighborTex:{value:m.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16},renderTarget:Lr(e)}),g=new P(e,{name:`fxaa`,frag:vr}),_=new P(e,{name:`bloom/bright`,frag:ir,uniforms:{uShadingTexture:{value:t.shadingBuffer.textures[0],type:`1i`},uThreshold:{value:1,type:`1f`},uBrightness:{value:1,type:`1f`}},renderTarget:Lr(e),resolutionRatio:.5,passThrough:!0}),v=[_],y=[],b=_.renderTarget.textures[0],x=2;for(let t=0;t<Pr;t++){let n=Lr(e),r=Lr(e),i={name:`bloom/blur/`+t+`/v`,renderTarget:n,frag:br,uniforms:{uBackBlurTex:{value:b,type:`1i`},uIsVertical:{type:`1i`,value:!0},uWeights:{type:`1fv`,value:je.gaussWeights(Fr)},uBlurRange:{value:2,type:`1f`}},defines:{GAUSS_WEIGHTS:Fr.toString(),USE_BACKBLURTEX:``},passThrough:!0,resolutionRatio:1/x};v.push(new P(e,i)),v.push(new P(e,{...i,name:`bloom/blur/`+t+`/h`,renderTarget:r,uniforms:{...i.uniforms,uBackBlurTex:{value:n.textures[0],type:`1i`},uIsVertical:{type:`1i`,value:!1}}})),y.push(r.textures[0]),b=r.textures[0],x*=2}v.push(new P(e,{name:`bloom/composite`,frag:or,uniforms:{uBloomTexture:{value:y,type:`1iv`}},renderTarget:Lr(e)})),this.postprocess=new Sn({passes:[r,o,s,l,u,d,f,p,m,h,...v,n,g]}),this._ssr=r,this._ssrTemporal=o,this._ssComposite=s,this.dofCoc=l,this.dofBokeh=u,this.dofBlur=d,this.dofComposite=f,this._motionBlur=h,this._motionBlurTile=p,this._motionBlurNeighbor=m,this._colorCollection=n,this._bloomBright=_,this._bloomPasses=v,this._dofParams=c,this.rtSSR1=i,this.rtSSR2=a,r.uniforms.uGbufferPos.value=t.gBuffer.textures[0],r.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],r.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],o.uniforms.uGbufferPos.value=t.gBuffer.textures[0],o.uniforms.uVelTex.value=t.gBuffer.textures[4],s.uniforms.uGbufferPos.value=t.gBuffer.textures[0],s.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],s.uniforms.uGbufferMaterial.value=t.gBuffer.textures[3],l.uniforms.uGbufferPos.value=t.gBuffer.textures[0],p.uniforms.uVelTex.value=t.gBuffer.textures[4],h.uniforms.uVelTex.value=t.gBuffer.textures[4],h.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}update(e){let t=e.dofParams.kFilmHeight,n=.5*t/Math.tan(.5*(e.fov/180*Math.PI)),r=Math.max(e.dofParams.focusDistance,n),i=Ir,a=1/i,o=n*n/(e.dofParams.fNumber*(r-n)*t*2);this._dofParams.set(r,i,a,o);let s=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=s,this._ssrTemporal.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssrTemporal.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){if(e.toneMap!==void 0&&(this._colorCollection.uniforms.uToneMap.value=+!!e.toneMap),e.bloom!==void 0)for(let t of this._bloomPasses)t.enabled=e.bloom;e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssrTemporal.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofBlur.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofBlur.renderTarget&&this.dofBlur.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}setExposure(e){this._colorCollection.uniforms.uExposure.value=2**e}setBloomParams(e,t){this._bloomBright.uniforms.uThreshold.value=e,this._bloomBright.uniforms.uBrightness.value=t}dispose(){this.postprocess.dispose(),this.rtSSR1.dispose(),this.rtSSR2.dispose()}}})))()}var Br,Vr;function Hr(){return(Hr=t((()=>{k(),Xe(),rr(),zr(),Br=e=>{let t=e.createFrameBuffer();t.setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA32F,format:A.RGBA,magFilter:A.NEAREST,minFilter:A.NEAREST}),e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA32F,format:A.RGBA}),e.createTexture().setting({internalFormat:A.SRGB8_ALPHA8}),e.createTexture(),e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA32F,format:A.RGBA})]);let n=e.createFrameBuffer({disableDepthBuffer:!0});n.setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA}),e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA})]);let r=e.createFrameBuffer({disableDepthBuffer:!0});r.setDepthTexture(t.depthTexture),r.setTexture([n.textures[0],t.textures[0],t.textures[4]]);let i=e.createFrameBuffer({disableDepthBuffer:!0});i.setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA16F,format:A.RGBA,magFilter:A.LINEAR,minFilter:A.LINEAR})]);let a=e.createFrameBuffer({disableDepthBuffer:!0});a.setDepthTexture(t.depthTexture),a.setTexture([e.createTexture()]);let o=e.createFrameBuffer();return o.setTexture([e.createTexture().setting({type:A.FLOAT,internalFormat:A.RGBA32F,format:A.RGBA,magFilter:A.NEAREST,minFilter:A.NEAREST})]),{gBuffer:t,shadingBuffer:n,forwardBuffer:r,refractionBuffer:i,uiBuffer:a,normalBuffer:o}},Vr=class{camera;size;resolution;offscreen;renderTarget;deferredRenderer;pipelinePostProcess;_pipelineOverride;_sceneConfig;_onDispose;constructor(e){this.camera=null,this.size=null,this.resolution=new D,this.offscreen=e.offscreen,this._pipelineOverride=null,this._sceneConfig=e.sceneConfig,this._onDispose=e.onDispose,this.renderTarget=Br(e.backend),this.deferredRenderer=new nr({backend:e.backend,envMap:e.envMap,envMapCube:e.envMapCube,renderTarget:this.renderTarget}),this.pipelinePostProcess=new Rr(e.backend,this.renderTarget),this.fit(e.resolution),this.applyPipelineConfig()}get pipelineOverride(){return this._pipelineOverride}set pipelineOverride(e){this._pipelineOverride=e,this.applyPipelineConfig()}applyPipelineConfig(){let e={...this._sceneConfig,...this._pipelineOverride};this.deferredRenderer.setPassEnabled({ssao:e.ssao,lightShaft:e.lightShaft,sss:e.sss}),this.deferredRenderer.setSSSRadius(e.sssRadius??.05),this.pipelinePostProcess.setPassEnabled({toneMap:e.toneMap,motionBlur:e.motionBlur,ssr:e.ssr,dof:e.dof,bloom:e.bloom}),this.pipelinePostProcess.setMotionBlurPower(e.motionBlurPower??1),this.pipelinePostProcess.setExposure(e.exposure??0),this.pipelinePostProcess.setBloomParams(e.bloomThreshold??1,e.bloomBrightness??1)}fit(e){e.x<=0||e.y<=0||(this.resolution.x!==e.x||this.resolution.y!==e.y)&&this.resize(e)}resize(e){this.resolution.copy(e);let t=this.renderTarget;t.gBuffer.setSize(e),t.shadingBuffer.setSize(e),t.forwardBuffer.setSize(e),t.refractionBuffer.setSize(e),t.uiBuffer.setSize(e),t.normalBuffer.setSize(e),this.deferredRenderer.resize(e),this.pipelinePostProcess.resize(e)}dispose(){this._onDispose(this);let e=this.renderTarget;e.forwardBuffer.dispose();let t=[e.gBuffer,e.shadingBuffer,e.refractionBuffer,e.uiBuffer,e.normalBuffer];for(let e=0;e<t.length;e++){let n=t[e];for(let e=0;e<n.textures.length;e++)n.textures[e].dispose();n.dispose()}e.gBuffer.depthTexture&&e.gBuffer.depthTexture.dispose(),this.deferredRenderer.dispose(),this.pipelinePostProcess.dispose()}}})))()}var Ur;function Wr(){return(Wr=t((()=>{Ur=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},activateOnSelect:{required:!1,tsType:{name:`Array`,elements:[{name:`string`}],raw:`PanelId[]`},description:``}}}})))()}var Ix,Lx,Rx;function zx(){return(zx=t((()=>{Ix=`RendererSettings__renderer___LnJlb`,Lx=`RendererSettings__renderer_inner___LnJlb`,Rx={renderer:Ix,renderer_inner:Lx}})))()}var Bx,Vx;function Hx(){return(Hx=t((()=>{w(),R(),ov(),zx(),Bx=o(),Vx=()=>{let{editor:e}=L(),t=e.engine.renderer;return(0,Bx.jsx)(`div`,{className:Rx.renderer,children:(0,Bx.jsxs)(`div`,{className:Rx.renderer_inner,children:[(0,Bx.jsx)(s,{label:`Resolution`,accordion:!0,children:(0,Bx.jsx)(av,{target:e,filter:`resolution`})}),(0,Bx.jsx)(s,{label:`Pipeline`,accordion:!0,children:(0,Bx.jsx)(av,{target:t,filter:`pipeline`})}),(0,Bx.jsx)(s,{label:`Sky`,accordion:!0,children:(0,Bx.jsx)(av,{target:t,filter:`sky`})})]})})},Vx.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var Ux,Wx,Gx,Kx,qx,Jx;function Yx(){return(Yx=t((()=>{Ux=`SceneControl__sceneControl___LnNjZ`,Wx=`SceneControl__sceneControl_inner___LnNjZ`,Gx=`SceneControl__select___LnNjZ`,Kx=`SceneControl__select_name___LnNjZ`,qx=`SceneControl__save___LnNjZ`,Jx={sceneControl:Ux,sceneControl_inner:Wx,select:Gx,select_name:Kx,save:qx}})))()}var Xx,Zx,Qx;function $x(){return($x=t((()=>{Xx=i(),w(),R(),pe(),Yx(),Zx=o(),Qx=()=>{let{editor:e,projectName:t,scenes:n}=L(),[r,i]=(0,Xx.useState)(null),o=null;return n&&(o=(0,Zx.jsx)(E,{title:`scene`,children:(0,Zx.jsxs)(`button`,{className:Jx.select,onClick:e=>{i(ie(e.clientX,e.clientY))},children:[(0,Zx.jsx)(`span`,{className:Jx.select_name,children:n.current??`-`}),(0,Zx.jsx)(a,{open:!0})]})})),(0,Zx.jsxs)(`div`,{className:Jx.sceneControl,children:[(0,Zx.jsx)(`div`,{className:Jx.sceneControl_inner,children:(0,Zx.jsxs)(s,{label:t,accordion:!0,children:[o,(0,Zx.jsx)(`div`,{className:Jx.save,children:(0,Zx.jsx)(c,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,Zx.jsx)(me,{scenes:n,projectName:t,anchor:r,onClose:()=>{i(null)}})]})},Qx.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var eS,tS,nS,rS,iS,aS,oS;function sS(){return(sS=t((()=>{eS=`Textures__textures___LnRle`,tS=`Textures__item___LnRle`,nS=`Textures__preview___LnRle`,rS=`Textures__img___LnRle`,iS=`Textures__placeholder___LnRle`,aS=`Textures__name___LnRle`,oS={textures:eS,item:tS,preview:nS,img:rS,placeholder:iS,name:aS}})))()}var cS,lS,uS;function dS(){return(dS=t((()=>{cS=i(),Ni(),R(),sS(),lS=o(),uS=()=>{let{engine:e,editor:t}=L(),[,n]=(0,cS.useState)(0);(0,cS.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return I.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{I.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=I.resources.textureList;return(0,lS.jsx)(`div`,{className:oS.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,lS.jsxs)(`div`,{className:oS.item,children:[(0,lS.jsx)(`div`,{className:oS.preview,children:n?(0,lS.jsx)(`img`,{src:n,className:oS.img}):(0,lS.jsx)(`div`,{className:oS.placeholder})}),(0,lS.jsx)(`div`,{className:oS.name,children:e.name})]},e.name)})})},uS.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var fS,pS;function mS(){return(mS=t((()=>{fS=i(),pS=(0,fS.createContext)(null)})))()}var hS,gS;function _S(){return(_S=t((()=>{hS=i(),mS(),gS=()=>{let e=(0,hS.useContext)(pS);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var vS;function yS(){return(yS=t((()=>{vS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
...
}`})))()}var bS;function xS(){return(xS=t((()=>{ot(),Je(),k(),F(),yS(),bS=class extends nt{wrapperElm;glCanvas;backend;gl;canvasTexture;canvas;canvasCtx;glRenderer;postProcess;viewPort;viewPortRange;viewPortScale;frameSetting;loopSetting;musicBuffer;musicTexture;resizeObserver;canvasSize;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.glCanvas=document.createElement(`canvas`),this.backend=new Ye(this.glCanvas.getContext(`webgl2`)),this.gl=this.backend.gl,this.canvasSize=new D(this.glCanvas.width,this.glCanvas.height),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0],this.viewPortScale=50,this.frameSetting=null,this.loopSetting={enabled:!1,start:0,end:0},this.resizeObserver=new ResizeObserver(this.onResize.bind(this));let e={renderer:null,curves:{},createEntity:t=>new Zt({...t,engine:e})};this.glRenderer=new ri(this.backend,e),e.renderer=this.glRenderer,this.canvasTexture=new Be(this.gl),this.musicBuffer=null,this.musicTexture=new Be(this.gl),this.musicTexture.setting({type:this.gl.UNSIGNED_BYTE,internalFormat:this.gl.LUMINANCE,format:this.gl.LUMINANCE,magFilter:this.gl.LINEAR,minFilter:this.gl.LINEAR,wrapS:this.gl.MIRRORED_REPEAT}),this.postProcess=new Sn({passes:[new P(this.backend,{frag:vS,uniforms:{uCanvasTex:{type:`1i`,value:null},uMusicTex:{type:`1i`,value:this.musicTexture}},renderTarget:null})]})}onResize(){if(this.wrapperElm){let e=new D(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);if(e.x===0||e.y===0)return;this.glCanvas.width=this.canvas.width=e.x,this.glCanvas.height=this.canvas.height=e.y,this.canvasSize.set(this.glCanvas.width,this.glCanvas.height),this.postProcess.resize(e),this.render()}}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.frameSetting){this.canvasCtx.fillStyle=`#181818`;let e=this.frameToPx(0),t=this.frameToPx(this.frameSetting.duration);this.canvasCtx.fillRect(e,0,t-e,this.canvas.height)}let e=(e,t,n)=>{let r=Math.ceil(this.viewPort[0]/e)*e;this.canvasCtx.beginPath();let i=0;for(;r<this.viewPort[2]&&i<100;){let n=this.frameToPx(r+t);this.canvasCtx.moveTo(n,0),this.canvasCtx.lineTo(n,this.canvas.height),r+=e,i++}this.canvasCtx.strokeStyle=n,this.canvasCtx.lineWidth=1,this.canvasCtx.stroke()};if(e(this.viewPortScale,0,`#555`),e(this.viewPortScale,this.viewPortScale/2,`#333`),this.musicBuffer&&this.frameSetting){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)],s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}if(this.loopSetting.enabled){this.canvasCtx.fillStyle=`#0009`;let e=this.frameToPx(this.loopSetting.start),t=this.frameToPx(this.loopSetting.end);this.canvasCtx.fillRect(0,0,e,this.canvas.height),this.canvasCtx.fillRect(t,0,this.canvas.width-t,this.canvas.height)}this.canvasTexture.attach(this.canvas),this.postProcess.passes&&(this.postProcess.passes[0].uniforms.uCanvasTex.value=this.canvasTexture),this.glRenderer.renderPostProcess(this.postProcess,void 0,this.canvasSize)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.glCanvas),this.onResize()}setViewPort(e,t){this.viewPort=e,this.viewPortRange=[e[2]-e[0],e[3]-e[1]],this.viewPortScale=t,this.render()}setFrameSetting(e){this.frameSetting={duration:Math.round(e.duration),fps:Math.round(e.fps)},this.render()}setMusicBuffer(e){this.musicBuffer=e,setTimeout(()=>{this.render()},100)}setLoopSetting(e,t,n){this.loopSetting={enabled:e,start:t,end:n},this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.glCanvas),this.resizeObserver.disconnect()}},bS.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setViewPort`,docblock:null,modifiers:[],params:[{name:`viewPort`,optional:!1,type:{name:`Array`,elements:[{name:`number`}],raw:`number[]`}},{name:`scale`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`setLoopSetting`,docblock:null,modifiers:[],params:[{name:`enabled`,optional:!1,type:{name:`boolean`}},{name:`start`,optional:!1,type:{name:`number`}},{name:`end`,optional:!1,type:{name:`number`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`TimelineCanvasRenderer`}})))()}var SS,CS;function wS(){return(wS=t((()=>{SS=`TimelineCanvas__timelineCanvas___LnRpb`,CS={timelineCanvas:SS}})))()}var TS,ES,DS;function OS(){return(OS=t((()=>{TS=i(),sv(),_S(),xS(),wS(),ES=o(),DS=()=>{let{viewPort:e,viewPortScale:t,musicBuffer:n,musicBufferVersion:r,glEditor:i}=gS(),[a,o]=(0,TS.useState)(),s=(0,TS.useRef)(null);(0,TS.useEffect)(()=>{let e=new bS;return o(e),s.current&&e.setWrapperElm(s.current),()=>{e.dispose()}},[]),(0,TS.useEffect)(()=>{a&&e&&t&&a.setViewPort(e,t)},[a,e,t]);let[c]=Y(i?.engine,`timeline/duration`),[l]=Y(i?.engine,`timeline/fps`);(0,TS.useEffect)(()=>{a&&c&&l&&a.setFrameSetting({duration:c||0,fps:l||0})},[a,c,l]);let[u]=Y(i,`frameLoop/enabled`),[d]=Y(i,`frameLoop/start`),[f]=Y(i,`frameLoop/end`);return(0,TS.useEffect)(()=>{a&&a.setLoopSetting(u||!1,d||0,f||0)},[a,u,d,f]),(0,TS.useEffect)(()=>{a&&n&&a.setMusicBuffer(n)},[a,n,r]),(0,ES.jsx)(`div`,{className:CS.timelineCanvas,ref:s})},DS.__docgenInfo={description:``,methods:[],displayName:`TimelineCanvas`}})))()}var kS,AS;function jS(){return(jS=t((()=>{kS=`TimelineControls__controls___LmNvb`,AS={controls:kS}})))()}var MS,NS,PS;function FS(){return(FS=t((()=>{MS=e(i(),1),_S(),jS(),NS=o(),PS=e=>{let{viewPort:t,setCurrentFrame:n,getFrameViewPort:r,zoom:i,scroll:a,setViewPortCenter:o}=gS(),s=(0,MS.useRef)([0,0,0,0]),c=(0,MS.useRef)([0,0]);t&&(s.current=t,c.current=[t[2]-t[0],t[3]-t[1]]);let l=(0,MS.useRef)(null),u=(0,MS.useRef)(null),d=(0,MS.useRef)(null),f=(0,MS.useRef)(null),p=(0,MS.useRef)(null),m=(0,MS.useCallback)(e=>{let t=l.current&&l.current.clientWidth||1;if(d.current==0){if(n&&r&&u.current){let i=(e.clientX-u.current.left)/t;n(r(i))}}else if(d.current==1){let n=[e.clientX,e.clientY];if(f.current&&p.current){let e=-(n[0]-f.current[0])/t*c.current[0];o&&o(p.current+e)}}},[n,r,o]),h=(0,MS.useCallback)(e=>{d.current=e.button,p.current=(s.current[2]+s.current[0])/2,f.current=[e.clientX,e.clientY],u.current=e.currentTarget.getBoundingClientRect();let t=(e.clientX-u.current.left)/e.currentTarget.clientWidth;d.current==0&&n&&r&&n(r(t)),window.addEventListener(`pointermove`,m);let i=()=>{f.current=null,d.current=null,p.current=null,window.removeEventListener(`pointermove`,m)};return window.addEventListener(`pointerup`,i),()=>{window.removeEventListener(`pointerup`,i),window.removeEventListener(`pointermove`,m)}},[r,n,m]),g=(0,MS.useCallback)(e=>{if(d.current!==null||!i||!a)return;e.preventDefault();let t=l.current&&l.current.clientWidth||1,n=Math.abs(e.deltaY);Math.abs(e.deltaX)<n?i(n>50?e.deltaY<0?.9:1.1:1+e.deltaY*.005):a(e.deltaX/t*.5)},[i,a]);return(0,MS.useEffect)(()=>{let e=l.current;return e&&e.addEventListener(`wheel`,g,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,g)}},[g]),t?(0,NS.jsx)(`div`,{className:AS.controls,onPointerDown:h,ref:l,children:e.children}):null},PS.__docgenInfo={description:``,methods:[],displayName:`TimelineControls`,props:{children:{required:!1,tsType:{name:`ReactReactNode`,raw:`React.ReactNode`},description:``}}}})))()}var IS,LS,RS;function zS(){return(zS=t((()=>{IS=`TimelineCursor__cursor___LmN1c`,LS=`TimelineCursor__frame___LmN1c`,RS={cursor:IS,frame:LS}})))()}var BS,VS;function HS(){return(HS=t((()=>{_S(),zS(),BS=o(),VS=()=>{let{viewPort:e,framePlay:t}=gS();if(!e||!t)return null;let n=e[2]-e[0],r=(t.current-e[0])/n;return(0,BS.jsx)(`div`,{className:RS.cursor,style:{left:r*100+`%`},children:(0,BS.jsx)(`div`,{className:RS.frame})})},VS.__docgenInfo={description:``,methods:[],displayName:`TimelineCursor`}})))()}var US,WS,GS,KS;function qS(){return(qS=t((()=>{US=`TimelineLoop__timelineLoop___LnRpb`,WS=`TimelineLoop__start___LnRpb`,GS=`TimelineLoop__end___LnRpb`,KS={timelineLoop:US,start:WS,end:GS}})))()}var JS,YS;function XS(){return(XS=t((()=>{JS=`TimelineLoopCursor__cursor___LmN1c`,YS={cursor:JS}})))()}var ZS,QS,$S;function eC(){return(eC=t((()=>{ZS=i(),XS(),QS=o(),$S=({onMove:e})=>{let t=(0,ZS.useRef)(!1);return(0,QS.jsx)(`div`,{className:YS.cursor,onPointerDown:e=>{e.buttons==1&&(t.current=!0,e.stopPropagation())},onPointerMove:n=>{let r=n.target;t.current!==!1&&n.buttons==1&&(r.setPointerCapture(n.pointerId),n.buttons==1&&e&&e(n.clientX),n.nativeEvent.preventDefault(),n.nativeEvent.stopPropagation())},onPointerUp:()=>{t.current=!1}})},$S.__docgenInfo={description:``,methods:[],displayName:`TimelineLoopCursor`}})))()}var tC,nC,rC;function iC(){return(iC=t((()=>{tC=i(),sv(),Fa(),_S(),qS(),eC(),nC=o(),rC=()=>{let{viewPort:e,framePlay:t,glEditor:n}=gS(),r=(0,tC.useRef)(null);Pa(n,[`frameLoop/enabled`,`frameLoop/start`,`frameLoop/end`]);let[i]=Y(n,`frameLoop/enabled`),[a,o]=Y(n,`frameLoop/start`),[s,c]=Y(n,`frameLoop/end`);if(i!==!0||!e||!t||a===void 0||s===void 0)return null;let l=e[2]-e[0],u=(a-e[0])/l,d=(s-e[0])/l,f=(t,n)=>{let r=t.getBoundingClientRect();return(n-r.x)/r.width*(e[2]-e[0])+e[0]};return(0,nC.jsx)(`div`,{className:KS.timelineLoop,ref:r,children:(0,nC.jsxs)(`div`,{className:KS.timelineLoop_inner,children:[(0,nC.jsx)(`div`,{className:KS.start,style:{left:u*100+`%`},children:(0,nC.jsx)($S,{onMove:e=>{r.current&&o&&o(f(r.current,e))}})}),(0,nC.jsx)(`div`,{className:KS.end,style:{left:d*100+`%`},children:(0,nC.jsx)($S,{onMove:e=>{r.current&&c&&c(f(r.current,e))}})})]})})},rC.__docgenInfo={description:``,methods:[],displayName:`TimelineLoop`}})))()}var aC,oC,sC,cC,lC,uC;function dC(){return(dC=t((()=>{aC=`TimelineScale__scale___LnNjY`,oC=`TimelineScale__scale_inner___LnNjY`,sC=`TimelineScale__scale_item___LnNjY`,cC=`TimelineScale__scale_item_frame___LnNjY`,lC=`TimelineScale__scale_item_time___LnNjY`,uC={scale:aC,scale_inner:oC,scale_item:sC,scale_item_frame:cC,scale_item_time:lC}})))()}var fC,pC,mC;function hC(){return(hC=t((()=>{sv(),_S(),dC(),fC=o(),pC=e=>`${(`00`+Math.floor(e%3600/60)).slice(-2)}:${(`00`+Math.floor(e%60)).slice(-2)}`,mC=()=>{let{glEditor:e,viewPort:t,viewPortScale:n}=gS(),[r,i]=Y(e?.engine,`timeline/fps`);if(!t||!n||r===void 0)return null;let a=[],o=Math.ceil(t[0]/n)*n,s=0;for(;o<t[2]&&s<100;){let e=(o-t[0])/(t[2]-t[0]),i=o/(r||0);a.push((0,fC.jsxs)(`div`,{className:uC.scale_item,style:{left:e*100+`%`},children:[(0,fC.jsx)(`div`,{className:uC.scale_item_frame,children:o}),(0,fC.jsx)(`div`,{className:uC.scale_item_time,children:pC(i)})]},o)),o+=n,s++}return(0,fC.jsx)(`div`,{className:uC.scale,children:(0,fC.jsx)(`div`,{className:uC.scale_inner,children:a})})},mC.__docgenInfo={description:``,methods:[],displayName:`TimelineScale`}})))()}var gC,_C,vC;function yC(){return(yC=t((()=>{gC=`TimelineSetting__timelineSetting___LnRpb`,_C=`TimelineSetting__play___LnRpb`,vC={timelineSetting:gC,play:_C}})))()}var bC,xC,SC;function CC(){return(CC=t((()=>{bC=i(),w(),ra(),sv(),_S(),yC(),xC=o(),SC=()=>{let{framePlay:e,glEditor:t}=gS(),n=(0,bC.useCallback)((e,t)=>{t&&t(e)},[]),[r,i]=Y(t,`frameLoop/enabled`),[a]=Y(t?.engine,`timeline/duration`),[o]=Y(t?.engine,`timeline/fps`),s=(0,bC.useCallback)((e,n)=>{t&&t.api.setField(t.engine,e,n)},[t]),l=(0,bC.useCallback)(()=>{t&&t.togglePlay()},[t]);return(0,xC.jsx)(`div`,{className:vC.timelineSetting,children:(0,xC.jsxs)(le,{children:[(0,xC.jsx)(`div`,{className:vC.play,children:(0,xC.jsx)(c,{onClick:l,children:e.playing?(0,xC.jsx)(f,{size:14}):(0,xC.jsx)(h,{size:14})})}),(0,xC.jsx)(E,{title:`current`,children:(0,xC.jsx)(na,{value:Math.floor(e?.current||0),readOnly:!0})}),(0,xC.jsx)(E,{title:`duration`,children:(0,xC.jsx)(na,{value:a,onChange:e=>s(`timeline/duration`,e)})}),(0,xC.jsx)(E,{title:`fps`,children:(0,xC.jsx)(na,{value:o,onChange:e=>s(`timeline/fps`,e)})}),(0,xC.jsx)(E,{title:`loop`,children:(0,xC.jsx)(na,{value:r||!1,onChange:e=>n(e,i)})})]})})},SC.__docgenInfo={description:``,methods:[],displayName:`TimelineSetting`}})))()}var wC,TC;function EC(){return(EC=t((()=>{wC=i(),TC=e=>{let[t,n]=(0,wC.useState)({width:0,height:0});return(0,wC.useEffect)(()=>{let t=e.current;if(!t)return;let r=()=>{n({width:t.clientWidth,height:t.clientHeight})};r();let i=new ResizeObserver(r);return i.observe(t),()=>{i.disconnect()}},[e]),t}})))()}var DC,OC;function kC(){return(kC=t((()=>{DC=i(),OC=(0,DC.createContext)(null)})))()}var AC,jC;function MC(){return(MC=t((()=>{AC=i(),kC(),jC=()=>{let e=(0,AC.useContext)(OC);if(e===null)throw Error(`useKeyEditor must be used within a KeyEditorProvider`);return e}})))()}var NC,PC,FC,IC,LC,RC;function zC(){return(zC=t((()=>{NC=(e,t)=>e+`:`+t,PC=e=>{let t=e.lastIndexOf(`:`);return{curveId:e.slice(0,t),index:Number(e.slice(t+1))}},FC=(e,t)=>{let n=new Map;for(let r of e){let{curveId:e,index:i}=PC(r),a=t[e];if(!a||i>=a.k.length)continue;let o=n.get(e);o||(o=[],n.set(e,o)),o.push(i)}return n},IC=(e,t)=>{for(let n of t)if(!e.has(n))return!1;return t.length>0},LC=e=>{if(!(e instanceof Element))return null;let t=e.closest(`[data-refs]`);if(!t)return null;let n=t.getAttribute(`data-refs`);return n?n.split(` `):null},RC=(e,t)=>{let n=[];for(let r of e.querySelectorAll(`[data-refs]`)){let e=r.getBoundingClientRect();if(!(e.right<t.left||e.left>t.right||e.bottom<t.top||e.top>t.bottom))for(let e of(r.getAttribute(`data-refs`)||``).split(` `))n.push(e)}return n}})))()}var BC,VC,HC,UC,WC,GC,KC,qC,JC,YC,XC,ZC;function QC(){return(QC=t((()=>{Ni(),w_(),zC(),BC=`#entity`,VC=[`x`,`y`,`z`,`w`],HC=[`r`,`g`,`b`,`a`],UC=1e-4,WC=(e,t)=>{let n=t.indexOf(`:`);if(n<0)return{target:e,component:null,path:t};let r=t.slice(0,n),i=t.slice(n+1),a=I.resources.getComponent(r),o=null;return a&&(o=e.getComponent(a.component)||null),{target:o,component:r,path:i}},GC=(e,t,n)=>{let r=VC;if(e){let n=e.getFieldOpt(t);n&&n.format&&n.format.type==`color`&&(r=HC)}return n<r.length?r[n]:String(n)},KC=(e,t,n)=>{let r=n.get(e)||0;if(r<2)return null;let i=e,a=t[e];return a&&a.name&&(i=a.name),{name:i,count:r}},qC=(e,t)=>{e.curveIds.indexOf(t)<0&&e.curveIds.push(t)},JC=(e,t,n)=>{let r=Cl(e),i=Object.keys(r),a={id:BC,parentId:null,depth:0,component:null,label:e.name,curveIds:[],leaf:!1,hasChildren:i.length>0,kind:null,element:null,shared:null},o=[a];for(let s of i){let i=r[s],c=WC(e,s),l=null;c.target&&(l=Rl({target:c.target,path:c.path}));let u={id:s,parentId:BC,depth:1,component:c.component,label:c.path,curveIds:[],leaf:!0,hasChildren:!1,kind:l,element:null,shared:null};if(o.push(u),typeof i[0]==`string`){let e=i[0];qC(u,e),qC(a,e),u.shared=KC(e,t,n);continue}u.leaf=!1,u.hasChildren=!0;let d=i;for(let e=0;e<d.length;e++){let r=d[e];if(!r)continue;let i=r[0];o.push({id:s+`#`+e,parentId:s,depth:2,component:null,label:GC(c.target,c.path,e),curveIds:[i],leaf:!0,hasChildren:!1,kind:l,element:e,shared:KC(i,t,n)}),qC(u,i),qC(a,i)}}return o},YC=new WeakMap,XC=e=>{if(!e)return[];let t=YC.get(e);return t||(t=qc(e),YC.set(e,t)),t},ZC=(e,t)=>{let n=new Map;for(let r of t){let t=XC(e[r]);for(let e=0;e<t.length;e++){let i=t[e].coordinate.x,a=Math.round(i/UC),o=n.get(a);o||(o={frame:i,refs:[]},n.set(a,o)),o.refs.push(NC(r,e))}}let r=Array.from(n.values());return r.sort((e,t)=>e.frame-t.frame),r}})))()}var $C,ew,tw,nw,rw,iw,aw,ow,sw,cw,lw,uw;function dw(){return(dw=t((()=>{F(),QC(),$C=[`var(--or-axis-x)`,`var(--or-axis-y)`,`var(--or-axis-z)`,`var(--or-axis-w)`],ew=e=>e===null||e>=$C.length?`var(--or-text-muted)`:$C[e],tw=.1,nw=40,rw=2,iw=(e,t)=>{let n=1/0,r=-1/0;for(let i of t){let t=XC(e[i]);for(let e=0;e<t.length;e++){let i=t[e],a=[i.coordinate.y];i.interpolation==`BEZIER`&&a.push(i.handleRight.y),e>0&&t[e-1].interpolation==`BEZIER`&&a.push(i.handleLeft.y);for(let e of a)n=Math.min(n,e),r=Math.max(r,e)}}if(n>r)return{min:-1,max:1};if(r-n<1e-6)return{min:n-1,max:r+1};let i=(r-n)*tw;return{min:n-i,max:r+i}},aw=e=>10**Math.floor(Math.log10(e)),ow=(e,t)=>{let n=aw(t),r=Math.max(0,-Math.floor(Math.log10(n)));return Number((Math.round(e/n)*n).toFixed(r))},sw=(e,t)=>{let n=[],r=Math.max(1,Math.floor(t/nw)),i=(e.max-e.min)/r,a=10**Math.floor(Math.log10(i)),o=a*10;i<=a?o=a:i<=a*2?o=a*2:i<=a*5&&(o=a*5);let s=Math.max(0,-Math.floor(Math.log10(o)));for(let t=Math.ceil(e.min/o)*o;t<=e.max;t+=o)n.push(Number(t.toFixed(s)));return n},cw=new WeakMap,lw=e=>{let t=cw.get(e);return t||(t=new mt(bt(e.k)),cw.set(e,t)),t},uw=(e,t,n,r)=>{if(e.k.length==0)return``;let i=lw(e),a=[];for(let e=0;e<=r+rw;e+=rw)a.push(e+`,`+n(i.getValue(t(e))).toFixed(1));return`M`+a.join(`L`)}})))()}var fw,pw,mw;function hw(){return(hw=t((()=>{fw=3,pw=(e,t)=>{let n=!1,r=r=>{let i=r.clientX-e.clientX,a=r.clientY-e.clientY;!n&&Math.hypot(i,a)<fw||(n=!0,t.onMove(i,a,r))},i=e=>{window.removeEventListener(`pointermove`,r),window.removeEventListener(`pointerup`,i),t.onEnd(n,e)};window.addEventListener(`pointermove`,r),window.addEventListener(`pointerup`,i)},mw=(e,t)=>({left:Math.min(e.clientX,t.clientX),top:Math.min(e.clientY,t.clientY),right:Math.max(e.clientX,t.clientX),bottom:Math.max(e.clientY,t.clientY)})})))()}var gw,_w,vw,yw,bw,xw,Sw,Cw,ww,Tw,Ew;function Dw(){return(Dw=t((()=>{gw=`KeyCurveGraph__graph___LmdyY`,_w=`KeyCurveGraph__svg___LmdyY`,vw=`KeyCurveGraph__tick___LmdyY`,yw=`KeyCurveGraph__curve___LmdyY`,bw=`KeyCurveGraph__handleLine___LmdyY`,xw=`KeyCurveGraph__tickLabel___LmdyY`,Sw=`KeyCurveGraph__sharedLabel___LmdyY`,Cw=`KeyCurveGraph__point___LmdyY`,ww=`KeyCurveGraph__handle___LmdyY`,Tw=`KeyCurveGraph__box___LmdyY`,Ew={graph:gw,svg:_w,tick:vw,curve:yw,handleLine:bw,tickLabel:xw,sharedLabel:Sw,point:Cw,handle:ww,box:Tw}})))()}var Ow,kw,Aw,jw;function Mw(){return(Mw=t((()=>{Ow=i(),_S(),EC(),MC(),dw(),QC(),zC(),hw(),Dw(),kw=o(),Aw=e=>{if(!(e instanceof Element))return null;let t=e.closest(`[data-side]`);return t?{curveId:t.getAttribute(`data-curve`)||``,index:Number(t.getAttribute(`data-index`)),side:t.getAttribute(`data-side`)}:null},jw=()=>{let{viewPort:e,setCurrentFrame:t,getFrameViewPort:n}=gS(),{curves:r,graphCurves:i,selection:a,pressKeys:o,selectRefs:s,select:c,beginMove:l,beginHandleMove:u}=jC(),d=(0,Ow.useRef)(null),{width:f,height:p}=TC(d),[m,h]=(0,Ow.useState)(null),[g,_]=(0,Ow.useState)(null),v=[];for(let e of i)v.push(e.id);let y=iw(r,v);g&&(y=g);let b=(e[2]-e[0])/Math.max(1,f),x=(y.max-y.min)/Math.max(1,p),S=t=>(t-e[0])/b,C=e=>(y.max-e)/x,ee=y.max,te=(0,Ow.useMemo)(()=>{let t=[],n=t=>e[0]+t*b,a=e=>(ee-e)/x;for(let e of i)t.push({id:e.id,element:e.element,d:uw(r[e.id],n,a,f)});return t},[i,r,e,b,x,ee,f]),ne=e=>{if(e.button!=0)return;e.stopPropagation();let i=d.current;if(!i)return;let a=i.getBoundingClientRect(),f=e.shiftKey,p={clientX:e.clientX,clientY:e.clientY},m=Aw(e.target),g=LC(e.target),S=b,C=x;if(m){let e=XC(r[m.curveId])[m.index],t=e.handleRight;m.side==`left`&&(t=e.handleLeft);let n=null;_(y),pw(p,{onMove:(e,r)=>{n||=u(m.curveId,m.index,m.side),n.move({x:ow(t.x+e*S,S),y:ow(t.y-r*C,C)})},onEnd:()=>{n&&n.end(),_(null)}});return}if(g){let e=o(g,f),t=null;_(y),pw(p,{onMove:(e,n)=>{t||=l(new Set(v)),t.move({x:e*S,y:-n*C},e=>ow(e,C))},onEnd:()=>{_(null),t?t.end():!f&&e&&c(new Set(g))}});return}pw(p,{onMove:(e,t,n)=>{let r=mw(p,n);h({left:r.left-a.left,top:r.top-a.top,width:r.right-r.left,height:r.bottom-r.top})},onEnd:(e,r)=>{if(h(null),e){s(RC(i,mw(p,r)),f);return}f||c(new Set),t(n((p.clientX-a.left)/a.width))}})},w=[],re=[],T=[];for(let e of i){let t=XC(r[e.id]);for(let n=0;n<t.length;n++){let r=t[n],i=NC(e.id,n),o=S(r.coordinate.x),s=C(r.coordinate.y);o<0||o>f||(w.push({ref:i,x:o,y:s}),a.has(i)&&(n>0&&t[n-1].interpolation==`BEZIER`&&re.push({curveId:e.id,index:n,side:`left`,x:S(r.handleLeft.x),y:C(r.handleLeft.y),keyX:o,keyY:s}),r.interpolation==`BEZIER`&&n<t.length-1&&re.push({curveId:e.id,index:n,side:`right`,x:S(r.handleRight.x),y:C(r.handleRight.y),keyX:o,keyY:s})))}e.shared&&t.length>0&&T.push({id:e.id,x:Math.max(0,S(t[0].coordinate.x)),y:C(t[0].coordinate.y),text:`⇄ ${e.shared.name} (${e.shared.count})`})}let ie=sw(y,p);return(0,kw.jsxs)(`div`,{className:Ew.graph,ref:d,onPointerDown:ne,children:[f>0&&(0,kw.jsxs)(`svg`,{className:Ew.svg,width:f,height:p,children:[ie.map(e=>(0,kw.jsx)(`line`,{className:Ew.tick,x1:0,x2:f,y1:C(e),y2:C(e)},e)),te.map(e=>(0,kw.jsx)(`path`,{className:Ew.curve,style:{stroke:ew(e.element)},d:e.d},e.id)),re.map(e=>(0,kw.jsx)(`line`,{className:Ew.handleLine,x1:e.keyX,y1:e.keyY,x2:e.x,y2:e.y},e.curveId+e.index+e.side))]}),ie.map(e=>(0,kw.jsx)(`div`,{className:Ew.tickLabel,style:{top:C(e)},children:e},e)),T.map(e=>(0,kw.jsx)(`div`,{className:Ew.sharedLabel,style:{left:e.x,top:e.y},children:e.text},e.id)),w.map(e=>(0,kw.jsx)(`div`,{className:Ew.point,"data-refs":e.ref,"data-selected":a.has(e.ref),style:{left:e.x,top:e.y}},e.ref)),re.map(e=>(0,kw.jsx)(`div`,{className:Ew.handle,"data-curve":e.curveId,"data-index":e.index,"data-side":e.side,style:{left:e.x,top:e.y}},e.curveId+e.index+e.side)),m&&(0,kw.jsx)(`div`,{className:Ew.box,style:m})]})},jw.__docgenInfo={description:``,methods:[],displayName:`KeyCurveGraph`}})))()}var Nw,Pw,Fw,Iw,Lw;function Rw(){return(Rw=t((()=>{Nw=`KeyDopeSheet__dopeSheet___LmRvc`,Pw=`KeyDopeSheet__row___LmRvc`,Fw=`KeyDopeSheet__key___LmRvc`,Iw=`KeyDopeSheet__box___LmRvc`,Lw={dopeSheet:Nw,row:Pw,key:Fw,box:Iw}})))()}var zw,Bw,Vw;function Hw(){return(Hw=t((()=>{zw=i(),w(),_S(),MC(),QC(),zC(),hw(),Rw(),Bw=o(),Vw=()=>{let{viewPort:e,setCurrentFrame:t,getFrameViewPort:n}=gS(),{curves:r,visibleChannels:i,selection:a,scrollTop:o,pressKeys:s,selectRefs:c,select:l,beginMove:u}=jC(),d=(0,zw.useRef)(null),[f,m]=(0,zw.useState)(null),h=e[2]-e[0];return(0,Bw.jsxs)(`div`,{className:Lw.dopeSheet,ref:d,onPointerDown:e=>{if(e.button!=0)return;e.stopPropagation();let r=d.current;if(!r)return;let i=r.getBoundingClientRect(),a=LC(e.target),o=e.shiftKey,f={clientX:e.clientX,clientY:e.clientY};if(a){let e=s(a,o),t=null;pw(f,{onMove:e=>{t||=u(null),t.move({x:e/i.width*h,y:0})},onEnd:()=>{t?t.end():!o&&e&&l(new Set(a))}});return}pw(f,{onMove:(e,t,n)=>{let r=mw(f,n);m({left:r.left-i.left,top:r.top-i.top,width:r.right-r.left,height:r.bottom-r.top})},onEnd:(e,a)=>{if(m(null),e){c(RC(r,mw(f,a)),o);return}o||l(new Set),t(n((f.clientX-i.left)/i.width))}})},children:[(0,Bw.jsx)(`div`,{className:Lw.rows,style:{transform:`translateY(${-o}px)`},children:i.map(t=>{let n=t.kind==`event`;return(0,Bw.jsx)(`div`,{className:Lw.row,"data-depth":t.depth,children:ZC(r,t.curveIds).map(t=>{let r=(t.frame-e[0])/h;return r<-.05||r>1.05?null:(0,Bw.jsx)(`div`,{className:Lw.key,"data-refs":t.refs.join(` `),"data-selected":IC(a,t.refs),"data-event":n,style:{left:r*100+`%`},children:!n&&(0,Bw.jsx)(p,{size:10})},t.frame)})},t.id)})}),f&&(0,Bw.jsx)(`div`,{className:Lw.box,style:f})]})},Vw.__docgenInfo={description:``,methods:[],displayName:`KeyDopeSheet`}})))()}var Uw,Ww;function Gw(){return(Gw=t((()=>{Uw=`KeyEditor__keyEditor___Lmtle`,Ww={keyEditor:Uw}})))()}var Kw,qw,Jw,Yw,Xw;function Zw(){return(Zw=t((()=>{Kw=i(),w(),R(),Mw(),Hw(),MC(),Gw(),zC(),qw=o(),Jw=[{label:`Constant`,value:`CONSTANT`},{label:`Linear`,value:`LINEAR`},{label:`Bezier`,value:`BEZIER`}],Yw=[{label:`Auto Clamped`,value:`AUTO_CLAMPED`},{label:`Auto`,value:`AUTO`},{label:`Vector`,value:`VECTOR`},{label:`Aligned`,value:`ALIGNED`},{label:`Free`,value:`FREE`}],Xw=()=>{let{editor:e}=L(),{open:t,closeAll:n}=C(),{entity:r,channels:i,mode:a,selection:o,select:s,timelineActions:c,deleteSelectedKeys:l,copySelectedKeys:u,pasteCopiedKeys:d,setSelectedInterpolation:f,setSelectedHandleType:p}=jC();if((0,Kw.useEffect)(()=>()=>{e.leaveTimeline(c)},[e,c]),!r||i.length<=1)return null;let m=e=>{e.preventDefault();let r=LC(e.target);r&&!IC(o,r)&&s(new Set(r));let i=e=>()=>{e(),n()},a=[];for(let e of Jw)a.push({label:e.label,onClick:i(()=>f(e.value))});let c=[];for(let e of Yw)c.push({label:e.label,onClick:i(()=>p(e.value))});let m=[{label:`Interpolation`,children:a},{label:`Handle Type`,children:c},{label:`Copy`,onClick:i(u)},{label:`Paste`,onClick:i(d)},{label:`Delete`,onClick:i(l)}];t((0,qw.jsx)(ce,{title:`Keyframes`,items:m}),ie(e.clientX,e.clientY))},h=(0,qw.jsx)(Vw,{});return a==`curves`&&(h=(0,qw.jsx)(jw,{})),(0,qw.jsx)(`div`,{className:Ww.keyEditor,onPointerEnter:()=>e.enterTimeline(c),onPointerLeave:()=>e.leaveTimeline(c),onContextMenu:m,children:h})},Xw.__docgenInfo={description:``,methods:[],displayName:`KeyEditor`}})))()}var Qw,$w,eT,tT,nT,rT,iT,aT,oT,sT;function cT(){return(cT=t((()=>{Qw=`KeyChannelList__channelList___LmNoY`,$w=`KeyChannelList__header___LmNoY`,eT=`KeyChannelList__list___LmNoY`,tT=`KeyChannelList__empty___LmNoY`,nT=`KeyChannelList__row___LmNoY`,rT=`KeyChannelList__toggle___LmNoY`,iT=`KeyChannelList__component___LmNoY`,aT=`KeyChannelList__label___LmNoY`,oT=`KeyChannelList__shared___LmNoY`,sT={channelList:Qw,header:$w,list:eT,empty:tT,row:nT,toggle:rT,component:iT,label:aT,shared:oT}})))()}var lT,uT;function dT(){return(dT=t((()=>{w(),MC(),dw(),cT(),lT=o(),uT=()=>{let{entity:e,visibleChannels:t,mode:n,setMode:r,collapsed:i,toggleCollapsed:o,activeChannelId:s,setActiveChannelId:l,setScrollTop:u}=jC();return(0,lT.jsxs)(`div`,{className:sT.channelList,children:[(0,lT.jsxs)(`div`,{className:sT.header,children:[(0,lT.jsx)(c,{active:n==`keys`,onClick:()=>r(`keys`),children:`Keys`}),(0,lT.jsx)(c,{active:n==`curves`,onClick:()=>r(`curves`),children:`Curves`})]}),(0,lT.jsxs)(`div`,{className:sT.list,onScroll:e=>u(e.currentTarget.scrollTop),children:[!e&&(0,lT.jsx)(`div`,{className:sT.empty,children:`No entity selected`}),t.map(e=>{let t;return n==`curves`&&e.element!==null&&(t=ew(e.element)),(0,lT.jsxs)(`div`,{className:sT.row,"data-depth":e.depth,"data-active":n==`curves`&&e.id==s,onClick:()=>l(e.id),children:[(0,lT.jsx)(`span`,{className:sT.toggle,children:e.hasChildren&&(0,lT.jsx)(`button`,{onClick:t=>{t.stopPropagation(),o(e.id)},children:(0,lT.jsx)(a,{open:!i.has(e.id)})})}),e.component&&(0,lT.jsx)(`span`,{className:sT.component,children:e.component}),(0,lT.jsx)(`span`,{className:sT.label,style:{color:t},children:e.label}),e.shared&&(0,lT.jsxs)(`span`,{className:sT.shared,title:`Shared with ${e.shared.count} fields`,children:[`⇄ `,e.shared.name,` (`,e.shared.count,`)`]})]},e.id)})]})]})},uT.__docgenInfo={description:``,methods:[],displayName:`KeyChannelList`}})))()}var fT,pT,mT,hT,gT,_T,vT,yT;function bT(){return(bT=t((()=>{fT=i(),w_(),D_(),R(),QC(),zC(),pT={entity:null,curves:{},channels:[]},mT=e=>{let t=e.getField(`selectedEntityId`);return t&&e.engine.root.findEntityByUUID(t)||null},hT=e=>{let t=[mT(e),e.engine.curves];return e.engine.root.traverse(e=>{let n=Cl(e);Object.keys(n).length>0&&t.push(n)}),t},gT=(e,t)=>{if(e.length!=t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0},_T=e=>{let t=mT(e),n=e.engine.curves;return t?{entity:t,curves:n,channels:JC(t,n,zl(e.engine))}:{...pT,curves:n}},vT=e=>e.kind==`number`||e.kind==`array`,yT=()=>{let{editor:e,engine:t}=L(),[n,r]=(0,fT.useState)(()=>_T(e)),i=(0,fT.useRef)([]),a=(0,fT.useRef)(null),[o,s]=(0,fT.useState)(`keys`),[c,l]=(0,fT.useState)(()=>new Set),[u,d]=(0,fT.useState)(()=>new Set),[f,p]=(0,fT.useState)(BC),[m,h]=(0,fT.useState)(0),g=(0,fT.useRef)(c),_=(0,fT.useRef)(null),v=(0,fT.useCallback)(e=>{g.current=e,l(e)},[]);E_(()=>{let t=hT(e),n=i.current;if(gT(t,n))return;i.current=t;let o=t[0]!==n[0],s=t[1]!==n[1]&&t[1]!==a.current;n.length>0&&(o||s)&&v(new Set),r(_T(e))});let y=n.channels,b=(0,fT.useMemo)(()=>{let e=new Set,t=[];for(let n of y){if(n.parentId&&(e.has(n.parentId)||u.has(n.parentId))){e.add(n.id);continue}t.push(n)}return t},[y,u]),x=(0,fT.useMemo)(()=>{let e=y[0];for(let t of y)t.id==f&&(e=t);let t=[],n=new Set;if(!e)return t;for(let r of y){if(!r.leaf||!vT(r)||e.id!=`#entity`&&r.id!=e.id&&r.parentId!=e.id)continue;let i=r.curveIds[0];n.has(i)||(n.add(i),t.push({id:i,element:r.element,shared:r.shared}))}return t},[y,f]),S=(0,fT.useCallback)(e=>{d(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},[]),C=(0,fT.useCallback)((e,t)=>{let n=g.current,r=IC(n,e);if(t){let t=new Set(n);for(let n of e)r?t.delete(n):t.add(n);v(t)}else r||v(new Set(e));return r},[v]),ee=(0,fT.useCallback)((e,t)=>{let n=new Set;t&&(n=new Set(g.current));for(let t of e)n.add(t);v(n)},[v]),te=e=>Ll(e,t.frameSetting.fps),ne=t=>{a.current=t,e.api.setCurves(t)},w=new Set;for(let e of y)e.leaf&&vT(e)&&w.add(e.curveIds[0]);let re=()=>{let e=FC(g.current,t.curves);if(e.size==0)return;let n={...t.curves};for(let[r,i]of e)n[r]=Qc(t.curves[r],i);ne(n),v(new Set)},T=e=>{let n=FC(g.current,t.curves),r={...t.curves},i=!1;for(let[a,o]of n)w.has(a)&&(r[a]=e(t.curves[a],o),i=!0);i&&ne(r)},ie=e=>{T((t,n)=>tl(t,n,e))},ae=e=>{T((t,n)=>nl(t,n,e))},E=()=>{let e=FC(g.current,t.curves),n=[],r=new Set,i=1/0;for(let a of y){if(!a.leaf)continue;let o=a.curveIds[0],s=e.get(o);if(!s||r.has(o))continue;r.add(o);let c=XC(t.curves[o]),l=[];for(let e of s)l.push(c[e]),i=Math.min(i,c[e].coordinate.x);n.push({channelId:a.id,keys:l})}n.length!=0&&(_.current={entries:n,start:i})},oe=()=>{let e=_.current;if(!e)return;let n=yl(t)-e.start,r={...t.curves},i=new Set,a=!1;for(let t of e.entries){let e=null;for(let n of y)n.leaf&&n.id==t.channelId&&(e=n);if(!e)continue;let o=e.curveIds[0],s=el(r[o],t.keys,n,te);r[o]=s.curve,a=!0;for(let e of s.indices)i.add(NC(o,e))}a&&(ne(r),v(i))},se=n=>{let r=t.curves,i=FC(g.current,r),o=e.api.beginEdit(t,`curves`),s=!1;return{move:(e,t)=>{let c={...r},l=new Set;for(let[a,o]of i){let i=0;n&&n.has(a)&&(i=e.y);let s=$c(r[a],o,{x:e.x,y:i},te,t);c[a]=s.curve;for(let e of s.indices)l.add(NC(a,e))}a.current=c,o.set(c),v(l),s=!0},end:()=>{s&&o.commit()}}},ce=(n,r,i)=>{let o=t.curves,s=e.api.beginEdit(t,`curves`),c=!1;return{move:e=>{let t={...o,[n]:rl(o[n],r,i,e)};a.current=t,s.set(t),c=!0},end:()=>{c&&s.commit()}}},le=(0,fT.useRef)({deleteSelectedKeys:re,copySelectedKeys:E,pasteCopiedKeys:oe});le.current={deleteSelectedKeys:re,copySelectedKeys:E,pasteCopiedKeys:oe};let ue=(0,fT.useMemo)(()=>({deleteKeys:()=>le.current.deleteSelectedKeys(),copyKeys:()=>le.current.copySelectedKeys(),pasteKeys:()=>le.current.pasteCopiedKeys()}),[]);return{entity:n.entity,curves:n.curves,channels:y,visibleChannels:b,graphCurves:x,mode:o,setMode:s,selection:c,collapsed:u,toggleCollapsed:S,activeChannelId:f,setActiveChannelId:p,scrollTop:m,setScrollTop:h,pressKeys:C,selectRefs:ee,select:v,deleteSelectedKeys:re,copySelectedKeys:E,pasteCopiedKeys:oe,setSelectedInterpolation:ie,setSelectedHandleType:ae,beginMove:se,beginHandleMove:ce,timelineActions:ue}}})))()}var xT,ST;function CT(){return(CT=t((()=>{kC(),bT(),xT=o(),ST=e=>{let t=yT();return(0,xT.jsx)(OC.Provider,{value:t,children:e.children})},ST.__docgenInfo={description:``,methods:[],displayName:`KeyEditorProvider`}})))()}var wT,TT,ET,DT,OT,kT;function AT(){return(AT=t((()=>{wT=`Timeline__timeline___LnRpb`,TT=`Timeline__inner___LnRpb`,ET=`Timeline__content___LnRpb`,DT=`Timeline__channels___LnRpb`,OT=`Timeline__setting___LnRpb`,kT={timeline:wT,inner:TT,content:ET,channels:DT,setting:OT}})))()}var jT,MT;function NT(){return(NT=t((()=>{jT=i(),R(),MT=()=>{let{editor:e}=L(),[t,n]=(0,jT.useState)({current:0,playing:!1}),[r,i]=(0,jT.useState)([0,0,100,0]),a=(0,jT.useRef)([0,0,0,0]);a.current=r;let o=r[2]-r[0],s=10*2**(0+Math.floor(Math.log2(o/100)));s=Math.max(1,Math.floor(s));let c=e?.audioBuffer,[l,u]=(0,jT.useState)();(0,jT.useEffect)(()=>{if(e){let t=e.engine,r=e=>{n({...e})};r(t.frame);let a=0,o=()=>{u(a++)},s=()=>{i([0,0,t.frameSetting.duration,0])};return s(),t.on(`update/frame/play`,r),t.on(`update/music`,o),t.on(`loaded`,s),()=>{t.off(`update/frame/play`,r),t.off(`update/music`,o),t.off(`loaded`,s)}}},[e]);let d=(0,jT.useCallback)(t=>{e&&e.engine.seek(t)},[e]),f=(0,jT.useCallback)(e=>{let t=r[2]-r[0];return Math.floor(r[0]+t*e)},[r]),p=(0,jT.useCallback)(e=>{let t=a.current,n=(t[2]+t[0])/2,r=(t[0]-n)*e+n,o=(t[2]-n)*e+n;i([r,t[1],o,t[3]])},[]),m=(0,jT.useCallback)(e=>{let t=a.current,n=e*(t[2]-t[0]);i([t[0]+n,t[1],t[2]+n,t[3]])},[]),h=(0,jT.useCallback)(e=>{let t=a.current,n=t[2]-t[0];i([e-n/2,t[1],e+n/2,t[3]])},[]);return{glEditor:e,framePlay:t,viewPort:r,viewPortScale:s,musicBuffer:c,musicBufferVersion:l,setCurrentFrame:d,getFrameViewPort:f,zoom:p,scroll:m,setViewPortCenter:h}}})))()}var PT,FT;function IT(){return(IT=t((()=>{mS(),NT(),PT=o(),FT=e=>{let t=MT();return(0,PT.jsx)(pS.Provider,{value:t,children:e.children})},FT.__docgenInfo={description:``,methods:[],displayName:`TimelineProvider`}})))()}var LT,RT;function zT(){return(zT=t((()=>{OS(),FS(),HS(),iC(),hC(),CC(),Zw(),dT(),CT(),AT(),IT(),LT=o(),RT=()=>(0,LT.jsx)(FT,{children:(0,LT.jsx)(ST,{children:(0,LT.jsx)(`div`,{className:kT.timeline,children:(0,LT.jsxs)(`div`,{className:kT.inner,children:[(0,LT.jsx)(`div`,{className:kT.setting,children:(0,LT.jsx)(SC,{})}),(0,LT.jsx)(`div`,{className:kT.channels,children:(0,LT.jsx)(uT,{})}),(0,LT.jsxs)(`div`,{className:kT.content,children:[(0,LT.jsx)(DS,{}),(0,LT.jsx)(VS,{}),(0,LT.jsxs)(PS,{children:[(0,LT.jsx)(Xw,{}),(0,LT.jsx)(rC,{})]}),(0,LT.jsx)(mC,{})]})]})})})}),RT.__docgenInfo={description:``,methods:[],displayName:`Timeline`}})))()}var BT,VT;function HT(){return(HT=t((()=>{BT=`OREditor__editor___LmVka`,VT={editor:BT}})))()}var UT,WT;function GT(){return(GT=t((()=>{UT=e(i(),1),w_(),Xv(),WT=e=>{let{engine:t}=Yv(),[n,r]=(0,UT.useState)(()=>new S_(t)),i=UT.useRef(n);return i.current=n,(0,UT.useEffect)(()=>{if(!i.current.disposed&&i.current.engine.uuid==t.uuid)return;let e=new S_(t);r(e)},[t]),(0,UT.useEffect)(()=>()=>{n.dispose()},[n]),{engine:t,editor:n,projectName:e}}})))()}var KT,qT,JT;function YT(){return(YT=t((()=>{KT=i(),w_(),Ii(),GT(),qT=o(),JT=e=>{let t=WT(e.projectName),n=(0,KT.useRef)(Promise.resolve());(0,KT.useEffect)(()=>{if(!t.editor||!e.onSave)return;let r=e.onSave,i=(e,t)=>{n.current=Promise.resolve(r(e,t))};return t.editor.on(`save`,i),()=>{t.editor.off(`save`,i)}},[t.editor,e.onSave]);let r=(0,KT.useRef)(null),i=e.scenes??null;return(0,KT.useEffect)(()=>{r.current=i},[i]),(0,KT.useEffect)(()=>Us({editor:t.editor,getScenes:()=>r.current,waitForSave:()=>n.current}),[t.editor]),(0,KT.useEffect)(()=>{t.editor&&t.editor.bootstrap(e.editorData)},[e.editorData,t.editor]),(0,qT.jsx)(Fi.Provider,{value:{...t,scenes:e.scenes,fieldUIs:e.fieldUIs},children:e.children})},JT.__docgenInfo={description:``,methods:[],displayName:`OREditorProvider`}})))()}var XT,$,ZT,QT,$T,eE;function tE(){return(tE=t((()=>{XT=e(i(),1),be(),w(),we(),ya(),ka(),Iv(),Wv(),Ty(),Qy(),rb(),Fx(),Hx(),$x(),Qb(),dS(),zT(),HT(),YT(),$=o(),ZT=[{id:`hierarchy`,title:`Hierarchy`,category:`General`,content:(0,$.jsx)(le,{children:(0,$.jsx)(Zy,{})})},{id:`timer`,title:`Timer`,category:`Rendering`,content:(0,$.jsx)(le,{noPadding:!0,children:(0,$.jsx)(wy,{})})},{id:Xb,title:`Screen`,category:`General`,multiple:!0,content:e=>(0,$.jsx)(Zb,{viewportId:e})},{id:`property`,title:`Property`,category:`General`,content:(0,$.jsx)(le,{children:(0,$.jsx)(Fv,{})})},{id:`textures`,title:`Textures`,category:`Rendering`,content:(0,$.jsx)(le,{noPadding:!0,children:(0,$.jsx)(uS,{})})},{id:`scene`,title:`Scene`,category:`General`,content:(0,$.jsx)(le,{children:(0,$.jsx)(Qx,{})})},{id:`export`,title:`Export`,category:`Project`,content:(0,$.jsx)(le,{children:(0,$.jsx)(Uv,{})})},{id:`renderer`,title:`Renderer`,category:`Rendering`,content:(0,$.jsx)(le,{children:(0,$.jsx)(Vx,{})})},{id:`editor-settings`,title:`Editor`,category:`Project`,content:(0,$.jsx)(le,{children:(0,$.jsx)(va,{})})},{id:`timeline`,title:`Timeline`,category:`Animation`,content:(0,$.jsx)(le,{noPadding:!0,children:(0,$.jsx)(RT,{})})}],QT=[`hierarchy`,`property`],$T=e=>{let t=[];for(let n of e)n.multiple||n.id!==`hierarchy`&&n.id!==`property`&&n.id!==`timeline`&&t.push({id:n.id,title:n.title,content:n.content});return t},eE=e=>{let t=Ce(),n=(0,XT.useMemo)(()=>e.panels?[...ZT,...e.panels]:ZT,[e.panels]),r=null;return r=t.isPC?(0,$.jsx)(Px,{panels:n,activateOnSelect:QT}):(0,$.jsx)($.Fragment,{children:(0,$.jsxs)(oe,{direction:`vertical`,storageKey:`orengine-editor-sp-main`,children:[(0,$.jsx)(oe.Item,{size:`calc( min( 56.25vw, 55vh ) + 77px )`,minSize:200,style:{minHeight:`200px`},children:(0,$.jsx)(Zb,{viewportId:`main`})}),(0,$.jsx)(oe.Item,{flex:1,minSize:200,children:(0,$.jsxs)(ue,{storageKey:`orengine-panel-sp-main`,children:[(0,$.jsx)(ue.Tab,{title:`Hierarchy / Property`,children:(0,$.jsxs)(oe,{direction:`horizontal`,storageKey:`orengine-editor-sp-hierarchyProp`,children:[(0,$.jsx)(oe.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,$.jsx)(Zy,{})}),(0,$.jsx)(oe.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,$.jsx)(Fv,{})})]})}),$T(n).map(e=>(0,$.jsx)(ue.Tab,{title:e.title,children:e.content},e.id))]})}),(0,$.jsx)(oe.Item,{size:`120px`,minSize:80,children:(0,$.jsx)(ue,{storageKey:`orengine-panel-sp-timeline`,children:(0,$.jsx)(ue.Tab,{title:`Timeline`,children:(0,$.jsx)(le,{noPadding:!0,children:(0,$.jsx)(ye,{fallback:(0,$.jsx)(`div`,{children:`エラーだよ`}),children:(0,$.jsx)(RT,{})})})})})})]})}),(0,$.jsx)(JT,{projectName:e.projectName,onSave:e.onSave,editorData:e.editorData,scenes:e.scenes,fieldUIs:e.fieldUIs,children:(0,$.jsx)(S,{children:(0,$.jsxs)(re,{children:[(0,$.jsx)(`div`,{className:VT.editor,children:r}),(0,$.jsx)(Oa,{}),(0,$.jsx)(nb,{}),(0,$.jsx)(b,{}),(0,$.jsx)(ne,{})]})})})},eE.__docgenInfo={description:``,methods:[],displayName:`OREditor`,props:{onSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( projectData: OREngineProjectData, editorData: MXP.SerializeField ) => Promise<void> | void`,signature:{arguments:[{type:{name:`OREngineProjectData`},name:`projectData`},{type:{name:`MXP.SerializeField`},name:`editorData`}],return:{name:`union`,raw:`Promise<void> | void`,elements:[{name:`Promise`,elements:[{name:`void`}],raw:`Promise<void>`},{name:`void`}]}}},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},projectName:{required:!1,tsType:{name:`string`},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}},{key:`layout`,value:{name:`union`,raw:`'inline' | 'block'`,elements:[{name:`literal`,value:`'inline'`},{name:`literal`,value:`'block'`}],required:!0}}]},required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}var nE,rE;function iE(){return(iE=t((()=>{nE=e(i(),1),ic(),Di(),rE=()=>{let[e,t]=nE.useState(()=>new I(nc)),n=nE.useRef(e);return n.current=e,(0,nE.useEffect)(()=>{n.current.disposed&&t(new I(nc))},[]),(0,nE.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,nE.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var aE,oE,sE;function cE(){return(cE=t((()=>{aE=i(),qv(),iE(),oE=o(),sE=e=>{let t=rE(),{engine:n}=t,r=(0,aE.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,aE.useEffect)(()=>{r.current?.(n)},[n]),(0,aE.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,oE.jsx)(Kv.Provider,{value:t,children:e.children})},sE.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var lE,uE,dE,fE,pE,mE,hE;function gE(){return(gE=t((()=>{lE=i(),tE(),cE(),uE=o(),dE=`scene`,fE=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},pE=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),mE=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),hE=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,lE.useState)(e.sceneData),[a,o]=(0,lE.useState)(e.editorData),[s,c]=(0,lE.useState)([]),[l,u]=(0,lE.useState)(null),d=(0,lE.useCallback)(async e=>{let t=await fE(`${n}/scenes/${e}`);if(!t)throw Error(`シーンを読み込めません: ${e}`);u(e),i(t)},[n]);(0,lE.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([fE(`${n}/editor`),fE(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[dE]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]),(0,lE.useEffect)(()=>{l&&(document.title=`${l} | OREngine`)},[l]);let f={names:s,current:l,onSelect:d,onCreate:(0,lE.useCallback)(async(e,t)=>{let r=mE(e);if(t!==void 0){let i=await fE(`${n}/scenes/${t}`);if(!i)throw Error(`複製元のシーンを読み込めません: ${t}`);r={...i,name:e}}let i=await pE(`${n}/scenes/${e}`,r);if(!i.ok)throw Error(`シーンを作成できません: ${e}（HTTP ${i.status}）`);let a=await fE(`${n}/scenes`);a&&c(a)},[n]),onDelete:(0,lE.useCallback)(async e=>{let t=await fetch(`${n}/scenes/${e}`,{method:`DELETE`});if(!t.ok)throw Error(`シーンを削除できません: ${e}（HTTP ${t.status}）`);let r=await fE(`${n}/scenes`)??[];c(r),e===l&&r.length>0&&await d(r[0])},[n,l,d])};return(0,uE.jsx)(sE,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,uE.jsx)(eE,{editorData:a,projectName:t,panels:e.panels,fieldUIs:e.fieldUIs,scenes:f,onSave:async(t,r)=>{e.onBeforeSave?.();let i=[pE(`${n}/editor`,{...r,[dE]:l})];l&&i.push(pE(`${n}/scenes/${l}`,t));for(let e of await Promise.all(i))if(!e.ok)throw Error(`保存に失敗しました（POST ${new URL(e.url).pathname}: HTTP ${e.status}）`)}})})},hE.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}},{key:`layout`,value:{name:`union`,raw:`'inline' | 'block'`,elements:[{name:`literal`,value:`'inline'`},{name:`literal`,value:`'block'`}],required:!0}}]},required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var _E,vE;function yE(){return(yE=t((()=>{tE(),cE(),_E=o(),vE=e=>(0,_E.jsx)(sE,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,_E.jsx)(eE,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,fieldUIs:e.fieldUIs,onSave:()=>{}})}),vE.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}},{key:`layout`,value:{name:`union`,raw:`'inline' | 'block'`,elements:[{name:`literal`,value:`'inline'`},{name:`literal`,value:`'block'`}],required:!0}}]},required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}var bE,xE,SE;function CE(){return(CE=t((()=>{bE=`InputGroup__group___Lmdyb`,xE=`InputGroup__submit___Lmdyb`,SE={group:bE,submit:xE}})))()}var wE,TE,EE;function DE(){return(DE=t((()=>{wE=i(),w(),ra(),CE(),TE=o(),EE=e=>{let t=e.initialValues,n=[],[r,i]=(0,wE.useState)(t);(0,wE.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,TE.jsx)(na,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,wE.useRef)(null);return(0,wE.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,TE.jsx)(`div`,{className:SE.group,ref:o,children:(0,TE.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,TE.jsx)(s,{label:e.title,noMargin:!0,children:n}),(0,TE.jsx)(`div`,{className:SE.submit,children:(0,TE.jsx)(c,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},EE.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}function OE(){return(OE=t((()=>{gE(),yE(),tE(),YT(),R(),D_(),cE(),Xv(),Qy(),Iv(),Qb(),yb(),Eb(),zT(),_S(),$x(),Wv(),Ty(),Hx(),ya(),fa(),dS(),ov(),ub(),ra(),H_(),DE(),Vi(),Gi(),ea(),sv(),Fa(),I_(),we()})))()}var kE;function AE(){return(AE=t((()=>{kE=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var jE;function ME(){return(ME=t((()=>{jE=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var NE=n({EyeRings:()=>PE}),PE;function FE(){return(FE=t((()=>{F(),AE(),ME(),PE=class extends j{constructor(e){super(e);let t=new tn({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new bn({phase:[`deferred`,`shadowMap`],frag:kE,vert:jE});this.entity.addComponent(M,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(M)}}})))()}var IE;function LE(){return(LE=t((()=>{IE=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var RE;function zE(){return(zE=t((()=>{RE=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var BE=n({FlashLine:()=>VE}),VE;function HE(){return(HE=t((()=>{k(),F(),LE(),zE(),VE=class extends j{geometry;material;constructor(e){super(e),this.geometry=new Nt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=je.randomVector().multiply(new D(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new bn({phase:[`forward`,`envMap`],frag:N(`flFrag`,IE),vert:N(`flVert`,RE)}),this.entity.addComponent(M,{material:this.material,geometry:this.geometry})}}})))()}var UE;function WE(){return(WE=t((()=>{UE=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var GE=n({SkyBox:()=>KE}),KE;function qE(){return(qE=t((()=>{F(),WE(),KE=class extends j{material;constructor(e){super(e);let t=this.engine;this.material=new bn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:N(`SkyBoxFrag`,UE),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}}})))()}var JE;function YE(){return(YE=t((()=>{JE=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var XE;function ZE(){return(ZE=t((()=>{XE=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var QE=n({GridCross:()=>$E}),$E;function eD(){return(eD=t((()=>{k(),F(),YE(),ZE(),$E=class extends j{constructor(e){super(e);let t=new jt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new D(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new bn({frag:N(`gridCrossFrag`,JE),vert:N(`gridCrossVert`,XE),phase:[`forward`]});this.entity.addComponent(M,{geometry:t,material:a})}}})))()}var tD;function nD(){return(nD=t((()=>{tD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var rD;function iD(){return(iD=t((()=>{rD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var aD=n({GridDots:()=>oD}),oD;function sD(){return(sD=t((()=>{k(),F(),nD(),iD(),oD=class extends j{constructor(e){super(e);let t=new Lt({radius:.1}),n=[],r=[],i=new D(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new bn({frag:N(`gridDotsFrag`,tD),vert:N(`gridDotsVert`,rD),phase:[`forward`]});this.entity.addComponent(M,{geometry:t,material:a})}}})))()}var cD;function lD(){return(lD=t((()=>{cD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
#endif\r
\r
}`})))()}var uD;function dD(){return(dD=t((()=>{uD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var fD=n({WireCube:()=>pD}),pD;function mD(){return(mD=t((()=>{F(),lD(),dD(),pD=class extends j{constructor(e){super(e);let t=3.3,n=t/2,r=new jt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new bn({phase:[`deferred`],frag:cD,vert:uD});this.entity.addComponent(M,{geometry:r,material:o})}}})))()}var hD=n({FieldUISample:()=>gD}),gD;function _D(){return(_D=t((()=>{k(),F(),gD=class extends j{speed;wave;rotQuaternion;constructor(e){super(e),this.speed=1,this.wave=.5,this.rotQuaternion=new ke,this.field(`speed`,()=>this.speed,e=>this.speed=e,{step:.1}),this.field(`wave`,()=>this.wave,e=>this.wave=e,{step:.05,min:0})}updateImpl(e){this.rotQuaternion.setFromEuler(new De(0,e.timeDelta*this.speed,0)),this.entity.quaternion.multiply(this.rotQuaternion),this.entity.position.y=Math.sin(e.timeElapsed*2)*this.wave}}})))()}var vD;function yD(){return(yD=t((()=>{vD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var bD;function xD(){return(xD=t((()=>{bD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var SD=n({OREngineCube:()=>CD}),CD;function wD(){return(wD=t((()=>{F(),Ni(),yD(),xD(),CD=class extends j{material;constructor(e){super(e),this.material=new bn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:N(`OREngineCubeVert`,bD),frag:N(`OREngineCubeFrag`,vD),uniforms:{uNoiseTex:{value:I.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(M);t&&(t.material=this.material)}}})))()}var TD;function ED(){return(ED=t((()=>{TD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var DD;function OD(){return(OD=t((()=>{DD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var kD=n({OREngineLogo:()=>AD}),AD;function jD(){return(jD=t((()=>{F(),ED(),OD(),AD=class extends j{material;constructor(e){super(e),this.material=new bn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:N(`OREngineLogoVert`,DD),frag:N(`OREngineLogoFrag`,TD)});let t=this.entity.getComponent(M);t&&(t.material=this.material)}}})))()}var MD;function ND(){return(ND=t((()=>{MD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var PD;function FD(){return(FD=t((()=>{PD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ID=n({Dust:()=>LD}),LD;function RD(){return(RD=t((()=>{k(),F(),ND(),FD(),LD=class extends j{constructor(e){super(e);let t=new kt,n=e.args?.num||2048,r=new D(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new bn({phase:[`forward`],drawType:`POINTS`,frag:MD,vert:PD});this.entity.addComponent(M,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(M)}}})))()}var zD;function BD(){return(BD=t((()=>{zD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var VD;function HD(){return(HD=t((()=>{VD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var UD;function WD(){return(WD=t((()=>{UD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `})))()}var GD=n({YakiSoba:()=>KD}),KD;function qD(){return(qD=t((()=>{k(),F(),BD(),HD(),WD(),KD=class extends j{_gpu;constructor(e){super(e);let t=this.engine,n=new D(64,512);this._gpu=new ci({passes:[new di(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:N(`yakiSobaCompute`,UD),uniforms:pn.merge({},t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new jt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new bn({frag:N(`chainFrag`,zD),vert:N(`chainVert`,VD),phase:[`deferred`,`shadowMap`],uniforms:pn.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(M,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(M),this._gpu.dispose()}}})))()}var JD;function YD(){return(YD=t((()=>{JD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var OO;function kO(){return(kO=t((()=>{DO(),OO={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:EO}})))()}var AO;function jO(){return(jO=t((()=>{AO=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var MO;function NO(){return(NO=t((()=>{jO(),MO={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:AO}})))()}var PO;function FO(){return(FO=t((()=>{PO=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var IO;function LO(){return(LO=t((()=>{FO(),IO={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:PO}})))()}var RO;function zO(){return(zO=t((()=>{FO(),RO={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:PO}})))()}var BO,VO,HO;function UO(){return(UO=t((()=>{kO(),NO(),LO(),zO(),Ni(),BO=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":OO,"/demo-webgl/Resources/Textures/noise.tex":MO,"/demo-webgl/Resources/Textures/noiseCyclic.tex":IO,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":RO}),VO=()=>{for(let e of Object.values(BO))e&&I.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},HO=e=>{I.resources.buildTextureInstances(e.renderer)}})))()}var WO,GO,KO,qO,JO;function YO(){return(YO=t((()=>{FE(),HE(),qE(),eD(),sD(),mD(),_D(),wD(),jD(),RD(),qD(),QD(),ic(),Ni(),TO(),UO(),WO=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":NE,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":BE,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":GE,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":QE,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":aD,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":fD,"/demo-webgl/Resources/Components/Samples/Objects/FieldUISample/index.ts":hD,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":SD,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":kD,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":ID,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":GD,"/demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":XD}),GO=Object.assign({}),KO=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);KO(a,e)}}},qO=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);qO(a,e)}}},JO=()=>{Ct.gltfLoaderFactory=e=>new Xs(e),I.resources.clear();let e=I.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Ut),e.addComponent(`Camera`,zt),e.addComponent(`Mesh`,M);let t=Object.keys(CO);for(let e=0;e<t.length;e++){let n=t[e],r=CO[n],i=I.resources.addComponentGroup(n);KO(r,i)}let n=Object.keys(wO);for(let e=0;e<n.length;e++){let t=n[e],r=wO[t],i=I.resources.addGeometryGroup(t);qO(r,i)}let r=Si(WO,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=I.resources.addComponentGroup(t);KO(n,a)}let a=Si(GO,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=I.resources.addGeometryGroup(t);qO(n,r)}VO()}})))()}var XO,ZO,QO,$O,ek,tk;function nk(){return(nk=t((()=>{XO=i(),OE(),w(),YO(),ZO=o(),JO(),QO=({setup:e})=>{let{editor:t}=L();return(0,XO.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},$O=e=>(0,ZO.jsx)(sE,{project:e.fixture.scene,onEngineInit:HO,children:(0,ZO.jsx)(JT,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,ZO.jsx)(S,{children:(0,ZO.jsxs)(re,{children:[e.children,e.fixture.setup&&(0,ZO.jsx)(QO,{setup:e.fixture.setup}),(0,ZO.jsx)(b,{}),(0,ZO.jsx)(ne,{})]})})})}),ek=e=>t=>(0,ZO.jsx)($O,{fixture:e,children:(0,ZO.jsx)(t,{})}),tk=e=>t=>(0,ZO.jsx)(sE,{project:e,onEngineInit:HO,children:(0,ZO.jsx)(t,{})}),$O.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var rk,ik,ak,ok,sk;function ck(){return(ck=t((()=>{rk={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`LookAt`,uuid:`sb-camera-lookat`}]},ik={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[rk,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},ak={...ik,scene:{name:`root`,uuid:`0`,childs:[rk]}},ok={enableRender:!0,"viewports/main/resolutionScale":.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},sk={scene:ik,editorData:ok}})))()}export{va as A,R as B,Wv as C,ov as D,av as E,ea as F,Ni as H,Wi as I,Gi as L,na as M,ra as N,V_ as O,$i as P,Bi as R,Uv as S,Iv as T,I as U,L as V,Di as W,$x as _,ik as a,Zy as b,ek as c,DE as d,eE as f,Qx as g,zT as h,sk as i,ya as j,H_ as k,tk as l,RT as m,ok as n,$O as o,tE as p,ak as r,nk as s,ck as t,EE as u,Vx as v,Fv as w,Qy as x,Hx as y,Vi as z};