...
`})))()}var tr,nr,rr;function ir(){return(ir=t((()=>{ot(),A(),F(),Hn(),Xe(),Wn(),Kn(),Jn(),Xn(),Qn(),er(),tr=e=>{let t=[];for(let n=0;n<e;n++){let r=new O;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},nr=9,rr=class extends nt{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;shading;sssH;sssV;sssCopy;constructor(e){super();let t=e.backend,n=e.renderTarget,r=new P(t,{name:`normalSelector`,frag:qn,renderTarget:null,uniforms:mn.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),a=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),o=new P(t,{name:`lightShaft`,frag:Gn,renderTarget:i,uniforms:mn.merge({uLightShaftBackBuffer:{value:a.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),c=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),l=new P(t,{name:`ssao`,frag:Yn,renderTarget:an(`ssao`,s),uniforms:mn.merge({uSSAOBackBuffer:{value:c.textures[0],type:`1i`},uSSAOKernel:{value:tr(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),u=mn.merge({uSSAOTexture:{value:c.textures[0],type:`1i`},uPosTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:je.gaussWeights(8)}}),d=new P(t,{name:`ssaoBlur/h`,frag:an(`ssaoBlur`,Zn),uniforms:u,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),f=new P(t,{name:`ssaoBlur/v`,frag:an(`ssaoBlur`,Zn),uniforms:mn.merge(u,{uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),p=new P(t,{name:`deferredShading`,frag:an(`deferredShading`,Un),uniforms:mn.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:f.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:l.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})}),m=()=>t.createFrameBuffer({disableDepthBuffer:!0}).setTexture([t.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA,magFilter:j.LINEAR,minFilter:j.LINEAR})]),h=mn.merge({uDiffuseTexture:{value:n.shadingBuffer.textures[1],type:`1i`},uAlbedoTexture:{value:n.gBuffer.textures[2],type:`1i`},uPosTexture:{value:n.gBuffer.textures[0],type:`1i`},uNormalTexture:{value:n.normalBuffer.textures[0],type:`1i`},uSSSRadius:{value:.05,type:`1f`},uKernel:{value:Vn(nr),type:`4fv`}}),g=new P(t,{name:`sss/h`,frag:an(`sss`,$n),uniforms:h,renderTarget:m(),passThrough:!0,defines:{SSS_SAMPLES:nr}}),_=new P(t,{name:`sss/v`,frag:an(`sss`,$n),uniforms:mn.merge(h,{uDiffuseTexture:{value:g.renderTarget.textures[0],type:`1i`},uShadingTexture:{value:n.shadingBuffer.textures[0],type:`1i`},uShadingDiffuseTexture:{value:n.shadingBuffer.textures[1],type:`1i`}}),renderTarget:m(),defines:{SSS_SAMPLES:nr,IS_VIRT:``}}),v=new P(t,{name:`sss/copy`,renderTarget:t.createFrameBuffer({disableDepthBuffer:!0}).setTexture([n.shadingBuffer.textures[0]])});this.postprocess=new Cn({passes:[r,o,l,d,f,p,g,_,v]}),this.shading=p,this.lightShaft=o,this.ssao=l,this.rtSSAO1=s,this.rtSSAO2=c,this.ssaoBlur=d,this.ssaoBlurV=f,this.sssH=g,this.sssV=_,this.sssCopy=v,this.rtLightShaft1=i,this.rtLightShaft2=a,this.normalSelector_=r;for(let e=0;e<n.gBuffer.textures.length;e++){let t=n.gBuffer.textures[e];e===1&&(t=n.normalBuffer.textures[0]),p.uniforms[`sampler`+e]=l.uniforms[`sampler`+e]={type:`1i`,value:t}}o.uniforms.uDepthTexture.value=n.gBuffer.depthTexture,p.renderTarget=n.shadingBuffer,r.renderTarget=n.normalBuffer,r.uniforms.uNormalTexture.value=n.gBuffer.textures[1],r.uniforms.uPosTexture.value=n.gBuffer.textures[0],r.uniforms.uSelectorTexture.value=n.gBuffer.textures[3],u.uPosTexture.value=n.gBuffer.textures[0],u.uNormalTexture.value=n.normalBuffer.textures[0]}update(){let e=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=e,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],e=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=e,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.sss!==void 0&&(this.sssH.enabled=e.sss,this.sssV.enabled=e.sss,this.sssCopy.enabled=e.sss),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}setSSSRadius(e){this.sssH.uniforms.uSSSRadius.value=e}resize(e){this.postprocess.resize(e)}dispose(){this.postprocess.dispose(),this.rtLightShaft1.dispose(),this.rtLightShaft2.dispose(),this.rtSSAO1.dispose(),this.rtSSAO2.dispose();for(let e of[this.sssH,this.sssV])e.renderTarget.textures[0].dispose(),e.renderTarget.dispose();this.sssCopy.renderTarget.dispose()}}})))()}var ar;function or(){return(or=t((()=>{ar=`uniform sampler2D uShadingTexture;
...
}`})))()}var sr;function cr(){return(cr=t((()=>{sr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var lr;function ur(){return(ur=t((()=>{lr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})))()}var yr;function br(){return(br=t((()=>{yr=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`})))()}var xr;function Sr(){return(Sr=t((()=>{xr=`// https://qiita.com/aa_debdeb/items/26ab808de6745611df53
...
}`})))()}var Cr;function wr(){return(wr=t((()=>{Cr=`in vec2 vUv;
...
}`})))()}var Tr;function Er(){return(Er=t((()=>{Tr=`in vec2 vUv;
uniform sampler2D uBackBuffer0;
uniform sampler2D uVelTex;
uniform vec2 uPPPixelSize;
...
}`})))()}var kr;function Ar(){return(Ar=t((()=>{kr=`// フレネルと粗さで重み付けして反射色を足す
...
`})))()}var jr;function Mr(){return(Mr=t((()=>{jr=`// 反射方向へレイマーチしてシーンを引く。今フレームの結果だけを出し、時間方向の蓄積は ssrTemporal.fs が行う
...
}`})))()}var Nr;function Pr(){return(Pr=t((()=>{Nr=`// ssr.fs の今フレームの結果を、前フレームの結果と混ぜて均す。
...
`})))()}var Fr,Ir,Lr,Rr,zr;function Br(){return(Br=t((()=>{A(),F(),Xe(),or(),cr(),ur(),fr(),mr(),gr(),vr(),br(),Sr(),wr(),Er(),Or(),Ar(),Mr(),Pr(),Fr=4,Ir=8,Lr=14/1080,Rr=e=>e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA,magFilter:j.LINEAR,minFilter:j.LINEAR})]),zr=class{dofCoc;dofBokeh;dofBlur;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssrTemporal;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;_colorCollection;_bloomBright;_bloomPasses;constructor(e,t){let n=new P(e,{name:`collection`,frag:lr,uniforms:{uToneMap:{value:1,type:`1f`},uExposure:{value:1,type:`1f`}}}),r=new P(e,{name:`ssr`,frag:an(`ssr`,jr),renderTarget:Rr(e),uniforms:mn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),i=Rr(e),a=Rr(e),o=new P(e,{name:`ssrTemporal`,frag:an(`ssrTemporal`,Nr),renderTarget:i,uniforms:mn.merge({uSSRCurrent:{value:r.renderTarget.textures[0],type:`1i`},uSSRBackBuffer:{value:a.textures[0],type:`1i`},uGbufferPos:{value:null,type:`1i`},uVelTex:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),s=new P(e,{name:`ssComposite`,frag:an(`ssComposite`,kr),uniforms:mn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uGbufferMaterial:{value:null,type:`1i`},uSSRTexture:{value:i.textures[0],type:`1i`}}),renderTarget:Rr(e)}),c=new O(10,.05,20,.05),l=new P(e,{name:`dof/coc`,frag:hr,uniforms:mn.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:c,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR,internalFormat:j.RGBA16F,type:j.HALF_FLOAT,format:j.RGBA})]),passThrough:!0,resolutionRatio:.5}),u=new P(e,{name:`dof/bokeh`,frag:pr,uniforms:mn.merge({uCocTex:{value:l.renderTarget.textures[0],type:`1i`},uParams:{value:c,type:`4f`}}),renderTarget:Rr(e),passThrough:!0,resolutionRatio:.5}),d=new P(e,{name:`dof/blur`,frag:dr,uniforms:mn.merge({uBokeTex:{value:u.renderTarget.textures[0],type:`1i`}}),renderTarget:Rr(e),passThrough:!0,resolutionRatio:.5}),f=new P(e,{name:`dof/composite`,frag:_r,uniforms:mn.merge({uBokeTex:{value:d.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR,internalFormat:j.RGBA16F,type:j.HALF_FLOAT,format:j.RGBA})])}),p=new P(e,{name:`motionBlurTile`,frag:Dr,uniforms:mn.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),m=new P(e,{name:`motionBlurNeighbor`,frag:Tr,uniforms:mn.merge({uVelTex:{value:p.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA})]),resolutionRatio:1/16,passThrough:!0}),h=new P(e,{name:`motionBlur`,frag:Cr,uniforms:mn.merge({uVelNeighborTex:{value:m.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16},renderTarget:Rr(e)}),g=new P(e,{name:`fxaa`,frag:yr}),_=new P(e,{name:`bloom/bright`,frag:ar,uniforms:{uShadingTexture:{value:t.shadingBuffer.textures[0],type:`1i`},uThreshold:{value:1,type:`1f`},uBrightness:{value:1,type:`1f`}},renderTarget:Rr(e),resolutionRatio:.5,passThrough:!0}),v=[_],y=[],b=_.renderTarget.textures[0],x=2;for(let t=0;t<Fr;t++){let n=Rr(e),r=Rr(e),i={name:`bloom/blur/`+t+`/v`,renderTarget:n,frag:xr,uniforms:{uBackBlurTex:{value:b,type:`1i`},uIsVertical:{type:`1i`,value:!0},uWeights:{type:`1fv`,value:je.gaussWeights(Ir)},uBlurRange:{value:2,type:`1f`}},defines:{GAUSS_WEIGHTS:Ir.toString(),USE_BACKBLURTEX:``},passThrough:!0,resolutionRatio:1/x};v.push(new P(e,i)),v.push(new P(e,{...i,name:`bloom/blur/`+t+`/h`,renderTarget:r,uniforms:{...i.uniforms,uBackBlurTex:{value:n.textures[0],type:`1i`},uIsVertical:{type:`1i`,value:!1}}})),y.push(r.textures[0]),b=r.textures[0],x*=2}v.push(new P(e,{name:`bloom/composite`,frag:sr,uniforms:{uBloomTexture:{value:y,type:`1iv`}},renderTarget:Rr(e)})),this.postprocess=new Cn({passes:[r,o,s,l,u,d,f,p,m,h,...v,n,g]}),this._ssr=r,this._ssrTemporal=o,this._ssComposite=s,this.dofCoc=l,this.dofBokeh=u,this.dofBlur=d,this.dofComposite=f,this._motionBlur=h,this._motionBlurTile=p,this._motionBlurNeighbor=m,this._colorCollection=n,this._bloomBright=_,this._bloomPasses=v,this._dofParams=c,this.rtSSR1=i,this.rtSSR2=a,r.uniforms.uGbufferPos.value=t.gBuffer.textures[0],r.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],r.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],o.uniforms.uGbufferPos.value=t.gBuffer.textures[0],o.uniforms.uVelTex.value=t.gBuffer.textures[4],s.uniforms.uGbufferPos.value=t.gBuffer.textures[0],s.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],s.uniforms.uGbufferMaterial.value=t.gBuffer.textures[3],l.uniforms.uGbufferPos.value=t.gBuffer.textures[0],p.uniforms.uVelTex.value=t.gBuffer.textures[4],h.uniforms.uVelTex.value=t.gBuffer.textures[4],h.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}update(e){let t=e.dofParams.kFilmHeight,n=.5*t/Math.tan(.5*(e.fov/180*Math.PI)),r=Math.max(e.dofParams.focusDistance,n),i=Lr,a=1/i,o=n*n/(e.dofParams.fNumber*(r-n)*t*2);this._dofParams.set(r,i,a,o);let s=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=s,this._ssrTemporal.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssrTemporal.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){if(e.toneMap!==void 0&&(this._colorCollection.uniforms.uToneMap.value=+!!e.toneMap),e.bloom!==void 0)for(let t of this._bloomPasses)t.enabled=e.bloom;e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssrTemporal.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofBlur.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofBlur.renderTarget&&this.dofBlur.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}setExposure(e){this._colorCollection.uniforms.uExposure.value=2**e}setBloomParams(e,t){this._bloomBright.uniforms.uThreshold.value=e,this._bloomBright.uniforms.uBrightness.value=t}dispose(){this.postprocess.dispose(),this.rtSSR1.dispose(),this.rtSSR2.dispose()}}})))()}var Vr,Hr;function Ur(){return(Ur=t((()=>{A(),Xe(),ir(),Br(),Vr=e=>{let t=e.createFrameBuffer();t.setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA,magFilter:j.NEAREST,minFilter:j.NEAREST}),e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA}),e.createTexture().setting({internalFormat:j.SRGB8_ALPHA8}),e.createTexture(),e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA})]);let n=e.createFrameBuffer({disableDepthBuffer:!0});n.setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA}),e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA})]);let r=e.createFrameBuffer({disableDepthBuffer:!0});r.setDepthTexture(t.depthTexture),r.setTexture([n.textures[0],t.textures[0],t.textures[4]]);let i=e.createFrameBuffer({disableDepthBuffer:!0});i.setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA,magFilter:j.LINEAR,minFilter:j.LINEAR})]);let a=e.createFrameBuffer({disableDepthBuffer:!0});a.setDepthTexture(t.depthTexture),a.setTexture([e.createTexture()]);let o=e.createFrameBuffer();return o.setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA,magFilter:j.NEAREST,minFilter:j.NEAREST})]),{gBuffer:t,shadingBuffer:n,forwardBuffer:r,refractionBuffer:i,uiBuffer:a,normalBuffer:o}},Hr=class{camera;size;resolution;offscreen;renderTarget;deferredRenderer;pipelinePostProcess;_pipelineOverride;_sceneConfig;_onDispose;constructor(e){this.camera=null,this.size=null,this.resolution=new O,this.offscreen=e.offscreen,this._pipelineOverride=null,this._sceneConfig=e.sceneConfig,this._onDispose=e.onDispose,this.renderTarget=Vr(e.backend),this.deferredRenderer=new rr({backend:e.backend,envMap:e.envMap,envMapCube:e.envMapCube,renderTarget:this.renderTarget}),this.pipelinePostProcess=new zr(e.backend,this.renderTarget),this.fit(e.resolution),this.applyPipelineConfig()}get pipelineOverride(){return this._pipelineOverride}set pipelineOverride(e){this._pipelineOverride=e,this.applyPipelineConfig()}applyPipelineConfig(){let e={...this._sceneConfig,...this._pipelineOverride};this.deferredRenderer.setPassEnabled({ssao:e.ssao,lightShaft:e.lightShaft,sss:e.sss}),this.deferredRenderer.setSSSRadius(e.sssRadius??.05),this.pipelinePostProcess.setPassEnabled({toneMap:e.toneMap,motionBlur:e.motionBlur,ssr:e.ssr,dof:e.dof,bloom:e.bloom}),this.pipelinePostProcess.setMotionBlurPower(e.motionBlurPower??1),this.pipelinePostProcess.setExposure(e.exposure??0),this.pipelinePostProcess.setBloomParams(e.bloomThreshold??1,e.bloomBrightness??1)}fit(e){e.x<=0||e.y<=0||(this.resolution.x!==e.x||this.resolution.y!==e.y)&&this.resize(e)}resize(e){this.resolution.copy(e);let t=this.renderTarget;t.gBuffer.setSize(e),t.shadingBuffer.setSize(e),t.forwardBuffer.setSize(e),t.refractionBuffer.setSize(e),t.uiBuffer.setSize(e),t.normalBuffer.setSize(e),this.deferredRenderer.resize(e),this.pipelinePostProcess.resize(e)}dispose(){this._onDispose(this);let e=this.renderTarget;e.forwardBuffer.dispose();let t=[e.gBuffer,e.shadingBuffer,e.refractionBuffer,e.uiBuffer,e.normalBuffer];for(let e=0;e<t.length;e++){let n=t[e];for(let e=0;e<n.textures.length;e++)n.textures[e].dispose();n.dispose()}e.gBuffer.depthTexture&&e.gBuffer.depthTexture.dispose(),this.deferredRenderer.dispose(),this.pipelinePostProcess.dispose()}}})))()}var Wr;function Gr(){return(Gr=t((()=>{Wr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	scale: number;
	offset: number;
}`,signature:{properties:[{key:`name`,value:{name:`string`,required:!0}},{key:`scale`,value:{name:`number`,required:!0}},{key:`offset`,value:{name:`number`,required:!0}}]}},name:`settings`}],return:{name:`void`}}},description:``},onClose:{required:!0,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var tv,nv,rv,iv,av,ov,sv;function cv(){return(cv=t((()=>{tv=i(),H_(),T(),G_(),R(),ev(),nv=[`x`,`y`,`z`,`w`],rv=[`r`,`g`,`b`,`a`],iv=(e,t)=>{if(e.length!=t.length)return!1;for(let n=0;n<e.length;n++)if(e[n].curveId!=t[n].curveId||e[n].label!=t[n].label||e[n].uses!=t[n].uses)return!1;return!0},av=e=>{let t=e.target.closest(`[data-element]`);return!t||!e.currentTarget.contains(t)?null:Number(t.getAttribute(`data-element`))},ov=(e,t)=>{let n=e&&e.format;return n&&n.type==`vector`&&nv[t]?nv[t]:n&&n.type==`color`&&rv[t]?rv[t]:String(t)},sv=(e,t)=>{let{editor:n,engine:r}=L(),{open:i,closeAll:a}=w(),o=(0,tv.useMemo)(()=>({target:e,path:t}),[e,t]),s=Al(o),[c,l]=(0,tv.useState)(!1),[u,d]=(0,tv.useState)(!1),[f,p]=(0,tv.useState)(!1),[m,h]=(0,tv.useState)([]);if(W_(()=>{if(!s)return;let e=Wl(r,o,Dl(r),r.frame.current);l(e!==null),d(e!==null&&e.keyed),p(e!==null&&e.changed);let t=Zl(r,o);h(e=>iv(e,t)?e:t)}),(0,tv.useEffect)(()=>()=>{n.leaveKeyField(o)},[n,o]),!s)return{state:null,shared:m,rowProps:void 0};let g=(e,t,o)=>{let s=[],c=Yl(r,e),l=n.copiedCurveId;return c&&s.push({label:`Copy Curve`,onClick:()=>{n.copyCurve(c.curveId),a()}}),l&&r.curves[l]&&(s.push({label:`Paste Curve (Link)`,onClick:()=>{n.pasteCurve(e,`link`),a()}}),s.push({label:`Paste Curve (Duplicate)`,onClick:()=>{n.pasteCurve(e,`duplicate`),a()}})),c&&c.uses>1&&s.push({label:`Unlink Curve`,onClick:()=>{n.unlinkCurve(e),a()}}),c&&s.push({label:`Link Settings`,onClick:()=>{a();let r=(0,tv.createElement)($_,{info:c,onSubmit:t=>{n.setCurveLinkSettings(e,t),a()},onClose:a});i(r,ie(t,o))}}),s},_=r=>{r.preventDefault();let s=[{label:`Insert Keyframe`,onClick:()=>{n.insertKeys([o]),a()}}];u&&s.push({label:`Delete Keyframe`,onClick:()=>{n.deleteKeys([o]),a()}});let c=0;if(Array.isArray(e.getField(t))&&(c=av(r)),c!==null)for(let n of g({target:e,path:t,element:c},r.clientX,r.clientY))s.push(n);else{let n=e.getFieldOpt(t),i=Xl(o);for(let a=0;a<i;a++){let i=g({target:e,path:t,element:a},r.clientX,r.clientY);i.length!=0&&s.push({label:`Curve `+ov(n,a),children:i})}}i((0,tv.createElement)(ce,{title:t,items:s}),ie(r.clientX,r.clientY))},v=null;return c&&(v={keyed:u,changed:f}),{state:v,shared:m,rowProps:{onPointerEnter:()=>n.enterKeyField(o),onPointerLeave:()=>n.leaveKeyField(o),onContextMenu:_}}}})))()}var lv,uv;function dv(){return(dv=t((()=>{lv=i(),R(),uv=(e,t)=>{let{editor:n}=L(),r=(0,lv.useRef)(null);return{onChange:i=>{r.current?r.current.set(i):n.api.setField(e,t,i)},onDragStart:()=>{r.current=n.api.beginEdit(e,t)},onDragEnd:()=>{r.current&&r.current.commit(),r.current=null},onDragCancel:()=>{r.current&&r.current.cancel(),r.current=null}}}})))()}var fv,pv;function mv(){return(mv=t((()=>{fv=i(),Na(),pv=()=>{let e=(0,fv.useContext)(Ma);if(!e)throw Error(`SerializeFieldViewContext is not defined`);return e}})))()}var hv,gv;function _v(){return(_v=t((()=>{hv=`ValueArray__container___LmNvb`,gv={container:hv}})))()}var vv,yv;function bv(){return(bv=t((()=>{i(),T(),ia(),_v(),vv=o(),yv=e=>{let t=[],n=e.value,r=e.format,i=r?.type==`array`?r.labels:void 0;if(n===void 0)return null;for(let r=0;r<n.length;r++){let a=n[r],o=r.toString();i&&(o+=`/ `+i(a,r)),t.push((0,vv.jsx)(`div`,{"data-element":r,children:(0,vv.jsx)(D,{title:o,children:(0,vv.jsx)(ra,{...e,value:a,onChange:t=>{let i=n.concat();i[r]=t,e.onChange&&e.onChange(i)}})})},r))}return(0,vv.jsx)(`div`,{className:gv.container,children:t})},yv.__docgenInfo={description:``,methods:[],displayName:`ValueArray`,props:{value:{required:!0,tsType:{name:`union`,raw:`T | undefined`,elements:[{name:`T`},{name:`undefined`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}}},description:``},onDragStart:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},onDragEnd:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},onDragCancel:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},format:{required:!1,tsType:{name:`SerializableFieldFormat`},description:``},label:{required:!1,tsType:{name:`union`,raw:`string | React.ReactNode`,elements:[{name:`string`},{name:`ReactReactNode`,raw:`React.ReactNode`}]},description:``},readOnly:{required:!1,tsType:{name:`boolean`},description:``},step:{required:!1,tsType:{name:`number`},description:``},min:{required:!1,tsType:{name:`number`},description:``},max:{required:!1,tsType:{name:`number`},description:``},int:{required:!1,tsType:{name:`boolean`},description:``},disabled:{required:!1,tsType:{name:`boolean`},description:``}}}})))()}var xv,Sv;function Cv(){return(Cv=t((()=>{xv=`SerializeFieldViewValue__action___LmFjd`,Sv={action:xv}})))()}var wv,Tv,Ev;function Dv(){return(Dv=t((()=>{wv=e(i(),1),T(),R(),Ba(),Ka(),$a(),cv(),dv(),mv(),ia(),bv(),Cv(),Tv=o(),Ev=e=>{let{editor:t,engine:n,fieldUIs:r}=L(),{target:i}=pv(),a=uv(i,e.path),o=sv(i,e.path),s=e.field.value,c=typeof s,l=e.field.opt,u=l?.format,d=l?.label||e.path.split(`/`).pop(),f=u&&u.type==`vector`,p=null;o.state&&(p=(0,Tv.jsx)(Ga,{state:o.state}));let m=null;o.shared.length>0&&(m=(0,Tv.jsx)(Qa,{curves:o.shared}));let h=(0,Tv.jsxs)(Tv.Fragment,{children:[d,p,m]}),g=za(r,i,e.path);if(g){let r=(0,wv.createElement)(g.ui,{value:s,setValue:n=>t.api.setField(i,e.path,n),beginEdit:()=>t.api.beginEdit(i,e.path),target:i,path:e.path,opt:l,engine:n,editor:t});return(0,Tv.jsx)(`div`,{...o.rowProps,children:(0,Tv.jsx)(D,{title:h,vertical:g.layout===`block`,children:r})})}let _=null;if(Array.isArray(s))_=u?.type==`vector`?(0,Tv.jsx)(te,{value:s,...l,...a}):u?.type==`color`?(0,Tv.jsx)(b,{value:s,...l,onChange:n=>{t.api.setField(i,e.path,n)}}):(0,Tv.jsx)(yv,{value:s,...l,...a});else if(_=(0,Tv.jsx)(ra,{value:s,...l,...a}),c===`function`)return(0,Tv.jsxs)(`div`,{className:Sv.action,...o.rowProps,children:[_,(0,Tv.jsxs)(`span`,{children:[p,m]})]});return(0,Tv.jsx)(`div`,{...o.rowProps,children:(0,Tv.jsx)(D,{title:h,vertical:f,children:_})})},Ev.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldViewValue`,props:{path:{required:!0,tsType:{name:`string`},description:``},field:{required:!0,tsType:{name:`SerializeFieldDirectoryValue`},description:``}}}})))()}var Ov,kv,Av,jv;function Mv(){return(Mv=t((()=>{Ov=`SerializeFieldViewDir__container___LmNvb`,kv=`SerializeFieldViewDir__field___LmNvb`,Av=`SerializeFieldViewDir__block___LmNvb`,jv={container:Ov,field:kv,block:Av}})))()}var Nv,Pv;function Fv(){return(Fv=t((()=>{i(),T(),Dv(),Mv(),Nv=o(),Pv=e=>{let t=[],n=Object.keys(e.fields.childs);for(let r=0;r<n.length;r++){let i=n[r],a=e.fields.childs[i],{opt:o}=a,c=!1;if(o&&(c=typeof o.hidden==`function`?o.hidden(a.type==`value`?a.value:null):o.hidden||!1),c)continue;let l=`field`+i,u=(e.basePath?e.basePath+`/`:``)+i,d=null;d=a.type===`value`?(0,Nv.jsx)(Ev,{path:u,field:a},l):(0,Nv.jsx)(`div`,{className:jv.block,children:(0,Nv.jsx)(s,{accordion:!0,label:i,children:(0,Nv.jsx)(Pv,{fields:a,basePath:u})},l)},l),d&&t.push(d)}return(0,Nv.jsx)(`div`,{className:jv.container,children:t})},Pv.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldViewDir`,props:{fields:{required:!0,tsType:{name:`MXP.SerializeFieldDirectoryFolder`},description:``},basePath:{required:!1,tsType:{name:`string`},description:``}}}})))()}var Iv,Lv;function Rv(){return(Rv=t((()=>{Na(),Ra(),Fv(),Iv=o(),Lv=e=>{let t=La(e),n=t.target.serializeToDirectory();if(e.filter){let t=n.childs[e.filter];t&&t.type===`folder`&&(n=t)}return(0,Iv.jsx)(Ma.Provider,{value:t,children:(0,Iv.jsx)(Pv,{fields:n,basePath:e.filter})})},Lv.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldView`}})))()}var Y;function zv(){return(zv=t((()=>{Ia(),Y=(e,t)=>{let n=n=>{e?.setField(t,n)},{fields:r}=Fa(e,[t]);return[r&&r[t],n]}})))()}var Bv,Vv;function Hv(){return(Hv=t((()=>{Bv=`ComponentAdd__compAdd___LmNvb`,Vv={compAdd:Bv}})))()}var Uv,Wv;function Gv(){return(Gv=t((()=>{T(),Ca(),R(),Hv(),Uv=o(),Wv=e=>{let{editor:t}=L(),{open:n,closeAll:r}=w(),i=Sa(n=>{t.api.addComponent(e.entity,n.component),r()});return(0,Uv.jsx)(`div`,{className:Vv.compAdd,children:(0,Uv.jsx)(c,{onClick:e=>{n((0,Uv.jsx)(ce,{items:i}),ie(e.clientX,e.clientY))},children:`Add Component`})})},Wv.__docgenInfo={description:``,methods:[],displayName:`ComponentAdd`,props:{entity:{required:!0,tsType:{name:`MXP.Entity`},description:``}}}})))()}var Kv,qv,Jv,Yv,Xv,Zv;function Qv(){return(Qv=t((()=>{Kv=`ComponentView__compoView___LmNvb`,qv=`ComponentView__head___LmNvb`,Jv=`ComponentView__name___LmNvb`,Yv=`ComponentView__check___LmNvb`,Xv=`ComponentView__propertyBlock___LmNvb`,Zv={compoView:Kv,head:qv,name:Jv,check:Yv,delete:`ComponentView__delete___LmNvb`,propertyBlock:Xv}})))()}var $v,ey,ty,ny;function ry(){return(ry=t((()=>{$v=i(),Pi(),T(),R(),Ka(),$a(),cv(),Rv(),zv(),Qv(),ey=o(),ty=e=>{let t=Object.keys(e.childs);for(let n=0;n<t.length;n++){let r=e.childs[t[n]],{opt:i}=r,a=!1;if(i&&(a=typeof i.hidden==`function`?i.hidden(r.type===`value`?r.value:null):i.hidden||!1),!a&&(r.type===`value`||ty(r)))return!0}return!1},ny=({component:e})=>{let{editor:t}=L(),[n]=Y(e,`enabled`),r=sv(e,`enabled`),i=e.initiator!==`user`,a=ty(e.serializeToDirectory()),o=(0,$v.useCallback)(n=>{n.stopPropagation();let r=e.entity;if(r){for(let[n,i]of r.components)if(i.uuid===e.uuid){t.api.removeComponent(r,n,e);break}}},[e,t]),c=(0,$v.useCallback)(n=>{t.api.setField(e,`enabled`,n)},[e,t]),l=null;r.state&&(l=(0,ey.jsx)(Ga,{state:r.state}));let d=null;r.shared.length>0&&(d=(0,ey.jsx)(Qa,{curves:r.shared}));let f=(0,ey.jsxs)(`div`,{className:Zv.head,children:[(0,ey.jsx)(`div`,{className:Zv.check,...r.rowProps,children:(0,ey.jsx)(y,{checked:n||!1,onChange:c,readOnly:i})}),l,d,(0,ey.jsx)(`div`,{className:Zv.name,children:I.resources.getComponentName(e)}),(0,ey.jsx)(`div`,{className:Zv.delete,children:(0,ey.jsx)(`button`,{onClick:o,children:(0,ey.jsx)(u,{})})})]});return(0,ey.jsx)(`div`,{className:Zv.compoView,"data-disable_component":i,children:(0,ey.jsx)(`div`,{className:Zv.content,children:(0,ey.jsx)(s,{label:f,accordion:a,bg:!0,defaultClose:!1,children:a&&(0,ey.jsx)(Lv,{target:e})})})})},ny.__docgenInfo={description:``,methods:[],displayName:`ComponentView`,props:{component:{required:!0,tsType:{name:`MXP.Component`},description:``}}}})))()}var iy,ay;function oy(){return(oy=t((()=>{iy=`ComponentList__container___LmNvb`,ay={container:iy}})))()}var sy,cy,ly;function uy(){return(uy=t((()=>{sy=i(),zv(),ry(),oy(),cy=o(),ly=({entity:e})=>{let[t]=Y(e,`components`),n=(0,sy.useMemo)(()=>{let n=[];return t?(t.forEach(t=>{let r=e.getComponentByUUID(t);r&&n.push((0,cy.jsx)(ny,{component:r},r.uuid))}),n):null},[t,e]);return(0,cy.jsx)(`div`,{className:ay.container,children:n})},ly.__docgenInfo={description:``,methods:[],displayName:`ComponentList`}})))()}var dy,fy,py;function my(){return(my=t((()=>{dy=i(),T(),R(),Rv(),zv(),Gv(),uy(),fy=o(),py=()=>{let{editor:e,engine:t}=L(),[n]=Y(e,`selectedEntityId`),r=(0,dy.useMemo)(()=>{if(n)return t.root.findEntityByUUID(n)},[t,n]);return r?(0,fy.jsxs)(fy.Fragment,{children:[(0,fy.jsx)(s,{label:`Fields`,accordion:!0,children:(0,fy.jsx)(Lv,{target:r})}),(0,fy.jsxs)(s,{label:`Components`,accordion:!0,children:[(0,fy.jsx)(ly,{entity:r}),(0,fy.jsx)(Wv,{entity:r})]})]}):null},py.__docgenInfo={description:``,methods:[],displayName:`EntityProperty`}})))()}var hy,gy,_y;function vy(){return(vy=t((()=>{hy=`ExportControl__exportControl___LmV4c`,gy=`ExportControl__exportControl_inner___LmV4c`,_y={exportControl:hy,exportControl_inner:gy,export:`ExportControl__export___LmV4c`}})))()}var yy,by,xy;function Sy(){return(Sy=t((()=>{yy=i(),T(),R(),vy(),by=o(),xy=()=>{let{editor:e}=L(),[t,n]=(0,yy.useState)(null);return(0,yy.useEffect)(()=>{let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),(0,by.jsx)(`div`,{className:_y.exportControl,children:(0,by.jsx)(`div`,{className:_y.exportControl_inner,children:(0,by.jsx)(s,{label:`MP4`,accordion:!0,children:(0,by.jsx)(`div`,{className:_y.export,children:(0,by.jsx)(c,{onClick:()=>{e.isExporting||e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})})})})})},xy.__docgenInfo={description:``,methods:[],displayName:`ExportControl`}})))()}var Cy,wy;function Ty(){return(Ty=t((()=>{Cy=i(),wy=(0,Cy.createContext)(null)})))()}var Ey,Dy;function Oy(){return(Oy=t((()=>{Ey=i(),Ty(),Dy=()=>{let e=(0,Ey.useContext)(wy);if(e===null)throw Error(`useOREngine must be used within a OREngineProvider`);return e}})))()}var ky,Ay,jy,My,Ny,Py,Fy,Iy,Ly,Ry,zy,By,Vy,Hy,Uy,Wy,Gy,Ky,qy;function Jy(){return(Jy=t((()=>{ky=`GPUTimer__container___LmNvb`,Ay=`GPUTimer__headerRow___LmNvb`,jy=`GPUTimer__totalTime___LmNvb`,My=`GPUTimer__toggleButton___LmNvb`,Ny=`GPUTimer__controls___LmNvb`,Py=`GPUTimer__control___LmNvb`,Fy=`GPUTimer__controlLabel___LmNvb`,Iy=`GPUTimer__select___LmNvb`,Ly=`GPUTimer__input___LmNvb`,Ry=`GPUTimer__group___LmNvb`,zy=`GPUTimer__item___LmNvb`,By=`GPUTimer__clickable___LmNvb`,Vy=`GPUTimer__itemRow___LmNvb`,Hy=`GPUTimer__itemName___LmNvb`,Uy=`GPUTimer__itemTime___LmNvb`,Wy=`GPUTimer__itemStats___LmNvb`,Gy=`GPUTimer__progressBar___LmNvb`,Ky=`GPUTimer__progressFill___LmNvb`,qy={container:ky,headerRow:Ay,totalTime:jy,toggleButton:My,controls:Ny,control:Py,controlLabel:Fy,select:Iy,input:Ly,group:Ry,item:zy,clickable:By,itemRow:Vy,itemName:Hy,itemTime:Uy,itemStats:Wy,progressBar:Gy,progressFill:Ky}})))()}var Yy,Xy;function Zy(){return(Zy=t((()=>{Yy=class{buffer;index;size;filled;constructor(e){this.size=e,this.buffer=Array(e),this.index=0,this.filled=!1}push(e){this.buffer[this.index]=e,this.index=(this.index+1)%this.size,!this.filled&&this.index===0&&(this.filled=!0)}getAverage(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=0;for(let n=0;n<e;n++)t+=this.buffer[n];return t/e}getMax(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]>t&&(t=this.buffer[n]);return t}getMin(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]<t&&(t=this.buffer[n]);return t}getCount(){return this.filled?this.size:this.index}},Xy=class{buffers;windowSize;currentData;constructor(e=30){this.windowSize=e,this.buffers=new Map,this.currentData=new Map}update(e){let t=performance.now();for(let n=0;n<e.length;n++){let r=e[n],i=r.name.split(`/`),a=i[0]||`unknown`,o,s=i[i.length-1],c=s&&s.match(/\[([^\]]+)\]/);c&&(o=c[1]);let l={name:r.name,duration:r.duration,timestamp:t,renderType:a},u=this.buffers.get(r.name);u||(u=new Yy(this.windowSize),this.buffers.set(r.name,u)),u.push(r.duration),this.currentData.set(r.name,{...l,entityId:o})}}getStatistics(){let e=[],t=0,n=performance.now(),r=[];return this.currentData.forEach((e,t)=>{n-e.timestamp>1e3&&r.push(t)}),r.forEach(e=>{this.currentData.delete(e)}),this.currentData.forEach(e=>{t+=e.duration}),this.currentData.forEach(n=>{let r=this.buffers.get(n.name);r&&e.push({name:n.name,renderType:n.renderType,entityId:n.entityId,current:n.duration,avg:r.getAverage(),max:r.getMax(),min:r.getMin(),samples:r.getCount(),percentage:t>0?n.duration/t*100:0})}),e}getTotalTime(){let e=0;return this.currentData.forEach(t=>{e+=t.duration}),e}}})))()}var Qy,X,$y,eb,tb,nb;function rb(){return(rb=t((()=>{Qy=i(),Oy(),R(),Jy(),Zy(),X=o(),$y=e=>{if(e<2){let t=e/2;return`rgb(${Math.floor(100+t*100)}, 200, 100)`}if(e<5){let t=(e-2)/3;return`rgb(200, ${Math.floor(200-t*50)}, 100)`}if(e<10){let t=(e-5)/5;return`rgb(200, ${Math.floor(150-t*80)}, ${Math.floor(100-t*50)})`}return`rgb(200, 70, 50)`},eb=e=>e>=10?e.toFixed(1):e>=1?e.toFixed(2):e.toFixed(3),tb=e=>e.replace(/\[([^\]]{4,})\]/g,(e,t)=>`[${t.slice(0,3)}]`),nb=()=>{let{editor:e}=L(),{engine:t}=Dy(),[n,r]=(0,Qy.useState)([]),[i,a]=(0,Qy.useState)(0),[o,s]=(0,Qy.useState)(`all`),[c,l]=(0,Qy.useState)(0),[u,d]=(0,Qy.useState)(`time`),[f,p]=(0,Qy.useState)(!1),m=(0,Qy.useRef)(new Xy(30)),h=(0,Qy.useRef)(0),g=(0,Qy.useRef)(!1),_=(0,Qy.useRef)(0),v=(0,Qy.useCallback)(n=>{if(!n)return;let r=t.root.findEntityByUUID(n);r&&e.selectEntity(r)},[t,e]);(0,Qy.useEffect)(()=>{let e=t.renderer,n=m.current,i=e=>{f&&(n.update(e),g.current=!0)},o=e=>{g.current&&e-_.current>=300&&(r(n.getStatistics()),a(n.getTotalTime()),g.current=!1,_.current=e),h.current=requestAnimationFrame(o)};return e.on(`timer`,i),h.current=requestAnimationFrame(o),()=>{e.off(`timer`,i),cancelAnimationFrame(h.current)}},[t,f]);let y=n.filter(e=>!(o!==`all`&&e.renderType!==o||e.avg<c)),b=Array.from(new Set(n.map(e=>e.renderType))),x=[...y].sort((e,t)=>u===`time`?t.avg-e.avg:e.name.localeCompare(t.name)),S=i>0?Math.floor(1e3/i):0;return(0,X.jsxs)(`div`,{className:qy.container,children:[(0,X.jsxs)(`div`,{className:qy.headerRow,children:[(0,X.jsxs)(`span`,{className:qy.totalTime,children:[eb(i),`ms (`,S,`fps)`]}),(0,X.jsx)(`button`,{className:qy.toggleButton,onClick:()=>p(!f),title:f?`Stop timer`:`Start timer`,children:f?`⏸`:`▶`})]}),(0,X.jsxs)(`div`,{className:qy.controls,children:[(0,X.jsxs)(`div`,{className:qy.control,children:[(0,X.jsx)(`span`,{className:qy.controlLabel,children:`Type`}),(0,X.jsxs)(`select`,{className:qy.select,value:o,onChange:e=>s(e.target.value),children:[(0,X.jsx)(`option`,{value:`all`,children:`All`}),b.map(e=>(0,X.jsx)(`option`,{value:e,children:e},e))]})]}),(0,X.jsxs)(`div`,{className:qy.control,children:[(0,X.jsx)(`span`,{className:qy.controlLabel,children:`Min`}),(0,X.jsx)(`input`,{className:qy.input,type:`number`,min:`0`,step:`0.1`,value:c,onChange:e=>l(parseFloat(e.target.value)||0)})]}),(0,X.jsxs)(`div`,{className:qy.control,children:[(0,X.jsx)(`span`,{className:qy.controlLabel,children:`Sort`}),(0,X.jsxs)(`select`,{className:qy.select,value:u,onChange:e=>d(e.target.value),children:[(0,X.jsx)(`option`,{value:`time`,children:`Time`}),(0,X.jsx)(`option`,{value:`name`,children:`Name`})]})]})]}),(0,X.jsx)(`div`,{className:qy.group,children:x.map((e,t)=>{let n=$y(e.avg),r=i>0?e.avg/i*100:0,a=!!e.entityId;return(0,X.jsxs)(`div`,{className:`${qy.item} ${a?qy.clickable:``}`,onClick:()=>v(e.entityId),children:[(0,X.jsxs)(`div`,{className:qy.itemRow,children:[(0,X.jsx)(`span`,{className:qy.itemName,title:e.name,children:tb(e.name)}),(0,X.jsx)(`span`,{className:qy.itemTime,style:{color:n},children:eb(e.avg)}),(0,X.jsx)(`span`,{className:qy.itemStats,children:eb(e.max)})]}),(0,X.jsx)(`div`,{className:qy.progressBar,children:(0,X.jsx)(`div`,{className:qy.progressFill,style:{width:`${r}%`,backgroundColor:n}})})]},e.name+t)})})]})},nb.__docgenInfo={description:``,methods:[],displayName:`Timer`}})))()}var ib,ab,ob,sb,cb,lb,ub,db,fb,pb,mb,hb,gb;function _b(){return(_b=t((()=>{ib=`HierarchyNode__node___Lm5vZ`,ab=`HierarchyNode__self_name___Lm5vZ`,ob=`HierarchyNode__self_name_input___Lm5vZ`,sb=`HierarchyNode__icon___Lm5vZ`,cb=`HierarchyNode__selectable___Lm5vZ`,lb=`HierarchyNode__self___Lm5vZ`,ub=`HierarchyNode__visibility___Lm5vZ`,db=`HierarchyNode__menu___Lm5vZ`,fb=`HierarchyNode__fold___Lm5vZ`,pb=`HierarchyNode__fold_button___Lm5vZ`,mb=`HierarchyNode__child___Lm5vZ`,hb=`HierarchyNode__child_line___Lm5vZ`,gb={node:ib,self_name:ab,self_name_input:ob,icon:sb,selectable:cb,self:lb,visibility:ub,menu:db,fold:fb,fold_button:pb,child:mb,child_line:hb}})))()}var vb,yb,bb;function xb(){return(xb=t((()=>{vb=i(),F(),T(),Ea(),R(),zv(),_b(),yb=o(),bb=e=>{let{editor:t,engine:n}=L(),[r]=Y(t,`selectedEntityId`),i=r!==void 0&&n.root.findEntityByUUID(r),o=!!(i&&i.uuid==e.entity.uuid),[s]=Y(e.entity,`name`),[c,u]=Y(e.entity,`visible`),[f,m]=Y(t,`unselectableEntityIds`),[h]=Y(e.entity,`children`),_=!(f||[]).includes(e.entity.uuid),y=(h||[]).map(e=>n.root.findEntityByUUID(e)).filter(e=>e!==void 0),b=e.depth||0,x=y&&y.concat().sort((e,t)=>e.name.localeCompare(t.name))||[],S=x.length>0,C=b*20,ee=e.entity.initiator==`script`,te=(0,vb.useMemo)(()=>e.entity.getComponent(Ut)?(0,yb.jsx)(p,{size:14}):e.entity.getComponent(zt)?(0,yb.jsx)(l,{size:14}):e.entity.getComponent(N)?(0,yb.jsx)(g,{size:14}):null,[e.entity]),ne=e.openNodes.has(e.entity.uuid),T=(0,vb.useCallback)(t=>{e.setNodeOpen(e.entity.uuid,!ne),t.stopPropagation()},[ne,e]),E=(0,vb.useCallback)(()=>{t&&t.selectEntity(e.entity)},[t,e.entity]),re=(0,vb.useCallback)(e=>{e.stopPropagation(),u&&u(!c)},[c,u]),ae=(0,vb.useCallback)(t=>{t.stopPropagation();let n=new Set(f||[]);_?n.add(e.entity.uuid):n.delete(e.entity.uuid),m(Array.from(n))},[_,f,m,e.entity.uuid]),[D,oe]=(0,vb.useState)(null),le=(0,vb.useRef)(!1),ue=(0,vb.useCallback)(()=>{ee||oe(e.entity.name)},[ee,e.entity]);(0,vb.useEffect)(()=>{let n=t=>{t===e.entity&&ue()};return t.on(`request/renameEntity`,n),()=>{t.off(`request/renameEntity`,n)}},[t,e.entity,ue]);let de=(0,vb.useCallback)(e=>{e.key===`Enter`&&e.currentTarget.blur(),e.key===`Escape`&&(le.current=!0,e.currentTarget.blur())},[]),fe=(0,vb.useCallback)(()=>{let n=le.current;if(le.current=!1,oe(null),n||D===null)return;let r=D.trim();r!==``&&r!==e.entity.name&&t.api.setField(e.entity,`name`,r)},[D,t,e.entity]),{open:pe,closeAll:me}=w(),he=Ta(e.entity),ge=(0,vb.useCallback)(n=>{if(n.preventDefault(),!t||ee)return;t.selectEntity(e.entity);let r=[{label:`Add Entity`,children:he}];e.entity.parent&&r.push({label:`Duplicate`,onClick:()=>{let n=t.api.duplicateEntity(e.entity);t.selectEntity(n),me()}}),r.push({label:`Rename`,onClick:()=>{t.emit(`request/renameEntity`,[e.entity]),me()}},{label:`Delete Entity`,onClick:()=>{t.api.deleteEntity(e.entity),me()}}),pe((0,yb.jsx)(ce,{title:e.entity.name,items:r}),ie(n.clientX,n.clientY))},[t,e.entity,pe,me,ee,he]),_e=(0,yb.jsx)(`p`,{children:s||`-`});return D!==null&&(_e=(0,yb.jsx)(`input`,{className:gb.self_name_input,value:D,autoFocus:!0,onChange:e=>oe(e.target.value),onFocus:e=>e.currentTarget.select(),onKeyDown:de,onBlur:fe,onClick:e=>e.stopPropagation()})),(0,yb.jsxs)(`div`,{className:gb.node,"data-no_export":ee,children:[(0,yb.jsxs)(se,{className:gb.self,style:{paddingLeft:C},onClick:E,onContextMenu:ge,selected:o,children:[(0,yb.jsx)(`div`,{className:gb.fold,"data-hnode_open":ne,children:S&&(0,yb.jsx)(`button`,{className:gb.fold_button,onClick:T,children:(0,yb.jsx)(a,{open:ne})})}),te&&(0,yb.jsx)(`div`,{className:gb.icon,children:te}),(0,yb.jsx)(`div`,{className:gb.self_name,onDoubleClick:ue,children:_e}),(0,yb.jsx)(`button`,{className:gb.selectable,onClick:ae,"data-selectable":_,children:(0,yb.jsx)(v,{size:14,selectable:_})}),(0,yb.jsx)(`button`,{className:gb.visibility,onClick:re,"data-visible":c!==!1,children:(0,yb.jsx)(d,{size:14,visible:c!==!1})}),!ee&&(0,yb.jsx)(`button`,{className:gb.menu,onClick:ge,children:`⋯`})]}),S&&(0,yb.jsxs)(`div`,{className:gb.child,"data-open":ne,children:[x.map(t=>(0,yb.jsx)(bb,{entity:t,depth:b+1,openNodes:e.openNodes,setNodeOpen:e.setNodeOpen},t.uuid)),(0,yb.jsx)(`div`,{className:gb.child_line,style:{marginLeft:C+4}})]})]})},bb.__docgenInfo={description:``,methods:[],displayName:`HierarchyNode`,props:{depth:{required:!1,tsType:{name:`number`},description:``},entity:{required:!0,tsType:{name:`MXP.Entity`},description:``},openNodes:{required:!0,tsType:{name:`Set`,elements:[{name:`string`}],raw:`Set<string>`},description:``},setNodeOpen:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( uuid: string, open: boolean ) => void`,signature:{arguments:[{type:{name:`string`},name:`uuid`},{type:{name:`boolean`},name:`open`}],return:{name:`void`}}},description:``}}}})))()}var Sb;function Cb(){return(Cb=t((()=>{Sb={}})))()}var wb,Tb,Eb,Db,Ob,kb;function Ab(){return(Ab=t((()=>{wb=i(),R(),zv(),xb(),Cb(),Tb=o(),Eb=`hierarchyOpenNodes`,Db=()=>{try{let e=localStorage.getItem(Eb);if(e)return new Set(JSON.parse(e))}catch{}return new Set},Ob=e=>{localStorage.setItem(Eb,JSON.stringify(Array.from(e)))},kb=()=>{let{editor:e,engine:t}=L(),[n]=Y(e,`selectedEntityId`),r=t.root,[i,a]=(0,wb.useState)(Db),o=(0,wb.useCallback)((e,t)=>{a(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),Ob(r),r})},[]);return(0,wb.useEffect)(()=>{if(!n)return;let e=r.findEntityByUUID(n);if(!e)return;let t=[],i=e.parent;for(;i;)t.push(i.uuid),i=i.parent;a(e=>{if(t.every(t=>e.has(t)))return e;let n=new Set(e);return t.forEach(e=>n.add(e)),Ob(n),n})},[n,r]),(0,Tb.jsx)(`div`,{className:Sb.hierarchy,children:r&&(0,Tb.jsx)(bb,{entity:r,openNodes:i,setNodeOpen:o})})},kb.__docgenInfo={description:``,methods:[],displayName:`Hierarchy`}})))()}var jb,Mb,Nb,Pb;function Fb(){return(Fb=t((()=>{jb=i(),T(),R(),Mb=o(),Nb=[{label:`Position`,paths:[`position`]},{label:`Rotation`,paths:[`euler`]},{label:`Scale`,paths:[`scale`]},{label:`All`,paths:[`position`,`euler`,`scale`]}],Pb=()=>{let{editor:e}=L(),{open:t,closeAll:n}=w(),[r,i]=(0,jb.useState)(null),a=(0,jb.useRef)({x:0,y:0});return(0,jb.useEffect)(()=>{let e=e=>{a.current.x=e.clientX,a.current.y=e.clientY};return window.addEventListener(`pointermove`,e),()=>{window.removeEventListener(`pointermove`,e)}},[]),(0,jb.useEffect)(()=>{let r=r=>{n();let i=[];for(let t of Nb)i.push({label:t.label,onClick:()=>{let i=[];for(let e of t.paths)i.push({target:r,path:e});e.insertKeys(i),n()}});t((0,Mb.jsx)(ce,{title:`Insert Keyframe`,items:i}),ie(a.current.x,a.current.y))},o=e=>{i({text:e,anchor:ie(a.current.x,a.current.y)})};return e.on(`request/insertKeyMenu`,r),e.on(`message`,o),()=>{e.off(`request/insertKeyMenu`,r),e.off(`message`,o)}},[e,t,n]),r?(0,Mb.jsx)(ae,{title:`Keyframe`,anchor:r.anchor,onClose:()=>i(null),children:r.text}):null},Pb.__docgenInfo={description:``,methods:[],displayName:`KeyFrame`}})))()}var Ib,Lb;function Rb(){return(Rb=t((()=>{Ib=`Canvas__container___LmNvb`,Lb={container:Ib}})))()}var zb,Bb,Vb;function Hb(){return(Hb=t((()=>{zb=i(),R(),Rb(),Bb=o(),Vb=({viewportId:e})=>{let{engine:t,editor:n}=L(),r=(0,zb.useRef)(null);return(0,zb.useEffect)(()=>{let i=r.current;if(!t||!i)return;let a=n.createViewport(e,i);return()=>{a.dispose()}},[t,n,e]),(0,Bb.jsx)(`div`,{className:Lb.container,role:`presentation`,"aria-label":`3D Canvas`,children:(0,Bb.jsx)(`canvas`,{ref:r})})},Vb.__docgenInfo={description:``,methods:[],displayName:`Canvas`}})))()}var Ub,Wb;function Gb(){return(Gb=t((()=>{Ub=`AudioView__audioView___LmF1Z`,Wb={audioView:Ub}})))()}var Kb;function qb(){return(qb=t((()=>{ot(),A(),Kb=class extends nt{wrapperElm;canvas;canvasCtx;viewRangeFrame;viewPort;viewPortRange;musicBuffer;resizeObserver;frameSetting;framePlay;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0];let e=window.localStorage.getItem(`audioViweRange`);this.viewRangeFrame=e?Number(e):2,this.frameSetting={duration:0,fps:60},this.framePlay={current:0,playing:!1},this.musicBuffer=null,this.resizeObserver=new ResizeObserver(this.onResize.bind(this))}onResize(){if(this.wrapperElm){let e=new O(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);this.canvas.width=e.x,this.canvas.height=e.y}this.render()}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.musicBuffer){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)]*1,s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]*1+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}this.canvasCtx.fillStyle=`#555`,this.canvasCtx.fillRect(this.canvas.width/2,0,1,this.canvas.height)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.canvas),this.onResize()}setFramePlaying(e){this.framePlay=e,this.viewPort=[this.framePlay.current-this.viewRangeFrame,0,this.framePlay.current+this.viewRangeFrame,0],this.viewPortRange=[this.viewPort[2]-this.viewPort[0],this.viewPort[3]-this.viewPort[1]],this.render()}setViewRangeFrame(e){this.viewRangeFrame=e,this.setFramePlaying(this.framePlay),localStorage.setItem(`audioViweRange`,String(this.viewRangeFrame))}setFrameSetting(e){this.frameSetting=e,this.render()}setMusicBuffer(e){this.musicBuffer=e,this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.canvas),this.resizeObserver.disconnect()}},Kb.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setFramePlaying`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`FramePlay`,alias:`FramePlay`}}],returns:null},{name:`setViewRangeFrame`,docblock:null,modifiers:[],params:[{name:`rangeFrame`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frameSetting`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`AudioViewRenderer`}})))()}var Jb,Yb,Xb;function Zb(){return(Zb=t((()=>{Jb=i(),R(),Gb(),qb(),Yb=o(),Xb=()=>{let{editor:e}=L(),t=(0,Jb.useRef)(null),[n,r]=(0,Jb.useState)();(0,Jb.useEffect)(()=>{let e=new Kb;if(r(e),t.current)return e.setWrapperElm(t.current),()=>{e.dispose()}},[]);let i=e&&e.audioBuffer,[a,o]=(0,Jb.useState)(),[s,c]=(0,Jb.useState)({duration:0,fps:0}),[l,u]=(0,Jb.useState)({current:0,playing:!1});(0,Jb.useEffect)(()=>{if(!e)return;let t=e.engine,n=e=>{c({duration:e[`timeline/duration`],fps:e[`timeline/fps`]})},r=0,i=()=>{o(r++)},a=e=>{u({...e})};return n(t.serialize()),a(t.frame),t.on(`fields/update`,n),t.on(`update/music`,i),t.on(`update/frame/play`,a),()=>{t.off(`update/frame/setting`,n),t.off(`update/music`,i),t.off(`update/frame/play`,a)}},[e]),(0,Jb.useEffect)(()=>{n&&i&&n.setMusicBuffer(i)},[n,i,a]),(0,Jb.useEffect)(()=>{n&&l&&n.setFramePlaying(l)},[n,l]),(0,Jb.useEffect)(()=>{n&&s&&n.setFrameSetting(s)},[n,s]);let d=(0,Jb.useCallback)(e=>{if(n){let t=e.deltaY>0?1.1:.9;n.setViewRangeFrame(n.viewRangeFrame*t)}e.preventDefault()},[n]);return(0,Jb.useEffect)(()=>{let e=t.current;return e&&e.addEventListener(`wheel`,d,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,d)}},[d]),(0,Yb.jsx)(`div`,{className:Wb.audioView,ref:t})},Xb.__docgenInfo={description:``,methods:[],displayName:`AudioView`}})))()}var Qb,$b,ex;function tx(){return(tx=t((()=>{Qb=`CameraPad__cameraPad___LmNhb`,$b=`CameraPad__btn___LmNhb`,ex={cameraPad:Qb,btn:$b}})))()}var nx,rx;function ix(){return(ix=t((()=>{R(),zv(),tx(),nx=o(),rx=({viewportId:e})=>{let{editor:t}=L(),[n]=Y(t,`selectedEntityId`),[r]=Y(t,`viewports/${e}/cameraView`);return(0,nx.jsxs)(`div`,{className:ex.cameraPad,children:[(0,nx.jsx)(`div`,{className:ex.btn,"data-disabled":!n,onClick:()=>{n&&t.focusSelected()},title:`Focus selected ( . )`,children:`Focus`}),(0,nx.jsx)(`div`,{className:ex.btn,"data-active":r===`camera`,onClick:()=>{t.toggleCameraView()},title:`Toggle scene camera view ( 0 )`,children:`Scene Cam`})]})},rx.__docgenInfo={description:``,methods:[],displayName:`CameraPad`}})))()}var ax,ox,sx,cx,lx,ux,dx,fx,px,mx,hx,gx,_x,vx,yx,bx,xx,Sx,Cx,wx,Tx,Z;function Ex(){return(Ex=t((()=>{ax=`Screen__screen___LnNjc`,ox=`Screen__header___LnNjc`,sx=`Screen__header_tabs___LnNjc`,cx=`Screen__header_tab___LnNjc`,lx=`Screen__header_right___LnNjc`,ux=`Screen__header_item___LnNjc`,dx=`Screen__content___LnNjc`,fx=`Screen__gizmoMode___LnNjc`,px=`Screen__gizmoMode_btn___LnNjc`,mx=`Screen__gizmoMode_separator___LnNjc`,hx=`Screen__modalStatus___LnNjc`,gx=`Screen__canvas___LnNjc`,_x=`Screen__audioViewHandle___LnNjc`,vx=`Screen__audioView___LnNjc`,yx=`Screen__displayOptions___LnNjc`,bx=`Screen__displayOptions_btn___LnNjc`,xx=`Screen__overlay___LnNjc`,Sx=`Screen__overlay_field___LnNjc`,Cx=`Screen__overlay_label___LnNjc`,wx=`Screen__overlay_separator___LnNjc`,Tx=`Screen__externalBtn___LnNjc`,Z={screen:ax,header:ox,header_tabs:sx,header_tab:cx,header_right:lx,header_item:ux,content:dx,gizmoMode:fx,gizmoMode_btn:px,gizmoMode_separator:mx,modalStatus:hx,canvas:gx,audioViewHandle:_x,audioView:vx,displayOptions:yx,displayOptions_btn:bx,overlay:xx,overlay_field:Sx,overlay_label:Cx,overlay_separator:wx,externalBtn:Tx}})))()}var Dx,Q,Ox,kx;function Ax(){return(Ax=t((()=>{Dx=i(),T(),we(),R(),pa(),Hb(),ia(),zv(),Zb(),ix(),Ex(),Q=o(),Ox=`viewport`,kx=({viewportId:e})=>{let{editor:t}=L(),n=Ce(),[r,i]=Y(t,`enableRender`),[a,o]=Y(t,`viewports/${e}/preview`),[s,l]=Y(t,`viewType`),[u,d]=Y(t,`viewports/${e}/resolutionScale`),[f,p]=Y(t,`gizmoMode`),[m,h]=Y(t,`transformOrientation`),[g]=Y(t,`modalStatus`),[_,v]=Y(t,`viewports/${e}/helpers/show`),[y,b]=Y(t,`viewports/${e}/helpers/empty`),[x,S]=Y(t,`viewports/${e}/helpers/camera`),[C,w]=Y(t,`viewports/${e}/helpers/light`),[ee,te]=Y(t,`viewports/${e}/helpers/grid`),[ne,T]=Y(t,`viewports/${e}/helpers/wireframe`),[E,re]=Y(t,`viewports/${e}/helpers/gizmo`),[ie,ae]=Y(t,`viewports/${e}/helpers/outline`),[oe]=fa(`showAudioView`),[se,ce]=(0,Dx.useState)(50),le=(0,Dx.useRef)(null),[ue,de]=(0,Dx.useState)(!1),fe=(0,Dx.useRef)(null),pe=(0,Dx.useCallback)(e=>{fe.current&&!fe.current.contains(e.target)&&de(!1)},[]);return(0,Dx.useEffect)(()=>(ue&&document.addEventListener(`pointerdown`,pe),()=>{document.removeEventListener(`pointerdown`,pe)}),[ue,pe]),(0,Q.jsxs)(`div`,{className:Z.screen,children:[(0,Q.jsxs)(`div`,{className:Z.header,children:[(0,Q.jsx)(`div`,{className:Z.header_tabs,children:(0,Q.jsx)(`div`,{className:Z.header_tab,"data-active":!!a,onClick:()=>o&&o(!a),title:`Camera Render`,children:(0,Q.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 512 512`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,Q.jsx)(`path`,{d:`M32 144 H336 V368 H32 Z M368 224 L480 152 V360 L368 288 Z`})})})}),(0,Q.jsxs)(`div`,{className:Z.header_right,children:[(0,Q.jsx)(`div`,{className:Z.header_item,children:(0,Q.jsx)(D,{title:`View`,children:(0,Q.jsx)(ra,{value:s,format:{type:`select`,list:[`render`,`debug`]},onChange:e=>l&&l(e)})})}),(0,Q.jsx)(`div`,{className:Z.header_item,children:(0,Q.jsx)(D,{title:`Res`,children:(0,Q.jsx)(ra,{value:u,format:{type:`select`,list:[,,,,,,].fill(0).map((e,t)=>{let n=2**t,r=1/n;return{value:r,label:r==1?`1`:`1/`+n}})},onChange:e=>d&&d(e)})})}),n.isPC&&(0,Q.jsx)(`div`,{className:Z.externalBtn,children:(0,Q.jsx)(c,{onClick:()=>{t.openInExternalWindow()},children:(0,Q.jsxs)(`svg`,{width:`32`,height:`12`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,Q.jsxs)(`g`,{clipPath:`url(#clip0_224_2)`,children:[(0,Q.jsx)(`path`,{d:`M96 0V416H512V0H96ZM472 376H136V40H472V376Z`,fill:`#aaa`}),(0,Q.jsx)(`path`,{d:`M40 472V296V136V96H0V512H416V472H376H40Z`,fill:`#aaa`}),(0,Q.jsx)(`path`,{d:`M232.812 312.829L350.671 194.969V279.766H390.671V126.688H237.594V166.688H322.39L204.531 284.547L232.812 312.829Z`,fill:`#aaa`})]}),(0,Q.jsx)(`defs`,{children:(0,Q.jsx)(`clipPath`,{id:`clip0_224_2`,children:(0,Q.jsx)(`rect`,{width:`512`,height:`512`,fill:`white`})})})]})})})]})]}),(0,Q.jsxs)(`div`,{className:Z.content,children:[(0,Q.jsxs)(`div`,{className:Z.displayOptions,ref:fe,children:[(0,Q.jsx)(`div`,{className:Z.displayOptions_btn,"data-active":ue,onClick:()=>de(!ue),title:`Display Options`,children:`⚙`}),ue&&(0,Q.jsxs)(`div`,{className:Z.overlay,children:[(0,Q.jsx)(`div`,{className:Z.overlay_label,children:`Rendering`}),(0,Q.jsx)(`div`,{className:Z.overlay_field,children:(0,Q.jsx)(D,{title:`Render`,children:(0,Q.jsx)(ra,{value:r,onChange:e=>i&&i(e)})})}),(0,Q.jsx)(`div`,{className:Z.overlay_separator}),(0,Q.jsx)(`div`,{className:Z.overlay_label,children:`Helpers`}),(0,Q.jsx)(`div`,{className:Z.overlay_field,children:(0,Q.jsx)(D,{title:`Show`,children:(0,Q.jsx)(ra,{value:_,onChange:e=>v&&v(e)})})}),(0,Q.jsx)(`div`,{className:Z.overlay_field,"data-indent":`true`,children:(0,Q.jsx)(D,{title:`Empty`,children:(0,Q.jsx)(ra,{value:y,onChange:e=>b&&b(e)})})}),(0,Q.jsx)(`div`,{className:Z.overlay_field,"data-indent":`true`,children:(0,Q.jsx)(D,{title:`Camera`,children:(0,Q.jsx)(ra,{value:x,onChange:e=>S&&S(e)})})}),(0,Q.jsx)(`div`,{className:Z.overlay_field,"data-indent":`true`,children:(0,Q.jsx)(D,{title:`Light`,children:(0,Q.jsx)(ra,{value:C,onChange:e=>w&&w(e)})})}),(0,Q.jsx)(`div`,{className:Z.overlay_separator}),(0,Q.jsx)(`div`,{className:Z.overlay_field,children:(0,Q.jsx)(D,{title:`Grid`,children:(0,Q.jsx)(ra,{value:ee,onChange:e=>te&&te(e)})})}),(0,Q.jsx)(`div`,{className:Z.overlay_field,children:(0,Q.jsx)(D,{title:`Wireframe`,children:(0,Q.jsx)(ra,{value:ne,onChange:e=>T&&T(e)})})}),(0,Q.jsx)(`div`,{className:Z.overlay_field,children:(0,Q.jsx)(D,{title:`Gizmo`,children:(0,Q.jsx)(ra,{value:E,onChange:e=>re&&re(e)})})}),(0,Q.jsx)(`div`,{className:Z.overlay_field,children:(0,Q.jsx)(D,{title:`Outline`,children:(0,Q.jsx)(ra,{value:ie,onChange:e=>ae&&ae(e)})})})]})]}),(0,Q.jsxs)(`div`,{className:Z.gizmoMode,children:[[`select`,`translate`,`rotate`,`scale`].map(e=>(0,Q.jsx)(`div`,{className:Z.gizmoMode_btn,"data-active":f===e,onClick:()=>p&&p(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`select`?`↖`:e===`translate`?`T`:e===`rotate`?`R`:`S`},e)),(0,Q.jsx)(`div`,{className:Z.gizmoMode_separator}),[`global`,`local`].map(e=>(0,Q.jsx)(`div`,{className:Z.gizmoMode_btn,"data-active":m===e,onClick:()=>h&&h(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`global`?`G`:`L`},e))]}),g&&(0,Q.jsx)(`div`,{className:Z.modalStatus,children:g}),(0,Q.jsx)(`div`,{className:Z.canvas,children:(0,Q.jsx)(Vb,{viewportId:e})}),n.isSP&&(0,Q.jsx)(rx,{viewportId:e}),n.isPC&&oe&&(0,Q.jsxs)(Q.Fragment,{children:[(0,Q.jsx)(`div`,{className:Z.audioViewHandle,onPointerDown:e=>{e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),le.current={startY:e.clientY,startHeight:se}},onPointerMove:e=>{if(!le.current)return;let t=le.current.startY-e.clientY,n=Math.max(20,Math.min(400,le.current.startHeight+t));ce(n)},onPointerUp:()=>{le.current=null}}),(0,Q.jsx)(`div`,{className:Z.audioView,style:{height:se},children:(0,Q.jsx)(Xb,{})})]})]})]})},kx.__docgenInfo={description:``,methods:[],displayName:`Screen`}})))()}function jx(e,t){let n=e.get(t);if(n)return n;let r=t.indexOf(`:`);if(r===-1)return;let i=e.get(t.slice(0,r));return i?.multiple?i:void 0}function Mx(e){return e.slice(e.indexOf(`:`)+1)}function Nx(e){return e.multiple?`${e.id}:${it.genUUID()}`:e.id}function Px(e,t){return e.multiple?e.content(Mx(t)):e.content}function Fx(){return Gx(`vertical`,[{ratio:916/1076,node:Gx(`horizontal`,[{ratio:300/1912,node:Gx(`vertical`,[{ratio:696/912,node:Kx([`hierarchy`,`scene`])},{ratio:216/912,node:Kx([`timer`])}])},{ratio:1312/1912,node:Kx([`viewport:main`])},{ratio:300/1912,node:Kx([`property`,`textures`,`renderer`,`editor-settings`])}])},{ratio:160/1076,node:Kx([`timeline`,`export`])}])}function Ix(e){return e.type===`pane`?[e]:e.children.flatMap(e=>Ix(e.node))}function Lx(e,t){let n=new Set,r=new Set,i=e=>{let t=typeof e==`string`&&e!==``&&!n.has(e)?e:it.genUUID();return n.add(t),t},a=e=>{if(typeof e!=`object`||!e)return null;let n=e;if(n.type===`pane`){if(!Array.isArray(n.tabs))return null;let e=[...new Set(n.tabs.filter(e=>typeof e==`string`))].filter(e=>{let n=t(e);return n?!n.multiple||!r.has(e)&&(r.add(e),!0):!1});if(e.length===0)return null;let a=typeof n.active==`string`&&e.includes(n.active)?n.active:e[0];return{type:`pane`,id:i(n.id),tabs:e,active:a}}if(n.type===`split`){if(n.direction!==`horizontal`&&n.direction!==`vertical`||!Array.isArray(n.children))return null;let e=[];return n.children.forEach(t=>{if(typeof t!=`object`||!t)return;let n=t,r=a(n.node);if(!r)return;let i=typeof n.ratio==`number`&&isFinite(n.ratio)&&n.ratio>0?n.ratio:1;e.push({ratio:i,node:r})}),e.length===0?null:e.length===1?e[0].node:{type:`split`,id:i(n.id),direction:n.direction,children:e}}return null},o=a(e);return o?qx(o):null}function Rx(e,t,n){return Jx(e,t,e=>e.type!==`pane`||!e.tabs.includes(n)?e:{...e,active:n})}function zx(e,t){let n=e;for(let r of Ix(e))for(let e of t)r.tabs.includes(e)&&r.active!==e&&(n=Rx(n,r.id,e));return n}function Bx(e,t,n,r){return Jx(e,t,e=>{if(e.type!==`pane`||e.tabs.includes(n))return e;let t=[...e.tabs];return t.splice(Math.max(0,Math.min(r??t.length,t.length)),0,n),{...e,tabs:t,active:n}})}function Vx(e,t,n,r,i){if(t===r)return Jx(e,t,e=>{if(e.type!==`pane`)return e;let t=e.tabs.indexOf(n);if(t===-1)return e;let r=e.tabs.filter(e=>e!==n),a=i??e.tabs.length,o=Math.max(0,Math.min(t<a?a-1:a,r.length));return o===t?e:(r.splice(o,0,n),{...e,tabs:r,active:n})});let a=Ix(e),o=a.find(e=>e.id===t),s=a.find(e=>e.id===r);return!o||!s||!o.tabs.includes(n)||s.tabs.includes(n)?e:Bx(Ux(e,t,n),r,n,i)}function Hx(e,t,n,r,i){let a=Ix(e),o=a.find(e=>e.id===r);if(!o||!o.tabs.includes(i)||!a.some(e=>e.id===t)||r===t&&o.tabs.length===1)return e;let s=Ux(e,r,i),c={type:`pane`,id:it.genUUID(),tabs:[i],active:i},l=Jx(s,t,e=>{let t=[{ratio:.5,node:c},{ratio:.5,node:e}];return(n===`right`||n===`bottom`)&&t.reverse(),{type:`split`,id:it.genUUID(),direction:n===`left`||n===`right`?`horizontal`:`vertical`,children:t}});return l===s?e:qx(l)??e}function Ux(e,t,n){let r=Jx(e,t,e=>{if(e.type!==`pane`||!e.tabs.includes(n))return e;let t=e.tabs.indexOf(n),r=e.tabs.filter(e=>e!==n),i=e.active!==n||r.length===0?e.active:r[Math.min(t,r.length-1)];return{...e,tabs:r,active:i}});return r===e?e:qx(r)??e}function Wx(e,t,n){return Jx(e,t,e=>e.type!==`split`||e.children.length!==n.length?e:{...e,children:e.children.map((e,t)=>({...e,ratio:n[t]}))})}var Gx,Kx,qx,Jx;function Yx(){return(Yx=t((()=>{ot(),Gx=(e,t)=>({type:`split`,id:it.genUUID(),direction:e,children:t}),Kx=e=>({type:`pane`,id:it.genUUID(),tabs:e,active:e[0]}),qx=e=>{if(e.type===`pane`)return e.tabs.length>0?e:null;let t=[];if(e.children.forEach(n=>{let r=qx(n.node);r&&(r.type===`split`&&r.direction===e.direction?r.children.forEach(e=>t.push({ratio:n.ratio*e.ratio,node:e.node})):t.push(r===n.node?n:{...n,node:r}))}),t.length===0)return null;if(t.length===1)return t[0].node;let n=t.reduce((e,t)=>e+t.ratio,0);return Math.abs(n-1)>1e-6?{...e,children:t.map(e=>({...e,ratio:e.ratio/n}))}:t.length!==e.children.length||t.some((t,n)=>t!==e.children[n])?{...e,children:t}:e},Jx=(e,t,n)=>{if(e.id===t)return n(e);if(e.type===`split`){let r=!1,i=e.children.map(e=>{let i=Jx(e.node,t,n);return i===e.node?e:(r=!0,{...e,node:i})});if(r)return{...e,children:i}}return e}})))()}function Xx(e,t,n){let[r,i]=(0,Zx.useState)(null),a=(0,Zx.useRef)(e);a.current=e;let o=(0,Zx.useRef)(t);o.current=t;let s=(0,Zx.useRef)(null);return(0,Zx.useEffect)(()=>()=>s.current?.(),[]),{dragState:r,onTabPointerDown:(e,t,r)=>{if(r.button!==0||s.current)return;let c=r.clientX,l=r.clientY,u=!1,d=null,f=r=>{if(r.buttons===0){p(!1);return}if(!u){if(Math.hypot(r.clientX-c,r.clientY-l)<Qx)return;u=!0,i({panelId:t,title:n(t)?.title??t,startX:r.clientX,startY:r.clientY,target:null})}let o=nS(r.clientX,r.clientY,a.current,e,t);rS(o,d)||(d=o,i(e=>e&&{...e,target:o}))},p=n=>{if(g(),n&&u&&d){let n=a.current;d.kind===`tabs`?o.current(Vx(n,e,t,d.paneId,d.index)):d.zone===`center`?o.current(Vx(n,e,t,d.paneId)):o.current(Hx(n,d.paneId,d.zone,e,t))}u&&i(null)},m=()=>p(!0),h=()=>p(!1),g=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),s.current=null};s.current=g,window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h)}}}var Zx,Qx,$x,eS,tS,nS,rS;function iS(){return(iS=t((()=>{Zx=i(),Yx(),Qx=4,$x=.25,eS=(e,t)=>{let n={left:e.left,top:e.top,width:e.width,height:e.height};return(t===`left`||t===`right`)&&(n.width/=2),t===`right`&&(n.left+=n.width),(t===`top`||t===`bottom`)&&(n.height/=2),t===`bottom`&&(n.top+=n.height),n},tS=(e,t,n,r,i)=>{if(n.id!==r&&n.tabs.includes(i))return null;let a=[...t.querySelectorAll(`[data-panel-tab-id]`)].filter(e=>e instanceof HTMLElement),o=a.length;for(let t=0;t<a.length;t++){let n=a[t].getBoundingClientRect();if(e<n.left+n.width/2){o=t;break}}let s=t.getBoundingClientRect(),c=o<a.length?a[o].getBoundingClientRect().left:a.length>0?a[a.length-1].getBoundingClientRect().right:s.left;return{kind:`tabs`,paneId:n.id,index:o,rect:{left:c-1,top:s.top,width:2,height:s.height}}},nS=(e,t,n,r,i)=>{let a=document.elementFromPoint(e,t);if(!a)return null;let o=a.closest(`[data-pane-id]`);if(!(o instanceof HTMLElement))return null;let s=Ix(n).find(e=>e.id===o.dataset.paneId);if(!s)return null;let c=a.closest(`[data-panel-tab-header]`);if(c instanceof HTMLElement)return tS(e,c,s,r,i);let l=o.querySelector(`[data-panel-content]`);if(!(l instanceof HTMLElement))return null;let u=l.getBoundingClientRect();if(u.width<=0||u.height<=0)return null;let d=(e-u.left)/u.width,f=(t-u.top)/u.height;if(d<0||d>1||f<0||f>1)return null;if(Math.min(d,1-d)>$x&&Math.min(f,1-f)>$x)return s.id===r||s.tabs.includes(i)?null:{kind:`zone`,paneId:s.id,zone:`center`,rect:eS(u,`center`)};if(s.id===r&&s.tabs.length===1)return null;let p=d-.5,m=f-.5,h=Math.abs(p)>=Math.abs(m)?p<0?`left`:`right`:m<0?`top`:`bottom`;return{kind:`zone`,paneId:s.id,zone:h,rect:eS(u,h)}},rS=(e,t)=>e===null||t===null?e===t:e.paneId===t.paneId?e.kind===`tabs`&&t.kind===`tabs`?e.index===t.index:e.kind===`zone`&&t.kind===`zone`&&e.zone===t.zone:!1})))()}var aS,oS;function sS(){return(sS=t((()=>{aS=`PanelLayout__pane___LnBhb`,oS={pane:aS}})))()}function cS(e,t){let n=[];for(let r of e){let e=n;if(r.category)for(let t of r.category.split(`/`)){if(t===``)continue;let n;for(let r of e)if(r.label===t&&`children`in r){n=r;break}n||(n={label:t,children:[]},e.push(n)),e=n.children}e.push({label:r.title,onClick:()=>t(r)})}return n}var lS,uS,dS,fS;function pS(){return(pS=t((()=>{lS=i(),T(),R(),Ax(),zv(),de(),iS(),sS(),Yx(),uS=o(),dS=e=>{let t=e.node;if(t.type===`split`)return(0,uS.jsx)(oe,{direction:t.direction,ratios:t.children.map(e=>e.ratio),onRatiosChange:n=>e.onRatiosChange(t.id,n),children:t.children.map(t=>(0,uS.jsx)(oe.Item,{children:(0,uS.jsx)(dS,{...e,node:t.node})},t.node.id))});let n=t.tabs.flatMap(t=>{let n=e.resolve(t);return n?[{id:t,title:n.title,content:Px(n,t)}]:[]});if(n.length===0)return null;let r=e.hasAddable(t);return(0,uS.jsx)(`div`,{className:oS.pane,"data-pane-id":t.id,children:(0,uS.jsx)(ue,{tabs:n,active:t.active,onSelect:n=>e.onSelectTab(t.id,n),onTabContextMenu:(n,r)=>e.onTabContextMenu(t.id,n,r),onTabPointerDown:(n,r)=>e.onTabPointerDown(t.id,n,r),onAddClick:r?n=>e.onAddTab(t.id,n):void 0})})},fS=e=>{let{editor:t}=L(),{open:n,closeAll:r}=w(),i=(0,lS.useMemo)(()=>{let t=new Map;return e.panels.forEach(e=>t.set(e.id,e)),t},[e.panels]),a=(0,lS.useMemo)(()=>e=>jx(i,e),[i]),[o,s]=Y(t,`panelLayout`),c=(0,lS.useMemo)(()=>Lx(o,a)??Fx(),[o,a]);(0,lS.useEffect)(()=>{let e=new Set(Ix(c).flatMap(e=>e.tabs).filter(e=>a(e)?.id===Ox).map(Mx));t.pruneViewportSettings(e)},[c,a,t]);let[l,u]=(0,lS.useState)(()=>!!t.getField(`selectedEntityId`));(0,lS.useEffect)(()=>{let e=()=>{t.getField(`selectedEntityId`)&&u(!0)};return t.on(`fields/update/selectedEntityId`,e),()=>{t.off(`fields/update/selectedEntityId`,e)}},[t]);let d=e=>{e!==c&&s(e)},f=e.activateOnSelect;(0,lS.useEffect)(()=>{if(!l||(u(!1),!f))return;let e=zx(c,f);e!==c&&t.setField(`panelLayout`,e)},[l,f,c,t]);let p=(e,t)=>d(Rx(c,e,t)),m=(e,t)=>d(Wx(c,e,t)),{dragState:h,onTabPointerDown:g}=Xx(c,d,a),_=e=>[...i.values()].filter(t=>t.multiple||!e.tabs.includes(t.id));return(0,uS.jsxs)(uS.Fragment,{children:[(0,uS.jsx)(dS,{node:c,resolve:a,onSelectTab:p,onRatiosChange:m,onTabContextMenu:(e,t,i)=>{i.preventDefault(),Ix(c).reduce((e,t)=>e+t.tabs.length,0)>1&&n((0,uS.jsx)(ce,{title:a(t)?.title,items:[{label:`Close Tab`,onClick:()=>{d(Ux(c,e,t)),r()}}]}),ie(i.clientX,i.clientY))},onTabPointerDown:g,onAddTab:(e,t)=>{let i=Ix(c).find(t=>t.id===e);if(!i)return;let a=_(i);if(a.length===0)return;let o=cS(a,t=>{d(Bx(c,e,Nx(t))),r()});n((0,uS.jsx)(ce,{items:o}),ie(t.clientX,t.clientY))},hasAddable:e=>_(e).length>0}),h&&(0,uS.jsx)(fe,{drag:h})]})},fS.__docgenInfo={description:``,methods:[],displayName:`PanelLayout`,props:{panels:{required:!0,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},activateOnSelect:{required:!1,tsType:{name:`Array`,elements:[{name:`string`}],raw:`PanelId[]`},description:``}}}})))()}var mS,hS,gS;function _S(){return(_S=t((()=>{mS=`RendererSettings__renderer___LnJlb`,hS=`RendererSettings__renderer_inner___LnJlb`,gS={renderer:mS,renderer_inner:hS}})))()}var vS,yS;function bS(){return(bS=t((()=>{T(),R(),Rv(),_S(),vS=o(),yS=()=>{let{editor:e}=L(),t=e.engine.renderer;return(0,vS.jsx)(`div`,{className:gS.renderer,children:(0,vS.jsxs)(`div`,{className:gS.renderer_inner,children:[(0,vS.jsx)(s,{label:`Resolution`,accordion:!0,children:(0,vS.jsx)(Lv,{target:e,filter:`resolution`})}),(0,vS.jsx)(s,{label:`Pipeline`,accordion:!0,children:(0,vS.jsx)(Lv,{target:t,filter:`pipeline`})}),(0,vS.jsx)(s,{label:`Sky`,accordion:!0,children:(0,vS.jsx)(Lv,{target:t,filter:`sky`})})]})})},yS.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var xS,SS,CS,wS,TS,ES;function DS(){return(DS=t((()=>{xS=`SceneControl__sceneControl___LnNjZ`,SS=`SceneControl__sceneControl_inner___LnNjZ`,CS=`SceneControl__select___LnNjZ`,wS=`SceneControl__select_name___LnNjZ`,TS=`SceneControl__save___LnNjZ`,ES={sceneControl:xS,sceneControl_inner:SS,select:CS,select_name:wS,save:TS}})))()}var OS,kS,AS;function jS(){return(jS=t((()=>{OS=i(),T(),R(),pe(),DS(),kS=o(),AS=()=>{let{editor:e,projectName:t,scenes:n}=L(),[r,i]=(0,OS.useState)(null),o=null;return n&&(o=(0,kS.jsx)(D,{title:`scene`,children:(0,kS.jsxs)(`button`,{className:ES.select,onClick:e=>{i(ie(e.clientX,e.clientY))},children:[(0,kS.jsx)(`span`,{className:ES.select_name,children:n.current??`-`}),(0,kS.jsx)(a,{open:!0})]})})),(0,kS.jsxs)(`div`,{className:ES.sceneControl,children:[(0,kS.jsx)(`div`,{className:ES.sceneControl_inner,children:(0,kS.jsxs)(s,{label:t,accordion:!0,children:[o,(0,kS.jsx)(`div`,{className:ES.save,children:(0,kS.jsx)(c,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,kS.jsx)(me,{scenes:n,projectName:t,anchor:r,onClose:()=>{i(null)}})]})},AS.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var MS,NS,PS,FS,IS,LS,RS;function zS(){return(zS=t((()=>{MS=`Textures__textures___LnRle`,NS=`Textures__item___LnRle`,PS=`Textures__preview___LnRle`,FS=`Textures__img___LnRle`,IS=`Textures__placeholder___LnRle`,LS=`Textures__name___LnRle`,RS={textures:MS,item:NS,preview:PS,img:FS,placeholder:IS,name:LS}})))()}var BS,VS,HS;function US(){return(US=t((()=>{BS=i(),Pi(),R(),zS(),VS=o(),HS=()=>{let{engine:e,editor:t}=L(),[,n]=(0,BS.useState)(0);(0,BS.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return I.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{I.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=I.resources.textureList;return(0,VS.jsx)(`div`,{className:RS.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,VS.jsxs)(`div`,{className:RS.item,children:[(0,VS.jsx)(`div`,{className:RS.preview,children:n?(0,VS.jsx)(`img`,{src:n,className:RS.img}):(0,VS.jsx)(`div`,{className:RS.placeholder})}),(0,VS.jsx)(`div`,{className:RS.name,children:e.name})]},e.name)})})},HS.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var WS,GS;function KS(){return(KS=t((()=>{WS=i(),GS=(0,WS.createContext)(null)})))()}var qS,JS;function YS(){return(YS=t((()=>{qS=i(),KS(),JS=()=>{let e=(0,qS.useContext)(GS);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var XS;function ZS(){return(ZS=t((()=>{XS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
...
}`})))()}var QS;function $S(){return($S=t((()=>{ot(),Je(),A(),F(),ZS(),QS=class extends nt{wrapperElm;glCanvas;backend;gl;canvasTexture;canvas;canvasCtx;glRenderer;postProcess;viewPort;viewPortRange;viewPortScale;frameSetting;loopSetting;musicBuffer;musicTexture;resizeObserver;canvasSize;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.glCanvas=document.createElement(`canvas`),this.backend=new Ye(this.glCanvas.getContext(`webgl2`)),this.gl=this.backend.gl,this.canvasSize=new O(this.glCanvas.width,this.glCanvas.height),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0],this.viewPortScale=50,this.frameSetting=null,this.loopSetting={enabled:!1,start:0,end:0},this.resizeObserver=new ResizeObserver(this.onResize.bind(this));let e={renderer:null,curves:{},createEntity:t=>new Zt({...t,engine:e})};this.glRenderer=new ii(this.backend,e),e.renderer=this.glRenderer,this.canvasTexture=new Be(this.gl),this.musicBuffer=null,this.musicTexture=new Be(this.gl),this.musicTexture.setting({type:this.gl.UNSIGNED_BYTE,internalFormat:this.gl.LUMINANCE,format:this.gl.LUMINANCE,magFilter:this.gl.LINEAR,minFilter:this.gl.LINEAR,wrapS:this.gl.MIRRORED_REPEAT}),this.postProcess=new Cn({passes:[new P(this.backend,{frag:XS,uniforms:{uCanvasTex:{type:`1i`,value:null},uMusicTex:{type:`1i`,value:this.musicTexture}},renderTarget:null})]})}onResize(){if(this.wrapperElm){let e=new O(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);if(e.x===0||e.y===0)return;this.glCanvas.width=this.canvas.width=e.x,this.glCanvas.height=this.canvas.height=e.y,this.canvasSize.set(this.glCanvas.width,this.glCanvas.height),this.postProcess.resize(e),this.render()}}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.frameSetting){this.canvasCtx.fillStyle=`#181818`;let e=this.frameToPx(0),t=this.frameToPx(this.frameSetting.duration);this.canvasCtx.fillRect(e,0,t-e,this.canvas.height)}let e=(e,t,n)=>{let r=Math.ceil(this.viewPort[0]/e)*e;this.canvasCtx.beginPath();let i=0;for(;r<this.viewPort[2]&&i<100;){let n=this.frameToPx(r+t);this.canvasCtx.moveTo(n,0),this.canvasCtx.lineTo(n,this.canvas.height),r+=e,i++}this.canvasCtx.strokeStyle=n,this.canvasCtx.lineWidth=1,this.canvasCtx.stroke()};if(e(this.viewPortScale,0,`#555`),e(this.viewPortScale,this.viewPortScale/2,`#333`),this.musicBuffer&&this.frameSetting){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)],s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}if(this.loopSetting.enabled){this.canvasCtx.fillStyle=`#0009`;let e=this.frameToPx(this.loopSetting.start),t=this.frameToPx(this.loopSetting.end);this.canvasCtx.fillRect(0,0,e,this.canvas.height),this.canvasCtx.fillRect(t,0,this.canvas.width-t,this.canvas.height)}this.canvasTexture.attach(this.canvas),this.postProcess.passes&&(this.postProcess.passes[0].uniforms.uCanvasTex.value=this.canvasTexture),this.glRenderer.renderPostProcess(this.postProcess,void 0,this.canvasSize)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.glCanvas),this.onResize()}setViewPort(e,t){this.viewPort=e,this.viewPortRange=[e[2]-e[0],e[3]-e[1]],this.viewPortScale=t,this.render()}setFrameSetting(e){this.frameSetting={duration:Math.round(e.duration),fps:Math.round(e.fps)},this.render()}setMusicBuffer(e){this.musicBuffer=e,setTimeout(()=>{this.render()},100)}setLoopSetting(e,t,n){this.loopSetting={enabled:e,start:t,end:n},this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.glCanvas),this.resizeObserver.disconnect()}},QS.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setViewPort`,docblock:null,modifiers:[],params:[{name:`viewPort`,optional:!1,type:{name:`Array`,elements:[{name:`number`}],raw:`number[]`}},{name:`scale`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`setLoopSetting`,docblock:null,modifiers:[],params:[{name:`enabled`,optional:!1,type:{name:`boolean`}},{name:`start`,optional:!1,type:{name:`number`}},{name:`end`,optional:!1,type:{name:`number`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`TimelineCanvasRenderer`}})))()}var eC,tC;function nC(){return(nC=t((()=>{eC=`TimelineCanvas__timelineCanvas___LnRpb`,tC={timelineCanvas:eC}})))()}var rC,iC,aC;function oC(){return(oC=t((()=>{rC=i(),zv(),YS(),$S(),nC(),iC=o(),aC=()=>{let{viewPort:e,viewPortScale:t,musicBuffer:n,musicBufferVersion:r,glEditor:i}=JS(),[a,o]=(0,rC.useState)(),s=(0,rC.useRef)(null);(0,rC.useEffect)(()=>{let e=new QS;return o(e),s.current&&e.setWrapperElm(s.current),()=>{e.dispose()}},[]),(0,rC.useEffect)(()=>{a&&e&&t&&a.setViewPort(e,t)},[a,e,t]);let[c]=Y(i?.engine,`timeline/duration`),[l]=Y(i?.engine,`timeline/fps`);(0,rC.useEffect)(()=>{a&&c&&l&&a.setFrameSetting({duration:c||0,fps:l||0})},[a,c,l]);let[u]=Y(i,`frameLoop/enabled`),[d]=Y(i,`frameLoop/start`),[f]=Y(i,`frameLoop/end`);return(0,rC.useEffect)(()=>{a&&a.setLoopSetting(u||!1,d||0,f||0)},[a,u,d,f]),(0,rC.useEffect)(()=>{a&&n&&a.setMusicBuffer(n)},[a,n,r]),(0,iC.jsx)(`div`,{className:tC.timelineCanvas,ref:s})},aC.__docgenInfo={description:``,methods:[],displayName:`TimelineCanvas`}})))()}var sC,cC;function lC(){return(lC=t((()=>{sC=`TimelineControls__controls___LmNvb`,cC={controls:sC}})))()}var uC,dC,fC;function pC(){return(pC=t((()=>{uC=e(i(),1),YS(),lC(),dC=o(),fC=e=>{let{viewPort:t,setCurrentFrame:n,getFrameViewPort:r,zoom:i,scroll:a,setViewPortCenter:o}=JS(),s=(0,uC.useRef)([0,0,0,0]),c=(0,uC.useRef)([0,0]);t&&(s.current=t,c.current=[t[2]-t[0],t[3]-t[1]]);let l=(0,uC.useRef)(null),u=(0,uC.useRef)(null),d=(0,uC.useRef)(null),f=(0,uC.useRef)(null),p=(0,uC.useRef)(null),m=(0,uC.useCallback)(e=>{let t=l.current&&l.current.clientWidth||1;if(d.current==0){if(n&&r&&u.current){let i=(e.clientX-u.current.left)/t;n(r(i))}}else if(d.current==1){let n=[e.clientX,e.clientY];if(f.current&&p.current){let e=-(n[0]-f.current[0])/t*c.current[0];o&&o(p.current+e)}}},[n,r,o]),h=(0,uC.useCallback)(e=>{d.current=e.button,p.current=(s.current[2]+s.current[0])/2,f.current=[e.clientX,e.clientY],u.current=e.currentTarget.getBoundingClientRect();let t=(e.clientX-u.current.left)/e.currentTarget.clientWidth;d.current==0&&n&&r&&n(r(t)),window.addEventListener(`pointermove`,m);let i=()=>{f.current=null,d.current=null,p.current=null,window.removeEventListener(`pointermove`,m)};return window.addEventListener(`pointerup`,i),()=>{window.removeEventListener(`pointerup`,i),window.removeEventListener(`pointermove`,m)}},[r,n,m]),g=(0,uC.useCallback)(e=>{if(d.current!==null||!i||!a)return;e.preventDefault();let t=l.current&&l.current.clientWidth||1,n=Math.abs(e.deltaY);Math.abs(e.deltaX)<n?i(n>50?e.deltaY<0?.9:1.1:1+e.deltaY*.005):a(e.deltaX/t*.5)},[i,a]);return(0,uC.useEffect)(()=>{let e=l.current;return e&&e.addEventListener(`wheel`,g,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,g)}},[g]),t?(0,dC.jsx)(`div`,{className:cC.controls,onPointerDown:h,ref:l,children:e.children}):null},fC.__docgenInfo={description:``,methods:[],displayName:`TimelineControls`,props:{children:{required:!1,tsType:{name:`ReactReactNode`,raw:`React.ReactNode`},description:``}}}})))()}var mC,hC,gC;function _C(){return(_C=t((()=>{mC=`TimelineCursor__cursor___LmN1c`,hC=`TimelineCursor__frame___LmN1c`,gC={cursor:mC,frame:hC}})))()}var vC,yC;function bC(){return(bC=t((()=>{YS(),_C(),vC=o(),yC=()=>{let{viewPort:e,framePlay:t}=JS();if(!e||!t)return null;let n=e[2]-e[0],r=(t.current-e[0])/n;return(0,vC.jsx)(`div`,{className:gC.cursor,style:{left:r*100+`%`},children:(0,vC.jsx)(`div`,{className:gC.frame})})},yC.__docgenInfo={description:``,methods:[],displayName:`TimelineCursor`}})))()}var xC,SC,CC,wC;function TC(){return(TC=t((()=>{xC=`TimelineLoop__timelineLoop___LnRpb`,SC=`TimelineLoop__start___LnRpb`,CC=`TimelineLoop__end___LnRpb`,wC={timelineLoop:xC,start:SC,end:CC}})))()}var EC,DC;function OC(){return(OC=t((()=>{EC=`TimelineLoopCursor__cursor___LmN1c`,DC={cursor:EC}})))()}var kC,AC,jC;function MC(){return(MC=t((()=>{kC=i(),OC(),AC=o(),jC=({onMove:e})=>{let t=(0,kC.useRef)(!1);return(0,AC.jsx)(`div`,{className:DC.cursor,onPointerDown:e=>{e.buttons==1&&(t.current=!0,e.stopPropagation())},onPointerMove:n=>{let r=n.target;t.current!==!1&&n.buttons==1&&(r.setPointerCapture(n.pointerId),n.buttons==1&&e&&e(n.clientX),n.nativeEvent.preventDefault(),n.nativeEvent.stopPropagation())},onPointerUp:()=>{t.current=!1}})},jC.__docgenInfo={description:``,methods:[],displayName:`TimelineLoopCursor`}})))()}var NC,PC,FC;function IC(){return(IC=t((()=>{NC=i(),zv(),Ia(),YS(),TC(),MC(),PC=o(),FC=()=>{let{viewPort:e,framePlay:t,glEditor:n}=JS(),r=(0,NC.useRef)(null);Fa(n,[`frameLoop/enabled`,`frameLoop/start`,`frameLoop/end`]);let[i]=Y(n,`frameLoop/enabled`),[a,o]=Y(n,`frameLoop/start`),[s,c]=Y(n,`frameLoop/end`);if(i!==!0||!e||!t||a===void 0||s===void 0)return null;let l=e[2]-e[0],u=(a-e[0])/l,d=(s-e[0])/l,f=(t,n)=>{let r=t.getBoundingClientRect();return(n-r.x)/r.width*(e[2]-e[0])+e[0]};return(0,PC.jsx)(`div`,{className:wC.timelineLoop,ref:r,children:(0,PC.jsxs)(`div`,{className:wC.timelineLoop_inner,children:[(0,PC.jsx)(`div`,{className:wC.start,style:{left:u*100+`%`},children:(0,PC.jsx)(jC,{onMove:e=>{r.current&&o&&o(f(r.current,e))}})}),(0,PC.jsx)(`div`,{className:wC.end,style:{left:d*100+`%`},children:(0,PC.jsx)(jC,{onMove:e=>{r.current&&c&&c(f(r.current,e))}})})]})})},FC.__docgenInfo={description:``,methods:[],displayName:`TimelineLoop`}})))()}var LC,RC,zC,BC,VC,HC;function UC(){return(UC=t((()=>{LC=`TimelineScale__scale___LnNjY`,RC=`TimelineScale__scale_inner___LnNjY`,zC=`TimelineScale__scale_item___LnNjY`,BC=`TimelineScale__scale_item_frame___LnNjY`,VC=`TimelineScale__scale_item_time___LnNjY`,HC={scale:LC,scale_inner:RC,scale_item:zC,scale_item_frame:BC,scale_item_time:VC}})))()}var WC,GC,KC;function qC(){return(qC=t((()=>{zv(),YS(),UC(),WC=o(),GC=e=>`${(`00`+Math.floor(e%3600/60)).slice(-2)}:${(`00`+Math.floor(e%60)).slice(-2)}`,KC=()=>{let{glEditor:e,viewPort:t,viewPortScale:n}=JS(),[r,i]=Y(e?.engine,`timeline/fps`);if(!t||!n||r===void 0)return null;let a=[],o=Math.ceil(t[0]/n)*n,s=0;for(;o<t[2]&&s<100;){let e=(o-t[0])/(t[2]-t[0]),i=o/(r||0);a.push((0,WC.jsxs)(`div`,{className:HC.scale_item,style:{left:e*100+`%`},children:[(0,WC.jsx)(`div`,{className:HC.scale_item_frame,children:o}),(0,WC.jsx)(`div`,{className:HC.scale_item_time,children:GC(i)})]},o)),o+=n,s++}return(0,WC.jsx)(`div`,{className:HC.scale,children:(0,WC.jsx)(`div`,{className:HC.scale_inner,children:a})})},KC.__docgenInfo={description:``,methods:[],displayName:`TimelineScale`}})))()}var JC,YC,XC;function ZC(){return(ZC=t((()=>{JC=`TimelineSetting__timelineSetting___LnRpb`,YC=`TimelineSetting__play___LnRpb`,XC={timelineSetting:JC,play:YC}})))()}var QC,$C,ew;function tw(){return(tw=t((()=>{QC=i(),T(),ia(),zv(),YS(),ZC(),$C=o(),ew=()=>{let{framePlay:e,glEditor:t}=JS(),n=(0,QC.useCallback)((e,t)=>{t&&t(e)},[]),[r,i]=Y(t,`frameLoop/enabled`),[a]=Y(t?.engine,`timeline/duration`),[o]=Y(t?.engine,`timeline/fps`),s=(0,QC.useCallback)((e,n)=>{t&&t.api.setField(t.engine,e,n)},[t]),l=(0,QC.useCallback)(()=>{t&&t.togglePlay()},[t]);return(0,$C.jsx)(`div`,{className:XC.timelineSetting,children:(0,$C.jsxs)(le,{children:[(0,$C.jsx)(`div`,{className:XC.play,children:(0,$C.jsx)(c,{onClick:l,children:e.playing?(0,$C.jsx)(f,{size:14}):(0,$C.jsx)(h,{size:14})})}),(0,$C.jsx)(D,{title:`current`,children:(0,$C.jsx)(ra,{value:Math.floor(e?.current||0),readOnly:!0})}),(0,$C.jsx)(D,{title:`duration`,children:(0,$C.jsx)(ra,{value:a,onChange:e=>s(`timeline/duration`,e)})}),(0,$C.jsx)(D,{title:`fps`,children:(0,$C.jsx)(ra,{value:o,onChange:e=>s(`timeline/fps`,e)})}),(0,$C.jsx)(D,{title:`loop`,children:(0,$C.jsx)(ra,{value:r||!1,onChange:e=>n(e,i)})})]})})},ew.__docgenInfo={description:``,methods:[],displayName:`TimelineSetting`}})))()}var nw,rw;function iw(){return(iw=t((()=>{nw=i(),rw=e=>{let[t,n]=(0,nw.useState)({width:0,height:0});return(0,nw.useEffect)(()=>{let t=e.current;if(!t)return;let r=()=>{n({width:t.clientWidth,height:t.clientHeight})};r();let i=new ResizeObserver(r);return i.observe(t),()=>{i.disconnect()}},[e]),t}})))()}var aw,ow;function sw(){return(sw=t((()=>{aw=i(),ow=(0,aw.createContext)(null)})))()}var cw,lw;function uw(){return(uw=t((()=>{cw=i(),sw(),lw=()=>{let e=(0,cw.useContext)(ow);if(e===null)throw Error(`useKeyEditor must be used within a KeyEditorProvider`);return e}})))()}var dw,fw,pw,mw,hw,gw;function _w(){return(_w=t((()=>{dw=(e,t)=>e+`:`+t,fw=e=>{let t=e.lastIndexOf(`:`);return{curveId:e.slice(0,t),index:Number(e.slice(t+1))}},pw=(e,t)=>{let n=new Map;for(let r of e){let{curveId:e,index:i}=fw(r),a=t[e];if(!a||i>=a.k.length)continue;let o=n.get(e);o||(o=[],n.set(e,o)),o.push(i)}return n},mw=(e,t)=>{for(let n of t)if(!e.has(n))return!1;return t.length>0},hw=e=>{if(!(e instanceof Element))return null;let t=e.closest(`[data-refs]`);if(!t)return null;let n=t.getAttribute(`data-refs`);return n?n.split(` `):null},gw=(e,t)=>{let n=[];for(let r of e.querySelectorAll(`[data-refs]`)){let e=r.getBoundingClientRect();if(!(e.right<t.left||e.left>t.right||e.bottom<t.top||e.top>t.bottom))for(let e of(r.getAttribute(`data-refs`)||``).split(` `))n.push(e)}return n}})))()}var vw,yw,bw,xw,Sw,Cw,ww,Tw,Ew,Dw,Ow,kw;function Aw(){return(Aw=t((()=>{Pi(),H_(),_w(),vw=`#entity`,yw=[`x`,`y`,`z`,`w`],bw=[`r`,`g`,`b`,`a`],xw=1e-4,Sw=(e,t)=>{let n=t.indexOf(`:`);if(n<0)return{target:e,component:null,path:t};let r=t.slice(0,n),i=t.slice(n+1),a=I.resources.getComponent(r),o=null;return a&&(o=e.getComponent(a.component)||null),{target:o,component:r,path:i}},Cw=(e,t,n)=>{let r=yw;if(e){let n=e.getFieldOpt(t);n&&n.format&&n.format.type==`color`&&(r=bw)}return n<r.length?r[n]:String(n)},ww=(e,t,n)=>{let r=n.get(e)||0;if(r<2)return null;let i=e,a=t[e];return a&&a.name&&(i=a.name),{name:i,count:r}},Tw=(e,t)=>{e.curveIds.indexOf(t)<0&&e.curveIds.push(t)},Ew=(e,t,n)=>{let r=jl(e),i=Object.keys(r),a={id:vw,parentId:null,depth:0,component:null,label:e.name,curveIds:[],leaf:!1,hasChildren:i.length>0,kind:null,element:null,shared:null},o=[a];for(let s of i){let i=r[s],c=Sw(e,s),l=null;c.target&&(l=iu({target:c.target,path:c.path}));let u={id:s,parentId:vw,depth:1,component:c.component,label:c.path,curveIds:[],leaf:!0,hasChildren:!1,kind:l,element:null,shared:null};if(o.push(u),typeof i[0]==`string`){let e=i[0];Tw(u,e),Tw(a,e),u.shared=ww(e,t,n);continue}u.leaf=!1,u.hasChildren=!0;let d=i;for(let e=0;e<d.length;e++){let r=d[e];if(!r)continue;let i=r[0];o.push({id:s+`#`+e,parentId:s,depth:2,component:null,label:Cw(c.target,c.path,e),curveIds:[i],leaf:!0,hasChildren:!1,kind:l,element:e,shared:ww(i,t,n)}),Tw(u,i),Tw(a,i)}}return o},Dw=new WeakMap,Ow=e=>{if(!e)return[];let t=Dw.get(e);return t||(t=tl(e),Dw.set(e,t)),t},kw=(e,t)=>{let n=new Map;for(let r of t){let t=Ow(e[r]);for(let e=0;e<t.length;e++){let i=t[e].coordinate.x,a=Math.round(i/xw),o=n.get(a);o||(o={frame:i,refs:[]},n.set(a,o)),o.refs.push(dw(r,e))}}let r=Array.from(n.values());return r.sort((e,t)=>e.frame-t.frame),r}})))()}var jw,Mw,Nw,Pw,Fw,Iw,Lw,Rw,zw,Bw,Vw,Hw;function Uw(){return(Uw=t((()=>{F(),Aw(),jw=[`var(--or-axis-x)`,`var(--or-axis-y)`,`var(--or-axis-z)`,`var(--or-axis-w)`],Mw=e=>e===null||e>=jw.length?`var(--or-text-muted)`:jw[e],Nw=.1,Pw=40,Fw=2,Iw=(e,t)=>{let n=1/0,r=-1/0;for(let i of t){let t=Ow(e[i]);for(let e=0;e<t.length;e++){let i=t[e],a=[i.coordinate.y];i.interpolation==`BEZIER`&&a.push(i.handleRight.y),e>0&&t[e-1].interpolation==`BEZIER`&&a.push(i.handleLeft.y);for(let e of a)n=Math.min(n,e),r=Math.max(r,e)}}if(n>r)return{min:-1,max:1};if(r-n<1e-6)return{min:n-1,max:r+1};let i=(r-n)*Nw;return{min:n-i,max:r+i}},Lw=e=>10**Math.floor(Math.log10(e)),Rw=(e,t)=>{let n=Lw(t),r=Math.max(0,-Math.floor(Math.log10(n)));return Number((Math.round(e/n)*n).toFixed(r))},zw=(e,t)=>{let n=[],r=Math.max(1,Math.floor(t/Pw)),i=(e.max-e.min)/r,a=10**Math.floor(Math.log10(i)),o=a*10;i<=a?o=a:i<=a*2?o=a*2:i<=a*5&&(o=a*5);let s=Math.max(0,-Math.floor(Math.log10(o)));for(let t=Math.ceil(e.min/o)*o;t<=e.max;t+=o)n.push(Number(t.toFixed(s)));return n},Bw=new WeakMap,Vw=e=>{let t=Bw.get(e);return t||(t=new mt(bt(e.k)),Bw.set(e,t)),t},Hw=(e,t,n,r)=>{if(e.k.length==0)return``;let i=Vw(e),a=[];for(let e=0;e<=r+Fw;e+=Fw)a.push(e+`,`+n(i.getValue(t(e))).toFixed(1));return`M`+a.join(`L`)}})))()}var Ww,Gw,Kw;function qw(){return(qw=t((()=>{Ww=3,Gw=(e,t)=>{let n=!1,r=r=>{let i=r.clientX-e.clientX,a=r.clientY-e.clientY;!n&&Math.hypot(i,a)<Ww||(n=!0,t.onMove(i,a,r))},i=e=>{window.removeEventListener(`pointermove`,r),window.removeEventListener(`pointerup`,i),t.onEnd(n,e)};window.addEventListener(`pointermove`,r),window.addEventListener(`pointerup`,i)},Kw=(e,t)=>({left:Math.min(e.clientX,t.clientX),top:Math.min(e.clientY,t.clientY),right:Math.max(e.clientX,t.clientX),bottom:Math.max(e.clientY,t.clientY)})})))()}var Jw,Yw,Xw,Zw,Qw,$w,eT,tT,nT,rT,iT;function aT(){return(aT=t((()=>{Jw=`KeyCurveGraph__graph___LmdyY`,Yw=`KeyCurveGraph__svg___LmdyY`,Xw=`KeyCurveGraph__tick___LmdyY`,Zw=`KeyCurveGraph__curve___LmdyY`,Qw=`KeyCurveGraph__handleLine___LmdyY`,$w=`KeyCurveGraph__tickLabel___LmdyY`,eT=`KeyCurveGraph__sharedLabel___LmdyY`,tT=`KeyCurveGraph__point___LmdyY`,nT=`KeyCurveGraph__handle___LmdyY`,rT=`KeyCurveGraph__box___LmdyY`,iT={graph:Jw,svg:Yw,tick:Xw,curve:Zw,handleLine:Qw,tickLabel:$w,sharedLabel:eT,point:tT,handle:nT,box:rT}})))()}var oT,sT,cT,lT;function uT(){return(uT=t((()=>{oT=i(),YS(),iw(),uw(),Uw(),Aw(),_w(),qw(),aT(),sT=o(),cT=e=>{if(!(e instanceof Element))return null;let t=e.closest(`[data-side]`);return t?{curveId:t.getAttribute(`data-curve`)||``,index:Number(t.getAttribute(`data-index`)),side:t.getAttribute(`data-side`)}:null},lT=()=>{let{viewPort:e,setCurrentFrame:t,getFrameViewPort:n}=JS(),{curves:r,graphCurves:i,selection:a,pressKeys:o,selectRefs:s,select:c,beginMove:l,beginHandleMove:u}=lw(),d=(0,oT.useRef)(null),{width:f,height:p}=rw(d),[m,h]=(0,oT.useState)(null),[g,_]=(0,oT.useState)(null),v=[];for(let e of i)v.push(e.id);let y=Iw(r,v);g&&(y=g);let b=(e[2]-e[0])/Math.max(1,f),x=(y.max-y.min)/Math.max(1,p),S=t=>(t-e[0])/b,C=e=>(y.max-e)/x,w=y.max,ee=(0,oT.useMemo)(()=>{let t=[],n=t=>e[0]+t*b,a=e=>(w-e)/x;for(let e of i)t.push({id:e.id,element:e.element,d:Hw(r[e.id],n,a,f)});return t},[i,r,e,b,x,w,f]),te=e=>{if(e.button!=0)return;e.stopPropagation();let i=d.current;if(!i)return;let a=i.getBoundingClientRect(),f=e.shiftKey,p={clientX:e.clientX,clientY:e.clientY},m=cT(e.target),g=hw(e.target),S=b,C=x;if(m){let e=Ow(r[m.curveId])[m.index],t=e.handleRight;m.side==`left`&&(t=e.handleLeft);let n=null;_(y),Gw(p,{onMove:(e,r)=>{n||=u(m.curveId,m.index,m.side),n.move({x:Rw(t.x+e*S,S),y:Rw(t.y-r*C,C)})},onEnd:()=>{n&&n.end(),_(null)}});return}if(g){let e=o(g,f),t=null;_(y),Gw(p,{onMove:(e,n)=>{t||=l(new Set(v)),t.move({x:e*S,y:-n*C},e=>Rw(e,C))},onEnd:()=>{_(null),t?t.end():!f&&e&&c(new Set(g))}});return}Gw(p,{onMove:(e,t,n)=>{let r=Kw(p,n);h({left:r.left-a.left,top:r.top-a.top,width:r.right-r.left,height:r.bottom-r.top})},onEnd:(e,r)=>{if(h(null),e){s(gw(i,Kw(p,r)),f);return}f||c(new Set),t(n((p.clientX-a.left)/a.width))}})},ne=[],T=[],E=[];for(let e of i){let t=Ow(r[e.id]);for(let n=0;n<t.length;n++){let r=t[n],i=dw(e.id,n),o=S(r.coordinate.x),s=C(r.coordinate.y);o<0||o>f||(ne.push({ref:i,x:o,y:s}),a.has(i)&&(n>0&&t[n-1].interpolation==`BEZIER`&&T.push({curveId:e.id,index:n,side:`left`,x:S(r.handleLeft.x),y:C(r.handleLeft.y),keyX:o,keyY:s}),r.interpolation==`BEZIER`&&n<t.length-1&&T.push({curveId:e.id,index:n,side:`right`,x:S(r.handleRight.x),y:C(r.handleRight.y),keyX:o,keyY:s})))}e.shared&&t.length>0&&E.push({id:e.id,x:Math.max(0,S(t[0].coordinate.x)),y:C(t[0].coordinate.y),text:`⇄ ${e.shared.name} (${e.shared.count})`})}let re=zw(y,p);return(0,sT.jsxs)(`div`,{className:iT.graph,ref:d,onPointerDown:te,children:[f>0&&(0,sT.jsxs)(`svg`,{className:iT.svg,width:f,height:p,children:[re.map(e=>(0,sT.jsx)(`line`,{className:iT.tick,x1:0,x2:f,y1:C(e),y2:C(e)},e)),ee.map(e=>(0,sT.jsx)(`path`,{className:iT.curve,style:{stroke:Mw(e.element)},d:e.d},e.id)),T.map(e=>(0,sT.jsx)(`line`,{className:iT.handleLine,x1:e.keyX,y1:e.keyY,x2:e.x,y2:e.y},e.curveId+e.index+e.side))]}),re.map(e=>(0,sT.jsx)(`div`,{className:iT.tickLabel,style:{top:C(e)},children:e},e)),E.map(e=>(0,sT.jsx)(`div`,{className:iT.sharedLabel,style:{left:e.x,top:e.y},children:e.text},e.id)),ne.map(e=>(0,sT.jsx)(`div`,{className:iT.point,"data-refs":e.ref,"data-selected":a.has(e.ref),style:{left:e.x,top:e.y}},e.ref)),T.map(e=>(0,sT.jsx)(`div`,{className:iT.handle,"data-curve":e.curveId,"data-index":e.index,"data-side":e.side,style:{left:e.x,top:e.y}},e.curveId+e.index+e.side)),m&&(0,sT.jsx)(`div`,{className:iT.box,style:m})]})},lT.__docgenInfo={description:``,methods:[],displayName:`KeyCurveGraph`}})))()}var dT,fT,pT,mT,hT;function gT(){return(gT=t((()=>{dT=`KeyDopeSheet__dopeSheet___LmRvc`,fT=`KeyDopeSheet__row___LmRvc`,pT=`KeyDopeSheet__key___LmRvc`,mT=`KeyDopeSheet__box___LmRvc`,hT={dopeSheet:dT,row:fT,key:pT,box:mT}})))()}var _T,vT,yT;function bT(){return(bT=t((()=>{_T=i(),T(),YS(),uw(),Aw(),_w(),qw(),gT(),vT=o(),yT=()=>{let{viewPort:e,setCurrentFrame:t,getFrameViewPort:n}=JS(),{curves:r,visibleChannels:i,selection:a,scrollTop:o,pressKeys:s,selectRefs:c,select:l,beginMove:u}=lw(),d=(0,_T.useRef)(null),[f,p]=(0,_T.useState)(null),m=e[2]-e[0];return(0,vT.jsxs)(`div`,{className:hT.dopeSheet,ref:d,onPointerDown:e=>{if(e.button!=0)return;e.stopPropagation();let r=d.current;if(!r)return;let i=r.getBoundingClientRect(),a=hw(e.target),o=e.shiftKey,f={clientX:e.clientX,clientY:e.clientY};if(a){let e=s(a,o),t=null;Gw(f,{onMove:e=>{t||=u(null),t.move({x:e/i.width*m,y:0})},onEnd:()=>{t?t.end():!o&&e&&l(new Set(a))}});return}Gw(f,{onMove:(e,t,n)=>{let r=Kw(f,n);p({left:r.left-i.left,top:r.top-i.top,width:r.right-r.left,height:r.bottom-r.top})},onEnd:(e,a)=>{if(p(null),e){c(gw(r,Kw(f,a)),o);return}o||l(new Set),t(n((f.clientX-i.left)/i.width))}})},children:[(0,vT.jsx)(`div`,{className:hT.rows,style:{transform:`translateY(${-o}px)`},children:i.map(t=>{let n=t.kind==`event`;return(0,vT.jsx)(`div`,{className:hT.row,"data-depth":t.depth,children:kw(r,t.curveIds).map(t=>{let r=(t.frame-e[0])/m;return r<-.05||r>1.05?null:(0,vT.jsx)(`div`,{className:hT.key,"data-refs":t.refs.join(` `),"data-selected":mw(a,t.refs),"data-event":n,style:{left:r*100+`%`},children:!n&&(0,vT.jsx)(_,{size:10})},t.frame)})},t.id)})}),f&&(0,vT.jsx)(`div`,{className:hT.box,style:f})]})},yT.__docgenInfo={description:``,methods:[],displayName:`KeyDopeSheet`}})))()}var xT,ST;function CT(){return(CT=t((()=>{xT=`KeyEditor__keyEditor___Lmtle`,ST={keyEditor:xT}})))()}var wT,TT,ET,DT,OT;function kT(){return(kT=t((()=>{wT=i(),T(),R(),uT(),bT(),uw(),CT(),_w(),TT=o(),ET=[{label:`Constant`,value:`CONSTANT`},{label:`Linear`,value:`LINEAR`},{label:`Bezier`,value:`BEZIER`}],DT=[{label:`Auto Clamped`,value:`AUTO_CLAMPED`},{label:`Auto`,value:`AUTO`},{label:`Vector`,value:`VECTOR`},{label:`Aligned`,value:`ALIGNED`},{label:`Free`,value:`FREE`}],OT=()=>{let{editor:e}=L(),{open:t,closeAll:n}=w(),{entity:r,channels:i,mode:a,selection:o,select:s,timelineActions:c,deleteSelectedKeys:l,copySelectedKeys:u,pasteCopiedKeys:d,setSelectedInterpolation:f,setSelectedHandleType:p}=lw();if((0,wT.useEffect)(()=>()=>{e.leaveTimeline(c)},[e,c]),!r||i.length<=1)return null;let m=e=>{e.preventDefault();let r=hw(e.target);r&&!mw(o,r)&&s(new Set(r));let i=e=>()=>{e(),n()},a=[];for(let e of ET)a.push({label:e.label,onClick:i(()=>f(e.value))});let c=[];for(let e of DT)c.push({label:e.label,onClick:i(()=>p(e.value))});let m=[{label:`Interpolation`,children:a},{label:`Handle Type`,children:c},{label:`Copy`,onClick:i(u)},{label:`Paste`,onClick:i(d)},{label:`Delete`,onClick:i(l)}];t((0,TT.jsx)(ce,{title:`Keyframes`,items:m}),ie(e.clientX,e.clientY))},h=(0,TT.jsx)(yT,{});return a==`curves`&&(h=(0,TT.jsx)(lT,{})),(0,TT.jsx)(`div`,{className:ST.keyEditor,onPointerEnter:()=>e.enterTimeline(c),onPointerLeave:()=>e.leaveTimeline(c),onContextMenu:m,children:h})},OT.__docgenInfo={description:``,methods:[],displayName:`KeyEditor`}})))()}var AT,jT,MT,NT,PT,FT,IT,LT,RT,zT;function BT(){return(BT=t((()=>{AT=`KeyChannelList__channelList___LmNoY`,jT=`KeyChannelList__header___LmNoY`,MT=`KeyChannelList__list___LmNoY`,NT=`KeyChannelList__empty___LmNoY`,PT=`KeyChannelList__row___LmNoY`,FT=`KeyChannelList__toggle___LmNoY`,IT=`KeyChannelList__component___LmNoY`,LT=`KeyChannelList__label___LmNoY`,RT=`KeyChannelList__shared___LmNoY`,zT={channelList:AT,header:jT,list:MT,empty:NT,row:PT,toggle:FT,component:IT,label:LT,shared:RT}})))()}var VT,HT;function UT(){return(UT=t((()=>{T(),uw(),Uw(),BT(),VT=o(),HT=()=>{let{entity:e,visibleChannels:t,mode:n,setMode:r,collapsed:i,toggleCollapsed:o,activeChannelId:s,setActiveChannelId:l,setScrollTop:u}=lw();return(0,VT.jsxs)(`div`,{className:zT.channelList,children:[(0,VT.jsxs)(`div`,{className:zT.header,children:[(0,VT.jsx)(c,{active:n==`keys`,onClick:()=>r(`keys`),children:`Keys`}),(0,VT.jsx)(c,{active:n==`curves`,onClick:()=>r(`curves`),children:`Curves`})]}),(0,VT.jsxs)(`div`,{className:zT.list,onScroll:e=>u(e.currentTarget.scrollTop),children:[!e&&(0,VT.jsx)(`div`,{className:zT.empty,children:`No entity selected`}),t.map(e=>{let t;return n==`curves`&&e.element!==null&&(t=Mw(e.element)),(0,VT.jsxs)(`div`,{className:zT.row,"data-depth":e.depth,"data-active":n==`curves`&&e.id==s,onClick:()=>l(e.id),children:[(0,VT.jsx)(`span`,{className:zT.toggle,children:e.hasChildren&&(0,VT.jsx)(`button`,{onClick:t=>{t.stopPropagation(),o(e.id)},children:(0,VT.jsx)(a,{open:!i.has(e.id)})})}),e.component&&(0,VT.jsx)(`span`,{className:zT.component,children:e.component}),(0,VT.jsx)(`span`,{className:zT.label,style:{color:t},children:e.label}),e.shared&&(0,VT.jsxs)(`span`,{className:zT.shared,title:`Shared with ${e.shared.count} fields`,children:[`⇄ `,e.shared.name,` (`,e.shared.count,`)`]})]},e.id)})]})]})},HT.__docgenInfo={description:``,methods:[],displayName:`KeyChannelList`}})))()}var WT,GT,KT,qT,JT,YT,XT,ZT;function QT(){return(QT=t((()=>{WT=i(),H_(),G_(),R(),Aw(),_w(),GT={entity:null,curves:{},channels:[]},KT=e=>{let t=e.getField(`selectedEntityId`);return t&&e.engine.root.findEntityByUUID(t)||null},qT=e=>{let t=[KT(e),e.engine.curves];return e.engine.root.traverse(e=>{let n=jl(e);Object.keys(n).length>0&&t.push(n)}),t},JT=(e,t)=>{if(e.length!=t.length)return!1;for(let n=0;n<e.length;n++)if(e[n]!==t[n])return!1;return!0},YT=e=>{let t=KT(e),n=e.engine.curves;return t?{entity:t,curves:n,channels:Ew(t,n,ql(e.engine))}:{...GT,curves:n}},XT=e=>e.kind==`number`||e.kind==`array`,ZT=()=>{let{editor:e,engine:t}=L(),[n,r]=(0,WT.useState)(()=>YT(e)),i=(0,WT.useRef)([]),a=(0,WT.useRef)(null),[o,s]=(0,WT.useState)(`keys`),[c,l]=(0,WT.useState)(()=>new Set),[u,d]=(0,WT.useState)(()=>new Set),[f,p]=(0,WT.useState)(vw),[m,h]=(0,WT.useState)(0),g=(0,WT.useRef)(c),_=(0,WT.useRef)(null),v=(0,WT.useCallback)(e=>{g.current=e,l(e)},[]);W_(()=>{let t=qT(e),n=i.current;if(JT(t,n))return;i.current=t;let o=t[0]!==n[0],s=t[1]!==n[1]&&t[1]!==a.current;n.length>0&&(o||s)&&v(new Set),r(YT(e))});let y=n.channels,b=(0,WT.useMemo)(()=>{let e=new Set,t=[];for(let n of y){if(n.parentId&&(e.has(n.parentId)||u.has(n.parentId))){e.add(n.id);continue}t.push(n)}return t},[y,u]),x=(0,WT.useMemo)(()=>{let e=y[0];for(let t of y)t.id==f&&(e=t);let t=[],n=new Set;if(!e)return t;for(let r of y){if(!r.leaf||!XT(r)||e.id!=`#entity`&&r.id!=e.id&&r.parentId!=e.id)continue;let i=r.curveIds[0];n.has(i)||(n.add(i),t.push({id:i,element:r.element,shared:r.shared}))}return t},[y,f]),S=(0,WT.useCallback)(e=>{d(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n})},[]),C=(0,WT.useCallback)((e,t)=>{let n=g.current,r=mw(n,e);if(t){let t=new Set(n);for(let n of e)r?t.delete(n):t.add(n);v(t)}else r||v(new Set(e));return r},[v]),w=(0,WT.useCallback)((e,t)=>{let n=new Set;t&&(n=new Set(g.current));for(let t of e)n.add(t);v(n)},[v]),ee=e=>ru(e,t.frameSetting.fps),te=t=>{a.current=t,e.api.setCurves(t)},ne=new Set;for(let e of y)e.leaf&&XT(e)&&ne.add(e.curveIds[0]);let T=()=>{let e=pw(g.current,t.curves);if(e.size==0)return;let n={...t.curves};for(let[r,i]of e)n[r]=ol(t.curves[r],i);te(n),v(new Set)},E=e=>{let n=pw(g.current,t.curves),r={...t.curves},i=!1;for(let[a,o]of n)ne.has(a)&&(r[a]=e(t.curves[a],o),i=!0);i&&te(r)},re=e=>{E((t,n)=>ll(t,n,e))},ie=e=>{E((t,n)=>ul(t,n,e))},ae=()=>{let e=pw(g.current,t.curves),n=[],r=new Set,i=1/0;for(let a of y){if(!a.leaf)continue;let o=a.curveIds[0],s=e.get(o);if(!s||r.has(o))continue;r.add(o);let c=Ow(t.curves[o]),l=[];for(let e of s)l.push(c[e]),i=Math.min(i,c[e].coordinate.x);n.push({channelId:a.id,keys:l})}n.length!=0&&(_.current={entries:n,start:i})},D=()=>{let e=_.current;if(!e)return;let n=Dl(t)-e.start,r={...t.curves},i=new Set,a=!1;for(let t of e.entries){let e=null;for(let n of y)n.leaf&&n.id==t.channelId&&(e=n);if(!e)continue;let o=e.curveIds[0],s=cl(r[o],t.keys,n,ee);r[o]=s.curve,a=!0;for(let e of s.indices)i.add(dw(o,e))}a&&(te(r),v(i))},oe=n=>{let r=t.curves,i=pw(g.current,r),o=e.api.beginEdit(t,`curves`),s=!1;return{move:(e,t)=>{let c={...r},l=new Set;for(let[a,o]of i){let i=0;n&&n.has(a)&&(i=e.y);let s=sl(r[a],o,{x:e.x,y:i},ee,t);c[a]=s.curve;for(let e of s.indices)l.add(dw(a,e))}a.current=c,o.set(c),v(l),s=!0},end:()=>{s&&o.commit()}}},se=(n,r,i)=>{let o=t.curves,s=e.api.beginEdit(t,`curves`),c=!1;return{move:e=>{let t={...o,[n]:dl(o[n],r,i,e)};a.current=t,s.set(t),c=!0},end:()=>{c&&s.commit()}}},ce=(0,WT.useRef)({deleteSelectedKeys:T,copySelectedKeys:ae,pasteCopiedKeys:D});ce.current={deleteSelectedKeys:T,copySelectedKeys:ae,pasteCopiedKeys:D};let le=(0,WT.useMemo)(()=>({deleteKeys:()=>ce.current.deleteSelectedKeys(),copyKeys:()=>ce.current.copySelectedKeys(),pasteKeys:()=>ce.current.pasteCopiedKeys()}),[]);return{entity:n.entity,curves:n.curves,channels:y,visibleChannels:b,graphCurves:x,mode:o,setMode:s,selection:c,collapsed:u,toggleCollapsed:S,activeChannelId:f,setActiveChannelId:p,scrollTop:m,setScrollTop:h,pressKeys:C,selectRefs:w,select:v,deleteSelectedKeys:T,copySelectedKeys:ae,pasteCopiedKeys:D,setSelectedInterpolation:re,setSelectedHandleType:ie,beginMove:oe,beginHandleMove:se,timelineActions:le}}})))()}var $T,eE;function tE(){return(tE=t((()=>{sw(),QT(),$T=o(),eE=e=>{let t=ZT();return(0,$T.jsx)(ow.Provider,{value:t,children:e.children})},eE.__docgenInfo={description:``,methods:[],displayName:`KeyEditorProvider`}})))()}var nE,rE,iE,aE,oE,sE;function cE(){return(cE=t((()=>{nE=`Timeline__timeline___LnRpb`,rE=`Timeline__inner___LnRpb`,iE=`Timeline__content___LnRpb`,aE=`Timeline__channels___LnRpb`,oE=`Timeline__setting___LnRpb`,sE={timeline:nE,inner:rE,content:iE,channels:aE,setting:oE}})))()}var lE,uE;function dE(){return(dE=t((()=>{lE=i(),R(),uE=()=>{let{editor:e}=L(),[t,n]=(0,lE.useState)({current:0,playing:!1}),[r,i]=(0,lE.useState)([0,0,100,0]),a=(0,lE.useRef)([0,0,0,0]);a.current=r;let o=r[2]-r[0],s=10*2**(0+Math.floor(Math.log2(o/100)));s=Math.max(1,Math.floor(s));let c=e?.audioBuffer,[l,u]=(0,lE.useState)();(0,lE.useEffect)(()=>{if(e){let t=e.engine,r=e=>{n({...e})};r(t.frame);let a=0,o=()=>{u(a++)},s=()=>{i([0,0,t.frameSetting.duration,0])};return s(),t.on(`update/frame/play`,r),t.on(`update/music`,o),t.on(`loaded`,s),()=>{t.off(`update/frame/play`,r),t.off(`update/music`,o),t.off(`loaded`,s)}}},[e]);let d=(0,lE.useCallback)(t=>{e&&e.engine.seek(t)},[e]),f=(0,lE.useCallback)(e=>{let t=r[2]-r[0];return Math.floor(r[0]+t*e)},[r]),p=(0,lE.useCallback)(e=>{let t=a.current,n=(t[2]+t[0])/2,r=(t[0]-n)*e+n,o=(t[2]-n)*e+n;i([r,t[1],o,t[3]])},[]),m=(0,lE.useCallback)(e=>{let t=a.current,n=e*(t[2]-t[0]);i([t[0]+n,t[1],t[2]+n,t[3]])},[]),h=(0,lE.useCallback)(e=>{let t=a.current,n=t[2]-t[0];i([e-n/2,t[1],e+n/2,t[3]])},[]);return{glEditor:e,framePlay:t,viewPort:r,viewPortScale:s,musicBuffer:c,musicBufferVersion:l,setCurrentFrame:d,getFrameViewPort:f,zoom:p,scroll:m,setViewPortCenter:h}}})))()}var fE,pE;function mE(){return(mE=t((()=>{KS(),dE(),fE=o(),pE=e=>{let t=uE();return(0,fE.jsx)(GS.Provider,{value:t,children:e.children})},pE.__docgenInfo={description:``,methods:[],displayName:`TimelineProvider`}})))()}var hE,gE;function _E(){return(_E=t((()=>{oC(),pC(),bC(),IC(),qC(),tw(),kT(),UT(),tE(),cE(),mE(),hE=o(),gE=()=>(0,hE.jsx)(pE,{children:(0,hE.jsx)(eE,{children:(0,hE.jsx)(`div`,{className:sE.timeline,children:(0,hE.jsxs)(`div`,{className:sE.inner,children:[(0,hE.jsx)(`div`,{className:sE.setting,children:(0,hE.jsx)(ew,{})}),(0,hE.jsx)(`div`,{className:sE.channels,children:(0,hE.jsx)(HT,{})}),(0,hE.jsxs)(`div`,{className:sE.content,children:[(0,hE.jsx)(aC,{}),(0,hE.jsx)(yC,{}),(0,hE.jsxs)(fC,{children:[(0,hE.jsx)(OT,{}),(0,hE.jsx)(FC,{})]}),(0,hE.jsx)(KC,{})]})]})})})}),gE.__docgenInfo={description:``,methods:[],displayName:`Timeline`}})))()}var vE,yE;function bE(){return(bE=t((()=>{vE=`OREditor__editor___LmVka`,yE={editor:vE}})))()}var xE,SE;function CE(){return(CE=t((()=>{xE=e(i(),1),H_(),Oy(),SE=e=>{let{engine:t}=Dy(),[n,r]=(0,xE.useState)(()=>new B_(t)),i=xE.useRef(n);return i.current=n,(0,xE.useEffect)(()=>{if(!i.current.disposed&&i.current.engine.uuid==t.uuid)return;let e=new B_(t);r(e)},[t]),(0,xE.useEffect)(()=>()=>{n.dispose()},[n]),{engine:t,editor:n,projectName:e}}})))()}var wE,TE,EE;function DE(){return(DE=t((()=>{wE=i(),H_(),Li(),CE(),TE=o(),EE=e=>{let t=SE(e.projectName),n=(0,wE.useRef)(Promise.resolve());(0,wE.useEffect)(()=>{if(!t.editor||!e.onSave)return;let r=e.onSave,i=(e,t)=>{n.current=Promise.resolve(r(e,t))};return t.editor.on(`save`,i),()=>{t.editor.off(`save`,i)}},[t.editor,e.onSave]);let r=(0,wE.useRef)(null),i=e.scenes??null;return(0,wE.useEffect)(()=>{r.current=i},[i]),(0,wE.useEffect)(()=>Zs({editor:t.editor,getScenes:()=>r.current,waitForSave:()=>n.current}),[t.editor]),(0,wE.useEffect)(()=>{t.editor&&t.editor.bootstrap(e.editorData)},[e.editorData,t.editor]),(0,TE.jsx)(Ii.Provider,{value:{...t,scenes:e.scenes,fieldUIs:e.fieldUIs},children:e.children})},EE.__docgenInfo={description:``,methods:[],displayName:`OREditorProvider`}})))()}var OE,$,kE,AE,jE,ME;function NE(){return(NE=t((()=>{OE=e(i(),1),be(),T(),we(),ba(),Aa(),my(),Sy(),rb(),Ab(),Fb(),pS(),bS(),jS(),Ax(),US(),_E(),bE(),DE(),$=o(),kE=[{id:`hierarchy`,title:`Hierarchy`,category:`General`,content:(0,$.jsx)(le,{children:(0,$.jsx)(kb,{})})},{id:`timer`,title:`Timer`,category:`Rendering`,content:(0,$.jsx)(le,{noPadding:!0,children:(0,$.jsx)(nb,{})})},{id:Ox,title:`Screen`,category:`General`,multiple:!0,content:e=>(0,$.jsx)(kx,{viewportId:e})},{id:`property`,title:`Property`,category:`General`,content:(0,$.jsx)(le,{children:(0,$.jsx)(py,{})})},{id:`textures`,title:`Textures`,category:`Rendering`,content:(0,$.jsx)(le,{noPadding:!0,children:(0,$.jsx)(HS,{})})},{id:`scene`,title:`Scene`,category:`General`,content:(0,$.jsx)(le,{children:(0,$.jsx)(AS,{})})},{id:`export`,title:`Export`,category:`Project`,content:(0,$.jsx)(le,{children:(0,$.jsx)(xy,{})})},{id:`renderer`,title:`Renderer`,category:`Rendering`,content:(0,$.jsx)(le,{children:(0,$.jsx)(yS,{})})},{id:`editor-settings`,title:`Editor`,category:`Project`,content:(0,$.jsx)(le,{children:(0,$.jsx)(ya,{})})},{id:`timeline`,title:`Timeline`,category:`Animation`,content:(0,$.jsx)(le,{noPadding:!0,children:(0,$.jsx)(gE,{})})}],AE=[`hierarchy`,`property`],jE=e=>{let t=[];for(let n of e)n.multiple||n.id!==`hierarchy`&&n.id!==`property`&&n.id!==`timeline`&&t.push({id:n.id,title:n.title,content:n.content});return t},ME=e=>{let t=Ce(),n=(0,OE.useMemo)(()=>e.panels?[...kE,...e.panels]:kE,[e.panels]),r=null;return r=t.isPC?(0,$.jsx)(fS,{panels:n,activateOnSelect:AE}):(0,$.jsx)($.Fragment,{children:(0,$.jsxs)(oe,{direction:`vertical`,storageKey:`orengine-editor-sp-main`,children:[(0,$.jsx)(oe.Item,{size:`calc( min( 56.25vw, 55vh ) + 77px )`,minSize:200,style:{minHeight:`200px`},children:(0,$.jsx)(kx,{viewportId:`main`})}),(0,$.jsx)(oe.Item,{flex:1,minSize:200,children:(0,$.jsxs)(ue,{storageKey:`orengine-panel-sp-main`,children:[(0,$.jsx)(ue.Tab,{title:`Hierarchy / Property`,children:(0,$.jsxs)(oe,{direction:`horizontal`,storageKey:`orengine-editor-sp-hierarchyProp`,children:[(0,$.jsx)(oe.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,$.jsx)(kb,{})}),(0,$.jsx)(oe.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,$.jsx)(py,{})})]})}),jE(n).map(e=>(0,$.jsx)(ue.Tab,{title:e.title,children:e.content},e.id))]})}),(0,$.jsx)(oe.Item,{size:`120px`,minSize:80,children:(0,$.jsx)(ue,{storageKey:`orengine-panel-sp-timeline`,children:(0,$.jsx)(ue.Tab,{title:`Timeline`,children:(0,$.jsx)(le,{noPadding:!0,children:(0,$.jsx)(ye,{fallback:(0,$.jsx)(`div`,{children:`エラーだよ`}),children:(0,$.jsx)(gE,{})})})})})})]})}),(0,$.jsx)(EE,{projectName:e.projectName,onSave:e.onSave,editorData:e.editorData,scenes:e.scenes,fieldUIs:e.fieldUIs,children:(0,$.jsx)(C,{children:(0,$.jsxs)(E,{children:[(0,$.jsx)(`div`,{className:yE.editor,children:r}),(0,$.jsx)(ka,{}),(0,$.jsx)(Pb,{}),(0,$.jsx)(x,{}),(0,$.jsx)(ne,{})]})})})},ME.__docgenInfo={description:``,methods:[],displayName:`OREditor`,props:{onSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( projectData: OREngineProjectData, editorData: MXP.SerializeField ) => Promise<void> | void`,signature:{arguments:[{type:{name:`OREngineProjectData`},name:`projectData`},{type:{name:`MXP.SerializeField`},name:`editorData`}],return:{name:`union`,raw:`Promise<void> | void`,elements:[{name:`Promise`,elements:[{name:`void`}],raw:`Promise<void>`},{name:`void`}]}}},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},projectName:{required:!1,tsType:{name:`string`},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}},{key:`layout`,value:{name:`union`,raw:`'inline' | 'block'`,elements:[{name:`literal`,value:`'inline'`},{name:`literal`,value:`'block'`}],required:!0}}]},required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}var PE,FE;function IE(){return(IE=t((()=>{PE=e(i(),1),fc(),Oi(),FE=()=>{let[e,t]=PE.useState(()=>new I(uc)),n=PE.useRef(e);return n.current=e,(0,PE.useEffect)(()=>{n.current.disposed&&t(new I(uc))},[]),(0,PE.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,PE.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var LE,RE,zE;function BE(){return(BE=t((()=>{LE=i(),Ty(),IE(),RE=o(),zE=e=>{let t=FE(),{engine:n}=t,r=(0,LE.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,LE.useEffect)(()=>{r.current?.(n)},[n]),(0,LE.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,RE.jsx)(wy.Provider,{value:t,children:e.children})},zE.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var VE,HE,UE,WE,GE,KE,qE;function JE(){return(JE=t((()=>{VE=i(),NE(),BE(),HE=o(),UE=`scene`,WE=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},GE=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),KE=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),qE=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,VE.useState)(e.sceneData),[a,o]=(0,VE.useState)(e.editorData),[s,c]=(0,VE.useState)([]),[l,u]=(0,VE.useState)(null),d=(0,VE.useCallback)(async e=>{let t=await WE(`${n}/scenes/${e}`);if(!t)throw Error(`シーンを読み込めません: ${e}`);u(e),i(t)},[n]);(0,VE.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([WE(`${n}/editor`),WE(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[UE]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]),(0,VE.useEffect)(()=>{l&&(document.title=`${l} | OREngine`)},[l]);let f={names:s,current:l,onSelect:d,onCreate:(0,VE.useCallback)(async(e,t)=>{let r=KE(e);if(t!==void 0){let i=await WE(`${n}/scenes/${t}`);if(!i)throw Error(`複製元のシーンを読み込めません: ${t}`);r={...i,name:e}}let i=await GE(`${n}/scenes/${e}`,r);if(!i.ok)throw Error(`シーンを作成できません: ${e}（HTTP ${i.status}）`);let a=await WE(`${n}/scenes`);a&&c(a)},[n]),onDelete:(0,VE.useCallback)(async e=>{let t=await fetch(`${n}/scenes/${e}`,{method:`DELETE`});if(!t.ok)throw Error(`シーンを削除できません: ${e}（HTTP ${t.status}）`);let r=await WE(`${n}/scenes`)??[];c(r),e===l&&r.length>0&&await d(r[0])},[n,l,d])};return(0,HE.jsx)(zE,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,HE.jsx)(ME,{editorData:a,projectName:t,panels:e.panels,fieldUIs:e.fieldUIs,scenes:f,onSave:async(t,r)=>{e.onBeforeSave?.();let i=[GE(`${n}/editor`,{...r,[UE]:l})];l&&i.push(GE(`${n}/scenes/${l}`,t));for(let e of await Promise.all(i))if(!e.ok)throw Error(`保存に失敗しました（POST ${new URL(e.url).pathname}: HTTP ${e.status}）`)}})})},qE.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}},{key:`layout`,value:{name:`union`,raw:`'inline' | 'block'`,elements:[{name:`literal`,value:`'inline'`},{name:`literal`,value:`'block'`}],required:!0}}]},required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var YE,XE;function ZE(){return(ZE=t((()=>{NE(),BE(),YE=o(),XE=e=>(0,YE.jsx)(zE,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,YE.jsx)(ME,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,fieldUIs:e.fieldUIs,onSave:()=>{}})}),XE.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}},{key:`layout`,value:{name:`union`,raw:`'inline' | 'block'`,elements:[{name:`literal`,value:`'inline'`},{name:`literal`,value:`'block'`}],required:!0}}]},required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}var QE,$E,eD;function tD(){return(tD=t((()=>{QE=`InputGroup__group___Lmdyb`,$E=`InputGroup__submit___Lmdyb`,eD={group:QE,submit:$E}})))()}var nD,rD,iD;function aD(){return(aD=t((()=>{nD=i(),T(),ia(),tD(),rD=o(),iD=e=>{let t=e.initialValues,n=[],[r,i]=(0,nD.useState)(t);(0,nD.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,rD.jsx)(ra,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,nD.useRef)(null);return(0,nD.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,rD.jsx)(`div`,{className:eD.group,ref:o,children:(0,rD.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,rD.jsx)(s,{label:e.title,noMargin:!0,children:n}),(0,rD.jsx)(`div`,{className:eD.submit,children:(0,rD.jsx)(c,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},iD.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}function oD(){return(oD=t((()=>{JE(),ZE(),NE(),DE(),R(),G_(),BE(),Oy(),Ab(),my(),Ax(),Zb(),ix(),_E(),YS(),jS(),Sy(),rb(),bS(),ba(),pa(),US(),Rv(),Hb(),ia(),bv(),aD(),Hi(),Ki(),ta(),zv(),Ia(),mv(),we()})))()}var sD;function cD(){return(cD=t((()=>{sD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var lD;function uD(){return(uD=t((()=>{lD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var dD=n({EyeRings:()=>fD}),fD;function pD(){return(pD=t((()=>{F(),cD(),uD(),fD=class extends M{constructor(e){super(e);let t=new tn({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new xn({phase:[`deferred`,`shadowMap`],frag:sD,vert:lD});this.entity.addComponent(N,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(N)}}})))()}var mD;function hD(){return(hD=t((()=>{mD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var gD;function _D(){return(_D=t((()=>{gD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var vD=n({FlashLine:()=>yD}),yD;function bD(){return(bD=t((()=>{A(),F(),hD(),_D(),yD=class extends M{geometry;material;constructor(e){super(e),this.geometry=new Nt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=je.randomVector().multiply(new O(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new xn({phase:[`forward`,`envMap`],frag:an(`flFrag`,mD),vert:an(`flVert`,gD)}),this.entity.addComponent(N,{material:this.material,geometry:this.geometry})}}})))()}var xD;function SD(){return(SD=t((()=>{xD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var CD=n({SkyBox:()=>wD}),wD;function TD(){return(TD=t((()=>{F(),SD(),wD=class extends M{material;constructor(e){super(e);let t=this.engine;this.material=new xn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:an(`SkyBoxFrag`,xD),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}}})))()}var ED;function DD(){return(DD=t((()=>{ED=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var OD;function kD(){return(kD=t((()=>{OD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var AD=n({GridCross:()=>jD}),jD;function MD(){return(MD=t((()=>{A(),F(),DD(),kD(),jD=class extends M{constructor(e){super(e);let t=new jt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new O(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new xn({frag:an(`gridCrossFrag`,ED),vert:an(`gridCrossVert`,OD),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}}})))()}var ND;function PD(){return(PD=t((()=>{ND=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var FD;function ID(){return(ID=t((()=>{FD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var LD=n({GridDots:()=>RD}),RD;function zD(){return(zD=t((()=>{A(),F(),PD(),ID(),RD=class extends M{constructor(e){super(e);let t=new Lt({radius:.1}),n=[],r=[],i=new O(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new xn({frag:an(`gridDotsFrag`,ND),vert:an(`gridDotsVert`,FD),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}}})))()}var BD;function VD(){return(VD=t((()=>{BD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
#endif\r
\r
}`})))()}var HD;function UD(){return(UD=t((()=>{HD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var WD=n({WireCube:()=>GD}),GD;function KD(){return(KD=t((()=>{F(),VD(),UD(),GD=class extends M{constructor(e){super(e);let t=3.3,n=t/2,r=new jt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new xn({phase:[`deferred`],frag:BD,vert:HD});this.entity.addComponent(N,{geometry:r,material:o})}}})))()}var qD=n({FieldUISample:()=>JD}),JD;function YD(){return(YD=t((()=>{A(),F(),JD=class extends M{speed;wave;rotQuaternion;constructor(e){super(e),this.speed=1,this.wave=.5,this.rotQuaternion=new ke,this.field(`speed`,()=>this.speed,e=>this.speed=e,{step:.1}),this.field(`wave`,()=>this.wave,e=>this.wave=e,{step:.05,min:0})}updateImpl(e){this.rotQuaternion.setFromEuler(new De(0,e.timeDelta*this.speed,0)),this.entity.quaternion.multiply(this.rotQuaternion),this.entity.position.y=Math.sin(e.timeElapsed*2)*this.wave}}})))()}var XD;function ZD(){return(ZD=t((()=>{XD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var QD;function $D(){return($D=t((()=>{QD=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var eO=n({OREngineCube:()=>tO}),tO;function nO(){return(nO=t((()=>{F(),Pi(),ZD(),$D(),tO=class extends M{material;constructor(e){super(e),this.material=new xn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:an(`OREngineCubeVert`,QD),frag:an(`OREngineCubeFrag`,XD),uniforms:{uNoiseTex:{value:I.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(N);t&&(t.material=this.material)}}})))()}var rO;function iO(){return(iO=t((()=>{rO=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var aO;function oO(){return(oO=t((()=>{aO=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var sO=n({OREngineLogo:()=>cO}),cO;function lO(){return(lO=t((()=>{F(),iO(),oO(),cO=class extends M{material;constructor(e){super(e),this.material=new xn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:an(`OREngineLogoVert`,aO),frag:an(`OREngineLogoFrag`,rO)});let t=this.entity.getComponent(N);t&&(t.material=this.material)}}})))()}var uO;function dO(){return(dO=t((()=>{uO=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var fO;function pO(){return(pO=t((()=>{fO=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var mO=n({Dust:()=>hO}),hO;function gO(){return(gO=t((()=>{A(),F(),dO(),pO(),hO=class extends M{constructor(e){super(e);let t=new kt,n=e.args?.num||2048,r=new O(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new xn({phase:[`forward`],drawType:`POINTS`,frag:uO,vert:fO});this.entity.addComponent(N,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(N)}}})))()}var _O;function vO(){return(vO=t((()=>{_O=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var yO;function bO(){return(bO=t((()=>{yO=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var xO;function SO(){return(SO=t((()=>{xO=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `})))()}var CO=n({YakiSoba:()=>wO}),wO;function TO(){return(TO=t((()=>{A(),F(),vO(),bO(),SO(),wO=class extends M{_gpu;constructor(e){super(e);let t=this.engine,n=new O(64,512);this._gpu=new li({passes:[new fi(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:an(`yakiSobaCompute`,xO),uniforms:mn.merge({},t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new jt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new xn({frag:an(`chainFrag`,_O),vert:an(`chainVert`,yO),phase:[`deferred`,`shadowMap`],uniforms:mn.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(N,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(N),this._gpu.dispose()}}})))()}var EO;function DO(){return(DO=t((()=>{EO=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var ok;function sk(){return(sk=t((()=>{ak(),ok={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:ik}})))()}var ck;function lk(){return(lk=t((()=>{ck=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var uk;function dk(){return(dk=t((()=>{lk(),uk={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:ck}})))()}var fk;function pk(){return(pk=t((()=>{fk=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var mk;function hk(){return(hk=t((()=>{pk(),mk={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:fk}})))()}var gk;function _k(){return(_k=t((()=>{pk(),gk={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:fk}})))()}var vk,yk,bk;function xk(){return(xk=t((()=>{sk(),dk(),hk(),_k(),Pi(),vk=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":ok,"/demo-webgl/Resources/Textures/noise.tex":uk,"/demo-webgl/Resources/Textures/noiseCyclic.tex":mk,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":gk}),yk=()=>{for(let e of Object.values(vk))e&&I.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},bk=e=>{I.resources.buildTextureInstances(e.renderer)}})))()}var Sk,Ck,wk,Tk,Ek;function Dk(){return(Dk=t((()=>{pD(),bD(),TD(),MD(),zD(),KD(),YD(),nO(),lO(),gO(),TO(),AO(),fc(),Pi(),rk(),xk(),Sk=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":dD,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":vD,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":CD,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":AD,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":LD,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":WD,"/demo-webgl/Resources/Components/Samples/Objects/FieldUISample/index.ts":qD,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":eO,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":sO,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":mO,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":CO,"/demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":OO}),Ck=Object.assign({}),wk=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);wk(a,e)}}},Tk=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);Tk(a,e)}}},Ek=()=>{Ct.gltfLoaderFactory=e=>new ic(e),I.resources.clear();let e=I.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Ut),e.addComponent(`Camera`,zt),e.addComponent(`Mesh`,N);let t=Object.keys(tk);for(let e=0;e<t.length;e++){let n=t[e],r=tk[n],i=I.resources.addComponentGroup(n);wk(r,i)}let n=Object.keys(nk);for(let e=0;e<n.length;e++){let t=n[e],r=nk[t],i=I.resources.addGeometryGroup(t);Tk(r,i)}let r=Ci(Sk,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=I.resources.addComponentGroup(t);wk(n,a)}let a=Ci(Ck,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=I.resources.addGeometryGroup(t);Tk(n,r)}yk()}})))()}var Ok,kk,Ak,jk,Mk,Nk;function Pk(){return(Pk=t((()=>{Ok=i(),oD(),T(),Dk(),kk=o(),Ek(),Ak=({setup:e})=>{let{editor:t}=L();return(0,Ok.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},jk=e=>(0,kk.jsx)(zE,{project:e.fixture.scene,onEngineInit:bk,children:(0,kk.jsx)(EE,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,kk.jsx)(C,{children:(0,kk.jsxs)(E,{children:[e.children,e.fixture.setup&&(0,kk.jsx)(Ak,{setup:e.fixture.setup}),(0,kk.jsx)(x,{}),(0,kk.jsx)(ne,{})]})})})}),Mk=e=>t=>(0,kk.jsx)(jk,{fixture:e,children:(0,kk.jsx)(t,{})}),Nk=e=>t=>(0,kk.jsx)(zE,{project:e,onEngineInit:bk,children:(0,kk.jsx)(t,{})}),jk.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var Fk,Ik,Lk,Rk,zk;function Bk(){return(Bk=t((()=>{Fk={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`LookAt`,uuid:`sb-camera-lookat`}]},Ik={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[Fk,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},Lk={...Ik,scene:{name:`root`,uuid:`0`,childs:[Fk]}},Rk={enableRender:!0,"viewports/main/resolutionScale":.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},zk={scene:Ik,editorData:Rk}})))()}export{ya as A,R as B,Sy as C,Rv as D,Lv as E,ta as F,Pi as H,Gi as I,Ki as L,ra as M,ia as N,yv as O,ea as P,Vi as R,xy as S,my as T,I as U,L as V,Oi as W,jS as _,Ik as a,kb as b,Mk as c,aD as d,ME as f,AS as g,_E as h,zk as i,ba as j,bv as k,Nk as l,gE as m,Rk as n,jk as o,NE as p,Lk as r,Pk as s,Bk as t,iD as u,yS as v,py as w,Ab as x,bS as y,Hi as z};