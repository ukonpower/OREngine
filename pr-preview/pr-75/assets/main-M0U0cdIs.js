...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}},Gt=class extends Tt{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}},P=class extends Wt{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Jt=class extends gt{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA,magFilter:j.LINEAR,minFilter:j.LINEAR,wrapS:j.CLAMP_TO_EDGE,wrapT:j.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new k(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA})])});let m=1/4*l,h=new P(e,{renderTarget:s[l].rt1,frag:qt,uniforms:Ht.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new k(d,f));let g=new P(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new Gt({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}},Yt=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}},Xt=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,tn=e=>{let t=[];for(let n=0;n<e;n++){let r=new k;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},nn=class extends gt{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;shading;constructor(e){super();let t=e.backend,n=new P(t,{name:`normalSelector`,frag:Qt,renderTarget:null,uniforms:Ht.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),r=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),a=new P(t,{name:`lightShaft`,frag:Zt,renderTarget:r,uniforms:Ht.merge({uLightShaftBackBuffer:{value:i.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),c=new P(t,{name:`ssao`,frag:$t,renderTarget:zt(`ssao`,o),uniforms:Ht.merge({uSSAOBackBuffer:{value:s.textures[0],type:`1i`},uSSAOKernel:{value:tn(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),l=Ht.merge({uSSAOTexture:{value:s.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:nt.gaussWeights(8)}}),u=new P(t,{name:`ssaoBlur/h`,frag:zt(`ssaoBlur`,en),uniforms:l,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),d=new P(t,{name:`ssaoBlur/v`,frag:zt(`ssaoBlur`,en),uniforms:Ht.merge(l,{uSSAOTexture:{value:u.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),f=new P(t,{name:`deferredShading`,frag:zt(`deferredShading`,Xt),uniforms:Ht.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:c.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})});this.postprocess=new Gt({passes:[n,a,c,u,d,f]}),this.shading=f,this.lightShaft=a,this.ssao=c,this.rtSSAO1=o,this.rtSSAO2=s,this.ssaoBlur=u,this.ssaoBlurV=d,this.rtLightShaft1=r,this.rtLightShaft2=i,this.normalSelector_=n;let p=e.renderTarget;for(let e=0;e<p.gBuffer.textures.length;e++){let t=p.gBuffer.textures[e];e===1&&(t=p.normalBuffer.textures[0]),f.uniforms[`sampler`+e]=c.uniforms[`sampler`+e]={type:`1i`,value:t}}u.uniforms.uDepthTexture.value=p.gBuffer.textures[0],a.uniforms.uDepthTexture.value=p.gBuffer.depthTexture,f.renderTarget=p.shadingBuffer,n.renderTarget=p.normalBuffer,n.uniforms.uNormalTexture.value=p.gBuffer.textures[1],n.uniforms.uPosTexture.value=p.gBuffer.textures[0],n.uniforms.uSelectorTexture.value=p.gBuffer.textures[3],l.uNormalTexture.value=p.normalBuffer.textures[0]}update(){let e=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=e,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],e=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=e,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}resize(e){this.postprocess.resize(e)}dispose(){this.postprocess.dispose(),this.rtLightShaft1.dispose(),this.rtLightShaft2.dispose(),this.rtSSAO1.dispose(),this.rtSSAO2.dispose()}},rn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`,Bn=`uniform sampler2D uBackBuffer0;
...
}`,tr=`uniform sampler2D uShadingTexture;
...
}`,rr=class extends Gt{constructor(e){let t=[],n=[];for(let r=0;r<4;r++)t.push(e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})])),n.push(e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]));let r=2,i=new P(e,{name:`bloom/bright/`,frag:tr,passThrough:!0,uniforms:{uThreshold:{value:1.8,type:`1f`},uBrightness:{value:1,type:`1f`}},resolutionRatio:1/r}),a=[],o=i.renderTarget.textures;for(let i=0;i<4;i++){let s=t[i],c=n[i],l={name:`bloom/blur/`+i+`/v`,renderTarget:s,frag:er,uniforms:{uBackBlurTex:{value:o,type:`1i`},uIsVertical:{type:`1i`,value:!0},uWeights:{type:`1fv`,value:nt.gaussWeights(8)},uBlurRange:{value:2,type:`1f`}},defines:{GAUSS_WEIGHTS:`8`,USE_BACKBLURTEX:``},passThrough:!0,resolutionRatio:1/r};a.push(new P(e,l)),a.push(new P(e,{...l,name:`bloom/blur/`+i+`/h`,renderTarget:c,uniforms:{...l.uniforms,uBackBlurTex:{value:s.textures[0],type:`1i`},uIsVertical:{type:`1i`,value:!1}}})),o=c.textures,r*=2}let s=new P(e,{name:`bloom/composite/`,frag:nr,uniforms:{uBloomTexture:{value:n.map(e=>e.textures[0]),type:`1iv`}}});super({name:`Bloom`,passes:[i,...a,s]})}get threshold(){return this.passes[0].uniforms.uThreshold.value}set threshold(e){this.passes[0].uniforms.uThreshold.value=e}get brightness(){return this.passes[0].uniforms.uBrightness.value}set brightness(e){this.passes[0].uniforms.uBrightness.value=e}},ir=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor = vec4( col, 1.0 );\r
\r
}`,ar=class extends Gt{constructor(e){super({name:`ColorGrading`,passes:[new P(e,{frag:ir})]})}},or=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor = vec4( col, 1.0 );\r
\r
}`,sr=class extends Gt{constructor(e){super({name:`Finalize`,passes:[new P(e,{frag:or})]})}},cr=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`,lr=class extends Gt{constructor(e){super({name:`FXAA`,passes:[new P(e,{name:`fxaa`,frag:cr})]})}},ur=(e,t)=>{let n=t.addComponent(Ut),r=e.renderer.backend,i=new rr(r);return i.threshold=1,i.brightness=1,n.add(new lr(r)),n.add(i),n.add(new ar(r)),n.add(new sr(r)),()=>{t.removeComponent(Ut)}},dr=class{static serializeEntity(e,t){let n=e=>{let r=[];e.children.forEach(e=>{e.initiator!=`script`&&r.push(n(e))});let i=[];e.components.forEach(e=>{let n=e.serialize({mode:`export`}),r=Object.keys(n).length>0;if(e.initiator!==`user`)return;let a={name:t.getName(e),uuid:e.uuid};r&&(a.props=n),i.push(a)});for(let t of e.unresolvedComponents)i.push({name:t.name,uuid:t.uuid,props:t.props});return{name:e.name,uuid:e.uuid,pos:e.position.x==0&&e.position.y==0&&e.position.z==0?void 0:e.position.getElm(`vec3`),rot:e.euler.x==0&&e.euler.y==0&&e.euler.z==0?void 0:e.euler.getElm(`vec3`),scale:e.scale.x==1&&e.scale.y==1&&e.scale.z==1?void 0:e.scale.getElm(`vec3`),components:i.length>0?i:void 0,childs:r.length>0?r:void 0}};return n(e)}static deserializeEntity(e,t,n,r){let i=(e,t)=>{let a=t||r.createEntity();a.initiator=`user`,a.name=e.name,a.restoreUUID(e.uuid);let o=e.pos||[0,0,0];a.position.x=o[0],a.position.y=o[1],a.position.z=o[2];let s=e.rot||[0,0,0];a.euler.x=s[0],a.euler.y=s[1],a.euler.z=s[2];let c=e.scale||[1,1,1];return a.scale.x=c[0],a.scale.y=c[1],a.scale.z=c[2],a.unresolvedComponents=[],e.components&&e.components.forEach(e=>{let t=n.resolve(e.name);if(t){let n=a.getComponent(t.component);n||(n=a.addComponent(t.component),n.initiator=`user`),n.restoreUUID(e.uuid),e.props&&n.deserialize(e.props)}else console.warn(`[ProjectSerializer] Component "${e.name}" not found in resolver. Preserving data for round-trip.`),a.unresolvedComponents.push({name:e.name,uuid:e.uuid,props:e.props})}),e.childs&&([...a.children].forEach(e=>{e.initiator!==`script`&&a.remove(e)}),e.childs.forEach(e=>{a.add(i(e))})),a};e&&i(e,t),t.initiator=`god`}},fr=class extends Tt{name;_frag;_resolution;_filter;_updateEveryFrame;_textures;constructor(e,t){super(),this.name=e;let n=t.data;this._frag=n?.frag||``,this._resolution=n?.resolution||[1024,1024],this._filter=n?.filter||`linear`,this._updateEveryFrame=n?.updateEveryFrame??!1,this._textures=n?.textures||{}}get frag(){return this._frag}get resolution(){return this._resolution}get filter(){return this._filter}get updateEveryFrame(){return this._updateEveryFrame}get textures(){return this._textures}},pr=(e,t)=>{let n={},r=`/${t}/`;for(let[t,i]of Object.entries(e)){let e=t.slice(t.lastIndexOf(r)+r.length).split(`/`).slice(0,-2),a=Object.entries(i).find(([e,t])=>typeof t==`function`&&/^[A-Z]/.test(e));if(!a)continue;let o=n;for(let t of e)o=o[t]=o[t]||{};o[a[0]]=a[1]}return n},mr=class extends gt{_componentList;_componentGroups;_geometryList;_geometryGroups;_textureResources;_textures;_updateEveryFrameTextures;constructor(){super(),this._componentList=[],this._textures=new Map,this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources=new Map,this._updateEveryFrameTextures=[]}get componentList(){return this._componentList}get componentGroups(){return this._componentGroups}get geometryList(){return this._geometryList}get geometryGroups(){return this._geometryGroups}get textureList(){return Array.from(this._textureResources.values())}get textures(){return this._textures}get updateEveryFrameTextures(){return this._updateEveryFrameTextures}clear(){this._componentList=[],this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources.clear(),this._textures.clear(),this._updateEveryFrameTextures=[],this.emit(`update`)}getComponent(e){return this._componentList.find(t=>t.name==e)}getComponentName(e){let t=this._componentList.find(t=>e instanceof t.component);return t?t.name:e.constructor.name}addComponentGroup(e){let t=this._componentGroups.find(t=>t.name==e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addComponent:(e,n)=>{let r={name:e,component:n};t.push(r),this._componentList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._componentGroups.push(t),this.emit(`update`),t}getGeometry(e){return this._geometryList.find(t=>t.name===e)}addGeometryGroup(e){let t=this._geometryGroups.find(t=>t.name===e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addGeometry:(e,n)=>{let r={name:e,geometryClass:n};t.push(r),this._geometryList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._geometryGroups.push(t),this.emit(`update`),t}addTextureResource(e,t){let n=new fr(e,{data:t});this._textureResources.set(e,n),this.emit(`update`)}getTextureResource(e){return this._textureResources.get(e)}removeTextureResource(e){this._textureResources.delete(e);let t=this._textures.get(e);t&&(t.dispose(),this._textures.delete(e)),this.emit(`update`)}addTexture(e,t){return this._textures.set(e,t),t}getTexture(e){return this._textures.get(e)}_buildTexture(e,t,n,r){let i=e.frag;return i?t.createTexProcedural({name:e.name,frag:i,resolution:new k(e.resolution[0]||1024,e.resolution[1]||1024),filter:e.filter,textures:n,uniforms:e.updateEveryFrame?r:void 0}):null}_ensureTexture(e,t,n,r){let i=this._textures.get(e.name);if(i)return i;if(r.has(e.name))return null;r.add(e.name);let a={},o=e.textures,s=Object.keys(o);for(let e=0;e<s.length;e++){let i=s[e],c=o[i],l=this._textureResources.get(c),u=l?this._ensureTexture(l,t,n,r):this._textures.get(c);u&&(a[i]=u)}let c=this._buildTexture(e,t,a,n);return c?(this._textures.set(e.name,c),e.updateEveryFrame&&this._updateEveryFrameTextures.push(c),c):null}buildTextureInstances(e,t){this._updateEveryFrameTextures=[];let n=new Set;this._textureResources.forEach(r=>{this._ensureTexture(r,e,t,n)}),this.emit(`update`)}},hr={duration:600,fps:30},gr=class e extends Tt{static resources;name;_renderer;_root;_uniforms;_time;_frame;_frameSetting;_disposed;_frameEvent;constructor(e){super(),this.name=`OREngine`,this._disposed=!1,this._uniforms={uEnvMapIntensity:{value:1,type:`1f`}},this._renderer=e(this),this._renderer.globalUniforms={uTime:{value:0,type:`1f`},uTimeF:{value:0,type:`1f`},uTimeE:{value:0,type:`1f`},uTimeEF:{value:0,type:`1f`},uDeltaTime:{value:0,type:`1f`},uResolution:{value:new k,type:`2fv`},uAspectRatio:{value:1,type:`1f`}},this._time={current:new Date().getTime(),engine:0,delta:0,code:0},this._frameSetting={...hr},this._frame={current:0,playing:!1},this.seek(0),this._frameEvent=null,this._root=this.createEntity({name:`root`}),this._root.initiator=`god`,this.field(`name`,()=>this.name,e=>this.name=e),this.field(`scene`,()=>dr.serializeEntity(this._root,this._createComponentResolver()),e=>{dr.deserializeEntity(e,this._root,this._createComponentResolver(),this)}),this.field(`renderer`,()=>this._renderer.serialize({mode:`export`}),e=>this._renderer.deserialize(e));let t=this.fieldDir(`timeline`);t.field(`duration`,()=>this._frameSetting.duration,e=>this._frameSetting.duration=e),t.field(`fps`,()=>this._frameSetting.fps,e=>this._frameSetting.fps=e)}createEntity(e){return new It({engine:this,...e})}get canvas(){return this._renderer.canvas}get renderer(){return this._renderer}get root(){return this._root}get frame(){return this._frame}get time(){return this._time}get frameSetting(){return this._frameSetting}get uniforms(){return this._uniforms}get disposed(){return this._disposed}createView(e){return this._renderer.createView(e)}_createComponentResolver(){return{resolve:t=>e.resources.getComponent(t),getName:t=>e.resources.getComponentName(t)}}init(){this._root.disposeRecursive(),this._root.position.set(0,0,0),this._root.euler.set(0,0,0),this._root.scale.set(1,1,1),this.name=`New Project`,this._renderer.reset(),Object.assign(this._frameSetting,hr),this.stop(),this.seek(0)}async load(e){this.init(),this.deserialize(e),this.emit(`update/graph`),this.emit(`loaded`)}update(t){let n=new Date().getTime();this._time.delta=(n-this._time.current)/1e3,this._time.current=n,this._time.engine+=this._time.delta,this._time.code+=this._time.delta*+!!this._frame.playing,this._frame.current=this._time.code*60;let r=this.createEntityUpdateEvent({forceDraw:t?.forceDraw});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1,this._renderer.globalUniforms.uDeltaTime.value=Math.min(this._time.delta,1/60);let i=e.resources.updateEveryFrameTextures;for(let e=0;e<i.length;e++)i[e].render();return this._step(r),this._frame.playing&&this.emit(`update/frame/play`,[this._frame]),this._time.delta}_step(e){this._root.commitFrame(e),this._root.update(e),this._root.postUpdate(e),this._root.updateMatrixRecursive(),this._root.prepareRender(e),this._renderer.prepareScene(this._root,e),this._frameEvent=e}render(e){this._frameEvent&&this._renderer.render(e,this._frameEvent)}createEntityUpdateEvent(e){let t={playing:this._frame.playing,timeElapsed:this._time.engine,timeDelta:this._time.delta,timeCode:this._time.code,timeCodeFrame:this._frame.current,resolution:this.renderer.resolution,renderer:this.renderer,forceDraw:!1};return e?{...t,...e}:t}setSize(e){this._renderer.resize(e),this._renderer.canvas.width=e.x,this._renderer.canvas.height=e.y,this._renderer.globalUniforms.uResolution.value.copy(e),this._renderer.globalUniforms.uAspectRatio.value=e.x/Math.max(e.y,1)}play(){this._frame.playing=!0,this._time.current=new Date().getTime()}stop(){this._frame.playing=!1}seek(e){this._time.code=e/60,this._frame.current=e,this.emit(`update/frame/play`,[this._frame])}updateOffline(t,n){let r=t/n,i=1/n;this._time.delta=i,this._time.current=new Date().getTime(),this._time.engine+=i,this._time.code=r,this._frame.current=r*60,this._frame.playing=!0;let a=this.createEntityUpdateEvent({forceDraw:!0});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1;let o=e.resources.updateEveryFrameTextures;for(let e=0;e<o.length;e++)o[e].render();this._step(a)}compileShaders(e,t){let n=this.createEntityUpdateEvent({forceDraw:!0});return this.renderer.compileShaders(this._root,e,n,t)}dispose(){this._disposed=!0,this._root.disposeRecursive()}};gr.resources=new mr;var _r=class extends gt{_pressedKeys;constructor(){super(),this._pressedKeys={};let e=this._onKeyDown.bind(this),t=this._onKeyUp.bind(this);window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,t),this.once(`dispose`,()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,t)})}get pressedKeys(){return this._pressedKeys}_onKeyDown(e){this._pressedKeys[e.key]=!0,this.emit(`keydown`,[e,this._pressedKeys])}_onKeyUp(e){if(this._pressedKeys[e.key]=!1,e.key==`Meta`||e.key==`Control`){let e=Object.keys(this._pressedKeys);for(let t=0;t<e.length;t++)this._pressedKeys[e[t]]=!1}this.emit(`keyup`,[e,this._pressedKeys])}dispose(){this.emit(`dispose`)}},vr=class extends gt{_isTouching;element=null;position;delta;constructor(){super(),this.position=new k(NaN,NaN),this.delta=new k(NaN,NaN),this._isTouching=!1;let e=this._onPointer.bind(this,`move`),t=this._onPointer.bind(this,`end`);window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`dragend`,t);let n=()=>{this.element&&this.removeElement(this.element),window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`dragend`,t),this.off(`dispose`,n)};this.on(`dispose`,n)}setElement(e){this.element&&this.removeElement(this.element),this.element=e;let t=this._onPointer.bind(this,`start`);e.addEventListener(`pointerdown`,t);let n=r=>{e.isEqualNode(r.elm)&&(e.removeEventListener(`pointerdown`,t),this.off(`unregister`,n))};this.on(`unregister`,n)}removeElement(e){this.emit(`unregister`,[e])}getScreenPosition(e){if(this.position.x!=this.position.x)return new k(NaN,NaN);let t=this.position.clone().divide(e).multiply(2).sub(1);return t.y*=-1,t}getRelativePosition(e,t){let n=e.getClientRects()[0],r=this.position.x-n.left,i=this.position.y-n.top;return t&&(r/=n.width,i/=n.height),new k(r,i)}_setPos(e,t){this.position.x!==this.position.x||this.position.y!==this.position.y?this.delta.set(0,0):this.delta.set(e-this.position.x,t-this.position.y),this.position.set(e,t)}_onPointer(e,t){let n=t.pointerType;(n==null||n==`mouse`&&(t.button==-1||t.button==0)||n==`touch`)&&this._touchEventHandler(t.pageX,t.pageY,e,t)}_touchEventHandler(e,t,n,r){let i=!1,a=e-window.pageXOffset,o=t-window.pageYOffset;n==`start`?(this._isTouching=!0,this._setPos(a,o),this.delta.set(0,0),i=!0):n==`move`?(this._setPos(a,o),this._isTouching&&(i=!0)):n==`end`&&(`targetTouches`in r?r.targetTouches.length==0&&(this._isTouching=!1):this._isTouching=!1,i=!0),i&&this.emit(n,[{pointerEvent:r,position:this.position.clone(),delta:this.delta.clone()}])}dispose(){this.emit(`dispose`)}},yr=(0,b.createContext)(null),br=()=>{let e=(0,b.useContext)(yr);if(e===null)throw Error(`useEditor must be used within a EditorProvider`);return e},xr=e=>{let{engine:t}=br(),n=(0,b.useCallback)(()=>{let e=[{label:`(None)`,value:``}];return t.root.traverse(n=>{n.components.forEach(r=>{e.push({label:`${n.getScenePath(t.root)} > ${gr.resources.getComponentName(r)}`,value:r.uuid})})}),e},[t]),[r,i]=(0,b.useState)(n);return(0,b.useEffect)(()=>{let e=()=>i(n());return t.on(`update/graph`,e),()=>{t.off(`update/graph`,e)}},[t,n]),(0,T.jsx)(Ee,{value:e.value||``,selectList:r,onChange:t=>{e.onChange&&e.onChange(t||null)}})},Sr=e=>{let{engine:t}=br(),n=(0,b.useCallback)(()=>{let e=[{label:`(None)`,value:``}];return t.root.traverse(n=>{e.push({label:n.getScenePath(t.root),value:n.uuid})}),e},[t]),[r,i]=(0,b.useState)(n);return(0,b.useEffect)(()=>{let e=()=>i(n());return t.on(`update/graph`,e),()=>{t.off(`update/graph`,e)}},[t,n]),(0,T.jsx)(Ee,{value:e.value||``,selectList:r,onChange:t=>{e.onChange&&e.onChange(t||null)}})},Cr={inputResourceSelect:`InputResourceSelect__inputResourceSelect___Lmluc`,select:`InputResourceSelect__select___Lmluc`,editButton:`InputResourceSelect__editButton___Lmluc`},wr=e=>{let{editor:t}=br(),n=(0,b.useCallback)(()=>{e.value&&(t.setField(`navigateAsset`,{assetType:e.resourceType,name:String(e.value)}),t.setField(`selectedAsset`,{name:String(e.value),assetType:e.resourceType}))},[t,e.value,e.resourceType]);return(0,T.jsxs)(`div`,{className:Cr.inputResourceSelect,children:[(0,T.jsx)(`div`,{className:Cr.select,children:(0,T.jsx)(Ee,{value:e.value,selectList:e.selectList,onChange:e.onChange})}),e.value&&(0,T.jsx)(`button`,{className:Cr.editButton,onClick:n,title:`Edit resource`,children:`✎`})]})},Tr=e=>{let t=null,n=e.onChange,r=e.value,i=e.format,a=e=>{n&&n(e)};if(i&&(i.type==`entity`?t=(0,T.jsx)(Sr,{value:r,onChange:a}):i.type==`component`?t=(0,T.jsx)(xr,{value:r,onChange:a}):i.type==`vector`&&Array.isArray(r)?t=(0,T.jsx)(Ze,{value:r,onChange:a}):i.type==`color`&&Array.isArray(r)?t=(0,T.jsx)(_e,{value:r,onChange:a}):i.type==`select`?t=(0,T.jsx)(Ee,{value:r,onChange:a,selectList:i.list}):i.type==`resource`&&(t=(0,T.jsx)(wr,{value:r,onChange:a,selectList:i.list,resourceType:i.resourceType}))),r==null)return t;if(!t){if(typeof r==`number`)t=(0,T.jsx)(we,{...e,value:r,onChange:a});else if(typeof r==`string`)t=(0,T.jsx)(Oe,{...e,value:r,onChange:a});else if(typeof r==`boolean`)t=(0,T.jsx)(pe,{...e,checked:r,onChange:a});else if(typeof r==`function`){let n=e.label||`Run`;t=(0,T.jsx)(ae,{onClick:()=>{r()},children:n})}else t=(0,T.jsx)(Oe,{...e,value:JSON.stringify(r),onChange:()=>{}})}return t},Er={showAudioView:!0},Dr=`orengine-editor-ui-settings`,Or=(()=>{try{let e=localStorage.getItem(Dr);if(e)return{...Er,...JSON.parse(e)}}catch{}return{...Er}})(),kr=new Set,Ar=e=>(kr.add(e),()=>{kr.delete(e)}),jr=e=>[(0,b.useSyncExternalStore)(Ar,()=>Or[e]),(0,b.useCallback)(t=>{Or={...Or,[e]:t};try{localStorage.setItem(Dr,JSON.stringify(Or))}catch{}kr.forEach(e=>e())},[e])],Mr={editorSettings:`EditorSettings__editorSettings___LmVka`,editorSettings_inner:`EditorSettings__editorSettings_inner___LmVka`},Nr=()=>{let[e,t]=jr(`showAudioView`);return(0,T.jsx)(`div`,{className:Mr.editorSettings,children:(0,T.jsx)(`div`,{className:Mr.editorSettings_inner,children:(0,T.jsx)(re,{label:`View`,accordion:!0,children:(0,T.jsx)(Ie,{title:`AudioView`,children:(0,T.jsx)(Tr,{value:e,onChange:e=>t(e)})})})})})},Pr=(0,b.createContext)(void 0),Fr=(e,t)=>{let[n,r]=(0,b.useState)(()=>e?e.serialize():{}),i=t?[...t]:[],a=(0,b.useMemo)(()=>i,i);return(0,b.useEffect)(()=>{if(e===void 0)return;r(e.serialize());let t=t=>{let n=a.length==0;for(let e=0;e<a.length;e++)if(t.find(t=>t==a[e])){n=!0;break}n&&r(e.serialize())};return e.on(`fields/update`,t),()=>{e.off(`fields/update`,t)}},[e,a]),{fields:n}},Ir=e=>(Fr(e.target),{target:e.target}),Lr=()=>{let e=(0,b.useContext)(Pr);if(!e)throw Error(`SerializeFieldViewContext is not defined`);return e},Rr={container:`ValueArray__container___LmNvb`},zr=e=>{let t=[],n=e.value,r=e.format,i=r?.type==`array`?r.labels:void 0;if(n===void 0)return null;for(let r=0;r<n.length;r++){let a=n[r],o=r.toString();i&&(o+=`/ `+i(a,r)),t.push((0,T.jsx)(Ie,{title:o,children:(0,T.jsx)(Tr,{...e,value:a,onChange:t=>{let i=n.concat();i[r]=t,e.onChange&&e.onChange(i)}})},r))}return(0,T.jsx)(`div`,{className:Rr.container,children:t})},Br={action:`SerializeFieldViewValue__action___LmFjd`},Vr=e=>{let{editor:t}=br(),{target:n}=Lr(),r=e.field.value,i=typeof r,a=e.field.opt,o=a?.format,s=a?.label||e.path.split(`/`).pop(),c=o&&o.type==`vector`,l=null;if(Array.isArray(r))l=o?.type==`vector`?(0,T.jsx)(Ze,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}}):o?.type==`color`?(0,T.jsx)(_e,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}}):(0,T.jsx)(zr,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}});else if(l=(0,T.jsx)(Tr,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}}),i===`function`)return(0,T.jsx)(`div`,{className:Br.action,children:l});return(0,T.jsx)(Ie,{title:s,vertical:c,children:l})},Hr={container:`SerializeFieldViewDir__container___LmNvb`,field:`SerializeFieldViewDir__field___LmNvb`,block:`SerializeFieldViewDir__block___LmNvb`},Ur=e=>{let t=[],n=Object.keys(e.fields.childs);for(let r=0;r<n.length;r++){let i=n[r],a=e.fields.childs[i],{opt:o}=a,s=!1;if(o&&(s=typeof o.hidden==`function`?o.hidden(a.type==`value`?a.value:null):o.hidden||!1),s)continue;let c=`field`+i,l=(e.basePath?e.basePath+`/`:``)+i,u=null;u=a.type===`value`?(0,T.jsx)(Vr,{path:l,field:a},c):(0,T.jsx)(`div`,{className:Hr.block,children:(0,T.jsx)(re,{accordion:!0,label:i,children:(0,T.jsx)(Ur,{fields:a,basePath:l})},c)},c),u&&t.push(u)}return(0,T.jsx)(`div`,{className:Hr.container,children:t})},Wr=e=>{let t=Ir(e),n=t.target.serializeToDirectory();if(e.filter){let t=n.childs[e.filter];t&&t.type===`folder`&&(n=t)}return(0,T.jsx)(Pr.Provider,{value:t,children:(0,T.jsx)(Ur,{fields:n,basePath:e.filter})})},F=(e,t)=>{let n=n=>{e?.setField(t,n)},{fields:r}=Fr(e,[t]);return[r&&r[t],n]},Gr=(0,b.createContext)(void 0),Kr=()=>(0,b.useContext)(Gr),qr={directory:`TreeMenu__directory___LmRpc`,subDirectory:`TreeMenu__subDirectory___LmRpc`,treeMenu:`TreeMenu__treeMenu___LmRpc`},Jr=e=>{let t=Kr(),[n,r]=(0,b.useState)(!1),i=e.item,a=null,o=`item`;if(`children`in i){o=`dir`,a=[];for(let e=0;e<i.children.length;e++)a.push((0,T.jsx)(Jr,{item:i.children[e]},e))}let s=e=>{if(`onClick`in i){i.onClick();return}e.stopPropagation(),r(!n)},c=window.matchMedia(`(hover: hover)`).matches,l,u;return c&&(l=()=>r(!0),u=()=>r(!1)),(0,T.jsxs)(`div`,{className:qr.directory,onPointerEnter:l,onPointerLeave:u,onClick:s,"data-type":o,"data-direction":t?.direction,children:[i.label,n&&a&&(0,T.jsx)(`div`,{className:qr.subDirectory,children:a})]})},Yr=e=>{let t=[];for(let n=0;n<e.items.length;n++)t.push((0,T.jsx)(Jr,{item:e.items[n]},n));return(0,T.jsx)(`div`,{className:qr.treeMenu,children:t})},Xr=(0,b.createContext)(null),Zr=()=>{let e=(0,b.useContext)(Xr);if(e===null)throw Error(`useMouseMenu must be used within a MouseMenuProvider`);return e},Qr={compAdd:`ComponentAdd__compAdd___LmNvb`},$r=(e,t)=>{let n=e.name;if(n.startsWith(`_`)&&(n=n.slice(1)),`child`in e){let r=[];for(let n of e.child)r.push($r(n,t));return{label:n,children:r}}return{label:n,onClick:()=>t(e)}},ei=e=>{let{editor:t}=br(),{pushContent:n,closeAll:r}=Zr(),i=gr.resources,a=(0,b.useCallback)(a=>{if(!i)return;let o=n=>{t.api.addComponent(e.entity,n.component),r()},s=[];for(let e of i.componentGroups)s.push($r(e,o));n((0,T.jsx)(Yr,{items:s}))},[n,i,e.entity,r,t]);return(0,T.jsx)(`div`,{className:Qr.compAdd,children:(0,T.jsx)(ae,{onClick:a,children:`Add Component`})})},ti={compoView:`ComponentView__compoView___LmNvb`,head:`ComponentView__head___LmNvb`,name:`ComponentView__name___LmNvb`,check:`ComponentView__check___LmNvb`,delete:`ComponentView__delete___LmNvb`,propertyBlock:`ComponentView__propertyBlock___LmNvb`},ni=e=>{let t=Object.keys(e.childs);for(let n=0;n<t.length;n++){let r=e.childs[t[n]],{opt:i}=r,a=!1;if(i&&(a=typeof i.hidden==`function`?i.hidden(r.type===`value`?r.value:null):i.hidden||!1),!a&&(r.type===`value`||ni(r)))return!0}return!1},ri=({component:e})=>{let{editor:t}=br(),[n,r]=F(e,`enabled`),i=e.initiator!==`user`,a=ni(e.serializeToDirectory()),o=(0,b.useCallback)(n=>{n.stopPropagation();let r=e.entity;if(r){for(let[n,i]of r.components)if(i.uuid===e.uuid){t.api.removeComponent(r,n,e);break}}},[e,t]),s=(0,T.jsxs)(`div`,{className:ti.head,children:[(0,T.jsx)(`div`,{className:ti.name,children:gr.resources.getComponentName(e)}),(0,T.jsx)(`div`,{className:ti.delete,children:(0,T.jsx)(`button`,{onClick:o,children:(0,T.jsx)(D,{})})})]});return(0,T.jsx)(`div`,{className:ti.compoView,"data-disable_component":i,children:(0,T.jsx)(`div`,{className:ti.content,children:(0,T.jsx)(re,{label:s,accordion:a,bg:!0,defaultClose:!1,children:a&&(0,T.jsx)(Wr,{target:e})})})})},ii={container:`ComponentList__container___LmNvb`},ai=({entity:e})=>{let[t]=F(e,`components`),n=(0,b.useMemo)(()=>{let n=[];return t?(t.forEach(t=>{let r=e.getComponentByUUID(t);r&&n.push((0,T.jsx)(ri,{component:r},r.uuid))}),n):null},[t,e]);return(0,T.jsx)(`div`,{className:ii.container,children:n})},oi=()=>{let{editor:e,engine:t}=br(),[n]=F(e,`selectedEntityId`),r=(0,b.useMemo)(()=>{if(n)return t.root.findEntityByUUID(n)},[t,n]);return r?(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(re,{label:`Fields`,accordion:!0,children:(0,T.jsx)(Wr,{target:r})}),(0,T.jsxs)(re,{label:`Components`,accordion:!0,children:[(0,T.jsx)(ai,{entity:r}),(0,T.jsx)(ei,{entity:r})]})]}):null},si={exportControl:`ExportControl__exportControl___LmV4c`,exportControl_inner:`ExportControl__exportControl_inner___LmV4c`,export:`ExportControl__export___LmV4c`},ci=()=>{let{editor:e}=br(),[t,n]=(0,b.useState)(null);return(0,b.useEffect)(()=>{let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),(0,T.jsx)(`div`,{className:si.exportControl,children:(0,T.jsx)(`div`,{className:si.exportControl_inner,children:(0,T.jsx)(re,{label:`MP4`,accordion:!0,children:(0,T.jsx)(`div`,{className:si.export,children:(0,T.jsx)(ae,{onClick:()=>{e.isExporting||e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})})})})})},li=(0,b.createContext)(null),ui=()=>{let e=(0,b.useContext)(li);if(e===null)throw Error(`useOREngine must be used within a OREngineProvider`);return e},I={container:`GPUTimer__container___LmNvb`,headerRow:`GPUTimer__headerRow___LmNvb`,totalTime:`GPUTimer__totalTime___LmNvb`,toggleButton:`GPUTimer__toggleButton___LmNvb`,controls:`GPUTimer__controls___LmNvb`,control:`GPUTimer__control___LmNvb`,controlLabel:`GPUTimer__controlLabel___LmNvb`,select:`GPUTimer__select___LmNvb`,input:`GPUTimer__input___LmNvb`,group:`GPUTimer__group___LmNvb`,item:`GPUTimer__item___LmNvb`,clickable:`GPUTimer__clickable___LmNvb`,itemRow:`GPUTimer__itemRow___LmNvb`,itemName:`GPUTimer__itemName___LmNvb`,itemTime:`GPUTimer__itemTime___LmNvb`,itemStats:`GPUTimer__itemStats___LmNvb`,progressBar:`GPUTimer__progressBar___LmNvb`,progressFill:`GPUTimer__progressFill___LmNvb`},di=class{buffer;index;size;filled;constructor(e){this.size=e,this.buffer=Array(e),this.index=0,this.filled=!1}push(e){this.buffer[this.index]=e,this.index=(this.index+1)%this.size,!this.filled&&this.index===0&&(this.filled=!0)}getAverage(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=0;for(let n=0;n<e;n++)t+=this.buffer[n];return t/e}getMax(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]>t&&(t=this.buffer[n]);return t}getMin(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]<t&&(t=this.buffer[n]);return t}getCount(){return this.filled?this.size:this.index}},fi=class{buffers;windowSize;currentData;constructor(e=30){this.windowSize=e,this.buffers=new Map,this.currentData=new Map}update(e){let t=performance.now();for(let n=0;n<e.length;n++){let r=e[n],i=r.name.split(`/`),a=i[0]||`unknown`,o,s=i[i.length-1],c=s&&s.match(/\[([^\]]+)\]/);c&&(o=c[1]);let l={name:r.name,duration:r.duration,timestamp:t,renderType:a},u=this.buffers.get(r.name);u||(u=new di(this.windowSize),this.buffers.set(r.name,u)),u.push(r.duration),this.currentData.set(r.name,{...l,entityId:o})}}getStatistics(){let e=[],t=0,n=performance.now(),r=[];return this.currentData.forEach((e,t)=>{n-e.timestamp>1e3&&r.push(t)}),r.forEach(e=>{this.currentData.delete(e)}),this.currentData.forEach(e=>{t+=e.duration}),this.currentData.forEach(n=>{let r=this.buffers.get(n.name);r&&e.push({name:n.name,renderType:n.renderType,entityId:n.entityId,current:n.duration,avg:r.getAverage(),max:r.getMax(),min:r.getMin(),samples:r.getCount(),percentage:t>0?n.duration/t*100:0})}),e}getTotalTime(){let e=0;return this.currentData.forEach(t=>{e+=t.duration}),e}},pi=e=>{if(e<2){let t=e/2;return`rgb(${Math.floor(100+t*100)}, 200, 100)`}if(e<5){let t=(e-2)/3;return`rgb(200, ${Math.floor(200-t*50)}, 100)`}if(e<10){let t=(e-5)/5;return`rgb(200, ${Math.floor(150-t*80)}, ${Math.floor(100-t*50)})`}return`rgb(200, 70, 50)`},mi=e=>e>=10?e.toFixed(1):e>=1?e.toFixed(2):e.toFixed(3),hi=e=>e.replace(/\[([^\]]{4,})\]/g,(e,t)=>`[${t.slice(0,3)}]`),gi=()=>{let{editor:e}=br(),{engine:t}=ui(),[n,r]=(0,b.useState)([]),[i,a]=(0,b.useState)(0),[o,s]=(0,b.useState)(`all`),[c,l]=(0,b.useState)(0),[u,d]=(0,b.useState)(`time`),[f,p]=(0,b.useState)(!1),m=(0,b.useRef)(new fi(30)),h=(0,b.useRef)(0),g=(0,b.useRef)(!1),_=(0,b.useRef)(0),v=(0,b.useCallback)(n=>{if(!n)return;let r=t.root.findEntityByUUID(n);r&&e.selectEntity(r)},[t,e]);(0,b.useEffect)(()=>{let e=t.renderer,n=m.current,i=e=>{f&&(n.update(e),g.current=!0)},o=e=>{g.current&&e-_.current>=300&&(r(n.getStatistics()),a(n.getTotalTime()),g.current=!1,_.current=e),h.current=requestAnimationFrame(o)};return e.on(`timer`,i),h.current=requestAnimationFrame(o),()=>{e.off(`timer`,i),cancelAnimationFrame(h.current)}},[t,f]);let y=n.filter(e=>!(o!==`all`&&e.renderType!==o||e.avg<c)),x=Array.from(new Set(n.map(e=>e.renderType))),S=[...y].sort((e,t)=>u===`time`?t.avg-e.avg:e.name.localeCompare(t.name)),C=i>0?Math.floor(1e3/i):0;return(0,T.jsxs)(`div`,{className:I.container,children:[(0,T.jsxs)(`div`,{className:I.headerRow,children:[(0,T.jsxs)(`span`,{className:I.totalTime,children:[mi(i),`ms (`,C,`fps)`]}),(0,T.jsx)(`button`,{className:I.toggleButton,onClick:()=>p(!f),title:f?`Stop timer`:`Start timer`,children:f?`⏸`:`▶`})]}),(0,T.jsxs)(`div`,{className:I.controls,children:[(0,T.jsxs)(`div`,{className:I.control,children:[(0,T.jsx)(`span`,{className:I.controlLabel,children:`Type`}),(0,T.jsxs)(`select`,{className:I.select,value:o,onChange:e=>s(e.target.value),children:[(0,T.jsx)(`option`,{value:`all`,children:`All`}),x.map(e=>(0,T.jsx)(`option`,{value:e,children:e},e))]})]}),(0,T.jsxs)(`div`,{className:I.control,children:[(0,T.jsx)(`span`,{className:I.controlLabel,children:`Min`}),(0,T.jsx)(`input`,{className:I.input,type:`number`,min:`0`,step:`0.1`,value:c,onChange:e=>l(parseFloat(e.target.value)||0)})]}),(0,T.jsxs)(`div`,{className:I.control,children:[(0,T.jsx)(`span`,{className:I.controlLabel,children:`Sort`}),(0,T.jsxs)(`select`,{className:I.select,value:u,onChange:e=>d(e.target.value),children:[(0,T.jsx)(`option`,{value:`time`,children:`Time`}),(0,T.jsx)(`option`,{value:`name`,children:`Name`})]})]})]}),(0,T.jsx)(`div`,{className:I.group,children:S.map((e,t)=>{let n=pi(e.avg),r=i>0?e.avg/i*100:0,a=!!e.entityId;return(0,T.jsxs)(`div`,{className:`${I.item} ${a?I.clickable:``}`,onClick:()=>v(e.entityId),children:[(0,T.jsxs)(`div`,{className:I.itemRow,children:[(0,T.jsx)(`span`,{className:I.itemName,title:e.name,children:hi(e.name)}),(0,T.jsx)(`span`,{className:I.itemTime,style:{color:n},children:mi(e.avg)}),(0,T.jsx)(`span`,{className:I.itemStats,children:mi(e.max)})]}),(0,T.jsx)(`div`,{className:I.progressBar,children:(0,T.jsx)(`div`,{className:I.progressFill,style:{width:`${r}%`,backgroundColor:n}})})]},e.name+t)})})]})},_i={picker:`Picker__picker___LnBpY`,picker_label:`Picker__picker_label___LnBpY`,picker_list:`Picker__picker_list___LnBpY`,picker_list_inner:`Picker__picker_list_inner___LnBpY`,item:`Picker__item___LnBpY`},vi=e=>(0,T.jsxs)(`div`,{className:_i.picker,"data-no_bg":e.noBg,children:[e.label&&(0,T.jsx)(`div`,{className:_i.picker_label,children:e.label}),(0,T.jsx)(`div`,{className:_i.picker_list,children:(0,T.jsx)(`div`,{className:_i.picker_list_inner,children:e.list.map((e,t)=>(0,T.jsx)(Ue,{className:_i.item,onClick:e.onClick,children:e.label},t))})})]}),yi={group:`InputGroup__group___Lmdyb`,submit:`InputGroup__submit___Lmdyb`},bi=e=>{let t=e.initialValues,n=[],[r,i]=(0,b.useState)(t);(0,b.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,T.jsx)(Tr,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,b.useRef)(null);return(0,b.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,T.jsx)(`div`,{className:yi.group,ref:o,children:(0,T.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,T.jsx)(re,{label:e.title,noMargin:!0,children:n}),(0,T.jsx)(`div`,{className:yi.submit,children:(0,T.jsx)(ae,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},xi={node:`HierarchyNode__node___Lm5vZ`,self_name:`HierarchyNode__self_name___Lm5vZ`,icon:`HierarchyNode__icon___Lm5vZ`,selectable:`HierarchyNode__selectable___Lm5vZ`,self:`HierarchyNode__self___Lm5vZ`,visibility:`HierarchyNode__visibility___Lm5vZ`,menu:`HierarchyNode__menu___Lm5vZ`,fold:`HierarchyNode__fold___Lm5vZ`,fold_button:`HierarchyNode__fold_button___Lm5vZ`,child:`HierarchyNode__child___Lm5vZ`,child_line:`HierarchyNode__child_line___Lm5vZ`},Si=e=>{let{editor:t,engine:n}=br(),[r]=F(t,`selectedEntityId`),i=r!==void 0&&n.root.findEntityByUUID(r),a=!!(i&&i.uuid==e.entity.uuid),[o,s]=F(e.entity,`visible`),[c,l]=F(t,`unselectableEntityIds`),[u]=F(e.entity,`children`),d=!(c||[]).includes(e.entity.uuid),f=(u||[]).map(e=>n.root.findEntityByUUID(e)).filter(e=>e!==void 0),p=e.depth||0,m=f&&f.concat().sort((e,t)=>e.name.localeCompare(t.name))||[],h=m.length>0,g=p*20,_=e.entity.initiator==`script`,v=(0,b.useMemo)(()=>e.entity.getComponent(Nt)?(0,T.jsx)(ue,{size:14}):e.entity.getComponent(jt)?(0,T.jsx)(oe,{size:14}):e.entity.getComponent(N)?(0,T.jsx)(de,{size:14}):null,[e.entity]),y=e.openNodes.has(e.entity.uuid),x=(0,b.useCallback)(t=>{e.setNodeOpen(e.entity.uuid,!y),t.stopPropagation()},[y,e]),S=(0,b.useCallback)(()=>{t&&t.selectEntity(e.entity)},[t,e.entity]),C=(0,b.useCallback)(e=>{e.stopPropagation(),s&&s(!o)},[o,s]),w=(0,b.useCallback)(t=>{t.stopPropagation();let n=new Set(c||[]);d?n.add(e.entity.uuid):n.delete(e.entity.uuid),l(Array.from(n))},[d,c,l,e.entity.uuid]),{pushContent:ee,closeAll:te}=Zr(),E=(0,b.useCallback)(n=>{n.preventDefault(),!(!t||!ee||!te||_)&&(t.selectEntity(e.entity),ee((0,T.jsx)(vi,{label:e.entity.name,list:[{label:`Add Entity`,onClick:()=>{ee((0,T.jsx)(bi,{initialValues:{name:``},onSubmit:n=>{let r=t.api.createEntity(e.entity,n.name);t.api.selectEntity(r),te()}}))}},{label:`Delete Entity`,onClick:()=>{t.api.deleteEntity(e.entity),te()}}]})))},[t,e.entity,ee,te,_]);return(0,T.jsxs)(`div`,{className:xi.node,"data-no_export":_,children:[(0,T.jsxs)(Ue,{className:xi.self,style:{paddingLeft:g},onClick:S,onContextMenu:E,selected:a,children:[(0,T.jsx)(`div`,{className:xi.fold,"data-hnode_open":y,children:h&&(0,T.jsx)(`button`,{className:xi.fold_button,onClick:x,children:(0,T.jsx)(ne,{open:y})})}),v&&(0,T.jsx)(`div`,{className:xi.icon,children:v}),(0,T.jsx)(`div`,{className:xi.self_name,children:(0,T.jsx)(`p`,{children:e.entity.name||`-`})}),(0,T.jsx)(`button`,{className:xi.selectable,onClick:w,"data-selectable":d,children:(0,T.jsx)(O,{size:14,selectable:d})}),(0,T.jsx)(`button`,{className:xi.visibility,onClick:C,"data-visible":o!==!1,children:(0,T.jsx)(le,{size:14,visible:o!==!1})}),!_&&(0,T.jsx)(`button`,{className:xi.menu,onClick:E,children:`⋯`})]}),h&&(0,T.jsxs)(`div`,{className:xi.child,"data-open":y,children:[m.map(t=>(0,T.jsx)(Si,{entity:t,depth:p+1,openNodes:e.openNodes,setNodeOpen:e.setNodeOpen},t.uuid)),(0,T.jsx)(`div`,{className:xi.child_line,style:{marginLeft:g+4}})]})]})},Ci={},wi=`hierarchyOpenNodes`,Ti=()=>{try{let e=localStorage.getItem(wi);if(e)return new Set(JSON.parse(e))}catch{}return new Set},Ei=e=>{localStorage.setItem(wi,JSON.stringify(Array.from(e)))},Di=()=>{let{editor:e,engine:t}=br(),[n]=F(e,`selectedEntityId`),r=t.root,[i,a]=(0,b.useState)(Ti),o=(0,b.useCallback)((e,t)=>{a(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),Ei(r),r})},[]);return(0,b.useEffect)(()=>{if(!n)return;let e=r.findEntityByUUID(n);if(!e)return;let t=[],i=e.parent;for(;i;)t.push(i.uuid),i=i.parent;a(e=>{if(t.every(t=>e.has(t)))return e;let n=new Set(e);return t.forEach(e=>n.add(e)),Ei(n),n})},[n,r]),(0,T.jsx)(`div`,{className:Ci.hierarchy,children:r&&(0,T.jsx)(Si,{entity:r,openNodes:i,setNodeOpen:o})})},Oi={mouseMenu:`MouseMenu__mouseMenu___Lm1vd`,hide:`MouseMenu__hide___Lm1vd`,menuItem:`MouseMenu__menuItem___Lm1vd`,menuItem_inner:`MouseMenu__menuItem_inner___Lm1vd`,menuItem_inner_inner:`MouseMenu__menuItem_inner_inner___Lm1vd`},ki=()=>{let{itemList:e,containerRef:t,closeAll:n}=Zr();return(0,T.jsxs)(`div`,{className:Oi.mouseMenu,ref:t,children:[e&&e.length>0&&(0,T.jsx)(`div`,{className:Oi.hide,onClick:()=>{n&&n()}}),e&&e.map(e=>{let t=e.pos;return(0,T.jsx)(Gr.Provider,{value:e,children:(0,T.jsx)(`div`,{className:Oi.menuItem,style:{left:0,top:0,transform:`translate(${t.x}px, ${t.y}px)`},children:(0,T.jsx)(`div`,{className:Oi.menuItem_inner,children:(0,T.jsx)(`div`,{className:Oi.menuItem_inner_inner,"data-direction":e.direction,children:e.elm})})})},e.id)})]})},Ai=0,ji=()=>{let e=(0,b.useRef)(null),t=(0,b.useRef)({x:0,y:0}),n=(0,b.useCallback)(e=>{t.current.x=e.clientX,t.current.y=e.clientY},[]);(0,b.useEffect)(()=>(window.addEventListener(`pointermove`,n),()=>{window.removeEventListener(`pointermove`,n)}),[n]);let[r,i]=(0,b.useState)([]),a=(0,b.useRef)(r);a.current=r;let o=(0,b.useCallback)(e=>{a.current=a.current.filter(t=>t.id!==e),i(a.current)},[]),s=(0,b.useCallback)(()=>{i([])},[]);return{itemList:r,pushContent:(0,b.useCallback)(e=>{let n=Ai++,r={x:t.current.x,y:t.current.y},s={id:n,elm:e,pos:r,direction:(r.x<window.innerWidth/2?`right`:`left`)+`-`+(r.y<window.innerHeight/2?`bottom`:`top`),close:()=>o(n)};return i([...a.current,s]),s},[o]),closeAll:s,containerRef:e}},Mi=e=>{let t=ji();return(0,T.jsx)(Xr.Provider,{value:t,children:e.children})},Ni={container:`Canvas__container___LmNvb`},Pi=({viewportId:e})=>{let{engine:t,editor:n}=br(),r=(0,b.useRef)(null);return(0,b.useEffect)(()=>{let i=r.current;if(!t||!i)return;let a=n.createViewport(e,i);return()=>{a.dispose()}},[t,n,e]),(0,T.jsx)(`div`,{className:Ni.container,role:`presentation`,"aria-label":`3D Canvas`,children:(0,T.jsx)(`canvas`,{ref:r})})},Fi={audioView:`AudioView__audioView___LmF1Z`},Ii=class extends gt{wrapperElm;canvas;canvasCtx;viewRangeFrame;viewPort;viewPortRange;musicBuffer;resizeObserver;frameSetting;framePlay;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0];let e=window.localStorage.getItem(`audioViweRange`);this.viewRangeFrame=e?Number(e):2,this.frameSetting={duration:0,fps:60},this.framePlay={current:0,playing:!1},this.musicBuffer=null,this.resizeObserver=new ResizeObserver(this.onResize.bind(this))}onResize(){if(this.wrapperElm){let e=new k(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);this.canvas.width=e.x,this.canvas.height=e.y}this.render()}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.musicBuffer){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)]*1,s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]*1+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}this.canvasCtx.fillStyle=`#555`,this.canvasCtx.fillRect(this.canvas.width/2,0,1,this.canvas.height)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.canvas),this.onResize()}setFramePlaying(e){this.framePlay=e,this.viewPort=[this.framePlay.current-this.viewRangeFrame,0,this.framePlay.current+this.viewRangeFrame,0],this.viewPortRange=[this.viewPort[2]-this.viewPort[0],this.viewPort[3]-this.viewPort[1]],this.render()}setViewRangeFrame(e){this.viewRangeFrame=e,this.setFramePlaying(this.framePlay),localStorage.setItem(`audioViweRange`,String(this.viewRangeFrame))}setFrameSetting(e){this.frameSetting=e,this.render()}setMusicBuffer(e){this.musicBuffer=e,this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.canvas),this.resizeObserver.disconnect()}},L=()=>{let{editor:e}=br(),t=(0,b.useRef)(null),[n,r]=(0,b.useState)();(0,b.useEffect)(()=>{let e=new Ii;if(r(e),t.current)return e.setWrapperElm(t.current),()=>{e.dispose()}},[]);let i=e&&e.audioBuffer,[a,o]=(0,b.useState)(),[s,c]=(0,b.useState)({duration:0,fps:0}),[l,u]=(0,b.useState)({current:0,playing:!1});(0,b.useEffect)(()=>{if(!e)return;let t=e.engine,n=e=>{c({duration:e[`timeline/duration`],fps:e[`timeline/fps`]})},r=0,i=()=>{o(r++)},a=e=>{u({...e})};return n(t.serialize()),a(t.frame),t.on(`fields/update`,n),t.on(`update/music`,i),t.on(`update/frame/play`,a),()=>{t.off(`update/frame/setting`,n),t.off(`update/music`,i),t.off(`update/frame/play`,a)}},[e]),(0,b.useEffect)(()=>{n&&i&&n.setMusicBuffer(i)},[n,i,a]),(0,b.useEffect)(()=>{n&&l&&n.setFramePlaying(l)},[n,l]),(0,b.useEffect)(()=>{n&&s&&n.setFrameSetting(s)},[n,s]);let d=(0,b.useCallback)(e=>{if(n){let t=e.deltaY>0?1.1:.9;n.setViewRangeFrame(n.viewRangeFrame*t)}e.preventDefault()},[n]);return(0,b.useEffect)(()=>{let e=t.current;return e&&e.addEventListener(`wheel`,d,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,d)}},[d]),(0,T.jsx)(`div`,{className:Fi.audioView,ref:t})},Li={cameraPad:`CameraPad__cameraPad___LmNhb`,btn:`CameraPad__btn___LmNhb`},Ri=()=>{let{editor:e}=br(),[t]=F(e,`selectedEntityId`);return(0,T.jsxs)(`div`,{className:Li.cameraPad,children:[(0,T.jsx)(`div`,{className:Li.btn,"data-disabled":!t,onClick:()=>{t&&e.focusSelected()},title:`Focus selected ( . )`,children:`Focus`}),(0,T.jsx)(`div`,{className:Li.btn,onClick:()=>{e.syncToSceneCamera()},title:`Move to scene camera ( Esc )`,children:`Scene Cam`})]})},R={screen:`Screen__screen___LnNjc`,header:`Screen__header___LnNjc`,header_tabs:`Screen__header_tabs___LnNjc`,header_tab:`Screen__header_tab___LnNjc`,header_right:`Screen__header_right___LnNjc`,header_item:`Screen__header_item___LnNjc`,content:`Screen__content___LnNjc`,gizmoMode:`Screen__gizmoMode___LnNjc`,gizmoMode_btn:`Screen__gizmoMode_btn___LnNjc`,gizmoMode_separator:`Screen__gizmoMode_separator___LnNjc`,modalStatus:`Screen__modalStatus___LnNjc`,canvas:`Screen__canvas___LnNjc`,audioViewHandle:`Screen__audioViewHandle___LnNjc`,audioView:`Screen__audioView___LnNjc`,displayOptions:`Screen__displayOptions___LnNjc`,displayOptions_btn:`Screen__displayOptions_btn___LnNjc`,overlay:`Screen__overlay___LnNjc`,overlay_field:`Screen__overlay_field___LnNjc`,overlay_label:`Screen__overlay_label___LnNjc`,overlay_separator:`Screen__overlay_separator___LnNjc`,externalBtn:`Screen__externalBtn___LnNjc`},zi=`viewport`,Bi=({viewportId:e})=>{let{editor:t}=br(),n=$e(),[r,i]=F(t,`enableRender`),[a,o]=F(t,`viewports/${e}/preview`),[s,c]=F(t,`viewType`),[l,u]=F(t,`resolutionScale`),[d,f]=F(t,`gizmoMode`),[p,m]=F(t,`transformOrientation`),[h]=F(t,`modalStatus`),[g,_]=F(t,`helpers/show`),[v,y]=F(t,`helpers/empty`),[x,S]=F(t,`helpers/camera`),[C,w]=F(t,`helpers/light`),[ee,te]=F(t,`helpers/grid`),[ne,E]=F(t,`helpers/wireframe`),[re,ie]=F(t,`helpers/gizmo`),[oe,se]=F(t,`helpers/outline`),[ce]=jr(`showAudioView`),[D,O]=(0,b.useState)(50),le=(0,b.useRef)(null),[ue,de]=(0,b.useState)(!1),fe=(0,b.useRef)(null),pe=(0,b.useCallback)(e=>{fe.current&&!fe.current.contains(e.target)&&de(!1)},[]);return(0,b.useEffect)(()=>(ue&&document.addEventListener(`pointerdown`,pe),()=>{document.removeEventListener(`pointerdown`,pe)}),[ue,pe]),(0,T.jsxs)(`div`,{className:R.screen,children:[(0,T.jsxs)(`div`,{className:R.header,children:[(0,T.jsx)(`div`,{className:R.header_tabs,children:(0,T.jsx)(`div`,{className:R.header_tab,"data-active":!!a,onClick:()=>o&&o(!a),title:`Camera Render`,children:(0,T.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 512 512`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,T.jsx)(`path`,{d:`M32 144 H336 V368 H32 Z M368 224 L480 152 V360 L368 288 Z`})})})}),(0,T.jsxs)(`div`,{className:R.header_right,children:[(0,T.jsx)(`div`,{className:R.header_item,children:(0,T.jsx)(Ie,{title:`View`,children:(0,T.jsx)(Tr,{value:s,format:{type:`select`,list:[`render`,`debug`]},onChange:e=>c&&c(e)})})}),(0,T.jsx)(`div`,{className:R.header_item,children:(0,T.jsx)(Ie,{title:`Res`,children:(0,T.jsx)(Tr,{value:l,format:{type:`select`,list:[,,,,,,].fill(0).map((e,t)=>{let n=2**t,r=1/n;return{value:r,label:r==1?`1`:`1/`+n}})},onChange:e=>u&&u(e)})})}),n.isPC&&(0,T.jsx)(`div`,{className:R.externalBtn,children:(0,T.jsx)(ae,{onClick:()=>{t.openInExternalWindow()},children:(0,T.jsxs)(`svg`,{width:`32`,height:`12`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,T.jsxs)(`g`,{clipPath:`url(#clip0_224_2)`,children:[(0,T.jsx)(`path`,{d:`M96 0V416H512V0H96ZM472 376H136V40H472V376Z`,fill:`#aaa`}),(0,T.jsx)(`path`,{d:`M40 472V296V136V96H0V512H416V472H376H40Z`,fill:`#aaa`}),(0,T.jsx)(`path`,{d:`M232.812 312.829L350.671 194.969V279.766H390.671V126.688H237.594V166.688H322.39L204.531 284.547L232.812 312.829Z`,fill:`#aaa`})]}),(0,T.jsx)(`defs`,{children:(0,T.jsx)(`clipPath`,{id:`clip0_224_2`,children:(0,T.jsx)(`rect`,{width:`512`,height:`512`,fill:`white`})})})]})})})]})]}),(0,T.jsxs)(`div`,{className:R.content,children:[(0,T.jsxs)(`div`,{className:R.displayOptions,ref:fe,children:[(0,T.jsx)(`div`,{className:R.displayOptions_btn,"data-active":ue,onClick:()=>de(!ue),title:`Display Options`,children:`⚙`}),ue&&(0,T.jsxs)(`div`,{className:R.overlay,children:[(0,T.jsx)(`div`,{className:R.overlay_label,children:`Rendering`}),(0,T.jsx)(`div`,{className:R.overlay_field,children:(0,T.jsx)(Ie,{title:`Render`,children:(0,T.jsx)(Tr,{value:r,onChange:e=>i&&i(e)})})}),(0,T.jsx)(`div`,{className:R.overlay_separator}),(0,T.jsx)(`div`,{className:R.overlay_label,children:`Helpers`}),(0,T.jsx)(`div`,{className:R.overlay_field,children:(0,T.jsx)(Ie,{title:`Show`,children:(0,T.jsx)(Tr,{value:g,onChange:e=>_&&_(e)})})}),(0,T.jsx)(`div`,{className:R.overlay_field,"data-indent":`true`,children:(0,T.jsx)(Ie,{title:`Empty`,children:(0,T.jsx)(Tr,{value:v,onChange:e=>y&&y(e)})})}),(0,T.jsx)(`div`,{className:R.overlay_field,"data-indent":`true`,children:(0,T.jsx)(Ie,{title:`Camera`,children:(0,T.jsx)(Tr,{value:x,onChange:e=>S&&S(e)})})}),(0,T.jsx)(`div`,{className:R.overlay_field,"data-indent":`true`,children:(0,T.jsx)(Ie,{title:`Light`,children:(0,T.jsx)(Tr,{value:C,onChange:e=>w&&w(e)})})}),(0,T.jsx)(`div`,{className:R.overlay_separator}),(0,T.jsx)(`div`,{className:R.overlay_field,children:(0,T.jsx)(Ie,{title:`Grid`,children:(0,T.jsx)(Tr,{value:ee,onChange:e=>te&&te(e)})})}),(0,T.jsx)(`div`,{className:R.overlay_field,children:(0,T.jsx)(Ie,{title:`Wireframe`,children:(0,T.jsx)(Tr,{value:ne,onChange:e=>E&&E(e)})})}),(0,T.jsx)(`div`,{className:R.overlay_field,children:(0,T.jsx)(Ie,{title:`Gizmo`,children:(0,T.jsx)(Tr,{value:re,onChange:e=>ie&&ie(e)})})}),(0,T.jsx)(`div`,{className:R.overlay_field,children:(0,T.jsx)(Ie,{title:`Outline`,children:(0,T.jsx)(Tr,{value:oe,onChange:e=>se&&se(e)})})})]})]}),(0,T.jsxs)(`div`,{className:R.gizmoMode,children:[[`select`,`translate`,`rotate`,`scale`].map(e=>(0,T.jsx)(`div`,{className:R.gizmoMode_btn,"data-active":d===e,onClick:()=>f&&f(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`select`?`↖`:e===`translate`?`T`:e===`rotate`?`R`:`S`},e)),(0,T.jsx)(`div`,{className:R.gizmoMode_separator}),[`global`,`local`].map(e=>(0,T.jsx)(`div`,{className:R.gizmoMode_btn,"data-active":p===e,onClick:()=>m&&m(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`global`?`G`:`L`},e))]}),h&&(0,T.jsx)(`div`,{className:R.modalStatus,children:h}),(0,T.jsx)(`div`,{className:R.canvas,children:(0,T.jsx)(Pi,{viewportId:e})}),n.isSP&&(0,T.jsx)(Ri,{}),n.isPC&&ce&&(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(`div`,{className:R.audioViewHandle,onPointerDown:e=>{e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),le.current={startY:e.clientY,startHeight:D}},onPointerMove:e=>{if(!le.current)return;let t=le.current.startY-e.clientY,n=Math.max(20,Math.min(400,le.current.startHeight+t));O(n)},onPointerUp:()=>{le.current=null}}),(0,T.jsx)(`div`,{className:R.audioView,style:{height:D},children:(0,T.jsx)(L,{})})]})]})]})},Vi={overlay:`DragOverlay__overlay___Lm92Z`,zone:`DragOverlay__zone___Lm92Z`,insert:`DragOverlay__insert___Lm92Z`,ghost:`DragOverlay__ghost___Lm92Z`},Hi=12,Ui=e=>{let t=(0,b.useRef)(null),n=e.drag.startX,r=e.drag.startY;(0,b.useEffect)(()=>{let e=(e,n)=>{let r=t.current;r&&(r.style.transform=`translate(${e+Hi}px, ${n+Hi}px)`)};e(n,r);let i=t=>e(t.clientX,t.clientY);window.addEventListener(`pointermove`,i);let a=document.body.style.userSelect;return document.body.style.userSelect=`none`,()=>{window.removeEventListener(`pointermove`,i),document.body.style.userSelect=a}},[n,r]);let i=e.drag.target;return(0,T.jsxs)(`div`,{className:Vi.overlay,children:[i&&(0,T.jsx)(`div`,{className:i.kind===`tabs`?Vi.insert:Vi.zone,style:{left:`${i.rect.left}px`,top:`${i.rect.top}px`,width:`${i.rect.width}px`,height:`${i.rect.height}px`}}),(0,T.jsx)(`div`,{className:Vi.ghost,ref:t,children:e.drag.title})]})};function Wi(e,t){let n=e.get(t);if(n)return n;let r=t.indexOf(`:`);if(r===-1)return;let i=e.get(t.slice(0,r));return i?.multiple?i:void 0}function Gi(e){return e.slice(e.indexOf(`:`)+1)}function Ki(e){return e.multiple?`${e.id}:${_t.genUUID()}`:e.id}function qi(e,t){return e.multiple?e.content(Gi(t)):e.content}var Ji=(e,t)=>({type:`split`,id:_t.genUUID(),direction:e,children:t}),Yi=e=>({type:`pane`,id:_t.genUUID(),tabs:e,active:e[0]});function Xi(){return Ji(`vertical`,[{ratio:916/1076,node:Ji(`horizontal`,[{ratio:300/1912,node:Ji(`vertical`,[{ratio:696/912,node:Yi([`hierarchy`,`scene`])},{ratio:216/912,node:Yi([`timer`])}])},{ratio:1312/1912,node:Yi([`viewport:main`])},{ratio:300/1912,node:Yi([`property`,`textures`,`renderer`,`editor-settings`])}])},{ratio:160/1076,node:Yi([`timeline`,`export`])}])}function Zi(e){return e.type===`pane`?[e]:e.children.flatMap(e=>Zi(e.node))}var Qi=e=>{if(e.type===`pane`)return e.tabs.length>0?e:null;let t=[];if(e.children.forEach(n=>{let r=Qi(n.node);r&&(r.type===`split`&&r.direction===e.direction?r.children.forEach(e=>t.push({ratio:n.ratio*e.ratio,node:e.node})):t.push(r===n.node?n:{...n,node:r}))}),t.length===0)return null;if(t.length===1)return t[0].node;let n=t.reduce((e,t)=>e+t.ratio,0);return Math.abs(n-1)>1e-6?{...e,children:t.map(e=>({...e,ratio:e.ratio/n}))}:t.length!==e.children.length||t.some((t,n)=>t!==e.children[n])?{...e,children:t}:e};function $i(e,t){let n=new Set,r=new Set,i=e=>{let t=typeof e==`string`&&e!==``&&!n.has(e)?e:_t.genUUID();return n.add(t),t},a=e=>{if(typeof e!=`object`||!e)return null;let n=e;if(n.type===`pane`){if(!Array.isArray(n.tabs))return null;let e=[...new Set(n.tabs.filter(e=>typeof e==`string`))].filter(e=>{let n=t(e);return n?!n.multiple||!r.has(e)&&(r.add(e),!0):!1});if(e.length===0)return null;let a=typeof n.active==`string`&&e.includes(n.active)?n.active:e[0];return{type:`pane`,id:i(n.id),tabs:e,active:a}}if(n.type===`split`){if(n.direction!==`horizontal`&&n.direction!==`vertical`||!Array.isArray(n.children))return null;let e=[];return n.children.forEach(t=>{if(typeof t!=`object`||!t)return;let n=t,r=a(n.node);if(!r)return;let i=typeof n.ratio==`number`&&isFinite(n.ratio)&&n.ratio>0?n.ratio:1;e.push({ratio:i,node:r})}),e.length===0?null:e.length===1?e[0].node:{type:`split`,id:i(n.id),direction:n.direction,children:e}}return null},o=a(e);return o?Qi(o):null}var ea=(e,t,n)=>{if(e.id===t)return n(e);if(e.type===`split`){let r=!1,i=e.children.map(e=>{let i=ea(e.node,t,n);return i===e.node?e:(r=!0,{...e,node:i})});if(r)return{...e,children:i}}return e};function ta(e,t,n){return ea(e,t,e=>e.type!==`pane`||!e.tabs.includes(n)?e:{...e,active:n})}function na(e,t,n,r){return ea(e,t,e=>{if(e.type!==`pane`||e.tabs.includes(n))return e;let t=[...e.tabs];return t.splice(Math.max(0,Math.min(r??t.length,t.length)),0,n),{...e,tabs:t,active:n}})}function ra(e,t,n,r,i){if(t===r)return ea(e,t,e=>{if(e.type!==`pane`)return e;let t=e.tabs.indexOf(n);if(t===-1)return e;let r=e.tabs.filter(e=>e!==n),a=i??e.tabs.length,o=Math.max(0,Math.min(t<a?a-1:a,r.length));return o===t?e:(r.splice(o,0,n),{...e,tabs:r,active:n})});let a=Zi(e),o=a.find(e=>e.id===t),s=a.find(e=>e.id===r);return!o||!s||!o.tabs.includes(n)||s.tabs.includes(n)?e:na(aa(e,t,n),r,n,i)}function ia(e,t,n,r,i){let a=Zi(e),o=a.find(e=>e.id===r);if(!o||!o.tabs.includes(i)||!a.some(e=>e.id===t)||r===t&&o.tabs.length===1)return e;let s=aa(e,r,i),c={type:`pane`,id:_t.genUUID(),tabs:[i],active:i},l=ea(s,t,e=>{let t=[{ratio:.5,node:c},{ratio:.5,node:e}];return(n===`right`||n===`bottom`)&&t.reverse(),{type:`split`,id:_t.genUUID(),direction:n===`left`||n===`right`?`horizontal`:`vertical`,children:t}});return l===s?e:Qi(l)??e}function aa(e,t,n){let r=ea(e,t,e=>{if(e.type!==`pane`||!e.tabs.includes(n))return e;let t=e.tabs.indexOf(n),r=e.tabs.filter(e=>e!==n),i=e.active!==n||r.length===0?e.active:r[Math.min(t,r.length-1)];return{...e,tabs:r,active:i}});return r===e?e:Qi(r)??e}function oa(e,t,n){return ea(e,t,e=>e.type!==`split`||e.children.length!==n.length?e:{...e,children:e.children.map((e,t)=>({...e,ratio:n[t]}))})}var sa=4,ca=.25,la=(e,t)=>{let n={left:e.left,top:e.top,width:e.width,height:e.height};return(t===`left`||t===`right`)&&(n.width/=2),t===`right`&&(n.left+=n.width),(t===`top`||t===`bottom`)&&(n.height/=2),t===`bottom`&&(n.top+=n.height),n},ua=(e,t,n,r,i)=>{if(n.id!==r&&n.tabs.includes(i))return null;let a=[...t.querySelectorAll(`[data-panel-tab-id]`)].filter(e=>e instanceof HTMLElement),o=a.length;for(let t=0;t<a.length;t++){let n=a[t].getBoundingClientRect();if(e<n.left+n.width/2){o=t;break}}let s=t.getBoundingClientRect(),c=o<a.length?a[o].getBoundingClientRect().left:a.length>0?a[a.length-1].getBoundingClientRect().right:s.left;return{kind:`tabs`,paneId:n.id,index:o,rect:{left:c-1,top:s.top,width:2,height:s.height}}},da=(e,t,n,r,i)=>{let a=document.elementFromPoint(e,t);if(!a)return null;let o=a.closest(`[data-pane-id]`);if(!(o instanceof HTMLElement))return null;let s=Zi(n).find(e=>e.id===o.dataset.paneId);if(!s)return null;let c=a.closest(`[data-panel-tab-header]`);if(c instanceof HTMLElement)return ua(e,c,s,r,i);let l=o.querySelector(`[data-panel-content]`);if(!(l instanceof HTMLElement))return null;let u=l.getBoundingClientRect();if(u.width<=0||u.height<=0)return null;let d=(e-u.left)/u.width,f=(t-u.top)/u.height;if(d<0||d>1||f<0||f>1)return null;if(Math.min(d,1-d)>ca&&Math.min(f,1-f)>ca)return s.id===r||s.tabs.includes(i)?null:{kind:`zone`,paneId:s.id,zone:`center`,rect:la(u,`center`)};if(s.id===r&&s.tabs.length===1)return null;let p=d-.5,m=f-.5,h=Math.abs(p)>=Math.abs(m)?p<0?`left`:`right`:m<0?`top`:`bottom`;return{kind:`zone`,paneId:s.id,zone:h,rect:la(u,h)}},fa=(e,t)=>e===null||t===null?e===t:e.paneId===t.paneId?e.kind===`tabs`&&t.kind===`tabs`?e.index===t.index:e.kind===`zone`&&t.kind===`zone`&&e.zone===t.zone:!1;function pa(e,t,n){let[r,i]=(0,b.useState)(null),a=(0,b.useRef)(e);a.current=e;let o=(0,b.useRef)(t);o.current=t;let s=(0,b.useRef)(null);return(0,b.useEffect)(()=>()=>s.current?.(),[]),{dragState:r,onTabPointerDown:(e,t,r)=>{if(r.button!==0||s.current)return;let c=r.clientX,l=r.clientY,u=!1,d=null,f=r=>{if(r.buttons===0){p(!1);return}if(!u){if(Math.hypot(r.clientX-c,r.clientY-l)<sa)return;u=!0,i({panelId:t,title:n(t)?.title??t,startX:r.clientX,startY:r.clientY,target:null})}let o=da(r.clientX,r.clientY,a.current,e,t);fa(o,d)||(d=o,i(e=>e&&{...e,target:o}))},p=n=>{if(g(),n&&u&&d){let n=a.current;d.kind===`tabs`?o.current(ra(n,e,t,d.paneId,d.index)):d.zone===`center`?o.current(ra(n,e,t,d.paneId)):o.current(ia(n,d.paneId,d.zone,e,t))}u&&i(null)},m=()=>p(!0),h=()=>p(!1),g=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),s.current=null};s.current=g,window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h)}}}var ma={pane:`PanelLayout__pane___LnBhb`};function ha(e,t){let n=[];for(let r of e){let e=n;if(r.category)for(let t of r.category.split(`/`)){if(t===``)continue;let n;for(let r of e)if(r.label===t&&`children`in r){n=r;break}n||(n={label:t,children:[]},e.push(n)),e=n.children}e.push({label:r.title,onClick:()=>t(r)})}return n}var ga=e=>{let t=e.node;if(t.type===`split`)return(0,T.jsx)(Ve,{direction:t.direction,ratios:t.children.map(e=>e.ratio),onRatiosChange:n=>e.onRatiosChange(t.id,n),children:t.children.map(t=>(0,T.jsx)(Ve.Item,{children:(0,T.jsx)(ga,{...e,node:t.node})},t.node.id))});let n=t.tabs.flatMap(t=>{let n=e.resolve(t);return n?[{id:t,title:n.title,content:qi(n,t)}]:[]});if(n.length===0)return null;let r=e.hasAddable(t);return(0,T.jsx)(`div`,{className:ma.pane,"data-pane-id":t.id,children:(0,T.jsx)(Je,{tabs:n,active:t.active,onSelect:n=>e.onSelectTab(t.id,n),onTabContextMenu:(n,r)=>e.onTabContextMenu(t.id,n,r),onTabPointerDown:(n,r)=>e.onTabPointerDown(t.id,n,r),onAddClick:r?()=>e.onAddTab(t.id):void 0})})},_a=e=>{let{editor:t}=br(),{pushContent:n,closeAll:r}=Zr(),i=(0,b.useMemo)(()=>{let t=new Map;return e.panels.forEach(e=>t.set(e.id,e)),t},[e.panels]),a=(0,b.useMemo)(()=>e=>Wi(i,e),[i]),[o,s]=F(t,`panelLayout`),c=(0,b.useMemo)(()=>$i(o,a)??Xi(),[o,a]);(0,b.useEffect)(()=>{let e=new Set(Zi(c).flatMap(e=>e.tabs).filter(e=>a(e)?.id===zi).map(Gi));t.pruneViewportSettings(e)},[c,a,t]);let l=e=>{e!==c&&s(e)},u=(e,t)=>l(ta(c,e,t)),d=(e,t)=>l(oa(c,e,t)),{dragState:f,onTabPointerDown:p}=pa(c,l,a),m=e=>[...i.values()].filter(t=>t.multiple||!e.tabs.includes(t.id));return(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(ga,{node:c,resolve:a,onSelectTab:u,onRatiosChange:d,onTabContextMenu:(e,t,i)=>{i.preventDefault(),Zi(c).reduce((e,t)=>e+t.tabs.length,0)>1&&n((0,T.jsx)(vi,{label:a(t)?.title,list:[{label:`Close Tab`,onClick:()=>{l(aa(c,e,t)),r()}}]}))},onTabPointerDown:p,onAddTab:e=>{let t=Zi(c).find(t=>t.id===e);if(!t)return;let i=m(t);if(i.length===0)return;let a=ha(i,t=>{l(na(c,e,Ki(t))),r()});n((0,T.jsx)(Yr,{items:a}))},hasAddable:e=>m(e).length>0}),f&&(0,T.jsx)(Ui,{drag:f})]})},va={renderer:`RendererSettings__renderer___LnJlb`,renderer_inner:`RendererSettings__renderer_inner___LnJlb`},ya=()=>{let{editor:e}=br(),t=e.engine.renderer;return(0,T.jsx)(`div`,{className:va.renderer,children:(0,T.jsxs)(`div`,{className:va.renderer_inner,children:[(0,T.jsx)(re,{label:`Resolution`,accordion:!0,children:(0,T.jsx)(Wr,{target:e,filter:`resolution`})}),(0,T.jsx)(re,{label:`Pipeline`,accordion:!0,children:(0,T.jsx)(Wr,{target:t,filter:`pipeline`})}),(0,T.jsx)(re,{label:`Sky`,accordion:!0,children:(0,T.jsx)(Wr,{target:t,filter:`sky`})})]})})},ba={list:`SceneWindow__list___Lmxpc`,item:`SceneWindow__item___Lmxpc`,item_name:`SceneWindow__item_name___Lmxpc`,item_badge:`SceneWindow__item_badge___Lmxpc`,newItem:`SceneWindow__newItem___Lmxpc`,newItem_input:`SceneWindow__newItem_input___Lmxpc`,newItem_error:`SceneWindow__newItem_error___Lmxpc`,footer_message:`SceneWindow__footer_message___Lmxpc`,footer_spacer:`SceneWindow__footer_spacer___Lmxpc`},xa=/^[A-Za-z0-9_-]+$/,Sa=e=>{let{scenes:t,onClose:n}=e,[r,i]=(0,b.useState)(t.current),[a,o]=(0,b.useState)(null),[s,c]=(0,b.useState)(null),[l,u]=(0,b.useState)(!1),d=(0,b.useCallback)(e=>{e!==t.current&&t.onSelect(e),n()},[t,n]);(0,b.useEffect)(()=>{let e=e=>{if(e.key===`Escape`){if(a!==null){o(null),c(null);return}if(l){u(!1);return}n()}};return window.addEventListener(`keydown`,e),()=>{window.removeEventListener(`keydown`,e)}},[a,l,n]);let f=()=>{let e=(a??``).trim();if(!xa.test(e)){c(`A-Z a-z 0-9 - _ のみ使えます`);return}if(t.names.includes(e)){c(`"${e}" は既にあります`);return}t.onCreate(e),n()},p=()=>{r&&(t.onDelete(r),i(null),u(!1))},m=[];for(let e of t.names){let n=e===t.current;m.push((0,T.jsxs)(Ue,{className:ba.item,selected:e===r,onClick:()=>{i(e),u(!1)},onDoubleClick:()=>{d(e)},children:[(0,T.jsx)(`span`,{className:ba.item_name,children:e}),n&&(0,T.jsx)(`span`,{className:ba.item_badge,children:`opened`})]},e))}let h=null;a!==null&&(h=(0,T.jsxs)(`div`,{className:ba.newItem,children:[(0,T.jsx)(`form`,{onSubmit:e=>{e.preventDefault(),f()},children:(0,T.jsx)(`input`,{className:ba.newItem_input,autoFocus:!0,value:a,placeholder:`scene name`,onChange:e=>{o(e.target.value),c(null)}})}),s&&(0,T.jsx)(`div`,{className:ba.newItem_error,children:s})]}));let g=null;if(l&&r)g=(0,T.jsxs)(T.Fragment,{children:[(0,T.jsxs)(`span`,{className:ba.footer_message,children:[`Delete "`,r,`" ?`]}),(0,T.jsx)(ae,{onClick:()=>{u(!1)},children:`Cancel`}),(0,T.jsx)(ae,{onClick:p,children:`Delete`})]});else{let e=r!==null&&t.names.length>1,n=r!==null&&r!==t.current;g=(0,T.jsxs)(T.Fragment,{children:[(0,T.jsx)(ae,{onClick:()=>{o(``),c(null),u(!1)},children:`+ New`}),(0,T.jsx)(`div`,{className:ba.footer_spacer}),(0,T.jsx)(ae,{disabled:!e,onClick:()=>{u(!0)},children:`Delete`}),(0,T.jsx)(ae,{disabled:!n,onClick:()=>{r&&d(r)},children:`Open`})]})}return(0,T.jsx)(Ae,{title:`Scenes`,note:e.projectName,width:360,onClose:n,footer:g,children:(0,T.jsxs)(`div`,{className:ba.list,children:[m,h]})})},Ca={sceneControl:`SceneControl__sceneControl___LnNjZ`,sceneControl_inner:`SceneControl__sceneControl_inner___LnNjZ`,select:`SceneControl__select___LnNjZ`,select_name:`SceneControl__select_name___LnNjZ`,save:`SceneControl__save___LnNjZ`},wa=()=>{let{editor:e,projectName:t,scenes:n}=br(),[r,i]=(0,b.useState)(!1),a=null;return n&&(a=(0,T.jsx)(Ie,{title:`scene`,children:(0,T.jsxs)(`button`,{className:Ca.select,onClick:()=>{i(!0)},children:[(0,T.jsx)(`span`,{className:Ca.select_name,children:n.current??`-`}),(0,T.jsx)(ne,{open:!0})]})})),(0,T.jsxs)(`div`,{className:Ca.sceneControl,children:[(0,T.jsx)(`div`,{className:Ca.sceneControl_inner,children:(0,T.jsxs)(re,{label:t,accordion:!0,children:[a,(0,T.jsx)(`div`,{className:Ca.save,children:(0,T.jsx)(ae,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,T.jsx)(Sa,{scenes:n,projectName:t,onClose:()=>{i(!1)}})]})},Ta={textures:`Textures__textures___LnRle`,item:`Textures__item___LnRle`,preview:`Textures__preview___LnRle`,img:`Textures__img___LnRle`,placeholder:`Textures__placeholder___LnRle`,name:`Textures__name___LnRle`},Ea=()=>{let{engine:e,editor:t}=br(),[,n]=(0,b.useState)(0);(0,b.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return gr.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{gr.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=gr.resources.textureList;return(0,T.jsx)(`div`,{className:Ta.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,T.jsxs)(`div`,{className:Ta.item,children:[(0,T.jsx)(`div`,{className:Ta.preview,children:n?(0,T.jsx)(`img`,{src:n,className:Ta.img}):(0,T.jsx)(`div`,{className:Ta.placeholder})}),(0,T.jsx)(`div`,{className:Ta.name,children:e.name})]},e.name)})})},Da=(0,b.createContext)(null),Oa=()=>{let e=(0,b.useContext)(Da);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e},ka=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,ip=s({EyeRings:()=>ap}),ap=class extends M{constructor(e){super(e);let t=this.engine,n=new Lt({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new Wt({phase:[`deferred`,`shadowMap`],frag:np,vert:rp,uniforms:t.uniforms});this.entity.addComponent(N,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(N)}},op=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,cp=s({FlashLine:()=>lp}),lp=class extends M{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new Ot({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=nt.randomVector().multiply(new k(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new Wt({phase:[`forward`,`envMap`],frag:zt(`flFrag`,op),vert:zt(`flVert`,sp),uniforms:Ht.merge(t.uniforms)}),this.entity.addComponent(N,{material:this.material,geometry:this.geometry})}},up=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,dp=s({SkyBox:()=>fp}),fp=class extends M{material;constructor(e){super(e);let t=this.engine;this.material=new Wt({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:zt(`SkyBoxFrag`,up),uniforms:Ht.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}},pp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,hp=s({GridCross:()=>gp}),gp=class extends M{constructor(e){super(e);let t=new Dt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new k(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new Wt({frag:zt(`gridCrossFrag`,pp),vert:zt(`gridCrossVert`,mp),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},_p=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,yp=s({GridDots:()=>bp}),bp=class extends M{constructor(e){super(e);let t=new At({radius:.1}),n=[],r=[],i=new k(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new Wt({frag:zt(`gridDotsFrag`,_p),vert:zt(`gridDotsVert`,vp),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},xp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,Cp=s({WireCube:()=>wp}),wp=class extends M{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new Dt({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new Wt({phase:[`deferred`],frag:xp,vert:Sp,uniforms:Ht.merge(t.uniforms)});this.entity.addComponent(N,{geometry:i,material:s})}},Tp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Dp=s({OREngineCube:()=>Op}),Op=class extends M{material;constructor(e){super(e);let t=this.engine;this.material=new Wt({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:zt(`OREngineCubeVert`,Ep),frag:zt(`OREngineCubeFrag`,Tp),uniforms:Ht.merge(t.uniforms,{uNoiseTex:{value:gr.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(N);n&&(n.material=this.material)}},kp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,jp=s({OREngineLogo:()=>Mp}),Mp=class extends M{material;constructor(e){super(e);let t=this.engine;this.material=new Wt({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:zt(`OREngineLogoVert`,Ap),frag:zt(`OREngineLogoFrag`,kp),uniforms:Ht.merge(t.uniforms)});let n=this.entity.getComponent(N);n&&(n.material=this.material)}},Np=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Fp=s({Dust:()=>Ip}),Ip=class extends M{constructor(e){super(e);let t=this.engine,n=new Et,r=e.args?.num||2048,i=new k(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new Wt({phase:[`forward`],drawType:`POINTS`,frag:Np,vert:Pp,uniforms:Ht.merge(t.uniforms)});this.entity.addComponent(N,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(N)}},Lp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `},lm={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `,dm=Object.assign({"../../demo-webgl/Resources/Textures/hash.tex":cm,"../../demo-webgl/Resources/Textures/noise.tex":lm,"../../demo-webgl/Resources/Textures/noiseCyclic.tex":{name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:um},"../../demo-webgl/Resources/Textures/noiseCyclicAnime.tex":{name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:um}}),fm=()=>{for(let e of Object.values(dm))e&&gr.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},pm=e=>{gr.resources.buildTextureInstances(e.renderer,e.uniforms)},mm=Object.assign({"../../demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":ip,"../../demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":cp,"../../demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":dp,"../../demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":hp,"../../demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":yp,"../../demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":Cp,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":Dp,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":jp,"../../demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":Fp,"../../demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":Bp}),hm=Object.assign({}),gm=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addComponent(i,a):gm(a,t.createGroup(i))}},_m=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addGeometry(i,a):_m(a,t.createGroup(i))}},vm=()=>{wt.gltfLoaderFactory=e=>new $n(e),gr.resources.clear();let e=gr.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Nt),e.addComponent(`Camera`,jt),e.addComponent(`Mesh`,N);let t=Object.keys(om);for(let e=0;e<t.length;e++){let n=t[e],r=om[n];gm(r,gr.resources.addComponentGroup(n))}let n=Object.keys(sm);for(let e=0;e<n.length;e++){let t=n[e],r=sm[t];_m(r,gr.resources.addGeometryGroup(t))}let r=pr(mm,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t];gm(n,gr.resources.addComponentGroup(t))}let a=pr(hm,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t];_m(n,gr.resources.addGeometryGroup(t))}fm()},ym=s({panel:()=>bm}),bm={id:`sample`,title:`Sample`,category:`Tools`,content:(0,T.jsx)(()=>{let{editor:e,engine:t}=br(),[n]=F(e,`selectedEntityId`),[r,i]=(0,b.useState)(``),a=n?t.root.findEntityByUUID(n):void 0;return(0,T.jsxs)(Ge,{children:[(0,T.jsx)(re,{label:`Selected Entity`,children:a?a.name:`-`}),(0,T.jsxs)(re,{label:`Server`,children:[(0,T.jsx)(ae,{onClick:async()=>{try{let e=await(await fetch(`/api/ext/hello`)).json();i(e.message)}catch{i(`failed`)}},children:`GET /api/ext/hello`}),r&&(0,T.jsx)(`p`,{children:r})]})]})},{})},xm=Object.assign({"../../demo-webgl/editor/Panels/Sample/index.tsx":ym}),Sm=(()=>{let e=[],t=Object.keys(xm);for(let n=0;n<t.length;n++){let r=xm[t[n]].panel;r&&e.push(r)}return e})();document.title=`demo-webgl`,vm(),_.createRoot(document.getElementById(`root`)).render((0,T.jsx)(tp,{projectName:`demo-webgl`,sceneData:y,editorData:v,initResourceInstances:pm,panels:Sm}));