...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}},Wt=class extends wt{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}},F=class extends Ut{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,qt=class extends ht{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA,magFilter:M.LINEAR,minFilter:M.LINEAR,wrapS:M.CLAMP_TO_EDGE,wrapT:M.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new A(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA})])});let m=1/4*l,h=new F(e,{renderTarget:s[l].rt1,frag:Kt,uniforms:Vt.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new A(d,f));let g=new F(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new Wt({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}},Jt=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}},Yt=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,en=e=>{let t=[];for(let n=0;n<e;n++){let r=new A;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},tn=class extends ht{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;shading;constructor(e){super();let t=e.backend,n=new F(t,{name:`normalSelector`,frag:Zt,renderTarget:null,uniforms:Vt.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),r=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),a=new F(t,{name:`lightShaft`,frag:Xt,renderTarget:r,uniforms:Vt.merge({uLightShaftBackBuffer:{value:i.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),c=new F(t,{name:`ssao`,frag:Qt,renderTarget:Rt(`ssao`,o),uniforms:Vt.merge({uSSAOBackBuffer:{value:s.textures[0],type:`1i`},uSSAOKernel:{value:en(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),l=Vt.merge({uSSAOTexture:{value:s.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:tt.gaussWeights(8)}}),u=new F(t,{name:`ssaoBlur/h`,frag:Rt(`ssaoBlur`,$t),uniforms:l,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),d=new F(t,{name:`ssaoBlur/v`,frag:Rt(`ssaoBlur`,$t),uniforms:Vt.merge(l,{uSSAOTexture:{value:u.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),f=new F(t,{name:`deferredShading`,frag:Rt(`deferredShading`,Yt),uniforms:Vt.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:c.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})});this.postprocess=new Wt({passes:[n,a,c,u,d,f]}),this.shading=f,this.lightShaft=a,this.ssao=c,this.rtSSAO1=o,this.rtSSAO2=s,this.ssaoBlur=u,this.ssaoBlurV=d,this.rtLightShaft1=r,this.rtLightShaft2=i,this.normalSelector_=n;let p=e.renderTarget;for(let e=0;e<p.gBuffer.textures.length;e++){let t=p.gBuffer.textures[e];e===1&&(t=p.normalBuffer.textures[0]),f.uniforms[`sampler`+e]=c.uniforms[`sampler`+e]={type:`1i`,value:t}}u.uniforms.uDepthTexture.value=p.gBuffer.textures[0],a.uniforms.uDepthTexture.value=p.gBuffer.depthTexture,f.renderTarget=p.shadingBuffer,n.renderTarget=p.normalBuffer,n.uniforms.uNormalTexture.value=p.gBuffer.textures[1],n.uniforms.uPosTexture.value=p.gBuffer.textures[0],n.uniforms.uSelectorTexture.value=p.gBuffer.textures[3],l.uNormalTexture.value=p.normalBuffer.textures[0]}update(){let e=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=e,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],e=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=e,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}resize(e){this.postprocess.resize(e)}dispose(){this.postprocess.dispose(),this.rtLightShaft1.dispose(),this.rtLightShaft2.dispose(),this.rtSSAO1.dispose(),this.rtSSAO2.dispose()}},nn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,fn=class{dofCoc;dofBokeh;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;constructor(e,t){let n=new F(e,{name:`collection`,frag:nn}),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),i=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),a=new F(e,{name:`ssr`,frag:Rt(`ssr`,dn),renderTarget:r,uniforms:Vt.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`},uSSRBackBuffer:{value:i.textures[0],type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=new F(e,{name:`ssComposite`,frag:Rt(`ssComposite`,un),uniforms:Vt.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSSRTexture:{value:i.textures[0],type:`1i`}})}),s=new A(10,.05,20,.05),c=new F(e,{name:`dof/coc`,frag:an,uniforms:Vt.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR,internalFormat:M.RGBA16F,type:M.HALF_FLOAT,format:M.RGBA})]),passThrough:!0,resolutionRatio:.5}),l=new F(e,{name:`dof/bokeh`,frag:rn,uniforms:Vt.merge({uCocTex:{value:c.renderTarget.textures[0],type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),passThrough:!0,resolutionRatio:.5}),u=new F(e,{name:`dof/composite`,frag:on,uniforms:Vt.merge({uBokeTex:{value:l.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR,internalFormat:M.RGBA16F,type:M.HALF_FLOAT,format:M.RGBA})])}),d=new F(e,{name:`motionBlurTile`,frag:ln,uniforms:Vt.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),f=new F(e,{name:`motionBlurNeighbor`,frag:cn,uniforms:Vt.merge({uVelTex:{value:d.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]),resolutionRatio:1/16,passThrough:!0}),p=new F(e,{name:`motionBlur`,frag:sn,uniforms:Vt.merge({uVelNeighborTex:{value:f.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16}});this.postprocess=new Wt({passes:[n,a,o,c,l,u,d,f,p]}),this._ssr=a,this._ssComposite=o,this.dofCoc=c,this.dofBokeh=l,this.dofComposite=u,this._motionBlur=p,this._motionBlurTile=d,this._motionBlurNeighbor=f,this._dofParams=s,this.rtSSR1=r,this.rtSSR2=i,n.backBufferOverride=t.shadingBuffer.textures,a.uniforms.uGbufferPos.value=t.gBuffer.textures[0],a.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],a.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],o.uniforms.uGbufferPos.value=t.gBuffer.textures[0],o.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],c.uniforms.uGbufferPos.value=t.gBuffer.textures[0],d.uniforms.uVelTex.value=t.gBuffer.textures[4],p.uniforms.uVelTex.value=t.gBuffer.textures[4],p.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}update(e){let t=e.fov,n=e.dofParams.focusDistance,r=e.dofParams.kFilmHeight,i=r/Math.tan(.5*(t/180*Math.PI)),a=1/this.dofBokeh.renderTarget.size.y*5,o=1/a,s=i*i/(e.dofParams.fNumber*(n-i)*r*2);this._dofParams.set(n,a,o,s);let c=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=c,this._ssr.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssr.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}dispose(){this.postprocess.dispose(),this.rtSSR1.dispose(),this.rtSSR2.dispose()}},pn=e=>{let t=e.createFrameBuffer();t.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA,magFilter:M.NEAREST,minFilter:M.NEAREST}),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA}),e.createTexture(),e.createTexture(),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]);let n=e.createFrameBuffer({disableDepthBuffer:!0});n.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA}),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA})]);let r=e.createFrameBuffer({disableDepthBuffer:!0});r.setDepthTexture(t.depthTexture),r.setTexture([n.textures[0],t.textures[0],t.textures[4]]);let i=e.createFrameBuffer({disableDepthBuffer:!0});i.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA,magFilter:M.LINEAR,minFilter:M.LINEAR})]);let a=e.createFrameBuffer({disableDepthBuffer:!0});a.setDepthTexture(t.depthTexture),a.setTexture([e.createTexture()]);let o=e.createFrameBuffer();return o.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA,magFilter:M.NEAREST,minFilter:M.NEAREST})]),{gBuffer:t,shadingBuffer:n,forwardBuffer:r,refractionBuffer:i,uiBuffer:a,normalBuffer:o}},mn=class{camera;offscreen;renderTarget;deferredRenderer;pipelinePostProcess;_pipelineOverride;_sceneConfig;_onDispose;constructor(e){this.camera=null,this.offscreen=e.offscreen,this._pipelineOverride=null,this._sceneConfig=e.sceneConfig,this._onDispose=e.onDispose,this.renderTarget=pn(e.backend),this.deferredRenderer=new tn({backend:e.backend,envMap:e.envMap,envMapCube:e.envMapCube,renderTarget:this.renderTarget}),this.pipelinePostProcess=new fn(e.backend,this.renderTarget),e.resolution.x>0&&e.resolution.y>0&&this.resize(e.resolution),this.applyPipelineConfig()}get pipelineOverride(){return this._pipelineOverride}set pipelineOverride(e){this._pipelineOverride=e,this.applyPipelineConfig()}applyPipelineConfig(){let e={...this._sceneConfig,...this._pipelineOverride};this.deferredRenderer.setPassEnabled({ssao:e.ssao,lightShaft:e.lightShaft}),this.pipelinePostProcess.setPassEnabled({motionBlur:e.motionBlur,ssr:e.ssr,dof:e.dof}),this.pipelinePostProcess.setMotionBlurPower(e.motionBlurPower??1)}resize(e){let t=this.renderTarget;t.gBuffer.setSize(e),t.shadingBuffer.setSize(e),t.forwardBuffer.setSize(e),t.refractionBuffer.setSize(e),t.uiBuffer.setSize(e),t.normalBuffer.setSize(e),this.deferredRenderer.resize(e),this.pipelinePostProcess.resize(e)}dispose(){this._onDispose(this);let e=this.renderTarget;e.forwardBuffer.dispose();let t=[e.gBuffer,e.shadingBuffer,e.refractionBuffer,e.uiBuffer,e.normalBuffer];for(let e=0;e<t.length;e++){let n=t[e];for(let e=0;e<n.textures.length;e++)n.textures[e].dispose();n.dispose()}e.gBuffer.depthTexture&&e.gBuffer.depthTexture.dispose(),this.deferredRenderer.dispose(),this.pipelinePostProcess.dispose()}},hn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`,zn=`uniform sampler2D uBackBuffer0;
...
}`,er=`uniform sampler2D uShadingTexture;
...
}`,nr=class extends Wt{constructor(e){let t=[],n=[];for(let r=0;r<4;r++)t.push(e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})])),n.push(e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]));let r=2,i=new F(e,{name:`bloom/bright/`,frag:er,passThrough:!0,uniforms:{uThreshold:{value:1.8,type:`1f`},uBrightness:{value:1,type:`1f`}},resolutionRatio:1/r}),a=[],o=i.renderTarget.textures;for(let i=0;i<4;i++){let s=t[i],c=n[i],l={name:`bloom/blur/`+i+`/v`,renderTarget:s,frag:$n,uniforms:{uBackBlurTex:{value:o,type:`1i`},uIsVertical:{type:`1i`,value:!0},uWeights:{type:`1fv`,value:tt.gaussWeights(8)},uBlurRange:{value:2,type:`1f`}},defines:{GAUSS_WEIGHTS:`8`,USE_BACKBLURTEX:``},passThrough:!0,resolutionRatio:1/r};a.push(new F(e,l)),a.push(new F(e,{...l,name:`bloom/blur/`+i+`/h`,renderTarget:c,uniforms:{...l.uniforms,uBackBlurTex:{value:s.textures[0],type:`1i`},uIsVertical:{type:`1i`,value:!1}}})),o=c.textures,r*=2}let s=new F(e,{name:`bloom/composite/`,frag:tr,uniforms:{uBloomTexture:{value:n.map(e=>e.textures[0]),type:`1iv`}}});super({name:`Bloom`,passes:[i,...a,s]})}get threshold(){return this.passes[0].uniforms.uThreshold.value}set threshold(e){this.passes[0].uniforms.uThreshold.value=e}get brightness(){return this.passes[0].uniforms.uBrightness.value}set brightness(e){this.passes[0].uniforms.uBrightness.value=e}},rr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor = vec4( col, 1.0 );\r
\r
}`,ir=class extends Wt{constructor(e){super({name:`ColorGrading`,passes:[new F(e,{frag:rr})]})}},ar=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor = vec4( col, 1.0 );\r
\r
}`,or=class extends Wt{constructor(e){super({name:`Finalize`,passes:[new F(e,{frag:ar})]})}},sr=`uniform sampler2D uBackBuffer0;\r
...
}`,ep=s({EyeRings:()=>tp}),tp=class extends N{constructor(e){super(e);let t=this.engine,n=new It({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new Ut({phase:[`deferred`,`shadowMap`],frag:Qf,vert:$f,uniforms:t.uniforms});this.entity.addComponent(P,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(P)}},np=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,ip=s({FlashLine:()=>ap}),ap=class extends N{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new Dt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=tt.randomVector().multiply(new A(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new Ut({phase:[`forward`,`envMap`],frag:Rt(`flFrag`,np),vert:Rt(`flVert`,rp),uniforms:Vt.merge(t.uniforms)}),this.entity.addComponent(P,{material:this.material,geometry:this.geometry})}},op=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,sp=s({SkyBox:()=>cp}),cp=class extends N{material;constructor(e){super(e);let t=this.engine;this.material=new Ut({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:Rt(`SkyBoxFrag`,op),uniforms:Vt.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}},lp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,dp=s({GridCross:()=>fp}),fp=class extends N{constructor(e){super(e);let t=new Et({width:.05,height:.5,depth:.05}),n=[],r=[],i=new A(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new Ut({frag:Rt(`gridCrossFrag`,lp),vert:Rt(`gridCrossVert`,up),phase:[`forward`]});this.entity.addComponent(P,{geometry:t,material:a})}},pp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,hp=s({GridDots:()=>gp}),gp=class extends N{constructor(e){super(e);let t=new kt({radius:.1}),n=[],r=[],i=new A(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new Ut({frag:Rt(`gridDotsFrag`,pp),vert:Rt(`gridDotsVert`,mp),phase:[`forward`]});this.entity.addComponent(P,{geometry:t,material:a})}},_p=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,yp=s({WireCube:()=>bp}),bp=class extends N{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new Et({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new Ut({phase:[`deferred`],frag:_p,vert:vp,uniforms:Vt.merge(t.uniforms)});this.entity.addComponent(P,{geometry:i,material:s})}},xp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Cp=s({OREngineCube:()=>wp}),wp=class extends N{material;constructor(e){super(e);let t=this.engine;this.material=new Ut({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:Rt(`OREngineCubeVert`,Sp),frag:Rt(`OREngineCubeFrag`,xp),uniforms:Vt.merge(t.uniforms,{uNoiseTex:{value:hr.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(P);n&&(n.material=this.material)}},Tp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Dp=s({OREngineLogo:()=>Op}),Op=class extends N{material;constructor(e){super(e);let t=this.engine;this.material=new Ut({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:Rt(`OREngineLogoVert`,Ep),frag:Rt(`OREngineLogoFrag`,Tp),uniforms:Vt.merge(t.uniforms)});let n=this.entity.getComponent(P);n&&(n.material=this.material)}},kp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,jp=s({Dust:()=>Mp}),Mp=class extends N{constructor(e){super(e);let t=this.engine,n=new Tt,r=e.args?.num||2048,i=new A(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new Ut({phase:[`forward`],drawType:`POINTS`,frag:kp,vert:Ap,uniforms:Vt.merge(t.uniforms)});this.entity.addComponent(P,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(P)}},Np=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `,sm=Object.assign({"../../demo-webgl/Resources/Textures/hash.tex":im,"../../demo-webgl/Resources/Textures/noise.tex":am,"../../demo-webgl/Resources/Textures/noiseCyclic.tex":{name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:om},"../../demo-webgl/Resources/Textures/noiseCyclicAnime.tex":{name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:om}}),cm=()=>{for(let e of Object.values(sm))e&&hr.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},lm=e=>{hr.resources.buildTextureInstances(e.renderer,e.uniforms)},um=Object.assign({"../../demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":ep,"../../demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":ip,"../../demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":sp,"../../demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":dp,"../../demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":hp,"../../demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":yp,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":Cp,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":Dp,"../../demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":jp,"../../demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":Ip}),dm=Object.assign({}),fm=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addComponent(i,a):fm(a,t.createGroup(i))}},pm=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addGeometry(i,a):pm(a,t.createGroup(i))}},mm=()=>{Ct.gltfLoaderFactory=e=>new Qn(e),hr.resources.clear();let e=hr.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Mt),e.addComponent(`Camera`,At),e.addComponent(`Mesh`,P);let t=Object.keys(nm);for(let e=0;e<t.length;e++){let n=t[e],r=nm[n];fm(r,hr.resources.addComponentGroup(n))}let n=Object.keys(rm);for(let e=0;e<n.length;e++){let t=n[e],r=rm[t];pm(r,hr.resources.addGeometryGroup(t))}let r=fr(um,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t];fm(n,hr.resources.addComponentGroup(t))}let a=fr(dm,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t];pm(n,hr.resources.addGeometryGroup(t))}cm()},hm=s({panel:()=>gm}),gm={id:`sample`,title:`Sample`,content:(0,E.jsx)(()=>{let{editor:e,engine:t}=yr(),[n]=I(e,`selectedEntityId`),[r,i]=(0,b.useState)(``),a=n?t.root.findEntityByUUID(n):void 0;return(0,E.jsxs)(We,{children:[(0,E.jsx)(ne,{label:`Selected Entity`,children:a?a.name:`-`}),(0,E.jsxs)(ne,{label:`Server`,children:[(0,E.jsx)(ie,{onClick:async()=>{try{let e=await(await fetch(`/api/ext/hello`)).json();i(e.message)}catch{i(`failed`)}},children:`GET /api/ext/hello`}),r&&(0,E.jsx)(`p`,{children:r})]})]})},{})},_m=Object.assign({"../../demo-webgl/editor/Panels/Sample/index.tsx":hm}),vm=(()=>{let e=[],t=Object.keys(_m);for(let n=0;n<t.length;n++){let r=_m[t[n]].panel;r&&e.push(r)}return e})();document.title=`demo-webgl`,mm(),_.createRoot(document.getElementById(`root`)).render((0,E.jsx)(Zf,{projectName:`demo-webgl`,sceneData:y,editorData:v,initResourceInstances:lm,panels:vm}));