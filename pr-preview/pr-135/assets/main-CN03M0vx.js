...
`,Nn=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`,Pn=`// https://qiita.com/aa_debdeb/items/26ab808de6745611df53
...
}`,Bn=4,Vn=8,Hn=14,Un=.05,Wn=class{dofCoc;dofBokeh;dofBlur;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;_colorCollection;_bloomBright;_bloomPasses;constructor(e,t){let n=new P(e,{name:`collection`,frag:On}),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),i=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),a=new P(e,{name:`ssr`,frag:cn(`ssr`,zn),renderTarget:r,uniforms:dn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`},uSSRBackBuffer:{value:i.textures[0],type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=new P(e,{name:`ssComposite`,frag:cn(`ssComposite`,Rn),uniforms:dn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSSRTexture:{value:i.textures[0],type:`1i`}})}),s=new A(10,.05,20,.05),c=new P(e,{name:`dof/coc`,frag:jn,uniforms:dn.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR,internalFormat:M.RGBA16F,type:M.HALF_FLOAT,format:M.RGBA})]),passThrough:!0,resolutionRatio:.5}),l=new P(e,{name:`dof/bokeh`,frag:An,uniforms:dn.merge({uCocTex:{value:c.renderTarget.textures[0],type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),passThrough:!0,resolutionRatio:.5}),u=new P(e,{name:`dof/blur`,frag:kn,uniforms:dn.merge({uBokeTex:{value:l.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),passThrough:!0,resolutionRatio:.5}),d=new P(e,{name:`dof/composite`,frag:Mn,uniforms:dn.merge({uBokeTex:{value:u.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR,internalFormat:M.RGBA16F,type:M.HALF_FLOAT,format:M.RGBA})])}),f=new P(e,{name:`motionBlurTile`,frag:Ln,uniforms:dn.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),p=new P(e,{name:`motionBlurNeighbor`,frag:In,uniforms:dn.merge({uVelTex:{value:f.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]),resolutionRatio:1/16,passThrough:!0}),m=new P(e,{name:`motionBlur`,frag:Fn,uniforms:dn.merge({uVelNeighborTex:{value:p.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16}}),h=new P(e,{name:`fxaa`,frag:Nn}),g=new P(e,{name:`bloom/bright`,frag:En,uniforms:{uShadingTexture:{value:t.shadingBuffer.textures[0],type:`1i`},uThreshold:{value:1,type:`1f`},uBrightness:{value:1,type:`1f`}},resolutionRatio:.5,passThrough:!0}),_=[g],v=[],y=g.renderTarget.textures[0],b=2;for(let t=0;t<Bn;t++){let n=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),i={name:`bloom/blur/`+t+`/v`,renderTarget:n,frag:Pn,uniforms:{uBackBlurTex:{value:y,type:`1i`},uIsVertical:{type:`1i`,value:!0},uWeights:{type:`1fv`,value:St.gaussWeights(Vn)},uBlurRange:{value:2,type:`1f`}},defines:{GAUSS_WEIGHTS:Vn.toString(),USE_BACKBLURTEX:``},passThrough:!0,resolutionRatio:1/b};_.push(new P(e,i)),_.push(new P(e,{...i,name:`bloom/blur/`+t+`/h`,renderTarget:r,uniforms:{...i.uniforms,uBackBlurTex:{value:n.textures[0],type:`1i`},uIsVertical:{type:`1i`,value:!1}}})),v.push(r.textures[0]),y=r.textures[0],b*=2}_.push(new P(e,{name:`bloom/composite`,frag:Dn,uniforms:{uBloomTexture:{value:v,type:`1iv`}}})),this.postprocess=new mn({passes:[n,a,o,c,l,u,d,f,p,m,h,..._]}),this._ssr=a,this._ssComposite=o,this.dofCoc=c,this.dofBokeh=l,this.dofBlur=u,this.dofComposite=d,this._motionBlur=m,this._motionBlurTile=f,this._motionBlurNeighbor=p,this._colorCollection=n,this._bloomBright=g,this._bloomPasses=_,this._dofParams=s,this.rtSSR1=r,this.rtSSR2=i,a.uniforms.uGbufferPos.value=t.gBuffer.textures[0],a.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],a.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],o.uniforms.uGbufferPos.value=t.gBuffer.textures[0],o.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],c.uniforms.uGbufferPos.value=t.gBuffer.textures[0],f.uniforms.uVelTex.value=t.gBuffer.textures[4],m.uniforms.uVelTex.value=t.gBuffer.textures[4],m.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}update(e){let t=e.dofParams.kFilmHeight,n=.5*t/Math.tan(.5*(e.fov/180*Math.PI)),r=Math.max(e.dofParams.focusDistance,n),i=Math.min(Un,Hn/this.dofComposite.renderTarget.size.y),a=1/i,o=n*n/(e.dofParams.fNumber*(r-n)*t*2);this._dofParams.set(r,i,a,o);let s=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=s,this._ssr.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssr.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){if(e.toneMap!==void 0&&(this._colorCollection.enabled=e.toneMap),e.bloom!==void 0)for(let t of this._bloomPasses)t.enabled=e.bloom;e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofBlur.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofBlur.renderTarget&&this.dofBlur.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}setBloomParams(e,t){this._bloomBright.uniforms.uThreshold.value=e,this._bloomBright.uniforms.uBrightness.value=t}dispose(){this.postprocess.dispose(),this.rtSSR1.dispose(),this.rtSSR2.dispose()}},Gn=e=>{let t=e.createFrameBuffer();t.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA,magFilter:M.NEAREST,minFilter:M.NEAREST}),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA}),e.createTexture(),e.createTexture(),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]);let n=e.createFrameBuffer({disableDepthBuffer:!0});n.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA}),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA})]);let r=e.createFrameBuffer({disableDepthBuffer:!0});r.setDepthTexture(t.depthTexture),r.setTexture([n.textures[0],t.textures[0],t.textures[4]]);let i=e.createFrameBuffer({disableDepthBuffer:!0});i.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA,magFilter:M.LINEAR,minFilter:M.LINEAR})]);let a=e.createFrameBuffer({disableDepthBuffer:!0});a.setDepthTexture(t.depthTexture),a.setTexture([e.createTexture()]);let o=e.createFrameBuffer();return o.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA,magFilter:M.NEAREST,minFilter:M.NEAREST})]),{gBuffer:t,shadingBuffer:n,forwardBuffer:r,refractionBuffer:i,uiBuffer:a,normalBuffer:o}},Kn=class{camera;size;resolution;offscreen;renderTarget;deferredRenderer;pipelinePostProcess;_pipelineOverride;_sceneConfig;_onDispose;constructor(e){this.camera=null,this.size=null,this.resolution=new A,this.offscreen=e.offscreen,this._pipelineOverride=null,this._sceneConfig=e.sceneConfig,this._onDispose=e.onDispose,this.renderTarget=Gn(e.backend),this.deferredRenderer=new Tn({backend:e.backend,envMap:e.envMap,envMapCube:e.envMapCube,renderTarget:this.renderTarget}),this.pipelinePostProcess=new Wn(e.backend,this.renderTarget),this.fit(e.resolution),this.applyPipelineConfig()}get pipelineOverride(){return this._pipelineOverride}set pipelineOverride(e){this._pipelineOverride=e,this.applyPipelineConfig()}applyPipelineConfig(){let e={...this._sceneConfig,...this._pipelineOverride};this.deferredRenderer.setPassEnabled({ssao:e.ssao,lightShaft:e.lightShaft}),this.pipelinePostProcess.setPassEnabled({toneMap:e.toneMap,motionBlur:e.motionBlur,ssr:e.ssr,dof:e.dof,bloom:e.bloom}),this.pipelinePostProcess.setMotionBlurPower(e.motionBlurPower??1),this.pipelinePostProcess.setBloomParams(e.bloomThreshold??1,e.bloomBrightness??1)}fit(e){e.x<=0||e.y<=0||(this.resolution.x!==e.x||this.resolution.y!==e.y)&&this.resize(e)}resize(e){this.resolution.copy(e);let t=this.renderTarget;t.gBuffer.setSize(e),t.shadingBuffer.setSize(e),t.forwardBuffer.setSize(e),t.refractionBuffer.setSize(e),t.uiBuffer.setSize(e),t.normalBuffer.setSize(e),this.deferredRenderer.resize(e),this.pipelinePostProcess.resize(e)}dispose(){this._onDispose(this);let e=this.renderTarget;e.forwardBuffer.dispose();let t=[e.gBuffer,e.shadingBuffer,e.refractionBuffer,e.uiBuffer,e.normalBuffer];for(let e=0;e<t.length;e++){let n=t[e];for(let e=0;e<n.textures.length;e++)n.textures[e].dispose();n.dispose()}e.gBuffer.depthTexture&&e.gBuffer.depthTexture.dispose(),this.deferredRenderer.dispose(),this.pipelinePostProcess.dispose()}},qn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`,_r=`uniform sampler2D uBackBuffer0;
...
`,yr=class{isEditorFrame=!0;texture;textarget;constructor(e,t){this.texture=e,this.textarget=t}},br=class extends yr{isEditorTarget=!0;frameBuffer;autoResize;_gl;_entries;constructor(e,t,n){let r=Sr(e,t);super(r.textures[0],M.TEXTURE_2D),this.frameBuffer=r,this.autoResize=n,this._gl=e,this._entries=new Map([[xr(r.size),r]])}setSize(e){let t=xr(e);if(t===xr(this.frameBuffer.size))return;let n=this._entries.get(t);n||(n=Sr(this._gl,e),this._entries.set(t,n)),this.frameBuffer=n,this.texture=n.textures[0]}reset(e){let t=xr(e),n=this._entries.get(t)||Sr(this._gl,e);this._entries.forEach((e,n)=>{n!==t&&(e.textures[0].dispose(),e.dispose())}),this._entries=new Map([[t,n]]),this.frameBuffer=n,this.texture=n.textures[0]}},xr=e=>`${Math.max(Math.floor(e.x),1)}x${Math.max(Math.floor(e.y),1)}`,Sr=(e,t)=>{let n=new Ot(e,{disableDepthBuffer:!0}).setTexture([new Dt(e).setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]);return n.setSize(Math.max(Math.floor(t.x),1),Math.max(Math.floor(t.y),1)),n},Cr=class{isEditorRecipe=!0;postprocess;pass;mask;constructor(e,t,n){this.pass=t,this.mask=n,this.postprocess=new mn({name:e,passes:[t]})}},wr=class{_renderer;_gl;_targets;_readFrameBuffer;_fullscreenTarget;_texturePass;_texturePostProcess;_viewTarget;constructor(e){this._renderer=e,this._gl=e.backend.gl,this._targets=[],this._readFrameBuffer=new Ot(this._gl,{disableDepthBuffer:!0}),this._fullscreenTarget=new br(this._gl,e.resolution,!0),this._texturePass=new P(e.backend,{frag:vr,renderTarget:null}),this._texturePostProcess=new mn({name:`editorTexture`,passes:[this._texturePass]}),this._viewTarget=null}renderEntities(e){let t=this._renderer,n=e.view;e.target&&this._fitToView(e.target,n);let r=e.target?e.target.frameBuffer:n.renderTarget.uiBuffer,i=e.materialOverride,a=[];if(e.target&&e.useSceneDepth&&r.setDepthTexture(n.renderTarget.gBuffer.depthTexture),i)for(let t=0;t<e.entities.length;t++){let n=e.entities[t].getComponent(N);a.push(n?n.material:null),n&&(n.material=i)}if(e.depthCompare===`lequal`&&this._gl.depthFunc(M.LEQUAL),t.backend.setBlendEnabled(!0),t.renderCamera(`forward`,e.camera,e.entities,r,n.resolution,{disableClear:e.target===null}),t.backend.setBlendEnabled(!1),e.depthCompare===`lequal`&&this._gl.depthFunc(M.LESS),i)for(let t=0;t<e.entities.length;t++){let n=e.entities[t].getComponent(N);n&&(n.material=a[t])}}renderFullscreen(e,t,n){let r=t,i=this._renderer;if(this._fitToView(r.mask,e),r.pass.uniforms.uMaskTexture.value=r.mask.texture,n){let t=n;this._fitToView(t,e);let a=t.frameBuffer;this._setPassResolution(r.pass,a.size),r.pass.renderTarget=a,i.renderPostProcess(r.postprocess,void 0,a.size);return}let a=e.renderTarget.uiBuffer,o=e.resolution;this._fullscreenTarget.setSize(o),this._setPassResolution(r.pass,o),r.pass.renderTarget=this._fullscreenTarget.frameBuffer,i.renderPostProcess(r.postprocess,a,o),i.backend.blit(this._fullscreenTarget.frameBuffer,a,o.x,o.y)}blit(e,t,n,r){let i=this._gl,a=t;n&&this._fitToView(n,e);let o=n?n.frameBuffer:e.renderTarget.uiBuffer,s=o.size,c=r||{x:0,y:0,width:s.x,height:s.y};this._readFrameBuffer.setSize(a.texture.size),i.bindFramebuffer(i.FRAMEBUFFER,this._readFrameBuffer.getFrameBuffer()),i.framebufferTexture2D(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0,a.textarget,a.texture.getTexture(),0),i.bindFramebuffer(i.READ_FRAMEBUFFER,this._readFrameBuffer.getFrameBuffer()),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,o.getFrameBuffer()),i.blitFramebuffer(0,0,a.texture.size.x,a.texture.size.y,c.x,s.y-c.y-c.height,c.x+c.width,s.y-c.y,i.COLOR_BUFFER_BIT,i.NEAREST),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null)}drawToCanvas(e,t){let n=this._renderer,r=e.resolution;if(n.backend.blit(e.renderTarget.uiBuffer,null,r.x,r.y),t!==n.canvas){let e=n.canvas.height-r.y;t.getContext(`2d`).drawImage(n.canvas,0,e,r.x,r.y,0,0,r.x,r.y)}}drawTexture(e,t){let n=t.frameBuffer;this._texturePass.uniforms.uSrcTexture={value:e,type:`1i`},this._texturePass.renderTarget=n,this._renderer.renderPostProcess(this._texturePostProcess,void 0,n.size)}async readPixels(e){let t=this._gl,n=e.frameBuffer,r=n.size,i=new Uint8Array(r.x*r.y*4);return t.bindFramebuffer(t.FRAMEBUFFER,n.getFrameBuffer()),t.readPixels(0,0,r.x,r.y,t.RGBA,t.UNSIGNED_BYTE,i),t.bindFramebuffer(t.FRAMEBUFFER,null),i}readView(e){return this._viewTarget||=this.createTarget(),this.blit(e,new yr(e.renderTarget.uiBuffer.textures[0],M.TEXTURE_2D),this._viewTarget),this.readPixels(this._viewTarget)}createTarget(e){let t=new br(this._gl,e&&e.size||this._renderer.resolution,!(e&&e.size));return this._targets.push(t),t}resize(e){this._fullscreenTarget.reset(e);for(let t=0;t<this._targets.length;t++){let n=this._targets[t];n.autoResize&&n.reset(e)}}_fitToView(e,t){e.autoResize&&e.setSize(t.resolution)}_setPassResolution(e,t){e.resolution.copy(t),e.resolutionInv.set(1/t.x,1/t.y)}onDrawPass(e){let t=(t,n)=>{if(!t)return;let r=t.textures,i=`currentFace`in t?t.currentFace:M.TEXTURE_2D;for(let t=0;t<r.length;t++){let a=n?n+(r.length>1?`_`+t:``):``;e(new yr(r[t],i),a)}};return this._renderer.on(`drawPass`,t),()=>this._renderer.off(`drawPass`,t)}materials={flat:e=>new pn({vert:pr,frag:fr,phase:[`forward`],drawType:e.lines?`LINES`:`TRIANGLES`,depthTest:e.depthTest??!0,depthWrite:e.depthWrite??!0,uniforms:{uColor:{value:e.color,type:`3fv`}}}),mask:()=>new pn({vert:gr,frag:hr,phase:[`forward`],depthTest:!1}),grid:e=>new pn({vert:pr,frag:mr,phase:[`forward`],depthWrite:!1,uniforms:{uColor:{value:e.color,type:`3fv`},uParams:{value:e.params,type:`3fv`}}})};recipes={outline:(e,t)=>new Cr(`editorOutline`,new P(this._renderer.backend,{frag:_r,renderTarget:null,uniforms:{uMaskTexture:{value:e.texture,type:`1i`},uOutlineColor:{value:new A(t[0],t[1],t[2]),type:`3fv`}}}),e)}},Tr=e=>new wr(e.renderer),Er=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,rm=class extends It{wrapperElm;glCanvas;backend;gl;canvasTexture;canvas;canvasCtx;glRenderer;postProcess;viewPort;viewPortRange;viewPortScale;frameSetting;loopSetting;musicBuffer;musicTexture;resizeObserver;canvasSize;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.glCanvas=document.createElement(`canvas`),this.backend=new jt(this.glCanvas.getContext(`webgl2`)),this.gl=this.backend.gl,this.canvasSize=new A(this.glCanvas.width,this.glCanvas.height),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0],this.viewPortScale=50,this.frameSetting=null,this.loopSetting={enabled:!1,start:0,end:0},this.resizeObserver=new ResizeObserver(this.onResize.bind(this));let e={renderer:null,createEntity:t=>new an({...t,engine:e})};this.glRenderer=new ar(this.backend,e),e.renderer=this.glRenderer,this.canvasTexture=new Dt(this.gl),this.musicBuffer=null,this.musicTexture=new Dt(this.gl),this.musicTexture.setting({type:this.gl.UNSIGNED_BYTE,internalFormat:this.gl.LUMINANCE,format:this.gl.LUMINANCE,magFilter:this.gl.LINEAR,minFilter:this.gl.LINEAR,wrapS:this.gl.MIRRORED_REPEAT}),this.postProcess=new mn({passes:[new P(this.backend,{frag:nm,uniforms:{uCanvasTex:{type:`1i`,value:null},uMusicTex:{type:`1i`,value:this.musicTexture}},renderTarget:null})]})}onResize(){if(this.wrapperElm){let e=new A(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);if(e.x===0||e.y===0)return;this.glCanvas.width=this.canvas.width=e.x,this.glCanvas.height=this.canvas.height=e.y,this.canvasSize.set(this.glCanvas.width,this.glCanvas.height),this.postProcess.resize(e),this.render()}}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.frameSetting){this.canvasCtx.fillStyle=`#181818`;let e=this.frameToPx(0),t=this.frameToPx(this.frameSetting.duration);this.canvasCtx.fillRect(e,0,t-e,this.canvas.height)}let e=(e,t,n)=>{let r=Math.ceil(this.viewPort[0]/e)*e;this.canvasCtx.beginPath();let i=0;for(;r<this.viewPort[2]&&i<100;){let n=this.frameToPx(r+t);this.canvasCtx.moveTo(n,0),this.canvasCtx.lineTo(n,this.canvas.height),r+=e,i++}this.canvasCtx.strokeStyle=n,this.canvasCtx.lineWidth=1,this.canvasCtx.stroke()};if(e(this.viewPortScale,0,`#555`),e(this.viewPortScale,this.viewPortScale/2,`#333`),this.musicBuffer&&this.frameSetting){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)],s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}if(this.loopSetting.enabled){this.canvasCtx.fillStyle=`#0009`;let e=this.frameToPx(this.loopSetting.start),t=this.frameToPx(this.loopSetting.end);this.canvasCtx.fillRect(0,0,e,this.canvas.height),this.canvasCtx.fillRect(t,0,this.canvas.width-t,this.canvas.height)}this.canvasTexture.attach(this.canvas),this.postProcess.passes&&(this.postProcess.passes[0].uniforms.uCanvasTex.value=this.canvasTexture),this.glRenderer.renderPostProcess(this.postProcess,void 0,this.canvasSize)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.glCanvas),this.onResize()}setViewPort(e,t){this.viewPort=e,this.viewPortRange=[e[2]-e[0],e[3]-e[1]],this.viewPortScale=t,this.render()}setFrameSetting(e){this.frameSetting={duration:Math.round(e.duration),fps:Math.round(e.fps)},this.render()}setMusicBuffer(e){this.musicBuffer=e,setTimeout(()=>{this.render()},100)}setLoopSetting(e,t,n){this.loopSetting={enabled:e,start:t,end:n},this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.glCanvas),this.resizeObserver.disconnect()}},im={timelineCanvas:`TimelineCanvas__timelineCanvas___LnRpb`},am=()=>{let{viewPort:e,viewPortScale:t,musicBuffer:n,musicBufferVersion:r,glEditor:i}=tm(),[a,o]=(0,b.useState)(),s=(0,b.useRef)(null);(0,b.useEffect)(()=>{let e=new rm;return o(e),s.current&&e.setWrapperElm(s.current),()=>{e.dispose()}},[]),(0,b.useEffect)(()=>{a&&e&&t&&a.setViewPort(e,t)},[a,e,t]);let[c]=Q(i?.engine,`timeline/duration`),[l]=Q(i?.engine,`timeline/fps`);(0,b.useEffect)(()=>{a&&c&&l&&a.setFrameSetting({duration:c||0,fps:l||0})},[a,c,l]);let[u]=Q(i,`frameLoop/enabled`),[d]=Q(i,`frameLoop/start`),[f]=Q(i,`frameLoop/end`);return(0,b.useEffect)(()=>{a&&a.setLoopSetting(u||!1,d||0,f||0)},[a,u,d,f]),(0,b.useEffect)(()=>{a&&n&&a.setMusicBuffer(n)},[a,n,r]),(0,T.jsx)(`div`,{className:im.timelineCanvas,ref:s})},om={controls:`TimelineControls__controls___LmNvb`},sm=e=>{let{viewPort:t,setCurrentFrame:n,getFrameViewPort:r,zoom:i,scroll:a,setViewPortCenter:o}=tm(),s=(0,b.useRef)([0,0,0,0]),c=(0,b.useRef)([0,0]);t&&(s.current=t,c.current=[t[2]-t[0],t[3]-t[1]]);let l=(0,b.useRef)(null),u=(0,b.useRef)(null),d=(0,b.useRef)(null),f=(0,b.useRef)(null),p=(0,b.useRef)(null),m=(0,b.useCallback)(e=>{let t=l.current&&l.current.clientWidth||1;if(d.current==0){if(n&&r&&u.current){let i=(e.clientX-u.current.left)/t;n(r(i))}}else if(d.current==1){let n=[e.clientX,e.clientY];if(f.current&&p.current){let e=-(n[0]-f.current[0])/t*c.current[0];o&&o(p.current+e)}}},[n,r,o]),h=(0,b.useCallback)(e=>{d.current=e.button,p.current=(s.current[2]+s.current[0])/2,f.current=[e.clientX,e.clientY],u.current=e.currentTarget.getBoundingClientRect();let t=(e.clientX-u.current.left)/e.currentTarget.clientWidth;d.current==0&&n&&r&&n(r(t)),window.addEventListener(`pointermove`,m);let i=()=>{f.current=null,d.current=null,p.current=null,window.removeEventListener(`pointermove`,m)};return window.addEventListener(`pointerup`,i),()=>{window.removeEventListener(`pointerup`,i),window.removeEventListener(`pointermove`,m)}},[r,n,m]),g=(0,b.useCallback)(e=>{if(d.current!==null||!i||!a)return;e.preventDefault();let t=e.target&&e.target.clientWidth||1,n=Math.abs(e.deltaY);Math.abs(e.deltaX)<n?i(n>50?e.deltaY<0?.9:1.1:1+e.deltaY*.005):a(e.deltaX/t*.5)},[i,a]);return(0,b.useEffect)(()=>{let e=l.current;return e&&e.addEventListener(`wheel`,g,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,g)}},[g]),t?(0,T.jsx)(`div`,{className:om.controls,onPointerDown:h,ref:l,children:e.children}):null},cm={cursor:`TimelineCursor__cursor___LmN1c`,frame:`TimelineCursor__frame___LmN1c`},lm=()=>{let{viewPort:e,framePlay:t}=tm();if(!e||!t)return null;let n=e[2]-e[0],r=(t.current-e[0])/n;return(0,T.jsx)(`div`,{className:cm.cursor,style:{left:r*100+`%`},children:(0,T.jsx)(`div`,{className:cm.frame})})},um={timelineLoop:`TimelineLoop__timelineLoop___LnRpb`,start:`TimelineLoop__start___LnRpb`,end:`TimelineLoop__end___LnRpb`},dm={cursor:`TimelineLoopCursor__cursor___LmN1c`},fm=({onMove:e})=>{let t=(0,b.useRef)(!1);return(0,T.jsx)(`div`,{className:dm.cursor,onPointerDown:e=>{e.buttons==1&&(t.current=!0,e.stopPropagation())},onPointerMove:n=>{let r=n.target;t.current!==!1&&n.buttons==1&&(r.setPointerCapture(n.pointerId),n.buttons==1&&e&&e(n.clientX),n.nativeEvent.preventDefault(),n.nativeEvent.stopPropagation())},onPointerUp:()=>{t.current=!1}})},pm=()=>{let{viewPort:e,framePlay:t,glEditor:n}=tm(),r=(0,b.useRef)(null);Sf(n,[`frameLoop/enabled`,`frameLoop/start`,`frameLoop/end`]);let[i]=Q(n,`frameLoop/enabled`),[a,o]=Q(n,`frameLoop/start`),[s,c]=Q(n,`frameLoop/end`);if(i!==!0||!e||!t||a===void 0||s===void 0)return null;let l=e[2]-e[0],u=(a-e[0])/l,d=(s-e[0])/l,f=(t,n)=>{let r=t.getBoundingClientRect();return(n-r.x)/r.width*(e[2]-e[0])+e[0]};return(0,T.jsx)(`div`,{className:um.timelineLoop,ref:r,children:(0,T.jsxs)(`div`,{className:um.timelineLoop_inner,children:[(0,T.jsx)(`div`,{className:um.start,style:{left:u*100+`%`},children:(0,T.jsx)(fm,{onMove:e=>{r.current&&o&&o(f(r.current,e))}})}),(0,T.jsx)(`div`,{className:um.end,style:{left:d*100+`%`},children:(0,T.jsx)(fm,{onMove:e=>{r.current&&c&&c(f(r.current,e))}})})]})})},mm={scale:`TimelineScale__scale___LnNjY`,scale_inner:`TimelineScale__scale_inner___LnNjY`,scale_item:`TimelineScale__scale_item___LnNjY`,scale_item_frame:`TimelineScale__scale_item_frame___LnNjY`,scale_item_time:`TimelineScale__scale_item_time___LnNjY`},hm=e=>`${(`00`+Math.floor(e%3600/60)).slice(-2)}:${(`00`+Math.floor(e%60)).slice(-2)}`,gm=()=>{let{glEditor:e,viewPort:t,viewPortScale:n}=tm(),[r,i]=Q(e?.engine,`timeline/fps`);if(!t||!n||r===void 0)return null;let a=[],o=Math.ceil(t[0]/n)*n,s=0;for(;o<t[2]&&s<100;){let e=(o-t[0])/(t[2]-t[0]),i=o/(r||0);a.push((0,T.jsxs)(`div`,{className:mm.scale_item,style:{left:e*100+`%`},children:[(0,T.jsx)(`div`,{className:mm.scale_item_frame,children:o}),(0,T.jsx)(`div`,{className:mm.scale_item_time,children:hm(i)})]},o)),o+=n,s++}return(0,T.jsx)(`div`,{className:mm.scale,children:(0,T.jsx)(`div`,{className:mm.scale_inner,children:a})})},_m={timelineSetting:`TimelineSetting__timelineSetting___LnRpb`,play:`TimelineSetting__play___LnRpb`},vm=()=>{let{framePlay:e,glEditor:t}=tm(),n=(0,b.useCallback)((e,t)=>{t&&t(e)},[]),[r,i]=Q(t,`frameLoop/enabled`),[a]=Q(t?.engine,`timeline/duration`),[o]=Q(t?.engine,`timeline/fps`),s=(0,b.useCallback)((e,n)=>{t&&t.api.setField(t.engine,e,n)},[t]),c=(0,b.useCallback)(()=>{t&&t.togglePlay()},[t]);return(0,T.jsx)(`div`,{className:_m.timelineSetting,children:(0,T.jsxs)(rt,{children:[(0,T.jsx)(`div`,{className:_m.play,children:(0,T.jsx)(ae,{onClick:c,children:e.playing?(0,T.jsx)(fe,{size:14}):(0,T.jsx)(pe,{size:14})})}),(0,T.jsx)(Ue,{title:`current`,children:(0,T.jsx)(Kr,{value:Math.floor(e?.current||0),readOnly:!0})}),(0,T.jsx)(Ue,{title:`duration`,children:(0,T.jsx)(Kr,{value:a,onChange:e=>s(`timeline/duration`,e)})}),(0,T.jsx)(Ue,{title:`fps`,children:(0,T.jsx)(Kr,{value:o,onChange:e=>s(`timeline/fps`,e)})}),(0,T.jsx)(Ue,{title:`loop`,children:(0,T.jsx)(Kr,{value:r||!1,onChange:e=>n(e,i)})})]})})},ym={timeline:`Timeline__timeline___LnRpb`,inner:`Timeline__inner___LnRpb`,content:`Timeline__content___LnRpb`,setting:`Timeline__setting___LnRpb`},bm=()=>{let{editor:e}=Vr(),[t,n]=(0,b.useState)({current:0,playing:!1}),[r,i]=(0,b.useState)([0,0,100,0]),a=(0,b.useRef)([0,0,0,0]);a.current=r;let o=r[2]-r[0],s=10*2**(0+Math.floor(Math.log2(o/100)));s=Math.max(1,Math.floor(s));let c=e?.audioBuffer,[l,u]=(0,b.useState)();(0,b.useEffect)(()=>{if(e){let t=e.engine,r=e=>{n({...e})};r(t.frame);let a=0,o=()=>{u(a++)},s=()=>{i([0,0,t.frameSetting.duration,0])};return s(),t.on(`update/frame/play`,r),t.on(`update/music`,o),t.on(`loaded`,s),()=>{t.off(`update/frame/play`,r),t.off(`update/music`,o),t.off(`loaded`,s)}}},[e]);let d=(0,b.useCallback)(t=>{e&&e.engine.seek(t)},[e]),f=(0,b.useCallback)(e=>{let t=r[2]-r[0];return Math.floor(r[0]+t*e)},[r]),p=(0,b.useCallback)(e=>{let t=a.current,n=(t[2]+t[0])/2,r=(t[0]-n)*e+n,o=(t[2]-n)*e+n;i([r,t[1],o,t[3]])},[]),m=(0,b.useCallback)(e=>{let t=a.current,n=e*(t[2]-t[0]);i([t[0]+n,t[1],t[2]+n,t[3]])},[]),h=(0,b.useCallback)(e=>{let t=a.current,n=t[2]-t[0];i([e-n/2,t[1],e+n/2,t[3]])},[]);return{glEditor:e,framePlay:t,viewPort:r,viewPortScale:s,musicBuffer:c,musicBufferVersion:l,setCurrentFrame:d,getFrameViewPort:f,zoom:p,scroll:m,setViewPortCenter:h}},xm=e=>{let t=bm();return(0,T.jsx)(em.Provider,{value:t,children:e.children})},Sm=()=>(0,T.jsx)(xm,{children:(0,T.jsx)(`div`,{className:ym.timeline,children:(0,T.jsxs)(`div`,{className:ym.inner,children:[(0,T.jsx)(`div`,{className:ym.setting,children:(0,T.jsx)(vm,{})}),(0,T.jsxs)(`div`,{className:ym.content,children:[(0,T.jsx)(am,{}),(0,T.jsx)(lm,{}),(0,T.jsx)(sm,{children:(0,T.jsx)(pm,{})}),(0,T.jsx)(gm,{})]})]})})}),Cm={editor:`OREditor__editor___LmVka`},wm=e=>{let{engine:t}=Wf(),[n,r]=(0,b.useState)(()=>new vf(t)),i=b.useRef(n);return i.current=n,(0,b.useEffect)(()=>{if(!i.current.disposed&&i.current.engine.uuid==t.uuid)return;let e=new vf(t);r(e)},[t]),(0,b.useEffect)(()=>()=>{n.dispose()},[n]),{engine:t,editor:n,projectName:e}},Tm=e=>{let t=wm(e.projectName),n=(0,b.useRef)(Promise.resolve());(0,b.useEffect)(()=>{if(!t.editor||!e.onSave)return;let r=e.onSave,i=(e,t)=>{n.current=Promise.resolve(r(e,t))};return t.editor.on(`save`,i),()=>{t.editor.off(`save`,i)}},[t.editor,e.onSave]);let r=(0,b.useRef)(null),i=e.scenes??null;return(0,b.useEffect)(()=>{r.current=i},[i]),(0,b.useEffect)(()=>Oa({editor:t.editor,getScenes:()=>r.current,waitForSave:()=>n.current}),[t.editor]),(0,b.useEffect)(()=>{t.editor&&t.editor.bootstrap(e.editorData)},[e.editorData,t.editor]),(0,T.jsx)(Br.Provider,{value:{...t,scenes:e.scenes},children:e.children})},Em=[{id:`hierarchy`,title:`Hierarchy`,category:`General`,content:(0,T.jsx)(rt,{children:(0,T.jsx)(ip,{})})},{id:`timer`,title:`Timer`,category:`Rendering`,content:(0,T.jsx)(rt,{noPadding:!0,children:(0,T.jsx)(Zf,{})})},{id:fp,title:`Screen`,category:`General`,multiple:!0,content:e=>(0,T.jsx)(pp,{viewportId:e})},{id:`property`,title:`Property`,category:`General`,content:(0,T.jsx)(rt,{children:(0,T.jsx)(Bf,{})})},{id:`textures`,title:`Textures`,category:`Rendering`,content:(0,T.jsx)(rt,{noPadding:!0,children:(0,T.jsx)($p,{})})},{id:`scene`,title:`Scene`,category:`General`,content:(0,T.jsx)(rt,{children:(0,T.jsx)(Zp,{})})},{id:`export`,title:`Export`,category:`Project`,content:(0,T.jsx)(rt,{children:(0,T.jsx)(Hf,{})})},{id:`renderer`,title:`Renderer`,category:`Rendering`,content:(0,T.jsx)(rt,{children:(0,T.jsx)(Kp,{})})},{id:`editor-settings`,title:`Editor`,category:`Project`,content:(0,T.jsx)(rt,{children:(0,T.jsx)(ei,{})})},{id:`timeline`,title:`Timeline`,category:`Animation`,content:(0,T.jsx)(rt,{noPadding:!0,children:(0,T.jsx)(Sm,{})})}],Dm=e=>{let t=[];for(let n of e)n.multiple||n.id!==`hierarchy`&&n.id!==`property`&&n.id!==`timeline`&&t.push({id:n.id,title:n.title,content:n.content});return t},Om=e=>{let t=yt(),n=(0,b.useMemo)(()=>e.panels?[...Em,...e.panels]:Em,[e.panels]),r=null;return r=t.isPC?(0,T.jsx)(Wp,{panels:n}):(0,T.jsx)(T.Fragment,{children:(0,T.jsxs)(Je,{direction:`vertical`,storageKey:`orengine-editor-sp-main`,children:[(0,T.jsx)(Je.Item,{size:`calc( min( 56.25vw, 55vh ) + 77px )`,minSize:200,style:{minHeight:`200px`},children:(0,T.jsx)(pp,{viewportId:`main`})}),(0,T.jsx)(Je.Item,{flex:1,minSize:200,children:(0,T.jsxs)(ot,{storageKey:`orengine-panel-sp-main`,children:[(0,T.jsx)(ot.Tab,{title:`Hierarchy / Property`,children:(0,T.jsxs)(Je,{direction:`horizontal`,storageKey:`orengine-editor-sp-hierarchyProp`,children:[(0,T.jsx)(Je.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,T.jsx)(ip,{})}),(0,T.jsx)(Je.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,T.jsx)(Bf,{})})]})}),Dm(n).map(e=>(0,T.jsx)(ot.Tab,{title:e.title,children:e.content},e.id))]})}),(0,T.jsx)(Je.Item,{size:`120px`,minSize:80,children:(0,T.jsx)(ot,{storageKey:`orengine-panel-sp-timeline`,children:(0,T.jsx)(ot.Tab,{title:`Timeline`,children:(0,T.jsx)(rt,{noPadding:!0,children:(0,T.jsx)(C,{fallback:(0,T.jsx)(`div`,{children:`エラーだよ`}),children:(0,T.jsx)(Sm,{})})})})})})]})}),(0,T.jsx)(Tm,{projectName:e.projectName,onSave:e.onSave,editorData:e.editorData,scenes:e.scenes,children:(0,T.jsx)(mt,{children:(0,T.jsxs)(Ve,{children:[(0,T.jsx)(`div`,{className:Cm.editor,children:r}),(0,T.jsx)(bf,{}),(0,T.jsx)(ze,{}),(0,T.jsx)(dt,{})]})})})},km=()=>{let[e,t]=b.useState(()=>new F(or)),n=b.useRef(e);return n.current=e,(0,b.useEffect)(()=>{n.current.disposed&&t(new F(or))},[]),(0,b.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,b.useCallback)(t=>{t&&e.load(t)},[e])}},Am=e=>{let t=km(),{engine:n}=t,r=(0,b.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,b.useEffect)(()=>{r.current?.(n)},[n]),(0,b.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,T.jsx)(Uf.Provider,{value:t,children:e.children})},jm=e=>(0,T.jsx)(Am,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,T.jsx)(Om,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),Mm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Pm=s({EyeRings:()=>Fm}),Fm=class extends qt{constructor(e){super(e);let t=new on({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new pn({phase:[`deferred`,`shadowMap`],frag:Mm,vert:Nm});this.entity.addComponent(N,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(N)}},Im=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Rm=s({FlashLine:()=>zm}),zm=class extends qt{geometry;material;constructor(e){super(e),this.geometry=new Xt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=St.randomVector().multiply(new A(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new pn({phase:[`forward`,`envMap`],frag:cn(`flFrag`,Im),vert:cn(`flVert`,Lm)}),this.entity.addComponent(N,{material:this.material,geometry:this.geometry})}},Bm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Vm=s({SkyBox:()=>Hm}),Hm=class extends qt{material;constructor(e){super(e);let t=this.engine;this.material=new pn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:cn(`SkyBoxFrag`,Bm),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}},Um=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Gm=s({GridCross:()=>Km}),Km=class extends qt{constructor(e){super(e);let t=new Yt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new A(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new pn({frag:cn(`gridCrossFrag`,Um),vert:cn(`gridCrossVert`,Wm),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},qm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Ym=s({GridDots:()=>Xm}),Xm=class extends qt{constructor(e){super(e);let t=new Qt({radius:.1}),n=[],r=[],i=new A(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new pn({frag:cn(`gridDotsFrag`,qm),vert:cn(`gridDotsVert`,Jm),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},Zm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,$m=s({WireCube:()=>eh}),eh=class extends qt{constructor(e){super(e);let t=3.3,n=t/2,r=new Yt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new pn({phase:[`deferred`],frag:Zm,vert:Qm});this.entity.addComponent(N,{geometry:r,material:o})}},th=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,rh=s({OREngineCube:()=>ih}),ih=class extends qt{material;constructor(e){super(e),this.material=new pn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:cn(`OREngineCubeVert`,nh),frag:cn(`OREngineCubeFrag`,th),uniforms:{uNoiseTex:{value:F.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(N);t&&(t.material=this.material)}},ah=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,sh=s({OREngineLogo:()=>ch}),ch=class extends qt{material;constructor(e){super(e),this.material=new pn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:cn(`OREngineLogoVert`,oh),frag:cn(`OREngineLogoFrag`,ah)});let t=this.entity.getComponent(N);t&&(t.material=this.material)}},lh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,dh=s({Dust:()=>fh}),fh=class extends qt{constructor(e){super(e);let t=new Jt,n=e.args?.num||2048,r=new A(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new pn({phase:[`forward`],drawType:`POINTS`,frag:lh,vert:uh});this.entity.addComponent(N,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(N)}},ph=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `,gh=s({YakiSoba:()=>_h}),_h=class extends qt{_gpu;constructor(e){super(e);let t=this.engine,n=new A(64,512);this._gpu=new ur({passes:[new dr(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:cn(`yakiSobaCompute`,hh),uniforms:dn.merge({},t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new Yt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new pn({frag:cn(`chainFrag`,ph),vert:cn(`chainVert`,mh),phase:[`deferred`,`shadowMap`],uniforms:dn.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(N,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(N),this._gpu.dispose()}},vh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `},Bh={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `,Hh=Object.assign({"../../demo-webgl/Resources/Textures/hash.tex":zh,"../../demo-webgl/Resources/Textures/noise.tex":Bh,"../../demo-webgl/Resources/Textures/noiseCyclic.tex":{name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:Vh},"../../demo-webgl/Resources/Textures/noiseCyclicAnime.tex":{name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:Vh}}),Uh=()=>{for(let e of Object.values(Hh))e&&F.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},Wh=e=>{F.resources.buildTextureInstances(e.renderer)},Gh=Object.assign({"../../demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":Pm,"../../demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":Rm,"../../demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":Vm,"../../demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":Gm,"../../demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":Ym,"../../demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":$m,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":rh,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":sh,"../../demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":dh,"../../demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":gh,"../../demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":yh}),Kh=Object.assign({}),qh=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addComponent(i,a):qh(a,t.createGroup(i))}},Jh=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addGeometry(i,a):Jh(a,t.createGroup(i))}},Yh=()=>{Wt.gltfLoaderFactory=e=>new Mr(e),F.resources.clear();let e=F.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,tn),e.addComponent(`Camera`,$t),e.addComponent(`Mesh`,N);let t=Object.keys(Lh);for(let e=0;e<t.length;e++){let n=t[e],r=Lh[n];qh(r,F.resources.addComponentGroup(n))}let n=Object.keys(Rh);for(let e=0;e<n.length;e++){let t=n[e],r=Rh[t];Jh(r,F.resources.addGeometryGroup(t))}let r=Fr(Gh,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t];qh(n,F.resources.addComponentGroup(t))}let a=Fr(Kh,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t];Jh(n,F.resources.addGeometryGroup(t))}Uh()},Xh=s({panel:()=>Zh}),Zh={id:`sample`,title:`Sample`,category:`Tools`,content:(0,T.jsx)(()=>{let{editor:e,engine:t}=Vr(),[n]=Q(e,`selectedEntityId`),[r,i]=(0,b.useState)(``),a=n?t.root.findEntityByUUID(n):void 0;return(0,T.jsxs)(rt,{children:[(0,T.jsx)(re,{label:`Selected Entity`,children:a?a.name:`-`}),(0,T.jsxs)(re,{label:`Server`,children:[(0,T.jsx)(ae,{onClick:async()=>{try{let e=await(await fetch(`/api/ext/hello`)).json();i(e.message)}catch{i(`failed`)}},children:`GET /api/ext/hello`}),r&&(0,T.jsx)(`p`,{children:r})]})]})},{})},Qh=Object.assign({"../../demo-webgl/editor/Panels/Sample/index.tsx":Xh}),$h=(()=>{let e=[],t=Object.keys(Qh);for(let n=0;n<t.length;n++){let r=Qh[t[n]].panel;r&&e.push(r)}return e})();document.title=`${y.name} | OREngine`,Yh(),_.createRoot(document.getElementById(`root`)).render((0,T.jsx)(jm,{projectName:`demo-webgl`,sceneData:y,editorData:v,initResourceInstances:Wh,panels:$h}));