...
void main( void ) {
	...
	id: PanelId;
	title: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},scenes:{required:!1,tsType:{name:`SceneSelection`},description:``}}}})))()}var Ax,jx;function Mx(){return(Mx=t((()=>{Ax=e(i(),1),ip(),Qa(),jx=()=>{let[e,t]=Ax.useState(()=>new Za(np)),n=Ax.useRef(e);return n.current=e,(0,Ax.useEffect)(()=>{n.current.disposed&&t(new Za(np))},[]),(0,Ax.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,Ax.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var Nx,Px,Fx;function Ix(){return(Ix=t((()=>{Nx=i(),cs(),Mx(),Px=s(),Fx=e=>{let t=jx(),{engine:n}=t,r=(0,Nx.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,Nx.useEffect)(()=>{r.current?.(n)},[n]),(0,Nx.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,Px.jsx)(ss.Provider,{value:t,children:e.children})},Fx.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var Lx,Rx,zx,Bx,Vx,Hx,Ux;function Wx(){return(Wx=t((()=>{Lx=i(),kx(),Ix(),Rx=s(),zx=`scene`,Bx=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},Vx=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),Hx=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),Ux=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,Lx.useState)(e.sceneData),[a,o]=(0,Lx.useState)(e.editorData),[s,c]=(0,Lx.useState)([]),[l,u]=(0,Lx.useState)(null),d=(0,Lx.useCallback)(async e=>{let t=await Bx(`${n}/scenes/${e}`);t&&(u(e),i(t))},[n]);(0,Lx.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([Bx(`${n}/editor`),Bx(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[zx]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]);let f={names:s,current:l,onSelect:d,onCreate:(0,Lx.useCallback)(async e=>{if(!(await Vx(`${n}/scenes/${e}`,Hx(e))).ok)return;let t=await Bx(`${n}/scenes`);t&&c(t),await d(e)},[n,d]),onDelete:(0,Lx.useCallback)(async e=>{if(!(await fetch(`${n}/scenes/${e}`,{method:`DELETE`})).ok)return;let t=await Bx(`${n}/scenes`)??[];c(t),e===l&&t.length>0&&await d(t[0])},[n,l,d])};return(0,Rx.jsx)(Fx,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,Rx.jsx)(Ox,{editorData:a,projectName:t,panels:e.panels,scenes:f,onSave:(t,r)=>{e.onBeforeSave?.(),l&&Vx(`${n}/scenes/${l}`,t),Vx(`${n}/editor`,{...r,[zx]:l})}})})},Ux.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
} & (
	// レイアウト内に同時1つまで。Panel ラッパー込みの完成形を持つ
	...
	id: PanelId;
	title: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var Gx,Kx;function qx(){return(qx=t((()=>{kx(),Ix(),Gx=s(),Kx=e=>(0,Gx.jsx)(Fx,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,Gx.jsx)(Ox,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),Kx.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
} & (
	// レイアウト内に同時1つまで。Panel ラッパー込みの完成形を持つ
	...
	id: PanelId;
	title: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}function Jx(){return(Jx=t((()=>{te(),re(),Ye(),fe(),nt()})))()}function Yx(){return(Yx=t((()=>{Wx(),qx(),kx(),wx(),D(),Ix(),ds(),Oc(),Zo(),ou(),Dl(),Pl(),Uf(),Sd(),id(),as(),zs(),Ju(),Jt(),Vt(),gd(),En(),vl(),Mt(),fn(),rc(),_t(),xt(),At(),Dn(),en(),on(),il(),dl(),Ys(),uo(),_o(),Hc(),Jc(),Le(),je(),Ve(),Pe(),c(),u(),x(),Jx(),ue(),w(),oe(),ce(),lt()})))()}export{ii as $,tt as $t,nc as A,jn as At,io as B,Jt as Bt,il as C,Cr as Ct,Hc as D,Mn as Dt,Vc as E,Fn as Et,as as F,Tn as Ft,Ia as G,bt as Gt,Qa as H,Mt as Ht,Xo as I,En as It,gi as J,_t as Jt,Ma as K,xt as Kt,Zo as L,dn as Lt,Js as M,kn as Mt,Ys as N,A as Nt,Dc as O,Nn as Ot,is as P,On as Pt,ri as Q,lt as Qt,uo as R,fn as Rt,rl as S,Sr as St,Jc as T,Pn as Tt,L as U,kt as Ut,Za as V,O as Vt,Fa as W,At as Wt,li as X,E as Xt,_i as Y,D as Yt,ui as Z,ct as Zt,id as _,jr as _t,kx as a,Gr as at,ul as b,Er as bt,Qb as c,Rr as ct,Yb as d,Lr as dt,nt as en,ei as et,Zb as f,Pr as ft,rd as g,Ar as gt,Uf as h,Nr as ht,Ox as i,Ie as in,F as it,rc as j,j as jt,Oc as k,An as kt,ex as l,zr as lt,Hf as m,Mr as mt,Fx as n,Ye as nn,Kr as nt,Cx as o,Hr as ot,ip as p,Fr as pt,Na as q,gt as qt,Ix as r,Le as rn,qr as rt,wx as s,Ur as st,Yx as t,Je as tn,ti as tt,Xb as u,Ir as ut,qu as v,Or as vt,qc as w,M as wt,dl as x,Dr as xt,Ju as y,kr as yt,lo as z,qt as zt};