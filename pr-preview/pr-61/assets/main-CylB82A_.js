...
\r
	...
	outColor = vec4( col, 1.0 );\r
\r
}`,mr=class extends en{constructor(e){super({name:`ColorGrading`,passes:[new I(e,{frag:pr})]})}},hr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor = vec4( col, 1.0 );\r
\r
}`,gr=class extends en{constructor(e){super({name:`Finalize`,passes:[new I(e,{frag:hr})]})}},_r=`uniform sampler2D uBackBuffer0;\r
...
}`,Yf=s({EyeRings:()=>Xf}),Xf=class extends Ft{constructor(e){super(e);let t=this.engine,n=new Kt({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new $t({phase:[`deferred`,`shadowMap`],frag:qf,vert:Jf,uniforms:t.uniforms});this.entity.addComponent(F,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(F)}},Zf=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,$f=s({FlashLine:()=>ep}),ep=class extends Ft{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new Lt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=dt.randomVector().multiply(new j(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new $t({phase:[`forward`,`envMap`],frag:Jt(`flFrag`,Zf),vert:Jt(`flVert`,Qf),uniforms:Zt.merge(t.uniforms)}),this.entity.addComponent(F,{material:this.material,geometry:this.geometry})}},tp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,np=s({SkyBox:()=>rp}),rp=class extends Ft{material;constructor(e){super(e);let t=this.engine;this.material=new $t({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:Jt(`SkyBoxFrag`,tp),uniforms:Zt.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}},ip=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,op=s({GridCross:()=>sp}),sp=class extends Ft{constructor(e){super(e);let t=new It({width:.05,height:.5,depth:.05}),n=[],r=[],i=new j(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new $t({frag:Jt(`gridCrossFrag`,ip),vert:Jt(`gridCrossVert`,ap),phase:[`forward`]});this.entity.addComponent(F,{geometry:t,material:a})}},cp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,up=s({GridDots:()=>dp}),dp=class extends Ft{constructor(e){super(e);let t=new zt({radius:.1}),n=[],r=[],i=new j(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new $t({frag:Jt(`gridDotsFrag`,cp),vert:Jt(`gridDotsVert`,lp),phase:[`forward`]});this.entity.addComponent(F,{geometry:t,material:a})}},fp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,mp=s({WireCube:()=>hp}),hp=class extends Ft{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new It({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new $t({phase:[`deferred`],frag:fp,vert:pp,uniforms:Zt.merge(t.uniforms)});this.entity.addComponent(F,{geometry:i,material:s})}},gp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,vp=s({OREngineCube:()=>yp}),yp=class extends Ft{material;constructor(e){super(e);let t=this.engine;this.material=new $t({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:Jt(`OREngineCubeVert`,_p),frag:Jt(`OREngineCubeFrag`,gp),uniforms:Zt.merge(t.uniforms,{uNoiseTex:{value:Tr.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(F);n&&(n.material=this.material)}},bp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Sp=s({OREngineLogo:()=>Cp}),Cp=class extends Ft{material;constructor(e){super(e);let t=this.engine;this.material=new $t({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:Jt(`OREngineLogoVert`,xp),frag:Jt(`OREngineLogoFrag`,bp),uniforms:Zt.merge(t.uniforms)});let n=this.entity.getComponent(F);n&&(n.material=this.material)}},wp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Ep=s({Dust:()=>Dp}),Dp=class extends Ft{constructor(e){super(e);let t=this.engine,n=new P,r=e.args?.num||2048,i=new j(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new $t({phase:[`forward`],drawType:`POINTS`,frag:wp,vert:Tp,uniforms:Zt.merge(t.uniforms)});this.entity.addComponent(F,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(F)}},Op=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
