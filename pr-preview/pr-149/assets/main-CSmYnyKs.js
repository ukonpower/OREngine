...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}},hn=class extends qt{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}},N=class extends mn{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	vUv = uv;\r
\r
}`}),this.enabled=!0,this._fixedResolution=t.fixedResotluion?t.fixedResotluion.clone():null,this.resolution=new k,this.resolutionInv=new k,this.viewPort=null,this.uniforms.uPPResolution={value:this.resolution,type:`2fv`},this.uniforms.uPPPixelSize={value:this.resolutionInv,type:`2fv`},this.renderTarget=t.renderTarget===void 0?e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]):t.renderTarget,this.clearColor=t.clearColor??null,this.clearDepth=t.clearDepth??null,this.depthTest=t.depthTest!==void 0&&t.depthTest,this.resolutionRatio=t.resolutionRatio||1,this.passThrough=t.passThrough??!1,this.viewPort=t.viewPort||null,this.backBufferOverride=t.backBufferOverride||null}get fixedResolution(){return this._fixedResolution}set fixedResolution(e){this._fixedResolution=e,this.resize(e||new k)}onAfterRender(){}resize(e){this._fixedResolution?this.resolution.copy(this._fixedResolution):this.resolution.copy(e).multiply(this.resolutionRatio),this.resolutionInv.set(1/this.resolution.x,1/this.resolution.y),this.renderTarget&&this.renderTarget.setSize(this.resolution)}setRendertarget(e){this.renderTarget=e,this.renderTarget&&(this.renderTarget.size.x!=this.resolution.x||this.renderTarget.size.y!=this.resolution.y)&&this.renderTarget.setSize(this.resolution)}},gn=class extends Ot{material;_renderer;_resolution;_postProcess;_frameBuffer;constructor(e,t){let n=e.backend,r=n.gl;super(r),this._renderer=e,this._resolution=t.resolution||new k(1024,1024),this.setting({wrapS:r.REPEAT,wrapT:r.REPEAT,magFilter:r.LINEAR,minFilter:r.LINEAR}),this._frameBuffer=new kt(r).setTexture([this]).setSize(this._resolution),this.material=new N(n,{...t,renderTarget:this._frameBuffer}),this._postProcess=new hn({passes:[this.material]}),this.render()}render(){this._renderer.renderPostProcess(this._postProcess,void 0,this._resolution)}},_n=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,vn=class extends Lt{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA,magFilter:j.LINEAR,minFilter:j.LINEAR,wrapS:j.CLAMP_TO_EDGE,wrapT:j.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new k(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA})])});let m=1/4*l,h=new N(e,{renderTarget:s[l].rt1,frag:_n,uniforms:fn.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new k(d,f));let g=new N(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new hn({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}},yn=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}},bn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Tn=e=>{let t=[];for(let n=0;n<e;n++){let r=new k;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},En=class extends Lt{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;shading;constructor(e){super();let t=e.backend,n=new N(t,{name:`normalSelector`,frag:Sn,renderTarget:null,uniforms:fn.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),r=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),a=new N(t,{name:`lightShaft`,frag:xn,renderTarget:r,uniforms:fn.merge({uLightShaftBackBuffer:{value:i.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),c=new N(t,{name:`ssao`,frag:Cn,renderTarget:ln(`ssao`,o),uniforms:fn.merge({uSSAOBackBuffer:{value:s.textures[0],type:`1i`},uSSAOKernel:{value:Tn(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),l=fn.merge({uSSAOTexture:{value:s.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:Ct.gaussWeights(8)}}),u=new N(t,{name:`ssaoBlur/h`,frag:ln(`ssaoBlur`,wn),uniforms:l,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),d=new N(t,{name:`ssaoBlur/v`,frag:ln(`ssaoBlur`,wn),uniforms:fn.merge(l,{uSSAOTexture:{value:u.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),f=new N(t,{name:`deferredShading`,frag:ln(`deferredShading`,bn),uniforms:fn.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:c.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})});this.postprocess=new hn({passes:[n,a,c,u,d,f]}),this.shading=f,this.lightShaft=a,this.ssao=c,this.rtSSAO1=o,this.rtSSAO2=s,this.ssaoBlur=u,this.ssaoBlurV=d,this.rtLightShaft1=r,this.rtLightShaft2=i,this.normalSelector_=n;let p=e.renderTarget;for(let e=0;e<p.gBuffer.textures.length;e++){let t=p.gBuffer.textures[e];e===1&&(t=p.normalBuffer.textures[0]),f.uniforms[`sampler`+e]=c.uniforms[`sampler`+e]={type:`1i`,value:t}}u.uniforms.uDepthTexture.value=p.gBuffer.textures[0],a.uniforms.uDepthTexture.value=p.gBuffer.depthTexture,f.renderTarget=p.shadingBuffer,n.renderTarget=p.normalBuffer,n.uniforms.uNormalTexture.value=p.gBuffer.textures[1],n.uniforms.uPosTexture.value=p.gBuffer.textures[0],n.uniforms.uSelectorTexture.value=p.gBuffer.textures[3],l.uNormalTexture.value=p.normalBuffer.textures[0]}update(){let e=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=e,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],e=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=e,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}resize(e){this.postprocess.resize(e)}dispose(){this.postprocess.dispose(),this.rtLightShaft1.dispose(),this.rtLightShaft2.dispose(),this.rtSSAO1.dispose(),this.rtSSAO2.dispose()}},Dn=`uniform sampler2D uShadingTexture;
...
`,Pn=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`,Fn=`// https://qiita.com/aa_debdeb/items/26ab808de6745611df53
...
}`,Vn=4,Hn=8,Un=14,Wn=.05,Gn=class{dofCoc;dofBokeh;dofBlur;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;_colorCollection;_bloomBright;_bloomPasses;constructor(e,t){let n=new N(e,{name:`collection`,frag:kn}),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),i=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),a=new N(e,{name:`ssr`,frag:ln(`ssr`,Bn),renderTarget:r,uniforms:fn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`},uSSRBackBuffer:{value:i.textures[0],type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=new N(e,{name:`ssComposite`,frag:ln(`ssComposite`,zn),uniforms:fn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSSRTexture:{value:i.textures[0],type:`1i`}})}),s=new k(10,.05,20,.05),c=new N(e,{name:`dof/coc`,frag:Mn,uniforms:fn.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR,internalFormat:j.RGBA16F,type:j.HALF_FLOAT,format:j.RGBA})]),passThrough:!0,resolutionRatio:.5}),l=new N(e,{name:`dof/bokeh`,frag:jn,uniforms:fn.merge({uCocTex:{value:c.renderTarget.textures[0],type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),passThrough:!0,resolutionRatio:.5}),u=new N(e,{name:`dof/blur`,frag:An,uniforms:fn.merge({uBokeTex:{value:l.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),passThrough:!0,resolutionRatio:.5}),d=new N(e,{name:`dof/composite`,frag:Nn,uniforms:fn.merge({uBokeTex:{value:u.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR,internalFormat:j.RGBA16F,type:j.HALF_FLOAT,format:j.RGBA})])}),f=new N(e,{name:`motionBlurTile`,frag:Rn,uniforms:fn.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),p=new N(e,{name:`motionBlurNeighbor`,frag:Ln,uniforms:fn.merge({uVelTex:{value:f.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA})]),resolutionRatio:1/16,passThrough:!0}),m=new N(e,{name:`motionBlur`,frag:In,uniforms:fn.merge({uVelNeighborTex:{value:p.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16}}),h=new N(e,{name:`fxaa`,frag:Pn}),g=new N(e,{name:`bloom/bright`,frag:Dn,uniforms:{uShadingTexture:{value:t.shadingBuffer.textures[0],type:`1i`},uThreshold:{value:1,type:`1f`},uBrightness:{value:1,type:`1f`}},resolutionRatio:.5,passThrough:!0}),_=[g],v=[],y=g.renderTarget.textures[0],b=2;for(let t=0;t<Vn;t++){let n=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),i={name:`bloom/blur/`+t+`/v`,renderTarget:n,frag:Fn,uniforms:{uBackBlurTex:{value:y,type:`1i`},uIsVertical:{type:`1i`,value:!0},uWeights:{type:`1fv`,value:Ct.gaussWeights(Hn)},uBlurRange:{value:2,type:`1f`}},defines:{GAUSS_WEIGHTS:Hn.toString(),USE_BACKBLURTEX:``},passThrough:!0,resolutionRatio:1/b};_.push(new N(e,i)),_.push(new N(e,{...i,name:`bloom/blur/`+t+`/h`,renderTarget:r,uniforms:{...i.uniforms,uBackBlurTex:{value:n.textures[0],type:`1i`},uIsVertical:{type:`1i`,value:!1}}})),v.push(r.textures[0]),y=r.textures[0],b*=2}_.push(new N(e,{name:`bloom/composite`,frag:On,uniforms:{uBloomTexture:{value:v,type:`1iv`}}})),this.postprocess=new hn({passes:[n,a,o,c,l,u,d,f,p,m,h,..._]}),this._ssr=a,this._ssComposite=o,this.dofCoc=c,this.dofBokeh=l,this.dofBlur=u,this.dofComposite=d,this._motionBlur=m,this._motionBlurTile=f,this._motionBlurNeighbor=p,this._colorCollection=n,this._bloomBright=g,this._bloomPasses=_,this._dofParams=s,this.rtSSR1=r,this.rtSSR2=i,a.uniforms.uGbufferPos.value=t.gBuffer.textures[0],a.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],a.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],o.uniforms.uGbufferPos.value=t.gBuffer.textures[0],o.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],c.uniforms.uGbufferPos.value=t.gBuffer.textures[0],f.uniforms.uVelTex.value=t.gBuffer.textures[4],m.uniforms.uVelTex.value=t.gBuffer.textures[4],m.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}update(e){let t=e.dofParams.kFilmHeight,n=.5*t/Math.tan(.5*(e.fov/180*Math.PI)),r=Math.max(e.dofParams.focusDistance,n),i=Math.min(Wn,Un/this.dofComposite.renderTarget.size.y),a=1/i,o=n*n/(e.dofParams.fNumber*(r-n)*t*2);this._dofParams.set(r,i,a,o);let s=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=s,this._ssr.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssr.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){if(e.toneMap!==void 0&&(this._colorCollection.enabled=e.toneMap),e.bloom!==void 0)for(let t of this._bloomPasses)t.enabled=e.bloom;e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofBlur.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofBlur.renderTarget&&this.dofBlur.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}setBloomParams(e,t){this._bloomBright.uniforms.uThreshold.value=e,this._bloomBright.uniforms.uBrightness.value=t}dispose(){this.postprocess.dispose(),this.rtSSR1.dispose(),this.rtSSR2.dispose()}},Kn=e=>{let t=e.createFrameBuffer();t.setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA,magFilter:j.NEAREST,minFilter:j.NEAREST}),e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA}),e.createTexture(),e.createTexture(),e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA})]);let n=e.createFrameBuffer({disableDepthBuffer:!0});n.setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA}),e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA})]);let r=e.createFrameBuffer({disableDepthBuffer:!0});r.setDepthTexture(t.depthTexture),r.setTexture([n.textures[0],t.textures[0],t.textures[4]]);let i=e.createFrameBuffer({disableDepthBuffer:!0});i.setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA16F,format:j.RGBA,magFilter:j.LINEAR,minFilter:j.LINEAR})]);let a=e.createFrameBuffer({disableDepthBuffer:!0});a.setDepthTexture(t.depthTexture),a.setTexture([e.createTexture()]);let o=e.createFrameBuffer();return o.setTexture([e.createTexture().setting({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA,magFilter:j.NEAREST,minFilter:j.NEAREST})]),{gBuffer:t,shadingBuffer:n,forwardBuffer:r,refractionBuffer:i,uiBuffer:a,normalBuffer:o}},qn=class{camera;size;resolution;offscreen;renderTarget;deferredRenderer;pipelinePostProcess;_pipelineOverride;_sceneConfig;_onDispose;constructor(e){this.camera=null,this.size=null,this.resolution=new k,this.offscreen=e.offscreen,this._pipelineOverride=null,this._sceneConfig=e.sceneConfig,this._onDispose=e.onDispose,this.renderTarget=Kn(e.backend),this.deferredRenderer=new En({backend:e.backend,envMap:e.envMap,envMapCube:e.envMapCube,renderTarget:this.renderTarget}),this.pipelinePostProcess=new Gn(e.backend,this.renderTarget),this.fit(e.resolution),this.applyPipelineConfig()}get pipelineOverride(){return this._pipelineOverride}set pipelineOverride(e){this._pipelineOverride=e,this.applyPipelineConfig()}applyPipelineConfig(){let e={...this._sceneConfig,...this._pipelineOverride};this.deferredRenderer.setPassEnabled({ssao:e.ssao,lightShaft:e.lightShaft}),this.pipelinePostProcess.setPassEnabled({toneMap:e.toneMap,motionBlur:e.motionBlur,ssr:e.ssr,dof:e.dof,bloom:e.bloom}),this.pipelinePostProcess.setMotionBlurPower(e.motionBlurPower??1),this.pipelinePostProcess.setBloomParams(e.bloomThreshold??1,e.bloomBrightness??1)}fit(e){e.x<=0||e.y<=0||(this.resolution.x!==e.x||this.resolution.y!==e.y)&&this.resize(e)}resize(e){this.resolution.copy(e);let t=this.renderTarget;t.gBuffer.setSize(e),t.shadingBuffer.setSize(e),t.forwardBuffer.setSize(e),t.refractionBuffer.setSize(e),t.uiBuffer.setSize(e),t.normalBuffer.setSize(e),this.deferredRenderer.resize(e),this.pipelinePostProcess.resize(e)}dispose(){this._onDispose(this);let e=this.renderTarget;e.forwardBuffer.dispose();let t=[e.gBuffer,e.shadingBuffer,e.refractionBuffer,e.uiBuffer,e.normalBuffer];for(let e=0;e<t.length;e++){let n=t[e];for(let e=0;e<n.textures.length;e++)n.textures[e].dispose();n.dispose()}e.gBuffer.depthTexture&&e.gBuffer.depthTexture.dispose(),this.deferredRenderer.dispose(),this.pipelinePostProcess.dispose()}},Jn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`,Yn=class{entity;mesh;material;color;groundColor;_intensity;_position;_positionPrev;_scale;_viewMatrixPrevInverse;constructor(e){this.color=new k(1,1,1),this.groundColor=new k(.3,.3,.3),this._intensity=1,this._position=new k,this._positionPrev=new k,this._scale=new k,this._viewMatrixPrevInverse=new A,this.material=new mn({phase:[`deferred`,`envMap`],frag:Jn,cullFace:!1,uniforms:{uSkyColor:{value:this.color,type:`3fv`},uGroundColor:{value:this.groundColor,type:`3fv`},uSkyIntensity:{value:this._intensity,type:`1f`}}}),this.entity=e.createEntity({name:`sky`}),this.mesh=this.entity.addComponent(M),this.mesh.geometry=new $t({radius:1,widthSegments:32,heightSegments:32}),this.mesh.material=this.material}followCamera(e,t){let n=t.far*.99,r=e.matrixWorld.elm,i=this._viewMatrixPrevInverse.copy(t.viewMatrixPrev).inverse().elm;this._position.set(r[12],r[13],r[14]),this._positionPrev.set(i[12],i[13],i[14]),this._scale.set(n,n,n),this.entity.matrixWorld.setFromTransform(this._position,void 0,this._scale),this.entity.matrixWorldPrev.setFromTransform(this._positionPrev,void 0,this._scale)}get intensity(){return this._intensity}set intensity(e){this._intensity=e,this.material.uniforms.uSkyIntensity.value=e}},Xn=()=>({motionBlur:!0,motionBlurPower:1,ssr:!0,ssao:!0,lightShaft:!0,dof:!0,toneMap:!0,bloom:!0,bloomThreshold:1,bloomBrightness:1}),Zn=new mn,Qn=e=>e.material||Zn,$n=0,er=new k(1,1,1,1),tr=new k(0,0,0,1),nr=[],rr=[],ir=e=>nr[e]||(nr[e]={direction:`directionalLight[${e}].direction`,color:`directionalLight[${e}].color`,camNear:`uDirectionalLightCamera[${e}].near`,camFar:`uDirectionalLightCamera[${e}].far`,camViewMatrix:`uDirectionalLightCamera[${e}].viewMatrix`,camProjectionMatrix:`uDirectionalLightCamera[${e}].projectionMatrix`,camResolution:`uDirectionalLightCamera[${e}].resolution`,shadowMap:`directionalLightShadowMap[${e}]`}),ar=e=>rr[e]||(rr[e]={position:`uSpotLight[${e}].position`,direction:`uSpotLight[${e}].direction`,color:`uSpotLight[${e}].color`,angle:`uSpotLight[${e}].angle`,blend:`uSpotLight[${e}].blend`,distance:`uSpotLight[${e}].distance`,decay:`uSpotLight[${e}].decay`,camNear:`uSpotLightCamera[${e}].near`,camFar:`uSpotLightCamera[${e}].far`,camViewMatrix:`uSpotLightCamera[${e}].viewMatrix`,camProjectionMatrix:`uSpotLightCamera[${e}].projectionMatrix`,camResolution:`uSpotLightCamera[${e}].resolution`,shadowMap:`spotLightShadowMap[${e}]`}),or=class extends qt{backend;canvas;resolution;globalUniforms;_views;_pipelineConfig;programManager;_geometryBuffers;_lights;_lightsUpdated;_lightInfoCache;_envMapCameras;_envMapRenderTarget;_envMapCube;_pmremRender;_stack;_sceneCamera;sky;_engine;_quad;_isCorrentCompiles;compileDrawParams;_tmpNormalMatrix;_tmpModelViewMatrix;_tmpViewMatrixInverseMatrix;_tmpLightDirection;_tmpModelMatrixInverse;_tmpProjectionMatrixInverse;_tmpResolution;_tmpResolutionUniform;_tmpUniformOverride;_tmpDrawParam;constructor(e,t){super(),this.backend=e,this.canvas=e.canvas,this.globalUniforms={},this._isCorrentCompiles=!1,this.compileDrawParams=[],this.programManager=new yn(e),this._geometryBuffers=new Map,this.resolution=new k,this._views=[],this._stack=this._createRenderStack(),this._sceneCamera=null,this._lights={directional:[],spot:[]},this._lightsUpdated=!1,this._lightInfoCache=new Map;let n=e.createCubeTexture();this._envMapCube=n,this._envMapRenderTarget=e.createCubeFrameBuffer().setTexture([n]),this._envMapRenderTarget.setSize(256,256);let r=new k(0,0,0),i=new k(0,-1,0),a=[new A().lookAt(r,new k(1,0,0),i),new A().lookAt(r,new k(0,1,0),new k(0,0,1)),new A().lookAt(r,new k(0,0,1),i),new A().lookAt(r,new k(-1,0,0),i),new A().lookAt(r,new k(0,-1,0),new k(0,0,-1)),new A().lookAt(r,new k(0,0,-1),i)];this._envMapCameras=[];for(let e=0;e<6;e++){let n=t.createEntity({name:`envMapCamera/`+e}),r=n.addComponent(en);r.fov=90,r.near=.1,r.far=1e3,r.aspect=1,n.applyMatrix(a[e].clone()),r.updateViewMatrix(),r.updateProjectionMatrix(),this._envMapCameras.push({entity:n,camera:r})}this._pmremRender=new vn(e,{input:[n],resolution:new k(768,1024)}),this._quad=new Qt({width:2,height:2}),this._tmpLightDirection=new k,this._tmpModelMatrixInverse=new A,this._tmpViewMatrixInverseMatrix=new A,this._tmpProjectionMatrixInverse=new A,this._tmpModelViewMatrix=new A,this._tmpNormalMatrix=new A,this._tmpResolution=new k,this._tmpResolutionUniform={value:this._tmpResolution,type:`2fv`},this._tmpUniformOverride={},this._tmpDrawParam={},this._engine=t,this.sky=new Yn(t),this._pipelineConfig=Xn();let o=this.fieldDir(`sky`);o.field(`skyColor`,()=>this.sky.color.getElm(`vec3`),e=>{this.sky.color.set(e[0],e[1],e[2])},{format:{type:`vector`}}),o.field(`groundColor`,()=>this.sky.groundColor.getElm(`vec3`),e=>{this.sky.groundColor.set(e[0],e[1],e[2])},{format:{type:`vector`}}),o.field(`intensity`,()=>this.sky.intensity,e=>{this.sky.intensity=e},{step:.1}),o.field(`reset`,()=>()=>{this._resetSky(),this.noticeField(`sky/skyColor`),this.noticeField(`sky/groundColor`),this.noticeField(`sky/intensity`)},void 0,{label:`Reset to Default`});let s=this.fieldDir(`pipeline`);[`motionBlur`,`ssr`,`ssao`,`dof`,`lightShaft`,`toneMap`,`bloom`].forEach(e=>{let t=s.dir(e);t.field(`enabled`,()=>this._pipelineConfig[e]??!0,t=>{this.applyPipelineConfig({[e]:t})}),e===`motionBlur`&&t.field(`power`,()=>this._pipelineConfig.motionBlurPower??1,e=>{this.applyPipelineConfig({motionBlurPower:e})},{step:.1}),e===`bloom`&&(t.field(`threshold`,()=>this._pipelineConfig.bloomThreshold??1,e=>{this.applyPipelineConfig({bloomThreshold:e})},{step:.1}),t.field(`brightness`,()=>this._pipelineConfig.bloomBrightness??1,e=>{this.applyPipelineConfig({bloomBrightness:e})},{step:.1}))})}createView(e){let t=new qn({backend:this.backend,envMap:this._pmremRender.renderTarget.textures[0],envMapCube:this._envMapCube,sceneConfig:this._pipelineConfig,resolution:this.resolution,offscreen:e?.offscreen??!1,onDispose:e=>{this._views.splice(this._views.indexOf(e),1)}});return this._views.push(t),t}_createRenderStack(){return{light:[],deferred:[],forward:[],ui:[],shadowMap:[],envMap:[]}}_collectRenderStack(e,t,n){let r=t&&e.visible,i=e.getComponent(M);if(i&&r){let t=Qn(i);t.visibilityFlag.deferred&&n.deferred.push(e),t.visibilityFlag.shadowMap&&n.shadowMap.push(e),t.visibilityFlag.forward&&n.forward.push(e),t.visibilityFlag.ui&&n.ui.push(e),t.visibilityFlag.envMap&&n.envMap.push(e)}let a=e.getComponent(nn);if(a&&a.enabled&&r&&n.light.push(e),!this._sceneCamera){let t=e.getComponentsByTag(`camera`);for(let n=0;n<t.length;n++)t[n].displayOut&&(this._sceneCamera=e)}for(let t=0;t<e.children.length;t++)this._collectRenderStack(e.children[t],r,n)}prepareScene(e,t){if(this.resolution.x===0||this.resolution.y===0)return;let n=this._stack=this._createRenderStack();this._sceneCamera=null,this._collectRenderStack(e,!0,n),this._collectRenderStack(this.sky.entity,!0,n);let r=[],i={},a=Object.keys(this._lights);for(let e=0;e<a.length;e++){let t=a[e];i[t]=this._lights[t].length,this._lights[t]=[]}for(let e=0;e<n.light.length;e++){let t=n.light[e],i=t.getComponent(nn);if(i){let e=this.collectLight(t,i);i.castShadow&&e.renderTarget&&r.push(e)}}this._lights.directional.sort((e,t)=>!e.component.castShadow-+!t.component.castShadow),this._lights.spot.sort((e,t)=>!e.component.castShadow-+!t.component.castShadow),this._lightsUpdated=!1;for(let e=0;e<a.length;e++){let t=a[e];if(i[t]!=this._lights[t].length){this._lightsUpdated=!0;break}}for(let e=0;e<r.length;e++){let t=r[e];this.renderCamera(`shadowMap`,t.component.entity,n.shadowMap,t.renderTarget,this.resolution)}for(let e=0;e<this._envMapCameras.length;e++){let{entity:t}=this._envMapCameras[e];this._envMapRenderTarget.face(e),this.renderCamera(`envMap`,t,n.envMap,this._envMapRenderTarget,this.resolution)}this.renderPostProcess(this._pmremRender.postprocess,void 0,this._pmremRender.resolution),this._pmremRender.swap()}render(e,t){let n=e;n.fit(n.size||this.resolution);let r=n.resolution;if(r.x===0||r.y===0)return;let i=n.camera||this._sceneCamera;if(!i)return;let a=i.getComponentsByTag(`camera`)[0];if(!a)return;let o=this._stack,s=n.renderTarget;this.backend.setBlendEnabled(!1),this.renderCamera(`deferred`,i,o.deferred,s.gBuffer,r),this.renderPostProcess(n.deferredRenderer.postprocess,void 0,r,{cameraOverride:{viewMatrix:a.viewMatrix,viewMatrixPrev:a.viewMatrixPrev,projectionMatrix:a.projectionMatrix,projectionMatrixPrev:a.projectionMatrixPrev,cameraMatrixWorld:i.matrixWorld}}),n.deferredRenderer.update(),this._copyToRefraction(s);let c=o.forward.slice().sort((e,t)=>Qn(e.getComponent(M)).renderOrder-Qn(t.getComponent(M)).renderOrder),l=[],u=null;for(let e of c){let t=Qn(e.getComponent(M)).renderOrder;(u===null||t!==u)&&(l.push([]),u=t),l[l.length-1].push(e)}this.backend.setBlendEnabled(!0);for(let e=0;e<l.length;e++)e>0&&this._copyToRefraction(s),this.renderCamera(`forward`,i,l[e],s.forwardBuffer,r,{uniformOverride:{uDeferredTexture:{value:s.refractionBuffer.textures[0],type:`1i`},uDeferredResolution:{value:s.shadingBuffer.size,type:`2fv`},uEnvMap:{value:this._pmremRender.renderTarget.textures[0],type:`1i`},uGbufferNormal:{value:s.normalBuffer.textures[0],type:`1i`},uGbufferAlbedo:{value:s.gBuffer.textures[2],type:`1i`},uGbufferMaterial:{value:s.gBuffer.textures[3],type:`1i`}},disableClear:!0});this.backend.setBlendEnabled(!1),this.renderPostProcess(n.pipelinePostProcess.postprocess,s.shadingBuffer,r,{cameraOverride:{viewMatrix:a.viewMatrix,projectionMatrix:a.projectionMatrix,cameraMatrixWorld:i.matrixWorld,cameraNear:a.near,cameraFar:a.far}}),n.pipelinePostProcess.update(a);let d=n.pipelinePostProcess.postprocess.output?n.pipelinePostProcess.postprocess.output:void 0,f=(this._sceneCamera||i).getComponent(pn);if(f){f.resize(r);for(let e=0;e<f.postProcesses.length;e++){let t=f.postProcesses[e];t.enabled&&t.hasOutput&&(this.renderPostProcess(t,d,r,{cameraOverride:{viewMatrix:a.viewMatrix,projectionMatrix:a.projectionMatrix,cameraMatrixWorld:i.matrixWorld,cameraNear:a.near,cameraFar:a.far}}),d=t.output||void 0)}}let p=n.offscreen?s.uiBuffer:null;if(d){let e=d.size;this.backend.blit(d,p,e.x,e.y)}this.backend.setBlendEnabled(!0),this.renderCamera(`forward`,i,o.ui,p,r,{uniformOverride:{uDeferredTexture:{value:s.refractionBuffer.textures[0],type:`1i`}},disableClear:!0}),this.backend.setBlendEnabled(!1)}renderCamera(e,t,n,r,i,a){let o=t.getComponentsByTag(`camera`)[0]||t.getComponent(nn);a||={},(e==`deferred`||e==`envMap`)&&this.sky.followCamera(t,o);let s=this._tmpDrawParam;s.viewMatrix=o.viewMatrix,s.viewMatrixPrev=o.viewMatrixPrev,s.projectionMatrix=o.projectionMatrix,s.projectionMatrixPrev=o.projectionMatrixPrev,s.cameraMatrixWorld=t.matrixWorld,s.cameraNear=o.near,s.cameraFar=o.far,s.renderTarget=r,s.uniformOverride=a.uniformOverride||this._tmpUniformOverride,a.cameraOverride&&Object.assign(s,a.cameraOverride),this.backend.bindRenderTarget(r,o.viewPort,i),r?this._tmpResolution.set(r.size.x,r.size.y):this._tmpResolution.set(i.x,i.y),s.uniformOverride.uResolution=this._tmpResolutionUniform,a.disableClear||this.backend.clear(e==`shadowMap`?er:tr,1);for(let t=0;t<n.length;t++){let r=n[t],i=r.getComponentsByTag(`materialOverride`)[0],a=r.getComponent(M),c=i&&i.material||Qn(a),l=a.geometry;s.modelMatrixWorld=r.matrixWorld,s.modelMatrixWorldPrev=r.matrixWorldPrev,s.label=`cam[${o.uuid}]/${r.name||c.name||`-`}`,this.draw(r.uuid,e,l,c,s)}}_copyToRefraction(e){let t=e.shadingBuffer.size;this.backend.blit(e.shadingBuffer,e.refractionBuffer,t.x,t.y,!0,!0)}collectLight(e,t){let n=t.lightType,r=this._lightInfoCache.get(t);return r||(r={position:new k,direction:new k,color:new k,renderTarget:null,component:t},this._lightInfoCache.set(t,r)),r.position.set(0,0,0,1).applyMatrix4(e.matrixWorld),r.direction.set(0,1,0,0).applyMatrix4(e.matrixWorld).normalize(),r.color.set(t.color.x,t.color.y,t.color.z).multiply(t.intensity*Math.PI),n==`directional`?this._lights.directional.push(r):n==`spot`&&this._lights.spot.push(r),t.castShadow&&r.renderTarget==null&&(r.renderTarget=this.backend.createFrameBuffer().setTexture([this.backend.createTexture().setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]),r.renderTarget.setSize(t.shadowMapSize)),r}renderPostProcess(e,t,n,r){let i=t?t.textures:void 0;if(e.passes)for(let t=0;t<e.passes.length;t++){let a=e.passes[t];if(a.enabled===!1)continue;let o=a.renderTarget;this.backend.bindRenderTarget(o,a.viewPort,n),this.backend.clear(a.clearColor,a.clearDepth);let s=a.backBufferOverride||i||null;if(s)for(let e=0;e<s.length;e++)a.uniforms[`uBackBuffer`+e]={type:`1i`,value:s[e]};let c=r&&r.cameraOverride||{};c.label=a.name,c.renderTarget=o,c.uniformOverride=r&&r.uniformOverride,this.draw(a.uuid,`postprocess`,this._quad,a,c),a.onAfterRender(),!a.passThrough&&a.renderTarget&&(i=a.renderTarget.textures)}}draw(e,t,n,r,i){if(this._isCorrentCompiles){this.compileDrawParams.push({drawId:e,renderType:t,geometry:n,material:r,param:{...i}});return}$n=0,this.backend.setMaterialState(r.cullFace,r.depthTest,r.depthWrite);let a=r.programCache[t];if(!a||this._lightsUpdated){let e={...r.defines};t==`deferred`?e.IS_DEFERRED=``:t==`forward`||t==`envMap`?e.IS_FORWARD=``:t==`shadowMap`&&(e.IS_DEPTH=``);let n=It(r.vert,e,this._lights),i=It(r.frag,e,this._lights);a=this.programManager.get(n,i,r.name),r.programCache[t]=a}if(i&&(i.modelMatrixWorld&&(a.setUniform(`uModelMatrix`,`Matrix4fv`,i.modelMatrixWorld.elm),a.setUniform(`uModelMatrixInverse`,`Matrix4fv`,this._tmpModelMatrixInverse.copy(i.modelMatrixWorld).inverse().elm),i.modelMatrixWorldPrev&&a.setUniform(`uModelMatrixPrev`,`Matrix4fv`,i.modelMatrixWorldPrev.elm),i.viewMatrix&&(this._tmpModelViewMatrix.copy(i.modelMatrixWorld).preMultiply(i.viewMatrix),this._tmpNormalMatrix.copy(this._tmpModelViewMatrix),this._tmpNormalMatrix.inverse(),this._tmpNormalMatrix.transpose(),a.setUniform(`uModelViewMatrix`,`Matrix4fv`,this._tmpModelViewMatrix.elm),a.setUniform(`uNormalMatrix`,`Matrix4fv`,this._tmpNormalMatrix.elm),a.setUniform(`uViewMatrixInverse`,`Matrix4fv`,this._tmpViewMatrixInverseMatrix.copy(i.viewMatrix).inverse().elm))),i.viewMatrix&&(a.setUniform(`uViewMatrix`,`Matrix4fv`,i.viewMatrix.elm),i.viewMatrixPrev&&a.setUniform(`uViewMatrixPrev`,`Matrix4fv`,i.viewMatrixPrev.elm)),i.projectionMatrix&&(a.setUniform(`uProjectionMatrix`,`Matrix4fv`,i.projectionMatrix.elm),a.setUniform(`uProjectionMatrixInverse`,`Matrix4fv`,this._tmpProjectionMatrixInverse.copy(i.projectionMatrix).inverse().elm),i.projectionMatrixPrev&&a.setUniform(`uProjectionMatrixPrev`,`Matrix4fv`,i.projectionMatrixPrev.elm)),i.cameraMatrixWorld&&(a.setUniform(`uCameraMatrix`,`Matrix4fv`,i.cameraMatrixWorld.elm),a.setUniform(`uCameraPosition`,`3f`,[i.cameraMatrixWorld.elm[12],i.cameraMatrixWorld.elm[13],i.cameraMatrixWorld.elm[14]])),t!=`deferred`&&(i.cameraNear&&a.setUniform(`uCameraNear`,`1f`,[i.cameraNear]),i.cameraFar&&a.setUniform(`uCameraFar`,`1f`,[i.cameraFar]))),r.useLight&&t!==`deferred`&&t!==`shadowMap`){for(let e=0;e<this._lights.directional.length;e++){let t=this._lights.directional[e],n=ir(e);if(a.setUniform(n.direction,`3fv`,t.direction.getElm(`vec3`)),a.setUniform(n.color,`3fv`,t.color.getElm(`vec3`)),t.renderTarget){let e=t.renderTarget.textures[0].activate($n++);a.setUniform(n.camNear,`1fv`,[t.component.near]),a.setUniform(n.camFar,`1fv`,[t.component.far]),a.setUniform(n.camViewMatrix,`Matrix4fv`,t.component.viewMatrix.elm),a.setUniform(n.camProjectionMatrix,`Matrix4fv`,t.component.projectionMatrix.elm),a.setUniform(n.camResolution,`2fv`,e.size.getElm(`vec2`)),a.setUniform(n.shadowMap,`1i`,[e.unit])}}for(let e=0;e<this._lights.spot.length;e++){let t=this._lights.spot[e],n=ar(e);if(i&&i.viewMatrix&&this._tmpLightDirection.copy(t.direction).applyMatrix3(i.viewMatrix),a.setUniform(n.position,`3fv`,t.position.getElm(`vec3`)),a.setUniform(n.direction,`3fv`,t.direction.getElm(`vec3`)),a.setUniform(n.color,`3fv`,t.color.getElm(`vec3`)),a.setUniform(n.angle,`1fv`,[Math.cos(t.component.angle/2)]),a.setUniform(n.blend,`1fv`,[t.component.blend]),a.setUniform(n.distance,`1fv`,[t.component.distance]),a.setUniform(n.decay,`1fv`,[t.component.decay]),t.renderTarget){let e=t.renderTarget.textures[0].activate($n++);a.setUniform(n.camNear,`1fv`,[t.component.near]),a.setUniform(n.camFar,`1fv`,[t.component.far]),a.setUniform(n.camViewMatrix,`Matrix4fv`,t.component.viewMatrix.elm),a.setUniform(n.camProjectionMatrix,`Matrix4fv`,t.component.projectionMatrix.elm),a.setUniform(n.camResolution,`2fv`,e.size.getElm(`vec2`)),a.setUniform(n.shadowMap,`1i`,[e.unit])}}}ur(a,this.globalUniforms,r.uniforms,i&&i.uniformOverride);let o=a.getVAO(e.toString());if(o){let e=this._getGeometryBuffer(n);e.vaoVersions.get(o)!==n.updateVersion&&(n.attributes.forEach((t,n)=>{let r=e.buffers.get(n);r!==void 0&&(n==`index`?o.setIndex(r):o.setAttribute(n,r,t.size,t.opt))}),e.vaoVersions.set(o,n.updateVersion)),this.backend.draw(a,o,r.drawType,r.blending,void 0)}}_getGeometryBuffer(e){let t=this._geometryBuffers.get(e);if(t||(t={buffers:new Map,vaoVersions:new Map,version:-1},this._geometryBuffers.set(e,t)),t.version!==e.updateVersion){let n=t.buffers;n.forEach(e=>e.dispose()),n.clear(),t.vaoVersions.clear(),e.attributes.forEach((e,t)=>{n.set(t,new Dt(this.backend.gl).setData(e.array,t==`index`?`ibo`:`vbo`,e.opt&&e.opt.usage))}),t.version=e.updateVersion}return t}applyPipelineConfig(e){Object.assign(this._pipelineConfig,e);for(let e=0;e<this._views.length;e++)this._views[e].applyPipelineConfig()}get pipelineConfig(){return this._pipelineConfig}resize(e){this.resolution.copy(e);for(let t=0;t<this._views.length;t++){let n=this._views[t];n.fit(n.size||e)}}_resetSky(){this.sky.entity.disposeRecursive(),this.sky=new Yn(this._engine)}reset(){this._resetSky(),this.applyPipelineConfig(Xn()),this._geometryBuffers.forEach(e=>{e.buffers.forEach(e=>e.dispose())}),this._geometryBuffers.clear(),this._lightInfoCache.forEach(e=>{e.renderTarget&&(e.renderTarget.textures.forEach(e=>e.dispose()),e.renderTarget.dispose())}),this._lightInfoCache.clear()}async compileShaders(e,t,n,r){this._isCorrentCompiles=!0,this.compileDrawParams=[],this.prepareScene(e,n),this.render(t,n),this._isCorrentCompiles=!1;let i=this.compileDrawParams.length,a=0;for(let e=0;e<this.compileDrawParams.length;e++){let t=this.compileDrawParams[e];if(this.backend.bindRenderTarget(t.param.renderTarget||null),this.draw(t.drawId,t.renderType,t.geometry,t.material,t.param),await new Promise(e=>{setTimeout(()=>{e(null)},10)}),r){a++;let e=t.param&&t.param.label||`-`;r(`${t.renderType}/${e}/[${t.drawId}]`,a,i)}}}createTexProcedural(e){let t={},n=e.textures||{},r=Object.keys(n);for(let e=0;e<r.length;e++)t[r[e]]={value:n[r[e]],type:`1i`};let i=new gn(this,{frag:e.frag,resolution:e.resolution,uniforms:t});return e.filter===`nearest`&&(i.setting({magFilter:j.NEAREST,minFilter:j.NEAREST}),i.render()),i}},sr=e=>new or(new Mt(document.createElement(`canvas`).getContext(`webgl2`,{antialias:!1,preserveDrawingBuffer:!0})),e),cr=[],lr=(e,t)=>{e!=null&&(typeof e==`number`||typeof e==`boolean`?cr.push(e):`isVector`in e?cr.push(...e.getElm(`vec`+t.charAt(0))):`isTexture`in e?(e.activate($n++),cr.push(e.unit)):cr.push(...e.elm))},ur=(e,...t)=>{for(let n=0;n<t.length;n++){let r=t[n];if(!r)continue;let i=Object.keys(r);for(let t=0;t<i.length;t++){let n=i[t],a=r[n];if(!a)continue;let o=a.type,s=a.value;if(cr.length=0,Array.isArray(s))for(let e=0;e<s.length;e++)lr(s[e],o);else lr(s,o);cr.length>0&&e.setUniform(n,o,cr)}}},dr=class extends hn{_passes;date;constructor(e){super({...e}),this._passes=e.passes,this.date=new Date}get passes(){return this._passes}compute(e){let t=Math.min(1/60,(new Date().getTime()-this.date.getTime())/1e3);this.date=new Date,this.passes.forEach(e=>{e.uniforms.uDeltaTime.value=t}),e.renderPostProcess(this)}},fr=class extends N{size;layerCnt;clearColor;rt1;rt2;outputUniforms;constructor(e,t){let n=Object.assign({type:j.FLOAT,internalFormat:j.RGBA32F,format:j.RGBA,magFilter:j.NEAREST,minFilter:j.NEAREST},t.textureParam),r=e.createFrameBuffer().setTexture(Array(t.dataLayerCount).fill(0).map(()=>e.createTexture().setting(n))).setSize(t.size),i=e.createFrameBuffer().setTexture(Array(t.dataLayerCount).fill(0).map(()=>e.createTexture().setting(n))).setSize(t.size),a={uGPUResolution:{value:t.size,type:`2fv`}};for(let e=0;e<t.dataLayerCount;e++)a[`uGPUSampler`+e]={value:i.textures[e],type:`1i`};super(e,{...t,vert:t.vert||`layout ( location = 0 ) in vec3 position;\r
layout ( location = 1 ) in vec2 uv;\r
\r
out vec2 vUv;\r
\r
...
`,vr=`uniform sampler2D uBackBuffer0;
...
`,br=class{isEditorFrame=!0;texture;textarget;constructor(e,t){this.texture=e,this.textarget=t}},xr=class extends br{isEditorTarget=!0;frameBuffer;autoResize;_gl;_entries;constructor(e,t,n){let r=Cr(e,t);super(r.textures[0],j.TEXTURE_2D),this.frameBuffer=r,this.autoResize=n,this._gl=e,this._entries=new Map([[Sr(r.size),r]])}setSize(e){let t=Sr(e);if(t===Sr(this.frameBuffer.size))return;let n=this._entries.get(t);n||(n=Cr(this._gl,e),this._entries.set(t,n)),this.frameBuffer=n,this.texture=n.textures[0]}reset(e){let t=Sr(e),n=this._entries.get(t)||Cr(this._gl,e);this._entries.forEach((e,n)=>{n!==t&&(e.textures[0].dispose(),e.dispose())}),this._entries=new Map([[t,n]]),this.frameBuffer=n,this.texture=n.textures[0]}},Sr=e=>`${Math.max(Math.floor(e.x),1)}x${Math.max(Math.floor(e.y),1)}`,Cr=(e,t)=>{let n=new kt(e,{disableDepthBuffer:!0}).setTexture([new Ot(e).setting({magFilter:j.LINEAR,minFilter:j.LINEAR})]);return n.setSize(Math.max(Math.floor(t.x),1),Math.max(Math.floor(t.y),1)),n},wr=class{isEditorRecipe=!0;postprocess;pass;mask;constructor(e,t,n){this.pass=t,this.mask=n,this.postprocess=new hn({name:e,passes:[t]})}},Tr=class{_renderer;_gl;_targets;_readFrameBuffer;_fullscreenTarget;_texturePass;_texturePostProcess;_viewTarget;constructor(e){this._renderer=e,this._gl=e.backend.gl,this._targets=[],this._readFrameBuffer=new kt(this._gl,{disableDepthBuffer:!0}),this._fullscreenTarget=new xr(this._gl,e.resolution,!0),this._texturePass=new N(e.backend,{frag:yr,renderTarget:null}),this._texturePostProcess=new hn({name:`editorTexture`,passes:[this._texturePass]}),this._viewTarget=null}renderEntities(e){let t=this._renderer,n=e.view;e.target&&this._fitToView(e.target,n);let r=e.target?e.target.frameBuffer:n.renderTarget.uiBuffer,i=e.materialOverride,a=[];if(e.target&&e.useSceneDepth&&r.setDepthTexture(n.renderTarget.gBuffer.depthTexture),i)for(let t=0;t<e.entities.length;t++){let n=e.entities[t].getComponent(M);a.push(n?n.material:null),n&&(n.material=i)}if(e.depthCompare===`lequal`&&this._gl.depthFunc(j.LEQUAL),t.backend.setBlendEnabled(!0),t.renderCamera(`forward`,e.camera,e.entities,r,n.resolution,{disableClear:e.target===null}),t.backend.setBlendEnabled(!1),e.depthCompare===`lequal`&&this._gl.depthFunc(j.LESS),i)for(let t=0;t<e.entities.length;t++){let n=e.entities[t].getComponent(M);n&&(n.material=a[t])}}renderFullscreen(e,t,n){let r=t,i=this._renderer;if(this._fitToView(r.mask,e),r.pass.uniforms.uMaskTexture.value=r.mask.texture,n){let t=n;this._fitToView(t,e);let a=t.frameBuffer;this._setPassResolution(r.pass,a.size),r.pass.renderTarget=a,i.renderPostProcess(r.postprocess,void 0,a.size);return}let a=e.renderTarget.uiBuffer,o=e.resolution;this._fullscreenTarget.setSize(o),this._setPassResolution(r.pass,o),r.pass.renderTarget=this._fullscreenTarget.frameBuffer,i.renderPostProcess(r.postprocess,a,o),i.backend.blit(this._fullscreenTarget.frameBuffer,a,o.x,o.y)}blit(e,t,n,r){let i=this._gl,a=t;n&&this._fitToView(n,e);let o=n?n.frameBuffer:e.renderTarget.uiBuffer,s=o.size,c=r||{x:0,y:0,width:s.x,height:s.y};this._readFrameBuffer.setSize(a.texture.size),i.bindFramebuffer(i.FRAMEBUFFER,this._readFrameBuffer.getFrameBuffer()),i.framebufferTexture2D(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0,a.textarget,a.texture.getTexture(),0),i.bindFramebuffer(i.READ_FRAMEBUFFER,this._readFrameBuffer.getFrameBuffer()),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,o.getFrameBuffer()),i.blitFramebuffer(0,0,a.texture.size.x,a.texture.size.y,c.x,s.y-c.y-c.height,c.x+c.width,s.y-c.y,i.COLOR_BUFFER_BIT,i.NEAREST),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null)}drawToCanvas(e,t){let n=this._renderer,r=e.resolution;if(n.backend.blit(e.renderTarget.uiBuffer,null,r.x,r.y),t!==n.canvas){let e=n.canvas.height-r.y;t.getContext(`2d`).drawImage(n.canvas,0,e,r.x,r.y,0,0,r.x,r.y)}}drawTexture(e,t){let n=t.frameBuffer;this._texturePass.uniforms.uSrcTexture={value:e,type:`1i`},this._texturePass.renderTarget=n,this._renderer.renderPostProcess(this._texturePostProcess,void 0,n.size)}async readPixels(e){let t=this._gl,n=e.frameBuffer,r=n.size,i=new Uint8Array(r.x*r.y*4);return t.bindFramebuffer(t.FRAMEBUFFER,n.getFrameBuffer()),t.readPixels(0,0,r.x,r.y,t.RGBA,t.UNSIGNED_BYTE,i),t.bindFramebuffer(t.FRAMEBUFFER,null),i}readView(e){return this._viewTarget||=this.createTarget(),this.blit(e,new br(e.renderTarget.uiBuffer.textures[0],j.TEXTURE_2D),this._viewTarget),this.readPixels(this._viewTarget)}createTarget(e){let t=new xr(this._gl,e&&e.size||this._renderer.resolution,!(e&&e.size));return this._targets.push(t),t}resize(e){this._fullscreenTarget.reset(e);for(let t=0;t<this._targets.length;t++){let n=this._targets[t];n.autoResize&&n.reset(e)}}_fitToView(e,t){e.autoResize&&e.setSize(t.resolution)}_setPassResolution(e,t){e.resolution.copy(t),e.resolutionInv.set(1/t.x,1/t.y)}onDrawPass(e){let t=(t,n)=>{if(!t)return;let r=t.textures,i=`currentFace`in t?t.currentFace:j.TEXTURE_2D;for(let t=0;t<r.length;t++){let a=n?n+(r.length>1?`_`+t:``):``;e(new br(r[t],i),a)}};return this._renderer.on(`drawPass`,t),()=>this._renderer.off(`drawPass`,t)}materials={flat:e=>new mn({vert:mr,frag:pr,phase:[`forward`],drawType:e.lines?`LINES`:`TRIANGLES`,depthTest:e.depthTest??!0,depthWrite:e.depthWrite??!0,uniforms:{uColor:{value:e.color,type:`3fv`}}}),mask:()=>new mn({vert:_r,frag:gr,phase:[`forward`],depthTest:!1}),grid:e=>new mn({vert:mr,frag:hr,phase:[`forward`],depthWrite:!1,uniforms:{uColor:{value:e.color,type:`3fv`},uParams:{value:e.params,type:`3fv`}}})};recipes={outline:(e,t)=>new wr(`editorOutline`,new N(this._renderer.backend,{frag:vr,renderTarget:null,uniforms:{uMaskTexture:{value:e.texture,type:`1i`},uOutlineColor:{value:new k(t[0],t[1],t[2]),type:`3fv`}}}),e)}},Er=e=>new Tr(e.renderer),Dr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,cm=class extends Lt{wrapperElm;glCanvas;backend;gl;canvasTexture;canvas;canvasCtx;glRenderer;postProcess;viewPort;viewPortRange;viewPortScale;frameSetting;loopSetting;musicBuffer;musicTexture;resizeObserver;canvasSize;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.glCanvas=document.createElement(`canvas`),this.backend=new Mt(this.glCanvas.getContext(`webgl2`)),this.gl=this.backend.gl,this.canvasSize=new k(this.glCanvas.width,this.glCanvas.height),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0],this.viewPortScale=50,this.frameSetting=null,this.loopSetting={enabled:!1,start:0,end:0},this.resizeObserver=new ResizeObserver(this.onResize.bind(this));let e={renderer:null,createEntity:t=>new on({...t,engine:e})};this.glRenderer=new or(this.backend,e),e.renderer=this.glRenderer,this.canvasTexture=new Ot(this.gl),this.musicBuffer=null,this.musicTexture=new Ot(this.gl),this.musicTexture.setting({type:this.gl.UNSIGNED_BYTE,internalFormat:this.gl.LUMINANCE,format:this.gl.LUMINANCE,magFilter:this.gl.LINEAR,minFilter:this.gl.LINEAR,wrapS:this.gl.MIRRORED_REPEAT}),this.postProcess=new hn({passes:[new N(this.backend,{frag:sm,uniforms:{uCanvasTex:{type:`1i`,value:null},uMusicTex:{type:`1i`,value:this.musicTexture}},renderTarget:null})]})}onResize(){if(this.wrapperElm){let e=new k(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);if(e.x===0||e.y===0)return;this.glCanvas.width=this.canvas.width=e.x,this.glCanvas.height=this.canvas.height=e.y,this.canvasSize.set(this.glCanvas.width,this.glCanvas.height),this.postProcess.resize(e),this.render()}}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.frameSetting){this.canvasCtx.fillStyle=`#181818`;let e=this.frameToPx(0),t=this.frameToPx(this.frameSetting.duration);this.canvasCtx.fillRect(e,0,t-e,this.canvas.height)}let e=(e,t,n)=>{let r=Math.ceil(this.viewPort[0]/e)*e;this.canvasCtx.beginPath();let i=0;for(;r<this.viewPort[2]&&i<100;){let n=this.frameToPx(r+t);this.canvasCtx.moveTo(n,0),this.canvasCtx.lineTo(n,this.canvas.height),r+=e,i++}this.canvasCtx.strokeStyle=n,this.canvasCtx.lineWidth=1,this.canvasCtx.stroke()};if(e(this.viewPortScale,0,`#555`),e(this.viewPortScale,this.viewPortScale/2,`#333`),this.musicBuffer&&this.frameSetting){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)],s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}if(this.loopSetting.enabled){this.canvasCtx.fillStyle=`#0009`;let e=this.frameToPx(this.loopSetting.start),t=this.frameToPx(this.loopSetting.end);this.canvasCtx.fillRect(0,0,e,this.canvas.height),this.canvasCtx.fillRect(t,0,this.canvas.width-t,this.canvas.height)}this.canvasTexture.attach(this.canvas),this.postProcess.passes&&(this.postProcess.passes[0].uniforms.uCanvasTex.value=this.canvasTexture),this.glRenderer.renderPostProcess(this.postProcess,void 0,this.canvasSize)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.glCanvas),this.onResize()}setViewPort(e,t){this.viewPort=e,this.viewPortRange=[e[2]-e[0],e[3]-e[1]],this.viewPortScale=t,this.render()}setFrameSetting(e){this.frameSetting={duration:Math.round(e.duration),fps:Math.round(e.fps)},this.render()}setMusicBuffer(e){this.musicBuffer=e,setTimeout(()=>{this.render()},100)}setLoopSetting(e,t,n){this.loopSetting={enabled:e,start:t,end:n},this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.glCanvas),this.resizeObserver.disconnect()}},lm={timelineCanvas:`TimelineCanvas__timelineCanvas___LnRpb`},um=()=>{let{viewPort:e,viewPortScale:t,musicBuffer:n,musicBufferVersion:r,glEditor:i}=om(),[a,o]=(0,b.useState)(),s=(0,b.useRef)(null);(0,b.useEffect)(()=>{let e=new cm;return o(e),s.current&&e.setWrapperElm(s.current),()=>{e.dispose()}},[]),(0,b.useEffect)(()=>{a&&e&&t&&a.setViewPort(e,t)},[a,e,t]);let[c]=Q(i?.engine,`timeline/duration`),[l]=Q(i?.engine,`timeline/fps`);(0,b.useEffect)(()=>{a&&c&&l&&a.setFrameSetting({duration:c||0,fps:l||0})},[a,c,l]);let[u]=Q(i,`frameLoop/enabled`),[d]=Q(i,`frameLoop/start`),[f]=Q(i,`frameLoop/end`);return(0,b.useEffect)(()=>{a&&a.setLoopSetting(u||!1,d||0,f||0)},[a,u,d,f]),(0,b.useEffect)(()=>{a&&n&&a.setMusicBuffer(n)},[a,n,r]),(0,T.jsx)(`div`,{className:lm.timelineCanvas,ref:s})},dm={controls:`TimelineControls__controls___LmNvb`},fm=e=>{let{viewPort:t,setCurrentFrame:n,getFrameViewPort:r,zoom:i,scroll:a,setViewPortCenter:o}=om(),s=(0,b.useRef)([0,0,0,0]),c=(0,b.useRef)([0,0]);t&&(s.current=t,c.current=[t[2]-t[0],t[3]-t[1]]);let l=(0,b.useRef)(null),u=(0,b.useRef)(null),d=(0,b.useRef)(null),f=(0,b.useRef)(null),p=(0,b.useRef)(null),m=(0,b.useCallback)(e=>{let t=l.current&&l.current.clientWidth||1;if(d.current==0){if(n&&r&&u.current){let i=(e.clientX-u.current.left)/t;n(r(i))}}else if(d.current==1){let n=[e.clientX,e.clientY];if(f.current&&p.current){let e=-(n[0]-f.current[0])/t*c.current[0];o&&o(p.current+e)}}},[n,r,o]),h=(0,b.useCallback)(e=>{d.current=e.button,p.current=(s.current[2]+s.current[0])/2,f.current=[e.clientX,e.clientY],u.current=e.currentTarget.getBoundingClientRect();let t=(e.clientX-u.current.left)/e.currentTarget.clientWidth;d.current==0&&n&&r&&n(r(t)),window.addEventListener(`pointermove`,m);let i=()=>{f.current=null,d.current=null,p.current=null,window.removeEventListener(`pointermove`,m)};return window.addEventListener(`pointerup`,i),()=>{window.removeEventListener(`pointerup`,i),window.removeEventListener(`pointermove`,m)}},[r,n,m]),g=(0,b.useCallback)(e=>{if(d.current!==null||!i||!a)return;e.preventDefault();let t=e.target&&e.target.clientWidth||1,n=Math.abs(e.deltaY);Math.abs(e.deltaX)<n?i(n>50?e.deltaY<0?.9:1.1:1+e.deltaY*.005):a(e.deltaX/t*.5)},[i,a]);return(0,b.useEffect)(()=>{let e=l.current;return e&&e.addEventListener(`wheel`,g,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,g)}},[g]),t?(0,T.jsx)(`div`,{className:dm.controls,onPointerDown:h,ref:l,children:e.children}):null},pm={cursor:`TimelineCursor__cursor___LmN1c`,frame:`TimelineCursor__frame___LmN1c`},mm=()=>{let{viewPort:e,framePlay:t}=om();if(!e||!t)return null;let n=e[2]-e[0],r=(t.current-e[0])/n;return(0,T.jsx)(`div`,{className:pm.cursor,style:{left:r*100+`%`},children:(0,T.jsx)(`div`,{className:pm.frame})})},hm={timelineLoop:`TimelineLoop__timelineLoop___LnRpb`,start:`TimelineLoop__start___LnRpb`,end:`TimelineLoop__end___LnRpb`},gm={cursor:`TimelineLoopCursor__cursor___LmN1c`},_m=({onMove:e})=>{let t=(0,b.useRef)(!1);return(0,T.jsx)(`div`,{className:gm.cursor,onPointerDown:e=>{e.buttons==1&&(t.current=!0,e.stopPropagation())},onPointerMove:n=>{let r=n.target;t.current!==!1&&n.buttons==1&&(r.setPointerCapture(n.pointerId),n.buttons==1&&e&&e(n.clientX),n.nativeEvent.preventDefault(),n.nativeEvent.stopPropagation())},onPointerUp:()=>{t.current=!1}})},vm=()=>{let{viewPort:e,framePlay:t,glEditor:n}=om(),r=(0,b.useRef)(null);Df(n,[`frameLoop/enabled`,`frameLoop/start`,`frameLoop/end`]);let[i]=Q(n,`frameLoop/enabled`),[a,o]=Q(n,`frameLoop/start`),[s,c]=Q(n,`frameLoop/end`);if(i!==!0||!e||!t||a===void 0||s===void 0)return null;let l=e[2]-e[0],u=(a-e[0])/l,d=(s-e[0])/l,f=(t,n)=>{let r=t.getBoundingClientRect();return(n-r.x)/r.width*(e[2]-e[0])+e[0]};return(0,T.jsx)(`div`,{className:hm.timelineLoop,ref:r,children:(0,T.jsxs)(`div`,{className:hm.timelineLoop_inner,children:[(0,T.jsx)(`div`,{className:hm.start,style:{left:u*100+`%`},children:(0,T.jsx)(_m,{onMove:e=>{r.current&&o&&o(f(r.current,e))}})}),(0,T.jsx)(`div`,{className:hm.end,style:{left:d*100+`%`},children:(0,T.jsx)(_m,{onMove:e=>{r.current&&c&&c(f(r.current,e))}})})]})})},ym={scale:`TimelineScale__scale___LnNjY`,scale_inner:`TimelineScale__scale_inner___LnNjY`,scale_item:`TimelineScale__scale_item___LnNjY`,scale_item_frame:`TimelineScale__scale_item_frame___LnNjY`,scale_item_time:`TimelineScale__scale_item_time___LnNjY`},bm=e=>`${(`00`+Math.floor(e%3600/60)).slice(-2)}:${(`00`+Math.floor(e%60)).slice(-2)}`,xm=()=>{let{glEditor:e,viewPort:t,viewPortScale:n}=om(),[r,i]=Q(e?.engine,`timeline/fps`);if(!t||!n||r===void 0)return null;let a=[],o=Math.ceil(t[0]/n)*n,s=0;for(;o<t[2]&&s<100;){let e=(o-t[0])/(t[2]-t[0]),i=o/(r||0);a.push((0,T.jsxs)(`div`,{className:ym.scale_item,style:{left:e*100+`%`},children:[(0,T.jsx)(`div`,{className:ym.scale_item_frame,children:o}),(0,T.jsx)(`div`,{className:ym.scale_item_time,children:bm(i)})]},o)),o+=n,s++}return(0,T.jsx)(`div`,{className:ym.scale,children:(0,T.jsx)(`div`,{className:ym.scale_inner,children:a})})},Sm={timelineSetting:`TimelineSetting__timelineSetting___LnRpb`,play:`TimelineSetting__play___LnRpb`},Cm=()=>{let{framePlay:e,glEditor:t}=om(),n=(0,b.useCallback)((e,t)=>{t&&t(e)},[]),[r,i]=Q(t,`frameLoop/enabled`),[a]=Q(t?.engine,`timeline/duration`),[o]=Q(t?.engine,`timeline/fps`),s=(0,b.useCallback)((e,n)=>{t&&t.api.setField(t.engine,e,n)},[t]),c=(0,b.useCallback)(()=>{t&&t.togglePlay()},[t]);return(0,T.jsx)(`div`,{className:Sm.timelineSetting,children:(0,T.jsxs)(it,{children:[(0,T.jsx)(`div`,{className:Sm.play,children:(0,T.jsx)(ae,{onClick:c,children:e.playing?(0,T.jsx)(fe,{size:14}):(0,T.jsx)(pe,{size:14})})}),(0,T.jsx)(We,{title:`current`,children:(0,T.jsx)(qr,{value:Math.floor(e?.current||0),readOnly:!0})}),(0,T.jsx)(We,{title:`duration`,children:(0,T.jsx)(qr,{value:a,onChange:e=>s(`timeline/duration`,e)})}),(0,T.jsx)(We,{title:`fps`,children:(0,T.jsx)(qr,{value:o,onChange:e=>s(`timeline/fps`,e)})}),(0,T.jsx)(We,{title:`loop`,children:(0,T.jsx)(qr,{value:r||!1,onChange:e=>n(e,i)})})]})})},wm={timeline:`Timeline__timeline___LnRpb`,inner:`Timeline__inner___LnRpb`,content:`Timeline__content___LnRpb`,setting:`Timeline__setting___LnRpb`},Tm=()=>{let{editor:e}=Hr(),[t,n]=(0,b.useState)({current:0,playing:!1}),[r,i]=(0,b.useState)([0,0,100,0]),a=(0,b.useRef)([0,0,0,0]);a.current=r;let o=r[2]-r[0],s=10*2**(0+Math.floor(Math.log2(o/100)));s=Math.max(1,Math.floor(s));let c=e?.audioBuffer,[l,u]=(0,b.useState)();(0,b.useEffect)(()=>{if(e){let t=e.engine,r=e=>{n({...e})};r(t.frame);let a=0,o=()=>{u(a++)},s=()=>{i([0,0,t.frameSetting.duration,0])};return s(),t.on(`update/frame/play`,r),t.on(`update/music`,o),t.on(`loaded`,s),()=>{t.off(`update/frame/play`,r),t.off(`update/music`,o),t.off(`loaded`,s)}}},[e]);let d=(0,b.useCallback)(t=>{e&&e.engine.seek(t)},[e]),f=(0,b.useCallback)(e=>{let t=r[2]-r[0];return Math.floor(r[0]+t*e)},[r]),p=(0,b.useCallback)(e=>{let t=a.current,n=(t[2]+t[0])/2,r=(t[0]-n)*e+n,o=(t[2]-n)*e+n;i([r,t[1],o,t[3]])},[]),m=(0,b.useCallback)(e=>{let t=a.current,n=e*(t[2]-t[0]);i([t[0]+n,t[1],t[2]+n,t[3]])},[]),h=(0,b.useCallback)(e=>{let t=a.current,n=t[2]-t[0];i([e-n/2,t[1],e+n/2,t[3]])},[]);return{glEditor:e,framePlay:t,viewPort:r,viewPortScale:s,musicBuffer:c,musicBufferVersion:l,setCurrentFrame:d,getFrameViewPort:f,zoom:p,scroll:m,setViewPortCenter:h}},Em=e=>{let t=Tm();return(0,T.jsx)(am.Provider,{value:t,children:e.children})},Dm=()=>(0,T.jsx)(Em,{children:(0,T.jsx)(`div`,{className:wm.timeline,children:(0,T.jsxs)(`div`,{className:wm.inner,children:[(0,T.jsx)(`div`,{className:wm.setting,children:(0,T.jsx)(Cm,{})}),(0,T.jsxs)(`div`,{className:wm.content,children:[(0,T.jsx)(um,{}),(0,T.jsx)(mm,{}),(0,T.jsx)(fm,{children:(0,T.jsx)(vm,{})}),(0,T.jsx)(xm,{})]})]})})}),Om={editor:`OREditor__editor___LmVka`},km=e=>{let{engine:t}=Yf(),[n,r]=(0,b.useState)(()=>new Cf(t)),i=b.useRef(n);return i.current=n,(0,b.useEffect)(()=>{if(!i.current.disposed&&i.current.engine.uuid==t.uuid)return;let e=new Cf(t);r(e)},[t]),(0,b.useEffect)(()=>()=>{n.dispose()},[n]),{engine:t,editor:n,projectName:e}},Am=e=>{let t=km(e.projectName),n=(0,b.useRef)(Promise.resolve());(0,b.useEffect)(()=>{if(!t.editor||!e.onSave)return;let r=e.onSave,i=(e,t)=>{n.current=Promise.resolve(r(e,t))};return t.editor.on(`save`,i),()=>{t.editor.off(`save`,i)}},[t.editor,e.onSave]);let r=(0,b.useRef)(null),i=e.scenes??null;return(0,b.useEffect)(()=>{r.current=i},[i]),(0,b.useEffect)(()=>Aa({editor:t.editor,getScenes:()=>r.current,waitForSave:()=>n.current}),[t.editor]),(0,b.useEffect)(()=>{t.editor&&t.editor.bootstrap(e.editorData)},[e.editorData,t.editor]),(0,T.jsx)(Vr.Provider,{value:{...t,scenes:e.scenes},children:e.children})},jm=[{id:`hierarchy`,title:`Hierarchy`,category:`General`,content:(0,T.jsx)(it,{children:(0,T.jsx)(lp,{})})},{id:`timer`,title:`Timer`,category:`Rendering`,content:(0,T.jsx)(it,{noPadding:!0,children:(0,T.jsx)(np,{})})},{id:_p,title:`Screen`,category:`General`,multiple:!0,content:e=>(0,T.jsx)(vp,{viewportId:e})},{id:`property`,title:`Property`,category:`General`,content:(0,T.jsx)(it,{children:(0,T.jsx)(Gf,{})})},{id:`textures`,title:`Textures`,category:`Rendering`,content:(0,T.jsx)(it,{noPadding:!0,children:(0,T.jsx)(im,{})})},{id:`scene`,title:`Scene`,category:`General`,content:(0,T.jsx)(it,{children:(0,T.jsx)(nm,{})})},{id:`export`,title:`Export`,category:`Project`,content:(0,T.jsx)(it,{children:(0,T.jsx)(qf,{})})},{id:`renderer`,title:`Renderer`,category:`Rendering`,content:(0,T.jsx)(it,{children:(0,T.jsx)(Zp,{})})},{id:`editor-settings`,title:`Editor`,category:`Project`,content:(0,T.jsx)(it,{children:(0,T.jsx)(ti,{})})},{id:`timeline`,title:`Timeline`,category:`Animation`,content:(0,T.jsx)(it,{noPadding:!0,children:(0,T.jsx)(Dm,{})})}],Mm=e=>{let t=[];for(let n of e)n.multiple||n.id!==`hierarchy`&&n.id!==`property`&&n.id!==`timeline`&&t.push({id:n.id,title:n.title,content:n.content});return t},Nm=e=>{let t=bt(),n=(0,b.useMemo)(()=>e.panels?[...jm,...e.panels]:jm,[e.panels]),r=null;return r=t.isPC?(0,T.jsx)(Yp,{panels:n}):(0,T.jsx)(T.Fragment,{children:(0,T.jsxs)(Ye,{direction:`vertical`,storageKey:`orengine-editor-sp-main`,children:[(0,T.jsx)(Ye.Item,{size:`calc( min( 56.25vw, 55vh ) + 77px )`,minSize:200,style:{minHeight:`200px`},children:(0,T.jsx)(vp,{viewportId:`main`})}),(0,T.jsx)(Ye.Item,{flex:1,minSize:200,children:(0,T.jsxs)(st,{storageKey:`orengine-panel-sp-main`,children:[(0,T.jsx)(st.Tab,{title:`Hierarchy / Property`,children:(0,T.jsxs)(Ye,{direction:`horizontal`,storageKey:`orengine-editor-sp-hierarchyProp`,children:[(0,T.jsx)(Ye.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,T.jsx)(lp,{})}),(0,T.jsx)(Ye.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,T.jsx)(Gf,{})})]})}),Mm(n).map(e=>(0,T.jsx)(st.Tab,{title:e.title,children:e.content},e.id))]})}),(0,T.jsx)(Ye.Item,{size:`120px`,minSize:80,children:(0,T.jsx)(st,{storageKey:`orengine-panel-sp-timeline`,children:(0,T.jsx)(st.Tab,{title:`Timeline`,children:(0,T.jsx)(it,{noPadding:!0,children:(0,T.jsx)(C,{fallback:(0,T.jsx)(`div`,{children:`エラーだよ`}),children:(0,T.jsx)(Dm,{})})})})})})]})}),(0,T.jsx)(Am,{projectName:e.projectName,onSave:e.onSave,editorData:e.editorData,scenes:e.scenes,children:(0,T.jsx)(ht,{children:(0,T.jsxs)(He,{children:[(0,T.jsx)(`div`,{className:Om.editor,children:r}),(0,T.jsx)(Tf,{}),(0,T.jsx)(Be,{}),(0,T.jsx)(ft,{})]})})})},Pm=()=>{let[e,t]=b.useState(()=>new P(sr)),n=b.useRef(e);return n.current=e,(0,b.useEffect)(()=>{n.current.disposed&&t(new P(sr))},[]),(0,b.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,b.useCallback)(t=>{t&&e.load(t)},[e])}},Fm=e=>{let t=Pm(),{engine:n}=t,r=(0,b.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,b.useEffect)(()=>{r.current?.(n)},[n]),(0,b.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,T.jsx)(Jf.Provider,{value:t,children:e.children})},Im=e=>(0,T.jsx)(Fm,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,T.jsx)(Nm,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),Lm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,zm=s({EyeRings:()=>Bm}),Bm=class extends Jt{constructor(e){super(e);let t=new sn({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new mn({phase:[`deferred`,`shadowMap`],frag:Lm,vert:Rm});this.entity.addComponent(M,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(M)}},Vm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Um=s({FlashLine:()=>Wm}),Wm=class extends Jt{geometry;material;constructor(e){super(e),this.geometry=new Zt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=Ct.randomVector().multiply(new k(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new mn({phase:[`forward`,`envMap`],frag:ln(`flFrag`,Vm),vert:ln(`flVert`,Hm)}),this.entity.addComponent(M,{material:this.material,geometry:this.geometry})}},Gm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Km=s({SkyBox:()=>qm}),qm=class extends Jt{material;constructor(e){super(e);let t=this.engine;this.material=new mn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:ln(`SkyBoxFrag`,Gm),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}},Jm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Xm=s({GridCross:()=>Zm}),Zm=class extends Jt{constructor(e){super(e);let t=new Xt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new k(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new mn({frag:ln(`gridCrossFrag`,Jm),vert:ln(`gridCrossVert`,Ym),phase:[`forward`]});this.entity.addComponent(M,{geometry:t,material:a})}},Qm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,eh=s({GridDots:()=>th}),th=class extends Jt{constructor(e){super(e);let t=new $t({radius:.1}),n=[],r=[],i=new k(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new mn({frag:ln(`gridDotsFrag`,Qm),vert:ln(`gridDotsVert`,$m),phase:[`forward`]});this.entity.addComponent(M,{geometry:t,material:a})}},nh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,ih=s({WireCube:()=>ah}),ah=class extends Jt{constructor(e){super(e);let t=3.3,n=t/2,r=new Xt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new mn({phase:[`deferred`],frag:nh,vert:rh});this.entity.addComponent(M,{geometry:r,material:o})}},oh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,ch=s({OREngineCube:()=>lh}),lh=class extends Jt{material;constructor(e){super(e),this.material=new mn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:ln(`OREngineCubeVert`,sh),frag:ln(`OREngineCubeFrag`,oh),uniforms:{uNoiseTex:{value:P.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(M);t&&(t.material=this.material)}},uh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,fh=s({OREngineLogo:()=>ph}),ph=class extends Jt{material;constructor(e){super(e),this.material=new mn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:ln(`OREngineLogoVert`,dh),frag:ln(`OREngineLogoFrag`,uh)});let t=this.entity.getComponent(M);t&&(t.material=this.material)}},mh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,gh=s({Dust:()=>_h}),_h=class extends Jt{constructor(e){super(e);let t=new Yt,n=e.args?.num||2048,r=new k(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new mn({phase:[`forward`],drawType:`POINTS`,frag:mh,vert:hh});this.entity.addComponent(M,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(M)}},vh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `,xh=s({YakiSoba:()=>Sh}),Sh=class extends Jt{_gpu;constructor(e){super(e);let t=this.engine,n=new k(64,512);this._gpu=new dr({passes:[new fr(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:ln(`yakiSobaCompute`,bh),uniforms:fn.merge({},t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new Xt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new mn({frag:ln(`chainFrag`,vh),vert:ln(`chainVert`,yh),phase:[`deferred`,`shadowMap`],uniforms:fn.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(M,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(M),this._gpu.dispose()}},Ch=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `},Gh={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `,qh=Object.assign({"../../demo-webgl/Resources/Textures/hash.tex":Wh,"../../demo-webgl/Resources/Textures/noise.tex":Gh,"../../demo-webgl/Resources/Textures/noiseCyclic.tex":{name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:Kh},"../../demo-webgl/Resources/Textures/noiseCyclicAnime.tex":{name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:Kh}}),Jh=()=>{for(let e of Object.values(qh))e&&P.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},Yh=e=>{P.resources.buildTextureInstances(e.renderer)},Xh=Object.assign({"../../demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":zm,"../../demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":Um,"../../demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":Km,"../../demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":Xm,"../../demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":eh,"../../demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":ih,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":ch,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":fh,"../../demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":gh,"../../demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":xh,"../../demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":wh}),Zh=Object.assign({}),Qh=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addComponent(i,a):Qh(a,t.createGroup(i))}},$h=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addGeometry(i,a):$h(a,t.createGroup(i))}},eg=()=>{Gt.gltfLoaderFactory=e=>new Nr(e),P.resources.clear();let e=P.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,nn),e.addComponent(`Camera`,en),e.addComponent(`Mesh`,M);let t=Object.keys(Hh);for(let e=0;e<t.length;e++){let n=t[e],r=Hh[n];Qh(r,P.resources.addComponentGroup(n))}let n=Object.keys(Uh);for(let e=0;e<n.length;e++){let t=n[e],r=Uh[t];$h(r,P.resources.addGeometryGroup(t))}let r=Ir(Xh,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t];Qh(n,P.resources.addComponentGroup(t))}let a=Ir(Zh,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t];$h(n,P.resources.addGeometryGroup(t))}Jh()},tg=s({panel:()=>ng}),ng={id:`sample`,title:`Sample`,category:`Tools`,content:(0,T.jsx)(()=>{let{editor:e,engine:t}=Hr(),[n]=Q(e,`selectedEntityId`),[r,i]=(0,b.useState)(``),a=n?t.root.findEntityByUUID(n):void 0;return(0,T.jsxs)(it,{children:[(0,T.jsx)(re,{label:`Selected Entity`,children:a?a.name:`-`}),(0,T.jsxs)(re,{label:`Server`,children:[(0,T.jsx)(ae,{onClick:async()=>{try{let e=await(await fetch(`/api/ext/hello`)).json();i(e.message)}catch{i(`failed`)}},children:`GET /api/ext/hello`}),r&&(0,T.jsx)(`p`,{children:r})]})]})},{})},rg=Object.assign({"../../demo-webgl/editor/Panels/Sample/index.tsx":tg}),ig=(()=>{let e=[],t=Object.keys(rg);for(let n=0;n<t.length;n++){let r=rg[t[n]].panel;r&&e.push(r)}return e})();document.title=`${y.name} | OREngine`,eg(),_.createRoot(document.getElementById(`root`)).render((0,T.jsx)(Im,{projectName:`demo-webgl`,sceneData:y,editorData:v,initResourceInstances:Yh,panels:ig}));