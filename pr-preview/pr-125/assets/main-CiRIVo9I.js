...
\r
} `},Nh={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `,Fh=Object.assign({"../../demo-webgl/Resources/Textures/hash.tex":Mh,"../../demo-webgl/Resources/Textures/noise.tex":Nh,"../../demo-webgl/Resources/Textures/noiseCyclic.tex":{name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:Ph},"../../demo-webgl/Resources/Textures/noiseCyclicAnime.tex":{name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:Ph}}),Ih=()=>{for(let e of Object.values(Fh))e&&F.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},Lh=e=>{F.resources.buildTextureInstances(e.renderer)},Rh=Object.assign({"../../demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":Dm,"../../demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":jm,"../../demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":Pm,"../../demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":Rm,"../../demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":Hm,"../../demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":Km,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":Xm,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":eh,"../../demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":ih,"../../demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":lh,"../../demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":fh}),zh=Object.assign({}),Bh=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addComponent(i,a):Bh(a,t.createGroup(i))}},Vh=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addGeometry(i,a):Vh(a,t.createGroup(i))}},Hh=()=>{Ut.gltfLoaderFactory=e=>new Or(e),F.resources.clear();let e=F.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,$t),e.addComponent(`Camera`,Zt),e.addComponent(`Mesh`,N);let t=Object.keys(Ah);for(let e=0;e<t.length;e++){let n=t[e],r=Ah[n];Bh(r,F.resources.addComponentGroup(n))}let n=Object.keys(jh);for(let e=0;e<n.length;e++){let t=n[e],r=jh[t];Vh(r,F.resources.addGeometryGroup(t))}let r=jr(Rh,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t];Bh(n,F.resources.addComponentGroup(t))}let a=jr(zh,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t];Vh(n,F.resources.addGeometryGroup(t))}Ih()},Uh=s({panel:()=>Wh}),Wh={id:`sample`,title:`Sample`,category:`Tools`,content:(0,T.jsx)(()=>{let{editor:e,engine:t}=Lr(),[n]=Q(e,`selectedEntityId`),[r,i]=(0,b.useState)(``),a=n?t.root.findEntityByUUID(n):void 0;return(0,T.jsxs)(nt,{children:[(0,T.jsx)(re,{label:`Selected Entity`,children:a?a.name:`-`}),(0,T.jsxs)(re,{label:`Server`,children:[(0,T.jsx)(ae,{onClick:async()=>{try{let e=await(await fetch(`/api/ext/hello`)).json();i(e.message)}catch{i(`failed`)}},children:`GET /api/ext/hello`}),r&&(0,T.jsx)(`p`,{children:r})]})]})},{})},Gh=Object.assign({"../../demo-webgl/editor/Panels/Sample/index.tsx":Uh}),Kh=(()=>{let e=[],t=Object.keys(Gh);for(let n=0;n<t.length;n++){let r=Gh[t[n]].panel;r&&e.push(r)}return e})();document.title=`${y.name} | OREngine`,Hh(),_.createRoot(document.getElementById(`root`)).render((0,T.jsx)(wm,{projectName:`demo-webgl`,sceneData:y,editorData:v,initResourceInstances:Lh,panels:Kh}));