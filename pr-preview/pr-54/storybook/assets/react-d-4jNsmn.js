...
\r
	...
	vUv = uv;\r
\r
}`,renderTarget:r,uniforms:li.merge(t.uniforms,a,{uDeltaTime:{value:0,type:`1f`}})}),this.size=t.size,this.layerCnt=t.dataLayerCount,this.rt1=r,this.rt2=i,this.renderTarget=this.rt1,this.clearColor=t.clearColor??null,this.outputUniforms=a}onAfterRender(){super.onAfterRender();for(let e=0;e<this.layerCnt;e++)this.outputUniforms[`uGPUSampler`+e].value=this.renderTarget.textures[e];let e=this.rt1;this.rt1=this.rt2,this.rt2=e,this.renderTarget=this.rt1}initTexture(e){for(let t=0;t<this.layerCnt;t++){let n=[];for(let r=0;r<this.size.y;r++)for(let i=0;i<this.size.x;i++){let a=i,o=r;n.push(...e(t,a,o))}this.rt2.textures[t].subImage(new Float32Array(n),this.size.x,this.size.y)}}}})))()}function Ia(){return(Ia=t((()=>{Xn(),N(),Gr(),Qn(),_i(),yi(),Si()})))()}function La(){return(La=t((()=>{cr(),Gr(),kr(),_i()})))()}function Ra(){return(Ra=t((()=>{N(),yi(),Qn(),Si()})))()}function za(){return(za=t((()=>{yi(),Si()})))()}function Ba(){return(Ba=t((()=>{yi(),Si()})))()}function Va(){return(Va=t((()=>{yi(),Si()})))()}function Ha(){return(Ha=t((()=>{pi(),Ra(),za(),Ba(),Va()})))()}function L(){return(L=t((()=>{Qn(),di(),Aa(),_i(),Ma(),Fa(),pi(),Ui(),fa(),Ia(),La(),yi(),Si(),Ha(),wi()})))()}var Ua;function Wa(){return(Wa=t((()=>{Ua=class{static serializeEntity(e,t){let n=e=>{let r=[];e.children.forEach(e=>{e.initiator!=`script`&&r.push(n(e))});let i=[];e.components.forEach(e=>{let n=e.serialize({mode:`export`}),r=Object.keys(n).length>0;if(e.initiator!==`user`)return;let a={name:t.getName(e),uuid:e.uuid};r&&(a.props=n),i.push(a)});for(let t of e.unresolvedComponents)i.push({name:t.name,uuid:t.uuid,props:t.props});return{name:e.name,uuid:e.uuid,pos:e.position.x==0&&e.position.y==0&&e.position.z==0?void 0:e.position.getElm(`vec3`),rot:e.euler.x==0&&e.euler.y==0&&e.euler.z==0?void 0:e.euler.getElm(`vec3`),scale:e.scale.x==1&&e.scale.y==1&&e.scale.z==1?void 0:e.scale.getElm(`vec3`),components:i.length>0?i:void 0,childs:r.length>0?r:void 0}};return n(e)}static deserializeEntity(e,t,n,r){let i=(e,t)=>{let a=t||r.createEntity();a.initiator=`user`,a.name=e.name,a.restoreUUID(e.uuid);let o=e.pos||[0,0,0];a.position.x=o[0],a.position.y=o[1],a.position.z=o[2];let s=e.rot||[0,0,0];a.euler.x=s[0],a.euler.y=s[1],a.euler.z=s[2];let c=e.scale||[1,1,1];return a.scale.x=c[0],a.scale.y=c[1],a.scale.z=c[2],a.unresolvedComponents=[],e.components&&e.components.forEach(e=>{let t=n.resolve(e.name);if(t){let n=a.getComponent(t.component);n||(n=a.addComponent(t.component),n.initiator=`user`),n.restoreUUID(e.uuid),e.props&&n.deserialize(e.props)}else console.warn(`[ProjectSerializer] Component "${e.name}" not found in resolver. Preserving data for round-trip.`),a.unresolvedComponents.push({name:e.name,uuid:e.uuid,props:e.props})}),e.childs&&([...a.children].forEach(e=>{e.initiator!==`script`&&a.remove(e)}),e.childs.forEach(e=>{a.add(i(e))})),a};e&&i(e,t),t.initiator=`god`}}})))()}var Ga;function Ka(){return(Ka=t((()=>{L(),Ga=class extends wr{name;_frag;_resolution;_filter;_updateEveryFrame;_textures;constructor(e,t){super(),this.name=e;let n=t.data;this._frag=n?.frag||``,this._resolution=n?.resolution||[1024,1024],this._filter=n?.filter||`linear`,this._updateEveryFrame=n?.updateEveryFrame??!1,this._textures=n?.textures||{}}get frag(){return this._frag}get resolution(){return this._resolution}get filter(){return this._filter}get updateEveryFrame(){return this._updateEveryFrame}get textures(){return this._textures}}})))()}var qa;function Ja(){return(Ja=t((()=>{cr(),N(),Ka(),he(),qa=class extends ir{_componentList;_componentGroups;_geometryList;_geometryGroups;_textureResources;_textures;_updateEveryFrameTextures;constructor(){super(),this._componentList=[],this._textures=new Map,this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources=new Map,this._updateEveryFrameTextures=[]}get componentList(){return this._componentList}get componentGroups(){return this._componentGroups}get geometryList(){return this._geometryList}get geometryGroups(){return this._geometryGroups}get textureList(){return Array.from(this._textureResources.values())}get textures(){return this._textures}get updateEveryFrameTextures(){return this._updateEveryFrameTextures}clear(){this._componentList=[],this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources.clear(),this._textures.clear(),this._updateEveryFrameTextures=[],this.emit(`update`)}getComponent(e){return this._componentList.find(t=>t.name==e)}addComponentGroup(e){let t=this._componentGroups.find(t=>t.name==e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addComponent:(e,n)=>{let r={name:e,component:n};t.push(r),this._componentList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._componentGroups.push(t),this.emit(`update`),t}getGeometry(e){return this._geometryList.find(t=>t.name===e)}addGeometryGroup(e){let t=this._geometryGroups.find(t=>t.name===e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addGeometry:(e,n)=>{let r={name:e,geometryClass:n};t.push(r),this._geometryList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._geometryGroups.push(t),this.emit(`update`),t}addTextureResource(e,t){let n=new Ga(e,{data:t});this._textureResources.set(e,n),this.emit(`update`)}getTextureResource(e){return this._textureResources.get(e)}removeTextureResource(e){this._textureResources.delete(e);let t=this._textures.get(e);t&&(t.dispose(),this._textures.delete(e)),this.emit(`update`)}addTexture(e,t){return this._textures.set(e,t),t}getTexture(e){return this._textures.get(e)}_buildTexture(e,t,n,r){let i=e.frag;return i?t.createTexProcedural({name:e.name,frag:i,resolution:new j(e.resolution[0]||1024,e.resolution[1]||1024),filter:e.filter,textures:n,uniforms:e.updateEveryFrame?r:void 0}):null}_ensureTexture(e,t,n,r){let i=this._textures.get(e.name);if(i)return i;if(r.has(e.name))return null;r.add(e.name);let a={},o=e.textures,s=Object.keys(o);for(let e=0;e<s.length;e++){let i=s[e],c=o[i],l=this._textureResources.get(c),u=l?this._ensureTexture(l,t,n,r):this._textures.get(c);u&&(a[i]=u)}let c=this._buildTexture(e,t,a,n);return c?(this._textures.set(e.name,c),e.updateEveryFrame&&this._updateEveryFrameTextures.push(c),c):null}buildTextureInstances(e,t){this._updateEveryFrameTextures=[];let n=new Set;this._textureResources.forEach(r=>{this._ensureTexture(r,e,t,n)}),this.emit(`update`)}}})))()}var Ya;function Xa(){return(Xa=t((()=>{N(),L(),Wa(),Ja(),Ya=class e extends wr{static resources;name;_renderer;_root;_uniforms;_time;_frame;_frameSetting;_disposed;_frameEvent;constructor(e){super(),this.name=`OREngine`,this._disposed=!1,this._uniforms={uEnvMapIntensity:{value:1,type:`1f`}},this._renderer=e(this),this._renderer.globalUniforms={uTime:{value:0,type:`1f`},uTimeF:{value:0,type:`1f`},uTimeE:{value:0,type:`1f`},uTimeEF:{value:0,type:`1f`},uDeltaTime:{value:0,type:`1f`},uResolution:{value:new j,type:`2fv`},uAspectRatio:{value:1,type:`1f`}},this._time={current:new Date().getTime(),engine:0,delta:0,code:0},this._frameSetting={duration:600,fps:30},this._frame={current:0,playing:!1},this.seek(0),this._frameEvent=null,this._root=this.createEntity({name:`root`}),this._root.initiator=`god`,this.field(`name`,()=>this.name,e=>this.name=e),this.field(`scene`,()=>Ua.serializeEntity(this._root,this._createComponentResolver()),e=>{Ua.deserializeEntity(e,this._root,this._createComponentResolver(),this)}),this.field(`renderer`,()=>this._renderer.serialize({mode:`export`}),e=>this._renderer.deserialize(e));let t=this.fieldDir(`timeline`);t.field(`duration`,()=>this._frameSetting.duration,e=>this._frameSetting.duration=e),t.field(`fps`,()=>this._frameSetting.fps,e=>this._frameSetting.fps=e)}createEntity(e){return new Xr({engine:this,...e})}get canvas(){return this._renderer.canvas}get renderer(){return this._renderer}get root(){return this._root}get frame(){return this._frame}get time(){return this._time}get frameSetting(){return this._frameSetting}get uniforms(){return this._uniforms}get disposed(){return this._disposed}createView(e){return this._renderer.createView(e)}_createComponentResolver(){return{resolve:t=>e.resources.getComponent(t),getName:t=>{let n=e.resources.componentList.find(e=>t instanceof e.component);return n?n.name:t.constructor.name}}}init(){this._root.disposeRecursive(),this._root.position.set(0,0,0),this._root.euler.set(0,0,0),this._root.scale.set(1,1,1),this.name=`New Project`}async load(e){this.init(),this.deserialize(e),this.emit(`update/graph`),this.emit(`loaded`)}update(t){let n=new Date().getTime();this._time.delta=(n-this._time.current)/1e3,this._time.current=n,this._time.engine+=this._time.delta,this._time.code+=this._time.delta*+!!this._frame.playing,this._frame.current=this._time.code*60;let r=this.createEntityUpdateEvent({forceDraw:t?.forceDraw});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1,this._renderer.globalUniforms.uDeltaTime.value=Math.min(this._time.delta,1/60);let i=e.resources.updateEveryFrameTextures;for(let e=0;e<i.length;e++)i[e].render();return this._step(r),this._frame.playing&&this.emit(`update/frame/play`,[this._frame]),this._time.delta}_step(e){this._root.commitFrame(e),this._root.update(e),this._root.postUpdate(e),this._root.updateMatrixRecursive(),this._root.prepareRender(e),this._renderer.prepareScene(this._root,e),this._frameEvent=e}render(e){this._frameEvent&&this._renderer.render(e,this._frameEvent)}createEntityUpdateEvent(e){let t={playing:this._frame.playing,timeElapsed:this._time.engine,timeDelta:this._time.delta,timeCode:this._time.code,timeCodeFrame:this._frame.current,resolution:this.renderer.resolution,renderer:this.renderer,forceDraw:!1};return e?{...t,...e}:t}setSize(e){this._renderer.resize(e),this._renderer.canvas.width=e.x,this._renderer.canvas.height=e.y,this._renderer.globalUniforms.uResolution.value.copy(e),this._renderer.globalUniforms.uAspectRatio.value=e.x/Math.max(e.y,1)}play(){this._frame.playing=!0,this._time.current=new Date().getTime()}stop(){this._frame.playing=!1}seek(e){this._time.code=e/60,this._frame.current=e,this.emit(`update/frame/play`,[this._frame])}updateOffline(t,n){let r=t/n,i=1/n;this._time.delta=i,this._time.current=new Date().getTime(),this._time.engine+=i,this._time.code=r,this._frame.current=r*60,this._frame.playing=!0;let a=this.createEntityUpdateEvent({forceDraw:!0});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1;let o=e.resources.updateEveryFrameTextures;for(let e=0;e<o.length;e++)o[e].render();this._step(a)}compileShaders(e,t){let n=this.createEntityUpdateEvent({forceDraw:!0});return this.renderer.compileShaders(this._root,e,n,t)}dispose(){this._disposed=!0,this._root.disposeRecursive()}},Ya.resources=new qa,Ya.__docgenInfo={description:``,methods:[{name:`createEntity`,docblock:null,modifiers:[],params:[{name:`params`,optional:!0,type:{name:`Omit`,elements:[{name:`MXP.EntityParams`},{name:`literal`,value:`'engine'`}],raw:`Omit<MXP.EntityParams, 'engine'>`,alias:`Omit`}}],returns:{type:{name:`MXP.Entity`}}},{name:`canvas`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`renderer`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`root`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`frame`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`time`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`frameSetting`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`uniforms`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`disposed`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`createView`,docblock:null,modifiers:[],params:[{name:`opt`,optional:!0,type:{name:`MXP.RenderViewOptions`,alias:`MXP.RenderViewOptions`}}],returns:null},{name:`init`,docblock:null,modifiers:[],params:[],returns:null},{name:`load`,docblock:null,modifiers:[`async`],params:[{name:`project`,optional:!1,type:{name:`OREngineProjectData`,alias:`OREngineProjectData`}}],returns:null},{name:`update`,docblock:null,modifiers:[],params:[{name:`param`,optional:!0,type:{name:`Partial`,elements:[{name:`MXP.EntityUpdateEvent`}],raw:`Partial<MXP.EntityUpdateEvent>`,alias:`Partial`}}],returns:null},{name:`createEntityUpdateEvent`,docblock:null,modifiers:[],params:[{name:`overrideParams`,optional:!0,type:{name:`Partial`,elements:[{name:`MXP.EntityUpdateEvent`}],raw:`Partial<MXP.EntityUpdateEvent>`,alias:`Partial`}}],returns:{type:{name:`MXP.EntityUpdateEvent`}}},{name:`setSize`,docblock:null,modifiers:[],params:[{name:`resolution`,optional:!1,type:{name:`MTP.Vector`,alias:`MTP.Vector`}}],returns:null},{name:`play`,docblock:null,modifiers:[],params:[],returns:null},{name:`stop`,docblock:null,modifiers:[],params:[],returns:null},{name:`seek`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`number`}}],returns:null},{name:`updateOffline`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`number`}},{name:`fps`,optional:!1,type:{name:`number`}}],returns:null},{name:`compileShaders`,docblock:null,modifiers:[],params:[{name:`view`,optional:!1,type:{name:`MXP.RenderViewContract`,alias:`MXP.RenderViewContract`}},{name:`onProgress`,optional:!0,type:{name:`signature`,type:`function`,raw:`( label: string, loaded: number, total: number ) => void`,signature:{arguments:[{type:{name:`string`},name:`label`},{type:{name:`number`},name:`loaded`},{type:{name:`number`},name:`total`}],return:{name:`void`}}}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`Engine`}})))()}var Za;function Qa(){return(Qa=t((()=>{cr(),Za=class extends ir{_pressedKeys;constructor(){super(),this._pressedKeys={};let e=this._onKeyDown.bind(this),t=this._onKeyUp.bind(this);window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,t),this.once(`dispose`,()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,t)})}get pressedKeys(){return this._pressedKeys}_onKeyDown(e){this._pressedKeys[e.key]=!0,this.emit(`keydown`,[e,this._pressedKeys])}_onKeyUp(e){if(this._pressedKeys[e.key]=!1,e.key==`Meta`||e.key==`Control`){let e=Object.keys(this._pressedKeys);for(let t=0;t<e.length;t++)this._pressedKeys[e[t]]=!1}this.emit(`keyup`,[e,this._pressedKeys])}dispose(){this.emit(`dispose`)}}})))()}var $a;function eo(){return(eo=t((()=>{cr(),N(),$a=class extends ir{_isTouching;element=null;position;delta;constructor(){super(),this.position=new j(NaN,NaN),this.delta=new j(NaN,NaN),this._isTouching=!1;let e=this._onPointer.bind(this,`move`),t=this._onPointer.bind(this,`end`);window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`dragend`,t);let n=()=>{this.element&&this.removeElement(this.element),window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`dragend`,t),this.off(`dispose`,n)};this.on(`dispose`,n)}setElement(e){this.element&&this.removeElement(this.element),this.element=e;let t=this._onPointer.bind(this,`start`);e.addEventListener(`pointerdown`,t);let n=r=>{e.isEqualNode(r.elm)&&(e.removeEventListener(`pointerdown`,t),this.off(`unregister`,n))};this.on(`unregister`,n)}removeElement(e){this.emit(`unregister`,[e])}getScreenPosition(e){if(this.position.x!=this.position.x)return new j(NaN,NaN);let t=this.position.clone().divide(e).multiply(2).sub(1);return t.y*=-1,t}getRelativePosition(e,t){let n=e.getClientRects()[0],r=this.position.x-n.left,i=this.position.y-n.top;return t&&(r/=n.width,i/=n.height),new j(r,i)}_setPos(e,t){this.position.x!==this.position.x||this.position.y!==this.position.y?this.delta.set(0,0):this.delta.set(e-this.position.x,t-this.position.y),this.position.set(e,t)}_onPointer(e,t){let n=t.pointerType;(n==null||n==`mouse`&&(t.button==-1||t.button==0)||n==`touch`)&&this._touchEventHandler(t.pageX,t.pageY,e,t)}_touchEventHandler(e,t,n,r){let i=!1,a=e-window.pageXOffset,o=t-window.pageYOffset;n==`start`?(this._isTouching=!0,this._setPos(a,o),this.delta.set(0,0),i=!0):n==`move`?(this._setPos(a,o),this._isTouching&&(i=!0)):n==`end`&&(`targetTouches`in r?r.targetTouches.length==0&&(this._isTouching=!1):this._isTouching=!1,i=!0),i&&this.emit(n,[{pointerEvent:r,position:this.position.clone(),delta:this.delta.clone()}])}dispose(){this.emit(`dispose`)}}})))()}function to(){return(to=t((()=>{Xa(),Ja(),Qa(),eo()})))()}function no(){return(no=t((()=>{to()})))()}var ro,io;function ao(){return(ao=t((()=>{ro=i(),io=(0,ro.createContext)(null)})))()}var oo,so;function co(){return(co=t((()=>{oo=i(),ao(),so=()=>{let e=(0,oo.useContext)(io);if(e===null)throw Error(`useMouseMenu must be used within a MouseMenuProvider`);return e}})))()}var lo,uo;function fo(){return(fo=t((()=>{lo=i(),uo=(0,lo.createContext)(void 0)})))()}var po,mo;function ho(){return(ho=t((()=>{po=i(),fo(),mo=()=>(0,po.useContext)(uo)})))()}var go,_o,vo,yo,bo;function xo(){return(xo=t((()=>{go=`ComponentAdd__compoAdd___LmNvb`,_o=`ComponentAdd__directory___LmNvb`,vo=`ComponentAdd__subDirectory___LmNvb`,yo=`ComponentAdd__picker___LmNvb`,bo={compoAdd:go,directory:_o,subDirectory:vo,picker:yo}})))()}var So,Co,wo,To;function Eo(){return(Eo=t((()=>{So=e(i(),1),no(),u(),O(),co(),ho(),xo(),Co=s(),wo=({group:e,onClickAdd:t})=>{let n=mo(),[r,i]=(0,So.useState)(!1),a=null,o,s=`dir`,c=e.name.startsWith(`_`)?e.name.slice(1):e.name;`child`in e?a=(0,Co.jsx)(Co.Fragment,{children:e.child.map((e,n)=>(0,Co.jsx)(wo,{group:e,onClickAdd:t},n))}):(o=()=>t(e),s=`item`);let l=window.matchMedia(`(hover: hover)`).matches;return(0,Co.jsxs)(`div`,{className:bo.directory,onPointerEnter:l?()=>i(!0):void 0,onPointerLeave:l?()=>i(!1):void 0,onClick:e=>{o?o():(e.stopPropagation(),i(!r))},"data-type":s,"data-direction":n?.direction,children:[c,r&&(0,Co.jsx)(`div`,{className:bo.subDirectory,children:a})]})},To=e=>{let{editor:t}=D(),{pushContent:n,closeAll:r}=so(),i=Ya.resources,a=(0,So.useCallback)(a=>{if(!i||!n||!r)return;let o=[],s=n=>{t.api.addComponent(e.entity,n.component),r()};i.componentGroups.forEach((e,t)=>{o.push((0,Co.jsx)(wo,{group:e,onClickAdd:s},t))}),n((0,Co.jsx)(`div`,{className:bo.picker,children:o}))},[n,i,e.entity,r,t]);return(0,Co.jsx)(`div`,{className:bo.compAdd,children:(0,Co.jsx)(d,{onClick:a,children:`Add Component`})})},To.__docgenInfo={description:``,methods:[],displayName:`ComponentAdd`,props:{entity:{required:!0,tsType:{name:`MXP.Entity`},description:``}}}})))()}var Do,Oo,ko,Ao,jo,Mo;function No(){return(No=t((()=>{Do=`ComponentView__compoView___LmNvb`,Oo=`ComponentView__head___LmNvb`,ko=`ComponentView__name___LmNvb`,Ao=`ComponentView__check___LmNvb`,jo=`ComponentView__propertyBlock___LmNvb`,Mo={compoView:Do,head:Oo,name:ko,check:Ao,delete:`ComponentView__delete___LmNvb`,propertyBlock:jo}})))()}var Po,Fo,Io,Lo;function Ro(){return(Ro=t((()=>{Po=i(),c(),ee(),O(),Tn(),En(),No(),Fo=s(),Io=e=>{let t=Object.keys(e.childs);for(let n=0;n<t.length;n++){let r=e.childs[t[n]],{opt:i}=r,a=!1;if(i&&(a=typeof i.hidden==`function`?i.hidden(r.type===`value`?r.value:null):i.hidden||!1),!a&&(r.type===`value`||Io(r)))return!0}return!1},Lo=({component:e})=>{let{editor:t}=D(),[n,r]=A(e,`enabled`),i=e.initiator!==`user`,a=Io(e.serializeToDirectory()),o=(0,Po.useCallback)(n=>{n.stopPropagation();let r=e.entity;if(r){for(let[n,i]of r.components)if(i.uuid===e.uuid){t.api.removeComponent(r,n,e);break}}},[e,t]),s=(0,Fo.jsxs)(`div`,{className:Mo.head,children:[(0,Fo.jsx)(`div`,{className:Mo.name,children:e.constructor.name}),(0,Fo.jsx)(`div`,{className:Mo.delete,children:(0,Fo.jsx)(`button`,{onClick:o,children:(0,Fo.jsx)(C,{})})})]});return(0,Fo.jsx)(`div`,{className:Mo.compoView,"data-disable_component":i,children:(0,Fo.jsx)(`div`,{className:Mo.content,children:(0,Fo.jsx)(l,{label:s,accordion:a,bg:!0,defaultClose:!1,children:a&&(0,Fo.jsx)(wn,{target:e})})})})},Lo.__docgenInfo={description:``,methods:[],displayName:`ComponentView`,props:{component:{required:!0,tsType:{name:`MXP.Component`},description:``}}}})))()}var zo,Bo;function Vo(){return(Vo=t((()=>{zo=`ComponentList__container___LmNvb`,Bo={container:zo}})))()}var Ho,Uo,Wo;function Go(){return(Go=t((()=>{Ho=i(),En(),Ro(),Vo(),Uo=s(),Wo=({entity:e})=>{let[t]=A(e,`components`),n=(0,Ho.useMemo)(()=>{let n=[];return t?(t.forEach(t=>{let r=e.getComponentByUUID(t);r&&n.push((0,Uo.jsx)(Lo,{component:r},r.uuid))}),n):null},[t,e]);return(0,Uo.jsx)(`div`,{className:Bo.container,children:n})},Wo.__docgenInfo={description:``,methods:[],displayName:`ComponentList`}})))()}var Ko,qo,Jo;function Yo(){return(Yo=t((()=>{Ko=i(),c(),O(),Tn(),En(),Eo(),Go(),qo=s(),Jo=()=>{let{editor:e,engine:t}=D(),[n]=A(e,`selectedEntityId`),r=(0,Ko.useMemo)(()=>{if(n)return t.root.findEntityByUUID(n)},[t,n]);return r?(0,qo.jsxs)(qo.Fragment,{children:[(0,qo.jsx)(l,{label:`Fields`,accordion:!0,children:(0,qo.jsx)(wn,{target:r})}),(0,qo.jsxs)(l,{label:`Components`,accordion:!0,children:[(0,qo.jsx)(Wo,{entity:r}),(0,qo.jsx)(To,{entity:r})]})]}):null},Jo.__docgenInfo={description:``,methods:[],displayName:`EntityProperty`}})))()}var Xo,Zo,Qo;function $o(){return($o=t((()=>{Xo=`ExportControl__exportControl___LmV4c`,Zo=`ExportControl__exportControl_inner___LmV4c`,Qo={exportControl:Xo,exportControl_inner:Zo}})))()}var es,ts,ns;function rs(){return(rs=t((()=>{es=i(),c(),u(),O(),$o(),ts=s(),ns=()=>{let{editor:e}=D(),[t,n]=(0,es.useState)(null);return(0,es.useEffect)(()=>{let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),(0,ts.jsx)(`div`,{className:Qo.exportControl,children:(0,ts.jsx)(`div`,{className:Qo.exportControl_inner,children:(0,ts.jsx)(l,{label:`MP4`,accordion:!0,children:(0,ts.jsx)(d,{onClick:()=>{e.isExporting||e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})})})})},ns.__docgenInfo={description:``,methods:[],displayName:`ExportControl`}})))()}var is,as;function os(){return(os=t((()=>{is=i(),as=(0,is.createContext)(null)})))()}var ss,cs;function ls(){return(ls=t((()=>{ss=i(),os(),cs=()=>{let e=(0,ss.useContext)(as);if(e===null)throw Error(`useOREngine must be used within a OREngineProvider`);return e}})))()}var us,ds,fs,ps,ms,hs,gs,_s,vs,ys,bs,xs,Ss,Cs,ws,Ts,Es,Ds,R;function Os(){return(Os=t((()=>{us=`GPUTimer__container___LmNvb`,ds=`GPUTimer__headerRow___LmNvb`,fs=`GPUTimer__totalTime___LmNvb`,ps=`GPUTimer__toggleButton___LmNvb`,ms=`GPUTimer__controls___LmNvb`,hs=`GPUTimer__control___LmNvb`,gs=`GPUTimer__controlLabel___LmNvb`,_s=`GPUTimer__select___LmNvb`,vs=`GPUTimer__input___LmNvb`,ys=`GPUTimer__group___LmNvb`,bs=`GPUTimer__item___LmNvb`,xs=`GPUTimer__clickable___LmNvb`,Ss=`GPUTimer__itemRow___LmNvb`,Cs=`GPUTimer__itemName___LmNvb`,ws=`GPUTimer__itemTime___LmNvb`,Ts=`GPUTimer__itemStats___LmNvb`,Es=`GPUTimer__progressBar___LmNvb`,Ds=`GPUTimer__progressFill___LmNvb`,R={container:us,headerRow:ds,totalTime:fs,toggleButton:ps,controls:ms,control:hs,controlLabel:gs,select:_s,input:vs,group:ys,item:bs,clickable:xs,itemRow:Ss,itemName:Cs,itemTime:ws,itemStats:Ts,progressBar:Es,progressFill:Ds}})))()}var ks,As;function js(){return(js=t((()=>{ks=class{buffer;index;size;filled;constructor(e){this.size=e,this.buffer=Array(e),this.index=0,this.filled=!1}push(e){this.buffer[this.index]=e,this.index=(this.index+1)%this.size,!this.filled&&this.index===0&&(this.filled=!0)}getAverage(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=0;for(let n=0;n<e;n++)t+=this.buffer[n];return t/e}getMax(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]>t&&(t=this.buffer[n]);return t}getMin(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]<t&&(t=this.buffer[n]);return t}getCount(){return this.filled?this.size:this.index}},As=class{buffers;windowSize;currentData;constructor(e=30){this.windowSize=e,this.buffers=new Map,this.currentData=new Map}update(e){let t=performance.now();for(let n=0;n<e.length;n++){let r=e[n],i=r.name.split(`/`),a=i[0]||`unknown`,o,s=i[i.length-1],c=s&&s.match(/\[([^\]]+)\]/);c&&(o=c[1]);let l={name:r.name,duration:r.duration,timestamp:t,renderType:a},u=this.buffers.get(r.name);u||(u=new ks(this.windowSize),this.buffers.set(r.name,u)),u.push(r.duration),this.currentData.set(r.name,{...l,entityId:o})}}getStatistics(){let e=[],t=0,n=performance.now(),r=[];return this.currentData.forEach((e,t)=>{n-e.timestamp>1e3&&r.push(t)}),r.forEach(e=>{this.currentData.delete(e)}),this.currentData.forEach(e=>{t+=e.duration}),this.currentData.forEach(n=>{let r=this.buffers.get(n.name);r&&e.push({name:n.name,renderType:n.renderType,entityId:n.entityId,current:n.duration,avg:r.getAverage(),max:r.getMax(),min:r.getMin(),samples:r.getCount(),percentage:t>0?n.duration/t*100:0})}),e}getTotalTime(){let e=0;return this.currentData.forEach(t=>{e+=t.duration}),e}}})))()}var Ms,z,Ns,Ps,Fs,Is;function Ls(){return(Ls=t((()=>{Ms=i(),ls(),O(),Os(),js(),z=s(),Ns=e=>{if(e<2){let t=e/2;return`rgb(${Math.floor(100+t*100)}, 200, 100)`}if(e<5){let t=(e-2)/3;return`rgb(200, ${Math.floor(200-t*50)}, 100)`}if(e<10){let t=(e-5)/5;return`rgb(200, ${Math.floor(150-t*80)}, ${Math.floor(100-t*50)})`}return`rgb(200, 70, 50)`},Ps=e=>e>=10?e.toFixed(1):e>=1?e.toFixed(2):e.toFixed(3),Fs=e=>e.replace(/\[([^\]]{4,})\]/g,(e,t)=>`[${t.slice(0,3)}]`),Is=()=>{let{editor:e}=D(),{engine:t}=cs(),[n,r]=(0,Ms.useState)([]),[i,a]=(0,Ms.useState)(0),[o,s]=(0,Ms.useState)(`all`),[c,l]=(0,Ms.useState)(0),[u,d]=(0,Ms.useState)(`time`),[f,p]=(0,Ms.useState)(!1),m=(0,Ms.useRef)(new As(30)),h=(0,Ms.useRef)(0),g=(0,Ms.useRef)(!1),_=(0,Ms.useRef)(0),v=(0,Ms.useCallback)(n=>{if(!n)return;let r=t.root.findEntityByUUID(n);r&&e.selectEntity(r)},[t,e]);(0,Ms.useEffect)(()=>{let e=t.renderer,n=m.current,i=e=>{f&&(n.update(e),g.current=!0)},o=e=>{g.current&&e-_.current>=300&&(r(n.getStatistics()),a(n.getTotalTime()),g.current=!1,_.current=e),h.current=requestAnimationFrame(o)};return e.on(`timer`,i),h.current=requestAnimationFrame(o),()=>{e.off(`timer`,i),cancelAnimationFrame(h.current)}},[t,f]);let y=n.filter(e=>!(o!==`all`&&e.renderType!==o||e.avg<c)),b=Array.from(new Set(n.map(e=>e.renderType))),x=[...y].sort((e,t)=>u===`time`?t.avg-e.avg:e.name.localeCompare(t.name)),S=i>0?Math.floor(1e3/i):0;return(0,z.jsxs)(`div`,{className:R.container,children:[(0,z.jsxs)(`div`,{className:R.headerRow,children:[(0,z.jsxs)(`span`,{className:R.totalTime,children:[Ps(i),`ms (`,S,`fps)`]}),(0,z.jsx)(`button`,{className:R.toggleButton,onClick:()=>p(!f),title:f?`Stop timer`:`Start timer`,children:f?`⏸`:`▶`})]}),(0,z.jsxs)(`div`,{className:R.controls,children:[(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Type`}),(0,z.jsxs)(`select`,{className:R.select,value:o,onChange:e=>s(e.target.value),children:[(0,z.jsx)(`option`,{value:`all`,children:`All`}),b.map(e=>(0,z.jsx)(`option`,{value:e,children:e},e))]})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Min`}),(0,z.jsx)(`input`,{className:R.input,type:`number`,min:`0`,step:`0.1`,value:c,onChange:e=>l(parseFloat(e.target.value)||0)})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Sort`}),(0,z.jsxs)(`select`,{className:R.select,value:u,onChange:e=>d(e.target.value),children:[(0,z.jsx)(`option`,{value:`time`,children:`Time`}),(0,z.jsx)(`option`,{value:`name`,children:`Name`})]})]})]}),(0,z.jsx)(`div`,{className:R.group,children:x.map((e,t)=>{let n=Ns(e.avg),r=i>0?e.avg/i*100:0,a=!!e.entityId;return(0,z.jsxs)(`div`,{className:`${R.item} ${a?R.clickable:``}`,onClick:()=>v(e.entityId),children:[(0,z.jsxs)(`div`,{className:R.itemRow,children:[(0,z.jsx)(`span`,{className:R.itemName,title:e.name,children:Fs(e.name)}),(0,z.jsx)(`span`,{className:R.itemTime,style:{color:n},children:Ps(e.avg)}),(0,z.jsx)(`span`,{className:R.itemStats,children:Ps(e.max)})]}),(0,z.jsx)(`div`,{className:R.progressBar,children:(0,z.jsx)(`div`,{className:R.progressFill,style:{width:`${r}%`,backgroundColor:n}})})]},e.name+t)})})]})},Is.__docgenInfo={description:``,methods:[],displayName:`Timer`}})))()}var Rs,zs,Bs,Vs,Hs,Us;function Ws(){return(Ws=t((()=>{Rs=`Picker__picker___LnBpY`,zs=`Picker__picker_label___LnBpY`,Bs=`Picker__picker_list___LnBpY`,Vs=`Picker__picker_list_inner___LnBpY`,Hs=`Picker__item___LnBpY`,Us={picker:Rs,picker_label:zs,picker_list:Bs,picker_list_inner:Vs,item:Hs}})))()}var Gs,Ks;function qs(){return(qs=t((()=>{Ws(),Gs=s(),Ks=e=>(0,Gs.jsxs)(`div`,{className:Us.picker,"data-no_bg":e.noBg,children:[e.label&&(0,Gs.jsx)(`div`,{className:Us.picker_label,children:e.label}),(0,Gs.jsx)(`div`,{className:Us.picker_list,children:(0,Gs.jsx)(`div`,{className:Us.picker_list_inner,children:e.list.map((e,t)=>(0,Gs.jsx)(`div`,{className:Us.item,onClick:e.onClick,children:e.label},t))})})]}),Ks.__docgenInfo={description:``,methods:[],displayName:`Picker`,props:{label:{required:!1,tsType:{name:`string`},description:``},list:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
	label: string,
	onClick?: () => void
}`,signature:{properties:[{key:`label`,value:{name:`string`,required:!0}},{key:`onClick`,value:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}},required:!1}}]}}],raw:`SelectListItem[]`},description:``},noBg:{required:!1,tsType:{name:`boolean`},description:``}}}})))()}var Js,Ys,Xs;function Zs(){return(Zs=t((()=>{Js=`InputGroup__group___Lmdyb`,Ys=`InputGroup__submit___Lmdyb`,Xs={group:Js,submit:Ys}})))()}var Qs,$s,ec;function tc(){return(tc=t((()=>{Qs=i(),c(),u(),jt(),Zs(),$s=s(),ec=e=>{let t=e.initialValues,n=[],[r,i]=(0,Qs.useState)(t);(0,Qs.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,$s.jsx)(k,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,Qs.useRef)(null);return(0,Qs.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,$s.jsx)(`div`,{className:Xs.group,ref:o,children:(0,$s.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,$s.jsx)(l,{label:e.title,noMargin:!0,children:n}),(0,$s.jsx)(`div`,{className:Xs.submit,children:(0,$s.jsx)(d,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},ec.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}var nc,rc,ic,ac,oc,sc,cc,lc,uc,dc,fc,pc;function mc(){return(mc=t((()=>{nc=`HierarchyNode__node___Lm5vZ`,rc=`HierarchyNode__self___Lm5vZ`,ic=`HierarchyNode__self_name___Lm5vZ`,ac=`HierarchyNode__icon___Lm5vZ`,oc=`HierarchyNode__selectable___Lm5vZ`,sc=`HierarchyNode__visibility___Lm5vZ`,cc=`HierarchyNode__menu___Lm5vZ`,lc=`HierarchyNode__fold___Lm5vZ`,uc=`HierarchyNode__fold_button___Lm5vZ`,dc=`HierarchyNode__child___Lm5vZ`,fc=`HierarchyNode__child_line___Lm5vZ`,pc={node:nc,self:rc,self_name:ic,icon:ac,selectable:oc,visibility:sc,menu:cc,fold:lc,fold_button:uc,child:dc,child_line:fc}})))()}var hc,B,gc;function _c(){return(_c=t((()=>{hc=i(),L(),a(),f(),m(),_(),h(),b(),O(),qs(),co(),tc(),En(),mc(),B=s(),gc=e=>{let{editor:t,engine:n}=D(),[r]=A(t,`selectedEntityId`),i=r!==void 0&&n.root.findEntityByUUID(r),[a,s]=A(e.entity,`visible`),[c,l]=A(t,`unselectableEntityIds`),[u]=A(e.entity,`children`),d=!(c||[]).includes(e.entity.uuid),f=(u||[]).map(e=>n.root.findEntityByUUID(e)).filter(e=>e!==void 0),m=e.depth||0,h=f&&f.concat().sort((e,t)=>e.name.localeCompare(t.name))||[],_=h.length>0,b=m*20,x=e.entity.initiator==`script`,C=(0,hc.useMemo)(()=>e.entity.getComponent(Hr)?(0,B.jsx)(S,{size:14}):e.entity.getComponent(Rr)?(0,B.jsx)(p,{size:14}):e.entity.getComponent(F)?(0,B.jsx)(y,{size:14}):null,[e.entity]),ee=e.openNodes.has(e.entity.uuid),te=(0,hc.useCallback)(t=>{e.setNodeOpen(e.entity.uuid,!ee),t.stopPropagation()},[ee,e]),ne=(0,hc.useCallback)(()=>{t&&t.selectEntity(e.entity)},[t,e.entity]),re=(0,hc.useCallback)(e=>{e.stopPropagation(),s&&s(!a)},[a,s]),ie=(0,hc.useCallback)(t=>{t.stopPropagation();let n=new Set(c||[]);d?n.add(e.entity.uuid):n.delete(e.entity.uuid),l(Array.from(n))},[d,c,l,e.entity.uuid]),{pushContent:w,closeAll:ae}=so(),oe=(0,hc.useCallback)(n=>{n.preventDefault(),!(!t||!w||!ae||x)&&(t.selectEntity(e.entity),w((0,B.jsx)(Ks,{label:e.entity.name,list:[{label:`Add Entity`,onClick:()=>{w((0,B.jsx)(ec,{initialValues:{name:``},onSubmit:n=>{let r=t.api.createEntity(e.entity,n.name);t.api.selectEntity(r),ae()}}))}},{label:`Delete Entity`,onClick:()=>{t.api.deleteEntity(e.entity),ae()}}]})))},[t,e.entity,w,ae,x]);return(0,B.jsxs)(`div`,{className:pc.node,"data-no_export":x,children:[(0,B.jsxs)(`div`,{className:pc.self,style:{paddingLeft:b},onClick:ne,onContextMenu:oe,"data-selected":i&&i.uuid==e.entity.uuid,children:[(0,B.jsx)(`div`,{className:pc.fold,"data-hnode_open":ee,children:_&&(0,B.jsx)(`button`,{className:pc.fold_button,onClick:te,children:(0,B.jsx)(o,{open:ee})})}),C&&(0,B.jsx)(`div`,{className:pc.icon,children:C}),(0,B.jsx)(`div`,{className:pc.self_name,children:(0,B.jsx)(`p`,{children:e.entity.name||`-`})}),(0,B.jsx)(`button`,{className:pc.selectable,onClick:ie,"data-selectable":d,children:(0,B.jsx)(g,{size:14,selectable:d})}),(0,B.jsx)(`button`,{className:pc.visibility,onClick:re,"data-visible":a!==!1,children:(0,B.jsx)(v,{size:14,visible:a!==!1})}),!x&&(0,B.jsx)(`button`,{className:pc.menu,onClick:oe,children:`⋯`})]}),_&&(0,B.jsxs)(`div`,{className:pc.child,"data-open":ee,children:[h.map(t=>(0,B.jsx)(gc,{entity:t,depth:m+1,openNodes:e.openNodes,setNodeOpen:e.setNodeOpen},t.uuid)),(0,B.jsx)(`div`,{className:pc.child_line,style:{marginLeft:b+4}})]})]})},gc.__docgenInfo={description:``,methods:[],displayName:`HierarchyNode`,props:{depth:{required:!1,tsType:{name:`number`},description:``},entity:{required:!0,tsType:{name:`MXP.Entity`},description:``},openNodes:{required:!0,tsType:{name:`Set`,elements:[{name:`string`}],raw:`Set<string>`},description:``},setNodeOpen:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( uuid: string, open: boolean ) => void`,signature:{arguments:[{type:{name:`string`},name:`uuid`},{type:{name:`boolean`},name:`open`}],return:{name:`void`}}},description:``}}}})))()}var vc;function yc(){return(yc=t((()=>{vc={}})))()}var bc,xc,Sc,Cc,wc,Tc;function Ec(){return(Ec=t((()=>{bc=i(),O(),En(),_c(),yc(),xc=s(),Sc=`hierarchyOpenNodes`,Cc=()=>{try{let e=localStorage.getItem(Sc);if(e)return new Set(JSON.parse(e))}catch{}return new Set},wc=e=>{localStorage.setItem(Sc,JSON.stringify(Array.from(e)))},Tc=()=>{let{editor:e,engine:t}=D(),[n]=A(e,`selectedEntityId`),r=t.root,[i,a]=(0,bc.useState)(Cc),o=(0,bc.useCallback)((e,t)=>{a(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),wc(r),r})},[]);return(0,bc.useEffect)(()=>{if(!n)return;let e=r.findEntityByUUID(n);if(!e)return;let t=[],i=e.parent;for(;i;)t.push(i.uuid),i=i.parent;a(e=>{if(t.every(t=>e.has(t)))return e;let n=new Set(e);return t.forEach(e=>n.add(e)),wc(n),n})},[n,r]),(0,xc.jsx)(`div`,{className:vc.hierarchy,children:r&&(0,xc.jsx)(gc,{entity:r,openNodes:i,setNodeOpen:o})})},Tc.__docgenInfo={description:``,methods:[],displayName:`Hierarchy`}})))()}var Dc,Oc,kc,Ac,jc,Mc,Nc,Pc,Fc;function Ic(){return(Ic=t((()=>{Dc=`InputWindow__inputWindow___Lmluc`,Oc=`InputWindow__overlay___Lmluc`,kc=`InputWindow__window___Lmluc`,Ac=`InputWindow__label___Lmluc`,jc=`InputWindow__input___Lmluc`,Mc=`InputWindow__buttons___Lmluc`,Nc=`InputWindow__cancelBtn___Lmluc`,Pc=`InputWindow__okBtn___Lmluc`,Fc={inputWindow:Dc,overlay:Oc,window:kc,label:Ac,input:jc,buttons:Mc,cancelBtn:Nc,okBtn:Pc}})))()}var Lc,Rc,zc;function Bc(){return(Bc=t((()=>{Lc=i(),Ie(),Ic(),Rc=s(),zc=()=>{let{config:e,close:t}=Fe(),n=(0,Lc.useRef)(null),[r,i]=(0,Lc.useState)(``),a=(0,Lc.useRef)(!1);(0,Lc.useEffect)(()=>{e&&(i(String(e.value)),a.current=!0)},[e]),(0,Lc.useEffect)(()=>{a.current&&(a.current=!1,n.current?.focus(),n.current?.select())},[r]);let o=(0,Lc.useCallback)(()=>{e&&(e.type===`number`?e.onChange(Number(r)):e.onChange(r),t())},[e,r,t]),s=(0,Lc.useCallback)(()=>{t()},[t]);return e?(0,Rc.jsxs)(`div`,{className:Fc.inputWindow,children:[(0,Rc.jsx)(`div`,{className:Fc.overlay,onClick:s}),(0,Rc.jsxs)(`div`,{className:Fc.window,children:[e.label&&(0,Rc.jsx)(`div`,{className:Fc.label,children:e.label}),(0,Rc.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),o()},children:[(0,Rc.jsx)(`input`,{ref:n,className:Fc.input,type:`text`,inputMode:e.type===`number`?`decimal`:`text`,value:r,step:e.step,min:e.min,max:e.max,onChange:e=>i(e.target.value),onKeyDown:e=>{e.key===`Escape`&&s()}}),(0,Rc.jsxs)(`div`,{className:Fc.buttons,children:[(0,Rc.jsx)(`button`,{type:`button`,className:Fc.cancelBtn,onClick:s,children:`Cancel`}),(0,Rc.jsx)(`button`,{type:`submit`,className:Fc.okBtn,children:`OK`})]})]})]})]}):null},zc.__docgenInfo={description:``,methods:[],displayName:`InputWindow`}})))()}var Vc,Hc;function Uc(){return(Uc=t((()=>{Vc=i(),Hc=()=>{let[e,t]=(0,Vc.useState)(null);return{config:e,open:(0,Vc.useCallback)(e=>{t(e)},[]),close:(0,Vc.useCallback)(()=>{t(null)},[])}}})))()}var Wc,Gc;function Kc(){return(Kc=t((()=>{Ne(),Uc(),Wc=s(),Gc=e=>{let t=Hc();return(0,Wc.jsx)(Me.Provider,{value:t,children:e.children})},Gc.__docgenInfo={description:``,methods:[],displayName:`InputWindowProvider`}})))()}var qc,Jc,Yc,Xc,Zc,Qc;function $c(){return($c=t((()=>{qc=`MouseMenu__mouseMenu___Lm1vd`,Jc=`MouseMenu__hide___Lm1vd`,Yc=`MouseMenu__menuItem___Lm1vd`,Xc=`MouseMenu__menuItem_inner___Lm1vd`,Zc=`MouseMenu__menuItem_inner_inner___Lm1vd`,Qc={mouseMenu:qc,hide:Jc,menuItem:Yc,menuItem_inner:Xc,menuItem_inner_inner:Zc}})))()}var el,tl;function nl(){return(nl=t((()=>{fo(),co(),$c(),el=s(),tl=()=>{let{itemList:e,containerRef:t,closeAll:n}=so();return(0,el.jsxs)(`div`,{className:Qc.mouseMenu,ref:t,children:[e&&e.length>0&&(0,el.jsx)(`div`,{className:Qc.hide,onClick:()=>{n&&n()}}),e&&e.map(e=>{let t=e.pos;return(0,el.jsx)(uo.Provider,{value:e,children:(0,el.jsx)(`div`,{className:Qc.menuItem,style:{left:0,top:0,transform:`translate(${t.x}px, ${t.y}px)`},children:(0,el.jsx)(`div`,{className:Qc.menuItem_inner,children:(0,el.jsx)(`div`,{className:Qc.menuItem_inner_inner,"data-direction":e.direction,children:e.elm})})})},e.id)})]})},tl.__docgenInfo={description:``,methods:[],displayName:`MouseMenu`}})))()}var rl,il,al;function ol(){return(ol=t((()=>{rl=i(),il=0,al=()=>{let e=(0,rl.useRef)(null),t=(0,rl.useRef)({x:0,y:0}),n=(0,rl.useCallback)(e=>{t.current.x=e.clientX,t.current.y=e.clientY},[]);(0,rl.useEffect)(()=>(window.addEventListener(`pointermove`,n),()=>{window.removeEventListener(`pointermove`,n)}),[n]);let[r,i]=(0,rl.useState)([]),a=(0,rl.useRef)(r);a.current=r;let o=(0,rl.useCallback)(e=>{a.current=a.current.filter(t=>t.id!==e),i(a.current)},[]),s=(0,rl.useCallback)(()=>{i([])},[]);return{itemList:r,pushContent:(0,rl.useCallback)(e=>{let n=il++,r={x:t.current.x,y:t.current.y},s={id:n,elm:e,pos:r,direction:(r.x<window.innerWidth/2?`right`:`left`)+`-`+(r.y<window.innerHeight/2?`bottom`:`top`),close:()=>o(n)};return i([...a.current,s]),s},[o]),closeAll:s,containerRef:e}}})))()}var sl,cl;function ll(){return(ll=t((()=>{ao(),ol(),sl=s(),cl=e=>{let t=al();return(0,sl.jsx)(io.Provider,{value:t,children:e.children})},cl.__docgenInfo={description:``,methods:[],displayName:`MouseMenuProvider`}})))()}var ul,dl;function fl(){return(fl=t((()=>{ul=`Canvas__container___LmNvb`,dl={container:ul}})))()}var pl,ml,hl;function gl(){return(gl=t((()=>{pl=i(),O(),fl(),ml=s(),hl=({viewportId:e})=>{let{engine:t,editor:n}=D(),r=(0,pl.useRef)(null);return(0,pl.useEffect)(()=>{let i=r.current;if(!t||!i)return;let a=n.createViewport(e,i);return()=>{a.dispose()}},[t,n,e]),(0,ml.jsx)(`div`,{className:dl.container,role:`presentation`,"aria-label":`3D Canvas`,children:(0,ml.jsx)(`canvas`,{ref:r})})},hl.__docgenInfo={description:``,methods:[],displayName:`Canvas`}})))()}var _l,vl;function yl(){return(yl=t((()=>{_l=`AudioView__audioView___LmF1Z`,vl={audioView:_l}})))()}var bl;function xl(){return(xl=t((()=>{cr(),N(),bl=class extends ir{wrapperElm;canvas;canvasCtx;viewRangeFrame;viewPort;viewPortRange;musicBuffer;resizeObserver;frameSetting;framePlay;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0];let e=window.localStorage.getItem(`audioViweRange`);this.viewRangeFrame=e?Number(e):2,this.frameSetting={duration:0,fps:60},this.framePlay={current:0,playing:!1},this.musicBuffer=null,this.resizeObserver=new ResizeObserver(this.onResize.bind(this))}onResize(){if(this.wrapperElm){let e=new j(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);this.canvas.width=e.x,this.canvas.height=e.y}this.render()}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.musicBuffer){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)]*1,s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]*1+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}this.canvasCtx.fillStyle=`#555`,this.canvasCtx.fillRect(this.canvas.width/2,0,1,this.canvas.height)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.canvas),this.onResize()}setFramePlaying(e){this.framePlay=e,this.viewPort=[this.framePlay.current-this.viewRangeFrame,0,this.framePlay.current+this.viewRangeFrame,0],this.viewPortRange=[this.viewPort[2]-this.viewPort[0],this.viewPort[3]-this.viewPort[1]],this.render()}setViewRangeFrame(e){this.viewRangeFrame=e,this.setFramePlaying(this.framePlay),localStorage.setItem(`audioViweRange`,String(this.viewRangeFrame))}setFrameSetting(e){this.frameSetting=e,this.render()}setMusicBuffer(e){this.musicBuffer=e,this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.canvas),this.resizeObserver.disconnect()}},bl.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setFramePlaying`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`FramePlay`,alias:`FramePlay`}}],returns:null},{name:`setViewRangeFrame`,docblock:null,modifiers:[],params:[{name:`rangeFrame`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frameSetting`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`AudioViewRenderer`}})))()}var Sl,Cl,wl;function Tl(){return(Tl=t((()=>{Sl=i(),O(),yl(),xl(),Cl=s(),wl=()=>{let{editor:e}=D(),t=(0,Sl.useRef)(null),[n,r]=(0,Sl.useState)();(0,Sl.useEffect)(()=>{let e=new bl;if(r(e),t.current)return e.setWrapperElm(t.current),()=>{e.dispose()}},[]);let i=e&&e.audioBuffer,[a,o]=(0,Sl.useState)(),[s,c]=(0,Sl.useState)({duration:0,fps:0}),[l,u]=(0,Sl.useState)({current:0,playing:!1});(0,Sl.useEffect)(()=>{if(!e)return;let t=e.engine,n=e=>{c({duration:e[`timeline/duration`],fps:e[`timeline/fps`]})},r=0,i=()=>{o(r++)},a=e=>{u({...e})};return n(t.serialize()),a(t.frame),t.on(`fields/update`,n),t.on(`update/music`,i),t.on(`update/frame/play`,a),()=>{t.off(`update/frame/setting`,n),t.off(`update/music`,i),t.off(`update/frame/play`,a)}},[e]),(0,Sl.useEffect)(()=>{n&&i&&n.setMusicBuffer(i)},[n,i,a]),(0,Sl.useEffect)(()=>{n&&l&&n.setFramePlaying(l)},[n,l]),(0,Sl.useEffect)(()=>{n&&s&&n.setFrameSetting(s)},[n,s]);let d=(0,Sl.useCallback)(e=>{if(n){let t=e.deltaY>0?1.1:.9;n.setViewRangeFrame(n.viewRangeFrame*t)}e.preventDefault()},[n]);return(0,Sl.useEffect)(()=>{let e=t.current;return e&&e.addEventListener(`wheel`,d,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,d)}},[d]),(0,Cl.jsx)(`div`,{className:vl.audioView,ref:t})},wl.__docgenInfo={description:``,methods:[],displayName:`AudioView`}})))()}var El,Dl,Ol;function kl(){return(kl=t((()=>{El=`CameraPad__cameraPad___LmNhb`,Dl=`CameraPad__btn___LmNhb`,Ol={cameraPad:El,btn:Dl}})))()}var Al,jl;function Ml(){return(Ml=t((()=>{O(),En(),kl(),Al=s(),jl=()=>{let{editor:e}=D(),[t]=A(e,`selectedEntityId`);return(0,Al.jsxs)(`div`,{className:Ol.cameraPad,children:[(0,Al.jsx)(`div`,{className:Ol.btn,"data-disabled":!t,onClick:()=>{t&&e.focusSelected()},title:`Focus selected ( . )`,children:`Focus`}),(0,Al.jsx)(`div`,{className:Ol.btn,onClick:()=>{e.syncToSceneCamera()},title:`Move to scene camera ( Esc )`,children:`Scene Cam`})]})},jl.__docgenInfo={description:``,methods:[],displayName:`CameraPad`}})))()}var Nl,Pl,Fl,Il,Ll,Rl,zl,Bl,Vl,Hl,Ul,Wl,Gl,Kl,ql,Jl,Yl,Xl,Zl,Ql,$l,V;function eu(){return(eu=t((()=>{Nl=`Screen__screen___LnNjc`,Pl=`Screen__header___LnNjc`,Fl=`Screen__header_tabs___LnNjc`,Il=`Screen__header_tab___LnNjc`,Ll=`Screen__header_right___LnNjc`,Rl=`Screen__header_item___LnNjc`,zl=`Screen__content___LnNjc`,Bl=`Screen__gizmoMode___LnNjc`,Vl=`Screen__gizmoMode_btn___LnNjc`,Hl=`Screen__gizmoMode_separator___LnNjc`,Ul=`Screen__modalStatus___LnNjc`,Wl=`Screen__canvas___LnNjc`,Gl=`Screen__audioViewHandle___LnNjc`,Kl=`Screen__audioView___LnNjc`,ql=`Screen__displayOptions___LnNjc`,Jl=`Screen__displayOptions_btn___LnNjc`,Yl=`Screen__overlay___LnNjc`,Xl=`Screen__overlay_field___LnNjc`,Zl=`Screen__overlay_label___LnNjc`,Ql=`Screen__overlay_separator___LnNjc`,$l=`Screen__externalBtn___LnNjc`,V={screen:Nl,header:Pl,header_tabs:Fl,header_tab:Il,header_right:Ll,header_item:Rl,content:zl,gizmoMode:Bl,gizmoMode_btn:Vl,gizmoMode_separator:Hl,modalStatus:Ul,canvas:Wl,audioViewHandle:Gl,audioView:Kl,displayOptions:ql,displayOptions_btn:Jl,overlay:Yl,overlay_field:Xl,overlay_label:Zl,overlay_separator:Ql,externalBtn:$l}})))()}var tu,H,nu,ru;function iu(){return(iu=t((()=>{tu=i(),u(),le(),Ae(),O(),Bt(),gl(),jt(),En(),Tl(),Ml(),eu(),H=s(),nu=`viewport`,ru=({viewportId:e})=>{let{editor:t}=D(),n=ke(),[r,i]=A(t,`enableRender`),[a,o]=A(t,`viewports/${e}/preview`),[s,c]=A(t,`viewType`),[l,u]=A(t,`resolutionScale`),[f,p]=A(t,`gizmoMode`),[m,h]=A(t,`transformOrientation`),[g]=A(t,`modalStatus`),[_,v]=A(t,`helpers/show`),[y,b]=A(t,`helpers/empty`),[x,S]=A(t,`helpers/camera`),[C,ee]=A(t,`helpers/light`),[te,ne]=A(t,`helpers/grid`),[re,ie]=A(t,`helpers/wireframe`),[w,ae]=A(t,`helpers/gizmo`),[oe,T]=A(t,`helpers/outline`),[se]=zt(`showAudioView`),[ce,le]=(0,tu.useState)(50),ue=(0,tu.useRef)(null),[de,fe]=(0,tu.useState)(!1),pe=(0,tu.useRef)(null),me=(0,tu.useCallback)(e=>{pe.current&&!pe.current.contains(e.target)&&fe(!1)},[]);return(0,tu.useEffect)(()=>(de&&document.addEventListener(`pointerdown`,me),()=>{document.removeEventListener(`pointerdown`,me)}),[de,me]),(0,H.jsxs)(`div`,{className:V.screen,children:[(0,H.jsxs)(`div`,{className:V.header,children:[(0,H.jsx)(`div`,{className:V.header_tabs,children:(0,H.jsx)(`div`,{className:V.header_tab,"data-active":!!a,onClick:()=>o&&o(!a),title:`Camera Render`,children:(0,H.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 512 512`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,H.jsx)(`path`,{d:`M32 144 H336 V368 H32 Z M368 224 L480 152 V360 L368 288 Z`})})})}),(0,H.jsxs)(`div`,{className:V.header_right,children:[(0,H.jsx)(`div`,{className:V.header_item,children:(0,H.jsx)(E,{title:`View`,children:(0,H.jsx)(k,{value:s,format:{type:`select`,list:[`render`,`debug`]},onChange:e=>c&&c(e)})})}),(0,H.jsx)(`div`,{className:V.header_item,children:(0,H.jsx)(E,{title:`Res`,children:(0,H.jsx)(k,{value:l,format:{type:`select`,list:[,,,,,,].fill(0).map((e,t)=>{let n=2**t,r=1/n;return{value:r,label:r==1?`1`:`1/`+n}})},onChange:e=>u&&u(e)})})}),n.isPC&&(0,H.jsx)(`div`,{className:V.externalBtn,children:(0,H.jsx)(d,{onClick:()=>{t.openInExternalWindow()},children:(0,H.jsxs)(`svg`,{width:`32`,height:`12`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,H.jsxs)(`g`,{clipPath:`url(#clip0_224_2)`,children:[(0,H.jsx)(`path`,{d:`M96 0V416H512V0H96ZM472 376H136V40H472V376Z`,fill:`#aaa`}),(0,H.jsx)(`path`,{d:`M40 472V296V136V96H0V512H416V472H376H40Z`,fill:`#aaa`}),(0,H.jsx)(`path`,{d:`M232.812 312.829L350.671 194.969V279.766H390.671V126.688H237.594V166.688H322.39L204.531 284.547L232.812 312.829Z`,fill:`#aaa`})]}),(0,H.jsx)(`defs`,{children:(0,H.jsx)(`clipPath`,{id:`clip0_224_2`,children:(0,H.jsx)(`rect`,{width:`512`,height:`512`,fill:`white`})})})]})})})]})]}),(0,H.jsxs)(`div`,{className:V.content,children:[(0,H.jsxs)(`div`,{className:V.displayOptions,ref:pe,children:[(0,H.jsx)(`div`,{className:V.displayOptions_btn,"data-active":de,onClick:()=>fe(!de),title:`Display Options`,children:`⚙`}),de&&(0,H.jsxs)(`div`,{className:V.overlay,children:[(0,H.jsx)(`div`,{className:V.overlay_label,children:`Rendering`}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(E,{title:`Render`,children:(0,H.jsx)(k,{value:r,onChange:e=>i&&i(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_separator}),(0,H.jsx)(`div`,{className:V.overlay_label,children:`Helpers`}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(E,{title:`Show`,children:(0,H.jsx)(k,{value:_,onChange:e=>v&&v(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(E,{title:`Empty`,children:(0,H.jsx)(k,{value:y,onChange:e=>b&&b(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(E,{title:`Camera`,children:(0,H.jsx)(k,{value:x,onChange:e=>S&&S(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(E,{title:`Light`,children:(0,H.jsx)(k,{value:C,onChange:e=>ee&&ee(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_separator}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(E,{title:`Grid`,children:(0,H.jsx)(k,{value:te,onChange:e=>ne&&ne(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(E,{title:`Wireframe`,children:(0,H.jsx)(k,{value:re,onChange:e=>ie&&ie(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(E,{title:`Gizmo`,children:(0,H.jsx)(k,{value:w,onChange:e=>ae&&ae(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(E,{title:`Outline`,children:(0,H.jsx)(k,{value:oe,onChange:e=>T&&T(e)})})})]})]}),(0,H.jsxs)(`div`,{className:V.gizmoMode,children:[[`select`,`translate`,`rotate`,`scale`].map(e=>(0,H.jsx)(`div`,{className:V.gizmoMode_btn,"data-active":f===e,onClick:()=>p&&p(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`select`?`↖`:e===`translate`?`T`:e===`rotate`?`R`:`S`},e)),(0,H.jsx)(`div`,{className:V.gizmoMode_separator}),[`global`,`local`].map(e=>(0,H.jsx)(`div`,{className:V.gizmoMode_btn,"data-active":m===e,onClick:()=>h&&h(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`global`?`G`:`L`},e))]}),g&&(0,H.jsx)(`div`,{className:V.modalStatus,children:g}),(0,H.jsx)(`div`,{className:V.canvas,children:(0,H.jsx)(hl,{viewportId:e})}),n.isSP&&(0,H.jsx)(jl,{}),n.isPC&&se&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{className:V.audioViewHandle,onPointerDown:e=>{e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),ue.current={startY:e.clientY,startHeight:ce}},onPointerMove:e=>{if(!ue.current)return;let t=ue.current.startY-e.clientY,n=Math.max(20,Math.min(400,ue.current.startHeight+t));le(n)},onPointerUp:()=>{ue.current=null}}),(0,H.jsx)(`div`,{className:V.audioView,style:{height:ce},children:(0,H.jsx)(wl,{})})]})]})]})},ru.__docgenInfo={description:``,methods:[],displayName:`Screen`}})))()}function au(e,t){let n=e.get(t);if(n)return n;let r=t.indexOf(`:`);if(r===-1)return;let i=e.get(t.slice(0,r));return i?.multiple?i:void 0}function ou(e){return e.slice(e.indexOf(`:`)+1)}function su(e){return e.multiple?`${e.id}:${crypto.randomUUID()}`:e.id}function cu(e,t){return e.multiple?e.content(ou(t)):e.content}function lu(e={}){let t=yu([`viewport:main`]),n=e.mainBottom,r=n?vu(`vertical`,[{ratio:712/912,node:t},{ratio:200/912,node:yu(n.tabs,n.active)}]):t;return vu(`vertical`,[{ratio:916/1076,node:vu(`horizontal`,[{ratio:300/1912,node:vu(`vertical`,[{ratio:696/912,node:bu([`hierarchy`,`scene`],e.leftTop)},{ratio:216/912,node:bu([`timer`],e.leftBottom)}])},{ratio:1312/1912,node:r},{ratio:300/1912,node:bu([`property`,`textures`,`renderer`,`editor-settings`],e.rightTop)}])},{ratio:160/1076,node:bu([`timeline`,`export`],e.footer)}])}function uu(e){return e.type===`pane`?[e]:e.children.flatMap(e=>uu(e.node))}function du(e,t){let n=new Set,r=new Set,i=e=>{let t=typeof e==`string`&&e!==``&&!n.has(e)?e:crypto.randomUUID();return n.add(t),t},a=e=>{if(typeof e!=`object`||!e)return null;let n=e;if(n.type===`pane`){if(!Array.isArray(n.tabs))return null;let e=[...new Set(n.tabs.filter(e=>typeof e==`string`))].filter(e=>{let n=t(e);return n?!n.multiple||!r.has(e)&&(r.add(e),!0):!1});if(e.length===0)return null;let a=typeof n.active==`string`&&e.includes(n.active)?n.active:e[0];return{type:`pane`,id:i(n.id),tabs:e,active:a}}if(n.type===`split`){if(n.direction!==`horizontal`&&n.direction!==`vertical`||!Array.isArray(n.children))return null;let e=[];return n.children.forEach(t=>{if(typeof t!=`object`||!t)return;let n=t,r=a(n.node);if(!r)return;let i=typeof n.ratio==`number`&&isFinite(n.ratio)&&n.ratio>0?n.ratio:1;e.push({ratio:i,node:r})}),e.length===0?null:e.length===1?e[0].node:{type:`split`,id:i(n.id),direction:n.direction,children:e}}return null},o=a(e);return o?xu(o):null}function fu(e,t,n){return Su(e,t,e=>e.type!==`pane`||!e.tabs.includes(n)?e:{...e,active:n})}function pu(e,t,n,r){return Su(e,t,e=>{if(e.type!==`pane`||e.tabs.includes(n))return e;let t=[...e.tabs];return t.splice(Math.max(0,Math.min(r??t.length,t.length)),0,n),{...e,tabs:t,active:n}})}function mu(e,t,n,r,i){if(t===r)return Su(e,t,e=>{if(e.type!==`pane`)return e;let t=e.tabs.indexOf(n);if(t===-1)return e;let r=e.tabs.filter(e=>e!==n),a=i??e.tabs.length,o=Math.max(0,Math.min(t<a?a-1:a,r.length));return o===t?e:(r.splice(o,0,n),{...e,tabs:r,active:n})});let a=uu(e),o=a.find(e=>e.id===t),s=a.find(e=>e.id===r);return!o||!s||!o.tabs.includes(n)||s.tabs.includes(n)?e:pu(gu(e,t,n),r,n,i)}function hu(e,t,n,r,i){let a=uu(e),o=a.find(e=>e.id===r);if(!o||!o.tabs.includes(i)||!a.some(e=>e.id===t)||r===t&&o.tabs.length===1)return e;let s=gu(e,r,i),c={type:`pane`,id:crypto.randomUUID(),tabs:[i],active:i},l=Su(s,t,e=>{let t=[{ratio:.5,node:c},{ratio:.5,node:e}];return(n===`right`||n===`bottom`)&&t.reverse(),{type:`split`,id:crypto.randomUUID(),direction:n===`left`||n===`right`?`horizontal`:`vertical`,children:t}});return l===s?e:xu(l)??e}function gu(e,t,n){let r=Su(e,t,e=>{if(e.type!==`pane`||!e.tabs.includes(n))return e;let t=e.tabs.indexOf(n),r=e.tabs.filter(e=>e!==n),i=e.active!==n||r.length===0?e.active:r[Math.min(t,r.length-1)];return{...e,tabs:r,active:i}});return r===e?e:xu(r)??e}function _u(e,t,n){return Su(e,t,e=>e.type!==`split`||e.children.length!==n.length?e:{...e,children:e.children.map((e,t)=>({...e,ratio:n[t]}))})}var vu,yu,bu,xu,Su;function Cu(){return(Cu=t((()=>{vu=(e,t)=>({type:`split`,id:crypto.randomUUID(),direction:e,children:t}),yu=(e,t)=>({type:`pane`,id:crypto.randomUUID(),tabs:e,active:t??e[0]}),bu=(e,t)=>yu([...e,...t?.tabs??[]],t?.active),xu=e=>{if(e.type===`pane`)return e.tabs.length>0?e:null;let t=[];if(e.children.forEach(n=>{let r=xu(n.node);r&&(r.type===`split`&&r.direction===e.direction?r.children.forEach(e=>t.push({ratio:n.ratio*e.ratio,node:e.node})):t.push(r===n.node?n:{...n,node:r}))}),t.length===0)return null;if(t.length===1)return t[0].node;let n=t.reduce((e,t)=>e+t.ratio,0);return Math.abs(n-1)>1e-6?{...e,children:t.map(e=>({...e,ratio:e.ratio/n}))}:t.length!==e.children.length||t.some((t,n)=>t!==e.children[n])?{...e,children:t}:e},Su=(e,t,n)=>{if(e.id===t)return n(e);if(e.type===`split`){let r=!1,i=e.children.map(e=>{let i=Su(e.node,t,n);return i===e.node?e:(r=!0,{...e,node:i})});if(r)return{...e,children:i}}return e}})))()}function wu(e,t,n){let[r,i]=(0,Tu.useState)(null),a=(0,Tu.useRef)(e);a.current=e;let o=(0,Tu.useRef)(t);o.current=t;let s=(0,Tu.useRef)(null);return(0,Tu.useEffect)(()=>()=>s.current?.(),[]),{dragState:r,onTabPointerDown:(e,t,r)=>{if(r.button!==0||s.current)return;let c=r.clientX,l=r.clientY,u=!1,d=null,f=r=>{if(r.buttons===0){p(!1);return}if(!u){if(Math.hypot(r.clientX-c,r.clientY-l)<Eu)return;u=!0,i({panelId:t,title:n(t)?.title??t,startX:r.clientX,startY:r.clientY,target:null})}let o=Au(r.clientX,r.clientY,a.current,e,t);ju(o,d)||(d=o,i(e=>e&&{...e,target:o}))},p=n=>{if(g(),n&&u&&d){let n=a.current;d.kind===`tabs`?o.current(mu(n,e,t,d.paneId,d.index)):d.zone===`center`?o.current(mu(n,e,t,d.paneId)):o.current(hu(n,d.paneId,d.zone,e,t))}u&&i(null)},m=()=>p(!0),h=()=>p(!1),g=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),s.current=null};s.current=g,window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h)}}}var Tu,Eu,Du,Ou,ku,Au,ju;function Mu(){return(Mu=t((()=>{Tu=i(),Cu(),Eu=4,Du=.25,Ou=(e,t)=>{let n={left:e.left,top:e.top,width:e.width,height:e.height};return(t===`left`||t===`right`)&&(n.width/=2),t===`right`&&(n.left+=n.width),(t===`top`||t===`bottom`)&&(n.height/=2),t===`bottom`&&(n.top+=n.height),n},ku=(e,t,n,r,i)=>{if(n.id!==r&&n.tabs.includes(i))return null;let a=[...t.querySelectorAll(`[data-panel-tab-id]`)].filter(e=>e instanceof HTMLElement),o=a.length;for(let t=0;t<a.length;t++){let n=a[t].getBoundingClientRect();if(e<n.left+n.width/2){o=t;break}}let s=t.getBoundingClientRect(),c=o<a.length?a[o].getBoundingClientRect().left:a.length>0?a[a.length-1].getBoundingClientRect().right:s.left;return{kind:`tabs`,paneId:n.id,index:o,rect:{left:c-1,top:s.top,width:2,height:s.height}}},Au=(e,t,n,r,i)=>{let a=document.elementFromPoint(e,t);if(!a)return null;let o=a.closest(`[data-pane-id]`);if(!(o instanceof HTMLElement))return null;let s=uu(n).find(e=>e.id===o.dataset.paneId);if(!s)return null;let c=a.closest(`[data-panel-tab-header]`);if(c instanceof HTMLElement)return ku(e,c,s,r,i);let l=o.querySelector(`[data-panel-content]`);if(!(l instanceof HTMLElement))return null;let u=l.getBoundingClientRect();if(u.width<=0||u.height<=0)return null;let d=(e-u.left)/u.width,f=(t-u.top)/u.height;if(d<0||d>1||f<0||f>1)return null;if(Math.min(d,1-d)>Du&&Math.min(f,1-f)>Du)return s.id===r||s.tabs.includes(i)?null:{kind:`zone`,paneId:s.id,zone:`center`,rect:Ou(u,`center`)};if(s.id===r&&s.tabs.length===1)return null;let p=d-.5,m=f-.5,h=Math.abs(p)>=Math.abs(m)?p<0?`left`:`right`:m<0?`top`:`bottom`;return{kind:`zone`,paneId:s.id,zone:h,rect:Ou(u,h)}},ju=(e,t)=>e===null||t===null?e===t:e.paneId===t.paneId?e.kind===`tabs`&&t.kind===`tabs`?e.index===t.index:e.kind===`zone`&&t.kind===`zone`&&e.zone===t.zone:!1})))()}var Nu,Pu;function Fu(){return(Fu=t((()=>{Nu=`PanelLayout__pane___LnBhb`,Pu={pane:Nu}})))()}var Iu,Lu,Ru,zu,Bu;function Vu(){return(Vu=t((()=>{Iu=i(),w(),oe(),se(),O(),qs(),co(),iu(),En(),_e(),Mu(),Fu(),Cu(),Lu=s(),Ru=e=>{let t=[],n={};if(!e)return{definitions:t,slots:n};let r=new Set;return Object.keys(e).forEach(i=>{let a=e[i];if(!a||a.length===0)return;let o=[],s;a.forEach(e=>{let n=`custom/${i}/${e.title}`;for(let t=2;r.has(n);t++)n=`custom/${i}/${e.title}-${t}`;r.add(n),o.push(n),t.push({id:n,title:e.title,content:(0,Lu.jsx)(T,{children:e.content})}),e.default&&s===void 0&&(s=n)}),n[i]={tabs:o,active:s}}),{definitions:t,slots:n}},zu=e=>{let t=e.node;if(t.type===`split`)return(0,Lu.jsx)(ae,{direction:t.direction,ratios:t.children.map(e=>e.ratio),onRatiosChange:n=>e.onRatiosChange(t.id,n),children:t.children.map(t=>(0,Lu.jsx)(ae.Item,{children:(0,Lu.jsx)(zu,{...e,node:t.node})},t.node.id))});let n=t.tabs.flatMap(t=>{let n=e.resolve(t);return n?[{id:t,title:n.title,content:cu(n,t)}]:[]});if(n.length===0)return null;let r=e.hasAddable(t);return(0,Lu.jsx)(`div`,{className:Pu.pane,"data-pane-id":t.id,children:(0,Lu.jsx)(ce,{tabs:n,active:t.active,onSelect:n=>e.onSelectTab(t.id,n),onTabContextMenu:(n,r)=>e.onTabContextMenu(t.id,n,r),onTabPointerDown:(n,r)=>e.onTabPointerDown(t.id,n,r),onAddClick:r?()=>e.onAddTab(t.id):void 0})})},Bu=e=>{let{editor:t}=D(),{pushContent:n,closeAll:r}=so(),i=(0,Iu.useMemo)(()=>Ru(e.customTabs),[e.customTabs]),a=(0,Iu.useMemo)(()=>{let t=new Map;return[...e.panels,...i.definitions].forEach(e=>t.set(e.id,e)),t},[e.panels,i]),o=(0,Iu.useMemo)(()=>e=>au(a,e),[a]),[s,c]=A(t,`panelLayout`),l=(0,Iu.useMemo)(()=>du(s,o)??lu(i.slots),[s,o,i]);(0,Iu.useEffect)(()=>{let e=new Set(uu(l).flatMap(e=>e.tabs).filter(e=>o(e)?.id===nu).map(ou));t.pruneViewportSettings(e)},[l,o,t]);let u=e=>{e!==l&&c(e)},d=(e,t)=>u(fu(l,e,t)),f=(e,t)=>u(_u(l,e,t)),{dragState:p,onTabPointerDown:m}=wu(l,u,o),h=e=>[...a.values()].filter(t=>t.multiple||!e.tabs.includes(t.id));return(0,Lu.jsxs)(Lu.Fragment,{children:[(0,Lu.jsx)(zu,{node:l,resolve:o,onSelectTab:d,onRatiosChange:f,onTabContextMenu:(e,t,i)=>{i.preventDefault(),uu(l).reduce((e,t)=>e+t.tabs.length,0)>1&&n((0,Lu.jsx)(Ks,{label:o(t)?.title,list:[{label:`Close Tab`,onClick:()=>{u(gu(l,e,t)),r()}}]}))},onTabPointerDown:m,onAddTab:e=>{let t=uu(l).find(t=>t.id===e);if(!t)return;let i=h(t);i.length!==0&&n((0,Lu.jsx)(Ks,{list:i.map(t=>({label:t.title,onClick:()=>{u(pu(l,e,su(t))),r()}}))}))},hasAddable:e=>h(e).length>0}),p&&(0,Lu.jsx)(ve,{drag:p})]})},Bu.__docgenInfo={description:``,methods:[],displayName:`PanelLayout`,props:{panels:{required:!0,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
} & (
