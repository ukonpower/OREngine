...
}`})))()}var oa;function sa(){return(sa=t((()=>{j(),L(),Qn(),Ui(),Gi(),qi(),Yi(),Zi(),$i(),ta(),ra(),aa(),oa=class{dofCoc;dofBokeh;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;constructor(e,t){let n=new I(e,{name:`collection`,frag:Hi}),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),i=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),a=new I(e,{name:`ssr`,frag:ti(`ssr`,ia),renderTarget:r,uniforms:si.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`},uSSRBackBuffer:{value:i.textures[0],type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=new I(e,{name:`ssComposite`,frag:ti(`ssComposite`,na),uniforms:si.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSSRTexture:{value:i.textures[0],type:`1i`}})}),s=new k(10,.05,20,.05),c=new I(e,{name:`dof/coc`,frag:Ki,uniforms:si.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR,internalFormat:M.RGBA16F,type:M.HALF_FLOAT,format:M.RGBA})]),passThrough:!0,resolutionRatio:.5}),l=new I(e,{name:`dof/bokeh`,frag:Wi,uniforms:si.merge({uCocTex:{value:c.renderTarget.textures[0],type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),passThrough:!0,resolutionRatio:.5}),u=new I(e,{name:`dof/composite`,frag:Ji,uniforms:si.merge({uBokeTex:{value:l.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR,internalFormat:M.RGBA16F,type:M.HALF_FLOAT,format:M.RGBA})])}),d=new I(e,{name:`motionBlurTile`,frag:ea,uniforms:si.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),f=new I(e,{name:`motionBlurNeighbor`,frag:Qi,uniforms:si.merge({uVelTex:{value:d.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]),resolutionRatio:1/16,passThrough:!0}),p=new I(e,{name:`motionBlur`,frag:Xi,uniforms:si.merge({uVelNeighborTex:{value:f.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16}});this.postprocess=new gi({passes:[n,a,o,c,l,u,d,f,p]}),this._ssr=a,this._ssComposite=o,this.dofCoc=c,this.dofBokeh=l,this.dofComposite=u,this._motionBlur=p,this._motionBlurTile=d,this._motionBlurNeighbor=f,this._dofParams=s,this.rtSSR1=r,this.rtSSR2=i,n.backBufferOverride=t.shadingBuffer.textures,a.uniforms.uGbufferPos.value=t.gBuffer.textures[0],a.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],a.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],o.uniforms.uGbufferPos.value=t.gBuffer.textures[0],o.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],c.uniforms.uGbufferPos.value=t.gBuffer.textures[0],d.uniforms.uVelTex.value=t.gBuffer.textures[4],p.uniforms.uVelTex.value=t.gBuffer.textures[4],p.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}update(e){let t=e.fov,n=e.dofParams.focusDistance,r=e.dofParams.kFilmHeight,i=r/Math.tan(.5*(t/180*Math.PI)),a=1/this.dofBokeh.renderTarget.size.y*5,o=1/a,s=i*i/(e.dofParams.fNumber*(n-i)*r*2);this._dofParams.set(n,a,o,s);let c=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=c,this._ssr.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssr.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}dispose(){this.postprocess.dispose(),this.rtSSR1.dispose(),this.rtSSR2.dispose()}}})))()}var ca,la;function ua(){return(ua=t((()=>{Qn(),Vi(),sa(),ca=e=>{let t=e.createFrameBuffer();t.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA,magFilter:M.NEAREST,minFilter:M.NEAREST}),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA}),e.createTexture(),e.createTexture(),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]);let n=e.createFrameBuffer({disableDepthBuffer:!0});n.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA}),e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA})]);let r=e.createFrameBuffer({disableDepthBuffer:!0});r.setDepthTexture(t.depthTexture),r.setTexture([n.textures[0],t.textures[0],t.textures[4]]);let i=e.createFrameBuffer({disableDepthBuffer:!0});i.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA,magFilter:M.LINEAR,minFilter:M.LINEAR})]);let a=e.createFrameBuffer({disableDepthBuffer:!0});a.setDepthTexture(t.depthTexture),a.setTexture([e.createTexture()]);let o=e.createFrameBuffer();return o.setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA,magFilter:M.NEAREST,minFilter:M.NEAREST})]),{gBuffer:t,shadingBuffer:n,forwardBuffer:r,refractionBuffer:i,uiBuffer:a,normalBuffer:o}},la=class{camera;offscreen;renderTarget;deferredRenderer;pipelinePostProcess;_pipelineOverride;_sceneConfig;_onDispose;constructor(e){this.camera=null,this.offscreen=e.offscreen,this._pipelineOverride=null,this._sceneConfig=e.sceneConfig,this._onDispose=e.onDispose,this.renderTarget=ca(e.backend),this.deferredRenderer=new Bi({backend:e.backend,envMap:e.envMap,envMapCube:e.envMapCube,renderTarget:this.renderTarget}),this.pipelinePostProcess=new oa(e.backend,this.renderTarget),e.resolution.x>0&&e.resolution.y>0&&this.resize(e.resolution),this.applyPipelineConfig()}get pipelineOverride(){return this._pipelineOverride}set pipelineOverride(e){this._pipelineOverride=e,this.applyPipelineConfig()}applyPipelineConfig(){let e={...this._sceneConfig,...this._pipelineOverride};this.deferredRenderer.setPassEnabled({ssao:e.ssao,lightShaft:e.lightShaft}),this.pipelinePostProcess.setPassEnabled({motionBlur:e.motionBlur,ssr:e.ssr,dof:e.dof}),this.pipelinePostProcess.setMotionBlurPower(e.motionBlurPower??1)}resize(e){let t=this.renderTarget;t.gBuffer.setSize(e),t.shadingBuffer.setSize(e),t.forwardBuffer.setSize(e),t.refractionBuffer.setSize(e),t.uiBuffer.setSize(e),t.normalBuffer.setSize(e),this.deferredRenderer.resize(e),this.pipelinePostProcess.resize(e)}dispose(){this._onDispose(this);let e=this.renderTarget;e.forwardBuffer.dispose();let t=[e.gBuffer,e.shadingBuffer,e.refractionBuffer,e.uiBuffer,e.normalBuffer];for(let e=0;e<t.length;e++){let n=t[e];for(let e=0;e<n.textures.length;e++)n.textures[e].dispose();n.dispose()}e.gBuffer.depthTexture&&e.gBuffer.depthTexture.dispose(),this.deferredRenderer.dispose(),this.pipelinePostProcess.dispose()}}})))()}var da;function fa(){return(fa=t((()=>{da=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	default?: boolean;
}`,signature:{properties:[{key:`title`,value:{name:`string`,required:!0}},{key:`content`,value:{name:`ReactReactNode`,raw:`React.ReactNode`,required:!0}},{key:`default`,value:{name:`boolean`,required:!1}}]}}],raw:`CustomTab[]`}],raw:`Record<PanelSlot, CustomTab[]>`}],raw:`Partial<Record<PanelSlot, CustomTab[]>>`},description:``}}}})))()}function Mu(){return(Mu=t((()=>{te(),re(),Je(),pe(),tt()})))()}var Nu,Pu,Fu,Iu,Lu,Ru,zu;function Bu(){return(Bu=t((()=>{Nu=`ProjectControl__project___LnByb`,Pu=`ProjectControl__project_inner___LnByb`,Fu=`ProjectControl__scene___LnByb`,Iu=`ProjectControl__sceneSelect___LnByb`,Lu=`ProjectControl__row___LnByb`,Ru=`ProjectControl__rowItem___LnByb`,zu={project:Nu,project_inner:Pu,scene:Fu,sceneSelect:Iu,row:Lu,rowItem:Ru,export:`ProjectControl__export___LnByb`}})))()}var Vu,Hu,Uu,Wu,Gu;function Ku(){return(Ku=t((()=>{Vu=i(),c(),u(),a(),Mu(),E(),Bu(),Hu=s(),Uu=new URLSearchParams(location.search).get(`project`)||`default`,Wu=/^[A-Za-z0-9_-]+$/,Gu=()=>{let{editor:e,scenes:t}=T(),[n,r]=(0,Vu.useState)(null);if((0,Vu.useEffect)(()=>{if(!e)return;let t=()=>{r(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),!e)return null;let i=e.isExporting,a=()=>{if(!t)return;let e=window.prompt(`New scene name`);if(e){if(!Wu.test(e)){window.alert(`Scene name must be alphanumeric, "-" or "_"`);return}if(t.names.includes(e)){window.alert(`Scene "${e}" already exists`);return}t.onCreate(e)}},s=null;return t&&(s=(0,Hu.jsxs)(`div`,{className:zu.scene,children:[(0,Hu.jsx)(`div`,{className:zu.sceneSelect,children:(0,Hu.jsx)(he,{value:t.current??``,selectList:t.names,onChange:e=>{t.onSelect(e)}})}),(0,Hu.jsx)(d,{onClick:a,children:`New`})]})),(0,Hu.jsx)(`div`,{className:zu.project,children:(0,Hu.jsx)(`div`,{className:zu.project_inner,children:(0,Hu.jsxs)(l,{label:Uu,accordion:!0,children:[s,(0,Hu.jsx)(d,{onClick:()=>{e&&e.save()},children:`Save`}),(0,Hu.jsx)(d,{onClick:()=>{window.location.href=`/`},children:`Projects`}),(0,Hu.jsxs)(`div`,{className:zu.export,children:[(0,Hu.jsxs)(d,{onClick:()=>{e&&(e.save(),window.open(`/player`,`_blank`))},children:[`Play `,(0,Hu.jsx)(o,{})]}),(0,Hu.jsx)(d,{onClick:()=>{e&&!i&&e.exportMP4()},children:n?`Exporting... ${Math.floor(n.current/n.total*100)}%`:`Export MP4`})]})]})})})},Gu.__docgenInfo={description:``,methods:[],displayName:`ProjectControl`}})))()}var qu,Ju,Yu;function Xu(){return(Xu=t((()=>{qu=`RendererSettings__renderer___LnJlb`,Ju=`RendererSettings__renderer_inner___LnJlb`,Yu={renderer:qu,renderer_inner:Ju}})))()}var Zu,Qu;function $u(){return($u=t((()=>{c(),E(),Tn(),Xu(),Zu=s(),Qu=()=>{let{editor:e}=T(),t=e.engine.renderer;return(0,Zu.jsx)(`div`,{className:Yu.renderer,children:(0,Zu.jsxs)(`div`,{className:Yu.renderer_inner,children:[(0,Zu.jsx)(l,{label:`Resolution`,accordion:!0,children:(0,Zu.jsx)(wn,{target:e,filter:`resolution`})}),(0,Zu.jsx)(l,{label:`Pipeline`,accordion:!0,children:(0,Zu.jsx)(wn,{target:t,filter:`pipeline`})}),(0,Zu.jsx)(l,{label:`Sky`,accordion:!0,children:(0,Zu.jsx)(wn,{target:t,filter:`sky`})})]})})},Qu.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var ed,td,nd,rd,id,ad,od;function sd(){return(sd=t((()=>{ed=`Textures__textures___LnRle`,td=`Textures__item___LnRle`,nd=`Textures__preview___LnRle`,rd=`Textures__img___LnRle`,id=`Textures__placeholder___LnRle`,ad=`Textures__name___LnRle`,od={textures:ed,item:td,preview:nd,img:rd,placeholder:id,name:ad}})))()}var cd,ld,ud;function dd(){return(dd=t((()=>{cd=i(),eo(),E(),sd(),ld=s(),ud=()=>{let{engine:e,editor:t}=T(),[,n]=(0,cd.useState)(0);(0,cd.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return qa.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{qa.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=qa.resources.textureList;return(0,ld.jsx)(`div`,{className:od.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,ld.jsxs)(`div`,{className:od.item,children:[(0,ld.jsx)(`div`,{className:od.preview,children:n?(0,ld.jsx)(`img`,{src:n,className:od.img}):(0,ld.jsx)(`div`,{className:od.placeholder})}),(0,ld.jsx)(`div`,{className:od.name,children:e.name})]},e.name)})})},ud.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var fd,pd;function md(){return(md=t((()=>{fd=i(),pd=(0,fd.createContext)(null)})))()}var hd,gd;function _d(){return(_d=t((()=>{hd=i(),md(),gd=()=>{let e=(0,hd.useContext)(pd);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var vd;function yd(){return(yd=t((()=>{vd=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
