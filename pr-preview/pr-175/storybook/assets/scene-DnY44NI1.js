...
\r
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}var jl,Ml,Nl;function Pl(){return(Pl=t((()=>{jl=`RendererSettings__renderer___LnJlb`,Ml=`RendererSettings__renderer_inner___LnJlb`,Nl={renderer:jl,renderer_inner:Ml}})))()}var Fl,Il;function Ll(){return(Ll=t((()=>{w(),I(),so(),Pl(),Fl=o(),Il=()=>{let{editor:e}=F(),t=e.engine.renderer;return(0,Fl.jsx)(`div`,{className:Nl.renderer,children:(0,Fl.jsxs)(`div`,{className:Nl.renderer_inner,children:[(0,Fl.jsx)(s,{label:`Resolution`,accordion:!0,children:(0,Fl.jsx)(oo,{target:e,filter:`resolution`})}),(0,Fl.jsx)(s,{label:`Pipeline`,accordion:!0,children:(0,Fl.jsx)(oo,{target:t,filter:`pipeline`})}),(0,Fl.jsx)(s,{label:`Sky`,accordion:!0,children:(0,Fl.jsx)(oo,{target:t,filter:`sky`})})]})})},Il.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var Rl,zl,Bl,Vl,Hl,Ul;function Wl(){return(Wl=t((()=>{Rl=`SceneControl__sceneControl___LnNjZ`,zl=`SceneControl__sceneControl_inner___LnNjZ`,Bl=`SceneControl__select___LnNjZ`,Vl=`SceneControl__select_name___LnNjZ`,Hl=`SceneControl__save___LnNjZ`,Ul={sceneControl:Rl,sceneControl_inner:zl,select:Bl,select_name:Vl,save:Hl}})))()}var Gl,Kl,ql;function Jl(){return(Jl=t((()=>{Gl=i(),w(),I(),pe(),Wl(),Kl=o(),ql=()=>{let{editor:e,projectName:t,scenes:n}=F(),[r,i]=(0,Gl.useState)(null),o=null;return n&&(o=(0,Kl.jsx)(ae,{title:`scene`,children:(0,Kl.jsxs)(`button`,{className:Ul.select,onClick:e=>{i(ie(e.clientX,e.clientY))},children:[(0,Kl.jsx)(`span`,{className:Ul.select_name,children:n.current??`-`}),(0,Kl.jsx)(a,{open:!0})]})})),(0,Kl.jsxs)(`div`,{className:Ul.sceneControl,children:[(0,Kl.jsx)(`div`,{className:Ul.sceneControl_inner,children:(0,Kl.jsxs)(s,{label:t,accordion:!0,children:[o,(0,Kl.jsx)(`div`,{className:Ul.save,children:(0,Kl.jsx)(c,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,Kl.jsx)(me,{scenes:n,projectName:t,anchor:r,onClose:()=>{i(null)}})]})},ql.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var Yl,Xl,Zl,Ql,$l,eu,tu;function nu(){return(nu=t((()=>{Yl=`Textures__textures___LnRle`,Xl=`Textures__item___LnRle`,Zl=`Textures__preview___LnRle`,Ql=`Textures__img___LnRle`,$l=`Textures__placeholder___LnRle`,eu=`Textures__name___LnRle`,tu={textures:Yl,item:Xl,preview:Zl,img:Ql,placeholder:$l,name:eu}})))()}var ru,iu,au;function ou(){return(ou=t((()=>{ru=i(),Ti(),I(),nu(),iu=o(),au=()=>{let{engine:e,editor:t}=F(),[,n]=(0,ru.useState)(0);(0,ru.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return P.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{P.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=P.resources.textureList;return(0,iu.jsx)(`div`,{className:tu.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,iu.jsxs)(`div`,{className:tu.item,children:[(0,iu.jsx)(`div`,{className:tu.preview,children:n?(0,iu.jsx)(`img`,{src:n,className:tu.img}):(0,iu.jsx)(`div`,{className:tu.placeholder})}),(0,iu.jsx)(`div`,{className:tu.name,children:e.name})]},e.name)})})},au.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var su,cu;function lu(){return(lu=t((()=>{su=i(),cu=(0,su.createContext)(null)})))()}var uu,du;function fu(){return(fu=t((()=>{uu=i(),lu(),du=()=>{let e=(0,uu.useContext)(cu);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var pu;function mu(){return(mu=t((()=>{pu=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}var gS,_S;function vS(){return(vS=t((()=>{gS=e(i(),1),Yp(),yi(),_S=()=>{let[e,t]=gS.useState(()=>new P(qp)),n=gS.useRef(e);return n.current=e,(0,gS.useEffect)(()=>{n.current.disposed&&t(new P(qp))},[]),(0,gS.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,gS.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var yS,bS,xS;function SS(){return(SS=t((()=>{yS=i(),Yo(),vS(),bS=o(),xS=e=>{let t=_S(),{engine:n}=t,r=(0,yS.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,yS.useEffect)(()=>{r.current?.(n)},[n]),(0,yS.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,bS.jsx)(Jo.Provider,{value:t,children:e.children})},xS.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var CS,wS,TS,ES,DS,OS,kS;function AS(){return(AS=t((()=>{CS=i(),hS(),SS(),wS=o(),TS=`scene`,ES=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},DS=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),OS=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),kS=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,CS.useState)(e.sceneData),[a,o]=(0,CS.useState)(e.editorData),[s,c]=(0,CS.useState)([]),[l,u]=(0,CS.useState)(null),d=(0,CS.useCallback)(async e=>{let t=await ES(`${n}/scenes/${e}`);if(!t)throw Error(`シーンを読み込めません: ${e}`);u(e),i(t)},[n]);(0,CS.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([ES(`${n}/editor`),ES(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[TS]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]),(0,CS.useEffect)(()=>{l&&(document.title=`${l} | OREngine`)},[l]);let f={names:s,current:l,onSelect:d,onCreate:(0,CS.useCallback)(async(e,t)=>{let r=OS(e);if(t!==void 0){let i=await ES(`${n}/scenes/${t}`);if(!i)throw Error(`複製元のシーンを読み込めません: ${t}`);r={...i,name:e}}let i=await DS(`${n}/scenes/${e}`,r);if(!i.ok)throw Error(`シーンを作成できません: ${e}（HTTP ${i.status}）`);let a=await ES(`${n}/scenes`);a&&c(a)},[n]),onDelete:(0,CS.useCallback)(async e=>{let t=await fetch(`${n}/scenes/${e}`,{method:`DELETE`});if(!t.ok)throw Error(`シーンを削除できません: ${e}（HTTP ${t.status}）`);let r=await ES(`${n}/scenes`)??[];c(r),e===l&&r.length>0&&await d(r[0])},[n,l,d])};return(0,wS.jsx)(xS,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,wS.jsx)(mS,{editorData:a,projectName:t,panels:e.panels,fieldUIs:e.fieldUIs,scenes:f,onSave:async(t,r)=>{e.onBeforeSave?.();let i=[DS(`${n}/editor`,{...r,[TS]:l})];l&&i.push(DS(`${n}/scenes/${l}`,t));for(let e of await Promise.all(i))if(!e.ok)throw Error(`保存に失敗しました（POST ${new URL(e.url).pathname}: HTTP ${e.status}）`)}})})},kS.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var jS,MS;function NS(){return(NS=t((()=>{hS(),SS(),jS=o(),MS=e=>(0,jS.jsx)(xS,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,jS.jsx)(mS,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,fieldUIs:e.fieldUIs,onSave:()=>{}})}),MS.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}function PS(){return(PS=t((()=>{i(),I()})))()}var FS,IS,LS;function RS(){return(RS=t((()=>{FS=`InputGroup__group___Lmdyb`,IS=`InputGroup__submit___Lmdyb`,LS={group:FS,submit:IS}})))()}var zS,BS,VS;function HS(){return(HS=t((()=>{zS=i(),w(),Yi(),RS(),BS=o(),VS=e=>{let t=e.initialValues,n=[],[r,i]=(0,zS.useState)(t);(0,zS.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,BS.jsx)(Ji,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,zS.useRef)(null);return(0,zS.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,BS.jsx)(`div`,{className:LS.group,ref:o,children:(0,BS.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,BS.jsx)(s,{label:e.title,noMargin:!0,children:n}),(0,BS.jsx)(`div`,{className:LS.submit,children:(0,BS.jsx)(c,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},VS.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}function US(){return(US=t((()=>{AS(),NS(),hS(),uS(),I(),PS(),SS(),Qo(),$s(),Ro(),Jc(),hc(),Sc(),Nd(),fu(),Jl(),Ko(),Es(),Ll(),da(),ia(),ou(),so(),oc(),Yi(),Ua(),HS(),Ni(),Li(),Ki(),co(),Da(),La(),we()})))()}var WS;function GS(){return(GS=t((()=>{WS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var JS=n({EyeRings:()=>YS}),YS;function XS(){return(XS=t((()=>{N(),GS(),qS(),YS=class extends k{constructor(e){super(e);let t=new $t({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new hn({phase:[`deferred`,`shadowMap`],frag:WS,vert:KS});this.entity.addComponent(A,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var ZS;function QS(){return(QS=t((()=>{ZS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var tC=n({FlashLine:()=>nC}),nC;function rC(){return(rC=t((()=>{D(),N(),QS(),eC(),nC=class extends k{geometry;material;constructor(e){super(e),this.geometry=new jt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=je.randomVector().multiply(new T(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new hn({phase:[`forward`,`envMap`],frag:j(`flFrag`,ZS),vert:j(`flVert`,$S)}),this.entity.addComponent(A,{material:this.material,geometry:this.geometry})}}})))()}var iC;function aC(){return(aC=t((()=>{iC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var oC=n({SkyBox:()=>sC}),sC;function cC(){return(cC=t((()=>{N(),aC(),sC=class extends k{material;constructor(e){super(e);let t=this.engine;this.material=new hn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:j(`SkyBoxFrag`,iC),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}}})))()}var lC;function uC(){return(uC=t((()=>{lC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var pC=n({GridCross:()=>mC}),mC;function hC(){return(hC=t((()=>{D(),N(),uC(),fC(),mC=class extends k{constructor(e){super(e);let t=new kt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new T(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new hn({frag:j(`gridCrossFrag`,lC),vert:j(`gridCrossVert`,dC),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var gC;function _C(){return(_C=t((()=>{gC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var bC=n({GridDots:()=>xC}),xC;function SC(){return(SC=t((()=>{D(),N(),_C(),yC(),xC=class extends k{constructor(e){super(e);let t=new Ft({radius:.1}),n=[],r=[],i=new T(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new hn({frag:j(`gridDotsFrag`,gC),vert:j(`gridDotsVert`,vC),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var CC;function wC(){return(wC=t((()=>{CC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var DC=n({WireCube:()=>OC}),OC;function kC(){return(kC=t((()=>{N(),wC(),EC(),OC=class extends k{constructor(e){super(e);let t=3.3,n=t/2,r=new kt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new hn({phase:[`deferred`],frag:CC,vert:TC});this.entity.addComponent(A,{geometry:r,material:o})}}})))()}var AC=n({FieldUISample:()=>jC}),jC;function MC(){return(MC=t((()=>{D(),N(),jC=class extends k{speed;wave;rotQuaternion;constructor(e){super(e),this.speed=1,this.wave=.5,this.rotQuaternion=new ke,this.field(`speed`,()=>this.speed,e=>this.speed=e,{step:.1}),this.field(`wave`,()=>this.wave,e=>this.wave=e,{step:.05,min:0})}updateImpl(e){this.rotQuaternion.setFromEuler(new De(0,e.timeDelta*this.speed,0)),this.entity.quaternion.multiply(this.rotQuaternion),this.entity.position.y=Math.sin(e.timeElapsed*2)*this.wave}}})))()}var NC;function PC(){return(PC=t((()=>{NC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var FC;function IC(){return(IC=t((()=>{FC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var LC=n({OREngineCube:()=>RC}),RC;function zC(){return(zC=t((()=>{N(),Ti(),PC(),IC(),RC=class extends k{material;constructor(e){super(e),this.material=new hn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:j(`OREngineCubeVert`,FC),frag:j(`OREngineCubeFrag`,NC),uniforms:{uNoiseTex:{value:P.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var BC;function VC(){return(VC=t((()=>{BC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var WC=n({OREngineLogo:()=>GC}),GC;function KC(){return(KC=t((()=>{N(),VC(),UC(),GC=class extends k{material;constructor(e){super(e),this.material=new hn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:j(`OREngineLogoVert`,HC),frag:j(`OREngineLogoFrag`,BC)});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var qC;function JC(){return(JC=t((()=>{qC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ZC=n({Dust:()=>QC}),QC;function $C(){return($C=t((()=>{D(),N(),JC(),XC(),QC=class extends k{constructor(e){super(e);let t=new Dt,n=e.args?.num||2048,r=new T(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new hn({phase:[`forward`],drawType:`POINTS`,frag:qC,vert:YC});this.entity.addComponent(A,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var ew;function tw(){return(tw=t((()=>{ew=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var nw;function rw(){return(rw=t((()=>{nw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `})))()}var ow=n({YakiSoba:()=>sw}),sw;function cw(){return(cw=t((()=>{D(),N(),tw(),rw(),aw(),sw=class extends k{_gpu;constructor(e){super(e);let t=this.engine,n=new T(64,512);this._gpu=new ri({passes:[new oi(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:j(`yakiSobaCompute`,iw),uniforms:cn.merge({},t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new kt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new hn({frag:j(`chainFrag`,ew),vert:j(`chainVert`,nw),phase:[`deferred`,`shadowMap`],uniforms:cn.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(A,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(A),this._gpu.dispose()}}})))()}var lw;function uw(){return(uw=t((()=>{lw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var Uw;function Ww(){return(Ww=t((()=>{Hw(),Uw={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:Vw}})))()}var Gw;function Kw(){return(Kw=t((()=>{Gw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var qw;function Jw(){return(Jw=t((()=>{Kw(),qw={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:Gw}})))()}var Yw;function Xw(){return(Xw=t((()=>{Yw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var Zw;function Qw(){return(Qw=t((()=>{Xw(),Zw={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:Yw}})))()}var $w;function eT(){return(eT=t((()=>{Xw(),$w={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:Yw}})))()}var tT,nT,rT;function iT(){return(iT=t((()=>{Ww(),Jw(),Qw(),eT(),Ti(),tT=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":Uw,"/demo-webgl/Resources/Textures/noise.tex":qw,"/demo-webgl/Resources/Textures/noiseCyclic.tex":Zw,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":$w}),nT=()=>{for(let e of Object.values(tT))e&&P.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},rT=e=>{P.resources.buildTextureInstances(e.renderer)}})))()}var aT,oT,sT,cT,lT;function uT(){return(uT=t((()=>{XS(),rC(),cC(),hC(),SC(),kC(),MC(),zC(),KC(),$C(),cw(),pw(),Yp(),Ti(),Bw(),iT(),aT=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":JS,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":tC,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":oC,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":pC,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":bC,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":DC,"/demo-webgl/Resources/Components/Samples/Objects/FieldUISample/index.ts":AC,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":LC,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":WC,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":ZC,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":ow,"/demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":dw}),oT=Object.assign({}),sT=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);sT(a,e)}}},cT=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);cT(a,e)}}},lT=()=>{xt.gltfLoaderFactory=e=>new Vp(e),P.resources.clear();let e=P.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Vt),e.addComponent(`Camera`,Lt),e.addComponent(`Mesh`,A);let t=Object.keys(Rw);for(let e=0;e<t.length;e++){let n=t[e],r=Rw[n],i=P.resources.addComponentGroup(n);sT(r,i)}let n=Object.keys(zw);for(let e=0;e<n.length;e++){let t=n[e],r=zw[t],i=P.resources.addGeometryGroup(t);cT(r,i)}let r=mi(aT,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=P.resources.addComponentGroup(t);sT(n,a)}let a=mi(oT,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=P.resources.addGeometryGroup(t);cT(n,r)}nT()}})))()}var dT,fT,pT,mT,hT,gT;function _T(){return(_T=t((()=>{dT=i(),US(),w(),uT(),fT=o(),lT(),pT=({setup:e})=>{let{editor:t}=F();return(0,dT.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},mT=e=>(0,fT.jsx)(xS,{project:e.fixture.scene,onEngineInit:rT,children:(0,fT.jsx)(lS,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,fT.jsx)(x,{children:(0,fT.jsxs)(ne,{children:[e.children,e.fixture.setup&&(0,fT.jsx)(pT,{setup:e.fixture.setup}),(0,fT.jsx)(y,{}),(0,fT.jsx)(te,{})]})})})}),hT=e=>t=>(0,fT.jsx)(mT,{fixture:e,children:(0,fT.jsx)(t,{})}),gT=e=>t=>(0,fT.jsx)(xS,{project:e,onEngineInit:rT,children:(0,fT.jsx)(t,{})}),mT.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var vT,yT,bT,xT,ST;function CT(){return(CT=t((()=>{vT={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`LookAt`,uuid:`sb-camera-lookat`}]},yT={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[vT,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},bT={...yT,scene:{name:`root`,uuid:`0`,childs:[vT]}},xT={enableRender:!0,"viewports/main/resolutionScale":.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},ST={scene:yT,editorData:xT}})))()}export{ua as A,I as B,Ko as C,so as D,oo as E,Ki as F,Ti as H,Ii as I,Li as L,Ji as M,Yi as N,Ha as O,Gi as P,Mi as R,Go as S,Ro as T,P as U,F as V,yi as W,Jl as _,yT as a,Qs as b,hT as c,HS as d,mS as f,ql as g,Nd as h,ST as i,da as j,Ua as k,gT as l,Md as m,xT as n,mT as o,hS as p,bT as r,_T as s,CT as t,VS as u,Il as v,Lo as w,$s as x,Ll as y,Ni as z};