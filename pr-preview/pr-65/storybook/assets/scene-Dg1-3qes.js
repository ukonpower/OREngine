...
void main( void ) {
	...
	id: PanelId;
	title: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},scenes:{required:!1,tsType:{name:`SceneSelection`},description:``}}}})))()}var Sb,Cb;function wb(){return(wb=t((()=>{Sb=e(i(),1),Yd(),oa(),Cb=()=>{let[e,t]=Sb.useState(()=>new L(qd)),n=Sb.useRef(e);return n.current=e,(0,Sb.useEffect)(()=>{n.current.disposed&&t(new L(qd))},[]),(0,Sb.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,Sb.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var Tb,Eb,Db;function Ob(){return(Ob=t((()=>{Tb=i(),go(),wb(),Eb=o(),Db=e=>{let t=Cb(),{engine:n}=t,r=(0,Tb.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,Tb.useEffect)(()=>{r.current?.(n)},[n]),(0,Tb.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,Eb.jsx)(ho.Provider,{value:t,children:e.children})},Db.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var kb,Ab,jb,Mb,Nb,Pb,Fb;function Ib(){return(Ib=t((()=>{kb=i(),xb(),Ob(),Ab=o(),jb=`scene`,Mb=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},Nb=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),Pb=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),Fb=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,kb.useState)(e.sceneData),[a,o]=(0,kb.useState)(e.editorData),[s,c]=(0,kb.useState)([]),[l,u]=(0,kb.useState)(null),d=(0,kb.useCallback)(async e=>{let t=await Mb(`${n}/scenes/${e}`);t&&(u(e),i(t))},[n]);(0,kb.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([Mb(`${n}/editor`),Mb(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[jb]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]);let f={names:s,current:l,onSelect:d,onCreate:(0,kb.useCallback)(async e=>{if(!(await Nb(`${n}/scenes/${e}`,Pb(e))).ok)return;let t=await Mb(`${n}/scenes`);t&&c(t),await d(e)},[n,d]),onDelete:(0,kb.useCallback)(async e=>{if(!(await fetch(`${n}/scenes/${e}`,{method:`DELETE`})).ok)return;let t=await Mb(`${n}/scenes`)??[];c(t),e===l&&t.length>0&&await d(t[0])},[n,l,d])};return(0,Ab.jsx)(Db,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,Ab.jsx)(bb,{editorData:a,projectName:t,panels:e.panels,scenes:f,onSave:(t,r)=>{e.onBeforeSave?.(),l&&Nb(`${n}/scenes/${l}`,t),Nb(`${n}/editor`,{...r,[jb]:l})}})})},Fb.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
} & (
	// レイアウト内に同時1つまで。Panel ラッパー込みの完成形を持つ
	...
	id: PanelId;
	title: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var Lb,Rb;function zb(){return(zb=t((()=>{xb(),Ob(),Lb=o(),Rb=e=>(0,Lb.jsx)(Db,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,Lb.jsx)(bb,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),Rb.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
} & (
	// レイアウト内に同時1つまで。Panel ラッパー込みの完成形を持つ
	...
	id: PanelId;
	title: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}function Bb(){return(Bb=t((()=>{Ib(),zb(),xb(),gb(),O(),Ob(),yo(),Is(),io(),Jc(),hc(),Sc(),Ad(),uu(),Kl(),po(),qo(),Il(),et(),qe(),iu(),jt(),oc(),Re(),_t(),ds(),Se(),Ee(),Fe(),Mt(),ot(),dt(),Ks(),$s(),rs(),va(),wa(),me()})))()}var Vb;function Hb(){return(Hb=t((()=>{Vb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Gb=n({EyeRings:()=>Kb}),Kb;function qb(){return(qb=t((()=>{I(),Hb(),Wb(),Kb=class extends Nn{constructor(e){super(e);let t=this.engine,n=new sr({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new Sr({phase:[`deferred`,`shadowMap`],frag:Vb,vert:Ub,uniforms:t.uniforms});this.entity.addComponent(P,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(P)}}})))()}var Jb;function Yb(){return(Yb=t((()=>{Jb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Qb=n({FlashLine:()=>$b}),$b;function ex(){return(ex=t((()=>{M(),I(),Yb(),Zb(),$b=class extends Nn{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new zn({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=zt.randomVector().multiply(new A(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new Sr({phase:[`forward`,`envMap`],frag:ur(`flFrag`,Jb),vert:ur(`flVert`,Xb),uniforms:F.merge(t.uniforms)}),this.entity.addComponent(P,{material:this.material,geometry:this.geometry})}}})))()}var tx;function nx(){return(nx=t((()=>{tx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var rx=n({SkyBox:()=>ix}),ix;function ax(){return(ax=t((()=>{I(),nx(),ix=class extends Nn{material;constructor(e){super(e);let t=this.engine;this.material=new Sr({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:ur(`SkyBoxFrag`,tx),uniforms:F.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}}})))()}var ox;function sx(){return(sx=t((()=>{ox=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var cx;function lx(){return(lx=t((()=>{cx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ux=n({GridCross:()=>dx}),dx;function fx(){return(fx=t((()=>{M(),I(),sx(),lx(),dx=class extends Nn{constructor(e){super(e);let t=new Ln({width:.05,height:.5,depth:.05}),n=[],r=[],i=new A(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new Sr({frag:ur(`gridCrossFrag`,ox),vert:ur(`gridCrossVert`,cx),phase:[`forward`]});this.entity.addComponent(P,{geometry:t,material:a})}}})))()}var px;function mx(){return(mx=t((()=>{px=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var _x=n({GridDots:()=>vx}),vx;function yx(){return(yx=t((()=>{M(),I(),mx(),gx(),vx=class extends Nn{constructor(e){super(e);let t=new Un({radius:.1}),n=[],r=[],i=new A(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new Sr({frag:ur(`gridDotsFrag`,px),vert:ur(`gridDotsVert`,hx),phase:[`forward`]});this.entity.addComponent(P,{geometry:t,material:a})}}})))()}var bx;function xx(){return(xx=t((()=>{bx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var wx=n({WireCube:()=>Tx}),Tx;function Ex(){return(Ex=t((()=>{I(),xx(),Cx(),Tx=class extends Nn{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new Ln({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new Sr({phase:[`deferred`],frag:bx,vert:Sx,uniforms:F.merge(t.uniforms)});this.entity.addComponent(P,{geometry:i,material:s})}}})))()}var Dx;function Ox(){return(Ox=t((()=>{Dx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var jx=n({OREngineCube:()=>Mx}),Mx;function Nx(){return(Nx=t((()=>{I(),fa(),Ox(),Ax(),Mx=class extends Nn{material;constructor(e){super(e);let t=this.engine;this.material=new Sr({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:ur(`OREngineCubeVert`,kx),frag:ur(`OREngineCubeFrag`,Dx),uniforms:F.merge(t.uniforms,{uNoiseTex:{value:L.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(P);n&&(n.material=this.material)}}})))()}var Px;function Fx(){return(Fx=t((()=>{Px=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Rx=n({OREngineLogo:()=>zx}),zx;function Bx(){return(Bx=t((()=>{I(),Fx(),Lx(),zx=class extends Nn{material;constructor(e){super(e);let t=this.engine;this.material=new Sr({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:ur(`OREngineLogoVert`,Ix),frag:ur(`OREngineLogoFrag`,Px),uniforms:F.merge(t.uniforms)});let n=this.entity.getComponent(P);n&&(n.material=this.material)}}})))()}var Vx;function Hx(){return(Hx=t((()=>{Vx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Gx=n({Dust:()=>Kx}),Kx;function qx(){return(qx=t((()=>{M(),I(),Hx(),Wx(),Kx=class extends Nn{constructor(e){super(e);let t=this.engine,n=new Fn,r=e.args?.num||2048,i=new A(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new Sr({phase:[`forward`],drawType:`POINTS`,frag:Vx,vert:Ux,uniforms:F.merge(t.uniforms)});this.entity.addComponent(P,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(P)}}})))()}var Jx;function Yx(){return(Yx=t((()=>{Jx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var FS;function IS(){return(IS=t((()=>{PS(),FS={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:NS}})))()}var LS;function RS(){return(RS=t((()=>{LS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var zS;function BS(){return(BS=t((()=>{RS(),zS={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:LS}})))()}var VS;function HS(){return(HS=t((()=>{VS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var US;function WS(){return(WS=t((()=>{HS(),US={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:VS}})))()}var GS;function KS(){return(KS=t((()=>{HS(),GS={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:VS}})))()}var qS,JS,YS;function XS(){return(XS=t((()=>{IS(),BS(),WS(),KS(),fa(),qS=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":FS,"/demo-webgl/Resources/Textures/noise.tex":zS,"/demo-webgl/Resources/Textures/noiseCyclic.tex":US,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":GS}),JS=()=>{for(let e of Object.values(qS))e&&L.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},YS=e=>{L.resources.buildTextureInstances(e.renderer,e.uniforms)}})))()}var ZS,QS,$S,eC,tC;function nC(){return(nC=t((()=>{qb(),ex(),ax(),fx(),yx(),Ex(),Nx(),Bx(),qx(),nS(),Yd(),fa(),MS(),XS(),ZS=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":Gb,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":Qb,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":rx,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":ux,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":_x,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":wx,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":jx,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":Rx,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":Gx,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":eS}),QS=Object.assign({}),$S=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);$S(a,e)}}},eC=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);eC(a,e)}}},tC=()=>{kn.gltfLoaderFactory=e=>new Vd(e),L.resources.clear();let e=L.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Yn),e.addComponent(`Camera`,Gn),e.addComponent(`Mesh`,P);let t=Object.keys(AS);for(let e=0;e<t.length;e++){let n=t[e],r=AS[n],i=L.resources.addComponentGroup(n);$S(r,i)}let n=Object.keys(jS);for(let e=0;e<n.length;e++){let t=n[e],r=jS[t],i=L.resources.addGeometryGroup(t);eC(r,i)}let r=ta(ZS,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=L.resources.addComponentGroup(t);$S(n,a)}let a=ta(QS,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=L.resources.addGeometryGroup(t);eC(n,r)}JS()}})))()}var rC,iC,aC,oC,sC,cC;function lC(){return(lC=t((()=>{rC=i(),Bb(),x(),nC(),iC=o(),tC(),aC=({setup:e})=>{let{editor:t}=D();return(0,rC.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},oC=e=>(0,iC.jsx)(Db,{project:e.fixture.scene,onEngineInit:YS,children:(0,iC.jsx)(hb,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,iC.jsx)(Qs,{children:(0,iC.jsxs)(v,{children:[e.children,e.fixture.setup&&(0,iC.jsx)(aC,{setup:e.fixture.setup}),(0,iC.jsx)(b,{}),(0,iC.jsx)(Gs,{})]})})})}),sC=e=>t=>(0,iC.jsx)(oC,{fixture:e,children:(0,iC.jsx)(t,{})}),cC=e=>t=>(0,iC.jsx)(Db,{project:e,onEngineInit:YS,children:(0,iC.jsx)(t,{})}),oC.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var uC,dC,fC,pC,mC;function hC(){return(hC=t((()=>{uC={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`CameraController`,uuid:`sb-camera-controller`}]},dC={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[uC,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},fC={...dC,scene:{name:`root`,uuid:`0`,childs:[uC]}},pC={enableRender:!0,resolutionScale:.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},mC={scene:dC,editorData:pC}})))()}export{va as A,et as B,ds as C,po as D,fo as E,At as F,Te as G,Re as H,jt as I,Se as J,Ee as K,gt as L,fa as M,L as N,ro as O,oa as P,_t as R,us as S,rs as T,Pe as U,Le as V,Fe as W,D as X,O as Y,Il as _,dC as a,Fs as b,sC as c,xb as d,kd as f,Fl as g,Kl as h,mC as i,_a as j,io as k,cC as l,Gl as m,pC as n,oC as o,Ad as p,xe as q,fC as r,lC as s,hC as t,bb as u,Gs as v,ns as w,Is as x,Ks as y,$e as z};