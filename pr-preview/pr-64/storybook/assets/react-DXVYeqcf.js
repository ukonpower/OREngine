...
\r
	...
	id: PanelId;
	title: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}var Hu,Uu,Wu;function Gu(){return(Gu=t((()=>{Hu=`RendererSettings__renderer___LnJlb`,Uu=`RendererSettings__renderer_inner___LnJlb`,Wu={renderer:Hu,renderer_inner:Uu}})))()}var Ku,qu;function Ju(){return(Ju=t((()=>{c(),D(),En(),Gu(),Ku=s(),qu=()=>{let{editor:e}=E(),t=e.engine.renderer;return(0,Ku.jsx)(`div`,{className:Wu.renderer,children:(0,Ku.jsxs)(`div`,{className:Wu.renderer_inner,children:[(0,Ku.jsx)(l,{label:`Resolution`,accordion:!0,children:(0,Ku.jsx)(Tn,{target:e,filter:`resolution`})}),(0,Ku.jsx)(l,{label:`Pipeline`,accordion:!0,children:(0,Ku.jsx)(Tn,{target:t,filter:`pipeline`})}),(0,Ku.jsx)(l,{label:`Sky`,accordion:!0,children:(0,Ku.jsx)(Tn,{target:t,filter:`sky`})})]})})},qu.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var Yu,Xu,Zu,Qu,$u;function ed(){return(ed=t((()=>{Yu=`SceneControl__sceneControl___LnNjZ`,Xu=`SceneControl__sceneControl_inner___LnNjZ`,Zu=`SceneControl__select___LnNjZ`,Qu=`SceneControl__select_name___LnNjZ`,$u={sceneControl:Yu,sceneControl_inner:Xu,select:Zu,select_name:Qu}})))()}var td,nd,rd;function id(){return(id=t((()=>{td=i(),c(),u(),a(),ue(),D(),be(),ed(),nd=s(),rd=()=>{let{editor:e,projectName:t,scenes:n}=E(),[r,i]=(0,td.useState)(!1),a=null;return n&&(a=(0,nd.jsx)(T,{title:`scene`,children:(0,nd.jsxs)(`button`,{className:$u.select,onClick:()=>{i(!0)},children:[(0,nd.jsx)(`span`,{className:$u.select_name,children:n.current??`-`}),(0,nd.jsx)(o,{open:!0})]})})),(0,nd.jsxs)(`div`,{className:$u.sceneControl,children:[(0,nd.jsx)(`div`,{className:$u.sceneControl_inner,children:(0,nd.jsxs)(l,{label:t,accordion:!0,children:[a,(0,nd.jsx)(d,{onClick:()=>{e.save()},children:`Save`})]})}),r&&n&&(0,nd.jsx)(xe,{scenes:n,projectName:t,onClose:()=>{i(!1)}})]})},rd.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var ad,od,sd,cd,ld,ud,dd;function fd(){return(fd=t((()=>{ad=`Textures__textures___LnRle`,od=`Textures__item___LnRle`,sd=`Textures__preview___LnRle`,cd=`Textures__img___LnRle`,ld=`Textures__placeholder___LnRle`,ud=`Textures__name___LnRle`,dd={textures:ad,item:od,preview:sd,img:cd,placeholder:ld,name:ud}})))()}var pd,md,hd;function gd(){return(gd=t((()=>{pd=i(),io(),D(),fd(),md=s(),hd=()=>{let{engine:e,editor:t}=E(),[,n]=(0,pd.useState)(0);(0,pd.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return Za.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{Za.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=Za.resources.textureList;return(0,md.jsx)(`div`,{className:dd.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,md.jsxs)(`div`,{className:dd.item,children:[(0,md.jsx)(`div`,{className:dd.preview,children:n?(0,md.jsx)(`img`,{src:n,className:dd.img}):(0,md.jsx)(`div`,{className:dd.placeholder})}),(0,md.jsx)(`div`,{className:dd.name,children:e.name})]},e.name)})})},hd.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var _d,vd;function yd(){return(yd=t((()=>{_d=i(),vd=(0,_d.createContext)(null)})))()}var bd,xd;function Sd(){return(Sd=t((()=>{bd=i(),yd(),xd=()=>{let e=(0,bd.useContext)(vd);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var Cd;function wd(){return(wd=t((()=>{Cd=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
	...
	id: PanelId;
	title: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},scenes:{required:!1,tsType:{name:`SceneSelection`},description:``}}}})))()}var jx,Mx;function Nx(){return(Nx=t((()=>{jx=e(i(),1),ip(),Qa(),Mx=()=>{let[e,t]=jx.useState(()=>new Za(np)),n=jx.useRef(e);return n.current=e,(0,jx.useEffect)(()=>{n.current.disposed&&t(new Za(np))},[]),(0,jx.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,jx.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var Px,Fx,Ix;function Lx(){return(Lx=t((()=>{Px=i(),cs(),Nx(),Fx=s(),Ix=e=>{let t=Mx(),{engine:n}=t,r=(0,Px.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,Px.useEffect)(()=>{r.current?.(n)},[n]),(0,Px.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,Fx.jsx)(ss.Provider,{value:t,children:e.children})},Ix.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var Rx,zx,Bx,Vx,Hx,Ux,Wx;function Gx(){return(Gx=t((()=>{Rx=i(),Ax(),Lx(),zx=s(),Bx=`scene`,Vx=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},Hx=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),Ux=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),Wx=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,Rx.useState)(e.sceneData),[a,o]=(0,Rx.useState)(e.editorData),[s,c]=(0,Rx.useState)([]),[l,u]=(0,Rx.useState)(null),d=(0,Rx.useCallback)(async e=>{let t=await Vx(`${n}/scenes/${e}`);t&&(u(e),i(t))},[n]);(0,Rx.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([Vx(`${n}/editor`),Vx(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[Bx]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]);let f={names:s,current:l,onSelect:d,onCreate:(0,Rx.useCallback)(async e=>{if(!(await Hx(`${n}/scenes/${e}`,Ux(e))).ok)return;let t=await Vx(`${n}/scenes`);t&&c(t),await d(e)},[n,d]),onDelete:(0,Rx.useCallback)(async e=>{if(!(await fetch(`${n}/scenes/${e}`,{method:`DELETE`})).ok)return;let t=await Vx(`${n}/scenes`)??[];c(t),e===l&&t.length>0&&await d(t[0])},[n,l,d])};return(0,zx.jsx)(Ix,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,zx.jsx)(kx,{editorData:a,projectName:t,panels:e.panels,scenes:f,onSave:(t,r)=>{e.onBeforeSave?.(),l&&Hx(`${n}/scenes/${l}`,t),Hx(`${n}/editor`,{...r,[Bx]:l})}})})},Wx.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
} & (
	// レイアウト内に同時1つまで。Panel ラッパー込みの完成形を持つ
	...
	id: PanelId;
	title: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var Kx,qx;function Jx(){return(Jx=t((()=>{Ax(),Lx(),Kx=s(),qx=e=>(0,Kx.jsx)(Ix,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,Kx.jsx)(kx,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),qx.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
} & (
	// レイアウト内に同時1つまで。Panel ラッパー込みの完成形を持つ
	...
	id: PanelId;
	title: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}function Yx(){return(Yx=t((()=>{te(),re(),Ye(),fe(),nt()})))()}function Xx(){return(Xx=t((()=>{Gx(),Jx(),Ax(),Tx(),D(),Lx(),ds(),Oc(),Zo(),ou(),Dl(),Pl(),Uf(),Sd(),id(),as(),zs(),Ju(),Jt(),Vt(),gd(),En(),vl(),Mt(),fn(),rc(),_t(),xt(),At(),Dn(),en(),on(),il(),dl(),Ys(),uo(),_o(),Hc(),Jc(),Le(),je(),Ve(),Pe(),c(),u(),x(),Yx(),ue(),w(),oe(),ce(),lt()})))()}export{ii as $,tt as $t,nc as A,jn as At,io as B,Jt as Bt,il as C,Cr as Ct,Hc as D,Mn as Dt,Vc as E,Fn as Et,as as F,Tn as Ft,Ia as G,bt as Gt,Qa as H,Mt as Ht,Xo as I,En as It,gi as J,_t as Jt,Ma as K,xt as Kt,Zo as L,dn as Lt,Js as M,kn as Mt,Ys as N,A as Nt,Dc as O,Nn as Ot,is as P,On as Pt,ri as Q,lt as Qt,uo as R,fn as Rt,rl as S,Sr as St,Jc as T,Pn as Tt,L as U,kt as Ut,Za as V,O as Vt,Fa as W,At as Wt,li as X,E as Xt,_i as Y,D as Yt,ui as Z,ct as Zt,id as _,jr as _t,Ax as a,Gr as at,ul as b,Er as bt,Xb as c,Rr as ct,qb as d,Lr as dt,nt as en,ei as et,Yb as f,Pr as ft,rd as g,Ar as gt,Uf as h,Nr as ht,kx as i,Ie as in,F as it,rc as j,j as jt,Oc as k,An as kt,Qb as l,zr as lt,Hf as m,Mr as mt,Ix as n,Ye as nn,Kr as nt,wx as o,Hr as ot,ip as p,Fr as pt,Na as q,gt as qt,Lx as r,Le as rn,qr as rt,Tx as s,Ur as st,Xx as t,Je as tn,ti as tt,Jb as u,Ir as ut,qu as v,Or as vt,qc as w,M as wt,dl as x,Dr as xt,Ju as y,kr as yt,lo as z,qt as zt};