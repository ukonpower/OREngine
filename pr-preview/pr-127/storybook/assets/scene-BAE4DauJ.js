...
\r
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}var wy,Ty,Ey;function Dy(){return(Dy=t((()=>{wy=`RendererSettings__renderer___LnJlb`,Ty=`RendererSettings__renderer_inner___LnJlb`,Ey={renderer:wy,renderer_inner:Ty}})))()}var Oy,ky;function Ay(){return(Ay=t((()=>{w(),F(),eg(),Dy(),Oy=o(),ky=()=>{let{editor:e}=P(),t=e.engine.renderer;return(0,Oy.jsx)(`div`,{className:Ey.renderer,children:(0,Oy.jsxs)(`div`,{className:Ey.renderer_inner,children:[(0,Oy.jsx)(s,{label:`Resolution`,accordion:!0,children:(0,Oy.jsx)($h,{target:e,filter:`resolution`})}),(0,Oy.jsx)(s,{label:`Pipeline`,accordion:!0,children:(0,Oy.jsx)($h,{target:t,filter:`pipeline`})}),(0,Oy.jsx)(s,{label:`Sky`,accordion:!0,children:(0,Oy.jsx)($h,{target:t,filter:`sky`})})]})})},ky.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var jy,My,Ny,Py,Fy,Iy;function Ly(){return(Ly=t((()=>{jy=`SceneControl__sceneControl___LnNjZ`,My=`SceneControl__sceneControl_inner___LnNjZ`,Ny=`SceneControl__select___LnNjZ`,Py=`SceneControl__select_name___LnNjZ`,Fy=`SceneControl__save___LnNjZ`,Iy={sceneControl:jy,sceneControl_inner:My,select:Ny,select_name:Py,save:Fy}})))()}var Ry,zy,By;function Vy(){return(Vy=t((()=>{Ry=i(),w(),F(),fe(),Ly(),zy=o(),By=()=>{let{editor:e,projectName:t,scenes:n}=P(),[r,i]=(0,Ry.useState)(null),o=null;return n&&(o=(0,zy.jsx)(ie,{title:`scene`,children:(0,zy.jsxs)(`button`,{className:Iy.select,onClick:e=>{i(T(e.clientX,e.clientY))},children:[(0,zy.jsx)(`span`,{className:Iy.select_name,children:n.current??`-`}),(0,zy.jsx)(a,{open:!0})]})})),(0,zy.jsxs)(`div`,{className:Iy.sceneControl,children:[(0,zy.jsx)(`div`,{className:Iy.sceneControl_inner,children:(0,zy.jsxs)(s,{label:t,accordion:!0,children:[o,(0,zy.jsx)(`div`,{className:Iy.save,children:(0,zy.jsx)(c,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,zy.jsx)(pe,{scenes:n,projectName:t,anchor:r,onClose:()=>{i(null)}})]})},By.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var Hy,Uy,Wy,Gy,Ky,qy,Jy;function Yy(){return(Yy=t((()=>{Hy=`Textures__textures___LnRle`,Uy=`Textures__item___LnRle`,Wy=`Textures__preview___LnRle`,Gy=`Textures__img___LnRle`,Ky=`Textures__placeholder___LnRle`,qy=`Textures__name___LnRle`,Jy={textures:Hy,item:Uy,preview:Wy,img:Gy,placeholder:Ky,name:qy}})))()}var Xy,Zy,Qy;function $y(){return($y=t((()=>{Xy=i(),fi(),F(),Yy(),Zy=o(),Qy=()=>{let{engine:e,editor:t}=P(),[,n]=(0,Xy.useState)(0);(0,Xy.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return N.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{N.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=N.resources.textureList;return(0,Zy.jsx)(`div`,{className:Jy.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,Zy.jsxs)(`div`,{className:Jy.item,children:[(0,Zy.jsx)(`div`,{className:Jy.preview,children:n?(0,Zy.jsx)(`img`,{src:n,className:Jy.img}):(0,Zy.jsx)(`div`,{className:Jy.placeholder})}),(0,Zy.jsx)(`div`,{className:Jy.name,children:e.name})]},e.name)})})},Qy.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var eb,tb;function nb(){return(nb=t((()=>{eb=i(),tb=(0,eb.createContext)(null)})))()}var rb,ib;function ab(){return(ab=t((()=>{rb=i(),nb(),ib=()=>{let e=(0,rb.useContext)(tb);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var ob;function sb(){return(sb=t((()=>{ob=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
...
}`})))()}var cb;function lb(){return(lb=t((()=>{at(),qe(),O(),M(),sb(),cb=class extends tt{wrapperElm;glCanvas;backend;gl;canvasTexture;canvas;canvasCtx;glRenderer;postProcess;viewPort;viewPortRange;viewPortScale;frameSetting;loopSetting;musicBuffer;musicTexture;resizeObserver;canvasSize;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.glCanvas=document.createElement(`canvas`),this.backend=new Je(this.glCanvas.getContext(`webgl2`)),this.gl=this.backend.gl,this.canvasSize=new E(this.glCanvas.width,this.glCanvas.height),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0],this.viewPortScale=50,this.frameSetting=null,this.loopSetting={enabled:!1,start:0,end:0},this.resizeObserver=new ResizeObserver(this.onResize.bind(this));let e={renderer:null,createEntity:t=>new qt({...t,engine:e})};this.glRenderer=new zr(this.backend,e),e.renderer=this.glRenderer,this.canvasTexture=new ze(this.gl),this.musicBuffer=null,this.musicTexture=new ze(this.gl),this.musicTexture.setting({type:this.gl.UNSIGNED_BYTE,internalFormat:this.gl.LUMINANCE,format:this.gl.LUMINANCE,magFilter:this.gl.LINEAR,minFilter:this.gl.LINEAR,wrapS:this.gl.MIRRORED_REPEAT}),this.postProcess=new gn({passes:[new j(this.backend,{frag:ob,uniforms:{uCanvasTex:{type:`1i`,value:null},uMusicTex:{type:`1i`,value:this.musicTexture}},renderTarget:null})]})}onResize(){if(this.wrapperElm){let e=new E(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);if(e.x===0||e.y===0)return;this.glCanvas.width=this.canvas.width=e.x,this.glCanvas.height=this.canvas.height=e.y,this.canvasSize.set(this.glCanvas.width,this.glCanvas.height),this.postProcess.resize(e),this.render()}}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.frameSetting){this.canvasCtx.fillStyle=`#181818`;let e=this.frameToPx(0),t=this.frameToPx(this.frameSetting.duration);this.canvasCtx.fillRect(e,0,t-e,this.canvas.height)}let e=(e,t,n)=>{let r=Math.ceil(this.viewPort[0]/e)*e;this.canvasCtx.beginPath();let i=0;for(;r<this.viewPort[2]&&i<100;){let n=this.frameToPx(r+t);this.canvasCtx.moveTo(n,0),this.canvasCtx.lineTo(n,this.canvas.height),r+=e,i++}this.canvasCtx.strokeStyle=n,this.canvasCtx.lineWidth=1,this.canvasCtx.stroke()};if(e(this.viewPortScale,0,`#555`),e(this.viewPortScale,this.viewPortScale/2,`#333`),this.musicBuffer&&this.frameSetting){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)],s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}if(this.loopSetting.enabled){this.canvasCtx.fillStyle=`#0009`;let e=this.frameToPx(this.loopSetting.start),t=this.frameToPx(this.loopSetting.end);this.canvasCtx.fillRect(0,0,e,this.canvas.height),this.canvasCtx.fillRect(t,0,this.canvas.width-t,this.canvas.height)}this.canvasTexture.attach(this.canvas),this.postProcess.passes&&(this.postProcess.passes[0].uniforms.uCanvasTex.value=this.canvasTexture),this.glRenderer.renderPostProcess(this.postProcess,void 0,this.canvasSize)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.glCanvas),this.onResize()}setViewPort(e,t){this.viewPort=e,this.viewPortRange=[e[2]-e[0],e[3]-e[1]],this.viewPortScale=t,this.render()}setFrameSetting(e){this.frameSetting={duration:Math.round(e.duration),fps:Math.round(e.fps)},this.render()}setMusicBuffer(e){this.musicBuffer=e,setTimeout(()=>{this.render()},100)}setLoopSetting(e,t,n){this.loopSetting={enabled:e,start:t,end:n},this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.glCanvas),this.resizeObserver.disconnect()}},cb.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setViewPort`,docblock:null,modifiers:[],params:[{name:`viewPort`,optional:!1,type:{name:`Array`,elements:[{name:`number`}],raw:`number[]`}},{name:`scale`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`setLoopSetting`,docblock:null,modifiers:[],params:[{name:`enabled`,optional:!1,type:{name:`boolean`}},{name:`start`,optional:!1,type:{name:`number`}},{name:`end`,optional:!1,type:{name:`number`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`TimelineCanvasRenderer`}})))()}var ub,db;function fb(){return(fb=t((()=>{ub=`TimelineCanvas__timelineCanvas___LnRpb`,db={timelineCanvas:ub}})))()}var pb,mb,hb;function gb(){return(gb=t((()=>{pb=i(),tg(),ab(),lb(),fb(),mb=o(),hb=()=>{let{viewPort:e,viewPortScale:t,musicBuffer:n,musicBufferVersion:r,glEditor:i}=ib(),[a,o]=(0,pb.useState)(),s=(0,pb.useRef)(null);(0,pb.useEffect)(()=>{let e=new cb;return o(e),s.current&&e.setWrapperElm(s.current),()=>{e.dispose()}},[]),(0,pb.useEffect)(()=>{a&&e&&t&&a.setViewPort(e,t)},[a,e,t]);let[c]=q(i?.engine,`timeline/duration`),[l]=q(i?.engine,`timeline/fps`);(0,pb.useEffect)(()=>{a&&c&&l&&a.setFrameSetting({duration:c||0,fps:l||0})},[a,c,l]);let[u]=q(i,`frameLoop/enabled`),[d]=q(i,`frameLoop/start`),[f]=q(i,`frameLoop/end`);return(0,pb.useEffect)(()=>{a&&a.setLoopSetting(u||!1,d||0,f||0)},[a,u,d,f]),(0,pb.useEffect)(()=>{a&&n&&a.setMusicBuffer(n)},[a,n,r]),(0,mb.jsx)(`div`,{className:db.timelineCanvas,ref:s})},hb.__docgenInfo={description:``,methods:[],displayName:`TimelineCanvas`}})))()}var _b,vb;function yb(){return(yb=t((()=>{_b=`TimelineControls__controls___LmNvb`,vb={controls:_b}})))()}var bb,xb,Sb;function Cb(){return(Cb=t((()=>{bb=e(i(),1),ab(),yb(),xb=o(),Sb=e=>{let{viewPort:t,setCurrentFrame:n,getFrameViewPort:r,zoom:i,scroll:a,setViewPortCenter:o}=ib(),s=(0,bb.useRef)([0,0,0,0]),c=(0,bb.useRef)([0,0]);t&&(s.current=t,c.current=[t[2]-t[0],t[3]-t[1]]);let l=(0,bb.useRef)(null),u=(0,bb.useRef)(null),d=(0,bb.useRef)(null),f=(0,bb.useRef)(null),p=(0,bb.useRef)(null),m=(0,bb.useCallback)(e=>{let t=l.current&&l.current.clientWidth||1;if(d.current==0){if(n&&r&&u.current){let i=(e.clientX-u.current.left)/t;n(r(i))}}else if(d.current==1){let n=[e.clientX,e.clientY];if(f.current&&p.current){let e=-(n[0]-f.current[0])/t*c.current[0];o&&o(p.current+e)}}},[n,r,o]),h=(0,bb.useCallback)(e=>{d.current=e.button,p.current=(s.current[2]+s.current[0])/2,f.current=[e.clientX,e.clientY],u.current=e.currentTarget.getBoundingClientRect();let t=(e.clientX-u.current.left)/e.currentTarget.clientWidth;d.current==0&&n&&r&&n(r(t)),window.addEventListener(`pointermove`,m);let i=()=>{f.current=null,d.current=null,p.current=null,window.removeEventListener(`pointermove`,m)};return window.addEventListener(`pointerup`,i),()=>{window.removeEventListener(`pointerup`,i),window.removeEventListener(`pointermove`,m)}},[r,n,m]),g=(0,bb.useCallback)(e=>{if(d.current!==null||!i||!a)return;e.preventDefault();let t=e.target&&e.target.clientWidth||1,n=Math.abs(e.deltaY);Math.abs(e.deltaX)<n?i(n>50?e.deltaY<0?.9:1.1:1+e.deltaY*.005):a(e.deltaX/t*.5)},[i,a]);return(0,bb.useEffect)(()=>{let e=l.current;return e&&e.addEventListener(`wheel`,g,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,g)}},[g]),t?(0,xb.jsx)(`div`,{className:vb.controls,onPointerDown:h,ref:l,children:e.children}):null},Sb.__docgenInfo={description:``,methods:[],displayName:`TimelineControls`,props:{children:{required:!1,tsType:{name:`ReactReactNode`,raw:`React.ReactNode`},description:``}}}})))()}var wb,Tb,Eb;function Db(){return(Db=t((()=>{wb=`TimelineCursor__cursor___LmN1c`,Tb=`TimelineCursor__frame___LmN1c`,Eb={cursor:wb,frame:Tb}})))()}var Ob,kb;function Ab(){return(Ab=t((()=>{ab(),Db(),Ob=o(),kb=()=>{let{viewPort:e,framePlay:t}=ib();if(!e||!t)return null;let n=e[2]-e[0],r=(t.current-e[0])/n;return(0,Ob.jsx)(`div`,{className:Eb.cursor,style:{left:r*100+`%`},children:(0,Ob.jsx)(`div`,{className:Eb.frame})})},kb.__docgenInfo={description:``,methods:[],displayName:`TimelineCursor`}})))()}var jb,Mb,Nb,Pb;function Fb(){return(Fb=t((()=>{jb=`TimelineLoop__timelineLoop___LnRpb`,Mb=`TimelineLoop__start___LnRpb`,Nb=`TimelineLoop__end___LnRpb`,Pb={timelineLoop:jb,start:Mb,end:Nb}})))()}var Ib,Lb;function Rb(){return(Rb=t((()=>{Ib=`TimelineLoopCursor__cursor___LmN1c`,Lb={cursor:Ib}})))()}var zb,Bb,Vb;function Hb(){return(Hb=t((()=>{zb=i(),Rb(),Bb=o(),Vb=({onMove:e})=>{let t=(0,zb.useRef)(!1);return(0,Bb.jsx)(`div`,{className:Lb.cursor,onPointerDown:e=>{e.buttons==1&&(t.current=!0,e.stopPropagation())},onPointerMove:n=>{let r=n.target;t.current!==!1&&n.buttons==1&&(r.setPointerCapture(n.pointerId),n.buttons==1&&e&&e(n.clientX),n.nativeEvent.preventDefault(),n.nativeEvent.stopPropagation())},onPointerUp:()=>{t.current=!1}})},Vb.__docgenInfo={description:``,methods:[],displayName:`TimelineLoopCursor`}})))()}var Ub,Wb,Gb;function Kb(){return(Kb=t((()=>{Ub=i(),tg(),Eh(),ab(),Fb(),Hb(),Wb=o(),Gb=()=>{let{viewPort:e,framePlay:t,glEditor:n}=ib(),r=(0,Ub.useRef)(null);Th(n,[`frameLoop/enabled`,`frameLoop/start`,`frameLoop/end`]);let[i]=q(n,`frameLoop/enabled`),[a,o]=q(n,`frameLoop/start`),[s,c]=q(n,`frameLoop/end`);if(i!==!0||!e||!t||a===void 0||s===void 0)return null;let l=e[2]-e[0],u=(a-e[0])/l,d=(s-e[0])/l,f=(t,n)=>{let r=t.getBoundingClientRect();return(n-r.x)/r.width*(e[2]-e[0])+e[0]};return(0,Wb.jsx)(`div`,{className:Pb.timelineLoop,ref:r,children:(0,Wb.jsxs)(`div`,{className:Pb.timelineLoop_inner,children:[(0,Wb.jsx)(`div`,{className:Pb.start,style:{left:u*100+`%`},children:(0,Wb.jsx)(Vb,{onMove:e=>{r.current&&o&&o(f(r.current,e))}})}),(0,Wb.jsx)(`div`,{className:Pb.end,style:{left:d*100+`%`},children:(0,Wb.jsx)(Vb,{onMove:e=>{r.current&&c&&c(f(r.current,e))}})})]})})},Gb.__docgenInfo={description:``,methods:[],displayName:`TimelineLoop`}})))()}var qb,Jb,Yb,Xb,Zb,Qb;function $b(){return($b=t((()=>{qb=`TimelineScale__scale___LnNjY`,Jb=`TimelineScale__scale_inner___LnNjY`,Yb=`TimelineScale__scale_item___LnNjY`,Xb=`TimelineScale__scale_item_frame___LnNjY`,Zb=`TimelineScale__scale_item_time___LnNjY`,Qb={scale:qb,scale_inner:Jb,scale_item:Yb,scale_item_frame:Xb,scale_item_time:Zb}})))()}var ex,tx,nx;function rx(){return(rx=t((()=>{tg(),ab(),$b(),ex=o(),tx=e=>`${(`00`+Math.floor(e%3600/60)).slice(-2)}:${(`00`+Math.floor(e%60)).slice(-2)}`,nx=()=>{let{glEditor:e,viewPort:t,viewPortScale:n}=ib(),[r,i]=q(e?.engine,`timeline/fps`);if(!t||!n||r===void 0)return null;let a=[],o=Math.ceil(t[0]/n)*n,s=0;for(;o<t[2]&&s<100;){let e=(o-t[0])/(t[2]-t[0]),i=o/(r||0);a.push((0,ex.jsxs)(`div`,{className:Qb.scale_item,style:{left:e*100+`%`},children:[(0,ex.jsx)(`div`,{className:Qb.scale_item_frame,children:o}),(0,ex.jsx)(`div`,{className:Qb.scale_item_time,children:tx(i)})]},o)),o+=n,s++}return(0,ex.jsx)(`div`,{className:Qb.scale,children:(0,ex.jsx)(`div`,{className:Qb.scale_inner,children:a})})},nx.__docgenInfo={description:``,methods:[],displayName:`TimelineScale`}})))()}var ix,ax,ox;function sx(){return(sx=t((()=>{ix=`TimelineSetting__timelineSetting___LnRpb`,ax=`TimelineSetting__play___LnRpb`,ox={timelineSetting:ix,play:ax}})))()}var cx,lx,ux;function dx(){return(dx=t((()=>{cx=i(),w(),Ii(),tg(),ab(),sx(),lx=o(),ux=()=>{let{framePlay:e,glEditor:t}=ib(),n=(0,cx.useCallback)((e,t)=>{t&&t(e)},[]),[r,i]=q(t,`frameLoop/enabled`),[a]=q(t?.engine,`timeline/duration`),[o]=q(t?.engine,`timeline/fps`),s=(0,cx.useCallback)((e,n)=>{t&&t.api.setField(t.engine,e,n)},[t]),l=(0,cx.useCallback)(()=>{t&&t.togglePlay()},[t]);return(0,lx.jsx)(`div`,{className:ox.timelineSetting,children:(0,lx.jsxs)(ce,{children:[(0,lx.jsx)(`div`,{className:ox.play,children:(0,lx.jsx)(c,{onClick:l,children:e.playing?(0,lx.jsx)(f,{size:14}):(0,lx.jsx)(m,{size:14})})}),(0,lx.jsx)(ie,{title:`current`,children:(0,lx.jsx)(Fi,{value:Math.floor(e?.current||0),readOnly:!0})}),(0,lx.jsx)(ie,{title:`duration`,children:(0,lx.jsx)(Fi,{value:a,onChange:e=>s(`timeline/duration`,e)})}),(0,lx.jsx)(ie,{title:`fps`,children:(0,lx.jsx)(Fi,{value:o,onChange:e=>s(`timeline/fps`,e)})}),(0,lx.jsx)(ie,{title:`loop`,children:(0,lx.jsx)(Fi,{value:r||!1,onChange:e=>n(e,i)})})]})})},ux.__docgenInfo={description:``,methods:[],displayName:`TimelineSetting`}})))()}var fx,px,mx,hx,gx;function _x(){return(_x=t((()=>{fx=`Timeline__timeline___LnRpb`,px=`Timeline__inner___LnRpb`,mx=`Timeline__content___LnRpb`,hx=`Timeline__setting___LnRpb`,gx={timeline:fx,inner:px,content:mx,setting:hx}})))()}var vx,yx;function bx(){return(bx=t((()=>{vx=i(),F(),yx=()=>{let{editor:e}=P(),[t,n]=(0,vx.useState)({current:0,playing:!1}),[r,i]=(0,vx.useState)([0,0,100,0]),a=(0,vx.useRef)([0,0,0,0]);a.current=r;let o=r[2]-r[0],s=10*2**(0+Math.floor(Math.log2(o/100)));s=Math.max(1,Math.floor(s));let c=e?.audioBuffer,[l,u]=(0,vx.useState)();(0,vx.useEffect)(()=>{if(e){let t=e.engine,r=e=>{n({...e})};r(t.frame);let a=0,o=()=>{u(a++)},s=()=>{i([0,0,t.frameSetting.duration,0])};return s(),t.on(`update/frame/play`,r),t.on(`update/music`,o),t.on(`loaded`,s),()=>{t.off(`update/frame/play`,r),t.off(`update/music`,o),t.off(`loaded`,s)}}},[e]);let d=(0,vx.useCallback)(t=>{e&&e.engine.seek(t)},[e]),f=(0,vx.useCallback)(e=>{let t=r[2]-r[0];return Math.floor(r[0]+t*e)},[r]),p=(0,vx.useCallback)(e=>{let t=a.current,n=(t[2]+t[0])/2,r=(t[0]-n)*e+n,o=(t[2]-n)*e+n;i([r,t[1],o,t[3]])},[]),m=(0,vx.useCallback)(e=>{let t=a.current,n=e*(t[2]-t[0]);i([t[0]+n,t[1],t[2]+n,t[3]])},[]),h=(0,vx.useCallback)(e=>{let t=a.current,n=t[2]-t[0];i([e-n/2,t[1],e+n/2,t[3]])},[]);return{glEditor:e,framePlay:t,viewPort:r,viewPortScale:s,musicBuffer:c,musicBufferVersion:l,setCurrentFrame:d,getFrameViewPort:f,zoom:p,scroll:m,setViewPortCenter:h}}})))()}var xx,Sx;function Cx(){return(Cx=t((()=>{nb(),bx(),xx=o(),Sx=e=>{let t=yx();return(0,xx.jsx)(tb.Provider,{value:t,children:e.children})},Sx.__docgenInfo={description:``,methods:[],displayName:`TimelineProvider`}})))()}var wx,Tx;function Ex(){return(Ex=t((()=>{gb(),Cb(),Ab(),Kb(),rx(),dx(),_x(),Cx(),wx=o(),Tx=()=>(0,wx.jsx)(Sx,{children:(0,wx.jsx)(`div`,{className:gx.timeline,children:(0,wx.jsxs)(`div`,{className:gx.inner,children:[(0,wx.jsx)(`div`,{className:gx.setting,children:(0,wx.jsx)(ux,{})}),(0,wx.jsxs)(`div`,{className:gx.content,children:[(0,wx.jsx)(hb,{}),(0,wx.jsx)(kb,{}),(0,wx.jsx)(Sb,{children:(0,wx.jsx)(Gb,{})}),(0,wx.jsx)(nx,{})]})]})})}),Tx.__docgenInfo={description:``,methods:[],displayName:`Timeline`}})))()}var Dx,Ox;function kx(){return(kx=t((()=>{Dx=`OREditor__editor___LmVka`,Ox={editor:Dx}})))()}var Ax,jx;function Mx(){return(Mx=t((()=>{Ax=e(i(),1),ph(),Kg(),jx=e=>{let{engine:t}=Gg(),[n,r]=(0,Ax.useState)(()=>new dh(t)),i=Ax.useRef(n);return i.current=n,(0,Ax.useEffect)(()=>{if(!i.current.disposed&&i.current.engine.uuid==t.uuid)return;let e=new dh(t);r(e)},[t]),(0,Ax.useEffect)(()=>()=>{n.dispose()},[n]),{engine:t,editor:n,projectName:e}}})))()}var Nx,Px,Fx;function Ix(){return(Ix=t((()=>{Nx=i(),ph(),hi(),Mx(),Px=o(),Fx=e=>{let t=jx(e.projectName),n=(0,Nx.useRef)(Promise.resolve());(0,Nx.useEffect)(()=>{if(!t.editor||!e.onSave)return;let r=e.onSave,i=(e,t)=>{n.current=Promise.resolve(r(e,t))};return t.editor.on(`save`,i),()=>{t.editor.off(`save`,i)}},[t.editor,e.onSave]);let r=(0,Nx.useRef)(null),i=e.scenes??null;return(0,Nx.useEffect)(()=>{r.current=i},[i]),(0,Nx.useEffect)(()=>Zo({editor:t.editor,getScenes:()=>r.current,waitForSave:()=>n.current}),[t.editor]),(0,Nx.useEffect)(()=>{t.editor&&t.editor.bootstrap(e.editorData)},[e.editorData,t.editor]),(0,Px.jsx)(mi.Provider,{value:{...t,scenes:e.scenes},children:e.children})},Fx.__docgenInfo={description:``,methods:[],displayName:`OREditorProvider`}})))()}var Lx,$,Rx,zx,Bx;function Vx(){return(Vx=t((()=>{Lx=e(i(),1),ye(),w(),Ce(),Qi(),bh(),Mg(),Bg(),b_(),K_(),Cy(),Ay(),Vy(),Vv(),$y(),Ex(),kx(),Ix(),$=o(),Rx=[{id:`hierarchy`,title:`Hierarchy`,category:`General`,content:(0,$.jsx)(ce,{children:(0,$.jsx)(G_,{})})},{id:`timer`,title:`Timer`,category:`Rendering`,content:(0,$.jsx)(ce,{noPadding:!0,children:(0,$.jsx)(y_,{})})},{id:zv,title:`Screen`,category:`General`,multiple:!0,content:e=>(0,$.jsx)(Bv,{viewportId:e})},{id:`property`,title:`Property`,category:`General`,content:(0,$.jsx)(ce,{children:(0,$.jsx)(jg,{})})},{id:`textures`,title:`Textures`,category:`Rendering`,content:(0,$.jsx)(ce,{noPadding:!0,children:(0,$.jsx)(Qy,{})})},{id:`scene`,title:`Scene`,category:`General`,content:(0,$.jsx)(ce,{children:(0,$.jsx)(By,{})})},{id:`export`,title:`Export`,category:`Project`,content:(0,$.jsx)(ce,{children:(0,$.jsx)(zg,{})})},{id:`renderer`,title:`Renderer`,category:`Rendering`,content:(0,$.jsx)(ce,{children:(0,$.jsx)(ky,{})})},{id:`editor-settings`,title:`Editor`,category:`Project`,content:(0,$.jsx)(ce,{children:(0,$.jsx)(Zi,{})})},{id:`timeline`,title:`Timeline`,category:`Animation`,content:(0,$.jsx)(ce,{noPadding:!0,children:(0,$.jsx)(Tx,{})})}],zx=e=>{let t=[];for(let n of e)n.multiple||n.id!==`hierarchy`&&n.id!==`property`&&n.id!==`timeline`&&t.push({id:n.id,title:n.title,content:n.content});return t},Bx=e=>{let t=Se(),n=(0,Lx.useMemo)(()=>e.panels?[...Rx,...e.panels]:Rx,[e.panels]),r=null;return r=t.isPC?(0,$.jsx)(Sy,{panels:n}):(0,$.jsx)($.Fragment,{children:(0,$.jsxs)(ae,{direction:`vertical`,storageKey:`orengine-editor-sp-main`,children:[(0,$.jsx)(ae.Item,{size:`calc( min( 56.25vw, 55vh ) + 77px )`,minSize:200,style:{minHeight:`200px`},children:(0,$.jsx)(Bv,{viewportId:`main`})}),(0,$.jsx)(ae.Item,{flex:1,minSize:200,children:(0,$.jsxs)(le,{storageKey:`orengine-panel-sp-main`,children:[(0,$.jsx)(le.Tab,{title:`Hierarchy / Property`,children:(0,$.jsxs)(ae,{direction:`horizontal`,storageKey:`orengine-editor-sp-hierarchyProp`,children:[(0,$.jsx)(ae.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,$.jsx)(G_,{})}),(0,$.jsx)(ae.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,$.jsx)(jg,{})})]})}),zx(n).map(e=>(0,$.jsx)(le.Tab,{title:e.title,children:e.content},e.id))]})}),(0,$.jsx)(ae.Item,{size:`120px`,minSize:80,children:(0,$.jsx)(le,{storageKey:`orengine-panel-sp-timeline`,children:(0,$.jsx)(le.Tab,{title:`Timeline`,children:(0,$.jsx)(ce,{noPadding:!0,children:(0,$.jsx)(ve,{fallback:(0,$.jsx)(`div`,{children:`エラーだよ`}),children:(0,$.jsx)(Tx,{})})})})})})]})}),(0,$.jsx)(Fx,{projectName:e.projectName,onSave:e.onSave,editorData:e.editorData,scenes:e.scenes,children:(0,$.jsx)(x,{children:(0,$.jsxs)(ne,{children:[(0,$.jsx)(`div`,{className:Ox.editor,children:r}),(0,$.jsx)(yh,{}),(0,$.jsx)(y,{}),(0,$.jsx)(te,{})]})})})},Bx.__docgenInfo={description:``,methods:[],displayName:`OREditor`,props:{onSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( projectData: OREngineProjectData, editorData: MXP.SerializeField ) => Promise<void> | void`,signature:{arguments:[{type:{name:`OREngineProjectData`},name:`projectData`},{type:{name:`MXP.SerializeField`},name:`editorData`}],return:{name:`union`,raw:`Promise<void> | void`,elements:[{name:`Promise`,elements:[{name:`void`}],raw:`Promise<void>`},{name:`void`}]}}},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},projectName:{required:!1,tsType:{name:`string`},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
...
}`,signature:{properties:[{key:`names`,value:{name:`Array`,elements:[{name:`string`}],raw:`string[]`,required:!0}},{key:`current`,value:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}],required:!0}},{key:`onSelect`,value:{name:`signature`,type:`function`,raw:`( name: string ) => Promise<void>`,signature:{arguments:[{type:{name:`string`},name:`name`}],return:{name:`Promise`,elements:[{name:`void`}],raw:`Promise<void>`}},required:!0}},{key:`onCreate`,value:{name:`signature`,type:`function`,raw:`( name: string, from?: string ) => Promise<void>`,signature:{arguments:[{type:{name:`string`},name:`name`},{type:{name:`string`},name:`from`}],return:{name:`Promise`,elements:[{name:`void`}],raw:`Promise<void>`}},required:!0}},{key:`onDelete`,value:{name:`signature`,type:`function`,raw:`( name: string ) => Promise<void>`,signature:{arguments:[{type:{name:`string`},name:`name`}],return:{name:`Promise`,elements:[{name:`void`}],raw:`Promise<void>`}},required:!0}}]}},description:``}}}})))()}var Hx,Ux;function Wx(){return(Wx=t((()=>{Hx=e(i(),1),fs(),oi(),Ux=()=>{let[e,t]=Hx.useState(()=>new N(us)),n=Hx.useRef(e);return n.current=e,(0,Hx.useEffect)(()=>{n.current.disposed&&t(new N(us))},[]),(0,Hx.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,Hx.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var Gx,Kx,qx;function Jx(){return(Jx=t((()=>{Gx=i(),Ug(),Wx(),Kx=o(),qx=e=>{let t=Ux(),{engine:n}=t,r=(0,Gx.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,Gx.useEffect)(()=>{r.current?.(n)},[n]),(0,Gx.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,Kx.jsx)(Hg.Provider,{value:t,children:e.children})},qx.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var Yx,Xx,Zx,Qx,$x,eS,tS;function nS(){return(nS=t((()=>{Yx=i(),Vx(),Jx(),Xx=o(),Zx=`scene`,Qx=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},$x=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),eS=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),tS=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,Yx.useState)(e.sceneData),[a,o]=(0,Yx.useState)(e.editorData),[s,c]=(0,Yx.useState)([]),[l,u]=(0,Yx.useState)(null),d=(0,Yx.useCallback)(async e=>{let t=await Qx(`${n}/scenes/${e}`);if(!t)throw Error(`シーンを読み込めません: ${e}`);u(e),i(t)},[n]);(0,Yx.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([Qx(`${n}/editor`),Qx(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[Zx]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]),(0,Yx.useEffect)(()=>{l&&(document.title=`${l} | OREngine`)},[l]);let f={names:s,current:l,onSelect:d,onCreate:(0,Yx.useCallback)(async(e,t)=>{let r=eS(e);if(t!==void 0){let i=await Qx(`${n}/scenes/${t}`);if(!i)throw Error(`複製元のシーンを読み込めません: ${t}`);r={...i,name:e}}let i=await $x(`${n}/scenes/${e}`,r);if(!i.ok)throw Error(`シーンを作成できません: ${e}（HTTP ${i.status}）`);let a=await Qx(`${n}/scenes`);a&&c(a)},[n]),onDelete:(0,Yx.useCallback)(async e=>{let t=await fetch(`${n}/scenes/${e}`,{method:`DELETE`});if(!t.ok)throw Error(`シーンを削除できません: ${e}（HTTP ${t.status}）`);let r=await Qx(`${n}/scenes`)??[];c(r),e===l&&r.length>0&&await d(r[0])},[n,l,d])};return(0,Xx.jsx)(qx,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,Xx.jsx)(Bx,{editorData:a,projectName:t,panels:e.panels,scenes:f,onSave:async(t,r)=>{e.onBeforeSave?.();let i=[$x(`${n}/editor`,{...r,[Zx]:l})];l&&i.push($x(`${n}/scenes/${l}`,t));for(let e of await Promise.all(i))if(!e.ok)throw Error(`保存に失敗しました（POST ${new URL(e.url).pathname}: HTTP ${e.status}）`)}})})},tS.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var rS,iS;function aS(){return(aS=t((()=>{Vx(),Jx(),rS=o(),iS=e=>(0,rS.jsx)(qx,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,rS.jsx)(Bx,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),iS.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}var oS,sS,cS;function lS(){return(lS=t((()=>{oS=`InputGroup__group___Lmdyb`,sS=`InputGroup__submit___Lmdyb`,cS={group:oS,submit:sS}})))()}var uS,dS,fS;function pS(){return(pS=t((()=>{uS=i(),w(),Ii(),lS(),dS=o(),fS=e=>{let t=e.initialValues,n=[],[r,i]=(0,uS.useState)(t);(0,uS.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,dS.jsx)(Fi,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,uS.useRef)(null);return(0,uS.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,dS.jsx)(`div`,{className:cS.group,ref:o,children:(0,dS.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,dS.jsx)(s,{label:e.title,noMargin:!0,children:n}),(0,dS.jsx)(`div`,{className:cS.submit,children:(0,dS.jsx)(c,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},fS.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}function mS(){return(mS=t((()=>{nS(),aS(),Vx(),Ix(),F(),Jx(),Kg(),K_(),Mg(),Vv(),cv(),hv(),Ex(),ab(),Vy(),Bg(),b_(),Ay(),Qi(),Gi(),$y(),eg(),$_(),Ii(),Lh(),pS(),bi(),wi(),Ni(),tg(),Eh(),jh(),Ce()})))()}var hS;function gS(){return(gS=t((()=>{hS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var _S;function vS(){return(vS=t((()=>{_S=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var yS=n({EyeRings:()=>bS}),bS;function xS(){return(xS=t((()=>{M(),gS(),vS(),bS=class extends Ct{constructor(e){super(e);let t=new Zt({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new mn({phase:[`deferred`,`shadowMap`],frag:hS,vert:_S});this.entity.addComponent(A,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var SS;function CS(){return(CS=t((()=>{SS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ES=n({FlashLine:()=>DS}),DS;function OS(){return(OS=t((()=>{O(),M(),CS(),TS(),DS=class extends Ct{geometry;material;constructor(e){super(e),this.geometry=new kt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=Ae.randomVector().multiply(new E(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new mn({phase:[`forward`,`envMap`],frag:en(`flFrag`,SS),vert:en(`flVert`,wS)}),this.entity.addComponent(A,{material:this.material,geometry:this.geometry})}}})))()}var kS;function AS(){return(AS=t((()=>{kS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var jS=n({SkyBox:()=>MS}),MS;function NS(){return(NS=t((()=>{M(),AS(),MS=class extends Ct{material;constructor(e){super(e);let t=this.engine;this.material=new mn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:en(`SkyBoxFrag`,kS),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}}})))()}var PS;function FS(){return(FS=t((()=>{PS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var RS=n({GridCross:()=>zS}),zS;function BS(){return(BS=t((()=>{O(),M(),FS(),LS(),zS=class extends Ct{constructor(e){super(e);let t=new Dt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new E(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new mn({frag:en(`gridCrossFrag`,PS),vert:en(`gridCrossVert`,IS),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var VS;function HS(){return(HS=t((()=>{VS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var GS=n({GridDots:()=>KS}),KS;function qS(){return(qS=t((()=>{O(),M(),HS(),WS(),KS=class extends Ct{constructor(e){super(e);let t=new Nt({radius:.1}),n=[],r=[],i=new E(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new mn({frag:en(`gridDotsFrag`,VS),vert:en(`gridDotsVert`,US),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var JS;function YS(){return(YS=t((()=>{JS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var QS=n({WireCube:()=>$S}),$S;function eC(){return(eC=t((()=>{M(),YS(),ZS(),$S=class extends Ct{constructor(e){super(e);let t=3.3,n=t/2,r=new Dt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new mn({phase:[`deferred`],frag:JS,vert:XS});this.entity.addComponent(A,{geometry:r,material:o})}}})))()}var tC;function nC(){return(nC=t((()=>{tC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var aC=n({OREngineCube:()=>oC}),oC;function sC(){return(sC=t((()=>{M(),fi(),nC(),iC(),oC=class extends Ct{material;constructor(e){super(e),this.material=new mn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:en(`OREngineCubeVert`,rC),frag:en(`OREngineCubeFrag`,tC),uniforms:{uNoiseTex:{value:N.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var cC;function lC(){return(lC=t((()=>{cC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var uC;function dC(){return(dC=t((()=>{uC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var fC=n({OREngineLogo:()=>pC}),pC;function mC(){return(mC=t((()=>{M(),lC(),dC(),pC=class extends Ct{material;constructor(e){super(e),this.material=new mn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:en(`OREngineLogoVert`,uC),frag:en(`OREngineLogoFrag`,cC)});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var hC;function gC(){return(gC=t((()=>{hC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var _C;function vC(){return(vC=t((()=>{_C=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var yC=n({Dust:()=>bC}),bC;function xC(){return(xC=t((()=>{O(),M(),gC(),vC(),bC=class extends Ct{constructor(e){super(e);let t=new Tt,n=e.args?.num||2048,r=new E(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new mn({phase:[`forward`],drawType:`POINTS`,frag:hC,vert:_C});this.entity.addComponent(A,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var SC;function CC(){return(CC=t((()=>{SC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var wC;function TC(){return(TC=t((()=>{wC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var dw;function fw(){return(fw=t((()=>{uw(),dw={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:lw}})))()}var pw;function mw(){return(mw=t((()=>{pw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var hw;function gw(){return(gw=t((()=>{mw(),hw={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:pw}})))()}var _w;function vw(){return(vw=t((()=>{_w=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var yw;function bw(){return(bw=t((()=>{vw(),yw={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:_w}})))()}var xw;function Sw(){return(Sw=t((()=>{vw(),xw={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:_w}})))()}var Cw,ww,Tw;function Ew(){return(Ew=t((()=>{fw(),gw(),bw(),Sw(),fi(),Cw=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":dw,"/demo-webgl/Resources/Textures/noise.tex":hw,"/demo-webgl/Resources/Textures/noiseCyclic.tex":yw,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":xw}),ww=()=>{for(let e of Object.values(Cw))e&&N.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},Tw=e=>{N.resources.buildTextureInstances(e.renderer)}})))()}var Dw,Ow,kw,Aw,jw;function Mw(){return(Mw=t((()=>{xS(),OS(),NS(),BS(),qS(),eC(),sC(),mC(),xC(),AC(),FC(),fs(),fi(),cw(),Ew(),Dw=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":yS,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":ES,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":jS,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":RS,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":GS,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":QS,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":aC,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":fC,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":yC,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":OC,"/demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":NC}),Ow=Object.assign({}),kw=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);kw(a,e)}}},Aw=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);Aw(a,e)}}},jw=()=>{yt.gltfLoaderFactory=e=>new is(e),N.resources.clear();let e=N.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,zt),e.addComponent(`Camera`,Ft),e.addComponent(`Mesh`,A);let t=Object.keys(ow);for(let e=0;e<t.length;e++){let n=t[e],r=ow[n],i=N.resources.addComponentGroup(n);kw(r,i)}let n=Object.keys(sw);for(let e=0;e<n.length;e++){let t=n[e],r=sw[t],i=N.resources.addGeometryGroup(t);Aw(r,i)}let r=ti(Dw,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=N.resources.addComponentGroup(t);kw(n,a)}let a=ti(Ow,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=N.resources.addGeometryGroup(t);Aw(n,r)}ww()}})))()}var Nw,Pw,Fw,Iw,Lw,Rw;function zw(){return(zw=t((()=>{Nw=i(),mS(),w(),Mw(),Pw=o(),jw(),Fw=({setup:e})=>{let{editor:t}=P();return(0,Nw.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},Iw=e=>(0,Pw.jsx)(qx,{project:e.fixture.scene,onEngineInit:Tw,children:(0,Pw.jsx)(Fx,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,Pw.jsx)(x,{children:(0,Pw.jsxs)(ne,{children:[e.children,e.fixture.setup&&(0,Pw.jsx)(Fw,{setup:e.fixture.setup}),(0,Pw.jsx)(y,{}),(0,Pw.jsx)(te,{})]})})})}),Lw=e=>t=>(0,Pw.jsx)(Iw,{fixture:e,children:(0,Pw.jsx)(t,{})}),Rw=e=>t=>(0,Pw.jsx)(qx,{project:e,onEngineInit:Tw,children:(0,Pw.jsx)(t,{})}),Iw.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var Bw,Vw,Hw,Uw,Ww;function Gw(){return(Gw=t((()=>{Bw={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`LookAt`,uuid:`sb-camera-lookat`}]},Vw={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[Bw,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},Hw={...Vw,scene:{name:`root`,uuid:`0`,childs:[Bw]}},Uw={enableRender:!0,"viewports/main/resolutionScale":.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},Ww={scene:Vw,editorData:Uw}})))()}export{Zi as A,F as B,Bg as C,eg as D,$h as E,Ni as F,fi as H,Ci as I,wi as L,Fi as M,Ii as N,Ih as O,Mi as P,yi as R,zg as S,Mg as T,N as U,P as V,oi as W,Vy as _,Vw as a,G_ as b,Lw as c,pS as d,Bx as f,By as g,Ex as h,Ww as i,Qi as j,Lh as k,Rw as l,Tx as m,Uw as n,Iw as o,Vx as p,Hw as r,zw as s,Gw as t,fS as u,ky as v,jg as w,K_ as x,Ay as y,bi as z};