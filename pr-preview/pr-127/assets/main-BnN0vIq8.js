...
}`,$p=class extends Ft{wrapperElm;glCanvas;backend;gl;canvasTexture;canvas;canvasCtx;glRenderer;postProcess;viewPort;viewPortRange;viewPortScale;frameSetting;loopSetting;musicBuffer;musicTexture;resizeObserver;canvasSize;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.glCanvas=document.createElement(`canvas`),this.backend=new At(this.glCanvas.getContext(`webgl2`)),this.gl=this.backend.gl,this.canvasSize=new A(this.glCanvas.width,this.glCanvas.height),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0],this.viewPortScale=50,this.frameSetting=null,this.loopSetting={enabled:!1,start:0,end:0},this.resizeObserver=new ResizeObserver(this.onResize.bind(this));let e={renderer:null,createEntity:t=>new nn({...t,engine:e})};this.glRenderer=new rr(this.backend,e),e.renderer=this.glRenderer,this.canvasTexture=new Et(this.gl),this.musicBuffer=null,this.musicTexture=new Et(this.gl),this.musicTexture.setting({type:this.gl.UNSIGNED_BYTE,internalFormat:this.gl.LUMINANCE,format:this.gl.LUMINANCE,magFilter:this.gl.LINEAR,minFilter:this.gl.LINEAR,wrapS:this.gl.MIRRORED_REPEAT}),this.postProcess=new fn({passes:[new P(this.backend,{frag:Qp,uniforms:{uCanvasTex:{type:`1i`,value:null},uMusicTex:{type:`1i`,value:this.musicTexture}},renderTarget:null})]})}onResize(){if(this.wrapperElm){let e=new A(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);if(e.x===0||e.y===0)return;this.glCanvas.width=this.canvas.width=e.x,this.glCanvas.height=this.canvas.height=e.y,this.canvasSize.set(this.glCanvas.width,this.glCanvas.height),this.postProcess.resize(e),this.render()}}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.frameSetting){this.canvasCtx.fillStyle=`#181818`;let e=this.frameToPx(0),t=this.frameToPx(this.frameSetting.duration);this.canvasCtx.fillRect(e,0,t-e,this.canvas.height)}let e=(e,t,n)=>{let r=Math.ceil(this.viewPort[0]/e)*e;this.canvasCtx.beginPath();let i=0;for(;r<this.viewPort[2]&&i<100;){let n=this.frameToPx(r+t);this.canvasCtx.moveTo(n,0),this.canvasCtx.lineTo(n,this.canvas.height),r+=e,i++}this.canvasCtx.strokeStyle=n,this.canvasCtx.lineWidth=1,this.canvasCtx.stroke()};if(e(this.viewPortScale,0,`#555`),e(this.viewPortScale,this.viewPortScale/2,`#333`),this.musicBuffer&&this.frameSetting){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)],s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}if(this.loopSetting.enabled){this.canvasCtx.fillStyle=`#0009`;let e=this.frameToPx(this.loopSetting.start),t=this.frameToPx(this.loopSetting.end);this.canvasCtx.fillRect(0,0,e,this.canvas.height),this.canvasCtx.fillRect(t,0,this.canvas.width-t,this.canvas.height)}this.canvasTexture.attach(this.canvas),this.postProcess.passes&&(this.postProcess.passes[0].uniforms.uCanvasTex.value=this.canvasTexture),this.glRenderer.renderPostProcess(this.postProcess,void 0,this.canvasSize)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.glCanvas),this.onResize()}setViewPort(e,t){this.viewPort=e,this.viewPortRange=[e[2]-e[0],e[3]-e[1]],this.viewPortScale=t,this.render()}setFrameSetting(e){this.frameSetting={duration:Math.round(e.duration),fps:Math.round(e.fps)},this.render()}setMusicBuffer(e){this.musicBuffer=e,setTimeout(()=>{this.render()},100)}setLoopSetting(e,t,n){this.loopSetting={enabled:e,start:t,end:n},this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.glCanvas),this.resizeObserver.disconnect()}},em={timelineCanvas:`TimelineCanvas__timelineCanvas___LnRpb`},tm=()=>{let{viewPort:e,viewPortScale:t,musicBuffer:n,musicBufferVersion:r,glEditor:i}=Zp(),[a,o]=(0,b.useState)(),s=(0,b.useRef)(null);(0,b.useEffect)(()=>{let e=new $p;return o(e),s.current&&e.setWrapperElm(s.current),()=>{e.dispose()}},[]),(0,b.useEffect)(()=>{a&&e&&t&&a.setViewPort(e,t)},[a,e,t]);let[c]=Q(i?.engine,`timeline/duration`),[l]=Q(i?.engine,`timeline/fps`);(0,b.useEffect)(()=>{a&&c&&l&&a.setFrameSetting({duration:c||0,fps:l||0})},[a,c,l]);let[u]=Q(i,`frameLoop/enabled`),[d]=Q(i,`frameLoop/start`),[f]=Q(i,`frameLoop/end`);return(0,b.useEffect)(()=>{a&&a.setLoopSetting(u||!1,d||0,f||0)},[a,u,d,f]),(0,b.useEffect)(()=>{a&&n&&a.setMusicBuffer(n)},[a,n,r]),(0,T.jsx)(`div`,{className:em.timelineCanvas,ref:s})},nm={controls:`TimelineControls__controls___LmNvb`},rm=e=>{let{viewPort:t,setCurrentFrame:n,getFrameViewPort:r,zoom:i,scroll:a,setViewPortCenter:o}=Zp(),s=(0,b.useRef)([0,0,0,0]),c=(0,b.useRef)([0,0]);t&&(s.current=t,c.current=[t[2]-t[0],t[3]-t[1]]);let l=(0,b.useRef)(null),u=(0,b.useRef)(null),d=(0,b.useRef)(null),f=(0,b.useRef)(null),p=(0,b.useRef)(null),m=(0,b.useCallback)(e=>{let t=l.current&&l.current.clientWidth||1;if(d.current==0){if(n&&r&&u.current){let i=(e.clientX-u.current.left)/t;n(r(i))}}else if(d.current==1){let n=[e.clientX,e.clientY];if(f.current&&p.current){let e=-(n[0]-f.current[0])/t*c.current[0];o&&o(p.current+e)}}},[n,r,o]),h=(0,b.useCallback)(e=>{d.current=e.button,p.current=(s.current[2]+s.current[0])/2,f.current=[e.clientX,e.clientY],u.current=e.currentTarget.getBoundingClientRect();let t=(e.clientX-u.current.left)/e.currentTarget.clientWidth;d.current==0&&n&&r&&n(r(t)),window.addEventListener(`pointermove`,m);let i=()=>{f.current=null,d.current=null,p.current=null,window.removeEventListener(`pointermove`,m)};return window.addEventListener(`pointerup`,i),()=>{window.removeEventListener(`pointerup`,i),window.removeEventListener(`pointermove`,m)}},[r,n,m]),g=(0,b.useCallback)(e=>{if(d.current!==null||!i||!a)return;e.preventDefault();let t=e.target&&e.target.clientWidth||1,n=Math.abs(e.deltaY);Math.abs(e.deltaX)<n?i(n>50?e.deltaY<0?.9:1.1:1+e.deltaY*.005):a(e.deltaX/t*.5)},[i,a]);return(0,b.useEffect)(()=>{let e=l.current;return e&&e.addEventListener(`wheel`,g,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,g)}},[g]),t?(0,T.jsx)(`div`,{className:nm.controls,onPointerDown:h,ref:l,children:e.children}):null},im={cursor:`TimelineCursor__cursor___LmN1c`,frame:`TimelineCursor__frame___LmN1c`},am=()=>{let{viewPort:e,framePlay:t}=Zp();if(!e||!t)return null;let n=e[2]-e[0],r=(t.current-e[0])/n;return(0,T.jsx)(`div`,{className:im.cursor,style:{left:r*100+`%`},children:(0,T.jsx)(`div`,{className:im.frame})})},om={timelineLoop:`TimelineLoop__timelineLoop___LnRpb`,start:`TimelineLoop__start___LnRpb`,end:`TimelineLoop__end___LnRpb`},sm={cursor:`TimelineLoopCursor__cursor___LmN1c`},cm=({onMove:e})=>{let t=(0,b.useRef)(!1);return(0,T.jsx)(`div`,{className:sm.cursor,onPointerDown:e=>{e.buttons==1&&(t.current=!0,e.stopPropagation())},onPointerMove:n=>{let r=n.target;t.current!==!1&&n.buttons==1&&(r.setPointerCapture(n.pointerId),n.buttons==1&&e&&e(n.clientX),n.nativeEvent.preventDefault(),n.nativeEvent.stopPropagation())},onPointerUp:()=>{t.current=!1}})},lm=()=>{let{viewPort:e,framePlay:t,glEditor:n}=Zp(),r=(0,b.useRef)(null);vf(n,[`frameLoop/enabled`,`frameLoop/start`,`frameLoop/end`]);let[i]=Q(n,`frameLoop/enabled`),[a,o]=Q(n,`frameLoop/start`),[s,c]=Q(n,`frameLoop/end`);if(i!==!0||!e||!t||a===void 0||s===void 0)return null;let l=e[2]-e[0],u=(a-e[0])/l,d=(s-e[0])/l,f=(t,n)=>{let r=t.getBoundingClientRect();return(n-r.x)/r.width*(e[2]-e[0])+e[0]};return(0,T.jsx)(`div`,{className:om.timelineLoop,ref:r,children:(0,T.jsxs)(`div`,{className:om.timelineLoop_inner,children:[(0,T.jsx)(`div`,{className:om.start,style:{left:u*100+`%`},children:(0,T.jsx)(cm,{onMove:e=>{r.current&&o&&o(f(r.current,e))}})}),(0,T.jsx)(`div`,{className:om.end,style:{left:d*100+`%`},children:(0,T.jsx)(cm,{onMove:e=>{r.current&&c&&c(f(r.current,e))}})})]})})},um={scale:`TimelineScale__scale___LnNjY`,scale_inner:`TimelineScale__scale_inner___LnNjY`,scale_item:`TimelineScale__scale_item___LnNjY`,scale_item_frame:`TimelineScale__scale_item_frame___LnNjY`,scale_item_time:`TimelineScale__scale_item_time___LnNjY`},dm=e=>`${(`00`+Math.floor(e%3600/60)).slice(-2)}:${(`00`+Math.floor(e%60)).slice(-2)}`,fm=()=>{let{glEditor:e,viewPort:t,viewPortScale:n}=Zp(),[r,i]=Q(e?.engine,`timeline/fps`);if(!t||!n||r===void 0)return null;let a=[],o=Math.ceil(t[0]/n)*n,s=0;for(;o<t[2]&&s<100;){let e=(o-t[0])/(t[2]-t[0]),i=o/(r||0);a.push((0,T.jsxs)(`div`,{className:um.scale_item,style:{left:e*100+`%`},children:[(0,T.jsx)(`div`,{className:um.scale_item_frame,children:o}),(0,T.jsx)(`div`,{className:um.scale_item_time,children:dm(i)})]},o)),o+=n,s++}return(0,T.jsx)(`div`,{className:um.scale,children:(0,T.jsx)(`div`,{className:um.scale_inner,children:a})})},pm={timelineSetting:`TimelineSetting__timelineSetting___LnRpb`,play:`TimelineSetting__play___LnRpb`},mm=()=>{let{framePlay:e,glEditor:t}=Zp(),n=(0,b.useCallback)((e,t)=>{t&&t(e)},[]),[r,i]=Q(t,`frameLoop/enabled`),[a]=Q(t?.engine,`timeline/duration`),[o]=Q(t?.engine,`timeline/fps`),s=(0,b.useCallback)((e,n)=>{t&&t.api.setField(t.engine,e,n)},[t]),c=(0,b.useCallback)(()=>{t&&t.togglePlay()},[t]);return(0,T.jsx)(`div`,{className:pm.timelineSetting,children:(0,T.jsxs)(nt,{children:[(0,T.jsx)(`div`,{className:pm.play,children:(0,T.jsx)(ae,{onClick:c,children:e.playing?(0,T.jsx)(fe,{size:14}):(0,T.jsx)(pe,{size:14})})}),(0,T.jsx)(He,{title:`current`,children:(0,T.jsx)(Wr,{value:Math.floor(e?.current||0),readOnly:!0})}),(0,T.jsx)(He,{title:`duration`,children:(0,T.jsx)(Wr,{value:a,onChange:e=>s(`timeline/duration`,e)})}),(0,T.jsx)(He,{title:`fps`,children:(0,T.jsx)(Wr,{value:o,onChange:e=>s(`timeline/fps`,e)})}),(0,T.jsx)(He,{title:`loop`,children:(0,T.jsx)(Wr,{value:r||!1,onChange:e=>n(e,i)})})]})})},hm={timeline:`Timeline__timeline___LnRpb`,inner:`Timeline__inner___LnRpb`,content:`Timeline__content___LnRpb`,setting:`Timeline__setting___LnRpb`},gm=()=>{let{editor:e}=zr(),[t,n]=(0,b.useState)({current:0,playing:!1}),[r,i]=(0,b.useState)([0,0,100,0]),a=(0,b.useRef)([0,0,0,0]);a.current=r;let o=r[2]-r[0],s=10*2**(0+Math.floor(Math.log2(o/100)));s=Math.max(1,Math.floor(s));let c=e?.audioBuffer,[l,u]=(0,b.useState)();(0,b.useEffect)(()=>{if(e){let t=e.engine,r=e=>{n({...e})};r(t.frame);let a=0,o=()=>{u(a++)},s=()=>{i([0,0,t.frameSetting.duration,0])};return s(),t.on(`update/frame/play`,r),t.on(`update/music`,o),t.on(`loaded`,s),()=>{t.off(`update/frame/play`,r),t.off(`update/music`,o),t.off(`loaded`,s)}}},[e]);let d=(0,b.useCallback)(t=>{e&&e.engine.seek(t)},[e]),f=(0,b.useCallback)(e=>{let t=r[2]-r[0];return Math.floor(r[0]+t*e)},[r]),p=(0,b.useCallback)(e=>{let t=a.current,n=(t[2]+t[0])/2,r=(t[0]-n)*e+n,o=(t[2]-n)*e+n;i([r,t[1],o,t[3]])},[]),m=(0,b.useCallback)(e=>{let t=a.current,n=e*(t[2]-t[0]);i([t[0]+n,t[1],t[2]+n,t[3]])},[]),h=(0,b.useCallback)(e=>{let t=a.current,n=t[2]-t[0];i([e-n/2,t[1],e+n/2,t[3]])},[]);return{glEditor:e,framePlay:t,viewPort:r,viewPortScale:s,musicBuffer:c,musicBufferVersion:l,setCurrentFrame:d,getFrameViewPort:f,zoom:p,scroll:m,setViewPortCenter:h}},_m=e=>{let t=gm();return(0,T.jsx)(Xp.Provider,{value:t,children:e.children})},vm=()=>(0,T.jsx)(_m,{children:(0,T.jsx)(`div`,{className:hm.timeline,children:(0,T.jsxs)(`div`,{className:hm.inner,children:[(0,T.jsx)(`div`,{className:hm.setting,children:(0,T.jsx)(mm,{})}),(0,T.jsxs)(`div`,{className:hm.content,children:[(0,T.jsx)(tm,{}),(0,T.jsx)(am,{}),(0,T.jsx)(rm,{children:(0,T.jsx)(lm,{})}),(0,T.jsx)(fm,{})]})]})})}),ym={editor:`OREditor__editor___LmVka`},bm=e=>{let{engine:t}=Bf(),[n,r]=(0,b.useState)(()=>new mf(t)),i=b.useRef(n);return i.current=n,(0,b.useEffect)(()=>{if(!i.current.disposed&&i.current.engine.uuid==t.uuid)return;let e=new mf(t);r(e)},[t]),(0,b.useEffect)(()=>()=>{n.dispose()},[n]),{engine:t,editor:n,projectName:e}},xm=e=>{let t=bm(e.projectName),n=(0,b.useRef)(Promise.resolve());(0,b.useEffect)(()=>{if(!t.editor||!e.onSave)return;let r=e.onSave,i=(e,t)=>{n.current=Promise.resolve(r(e,t))};return t.editor.on(`save`,i),()=>{t.editor.off(`save`,i)}},[t.editor,e.onSave]);let r=(0,b.useRef)(null),i=e.scenes??null;return(0,b.useEffect)(()=>{r.current=i},[i]),(0,b.useEffect)(()=>Ea({editor:t.editor,getScenes:()=>r.current,waitForSave:()=>n.current}),[t.editor]),(0,b.useEffect)(()=>{t.editor&&t.editor.bootstrap(e.editorData)},[e.editorData,t.editor]),(0,T.jsx)(Rr.Provider,{value:{...t,scenes:e.scenes},children:e.children})},Sm=[{id:`hierarchy`,title:`Hierarchy`,category:`General`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(ep,{})})},{id:`timer`,title:`Timer`,category:`Rendering`,content:(0,T.jsx)(nt,{noPadding:!0,children:(0,T.jsx)(qf,{})})},{id:cp,title:`Screen`,category:`General`,multiple:!0,content:e=>(0,T.jsx)(lp,{viewportId:e})},{id:`property`,title:`Property`,category:`General`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(If,{})})},{id:`textures`,title:`Textures`,category:`Rendering`,content:(0,T.jsx)(nt,{noPadding:!0,children:(0,T.jsx)(Yp,{})})},{id:`scene`,title:`Scene`,category:`General`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(qp,{})})},{id:`export`,title:`Export`,category:`Project`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(Rf,{})})},{id:`renderer`,title:`Renderer`,category:`Rendering`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(Hp,{})})},{id:`editor-settings`,title:`Editor`,category:`Project`,content:(0,T.jsx)(nt,{children:(0,T.jsx)(Qr,{})})},{id:`timeline`,title:`Timeline`,category:`Animation`,content:(0,T.jsx)(nt,{noPadding:!0,children:(0,T.jsx)(vm,{})})}],Cm=e=>{let t=[];for(let n of e)n.multiple||n.id!==`hierarchy`&&n.id!==`property`&&n.id!==`timeline`&&t.push({id:n.id,title:n.title,content:n.content});return t},wm=e=>{let t=vt(),n=(0,b.useMemo)(()=>e.panels?[...Sm,...e.panels]:Sm,[e.panels]),r=null;return r=t.isPC?(0,T.jsx)(Bp,{panels:n}):(0,T.jsx)(T.Fragment,{children:(0,T.jsxs)(qe,{direction:`vertical`,storageKey:`orengine-editor-sp-main`,children:[(0,T.jsx)(qe.Item,{size:`calc( min( 56.25vw, 55vh ) + 77px )`,minSize:200,style:{minHeight:`200px`},children:(0,T.jsx)(lp,{viewportId:`main`})}),(0,T.jsx)(qe.Item,{flex:1,minSize:200,children:(0,T.jsxs)(at,{storageKey:`orengine-panel-sp-main`,children:[(0,T.jsx)(at.Tab,{title:`Hierarchy / Property`,children:(0,T.jsxs)(qe,{direction:`horizontal`,storageKey:`orengine-editor-sp-hierarchyProp`,children:[(0,T.jsx)(qe.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,T.jsx)(ep,{})}),(0,T.jsx)(qe.Item,{flex:1,minSize:120,overflow:!0,padding:!0,children:(0,T.jsx)(If,{})})]})}),Cm(n).map(e=>(0,T.jsx)(at.Tab,{title:e.title,children:e.content},e.id))]})}),(0,T.jsx)(qe.Item,{size:`120px`,minSize:80,children:(0,T.jsx)(at,{storageKey:`orengine-panel-sp-timeline`,children:(0,T.jsx)(at.Tab,{title:`Timeline`,children:(0,T.jsx)(nt,{noPadding:!0,children:(0,T.jsx)(C,{fallback:(0,T.jsx)(`div`,{children:`エラーだよ`}),children:(0,T.jsx)(vm,{})})})})})})]})}),(0,T.jsx)(xm,{projectName:e.projectName,onSave:e.onSave,editorData:e.editorData,scenes:e.scenes,children:(0,T.jsx)(pt,{children:(0,T.jsxs)(Be,{children:[(0,T.jsx)(`div`,{className:ym.editor,children:r}),(0,T.jsx)(gf,{}),(0,T.jsx)(Re,{}),(0,T.jsx)(ut,{})]})})})},Tm=()=>{let[e,t]=b.useState(()=>new F(ir)),n=b.useRef(e);return n.current=e,(0,b.useEffect)(()=>{n.current.disposed&&t(new F(ir))},[]),(0,b.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,b.useCallback)(t=>{t&&e.load(t)},[e])}},Em=e=>{let t=Tm(),{engine:n}=t,r=(0,b.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,b.useEffect)(()=>{r.current?.(n)},[n]),(0,b.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,T.jsx)(zf.Provider,{value:t,children:e.children})},Dm=e=>(0,T.jsx)(Em,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,T.jsx)(wm,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),Om=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Am=s({EyeRings:()=>jm}),jm=class extends Gt{constructor(e){super(e);let t=new rn({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new dn({phase:[`deferred`,`shadowMap`],frag:Om,vert:km});this.entity.addComponent(N,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(N)}},Mm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Lm=s({SkyBox:()=>Rm}),Rm=class extends Gt{material;constructor(e){super(e);let t=this.engine;this.material=new dn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:on(`SkyBoxFrag`,Im),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}},zm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Vm=s({GridCross:()=>Hm}),Hm=class extends Gt{constructor(e){super(e);let t=new qt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new A(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new dn({frag:on(`gridCrossFrag`,zm),vert:on(`gridCrossVert`,Bm),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},Um=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Gm=s({GridDots:()=>Km}),Km=class extends Gt{constructor(e){super(e);let t=new Xt({radius:.1}),n=[],r=[],i=new A(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new dn({frag:on(`gridDotsFrag`,Um),vert:on(`gridDotsVert`,Wm),phase:[`forward`]});this.entity.addComponent(N,{geometry:t,material:a})}},qm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,Ym=s({WireCube:()=>Xm}),Xm=class extends Gt{constructor(e){super(e);let t=3.3,n=t/2,r=new qt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new dn({phase:[`deferred`],frag:qm,vert:Jm});this.entity.addComponent(N,{geometry:r,material:o})}},Zm=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,$m=s({OREngineCube:()=>eh}),eh=class extends Gt{material;constructor(e){super(e),this.material=new dn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:on(`OREngineCubeVert`,Qm),frag:on(`OREngineCubeFrag`,Zm),uniforms:{uNoiseTex:{value:F.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(N);t&&(t.material=this.material)}},th=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,rh=s({OREngineLogo:()=>ih}),ih=class extends Gt{material;constructor(e){super(e),this.material=new dn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:on(`OREngineLogoVert`,nh),frag:on(`OREngineLogoFrag`,th)});let t=this.entity.getComponent(N);t&&(t.material=this.material)}},ah=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,sh=s({Dust:()=>ch}),ch=class extends Gt{constructor(e){super(e);let t=new Kt,n=e.args?.num||2048,r=new A(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new dn({phase:[`forward`],drawType:`POINTS`,frag:ah,vert:oh});this.entity.addComponent(N,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(N)}},lh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `,fh=s({YakiSoba:()=>ph}),ph=class extends Gt{_gpu;constructor(e){super(e);let t=this.engine,n=new A(64,512);this._gpu=new cr({passes:[new lr(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:on(`yakiSobaCompute`,dh),uniforms:ln.merge({},t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new qt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new dn({frag:on(`chainFrag`,lh),vert:on(`chainVert`,uh),phase:[`deferred`,`shadowMap`],uniforms:ln.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(N,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(N),this._gpu.dispose()}},mh=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `},Ih={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `,Rh=Object.assign({"../../demo-webgl/Resources/Textures/hash.tex":Fh,"../../demo-webgl/Resources/Textures/noise.tex":Ih,"../../demo-webgl/Resources/Textures/noiseCyclic.tex":{name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:Lh},"../../demo-webgl/Resources/Textures/noiseCyclicAnime.tex":{name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:Lh}}),zh=()=>{for(let e of Object.values(Rh))e&&F.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},Bh=e=>{F.resources.buildTextureInstances(e.renderer)},Vh=Object.assign({"../../demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":Am,"../../demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":Pm,"../../demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":Lm,"../../demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":Vm,"../../demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":Gm,"../../demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":Ym,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":$m,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":rh,"../../demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":sh,"../../demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":fh,"../../demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":hh}),Hh=Object.assign({}),Uh=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addComponent(i,a):Uh(a,t.createGroup(i))}},Wh=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addGeometry(i,a):Wh(a,t.createGroup(i))}},Gh=()=>{Ut.gltfLoaderFactory=e=>new Ar(e),F.resources.clear();let e=F.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,$t),e.addComponent(`Camera`,Zt),e.addComponent(`Mesh`,N);let t=Object.keys(Nh);for(let e=0;e<t.length;e++){let n=t[e],r=Nh[n];Uh(r,F.resources.addComponentGroup(n))}let n=Object.keys(Ph);for(let e=0;e<n.length;e++){let t=n[e],r=Ph[t];Wh(r,F.resources.addGeometryGroup(t))}let r=Nr(Vh,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t];Uh(n,F.resources.addComponentGroup(t))}let a=Nr(Hh,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t];Wh(n,F.resources.addGeometryGroup(t))}zh()},Kh=s({panel:()=>qh}),qh={id:`sample`,title:`Sample`,category:`Tools`,content:(0,T.jsx)(()=>{let{editor:e,engine:t}=zr(),[n]=Q(e,`selectedEntityId`),[r,i]=(0,b.useState)(``),a=n?t.root.findEntityByUUID(n):void 0;return(0,T.jsxs)(nt,{children:[(0,T.jsx)(re,{label:`Selected Entity`,children:a?a.name:`-`}),(0,T.jsxs)(re,{label:`Server`,children:[(0,T.jsx)(ae,{onClick:async()=>{try{let e=await(await fetch(`/api/ext/hello`)).json();i(e.message)}catch{i(`failed`)}},children:`GET /api/ext/hello`}),r&&(0,T.jsx)(`p`,{children:r})]})]})},{})},Jh=Object.assign({"../../demo-webgl/editor/Panels/Sample/index.tsx":Kh}),Yh=(()=>{let e=[],t=Object.keys(Jh);for(let n=0;n<t.length;n++){let r=Jh[t[n]].panel;r&&e.push(r)}return e})();document.title=`${y.name} | OREngine`,Gh(),_.createRoot(document.getElementById(`root`)).render((0,T.jsx)(Dm,{projectName:`demo-webgl`,sceneData:y,editorData:v,initResourceInstances:Bh,panels:Yh}));