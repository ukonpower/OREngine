...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}}})))()}var _n;function vn(){return(vn=t((()=>{Tt(),_n=class extends wt{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}}})))()}function yn(){return(yn=t((()=>{})))()}function bn(){return(bn=t((()=>{})))()}var M;function xn(){return(xn=t((()=>{D(),Xe(),gn(),yn(),bn(),M=class extends hn{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var En;function Dn(){return(Dn=t((()=>{ot(),D(),N(),Xe(),Tn(),En=class extends nt{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA,magFilter:O.LINEAR,minFilter:O.LINEAR,wrapS:O.CLAMP_TO_EDGE,wrapT:O.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new T(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA})])});let m=1/4*l,h=new M(e,{renderTarget:s[l].rt1,frag:wn,uniforms:cn.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new T(d,f));let g=new M(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new _n({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}}})))()}var On;function kn(){return(kn=t((()=>{On=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}}})))()}var An,jn,Mn,Nn,Pn,Fn;function In(){return(In=t((()=>{An=[[.1,.0484],[.118,.187],[.113,.567],[.358,1.99],[.078,7.41]],jn=[1,.37,.3],Mn=[.48,.41,.28],Nn=2,Pn=(e,t)=>{let n=e/(.001+jn[t]),r=0;for(let[e,t]of An)r+=e*Math.exp(-(n*n)/(2*t))/(2*Math.PI*t);return r},Fn=e=>{let t=[];for(let n=0;n<e;n++){let r=Nn*n/(e-1);t.push(r*r/Nn)}let n=[];for(let r=0;r<e;r++){let i=0;i=r===0?t[1]:r===e-1?(t[r]-t[r-1])/2:(t[r+1]-t[r-1])/2,n.push(i)}let r=[];for(let i=0;i<3;i++){let a=[],o=0;for(let r=0;r<e;r++){let e=n[r]*Pn(t[r],i);a.push(e),o+=r===0?e:e*2}let s=Mn[i];for(let t=0;t<e;t++){let e=a[t]/o*s;t===0&&(e+=1-s),r[t*4+i]=e}}for(let n=0;n<e;n++)r[n*4+3]=t[n]/Nn;return r}})))()}var Ln;function Rn(){return(Rn=t((()=>{Ln=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
}`})))()}var zn;function Bn(){return(Bn=t((()=>{zn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})))()}var Yn,Xn,Zn;function Qn(){return(Qn=t((()=>{ot(),D(),N(),In(),Xe(),Rn(),Bn(),Hn(),Wn(),Kn(),Jn(),Yn=e=>{let t=[];for(let n=0;n<e;n++){let r=new T;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},Xn=9,Zn=class extends nt{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;shading;sssH;sssV;sssCopy;constructor(e){super();let t=e.backend,n=e.renderTarget,r=new M(t,{name:`normalSelector`,frag:Vn,renderTarget:null,uniforms:cn.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),a=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),o=new M(t,{name:`lightShaft`,frag:zn,renderTarget:i,uniforms:cn.merge({uLightShaftBackBuffer:{value:a.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),c=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR})]),l=new M(t,{name:`ssao`,frag:Un,renderTarget:j(`ssao`,s),uniforms:cn.merge({uSSAOBackBuffer:{value:c.textures[0],type:`1i`},uSSAOKernel:{value:Yn(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),u=cn.merge({uSSAOTexture:{value:c.textures[0],type:`1i`},uPosTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:je.gaussWeights(8)}}),d=new M(t,{name:`ssaoBlur/h`,frag:j(`ssaoBlur`,Gn),uniforms:u,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),f=new M(t,{name:`ssaoBlur/v`,frag:j(`ssaoBlur`,Gn),uniforms:cn.merge(u,{uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),p=new M(t,{name:`deferredShading`,frag:j(`deferredShading`,Ln),uniforms:cn.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:f.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:l.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})}),m=()=>t.createFrameBuffer({disableDepthBuffer:!0}).setTexture([t.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA,magFilter:O.LINEAR,minFilter:O.LINEAR})]),h=cn.merge({uDiffuseTexture:{value:n.shadingBuffer.textures[1],type:`1i`},uAlbedoTexture:{value:n.gBuffer.textures[2],type:`1i`},uPosTexture:{value:n.gBuffer.textures[0],type:`1i`},uNormalTexture:{value:n.normalBuffer.textures[0],type:`1i`},uSSSRadius:{value:.05,type:`1f`},uKernel:{value:Fn(Xn),type:`4fv`}}),g=new M(t,{name:`sss/h`,frag:j(`sss`,qn),uniforms:h,renderTarget:m(),passThrough:!0,defines:{SSS_SAMPLES:Xn}}),_=new M(t,{name:`sss/v`,frag:j(`sss`,qn),uniforms:cn.merge(h,{uDiffuseTexture:{value:g.renderTarget.textures[0],type:`1i`},uShadingTexture:{value:n.shadingBuffer.textures[0],type:`1i`},uShadingDiffuseTexture:{value:n.shadingBuffer.textures[1],type:`1i`}}),renderTarget:m(),defines:{SSS_SAMPLES:Xn,IS_VIRT:``}}),v=new M(t,{name:`sss/copy`,renderTarget:t.createFrameBuffer({disableDepthBuffer:!0}).setTexture([n.shadingBuffer.textures[0]])});this.postprocess=new _n({passes:[r,o,l,d,f,p,g,_,v]}),this.shading=p,this.lightShaft=o,this.ssao=l,this.rtSSAO1=s,this.rtSSAO2=c,this.ssaoBlur=d,this.ssaoBlurV=f,this.sssH=g,this.sssV=_,this.sssCopy=v,this.rtLightShaft1=i,this.rtLightShaft2=a,this.normalSelector_=r;for(let e=0;e<n.gBuffer.textures.length;e++){let t=n.gBuffer.textures[e];e===1&&(t=n.normalBuffer.textures[0]),p.uniforms[`sampler`+e]=l.uniforms[`sampler`+e]={type:`1i`,value:t}}o.uniforms.uDepthTexture.value=n.gBuffer.depthTexture,p.renderTarget=n.shadingBuffer,r.renderTarget=n.normalBuffer,r.uniforms.uNormalTexture.value=n.gBuffer.textures[1],r.uniforms.uPosTexture.value=n.gBuffer.textures[0],r.uniforms.uSelectorTexture.value=n.gBuffer.textures[3],u.uPosTexture.value=n.gBuffer.textures[0],u.uNormalTexture.value=n.normalBuffer.textures[0]}update(){let e=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=e,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],e=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=e,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.sss!==void 0&&(this.sssH.enabled=e.sss,this.sssV.enabled=e.sss,this.sssCopy.enabled=e.sss),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}setSSSRadius(e){this.sssH.uniforms.uSSSRadius.value=e}resize(e){this.postprocess.resize(e)}dispose(){this.postprocess.dispose(),this.rtLightShaft1.dispose(),this.rtLightShaft2.dispose(),this.rtSSAO1.dispose(),this.rtSSAO2.dispose();for(let e of[this.sssH,this.sssV])e.renderTarget.textures[0].dispose(),e.renderTarget.dispose();this.sssCopy.renderTarget.dispose()}}})))()}var $n;function er(){return(er=t((()=>{$n=`uniform sampler2D uShadingTexture;
...
}`})))()}var rr;function ir(){return(ir=t((()=>{rr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
}`})))()}var ar;function or(){return(or=t((()=>{ar=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})))()}var pr;function mr(){return(mr=t((()=>{pr=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`})))()}var hr;function gr(){return(gr=t((()=>{hr=`// https://qiita.com/aa_debdeb/items/26ab808de6745611df53
...
}`})))()}var _r;function vr(){return(vr=t((()=>{_r=`in vec2 vUv;
...
}`})))()}var yr;function br(){return(br=t((()=>{yr=`in vec2 vUv;
uniform sampler2D uBackBuffer0;
uniform sampler2D uVelTex;
uniform vec2 uPPPixelSize;
...
}`})))()}var xr;function Sr(){return(Sr=t((()=>{xr=`in vec2 vUv;
uniform sampler2D uBackBuffer0;
uniform sampler2D uVelTex;
uniform vec2 uPPPixelSize;
...
}`})))()}var Cr;function wr(){return(wr=t((()=>{Cr=`// フレネルと粗さで重み付けして反射色を足す
...
`})))()}var Tr;function Er(){return(Er=t((()=>{Tr=`// 反射方向へレイマーチしてシーンを引く。今フレームの結果だけを出し、時間方向の蓄積は ssrTemporal.fs が行う
...
}`})))()}var Dr;function Or(){return(Or=t((()=>{Dr=`// ssr.fs の今フレームの結果を、前フレームの結果と混ぜて均す。
...
`})))()}var kr,Ar,jr,Mr,Nr;function Pr(){return(Pr=t((()=>{D(),N(),Xe(),er(),nr(),ir(),or(),cr(),ur(),fr(),mr(),gr(),vr(),br(),Sr(),wr(),Er(),Or(),kr=4,Ar=8,jr=14/1080,Mr=e=>e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA,magFilter:O.LINEAR,minFilter:O.LINEAR})]),Nr=class{dofCoc;dofBokeh;dofBlur;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssrTemporal;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;_colorCollection;_bloomBright;_bloomPasses;constructor(e,t){let n=new M(e,{name:`collection`,frag:rr,uniforms:{uToneMap:{value:1,type:`1f`},uExposure:{value:1,type:`1f`}}}),r=new M(e,{name:`ssr`,frag:j(`ssr`,Tr),renderTarget:Mr(e),uniforms:cn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),i=Mr(e),a=Mr(e),o=new M(e,{name:`ssrTemporal`,frag:j(`ssrTemporal`,Dr),renderTarget:i,uniforms:cn.merge({uSSRCurrent:{value:r.renderTarget.textures[0],type:`1i`},uSSRBackBuffer:{value:a.textures[0],type:`1i`},uGbufferPos:{value:null,type:`1i`},uVelTex:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),s=new M(e,{name:`ssComposite`,frag:j(`ssComposite`,Cr),uniforms:cn.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uGbufferMaterial:{value:null,type:`1i`},uSSRTexture:{value:i.textures[0],type:`1i`}}),renderTarget:Mr(e)}),c=new T(10,.05,20,.05),l=new M(e,{name:`dof/coc`,frag:lr,uniforms:cn.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:c,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR,internalFormat:O.RGBA16F,type:O.HALF_FLOAT,format:O.RGBA})]),passThrough:!0,resolutionRatio:.5}),u=new M(e,{name:`dof/bokeh`,frag:sr,uniforms:cn.merge({uCocTex:{value:l.renderTarget.textures[0],type:`1i`},uParams:{value:c,type:`4f`}}),renderTarget:Mr(e),passThrough:!0,resolutionRatio:.5}),d=new M(e,{name:`dof/blur`,frag:ar,uniforms:cn.merge({uBokeTex:{value:u.renderTarget.textures[0],type:`1i`}}),renderTarget:Mr(e),passThrough:!0,resolutionRatio:.5}),f=new M(e,{name:`dof/composite`,frag:dr,uniforms:cn.merge({uBokeTex:{value:d.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:O.LINEAR,minFilter:O.LINEAR,internalFormat:O.RGBA16F,type:O.HALF_FLOAT,format:O.RGBA})])}),p=new M(e,{name:`motionBlurTile`,frag:xr,uniforms:cn.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),m=new M(e,{name:`motionBlurNeighbor`,frag:yr,uniforms:cn.merge({uVelTex:{value:p.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA})]),resolutionRatio:1/16,passThrough:!0}),h=new M(e,{name:`motionBlur`,frag:_r,uniforms:cn.merge({uVelNeighborTex:{value:m.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16},renderTarget:Mr(e)}),g=new M(e,{name:`fxaa`,frag:pr}),_=new M(e,{name:`bloom/bright`,frag:$n,uniforms:{uShadingTexture:{value:t.shadingBuffer.textures[0],type:`1i`},uThreshold:{value:1,type:`1f`},uBrightness:{value:1,type:`1f`}},renderTarget:Mr(e),resolutionRatio:.5,passThrough:!0}),v=[_],y=[],b=_.renderTarget.textures[0],x=2;for(let t=0;t<kr;t++){let n=Mr(e),r=Mr(e),i={name:`bloom/blur/`+t+`/v`,renderTarget:n,frag:hr,uniforms:{uBackBlurTex:{value:b,type:`1i`},uIsVertical:{type:`1i`,value:!0},uWeights:{type:`1fv`,value:je.gaussWeights(Ar)},uBlurRange:{value:2,type:`1f`}},defines:{GAUSS_WEIGHTS:Ar.toString(),USE_BACKBLURTEX:``},passThrough:!0,resolutionRatio:1/x};v.push(new M(e,i)),v.push(new M(e,{...i,name:`bloom/blur/`+t+`/h`,renderTarget:r,uniforms:{...i.uniforms,uBackBlurTex:{value:n.textures[0],type:`1i`},uIsVertical:{type:`1i`,value:!1}}})),y.push(r.textures[0]),b=r.textures[0],x*=2}v.push(new M(e,{name:`bloom/composite`,frag:tr,uniforms:{uBloomTexture:{value:y,type:`1iv`}},renderTarget:Mr(e)})),this.postprocess=new _n({passes:[r,o,s,l,u,d,f,p,m,h,...v,n,g]}),this._ssr=r,this._ssrTemporal=o,this._ssComposite=s,this.dofCoc=l,this.dofBokeh=u,this.dofBlur=d,this.dofComposite=f,this._motionBlur=h,this._motionBlurTile=p,this._motionBlurNeighbor=m,this._colorCollection=n,this._bloomBright=_,this._bloomPasses=v,this._dofParams=c,this.rtSSR1=i,this.rtSSR2=a,r.uniforms.uGbufferPos.value=t.gBuffer.textures[0],r.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],r.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],o.uniforms.uGbufferPos.value=t.gBuffer.textures[0],o.uniforms.uVelTex.value=t.gBuffer.textures[4],s.uniforms.uGbufferPos.value=t.gBuffer.textures[0],s.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],s.uniforms.uGbufferMaterial.value=t.gBuffer.textures[3],l.uniforms.uGbufferPos.value=t.gBuffer.textures[0],p.uniforms.uVelTex.value=t.gBuffer.textures[4],h.uniforms.uVelTex.value=t.gBuffer.textures[4],h.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}update(e){let t=e.dofParams.kFilmHeight,n=.5*t/Math.tan(.5*(e.fov/180*Math.PI)),r=Math.max(e.dofParams.focusDistance,n),i=jr,a=1/i,o=n*n/(e.dofParams.fNumber*(r-n)*t*2);this._dofParams.set(r,i,a,o);let s=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=s,this._ssrTemporal.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssrTemporal.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){if(e.toneMap!==void 0&&(this._colorCollection.uniforms.uToneMap.value=+!!e.toneMap),e.bloom!==void 0)for(let t of this._bloomPasses)t.enabled=e.bloom;e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssrTemporal.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofBlur.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofBlur.renderTarget&&this.dofBlur.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}setExposure(e){this._colorCollection.uniforms.uExposure.value=2**e}setBloomParams(e,t){this._bloomBright.uniforms.uThreshold.value=e,this._bloomBright.uniforms.uBrightness.value=t}dispose(){this.postprocess.dispose(),this.rtSSR1.dispose(),this.rtSSR2.dispose()}}})))()}var Fr,Ir;function Lr(){return(Lr=t((()=>{D(),Xe(),Qn(),Pr(),Fr=e=>{let t=e.createFrameBuffer();t.setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA,magFilter:O.NEAREST,minFilter:O.NEAREST}),e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA}),e.createTexture().setting({internalFormat:O.SRGB8_ALPHA8}),e.createTexture(),e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA})]);let n=e.createFrameBuffer({disableDepthBuffer:!0});n.setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA}),e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA})]);let r=e.createFrameBuffer({disableDepthBuffer:!0});r.setDepthTexture(t.depthTexture),r.setTexture([n.textures[0],t.textures[0],t.textures[4]]);let i=e.createFrameBuffer({disableDepthBuffer:!0});i.setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA16F,format:O.RGBA,magFilter:O.LINEAR,minFilter:O.LINEAR})]);let a=e.createFrameBuffer({disableDepthBuffer:!0});a.setDepthTexture(t.depthTexture),a.setTexture([e.createTexture()]);let o=e.createFrameBuffer();return o.setTexture([e.createTexture().setting({type:O.FLOAT,internalFormat:O.RGBA32F,format:O.RGBA,magFilter:O.NEAREST,minFilter:O.NEAREST})]),{gBuffer:t,shadingBuffer:n,forwardBuffer:r,refractionBuffer:i,uiBuffer:a,normalBuffer:o}},Ir=class{camera;size;resolution;offscreen;renderTarget;deferredRenderer;pipelinePostProcess;_pipelineOverride;_sceneConfig;_onDispose;constructor(e){this.camera=null,this.size=null,this.resolution=new T,this.offscreen=e.offscreen,this._pipelineOverride=null,this._sceneConfig=e.sceneConfig,this._onDispose=e.onDispose,this.renderTarget=Fr(e.backend),this.deferredRenderer=new Zn({backend:e.backend,envMap:e.envMap,envMapCube:e.envMapCube,renderTarget:this.renderTarget}),this.pipelinePostProcess=new Nr(e.backend,this.renderTarget),this.fit(e.resolution),this.applyPipelineConfig()}get pipelineOverride(){return this._pipelineOverride}set pipelineOverride(e){this._pipelineOverride=e,this.applyPipelineConfig()}applyPipelineConfig(){let e={...this._sceneConfig,...this._pipelineOverride};this.deferredRenderer.setPassEnabled({ssao:e.ssao,lightShaft:e.lightShaft,sss:e.sss}),this.deferredRenderer.setSSSRadius(e.sssRadius??.05),this.pipelinePostProcess.setPassEnabled({toneMap:e.toneMap,motionBlur:e.motionBlur,ssr:e.ssr,dof:e.dof,bloom:e.bloom}),this.pipelinePostProcess.setMotionBlurPower(e.motionBlurPower??1),this.pipelinePostProcess.setExposure(e.exposure??0),this.pipelinePostProcess.setBloomParams(e.bloomThreshold??1,e.bloomBrightness??1)}fit(e){e.x<=0||e.y<=0||(this.resolution.x!==e.x||this.resolution.y!==e.y)&&this.resize(e)}resize(e){this.resolution.copy(e);let t=this.renderTarget;t.gBuffer.setSize(e),t.shadingBuffer.setSize(e),t.forwardBuffer.setSize(e),t.refractionBuffer.setSize(e),t.uiBuffer.setSize(e),t.normalBuffer.setSize(e),this.deferredRenderer.resize(e),this.pipelinePostProcess.resize(e)}dispose(){this._onDispose(this);let e=this.renderTarget;e.forwardBuffer.dispose();let t=[e.gBuffer,e.shadingBuffer,e.refractionBuffer,e.uiBuffer,e.normalBuffer];for(let e=0;e<t.length;e++){let n=t[e];for(let e=0;e<n.textures.length;e++)n.textures[e].dispose();n.dispose()}e.gBuffer.depthTexture&&e.gBuffer.depthTexture.dispose(),this.deferredRenderer.dispose(),this.pipelinePostProcess.dispose()}}})))()}var Rr;function zr(){return(zr=t((()=>{Rr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	vUv = uv;\r
\r
}`,renderTarget:r,uniforms:cn.merge(t.uniforms,a,{uDeltaTime:{value:0,type:`1f`}})}),this.size=t.size,this.layerCnt=t.dataLayerCount,this.rt1=r,this.rt2=i,this.renderTarget=this.rt1,this.clearColor=t.clearColor??null,this.outputUniforms=a}onAfterRender(){super.onAfterRender();for(let e=0;e<this.layerCnt;e++)this.outputUniforms[`uGPUSampler`+e].value=this.renderTarget.textures[e];let e=this.rt1;this.rt1=this.rt2,this.rt2=e,this.renderTarget=this.rt1}initTexture(e){for(let t=0;t<this.layerCnt;t++){let n=[];for(let r=0;r<this.size.y;r++)for(let i=0;i<this.size.x;i++){let a=i,o=r;n.push(...e(t,a,o))}this.rt2.textures[t].subImage(new Float32Array(n),this.size.x,this.size.y)}}}})))()}function ci(){return(ci=t((()=>{Je(),D(),Wt(),Xe(),gn(),vn(),xn()})))()}function li(){return(li=t((()=>{ot(),Wt(),Ot(),Xe(),gn()})))()}function N(){return(N=t((()=>{Xe(),un(),ni(),gn(),ii(),si(),fn(),Qn(),Lr(),ci(),li(),vn(),xn(),Cn()})))()}var ui;function di(){return(di=t((()=>{ui=class{static serializeEntity(e,t){let n=e=>{let r=[];e.children.forEach(e=>{e.initiator!=`script`&&r.push(n(e))});let i=[];e.components.forEach(e=>{let n=e.serialize({mode:`export`}),r=Object.keys(n).length>0;if(e.initiator!==`user`)return;let a={name:t.getName(e),uuid:e.uuid};r&&(a.props=n),i.push(a)});for(let t of e.unresolvedComponents)i.push({name:t.name,uuid:t.uuid,props:t.props});return{name:e.name,uuid:e.uuid,pos:e.position.x==0&&e.position.y==0&&e.position.z==0?void 0:e.position.getElm(`vec3`),rot:e.euler.x==0&&e.euler.y==0&&e.euler.z==0?void 0:e.euler.getElm(`vec3`),scale:e.scale.x==1&&e.scale.y==1&&e.scale.z==1?void 0:e.scale.getElm(`vec3`),components:i.length>0?i:void 0,childs:r.length>0?r:void 0}};return n(e)}static deserializeEntity(e,t,n,r){let i=(e,t)=>{let a=t||r.createEntity();a.initiator=`user`,a.setField(`name`,e.name),a.restoreUUID(e.uuid);let o=e.pos||[0,0,0];a.position.x=o[0],a.position.y=o[1],a.position.z=o[2];let s=e.rot||[0,0,0];a.euler.x=s[0],a.euler.y=s[1],a.euler.z=s[2];let c=e.scale||[1,1,1];return a.scale.x=c[0],a.scale.y=c[1],a.scale.z=c[2],a.unresolvedComponents=[],e.components&&e.components.forEach(e=>{let t=n.resolve(e.name);if(t){let n=a.getComponent(t.component);n||(n=a.addComponent(t.component),n.initiator=`user`),n.restoreUUID(e.uuid),e.props&&n.deserialize(e.props)}else console.warn(`[ProjectSerializer] Component "${e.name}" not found in resolver. Preserving data for round-trip.`),a.unresolvedComponents.push({name:e.name,uuid:e.uuid,props:e.props})}),e.childs&&([...a.children].forEach(e=>{e.initiator!==`script`&&a.remove(e)}),e.childs.forEach(e=>{a.add(i(e))})),a};e&&i(e,t),t.initiator=`god`}}})))()}var fi;function pi(){return(pi=t((()=>{N(),fi=class extends wt{name;_frag;_resolution;_filter;_updateEveryFrame;_textures;constructor(e,t){super(),this.name=e;let n=t.data;this._frag=n?.frag||``,this._resolution=n?.resolution||[1024,1024],this._filter=n?.filter||`linear`,this._updateEveryFrame=n?.updateEveryFrame??!1,this._textures=n?.textures||{}}get frag(){return this._frag}get resolution(){return this._resolution}get filter(){return this._filter}get updateEveryFrame(){return this._updateEveryFrame}get textures(){return this._textures}}})))()}var mi;function hi(){return(hi=t((()=>{mi=(e,t)=>{let n={},r=`/${t}/`;for(let[t,i]of Object.entries(e)){let e=t.slice(t.lastIndexOf(r)+r.length).split(`/`).slice(0,-2),a=Object.entries(i).find(([e,t])=>typeof t==`function`&&/^[A-Z]/.test(e));if(!a)continue;let o=n;for(let t of e)o=o[t]=o[t]||{};o[a[0]]=a[1]}return n}})))()}var gi;function _i(){return(_i=t((()=>{ot(),D(),pi(),hi(),gi=class extends nt{_componentList;_componentGroups;_geometryList;_geometryGroups;_textureResources;_textures;_updateEveryFrameTextures;constructor(){super(),this._componentList=[],this._textures=new Map,this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources=new Map,this._updateEveryFrameTextures=[]}get componentList(){return this._componentList}get componentGroups(){return this._componentGroups}get geometryList(){return this._geometryList}get geometryGroups(){return this._geometryGroups}get textureList(){return Array.from(this._textureResources.values())}get textures(){return this._textures}get updateEveryFrameTextures(){return this._updateEveryFrameTextures}clear(){this._componentList=[],this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources.clear(),this._textures.clear(),this._updateEveryFrameTextures=[],this.emit(`update`)}getComponent(e){return this._componentList.find(t=>t.name==e)}getComponentName(e){let t=this._componentList.find(t=>e instanceof t.component);return t?t.name:e.constructor.name}addComponentGroup(e){let t=this._componentGroups.find(t=>t.name==e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addComponent:(e,n)=>{let r={name:e,component:n};t.push(r),this._componentList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._componentGroups.push(t),this.emit(`update`),t}getGeometry(e){return this._geometryList.find(t=>t.name===e)}addGeometryGroup(e){let t=this._geometryGroups.find(t=>t.name===e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addGeometry:(e,n)=>{let r={name:e,geometryClass:n};t.push(r),this._geometryList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._geometryGroups.push(t),this.emit(`update`),t}addTextureResource(e,t){let n=new fi(e,{data:t});this._textureResources.set(e,n),this.emit(`update`)}getTextureResource(e){return this._textureResources.get(e)}removeTextureResource(e){this._textureResources.delete(e);let t=this._textures.get(e);t&&(t.dispose(),this._textures.delete(e)),this.emit(`update`)}addTexture(e,t){return this._textures.set(e,t),t}getTexture(e){return this._textures.get(e)}_buildTexture(e,t,n){let r=e.frag;return r?t.createTexProcedural({name:e.name,frag:r,resolution:new T(e.resolution[0]||1024,e.resolution[1]||1024),filter:e.filter,textures:n}):null}_ensureTexture(e,t,n){let r=this._textures.get(e.name);if(r)return r;if(n.has(e.name))return null;n.add(e.name);let i={},a=e.textures,o=Object.keys(a);for(let e=0;e<o.length;e++){let r=o[e],s=a[r],c=this._textureResources.get(s),l=c?this._ensureTexture(c,t,n):this._textures.get(s);l&&(i[r]=l)}let s=this._buildTexture(e,t,i);return s?(this._textures.set(e.name,s),e.updateEveryFrame&&this._updateEveryFrameTextures.push(s),s):null}buildTextureInstances(e){this._updateEveryFrameTextures=[];let t=new Set;this._textureResources.forEach(n=>{this._ensureTexture(n,e,t)}),this.emit(`update`)}}})))()}var vi,P;function yi(){return(yi=t((()=>{D(),N(),di(),_i(),vi={duration:600,fps:30},P=class e extends wt{static resources;name;_renderer;_root;_time;_frame;_frameSetting;_disposed;_frameEvent;constructor(e){super(),this.name=`OREngine`,this._disposed=!1,this._renderer=e(this),this._renderer.globalUniforms={uTime:{value:0,type:`1f`},uTimeF:{value:0,type:`1f`},uTimeE:{value:0,type:`1f`},uTimeEF:{value:0,type:`1f`},uDeltaTime:{value:0,type:`1f`},uResolution:{value:new T,type:`2fv`},uAspectRatio:{value:1,type:`1f`}},this._time={current:new Date().getTime(),engine:0,delta:0,code:0},this._frameSetting={...vi},this._frame={current:0,playing:!1},this.seek(0),this._frameEvent=null,this._root=this.createEntity({name:`root`}),this._root.initiator=`god`,this.field(`name`,()=>this.name,e=>this.name=e),this.field(`scene`,()=>ui.serializeEntity(this._root,this._createComponentResolver()),e=>{ui.deserializeEntity(e,this._root,this._createComponentResolver(),this)}),this.field(`renderer`,()=>this._renderer.serialize({mode:`export`}),e=>this._renderer.deserialize(e));let t=this.fieldDir(`timeline`);t.field(`duration`,()=>this._frameSetting.duration,e=>this._frameSetting.duration=e),t.field(`fps`,()=>this._frameSetting.fps,e=>this._frameSetting.fps=e)}createEntity(e){return new Yt({engine:this,...e})}get canvas(){return this._renderer.canvas}get renderer(){return this._renderer}get root(){return this._root}get frame(){return this._frame}get time(){return this._time}get frameSetting(){return this._frameSetting}get disposed(){return this._disposed}createView(e){return this._renderer.createView(e)}_createComponentResolver(){return{resolve:t=>e.resources.getComponent(t),getName:t=>e.resources.getComponentName(t)}}init(){this._root.disposeRecursive(),this._root.position.set(0,0,0),this._root.euler.set(0,0,0),this._root.scale.set(1,1,1),this.name=`New Project`,this._renderer.reset(),Object.assign(this._frameSetting,vi),this.stop(),this.seek(0)}async load(e){this.init(),this.deserialize(e),this.emit(`update/graph`),this.emit(`loaded`)}update(t){let n=new Date().getTime();this._time.delta=(n-this._time.current)/1e3,this._time.current=n,this._time.engine+=this._time.delta,this._time.code+=this._time.delta*+!!this._frame.playing,this._frame.current=this._time.code*60;let r=this.createEntityUpdateEvent({forceDraw:t?.forceDraw});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1,this._renderer.globalUniforms.uDeltaTime.value=Math.min(this._time.delta,1/60);let i=e.resources.updateEveryFrameTextures;for(let e=0;e<i.length;e++)i[e].render();return this.step(r),this._frame.playing&&this.emit(`update/frame/play`,[this._frame]),this._time.delta}step(e){this._root.commitFrame(e),this._root.update(e),this._root.postUpdate(e),this._root.updateMatrixRecursive(),this._root.prepareRender(e),this._renderer.prepareScene(this._root,e),this._frameEvent=e}render(e){this._frameEvent&&this._renderer.render(e,this._frameEvent)}createEntityUpdateEvent(e){let t={playing:this._frame.playing,timeElapsed:this._time.engine,timeDelta:this._time.delta,timeCode:this._time.code,timeCodeFrame:this._frame.current,resolution:this.renderer.resolution,renderer:this.renderer,forceDraw:!1};return e?{...t,...e}:t}setSize(e){this._renderer.resize(e),this._renderer.canvas.width=e.x,this._renderer.canvas.height=e.y,this._renderer.globalUniforms.uResolution.value.copy(e),this._renderer.globalUniforms.uAspectRatio.value=e.x/Math.max(e.y,1)}play(){this._frame.playing=!0,this._time.current=new Date().getTime()}stop(){this._frame.playing=!1}seek(e){this._time.code=e/60,this._frame.current=e,this.emit(`update/frame/play`,[this._frame])}updateOffline(t,n){let r=t/n,i=1/n;this._time.delta=i,this._time.current=new Date().getTime(),this._time.engine+=i,this._time.code=r,this._frame.current=r*60,this._frame.playing=!0;let a=this.createEntityUpdateEvent({forceDraw:!0});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1;let o=e.resources.updateEveryFrameTextures;for(let e=0;e<o.length;e++)o[e].render();this.step(a)}compileShaders(e,t){let n=this.createEntityUpdateEvent({forceDraw:!0});return this.renderer.compileShaders(this._root,e,n,t)}dispose(){this._disposed=!0,this._root.disposeRecursive()}},P.resources=new gi,P.__docgenInfo={description:``,methods:[{name:`createEntity`,docblock:null,modifiers:[],params:[{name:`params`,optional:!0,type:{name:`Omit`,elements:[{name:`MXP.EntityParams`},{name:`literal`,value:`'engine'`}],raw:`Omit<MXP.EntityParams, 'engine'>`,alias:`Omit`}}],returns:{type:{name:`MXP.Entity`}}},{name:`canvas`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`renderer`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`root`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`frame`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`time`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`frameSetting`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`disposed`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`createView`,docblock:null,modifiers:[],params:[{name:`opt`,optional:!0,type:{name:`MXP.RenderViewOptions`,alias:`MXP.RenderViewOptions`}}],returns:null},{name:`init`,docblock:null,modifiers:[],params:[],returns:null},{name:`load`,docblock:null,modifiers:[`async`],params:[{name:`project`,optional:!1,type:{name:`OREngineProjectData`,alias:`OREngineProjectData`}}],returns:null},{name:`update`,docblock:null,modifiers:[],params:[{name:`param`,optional:!0,type:{name:`Partial`,elements:[{name:`MXP.EntityUpdateEvent`}],raw:`Partial<MXP.EntityUpdateEvent>`,alias:`Partial`}}],returns:null},{name:`step`,docblock:null,modifiers:[],params:[{name:`event`,optional:!1,type:{name:`MXP.EntityUpdateEvent`,alias:`MXP.EntityUpdateEvent`}}],returns:null},{name:`createEntityUpdateEvent`,docblock:null,modifiers:[],params:[{name:`overrideParams`,optional:!0,type:{name:`Partial`,elements:[{name:`MXP.EntityUpdateEvent`}],raw:`Partial<MXP.EntityUpdateEvent>`,alias:`Partial`}}],returns:{type:{name:`MXP.EntityUpdateEvent`}}},{name:`setSize`,docblock:null,modifiers:[],params:[{name:`resolution`,optional:!1,type:{name:`MTP.Vector`,alias:`MTP.Vector`}}],returns:null},{name:`play`,docblock:null,modifiers:[],params:[],returns:null},{name:`stop`,docblock:null,modifiers:[],params:[],returns:null},{name:`seek`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`number`}}],returns:null},{name:`updateOffline`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`number`}},{name:`fps`,optional:!1,type:{name:`number`}}],returns:null},{name:`compileShaders`,docblock:null,modifiers:[],params:[{name:`view`,optional:!1,type:{name:`MXP.RenderViewContract`,alias:`MXP.RenderViewContract`}},{name:`onProgress`,optional:!0,type:{name:`signature`,type:`function`,raw:`( label: string, loaded: number, total: number ) => void`,signature:{arguments:[{type:{name:`string`},name:`label`},{type:{name:`number`},name:`loaded`},{type:{name:`number`},name:`total`}],return:{name:`void`}}}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`Engine`}})))()}var bi;function xi(){return(xi=t((()=>{ot(),bi=class extends nt{_pressedKeys;constructor(){super(),this._pressedKeys={};let e=this._onKeyDown.bind(this),t=this._onKeyUp.bind(this);window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,t),this.once(`dispose`,()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,t)})}get pressedKeys(){return this._pressedKeys}_onKeyDown(e){this._pressedKeys[e.key]=!0,this.emit(`keydown`,[e,this._pressedKeys])}_onKeyUp(e){if(this._pressedKeys[e.key]=!1,e.key==`Meta`||e.key==`Control`){let e=Object.keys(this._pressedKeys);for(let t=0;t<e.length;t++)this._pressedKeys[e[t]]=!1}this.emit(`keyup`,[e,this._pressedKeys])}dispose(){this.emit(`dispose`)}}})))()}var Si;function Ci(){return(Ci=t((()=>{ot(),D(),Si=class extends nt{_isTouching;element=null;position;delta;constructor(){super(),this.position=new T(NaN,NaN),this.delta=new T(NaN,NaN),this._isTouching=!1;let e=this._onPointer.bind(this,`move`),t=this._onPointer.bind(this,`end`);window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`dragend`,t);let n=()=>{this.element&&this.removeElement(this.element),window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`dragend`,t),this.off(`dispose`,n)};this.on(`dispose`,n)}setElement(e){this.element&&this.removeElement(this.element),this.element=e;let t=this._onPointer.bind(this,`start`);e.addEventListener(`pointerdown`,t);let n=r=>{e.isEqualNode(r.elm)&&(e.removeEventListener(`pointerdown`,t),this.off(`unregister`,n))};this.on(`unregister`,n)}removeElement(e){this.emit(`unregister`,[e])}getScreenPosition(e){if(this.position.x!=this.position.x)return new T(NaN,NaN);let t=this.position.clone().divide(e).multiply(2).sub(1);return t.y*=-1,t}getRelativePosition(e,t){let n=e.getClientRects()[0],r=this.position.x-n.left,i=this.position.y-n.top;return t&&(r/=n.width,i/=n.height),new T(r,i)}_setPos(e,t){this.position.x!==this.position.x||this.position.y!==this.position.y?this.delta.set(0,0):this.delta.set(e-this.position.x,t-this.position.y),this.position.set(e,t)}_onPointer(e,t){let n=t.pointerType;(n==null||n==`mouse`&&(t.button==-1||t.button==0)||n==`touch`)&&this._touchEventHandler(t.pageX,t.pageY,e,t)}_touchEventHandler(e,t,n,r){let i=!1,a=e-window.pageXOffset,o=t-window.pageYOffset;n==`start`?(this._isTouching=!0,this._setPos(a,o),this.delta.set(0,0),i=!0):n==`move`?(this._setPos(a,o),this._isTouching&&(i=!0)):n==`end`&&(`targetTouches`in r?r.targetTouches.length==0&&(this._isTouching=!1):this._isTouching=!1,i=!0),i&&this.emit(n,[{pointerEvent:r,position:this.position.clone(),delta:this.delta.clone()}])}dispose(){this.emit(`dispose`)}}})))()}function wi(){return(wi=t((()=>{yi(),_i(),xi(),Ci()})))()}function Ti(){return(Ti=t((()=>{wi()})))()}var Ei,Di;function Oi(){return(Oi=t((()=>{Ei=i(),Di=(0,Ei.createContext)(null)})))()}var ki,F;function I(){return(I=t((()=>{ki=i(),Oi(),F=()=>{let e=(0,ki.useContext)(Di);if(e===null)throw Error(`useEditor must be used within a EditorProvider`);return e}})))()}var Ai,ji,Mi;function Ni(){return(Ni=t((()=>{Ai=i(),Ti(),w(),I(),ji=o(),Mi=e=>{let{engine:t}=F(),n=(0,Ai.useCallback)(()=>{let e=[{label:`(None)`,value:``}];return t.root.traverse(n=>{n.components.forEach(r=>{e.push({label:`${n.getScenePath(t.root)} > ${P.resources.getComponentName(r)}`,value:r.uuid})})}),e},[t]),[r,i]=(0,Ai.useState)(n);return(0,Ai.useEffect)(()=>{let e=()=>i(n());return t.on(`update/graph`,e),()=>{t.off(`update/graph`,e)}},[t,n]),(0,ji.jsx)(re,{value:e.value||``,selectList:r,onChange:t=>{e.onChange&&e.onChange(t||null)}})},Mi.__docgenInfo={description:``,methods:[],displayName:`InputComponentRef`,props:{value:{required:!0,tsType:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: string | null ) => void`,signature:{arguments:[{type:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},name:`value`}],return:{name:`void`}}},description:``}}}})))()}var Pi,Fi,Ii;function Li(){return(Li=t((()=>{Pi=i(),w(),I(),Fi=o(),Ii=e=>{let{engine:t}=F(),n=(0,Pi.useCallback)(()=>{let e=[{label:`(None)`,value:``}];return t.root.traverse(n=>{e.push({label:n.getScenePath(t.root),value:n.uuid})}),e},[t]),[r,i]=(0,Pi.useState)(n);return(0,Pi.useEffect)(()=>{let e=()=>i(n());return t.on(`update/graph`,e),()=>{t.off(`update/graph`,e)}},[t,n]),(0,Fi.jsx)(re,{value:e.value||``,selectList:r,onChange:t=>{e.onChange&&e.onChange(t||null)}})},Ii.__docgenInfo={description:``,methods:[],displayName:`InputEntityRef`,props:{value:{required:!0,tsType:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: string | null ) => void`,signature:{arguments:[{type:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},name:`value`}],return:{name:`void`}}},description:``}}}})))()}var Ri,zi,Bi,Vi;function Hi(){return(Hi=t((()=>{Ri=`InputResourceSelect__inputResourceSelect___Lmluc`,zi=`InputResourceSelect__select___Lmluc`,Bi=`InputResourceSelect__editButton___Lmluc`,Vi={inputResourceSelect:Ri,select:zi,editButton:Bi}})))()}var Ui,Wi,Gi;function Ki(){return(Ki=t((()=>{Ui=i(),w(),I(),Hi(),Wi=o(),Gi=e=>{let{editor:t}=F(),n=(0,Ui.useCallback)(()=>{e.value&&(t.setField(`navigateAsset`,{assetType:e.resourceType,name:String(e.value)}),t.setField(`selectedAsset`,{name:String(e.value),assetType:e.resourceType}))},[t,e.value,e.resourceType]);return(0,Wi.jsxs)(`div`,{className:Vi.inputResourceSelect,children:[(0,Wi.jsx)(`div`,{className:Vi.select,children:(0,Wi.jsx)(re,{value:e.value,selectList:e.selectList,onChange:e.onChange})}),e.value&&(0,Wi.jsx)(`button`,{className:Vi.editButton,onClick:n,title:`Edit resource`,children:`✎`})]})},Gi.__docgenInfo={description:``,methods:[],displayName:`InputResourceSelect`,props:{value:{required:!0,tsType:{name:`T`},description:``},selectList:{required:!0,tsType:{name:`union`,raw:`SelectList | ( () => SelectList )`,elements:[{name:`SelectList`},{name:`unknown`}]},description:``},resourceType:{required:!0,tsType:{name:`union`,raw:`"material" | "texture" | "shader"`,elements:[{name:`literal`,value:`"material"`},{name:`literal`,value:`"texture"`},{name:`literal`,value:`"shader"`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}}},description:``}}}})))()}var qi,Ji;function Yi(){return(Yi=t((()=>{i(),w(),Ni(),Li(),Ki(),qi=o(),Ji=e=>{let t=null,n=e.onChange,r=e.value,i=e.format,a=e=>{n&&n(e)};if(i&&(i.type==`entity`?t=(0,qi.jsx)(Ii,{value:r,onChange:a}):i.type==`component`?t=(0,qi.jsx)(Mi,{value:r,onChange:a}):i.type==`vector`&&Array.isArray(r)?t=(0,qi.jsx)(ee,{value:r,onChange:a,onDragStart:e.onDragStart,onDragEnd:e.onDragEnd,onDragCancel:e.onDragCancel}):i.type==`color`&&Array.isArray(r)?t=(0,qi.jsx)(v,{value:r,onChange:a}):i.type==`select`?t=(0,qi.jsx)(re,{value:r,onChange:a,selectList:i.list}):i.type==`resource`&&(t=(0,qi.jsx)(Gi,{value:r,onChange:a,selectList:i.list,resourceType:i.resourceType}))),r==null)return t;if(!t){if(typeof r==`number`)t=(0,qi.jsx)(b,{...e,value:r,onChange:a});else if(typeof r==`string`)t=(0,qi.jsx)(C,{...e,value:r,onChange:a});else if(typeof r==`boolean`)t=(0,qi.jsx)(_,{...e,checked:r,onChange:a});else if(typeof r==`function`){let n=e.label||`Run`;t=(0,qi.jsx)(c,{onClick:()=>{r()},children:n})}else t=(0,qi.jsx)(C,{...e,value:JSON.stringify(r),onChange:()=>{}})}return t}})))()}var Xi,Zi,Qi,$i,ea,ta,na,ra;function ia(){return(ia=t((()=>{Xi=i(),Zi={showAudioView:!0},Qi=`orengine-editor-ui-settings`,$i=()=>{try{let e=localStorage.getItem(Qi);if(e)return{...Zi,...JSON.parse(e)}}catch{}return{...Zi}},ea=$i(),ta=new Set,na=e=>(ta.add(e),()=>{ta.delete(e)}),ra=e=>[(0,Xi.useSyncExternalStore)(na,()=>ea[e]),(0,Xi.useCallback)(t=>{ea={...ea,[e]:t};try{localStorage.setItem(Qi,JSON.stringify(ea))}catch{}ta.forEach(e=>e())},[e])]})))()}var aa,oa,sa;function ca(){return(ca=t((()=>{aa=`EditorSettings__editorSettings___LmVka`,oa=`EditorSettings__editorSettings_inner___LmVka`,sa={editorSettings:aa,editorSettings_inner:oa}})))()}var la,ua;function da(){return(da=t((()=>{w(),Yi(),ia(),ca(),la=o(),ua=()=>{let[e,t]=ra(`showAudioView`);return(0,la.jsx)(`div`,{className:sa.editorSettings,children:(0,la.jsx)(`div`,{className:sa.editorSettings_inner,children:(0,la.jsx)(s,{label:`View`,accordion:!0,children:(0,la.jsx)(ae,{title:`AudioView`,children:(0,la.jsx)(Ji,{value:e,onChange:e=>t(e)})})})})})},ua.__docgenInfo={description:``,methods:[],displayName:`EditorSettings`}})))()}var fa,pa;function ma(){return(ma=t((()=>{Ti(),fa=(e,t,n)=>{let r=e.name;if(r.startsWith(`_`)&&(r=r.slice(1)),`child`in e){let i=[];for(let r of e.child){let e=fa(r,t,n);e&&i.push(e)}return{label:r,children:i}}return n.includes(e.component)?null:{label:r,onClick:()=>t(e)}},pa=(e,t=[])=>{let n=[];for(let r of P.resources.componentGroups){let i=fa(r,e,t);i&&n.push(i)}return n}})))()}var ha,ga;function _a(){return(_a=t((()=>{N(),w(),ma(),I(),ha=[A],ga=e=>{let{editor:t}=F(),{closeAll:n}=S(),r=(r,i)=>{let a=t.api.createEntity(e,{name:r,components:i});t.api.selectEntity(a),n()},i=pa(e=>{r(e.name,[e.component])},ha),a=[{label:`Empty`,onClick:()=>r(`Empty`,[])}];for(let e of i)a.push(e);return a}})))()}var va,ya,ba;function xa(){return(xa=t((()=>{va=i(),w(),_a(),I(),ya=o(),ba=()=>{let{editor:e,engine:t}=F(),{open:n,closeAll:r}=S(),i=ga(t.root),a=(0,va.useRef)({x:0,y:0});return(0,va.useEffect)(()=>{let e=e=>{a.current.x=e.clientX,a.current.y=e.clientY};return window.addEventListener(`pointermove`,e),()=>{window.removeEventListener(`pointermove`,e)}},[]),(0,va.useEffect)(()=>{let t=()=>{r(),n((0,ya.jsx)(ce,{title:`Add Entity`,items:i}),ie(a.current.x,a.current.y))};return e.on(`request/addEntity`,t),()=>{e.off(`request/addEntity`,t)}},[e,t,n,r,i]),null}})))()}var Sa,Ca;function wa(){return(wa=t((()=>{Sa=i(),Ca=(0,Sa.createContext)(void 0)})))()}var Ta,Ea;function Da(){return(Da=t((()=>{Ta=i(),Ea=(e,t)=>{let[n,r]=(0,Ta.useState)(()=>e?e.serialize():{}),i=t?[...t]:[],a=(0,Ta.useMemo)(()=>i,i);return(0,Ta.useEffect)(()=>{if(e===void 0)return;r(e.serialize());let t=t=>{let n=a.length==0;for(let e=0;e<a.length;e++)if(t.find(t=>t==a[e])){n=!0;break}n&&r(e.serialize())};return e.on(`fields/update`,t),()=>{e.off(`fields/update`,t)}},[e,a]),{fields:n}}})))()}var Oa;function ka(){return(ka=t((()=>{Da(),Oa=e=>(Ea(e.target),{target:e.target})})))()}var Aa;function ja(){return(ja=t((()=>{Aa=(e,t,n)=>{if(!e)return null;for(let r of e){if(t.constructor!==r.target)continue;let e=r.fields[n];if(e)return e}return null}})))()}var Ma,Na;function Pa(){return(Pa=t((()=>{Ma=i(),I(),Na=(e,t)=>{let{editor:n}=F(),r=(0,Ma.useRef)(null);return{onChange:i=>{r.current?r.current.set(i):n.api.setField(e,t,i)},onDragStart:()=>{r.current=n.api.beginEdit(e,t)},onDragEnd:()=>{r.current&&r.current.commit(),r.current=null},onDragCancel:()=>{r.current&&r.current.cancel(),r.current=null}}}})))()}var Fa,Ia;function La(){return(La=t((()=>{Fa=i(),wa(),Ia=()=>{let e=(0,Fa.useContext)(Ca);if(!e)throw Error(`SerializeFieldViewContext is not defined`);return e}})))()}var Ra,za;function Ba(){return(Ba=t((()=>{Ra=`ValueArray__container___LmNvb`,za={container:Ra}})))()}var Va,Ha;function Ua(){return(Ua=t((()=>{i(),w(),Yi(),Ba(),Va=o(),Ha=e=>{let t=[],n=e.value,r=e.format,i=r?.type==`array`?r.labels:void 0;if(n===void 0)return null;for(let r=0;r<n.length;r++){let a=n[r],o=r.toString();i&&(o+=`/ `+i(a,r)),t.push((0,Va.jsx)(ae,{title:o,children:(0,Va.jsx)(Ji,{...e,value:a,onChange:t=>{let i=n.concat();i[r]=t,e.onChange&&e.onChange(i)}})},r))}return(0,Va.jsx)(`div`,{className:za.container,children:t})},Ha.__docgenInfo={description:``,methods:[],displayName:`ValueArray`,props:{value:{required:!0,tsType:{name:`union`,raw:`T | undefined`,elements:[{name:`T`},{name:`undefined`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}}},description:``},onDragStart:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},onDragEnd:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},onDragCancel:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``},format:{required:!1,tsType:{name:`SerializableFieldFormat`},description:``},label:{required:!1,tsType:{name:`union`,raw:`string | React.ReactNode`,elements:[{name:`string`},{name:`ReactReactNode`,raw:`React.ReactNode`}]},description:``},readOnly:{required:!1,tsType:{name:`boolean`},description:``},step:{required:!1,tsType:{name:`number`},description:``},min:{required:!1,tsType:{name:`number`},description:``},max:{required:!1,tsType:{name:`number`},description:``},int:{required:!1,tsType:{name:`boolean`},description:``},disabled:{required:!1,tsType:{name:`boolean`},description:``}}}})))()}var Wa,Ga;function Ka(){return(Ka=t((()=>{Wa=`SerializeFieldViewValue__action___LmFjd`,Ga={action:Wa}})))()}var qa,Ja,Ya;function Xa(){return(Xa=t((()=>{qa=e(i(),1),w(),I(),ja(),Pa(),La(),Yi(),Ua(),Ka(),Ja=o(),Ya=e=>{let{editor:t,engine:n,fieldUIs:r}=F(),{target:i}=Ia(),a=Na(i,e.path),o=e.field.value,s=typeof o,c=e.field.opt,l=c?.format,u=c?.label||e.path.split(`/`).pop(),d=l&&l.type==`vector`,f=Aa(r,i,e.path);if(f){let r=(0,qa.createElement)(f,{value:o,setValue:n=>t.api.setField(i,e.path,n),beginEdit:()=>t.api.beginEdit(i,e.path),target:i,path:e.path,opt:c,engine:n,editor:t});return(0,Ja.jsx)(ae,{title:u,vertical:!0,children:r})}let p=null;if(Array.isArray(o))p=l?.type==`vector`?(0,Ja.jsx)(ee,{value:o,...c,...a}):l?.type==`color`?(0,Ja.jsx)(v,{value:o,...c,onChange:n=>{t.api.setField(i,e.path,n)}}):(0,Ja.jsx)(Ha,{value:o,...c,...a});else if(p=(0,Ja.jsx)(Ji,{value:o,...c,...a}),s===`function`)return(0,Ja.jsx)(`div`,{className:Ga.action,children:p});return(0,Ja.jsx)(ae,{title:u,vertical:d,children:p})},Ya.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldViewValue`,props:{path:{required:!0,tsType:{name:`string`},description:``},field:{required:!0,tsType:{name:`SerializeFieldDirectoryValue`},description:``}}}})))()}var Za,Qa,$a,eo;function to(){return(to=t((()=>{Za=`SerializeFieldViewDir__container___LmNvb`,Qa=`SerializeFieldViewDir__field___LmNvb`,$a=`SerializeFieldViewDir__block___LmNvb`,eo={container:Za,field:Qa,block:$a}})))()}var no,ro;function io(){return(io=t((()=>{i(),w(),Xa(),to(),no=o(),ro=e=>{let t=[],n=Object.keys(e.fields.childs);for(let r=0;r<n.length;r++){let i=n[r],a=e.fields.childs[i],{opt:o}=a,c=!1;if(o&&(c=typeof o.hidden==`function`?o.hidden(a.type==`value`?a.value:null):o.hidden||!1),c)continue;let l=`field`+i,u=(e.basePath?e.basePath+`/`:``)+i,d=null;d=a.type===`value`?(0,no.jsx)(Ya,{path:u,field:a},l):(0,no.jsx)(`div`,{className:eo.block,children:(0,no.jsx)(s,{accordion:!0,label:i,children:(0,no.jsx)(ro,{fields:a,basePath:u})},l)},l),d&&t.push(d)}return(0,no.jsx)(`div`,{className:eo.container,children:t})},ro.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldViewDir`,props:{fields:{required:!0,tsType:{name:`MXP.SerializeFieldDirectoryFolder`},description:``},basePath:{required:!1,tsType:{name:`string`},description:``}}}})))()}var ao,oo;function so(){return(so=t((()=>{wa(),ka(),io(),ao=o(),oo=e=>{let t=Oa(e),n=t.target.serializeToDirectory();if(e.filter){let t=n.childs[e.filter];t&&t.type===`folder`&&(n=t)}return(0,ao.jsx)(Ca.Provider,{value:t,children:(0,ao.jsx)(ro,{fields:n,basePath:e.filter})})},oo.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldView`}})))()}var L;function co(){return(co=t((()=>{Da(),L=(e,t)=>{let n=n=>{e?.setField(t,n)},{fields:r}=Ea(e,[t]);return[r&&r[t],n]}})))()}var lo,uo;function fo(){return(fo=t((()=>{lo=`ComponentAdd__compAdd___LmNvb`,uo={compAdd:lo}})))()}var po,mo;function ho(){return(ho=t((()=>{w(),ma(),I(),fo(),po=o(),mo=e=>{let{editor:t}=F(),{open:n,closeAll:r}=S(),i=pa(n=>{t.api.addComponent(e.entity,n.component),r()});return(0,po.jsx)(`div`,{className:uo.compAdd,children:(0,po.jsx)(c,{onClick:e=>{n((0,po.jsx)(ce,{items:i}),ie(e.clientX,e.clientY))},children:`Add Component`})})},mo.__docgenInfo={description:``,methods:[],displayName:`ComponentAdd`,props:{entity:{required:!0,tsType:{name:`MXP.Entity`},description:``}}}})))()}var go,_o,vo,yo,bo,xo;function So(){return(So=t((()=>{go=`ComponentView__compoView___LmNvb`,_o=`ComponentView__head___LmNvb`,vo=`ComponentView__name___LmNvb`,yo=`ComponentView__check___LmNvb`,bo=`ComponentView__propertyBlock___LmNvb`,xo={compoView:go,head:_o,name:vo,check:yo,delete:`ComponentView__delete___LmNvb`,propertyBlock:bo}})))()}var Co,wo,To,Eo;function Do(){return(Do=t((()=>{Co=i(),Ti(),w(),I(),so(),co(),So(),wo=o(),To=e=>{let t=Object.keys(e.childs);for(let n=0;n<t.length;n++){let r=e.childs[t[n]],{opt:i}=r,a=!1;if(i&&(a=typeof i.hidden==`function`?i.hidden(r.type===`value`?r.value:null):i.hidden||!1),!a&&(r.type===`value`||To(r)))return!0}return!1},Eo=({component:e})=>{let{editor:t}=F(),[n,r]=L(e,`enabled`),i=e.initiator!==`user`,a=To(e.serializeToDirectory()),o=(0,Co.useCallback)(n=>{n.stopPropagation();let r=e.entity;if(r){for(let[n,i]of r.components)if(i.uuid===e.uuid){t.api.removeComponent(r,n,e);break}}},[e,t]),c=(0,wo.jsxs)(`div`,{className:xo.head,children:[(0,wo.jsx)(`div`,{className:xo.name,children:P.resources.getComponentName(e)}),(0,wo.jsx)(`div`,{className:xo.delete,children:(0,wo.jsx)(`button`,{onClick:o,children:(0,wo.jsx)(u,{})})})]});return(0,wo.jsx)(`div`,{className:xo.compoView,"data-disable_component":i,children:(0,wo.jsx)(`div`,{className:xo.content,children:(0,wo.jsx)(s,{label:c,accordion:a,bg:!0,defaultClose:!1,children:a&&(0,wo.jsx)(oo,{target:e})})})})},Eo.__docgenInfo={description:``,methods:[],displayName:`ComponentView`,props:{component:{required:!0,tsType:{name:`MXP.Component`},description:``}}}})))()}var Oo,ko;function Ao(){return(Ao=t((()=>{Oo=`ComponentList__container___LmNvb`,ko={container:Oo}})))()}var jo,Mo,No;function Po(){return(Po=t((()=>{jo=i(),co(),Do(),Ao(),Mo=o(),No=({entity:e})=>{let[t]=L(e,`components`),n=(0,jo.useMemo)(()=>{let n=[];return t?(t.forEach(t=>{let r=e.getComponentByUUID(t);r&&n.push((0,Mo.jsx)(Eo,{component:r},r.uuid))}),n):null},[t,e]);return(0,Mo.jsx)(`div`,{className:ko.container,children:n})},No.__docgenInfo={description:``,methods:[],displayName:`ComponentList`}})))()}var Fo,Io,Lo;function Ro(){return(Ro=t((()=>{Fo=i(),w(),I(),so(),co(),ho(),Po(),Io=o(),Lo=()=>{let{editor:e,engine:t}=F(),[n]=L(e,`selectedEntityId`),r=(0,Fo.useMemo)(()=>{if(n)return t.root.findEntityByUUID(n)},[t,n]);return r?(0,Io.jsxs)(Io.Fragment,{children:[(0,Io.jsx)(s,{label:`Fields`,accordion:!0,children:(0,Io.jsx)(oo,{target:r})}),(0,Io.jsxs)(s,{label:`Components`,accordion:!0,children:[(0,Io.jsx)(No,{entity:r}),(0,Io.jsx)(mo,{entity:r})]})]}):null},Lo.__docgenInfo={description:``,methods:[],displayName:`EntityProperty`}})))()}var zo,Bo,Vo;function Ho(){return(Ho=t((()=>{zo=`ExportControl__exportControl___LmV4c`,Bo=`ExportControl__exportControl_inner___LmV4c`,Vo={exportControl:zo,exportControl_inner:Bo,export:`ExportControl__export___LmV4c`}})))()}var Uo,Wo,Go;function Ko(){return(Ko=t((()=>{Uo=i(),w(),I(),Ho(),Wo=o(),Go=()=>{let{editor:e}=F(),[t,n]=(0,Uo.useState)(null);return(0,Uo.useEffect)(()=>{let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),(0,Wo.jsx)(`div`,{className:Vo.exportControl,children:(0,Wo.jsx)(`div`,{className:Vo.exportControl_inner,children:(0,Wo.jsx)(s,{label:`MP4`,accordion:!0,children:(0,Wo.jsx)(`div`,{className:Vo.export,children:(0,Wo.jsx)(c,{onClick:()=>{e.isExporting||e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})})})})})},Go.__docgenInfo={description:``,methods:[],displayName:`ExportControl`}})))()}var qo,Jo;function Yo(){return(Yo=t((()=>{qo=i(),Jo=(0,qo.createContext)(null)})))()}var Xo,Zo;function Qo(){return(Qo=t((()=>{Xo=i(),Yo(),Zo=()=>{let e=(0,Xo.useContext)(Jo);if(e===null)throw Error(`useOREngine must be used within a OREngineProvider`);return e}})))()}var $o,es,ts,ns,rs,is,as,os,ss,cs,ls,us,ds,fs,ps,ms,hs,gs,R;function _s(){return(_s=t((()=>{$o=`GPUTimer__container___LmNvb`,es=`GPUTimer__headerRow___LmNvb`,ts=`GPUTimer__totalTime___LmNvb`,ns=`GPUTimer__toggleButton___LmNvb`,rs=`GPUTimer__controls___LmNvb`,is=`GPUTimer__control___LmNvb`,as=`GPUTimer__controlLabel___LmNvb`,os=`GPUTimer__select___LmNvb`,ss=`GPUTimer__input___LmNvb`,cs=`GPUTimer__group___LmNvb`,ls=`GPUTimer__item___LmNvb`,us=`GPUTimer__clickable___LmNvb`,ds=`GPUTimer__itemRow___LmNvb`,fs=`GPUTimer__itemName___LmNvb`,ps=`GPUTimer__itemTime___LmNvb`,ms=`GPUTimer__itemStats___LmNvb`,hs=`GPUTimer__progressBar___LmNvb`,gs=`GPUTimer__progressFill___LmNvb`,R={container:$o,headerRow:es,totalTime:ts,toggleButton:ns,controls:rs,control:is,controlLabel:as,select:os,input:ss,group:cs,item:ls,clickable:us,itemRow:ds,itemName:fs,itemTime:ps,itemStats:ms,progressBar:hs,progressFill:gs}})))()}var vs,ys;function bs(){return(bs=t((()=>{vs=class{buffer;index;size;filled;constructor(e){this.size=e,this.buffer=Array(e),this.index=0,this.filled=!1}push(e){this.buffer[this.index]=e,this.index=(this.index+1)%this.size,!this.filled&&this.index===0&&(this.filled=!0)}getAverage(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=0;for(let n=0;n<e;n++)t+=this.buffer[n];return t/e}getMax(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]>t&&(t=this.buffer[n]);return t}getMin(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]<t&&(t=this.buffer[n]);return t}getCount(){return this.filled?this.size:this.index}},ys=class{buffers;windowSize;currentData;constructor(e=30){this.windowSize=e,this.buffers=new Map,this.currentData=new Map}update(e){let t=performance.now();for(let n=0;n<e.length;n++){let r=e[n],i=r.name.split(`/`),a=i[0]||`unknown`,o,s=i[i.length-1],c=s&&s.match(/\[([^\]]+)\]/);c&&(o=c[1]);let l={name:r.name,duration:r.duration,timestamp:t,renderType:a},u=this.buffers.get(r.name);u||(u=new vs(this.windowSize),this.buffers.set(r.name,u)),u.push(r.duration),this.currentData.set(r.name,{...l,entityId:o})}}getStatistics(){let e=[],t=0,n=performance.now(),r=[];return this.currentData.forEach((e,t)=>{n-e.timestamp>1e3&&r.push(t)}),r.forEach(e=>{this.currentData.delete(e)}),this.currentData.forEach(e=>{t+=e.duration}),this.currentData.forEach(n=>{let r=this.buffers.get(n.name);r&&e.push({name:n.name,renderType:n.renderType,entityId:n.entityId,current:n.duration,avg:r.getAverage(),max:r.getMax(),min:r.getMin(),samples:r.getCount(),percentage:t>0?n.duration/t*100:0})}),e}getTotalTime(){let e=0;return this.currentData.forEach(t=>{e+=t.duration}),e}}})))()}var xs,z,Ss,Cs,ws,Ts;function Es(){return(Es=t((()=>{xs=i(),Qo(),I(),_s(),bs(),z=o(),Ss=e=>{if(e<2){let t=e/2;return`rgb(${Math.floor(100+t*100)}, 200, 100)`}if(e<5){let t=(e-2)/3;return`rgb(200, ${Math.floor(200-t*50)}, 100)`}if(e<10){let t=(e-5)/5;return`rgb(200, ${Math.floor(150-t*80)}, ${Math.floor(100-t*50)})`}return`rgb(200, 70, 50)`},Cs=e=>e>=10?e.toFixed(1):e>=1?e.toFixed(2):e.toFixed(3),ws=e=>e.replace(/\[([^\]]{4,})\]/g,(e,t)=>`[${t.slice(0,3)}]`),Ts=()=>{let{editor:e}=F(),{engine:t}=Zo(),[n,r]=(0,xs.useState)([]),[i,a]=(0,xs.useState)(0),[o,s]=(0,xs.useState)(`all`),[c,l]=(0,xs.useState)(0),[u,d]=(0,xs.useState)(`time`),[f,p]=(0,xs.useState)(!1),m=(0,xs.useRef)(new ys(30)),h=(0,xs.useRef)(0),g=(0,xs.useRef)(!1),_=(0,xs.useRef)(0),v=(0,xs.useCallback)(n=>{if(!n)return;let r=t.root.findEntityByUUID(n);r&&e.selectEntity(r)},[t,e]);(0,xs.useEffect)(()=>{let e=t.renderer,n=m.current,i=e=>{f&&(n.update(e),g.current=!0)},o=e=>{g.current&&e-_.current>=300&&(r(n.getStatistics()),a(n.getTotalTime()),g.current=!1,_.current=e),h.current=requestAnimationFrame(o)};return e.on(`timer`,i),h.current=requestAnimationFrame(o),()=>{e.off(`timer`,i),cancelAnimationFrame(h.current)}},[t,f]);let y=n.filter(e=>!(o!==`all`&&e.renderType!==o||e.avg<c)),b=Array.from(new Set(n.map(e=>e.renderType))),x=[...y].sort((e,t)=>u===`time`?t.avg-e.avg:e.name.localeCompare(t.name)),S=i>0?Math.floor(1e3/i):0;return(0,z.jsxs)(`div`,{className:R.container,children:[(0,z.jsxs)(`div`,{className:R.headerRow,children:[(0,z.jsxs)(`span`,{className:R.totalTime,children:[Cs(i),`ms (`,S,`fps)`]}),(0,z.jsx)(`button`,{className:R.toggleButton,onClick:()=>p(!f),title:f?`Stop timer`:`Start timer`,children:f?`⏸`:`▶`})]}),(0,z.jsxs)(`div`,{className:R.controls,children:[(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Type`}),(0,z.jsxs)(`select`,{className:R.select,value:o,onChange:e=>s(e.target.value),children:[(0,z.jsx)(`option`,{value:`all`,children:`All`}),b.map(e=>(0,z.jsx)(`option`,{value:e,children:e},e))]})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Min`}),(0,z.jsx)(`input`,{className:R.input,type:`number`,min:`0`,step:`0.1`,value:c,onChange:e=>l(parseFloat(e.target.value)||0)})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Sort`}),(0,z.jsxs)(`select`,{className:R.select,value:u,onChange:e=>d(e.target.value),children:[(0,z.jsx)(`option`,{value:`time`,children:`Time`}),(0,z.jsx)(`option`,{value:`name`,children:`Name`})]})]})]}),(0,z.jsx)(`div`,{className:R.group,children:x.map((e,t)=>{let n=Ss(e.avg),r=i>0?e.avg/i*100:0,a=!!e.entityId;return(0,z.jsxs)(`div`,{className:`${R.item} ${a?R.clickable:``}`,onClick:()=>v(e.entityId),children:[(0,z.jsxs)(`div`,{className:R.itemRow,children:[(0,z.jsx)(`span`,{className:R.itemName,title:e.name,children:ws(e.name)}),(0,z.jsx)(`span`,{className:R.itemTime,style:{color:n},children:Cs(e.avg)}),(0,z.jsx)(`span`,{className:R.itemStats,children:Cs(e.max)})]}),(0,z.jsx)(`div`,{className:R.progressBar,children:(0,z.jsx)(`div`,{className:R.progressFill,style:{width:`${r}%`,backgroundColor:n}})})]},e.name+t)})})]})},Ts.__docgenInfo={description:``,methods:[],displayName:`Timer`}})))()}var Ds,Os,ks,As,js,Ms,Ns,Ps,Fs,Is,Ls,Rs,zs;function Bs(){return(Bs=t((()=>{Ds=`HierarchyNode__node___Lm5vZ`,Os=`HierarchyNode__self_name___Lm5vZ`,ks=`HierarchyNode__self_name_input___Lm5vZ`,As=`HierarchyNode__icon___Lm5vZ`,js=`HierarchyNode__selectable___Lm5vZ`,Ms=`HierarchyNode__self___Lm5vZ`,Ns=`HierarchyNode__visibility___Lm5vZ`,Ps=`HierarchyNode__menu___Lm5vZ`,Fs=`HierarchyNode__fold___Lm5vZ`,Is=`HierarchyNode__fold_button___Lm5vZ`,Ls=`HierarchyNode__child___Lm5vZ`,Rs=`HierarchyNode__child_line___Lm5vZ`,zs={node:Ds,self_name:Os,self_name_input:ks,icon:As,selectable:js,self:Ms,visibility:Ns,menu:Ps,fold:Fs,fold_button:Is,child:Ls,child_line:Rs}})))()}var Vs,Hs,Us;function Ws(){return(Ws=t((()=>{Vs=i(),N(),w(),_a(),I(),co(),Bs(),Hs=o(),Us=e=>{let{editor:t,engine:n}=F(),[r]=L(t,`selectedEntityId`),i=r!==void 0&&n.root.findEntityByUUID(r),o=!!(i&&i.uuid==e.entity.uuid),[s]=L(e.entity,`name`),[c,u]=L(e.entity,`visible`),[f,m]=L(t,`unselectableEntityIds`),[_]=L(e.entity,`children`),v=!(f||[]).includes(e.entity.uuid),y=(_||[]).map(e=>n.root.findEntityByUUID(e)).filter(e=>e!==void 0),b=e.depth||0,x=y&&y.concat().sort((e,t)=>e.name.localeCompare(t.name))||[],C=x.length>0,ee=b*20,te=e.entity.initiator==`script`,w=(0,Vs.useMemo)(()=>e.entity.getComponent(Vt)?(0,Hs.jsx)(p,{size:14}):e.entity.getComponent(Lt)?(0,Hs.jsx)(l,{size:14}):e.entity.getComponent(A)?(0,Hs.jsx)(h,{size:14}):null,[e.entity]),ne=e.openNodes.has(e.entity.uuid),re=(0,Vs.useCallback)(t=>{e.setNodeOpen(e.entity.uuid,!ne),t.stopPropagation()},[ne,e]),ae=(0,Vs.useCallback)(()=>{t&&t.selectEntity(e.entity)},[t,e.entity]),oe=(0,Vs.useCallback)(e=>{e.stopPropagation(),u&&u(!c)},[c,u]),le=(0,Vs.useCallback)(t=>{t.stopPropagation();let n=new Set(f||[]);v?n.add(e.entity.uuid):n.delete(e.entity.uuid),m(Array.from(n))},[v,f,m,e.entity.uuid]),[ue,de]=(0,Vs.useState)(null),fe=(0,Vs.useRef)(!1),pe=(0,Vs.useCallback)(()=>{te||de(e.entity.name)},[te,e.entity]);(0,Vs.useEffect)(()=>{let n=t=>{t===e.entity&&pe()};return t.on(`request/renameEntity`,n),()=>{t.off(`request/renameEntity`,n)}},[t,e.entity,pe]);let me=(0,Vs.useCallback)(e=>{e.key===`Enter`&&e.currentTarget.blur(),e.key===`Escape`&&(fe.current=!0,e.currentTarget.blur())},[]),he=(0,Vs.useCallback)(()=>{let n=fe.current;if(fe.current=!1,de(null),n||ue===null)return;let r=ue.trim();r!==``&&r!==e.entity.name&&t.api.setField(e.entity,`name`,r)},[ue,t,e.entity]),{open:ge,closeAll:_e}=S(),ve=ga(e.entity),ye=(0,Vs.useCallback)(n=>{if(n.preventDefault(),!t||te)return;t.selectEntity(e.entity);let r=[{label:`Add Entity`,children:ve}];e.entity.parent&&r.push({label:`Duplicate`,onClick:()=>{let n=t.api.duplicateEntity(e.entity);t.selectEntity(n),_e()}}),r.push({label:`Rename`,onClick:()=>{t.emit(`request/renameEntity`,[e.entity]),_e()}},{label:`Delete Entity`,onClick:()=>{t.api.deleteEntity(e.entity),_e()}}),ge((0,Hs.jsx)(ce,{title:e.entity.name,items:r}),ie(n.clientX,n.clientY))},[t,e.entity,ge,_e,te,ve]),be=(0,Hs.jsx)(`p`,{children:s||`-`});return ue!==null&&(be=(0,Hs.jsx)(`input`,{className:zs.self_name_input,value:ue,autoFocus:!0,onChange:e=>de(e.target.value),onFocus:e=>e.currentTarget.select(),onKeyDown:me,onBlur:he,onClick:e=>e.stopPropagation()})),(0,Hs.jsxs)(`div`,{className:zs.node,"data-no_export":te,children:[(0,Hs.jsxs)(se,{className:zs.self,style:{paddingLeft:ee},onClick:ae,onContextMenu:ye,selected:o,children:[(0,Hs.jsx)(`div`,{className:zs.fold,"data-hnode_open":ne,children:C&&(0,Hs.jsx)(`button`,{className:zs.fold_button,onClick:re,children:(0,Hs.jsx)(a,{open:ne})})}),w&&(0,Hs.jsx)(`div`,{className:zs.icon,children:w}),(0,Hs.jsx)(`div`,{className:zs.self_name,onDoubleClick:pe,children:be}),(0,Hs.jsx)(`button`,{className:zs.selectable,onClick:le,"data-selectable":v,children:(0,Hs.jsx)(d,{size:14,selectable:v})}),(0,Hs.jsx)(`button`,{className:zs.visibility,onClick:oe,"data-visible":c!==!1,children:(0,Hs.jsx)(g,{size:14,visible:c!==!1})}),!te&&(0,Hs.jsx)(`button`,{className:zs.menu,onClick:ye,children:`⋯`})]}),C&&(0,Hs.jsxs)(`div`,{className:zs.child,"data-open":ne,children:[x.map(t=>(0,Hs.jsx)(Us,{entity:t,depth:b+1,openNodes:e.openNodes,setNodeOpen:e.setNodeOpen},t.uuid)),(0,Hs.jsx)(`div`,{className:zs.child_line,style:{marginLeft:ee+4}})]})]})},Us.__docgenInfo={description:``,methods:[],displayName:`HierarchyNode`,props:{depth:{required:!1,tsType:{name:`number`},description:``},entity:{required:!0,tsType:{name:`MXP.Entity`},description:``},openNodes:{required:!0,tsType:{name:`Set`,elements:[{name:`string`}],raw:`Set<string>`},description:``},setNodeOpen:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( uuid: string, open: boolean ) => void`,signature:{arguments:[{type:{name:`string`},name:`uuid`},{type:{name:`boolean`},name:`open`}],return:{name:`void`}}},description:``}}}})))()}var Gs;function Ks(){return(Ks=t((()=>{Gs={}})))()}var qs,Js,Ys,Xs,Zs,Qs;function $s(){return($s=t((()=>{qs=i(),I(),co(),Ws(),Ks(),Js=o(),Ys=`hierarchyOpenNodes`,Xs=()=>{try{let e=localStorage.getItem(Ys);if(e)return new Set(JSON.parse(e))}catch{}return new Set},Zs=e=>{localStorage.setItem(Ys,JSON.stringify(Array.from(e)))},Qs=()=>{let{editor:e,engine:t}=F(),[n]=L(e,`selectedEntityId`),r=t.root,[i,a]=(0,qs.useState)(Xs),o=(0,qs.useCallback)((e,t)=>{a(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),Zs(r),r})},[]);return(0,qs.useEffect)(()=>{if(!n)return;let e=r.findEntityByUUID(n);if(!e)return;let t=[],i=e.parent;for(;i;)t.push(i.uuid),i=i.parent;a(e=>{if(t.every(t=>e.has(t)))return e;let n=new Set(e);return t.forEach(e=>n.add(e)),Zs(n),n})},[n,r]),(0,Js.jsx)(`div`,{className:Gs.hierarchy,children:r&&(0,Js.jsx)(Us,{entity:r,openNodes:i,setNodeOpen:o})})},Qs.__docgenInfo={description:``,methods:[],displayName:`Hierarchy`}})))()}var ec,tc;function nc(){return(nc=t((()=>{ec=`Canvas__container___LmNvb`,tc={container:ec}})))()}var rc,ic,ac;function oc(){return(oc=t((()=>{rc=i(),I(),nc(),ic=o(),ac=({viewportId:e})=>{let{engine:t,editor:n}=F(),r=(0,rc.useRef)(null);return(0,rc.useEffect)(()=>{let i=r.current;if(!t||!i)return;let a=n.createViewport(e,i);return()=>{a.dispose()}},[t,n,e]),(0,ic.jsx)(`div`,{className:tc.container,role:`presentation`,"aria-label":`3D Canvas`,children:(0,ic.jsx)(`canvas`,{ref:r})})},ac.__docgenInfo={description:``,methods:[],displayName:`Canvas`}})))()}var sc,cc;function lc(){return(lc=t((()=>{sc=`AudioView__audioView___LmF1Z`,cc={audioView:sc}})))()}var uc;function dc(){return(dc=t((()=>{ot(),D(),uc=class extends nt{wrapperElm;canvas;canvasCtx;viewRangeFrame;viewPort;viewPortRange;musicBuffer;resizeObserver;frameSetting;framePlay;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0];let e=window.localStorage.getItem(`audioViweRange`);this.viewRangeFrame=e?Number(e):2,this.frameSetting={duration:0,fps:60},this.framePlay={current:0,playing:!1},this.musicBuffer=null,this.resizeObserver=new ResizeObserver(this.onResize.bind(this))}onResize(){if(this.wrapperElm){let e=new T(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);this.canvas.width=e.x,this.canvas.height=e.y}this.render()}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.musicBuffer){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)]*1,s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]*1+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}this.canvasCtx.fillStyle=`#555`,this.canvasCtx.fillRect(this.canvas.width/2,0,1,this.canvas.height)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.canvas),this.onResize()}setFramePlaying(e){this.framePlay=e,this.viewPort=[this.framePlay.current-this.viewRangeFrame,0,this.framePlay.current+this.viewRangeFrame,0],this.viewPortRange=[this.viewPort[2]-this.viewPort[0],this.viewPort[3]-this.viewPort[1]],this.render()}setViewRangeFrame(e){this.viewRangeFrame=e,this.setFramePlaying(this.framePlay),localStorage.setItem(`audioViweRange`,String(this.viewRangeFrame))}setFrameSetting(e){this.frameSetting=e,this.render()}setMusicBuffer(e){this.musicBuffer=e,this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.canvas),this.resizeObserver.disconnect()}},uc.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setFramePlaying`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`FramePlay`,alias:`FramePlay`}}],returns:null},{name:`setViewRangeFrame`,docblock:null,modifiers:[],params:[{name:`rangeFrame`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frameSetting`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`AudioViewRenderer`}})))()}var fc,pc,mc;function hc(){return(hc=t((()=>{fc=i(),I(),lc(),dc(),pc=o(),mc=()=>{let{editor:e}=F(),t=(0,fc.useRef)(null),[n,r]=(0,fc.useState)();(0,fc.useEffect)(()=>{let e=new uc;if(r(e),t.current)return e.setWrapperElm(t.current),()=>{e.dispose()}},[]);let i=e&&e.audioBuffer,[a,o]=(0,fc.useState)(),[s,c]=(0,fc.useState)({duration:0,fps:0}),[l,u]=(0,fc.useState)({current:0,playing:!1});(0,fc.useEffect)(()=>{if(!e)return;let t=e.engine,n=e=>{c({duration:e[`timeline/duration`],fps:e[`timeline/fps`]})},r=0,i=()=>{o(r++)},a=e=>{u({...e})};return n(t.serialize()),a(t.frame),t.on(`fields/update`,n),t.on(`update/music`,i),t.on(`update/frame/play`,a),()=>{t.off(`update/frame/setting`,n),t.off(`update/music`,i),t.off(`update/frame/play`,a)}},[e]),(0,fc.useEffect)(()=>{n&&i&&n.setMusicBuffer(i)},[n,i,a]),(0,fc.useEffect)(()=>{n&&l&&n.setFramePlaying(l)},[n,l]),(0,fc.useEffect)(()=>{n&&s&&n.setFrameSetting(s)},[n,s]);let d=(0,fc.useCallback)(e=>{if(n){let t=e.deltaY>0?1.1:.9;n.setViewRangeFrame(n.viewRangeFrame*t)}e.preventDefault()},[n]);return(0,fc.useEffect)(()=>{let e=t.current;return e&&e.addEventListener(`wheel`,d,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,d)}},[d]),(0,pc.jsx)(`div`,{className:cc.audioView,ref:t})},mc.__docgenInfo={description:``,methods:[],displayName:`AudioView`}})))()}var gc,_c,vc;function yc(){return(yc=t((()=>{gc=`CameraPad__cameraPad___LmNhb`,_c=`CameraPad__btn___LmNhb`,vc={cameraPad:gc,btn:_c}})))()}var bc,xc;function Sc(){return(Sc=t((()=>{I(),co(),yc(),bc=o(),xc=({viewportId:e})=>{let{editor:t}=F(),[n]=L(t,`selectedEntityId`),[r]=L(t,`viewports/${e}/cameraView`);return(0,bc.jsxs)(`div`,{className:vc.cameraPad,children:[(0,bc.jsx)(`div`,{className:vc.btn,"data-disabled":!n,onClick:()=>{n&&t.focusSelected()},title:`Focus selected ( . )`,children:`Focus`}),(0,bc.jsx)(`div`,{className:vc.btn,"data-active":r===`camera`,onClick:()=>{t.toggleCameraView()},title:`Toggle scene camera view ( 0 )`,children:`Scene Cam`})]})},xc.__docgenInfo={description:``,methods:[],displayName:`CameraPad`}})))()}var Cc,wc,Tc,Ec,Dc,Oc,kc,Ac,jc,Mc,Nc,Pc,Fc,Ic,Lc,Rc,zc,Bc,Vc,Hc,Uc,B;function Wc(){return(Wc=t((()=>{Cc=`Screen__screen___LnNjc`,wc=`Screen__header___LnNjc`,Tc=`Screen__header_tabs___LnNjc`,Ec=`Screen__header_tab___LnNjc`,Dc=`Screen__header_right___LnNjc`,Oc=`Screen__header_item___LnNjc`,kc=`Screen__content___LnNjc`,Ac=`Screen__gizmoMode___LnNjc`,jc=`Screen__gizmoMode_btn___LnNjc`,Mc=`Screen__gizmoMode_separator___LnNjc`,Nc=`Screen__modalStatus___LnNjc`,Pc=`Screen__canvas___LnNjc`,Fc=`Screen__audioViewHandle___LnNjc`,Ic=`Screen__audioView___LnNjc`,Lc=`Screen__displayOptions___LnNjc`,Rc=`Screen__displayOptions_btn___LnNjc`,zc=`Screen__overlay___LnNjc`,Bc=`Screen__overlay_field___LnNjc`,Vc=`Screen__overlay_label___LnNjc`,Hc=`Screen__overlay_separator___LnNjc`,Uc=`Screen__externalBtn___LnNjc`,B={screen:Cc,header:wc,header_tabs:Tc,header_tab:Ec,header_right:Dc,header_item:Oc,content:kc,gizmoMode:Ac,gizmoMode_btn:jc,gizmoMode_separator:Mc,modalStatus:Nc,canvas:Pc,audioViewHandle:Fc,audioView:Ic,displayOptions:Lc,displayOptions_btn:Rc,overlay:zc,overlay_field:Bc,overlay_label:Vc,overlay_separator:Hc,externalBtn:Uc}})))()}var Gc,V,Kc,qc;function Jc(){return(Jc=t((()=>{Gc=i(),w(),we(),I(),ia(),oc(),Yi(),co(),hc(),Sc(),Wc(),V=o(),Kc=`viewport`,qc=({viewportId:e})=>{let{editor:t}=F(),n=Ce(),[r,i]=L(t,`enableRender`),[a,o]=L(t,`viewports/${e}/preview`),[s,l]=L(t,`viewType`),[u,d]=L(t,`viewports/${e}/resolutionScale`),[f,p]=L(t,`gizmoMode`),[m,h]=L(t,`transformOrientation`),[g]=L(t,`modalStatus`),[_,v]=L(t,`viewports/${e}/helpers/show`),[y,b]=L(t,`viewports/${e}/helpers/empty`),[x,S]=L(t,`viewports/${e}/helpers/camera`),[C,ee]=L(t,`viewports/${e}/helpers/light`),[te,w]=L(t,`viewports/${e}/helpers/grid`),[ne,re]=L(t,`viewports/${e}/helpers/wireframe`),[ie,oe]=L(t,`viewports/${e}/helpers/gizmo`),[se,ce]=L(t,`viewports/${e}/helpers/outline`),[le]=ra(`showAudioView`),[ue,de]=(0,Gc.useState)(50),fe=(0,Gc.useRef)(null),[pe,me]=(0,Gc.useState)(!1),he=(0,Gc.useRef)(null),ge=(0,Gc.useCallback)(e=>{he.current&&!he.current.contains(e.target)&&me(!1)},[]);return(0,Gc.useEffect)(()=>(pe&&document.addEventListener(`pointerdown`,ge),()=>{document.removeEventListener(`pointerdown`,ge)}),[pe,ge]),(0,V.jsxs)(`div`,{className:B.screen,children:[(0,V.jsxs)(`div`,{className:B.header,children:[(0,V.jsx)(`div`,{className:B.header_tabs,children:(0,V.jsx)(`div`,{className:B.header_tab,"data-active":!!a,onClick:()=>o&&o(!a),title:`Camera Render`,children:(0,V.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 512 512`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,V.jsx)(`path`,{d:`M32 144 H336 V368 H32 Z M368 224 L480 152 V360 L368 288 Z`})})})}),(0,V.jsxs)(`div`,{className:B.header_right,children:[(0,V.jsx)(`div`,{className:B.header_item,children:(0,V.jsx)(ae,{title:`View`,children:(0,V.jsx)(Ji,{value:s,format:{type:`select`,list:[`render`,`debug`]},onChange:e=>l&&l(e)})})}),(0,V.jsx)(`div`,{className:B.header_item,children:(0,V.jsx)(ae,{title:`Res`,children:(0,V.jsx)(Ji,{value:u,format:{type:`select`,list:[,,,,,,].fill(0).map((e,t)=>{let n=2**t,r=1/n;return{value:r,label:r==1?`1`:`1/`+n}})},onChange:e=>d&&d(e)})})}),n.isPC&&(0,V.jsx)(`div`,{className:B.externalBtn,children:(0,V.jsx)(c,{onClick:()=>{t.openInExternalWindow()},children:(0,V.jsxs)(`svg`,{width:`32`,height:`12`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,V.jsxs)(`g`,{clipPath:`url(#clip0_224_2)`,children:[(0,V.jsx)(`path`,{d:`M96 0V416H512V0H96ZM472 376H136V40H472V376Z`,fill:`#aaa`}),(0,V.jsx)(`path`,{d:`M40 472V296V136V96H0V512H416V472H376H40Z`,fill:`#aaa`}),(0,V.jsx)(`path`,{d:`M232.812 312.829L350.671 194.969V279.766H390.671V126.688H237.594V166.688H322.39L204.531 284.547L232.812 312.829Z`,fill:`#aaa`})]}),(0,V.jsx)(`defs`,{children:(0,V.jsx)(`clipPath`,{id:`clip0_224_2`,children:(0,V.jsx)(`rect`,{width:`512`,height:`512`,fill:`white`})})})]})})})]})]}),(0,V.jsxs)(`div`,{className:B.content,children:[(0,V.jsxs)(`div`,{className:B.displayOptions,ref:he,children:[(0,V.jsx)(`div`,{className:B.displayOptions_btn,"data-active":pe,onClick:()=>me(!pe),title:`Display Options`,children:`⚙`}),pe&&(0,V.jsxs)(`div`,{className:B.overlay,children:[(0,V.jsx)(`div`,{className:B.overlay_label,children:`Rendering`}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Render`,children:(0,V.jsx)(Ji,{value:r,onChange:e=>i&&i(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_separator}),(0,V.jsx)(`div`,{className:B.overlay_label,children:`Helpers`}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Show`,children:(0,V.jsx)(Ji,{value:_,onChange:e=>v&&v(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,"data-indent":`true`,children:(0,V.jsx)(ae,{title:`Empty`,children:(0,V.jsx)(Ji,{value:y,onChange:e=>b&&b(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,"data-indent":`true`,children:(0,V.jsx)(ae,{title:`Camera`,children:(0,V.jsx)(Ji,{value:x,onChange:e=>S&&S(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,"data-indent":`true`,children:(0,V.jsx)(ae,{title:`Light`,children:(0,V.jsx)(Ji,{value:C,onChange:e=>ee&&ee(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_separator}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Grid`,children:(0,V.jsx)(Ji,{value:te,onChange:e=>w&&w(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Wireframe`,children:(0,V.jsx)(Ji,{value:ne,onChange:e=>re&&re(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Gizmo`,children:(0,V.jsx)(Ji,{value:ie,onChange:e=>oe&&oe(e)})})}),(0,V.jsx)(`div`,{className:B.overlay_field,children:(0,V.jsx)(ae,{title:`Outline`,children:(0,V.jsx)(Ji,{value:se,onChange:e=>ce&&ce(e)})})})]})]}),(0,V.jsxs)(`div`,{className:B.gizmoMode,children:[[`select`,`translate`,`rotate`,`scale`].map(e=>(0,V.jsx)(`div`,{className:B.gizmoMode_btn,"data-active":f===e,onClick:()=>p&&p(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`select`?`↖`:e===`translate`?`T`:e===`rotate`?`R`:`S`},e)),(0,V.jsx)(`div`,{className:B.gizmoMode_separator}),[`global`,`local`].map(e=>(0,V.jsx)(`div`,{className:B.gizmoMode_btn,"data-active":m===e,onClick:()=>h&&h(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`global`?`G`:`L`},e))]}),g&&(0,V.jsx)(`div`,{className:B.modalStatus,children:g}),(0,V.jsx)(`div`,{className:B.canvas,children:(0,V.jsx)(ac,{viewportId:e})}),n.isSP&&(0,V.jsx)(xc,{viewportId:e}),n.isPC&&le&&(0,V.jsxs)(V.Fragment,{children:[(0,V.jsx)(`div`,{className:B.audioViewHandle,onPointerDown:e=>{e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),fe.current={startY:e.clientY,startHeight:ue}},onPointerMove:e=>{if(!fe.current)return;let t=fe.current.startY-e.clientY,n=Math.max(20,Math.min(400,fe.current.startHeight+t));de(n)},onPointerUp:()=>{fe.current=null}}),(0,V.jsx)(`div`,{className:B.audioView,style:{height:ue},children:(0,V.jsx)(mc,{})})]})]})]})},qc.__docgenInfo={description:``,methods:[],displayName:`Screen`}})))()}function Yc(e,t){let n=e.get(t);if(n)return n;let r=t.indexOf(`:`);if(r===-1)return;let i=e.get(t.slice(0,r));return i?.multiple?i:void 0}function Xc(e){return e.slice(e.indexOf(`:`)+1)}function Zc(e){return e.multiple?`${e.id}:${it.genUUID()}`:e.id}function Qc(e,t){return e.multiple?e.content(Xc(t)):e.content}function $c(){return ll(`vertical`,[{ratio:916/1076,node:ll(`horizontal`,[{ratio:300/1912,node:ll(`vertical`,[{ratio:696/912,node:ul([`hierarchy`,`scene`])},{ratio:216/912,node:ul([`timer`])}])},{ratio:1312/1912,node:ul([`viewport:main`])},{ratio:300/1912,node:ul([`property`,`textures`,`renderer`,`editor-settings`])}])},{ratio:160/1076,node:ul([`timeline`,`export`])}])}function el(e){return e.type===`pane`?[e]:e.children.flatMap(e=>el(e.node))}function tl(e,t){let n=new Set,r=new Set,i=e=>{let t=typeof e==`string`&&e!==``&&!n.has(e)?e:it.genUUID();return n.add(t),t},a=e=>{if(typeof e!=`object`||!e)return null;let n=e;if(n.type===`pane`){if(!Array.isArray(n.tabs))return null;let e=[...new Set(n.tabs.filter(e=>typeof e==`string`))].filter(e=>{let n=t(e);return n?!n.multiple||!r.has(e)&&(r.add(e),!0):!1});if(e.length===0)return null;let a=typeof n.active==`string`&&e.includes(n.active)?n.active:e[0];return{type:`pane`,id:i(n.id),tabs:e,active:a}}if(n.type===`split`){if(n.direction!==`horizontal`&&n.direction!==`vertical`||!Array.isArray(n.children))return null;let e=[];return n.children.forEach(t=>{if(typeof t!=`object`||!t)return;let n=t,r=a(n.node);if(!r)return;let i=typeof n.ratio==`number`&&isFinite(n.ratio)&&n.ratio>0?n.ratio:1;e.push({ratio:i,node:r})}),e.length===0?null:e.length===1?e[0].node:{type:`split`,id:i(n.id),direction:n.direction,children:e}}return null},o=a(e);return o?dl(o):null}function nl(e,t,n){return fl(e,t,e=>e.type!==`pane`||!e.tabs.includes(n)?e:{...e,active:n})}function rl(e,t){let n=e;for(let r of el(e))for(let e of t)r.tabs.includes(e)&&r.active!==e&&(n=nl(n,r.id,e));return n}function il(e,t,n,r){return fl(e,t,e=>{if(e.type!==`pane`||e.tabs.includes(n))return e;let t=[...e.tabs];return t.splice(Math.max(0,Math.min(r??t.length,t.length)),0,n),{...e,tabs:t,active:n}})}function al(e,t,n,r,i){if(t===r)return fl(e,t,e=>{if(e.type!==`pane`)return e;let t=e.tabs.indexOf(n);if(t===-1)return e;let r=e.tabs.filter(e=>e!==n),a=i??e.tabs.length,o=Math.max(0,Math.min(t<a?a-1:a,r.length));return o===t?e:(r.splice(o,0,n),{...e,tabs:r,active:n})});let a=el(e),o=a.find(e=>e.id===t),s=a.find(e=>e.id===r);return!o||!s||!o.tabs.includes(n)||s.tabs.includes(n)?e:il(sl(e,t,n),r,n,i)}function ol(e,t,n,r,i){let a=el(e),o=a.find(e=>e.id===r);if(!o||!o.tabs.includes(i)||!a.some(e=>e.id===t)||r===t&&o.tabs.length===1)return e;let s=sl(e,r,i),c={type:`pane`,id:it.genUUID(),tabs:[i],active:i},l=fl(s,t,e=>{let t=[{ratio:.5,node:c},{ratio:.5,node:e}];return(n===`right`||n===`bottom`)&&t.reverse(),{type:`split`,id:it.genUUID(),direction:n===`left`||n===`right`?`horizontal`:`vertical`,children:t}});return l===s?e:dl(l)??e}function sl(e,t,n){let r=fl(e,t,e=>{if(e.type!==`pane`||!e.tabs.includes(n))return e;let t=e.tabs.indexOf(n),r=e.tabs.filter(e=>e!==n),i=e.active!==n||r.length===0?e.active:r[Math.min(t,r.length-1)];return{...e,tabs:r,active:i}});return r===e?e:dl(r)??e}function cl(e,t,n){return fl(e,t,e=>e.type!==`split`||e.children.length!==n.length?e:{...e,children:e.children.map((e,t)=>({...e,ratio:n[t]}))})}var ll,ul,dl,fl;function pl(){return(pl=t((()=>{ot(),ll=(e,t)=>({type:`split`,id:it.genUUID(),direction:e,children:t}),ul=e=>({type:`pane`,id:it.genUUID(),tabs:e,active:e[0]}),dl=e=>{if(e.type===`pane`)return e.tabs.length>0?e:null;let t=[];if(e.children.forEach(n=>{let r=dl(n.node);r&&(r.type===`split`&&r.direction===e.direction?r.children.forEach(e=>t.push({ratio:n.ratio*e.ratio,node:e.node})):t.push(r===n.node?n:{...n,node:r}))}),t.length===0)return null;if(t.length===1)return t[0].node;let n=t.reduce((e,t)=>e+t.ratio,0);return Math.abs(n-1)>1e-6?{...e,children:t.map(e=>({...e,ratio:e.ratio/n}))}:t.length!==e.children.length||t.some((t,n)=>t!==e.children[n])?{...e,children:t}:e},fl=(e,t,n)=>{if(e.id===t)return n(e);if(e.type===`split`){let r=!1,i=e.children.map(e=>{let i=fl(e.node,t,n);return i===e.node?e:(r=!0,{...e,node:i})});if(r)return{...e,children:i}}return e}})))()}function ml(e,t,n){let[r,i]=(0,hl.useState)(null),a=(0,hl.useRef)(e);a.current=e;let o=(0,hl.useRef)(t);o.current=t;let s=(0,hl.useRef)(null);return(0,hl.useEffect)(()=>()=>s.current?.(),[]),{dragState:r,onTabPointerDown:(e,t,r)=>{if(r.button!==0||s.current)return;let c=r.clientX,l=r.clientY,u=!1,d=null,f=r=>{if(r.buttons===0){p(!1);return}if(!u){if(Math.hypot(r.clientX-c,r.clientY-l)<gl)return;u=!0,i({panelId:t,title:n(t)?.title??t,startX:r.clientX,startY:r.clientY,target:null})}let o=bl(r.clientX,r.clientY,a.current,e,t);xl(o,d)||(d=o,i(e=>e&&{...e,target:o}))},p=n=>{if(g(),n&&u&&d){let n=a.current;d.kind===`tabs`?o.current(al(n,e,t,d.paneId,d.index)):d.zone===`center`?o.current(al(n,e,t,d.paneId)):o.current(ol(n,d.paneId,d.zone,e,t))}u&&i(null)},m=()=>p(!0),h=()=>p(!1),g=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),s.current=null};s.current=g,window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h)}}}var hl,gl,_l,vl,yl,bl,xl;function Sl(){return(Sl=t((()=>{hl=i(),pl(),gl=4,_l=.25,vl=(e,t)=>{let n={left:e.left,top:e.top,width:e.width,height:e.height};return(t===`left`||t===`right`)&&(n.width/=2),t===`right`&&(n.left+=n.width),(t===`top`||t===`bottom`)&&(n.height/=2),t===`bottom`&&(n.top+=n.height),n},yl=(e,t,n,r,i)=>{if(n.id!==r&&n.tabs.includes(i))return null;let a=[...t.querySelectorAll(`[data-panel-tab-id]`)].filter(e=>e instanceof HTMLElement),o=a.length;for(let t=0;t<a.length;t++){let n=a[t].getBoundingClientRect();if(e<n.left+n.width/2){o=t;break}}let s=t.getBoundingClientRect(),c=o<a.length?a[o].getBoundingClientRect().left:a.length>0?a[a.length-1].getBoundingClientRect().right:s.left;return{kind:`tabs`,paneId:n.id,index:o,rect:{left:c-1,top:s.top,width:2,height:s.height}}},bl=(e,t,n,r,i)=>{let a=document.elementFromPoint(e,t);if(!a)return null;let o=a.closest(`[data-pane-id]`);if(!(o instanceof HTMLElement))return null;let s=el(n).find(e=>e.id===o.dataset.paneId);if(!s)return null;let c=a.closest(`[data-panel-tab-header]`);if(c instanceof HTMLElement)return yl(e,c,s,r,i);let l=o.querySelector(`[data-panel-content]`);if(!(l instanceof HTMLElement))return null;let u=l.getBoundingClientRect();if(u.width<=0||u.height<=0)return null;let d=(e-u.left)/u.width,f=(t-u.top)/u.height;if(d<0||d>1||f<0||f>1)return null;if(Math.min(d,1-d)>_l&&Math.min(f,1-f)>_l)return s.id===r||s.tabs.includes(i)?null:{kind:`zone`,paneId:s.id,zone:`center`,rect:vl(u,`center`)};if(s.id===r&&s.tabs.length===1)return null;let p=d-.5,m=f-.5,h=Math.abs(p)>=Math.abs(m)?p<0?`left`:`right`:m<0?`top`:`bottom`;return{kind:`zone`,paneId:s.id,zone:h,rect:vl(u,h)}},xl=(e,t)=>e===null||t===null?e===t:e.paneId===t.paneId?e.kind===`tabs`&&t.kind===`tabs`?e.index===t.index:e.kind===`zone`&&t.kind===`zone`&&e.zone===t.zone:!1})))()}var Cl,wl;function Tl(){return(Tl=t((()=>{Cl=`PanelLayout__pane___LnBhb`,wl={pane:Cl}})))()}function El(e,t){let n=[];for(let r of e){let e=n;if(r.category)for(let t of r.category.split(`/`)){if(t===``)continue;let n;for(let r of e)if(r.label===t&&`children`in r){n=r;break}n||(n={label:t,children:[]},e.push(n)),e=n.children}e.push({label:r.title,onClick:()=>t(r)})}return n}var Dl,Ol,kl,Al;function jl(){return(jl=t((()=>{Dl=i(),w(),I(),Jc(),co(),de(),Sl(),Tl(),pl(),Ol=o(),kl=e=>{let t=e.node;if(t.type===`split`)return(0,Ol.jsx)(oe,{direction:t.direction,ratios:t.children.map(e=>e.ratio),onRatiosChange:n=>e.onRatiosChange(t.id,n),children:t.children.map(t=>(0,Ol.jsx)(oe.Item,{children:(0,Ol.jsx)(kl,{...e,node:t.node})},t.node.id))});let n=t.tabs.flatMap(t=>{let n=e.resolve(t);return n?[{id:t,title:n.title,content:Qc(n,t)}]:[]});if(n.length===0)return null;let r=e.hasAddable(t);return(0,Ol.jsx)(`div`,{className:wl.pane,"data-pane-id":t.id,children:(0,Ol.jsx)(ue,{tabs:n,active:t.active,onSelect:n=>e.onSelectTab(t.id,n),onTabContextMenu:(n,r)=>e.onTabContextMenu(t.id,n,r),onTabPointerDown:(n,r)=>e.onTabPointerDown(t.id,n,r),onAddClick:r?n=>e.onAddTab(t.id,n):void 0})})},Al=e=>{let{editor:t}=F(),{open:n,closeAll:r}=S(),i=(0,Dl.useMemo)(()=>{let t=new Map;return e.panels.forEach(e=>t.set(e.id,e)),t},[e.panels]),a=(0,Dl.useMemo)(()=>e=>Yc(i,e),[i]),[o,s]=L(t,`panelLayout`),c=(0,Dl.useMemo)(()=>tl(o,a)??$c(),[o,a]);(0,Dl.useEffect)(()=>{let e=new Set(el(c).flatMap(e=>e.tabs).filter(e=>a(e)?.id===Kc).map(Xc));t.pruneViewportSettings(e)},[c,a,t]);let[l,u]=(0,Dl.useState)(()=>!!t.getField(`selectedEntityId`));(0,Dl.useEffect)(()=>{let e=()=>{t.getField(`selectedEntityId`)&&u(!0)};return t.on(`fields/update/selectedEntityId`,e),()=>{t.off(`fields/update/selectedEntityId`,e)}},[t]);let d=e=>{e!==c&&s(e)},f=e.activateOnSelect;(0,Dl.useEffect)(()=>{if(!l||(u(!1),!f))return;let e=rl(c,f);e!==c&&t.setField(`panelLayout`,e)},[l,f,c,t]);let p=(e,t)=>d(nl(c,e,t)),m=(e,t)=>d(cl(c,e,t)),{dragState:h,onTabPointerDown:g}=ml(c,d,a),_=e=>[...i.values()].filter(t=>t.multiple||!e.tabs.includes(t.id));return(0,Ol.jsxs)(Ol.Fragment,{children:[(0,Ol.jsx)(kl,{node:c,resolve:a,onSelectTab:p,onRatiosChange:m,onTabContextMenu:(e,t,i)=>{i.preventDefault(),el(c).reduce((e,t)=>e+t.tabs.length,0)>1&&n((0,Ol.jsx)(ce,{title:a(t)?.title,items:[{label:`Close Tab`,onClick:()=>{d(sl(c,e,t)),r()}}]}),ie(i.clientX,i.clientY))},onTabPointerDown:g,onAddTab:(e,t)=>{let i=el(c).find(t=>t.id===e);if(!i)return;let a=_(i);if(a.length===0)return;let o=El(a,t=>{d(il(c,e,Zc(t))),r()});n((0,Ol.jsx)(ce,{items:o}),ie(t.clientX,t.clientY))},hasAddable:e=>_(e).length>0}),h&&(0,Ol.jsx)(fe,{drag:h})]})},Al.__docgenInfo={description:``,methods:[],displayName:`PanelLayout`,props:{panels:{required:!0,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},activateOnSelect:{required:!1,tsType:{name:`Array`,elements:[{name:`string`}],raw:`PanelId[]`},description:``}}}})))()}var Ml,Nl,Pl;function Fl(){return(Fl=t((()=>{Ml=`RendererSettings__renderer___LnJlb`,Nl=`RendererSettings__renderer_inner___LnJlb`,Pl={renderer:Ml,renderer_inner:Nl}})))()}var Il,Ll;function Rl(){return(Rl=t((()=>{w(),I(),so(),Fl(),Il=o(),Ll=()=>{let{editor:e}=F(),t=e.engine.renderer;return(0,Il.jsx)(`div`,{className:Pl.renderer,children:(0,Il.jsxs)(`div`,{className:Pl.renderer_inner,children:[(0,Il.jsx)(s,{label:`Resolution`,accordion:!0,children:(0,Il.jsx)(oo,{target:e,filter:`resolution`})}),(0,Il.jsx)(s,{label:`Pipeline`,accordion:!0,children:(0,Il.jsx)(oo,{target:t,filter:`pipeline`})}),(0,Il.jsx)(s,{label:`Sky`,accordion:!0,children:(0,Il.jsx)(oo,{target:t,filter:`sky`})})]})})},Ll.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var zl,Bl,Vl,Hl,Ul,Wl;function Gl(){return(Gl=t((()=>{zl=`SceneControl__sceneControl___LnNjZ`,Bl=`SceneControl__sceneControl_inner___LnNjZ`,Vl=`SceneControl__select___LnNjZ`,Hl=`SceneControl__select_name___LnNjZ`,Ul=`SceneControl__save___LnNjZ`,Wl={sceneControl:zl,sceneControl_inner:Bl,select:Vl,select_name:Hl,save:Ul}})))()}var Kl,ql,Jl;function Yl(){return(Yl=t((()=>{Kl=i(),w(),I(),pe(),Gl(),ql=o(),Jl=()=>{let{editor:e,projectName:t,scenes:n}=F(),[r,i]=(0,Kl.useState)(null),o=null;return n&&(o=(0,ql.jsx)(ae,{title:`scene`,children:(0,ql.jsxs)(`button`,{className:Wl.select,onClick:e=>{i(ie(e.clientX,e.clientY))},children:[(0,ql.jsx)(`span`,{className:Wl.select_name,children:n.current??`-`}),(0,ql.jsx)(a,{open:!0})]})})),(0,ql.jsxs)(`div`,{className:Wl.sceneControl,children:[(0,ql.jsx)(`div`,{className:Wl.sceneControl_inner,children:(0,ql.jsxs)(s,{label:t,accordion:!0,children:[o,(0,ql.jsx)(`div`,{className:Wl.save,children:(0,ql.jsx)(c,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,ql.jsx)(me,{scenes:n,projectName:t,anchor:r,onClose:()=>{i(null)}})]})},Jl.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var Xl,Zl,Ql,$l,eu,tu,nu;function ru(){return(ru=t((()=>{Xl=`Textures__textures___LnRle`,Zl=`Textures__item___LnRle`,Ql=`Textures__preview___LnRle`,$l=`Textures__img___LnRle`,eu=`Textures__placeholder___LnRle`,tu=`Textures__name___LnRle`,nu={textures:Xl,item:Zl,preview:Ql,img:$l,placeholder:eu,name:tu}})))()}var iu,au,ou;function su(){return(su=t((()=>{iu=i(),Ti(),I(),ru(),au=o(),ou=()=>{let{engine:e,editor:t}=F(),[,n]=(0,iu.useState)(0);(0,iu.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return P.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{P.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=P.resources.textureList;return(0,au.jsx)(`div`,{className:nu.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,au.jsxs)(`div`,{className:nu.item,children:[(0,au.jsx)(`div`,{className:nu.preview,children:n?(0,au.jsx)(`img`,{src:n,className:nu.img}):(0,au.jsx)(`div`,{className:nu.placeholder})}),(0,au.jsx)(`div`,{className:nu.name,children:e.name})]},e.name)})})},ou.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var cu,lu;function uu(){return(uu=t((()=>{cu=i(),lu=(0,cu.createContext)(null)})))()}var du,fu;function pu(){return(pu=t((()=>{du=i(),uu(),fu=()=>{let e=(0,du.useContext)(lu);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var mu;function hu(){return(hu=t((()=>{mu=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
...
}`,signature:{properties:[{key:`target`,value:{name:`unknown`,required:!0}},{key:`fields`,value:{name:`signature`,type:`object`,raw:`{ [ path: string ]: FieldUI }`,signature:{properties:[{key:{name:`string`},value:{name:`ReactFC`,raw:`React.FC<FieldUIProps<T, C>>`,elements:[{name:`signature`,type:`object`,raw:`{
	value: T;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}var vS,yS;function bS(){return(bS=t((()=>{vS=e(i(),1),Xp(),yi(),yS=()=>{let[e,t]=vS.useState(()=>new P(Jp)),n=vS.useRef(e);return n.current=e,(0,vS.useEffect)(()=>{n.current.disposed&&t(new P(Jp))},[]),(0,vS.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,vS.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var xS,SS,CS;function wS(){return(wS=t((()=>{xS=i(),Yo(),bS(),SS=o(),CS=e=>{let t=yS(),{engine:n}=t,r=(0,xS.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,xS.useEffect)(()=>{r.current?.(n)},[n]),(0,xS.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,SS.jsx)(Jo.Provider,{value:t,children:e.children})},CS.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var TS,ES,DS,OS,kS,AS,jS;function MS(){return(MS=t((()=>{TS=i(),_S(),wS(),ES=o(),DS=`scene`,OS=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},kS=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),AS=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),jS=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,TS.useState)(e.sceneData),[a,o]=(0,TS.useState)(e.editorData),[s,c]=(0,TS.useState)([]),[l,u]=(0,TS.useState)(null),d=(0,TS.useCallback)(async e=>{let t=await OS(`${n}/scenes/${e}`);if(!t)throw Error(`シーンを読み込めません: ${e}`);u(e),i(t)},[n]);(0,TS.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([OS(`${n}/editor`),OS(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[DS]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]),(0,TS.useEffect)(()=>{l&&(document.title=`${l} | OREngine`)},[l]);let f={names:s,current:l,onSelect:d,onCreate:(0,TS.useCallback)(async(e,t)=>{let r=AS(e);if(t!==void 0){let i=await OS(`${n}/scenes/${t}`);if(!i)throw Error(`複製元のシーンを読み込めません: ${t}`);r={...i,name:e}}let i=await kS(`${n}/scenes/${e}`,r);if(!i.ok)throw Error(`シーンを作成できません: ${e}（HTTP ${i.status}）`);let a=await OS(`${n}/scenes`);a&&c(a)},[n]),onDelete:(0,TS.useCallback)(async e=>{let t=await fetch(`${n}/scenes/${e}`,{method:`DELETE`});if(!t.ok)throw Error(`シーンを削除できません: ${e}（HTTP ${t.status}）`);let r=await OS(`${n}/scenes`)??[];c(r),e===l&&r.length>0&&await d(r[0])},[n,l,d])};return(0,ES.jsx)(CS,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,ES.jsx)(gS,{editorData:a,projectName:t,panels:e.panels,fieldUIs:e.fieldUIs,scenes:f,onSave:async(t,r)=>{e.onBeforeSave?.();let i=[kS(`${n}/editor`,{...r,[DS]:l})];l&&i.push(kS(`${n}/scenes/${l}`,t));for(let e of await Promise.all(i))if(!e.ok)throw Error(`保存に失敗しました（POST ${new URL(e.url).pathname}: HTTP ${e.status}）`)}})})},jS.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var NS,PS;function FS(){return(FS=t((()=>{_S(),wS(),NS=o(),PS=e=>(0,NS.jsx)(CS,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,NS.jsx)(gS,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,fieldUIs:e.fieldUIs,onSave:()=>{}})}),PS.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	engine: Engine;
	editor: Editor;
}`,signature:{properties:[{key:`value`,value:{name:`T`,required:!0}},{key:`setValue`,value:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}},required:!0}},{key:`beginEdit`,value:{name:`signature`,type:`function`,raw:`() => FieldEdit`,signature:{arguments:[],return:{name:`FieldEdit`}},required:!0}},{key:`target`,value:{name:`C`,required:!0}},{key:`path`,value:{name:`string`,required:!0}},{key:`opt`,value:{name:`MXP.SerializableFieldOpt`,required:!1}},{key:`engine`,value:{name:`Engine`,required:!0}},{key:`editor`,value:{name:`Editor`,required:!0}}]}}],required:!0}}]},required:!0}}]}}],raw:`FieldUIDefinition[]`},description:``}}}})))()}function IS(){return(IS=t((()=>{i(),I()})))()}var LS,RS,zS;function BS(){return(BS=t((()=>{LS=`InputGroup__group___Lmdyb`,RS=`InputGroup__submit___Lmdyb`,zS={group:LS,submit:RS}})))()}var VS,HS,US;function WS(){return(WS=t((()=>{VS=i(),w(),Yi(),BS(),HS=o(),US=e=>{let t=e.initialValues,n=[],[r,i]=(0,VS.useState)(t);(0,VS.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,HS.jsx)(Ji,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,VS.useRef)(null);return(0,VS.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,HS.jsx)(`div`,{className:zS.group,ref:o,children:(0,HS.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,HS.jsx)(s,{label:e.title,noMargin:!0,children:n}),(0,HS.jsx)(`div`,{className:zS.submit,children:(0,HS.jsx)(c,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},US.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}function GS(){return(GS=t((()=>{MS(),FS(),_S(),dS(),I(),IS(),wS(),Qo(),$s(),Ro(),Jc(),hc(),Sc(),Pd(),pu(),Yl(),Ko(),Es(),Rl(),da(),ia(),su(),so(),oc(),Yi(),Ua(),WS(),Ni(),Li(),Ki(),co(),Da(),La(),we()})))()}var KS;function qS(){return(qS=t((()=>{KS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var JS;function YS(){return(YS=t((()=>{JS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var XS=n({EyeRings:()=>ZS}),ZS;function QS(){return(QS=t((()=>{N(),qS(),YS(),ZS=class extends k{constructor(e){super(e);let t=new $t({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),n=[];for(let e=0;e<8;e++)n.push(-1,e,e/7),n.push(1,e,e/7);t.setAttribute(`instance`,new Float32Array(n),3,{instanceDivisor:1});let r=new hn({phase:[`deferred`,`shadowMap`],frag:KS,vert:JS});this.entity.addComponent(A,{geometry:t,material:r})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var $S;function eC(){return(eC=t((()=>{$S=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var tC;function nC(){return(nC=t((()=>{tC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var rC=n({FlashLine:()=>iC}),iC;function aC(){return(aC=t((()=>{D(),N(),eC(),nC(),iC=class extends k{geometry;material;constructor(e){super(e),this.geometry=new jt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let t=[];for(let e=0;e<32;e++){let e=je.randomVector().multiply(new T(20,1,20));t.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(t),4,{instanceDivisor:1}),this.material=new hn({phase:[`forward`,`envMap`],frag:j(`flFrag`,$S),vert:j(`flVert`,tC)}),this.entity.addComponent(A,{material:this.material,geometry:this.geometry})}}})))()}var oC;function sC(){return(sC=t((()=>{oC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var cC=n({SkyBox:()=>lC}),lC;function uC(){return(uC=t((()=>{N(),sC(),lC=class extends k{material;constructor(e){super(e);let t=this.engine;this.material=new hn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:j(`SkyBoxFrag`,oC),uniforms:{uAspectRatio:{value:0,type:`1f`}}}),t.renderer.sky.mesh.material=this.material}}})))()}var dC;function fC(){return(fC=t((()=>{dC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var hC=n({GridCross:()=>gC}),gC;function _C(){return(_C=t((()=>{D(),N(),fC(),mC(),gC=class extends k{constructor(e){super(e);let t=new kt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new T(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new hn({frag:j(`gridCrossFrag`,dC),vert:j(`gridCrossVert`,pC),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var vC;function yC(){return(yC=t((()=>{vC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var SC=n({GridDots:()=>CC}),CC;function wC(){return(wC=t((()=>{D(),N(),yC(),xC(),CC=class extends k{constructor(e){super(e);let t=new Ft({radius:.1}),n=[],r=[],i=new T(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new hn({frag:j(`gridDotsFrag`,vC),vert:j(`gridDotsVert`,bC),phase:[`forward`]});this.entity.addComponent(A,{geometry:t,material:a})}}})))()}var TC;function EC(){return(EC=t((()=>{TC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var kC=n({WireCube:()=>AC}),AC;function jC(){return(jC=t((()=>{N(),EC(),OC(),AC=class extends k{constructor(e){super(e);let t=3.3,n=t/2,r=new kt({width:.01,height:t,depth:.01,segmentsHeight:16}),i=[],a=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[n,0,n],[n,0,-1.65],[-1.65,0,n],[-1.65,0,-1.65]][t].forEach(e=>{i.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{a.push(e)});r.setAttribute(`instancePos`,new Float32Array(i),3,{instanceDivisor:1}),r.setAttribute(`instanceRot`,new Float32Array(a),3,{instanceDivisor:1});let o=new hn({phase:[`deferred`],frag:TC,vert:DC});this.entity.addComponent(A,{geometry:r,material:o})}}})))()}var MC=n({FieldUISample:()=>NC}),NC;function PC(){return(PC=t((()=>{D(),N(),NC=class extends k{speed;wave;rotQuaternion;constructor(e){super(e),this.speed=1,this.wave=.5,this.rotQuaternion=new ke,this.field(`speed`,()=>this.speed,e=>this.speed=e,{step:.1}),this.field(`wave`,()=>this.wave,e=>this.wave=e,{step:.05,min:0})}updateImpl(e){this.rotQuaternion.setFromEuler(new De(0,e.timeDelta*this.speed,0)),this.entity.quaternion.multiply(this.rotQuaternion),this.entity.position.y=Math.sin(e.timeElapsed*2)*this.wave}}})))()}var FC;function IC(){return(IC=t((()=>{FC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var LC;function RC(){return(RC=t((()=>{LC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var zC=n({OREngineCube:()=>BC}),BC;function VC(){return(VC=t((()=>{N(),Ti(),IC(),RC(),BC=class extends k{material;constructor(e){super(e),this.material=new hn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:j(`OREngineCubeVert`,LC),frag:j(`OREngineCubeFrag`,FC),uniforms:{uNoiseTex:{value:P.resources.getTexture(`noise`),type:`1i`}}});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var HC;function UC(){return(UC=t((()=>{HC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var WC;function GC(){return(GC=t((()=>{WC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var KC=n({OREngineLogo:()=>qC}),qC;function JC(){return(JC=t((()=>{N(),UC(),GC(),qC=class extends k{material;constructor(e){super(e),this.material=new hn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:j(`OREngineLogoVert`,WC),frag:j(`OREngineLogoFrag`,HC)});let t=this.entity.getComponent(A);t&&(t.material=this.material)}}})))()}var YC;function XC(){return(XC=t((()=>{YC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ZC;function QC(){return(QC=t((()=>{ZC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var $C=n({Dust:()=>ew}),ew;function tw(){return(tw=t((()=>{D(),N(),XC(),QC(),ew=class extends k{constructor(e){super(e);let t=new Dt,n=e.args?.num||2048,r=new T(20,5,20),i=[],a=[];for(let e=0;e<n;e++)i.push((Math.random()-.5)*r.x),i.push((Math.random()-.5)*r.y),i.push((Math.random()-.5)*r.z),a.push(Math.random());t.setAttribute(`position`,new Float32Array(i),3);let o=new hn({phase:[`forward`],drawType:`POINTS`,frag:YC,vert:ZC});this.entity.addComponent(A,{geometry:t,material:o})}dispose(){super.dispose(),this.entity.removeComponent(A)}}})))()}var nw;function rw(){return(rw=t((()=>{nw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var iw;function aw(){return(aw=t((()=>{iw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
} `})))()}var cw=n({YakiSoba:()=>lw}),lw;function uw(){return(uw=t((()=>{D(),N(),rw(),aw(),sw(),lw=class extends k{_gpu;constructor(e){super(e);let t=this.engine,n=new T(64,512);this._gpu=new ri({passes:[new oi(t.renderer.backend,{name:`yakisoba`,size:n,dataLayerCount:2,frag:j(`yakiSobaCompute`,ow),uniforms:cn.merge({},t.renderer.globalUniforms)})]}),this._gpu.passes[0].initTexture((e,t,n)=>[0,0,0,0]);let r=new kt({width:.05,height:.05,depth:.05,segmentsHeight:n.x}),i=[],a=[];for(let e=0;e<n.y;e++)i.push(e/n.y),a.push(Math.random(),Math.random(),Math.random());r.setAttribute(`trailId`,new Float32Array(i),1,{instanceDivisor:1}),r.setAttribute(`id`,new Float32Array(a),3,{instanceDivisor:1});let o=new hn({frag:j(`chainFrag`,nw),vert:j(`chainVert`,iw),phase:[`deferred`,`shadowMap`],uniforms:cn.merge({},this._gpu.passes[0].outputUniforms)});this.entity.addComponent(A,{geometry:r,material:o})}updateImpl(e){this.entity.isVisibleTraverse()&&this._gpu.compute(e.renderer)}dispose(){super.dispose(),this.entity.removeComponent(A),this._gpu.dispose()}}})))()}var dw;function fw(){return(fw=t((()=>{dw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var Gw;function Kw(){return(Kw=t((()=>{Ww(),Gw={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:Uw}})))()}var qw;function Jw(){return(Jw=t((()=>{qw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var Yw;function Xw(){return(Xw=t((()=>{Jw(),Yw={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:qw}})))()}var Zw;function Qw(){return(Qw=t((()=>{Zw=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var $w;function eT(){return(eT=t((()=>{Qw(),$w={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:Zw}})))()}var tT;function nT(){return(nT=t((()=>{Qw(),tT={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:Zw}})))()}var rT,iT,aT;function oT(){return(oT=t((()=>{Kw(),Xw(),eT(),nT(),Ti(),rT=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":Gw,"/demo-webgl/Resources/Textures/noise.tex":Yw,"/demo-webgl/Resources/Textures/noiseCyclic.tex":$w,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":tT}),iT=()=>{for(let e of Object.values(rT))e&&P.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},aT=e=>{P.resources.buildTextureInstances(e.renderer)}})))()}var sT,cT,lT,uT,dT;function fT(){return(fT=t((()=>{QS(),aC(),uC(),_C(),wC(),jC(),PC(),VC(),JC(),tw(),uw(),hw(),Xp(),Ti(),Hw(),oT(),sT=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":XS,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":rC,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":cC,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":hC,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":SC,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":kC,"/demo-webgl/Resources/Components/Samples/Objects/FieldUISample/index.ts":MC,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":zC,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":KC,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":$C,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":cw,"/demo-webgl/Resources/Components/Samples/PostProcess/Finalize/index.ts":pw}),cT=Object.assign({}),lT=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);lT(a,e)}}},uT=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);uT(a,e)}}},dT=()=>{xt.gltfLoaderFactory=e=>new Hp(e),P.resources.clear();let e=P.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,Vt),e.addComponent(`Camera`,Lt),e.addComponent(`Mesh`,A);let t=Object.keys(Bw);for(let e=0;e<t.length;e++){let n=t[e],r=Bw[n],i=P.resources.addComponentGroup(n);lT(r,i)}let n=Object.keys(Vw);for(let e=0;e<n.length;e++){let t=n[e],r=Vw[t],i=P.resources.addGeometryGroup(t);uT(r,i)}let r=mi(sT,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=P.resources.addComponentGroup(t);lT(n,a)}let a=mi(cT,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=P.resources.addGeometryGroup(t);uT(n,r)}iT()}})))()}var pT,mT,hT,gT,_T,vT;function yT(){return(yT=t((()=>{pT=i(),GS(),w(),fT(),mT=o(),dT(),hT=({setup:e})=>{let{editor:t}=F();return(0,pT.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},gT=e=>(0,mT.jsx)(CS,{project:e.fixture.scene,onEngineInit:aT,children:(0,mT.jsx)(uS,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,mT.jsx)(x,{children:(0,mT.jsxs)(ne,{children:[e.children,e.fixture.setup&&(0,mT.jsx)(hT,{setup:e.fixture.setup}),(0,mT.jsx)(y,{}),(0,mT.jsx)(te,{})]})})})}),_T=e=>t=>(0,mT.jsx)(gT,{fixture:e,children:(0,mT.jsx)(t,{})}),vT=e=>t=>(0,mT.jsx)(CS,{project:e,onEngineInit:aT,children:(0,mT.jsx)(t,{})}),gT.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var bT,xT,ST,CT,wT;function TT(){return(TT=t((()=>{bT={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`LookAt`,uuid:`sb-camera-lookat`}]},xT={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[bT,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},ST={...xT,scene:{name:`root`,uuid:`0`,childs:[bT]}},CT={enableRender:!0,"viewports/main/resolutionScale":.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},wT={scene:xT,editorData:CT}})))()}export{ua as A,I as B,Ko as C,so as D,oo as E,Ki as F,Ti as H,Ii as I,Li as L,Ji as M,Yi as N,Ha as O,Gi as P,Mi as R,Go as S,Ro as T,P as U,F as V,yi as W,Yl as _,xT as a,Qs as b,_T as c,WS as d,gS as f,Jl as g,Pd as h,wT as i,da as j,Ua as k,vT as l,Nd as m,CT as n,gT as o,_S as p,ST as r,yT as s,TT as t,US as u,Ll as v,Lo as w,$s as x,Rl as y,Ni as z};