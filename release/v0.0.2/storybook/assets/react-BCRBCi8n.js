...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}}})))()}var gi;function _i(){return(_i=t((()=>{wr(),gi=class extends Cr{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}}})))()}function vi(){return(vi=t((()=>{})))()}function yi(){return(yi=t((()=>{})))()}var I;function bi(){return(bi=t((()=>{j(),Qn(),hi(),vi(),yi(),I=class extends mi{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Ni,Pi;function Fi(){return(Fi=t((()=>{N(),j(),L(),Qn(),wi(),Ei(),Oi(),Ai(),Mi(),Ni=e=>{let t=[];for(let n=0;n<e;n++){let r=new k;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},Pi=class extends ir{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;ssaoBlurUni;shading;constructor(e){super();let t=e.backend,n=new I(t,{name:`normalSelector`,frag:Di,renderTarget:null,uniforms:si.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),r=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),a=new I(t,{name:`lightShaft`,frag:Ti,renderTarget:r,uniforms:si.merge({uLightShaftBackBuffer:{value:i.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),c=new I(t,{name:`ssao`,frag:ki,renderTarget:ti(`ssao`,o),uniforms:si.merge({uSSAOBackBuffer:{value:s.textures[0],type:`1i`},uSSAOKernel:{value:Ni(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),l=si.merge({uSSAOTexture:{value:s.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:Nn.gaussWeights(8)}}),u=new I(t,{name:`ssaoBlur/h`,frag:ti(`ssaoBlur`,ji),uniforms:l,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),d=new I(t,{name:`ssaoBlur/v`,frag:ti(`ssaoBlur`,ji),uniforms:si.merge(l,{uSSAOTexture:{value:u.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),f=new I(t,{name:`deferredShading`,frag:ti(`deferredShading`,Ci),uniforms:si.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:c.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})});this.postprocess=new gi({passes:[n,a,c,u,d,f]}),this.shading=f,this.lightShaft=a,this.ssao=c,this.rtSSAO1=o,this.rtSSAO2=s,this.ssaoBlur=u,this.ssaoBlurV=d,this.ssaoBlurUni=l,this.rtLightShaft1=r,this.rtLightShaft2=i,this.normalSelector_=n}update(e){let t=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=t,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],t=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=t,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}setRenderCamera(e,t){for(let e=0;e<t.gBuffer.textures.length;e++){let n=t.gBuffer.textures[e];e===1&&(n=t.normalBuffer.textures[0]),this.shading.uniforms[`sampler`+e]=this.ssao.uniforms[`sampler`+e]={type:`1i`,value:n}}this.ssaoBlur.uniforms.uDepthTexture.value=t.gBuffer.textures[0],this.lightShaft.uniforms.uDepthTexture.value=t.gBuffer.depthTexture,this.shading.renderTarget=t.shadingBuffer,this.normalSelector_.renderTarget=t.normalBuffer,this.normalSelector_.uniforms.uNormalTexture.value=t.gBuffer.textures[1],this.normalSelector_.uniforms.uPosTexture.value=t.gBuffer.textures[0],this.normalSelector_.uniforms.uSelectorTexture.value=t.gBuffer.textures[3],this.ssaoBlurUni.uNormalTexture.value=t.normalBuffer.textures[0]}resize(e){this.postprocess.resize(e)}}})))()}var Ii;function Li(){return(Li=t((()=>{Ii=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
`})))()}var Hi;function Ui(){return(Ui=t((()=>{Hi=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Ji;function Yi(){return(Yi=t((()=>{Ji=`in vec2 vUv;
uniform sampler2D uBackBuffer0;
uniform sampler2D uVelTex;
uniform vec2 uPPPixelSize;
...
\r
}`})))()}var Qi;function $i(){return($i=t((()=>{Qi=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ea;function ta(){return(ta=t((()=>{j(),L(),Qn(),Li(),zi(),Vi(),Ui(),Gi(),qi(),Yi(),Zi(),$i(),ea=class{dofCoc;dofBokeh;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;_camera;constructor(e){let t=new I(e,{name:`collection`,frag:Ii}),n=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),i=new I(e,{name:`ssr`,frag:ti(`ssr`,Qi),renderTarget:n,uniforms:si.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`},uSSRBackBuffer:{value:r.textures[0],type:`1i`}}),resolutionRatio:.5,passThrough:!0}),a=new I(e,{name:`ssComposite`,frag:ti(`ssComposite`,Xi),uniforms:si.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSSRTexture:{value:r.textures[0],type:`1i`}})}),o=new k(10,.05,20,.05),s=new I(e,{name:`dof/coc`,frag:Bi,uniforms:si.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:o,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR,internalFormat:M.RGBA16F,type:M.HALF_FLOAT,format:M.RGBA})]),passThrough:!0,resolutionRatio:.5}),c=new I(e,{name:`dof/bokeh`,frag:Ri,uniforms:si.merge({uCocTex:{value:s.renderTarget.textures[0],type:`1i`},uParams:{value:o,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR})]),passThrough:!0,resolutionRatio:.5}),l=new I(e,{name:`dof/composite`,frag:Hi,uniforms:si.merge({uBokeTex:{value:c.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:M.LINEAR,minFilter:M.LINEAR,internalFormat:M.RGBA16F,type:M.HALF_FLOAT,format:M.RGBA})])}),u=new I(e,{name:`motionBlurTile`,frag:Ji,uniforms:si.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),d=new I(e,{name:`motionBlurNeighbor`,frag:Ki,uniforms:si.merge({uVelTex:{value:u.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA32F,format:M.RGBA})]),resolutionRatio:1/16,passThrough:!0}),f=new I(e,{name:`motionBlur`,frag:Wi,uniforms:si.merge({uVelNeighborTex:{value:d.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16}});this.postprocess=new gi({passes:[t,i,a,s,c,l,u,d,f]}),this._ssr=i,this._ssComposite=a,this.dofCoc=s,this.dofBokeh=c,this.dofComposite=l,this._motionBlur=f,this._motionBlurTile=u,this._motionBlurNeighbor=d,this._dofParams=o,this.rtSSR1=n,this.rtSSR2=r,this._camera=null}update(e){if(!this._camera)return;let t=this._camera.fov,n=this._camera.dofParams.focusDistance,r=this._camera.dofParams.kFilmHeight,i=r/Math.tan(.5*(t/180*Math.PI)),a=1/this.dofBokeh.renderTarget.size.y*5,o=1/a,s=i*i/(this._camera.dofParams.fNumber*(n-i)*r*2);this._dofParams.set(n,a,o,s);let c=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=c,this._ssr.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssr.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}setRenderCamera(e,t){this._camera=e,this.postprocess.passes[0]&&(this.postprocess.passes[0].backBufferOverride=t.shadingBuffer.textures),this._ssr.uniforms.uGbufferPos.value=t.gBuffer.textures[0],this._ssr.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],this._ssr.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],this._ssComposite.uniforms.uGbufferPos.value=t.gBuffer.textures[0],this._ssComposite.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],this.dofCoc.uniforms.uGbufferPos.value=t.gBuffer.textures[0],this._motionBlurTile.uniforms.uVelTex.value=t.gBuffer.textures[4],this._motionBlur.uniforms.uVelTex.value=t.gBuffer.textures[4],this._motionBlur.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}}})))()}var na;function ra(){return(ra=t((()=>{na=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ia;function aa(){return(aa=t((()=>{N(),j(),L(),Qn(),ra(),ia=class extends ir{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA,magFilter:M.LINEAR,minFilter:M.LINEAR,wrapS:M.CLAMP_TO_EDGE,wrapT:M.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new k(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:M.FLOAT,internalFormat:M.RGBA16F,format:M.RGBA})])});let m=1/4*l,h=new I(e,{renderTarget:s[l].rt1,frag:na,uniforms:si.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new k(d,f));let g=new I(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new gi({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}}})))()}var oa;function sa(){return(sa=t((()=>{oa=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}}})))()}var ca;function la(){return(la=t((()=>{ca=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	vUv = uv;\r
\r
}`,renderTarget:r,uniforms:si.merge(t.uniforms,a,{uDeltaTime:{value:0,type:`1f`}})}),this.size=t.size,this.layerCnt=t.dataLayerCount,this.rt1=r,this.rt2=i,this.renderTarget=this.rt1,this.clearColor=t.clearColor??null,this.outputUniforms=a}onAfterRender(){super.onAfterRender();for(let e=0;e<this.layerCnt;e++)this.outputUniforms[`uGPUSampler`+e].value=this.renderTarget.textures[e];let e=this.rt1;this.rt1=this.rt2,this.rt2=e,this.renderTarget=this.rt1}initTexture(e){for(let t=0;t<this.layerCnt;t++){let n=[];for(let r=0;r<this.size.y;r++)for(let i=0;i<this.size.x;i++){let a=i,o=r;n.push(...e(t,a,o))}this.rt2.textures[t].subImage(new Float32Array(n),this.size.x,this.size.y)}}}})))()}function ja(){return(ja=t((()=>{Xn(),j(),Ur(),Qn(),hi(),_i(),bi()})))()}function Ma(){return(Ma=t((()=>{N(),Ur(),Dr(),hi()})))()}function Na(){return(Na=t((()=>{j(),_i(),Qn(),bi()})))()}function Pa(){return(Pa=t((()=>{_i(),bi()})))()}function Fa(){return(Fa=t((()=>{_i(),bi()})))()}function Ia(){return(Ia=t((()=>{_i(),bi()})))()}function La(){return(La=t((()=>{di(),Na(),Pa(),Fa(),Ia()})))()}function L(){return(L=t((()=>{Qn(),li(),Ta(),hi(),Da(),Aa(),di(),Fi(),ja(),Ma(),_i(),bi(),La(),Si()})))()}var Ra;function za(){return(za=t((()=>{Ra=class{static serializeEntity(e,t){let n=e=>{let r=[];e.children.forEach(e=>{e.initiator!=`script`&&r.push(n(e))});let i=[];e.components.forEach(e=>{let n=e.serialize({mode:`export`}),r=Object.keys(n).length>0;if(e.initiator!==`user`)return;let a={name:t.getName(e),uuid:e.uuid};r&&(a.props=n),i.push(a)});for(let t of e.unresolvedComponents)i.push({name:t.name,uuid:t.uuid,props:t.props});return{name:e.name,uuid:e.uuid,pos:e.position.x==0&&e.position.y==0&&e.position.z==0?void 0:e.position.getElm(`vec3`),rot:e.euler.x==0&&e.euler.y==0&&e.euler.z==0?void 0:e.euler.getElm(`vec3`),scale:e.scale.x==1&&e.scale.y==1&&e.scale.z==1?void 0:e.scale.getElm(`vec3`),components:i.length>0?i:void 0,childs:r.length>0?r:void 0}};return n(e)}static deserializeEntity(e,t,n,r){let i=(e,t)=>{let a=t||r.createEntity();a.initiator=`user`,a.name=e.name,a.restoreUUID(e.uuid);let o=e.pos||[0,0,0];a.position.x=o[0],a.position.y=o[1],a.position.z=o[2];let s=e.rot||[0,0,0];a.euler.x=s[0],a.euler.y=s[1],a.euler.z=s[2];let c=e.scale||[1,1,1];return a.scale.x=c[0],a.scale.y=c[1],a.scale.z=c[2],a.unresolvedComponents=[],e.components&&e.components.forEach(e=>{let t=n.resolve(e.name);if(t){let n=a.getComponent(t.component);n||(n=a.addComponent(t.component),n.initiator=`user`),n.restoreUUID(e.uuid),e.props&&n.deserialize(e.props)}else console.warn(`[ProjectSerializer] Component "${e.name}" not found in resolver. Preserving data for round-trip.`),a.unresolvedComponents.push({name:e.name,uuid:e.uuid,props:e.props})}),e.childs&&([...a.children].forEach(e=>{e.initiator!==`script`&&a.remove(e)}),e.childs.forEach(e=>{a.add(i(e))})),a};e&&i(e,t),t.initiator=`god`}}})))()}var Ba;function Va(){return(Va=t((()=>{L(),Ba=class extends Cr{name;_frag;_resolution;_filter;_updateEveryFrame;_textures;constructor(e,t){super(),this.name=e;let n=t.data;this._frag=n?.frag||``,this._resolution=n?.resolution||[1024,1024],this._filter=n?.filter||`linear`,this._updateEveryFrame=n?.updateEveryFrame??!1,this._textures=n?.textures||{}}get frag(){return this._frag}get resolution(){return this._resolution}get filter(){return this._filter}get updateEveryFrame(){return this._updateEveryFrame}get textures(){return this._textures}}})))()}var Ha;function Ua(){return(Ua=t((()=>{N(),j(),Va(),_e(),Ha=class extends ir{_componentList;_componentGroups;_geometryList;_geometryGroups;_textureResources;_textures;_updateEveryFrameTextures;constructor(){super(),this._componentList=[],this._textures=new Map,this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources=new Map,this._updateEveryFrameTextures=[]}get componentList(){return this._componentList}get componentGroups(){return this._componentGroups}get geometryList(){return this._geometryList}get geometryGroups(){return this._geometryGroups}get textureList(){return Array.from(this._textureResources.values())}get textures(){return this._textures}get updateEveryFrameTextures(){return this._updateEveryFrameTextures}clear(){this._componentList=[],this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources.clear(),this._textures.clear(),this._updateEveryFrameTextures=[],this.emit(`update`)}getComponent(e){return this._componentList.find(t=>t.name==e)}addComponentGroup(e){let t=this._componentGroups.find(t=>t.name==e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addComponent:(e,n)=>{let r={name:e,component:n};t.push(r),this._componentList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._componentGroups.push(t),this.emit(`update`),t}getGeometry(e){return this._geometryList.find(t=>t.name===e)}addGeometryGroup(e){let t=this._geometryGroups.find(t=>t.name===e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addGeometry:(e,n)=>{let r={name:e,geometryClass:n};t.push(r),this._geometryList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._geometryGroups.push(t),this.emit(`update`),t}addTextureResource(e,t){let n=new Ba(e,{data:t});this._textureResources.set(e,n),this.emit(`update`)}getTextureResource(e){return this._textureResources.get(e)}removeTextureResource(e){this._textureResources.delete(e);let t=this._textures.get(e);t&&(t.dispose(),this._textures.delete(e)),this.emit(`update`)}addTexture(e,t){return this._textures.set(e,t),t}getTexture(e){return this._textures.get(e)}_buildTexture(e,t,n,r){let i=e.frag;return i?t.createTexProcedural({name:e.name,frag:i,resolution:new k(e.resolution[0]||1024,e.resolution[1]||1024),filter:e.filter,textures:n,uniforms:e.updateEveryFrame?r:void 0}):null}_ensureTexture(e,t,n,r){let i=this._textures.get(e.name);if(i)return i;if(r.has(e.name))return null;r.add(e.name);let a={},o=e.textures,s=Object.keys(o);for(let e=0;e<s.length;e++){let i=s[e],c=o[i],l=this._textureResources.get(c),u=l?this._ensureTexture(l,t,n,r):this._textures.get(c);u&&(a[i]=u)}let c=this._buildTexture(e,t,a,n);return c?(this._textures.set(e.name,c),e.updateEveryFrame&&this._updateEveryFrameTextures.push(c),c):null}buildTextureInstances(e,t){this._updateEveryFrameTextures=[];let n=new Set;this._textureResources.forEach(r=>{this._ensureTexture(r,e,t,n)}),this.emit(`update`)}}})))()}var Wa;function Ga(){return(Ga=t((()=>{j(),L(),za(),Ua(),Wa=class e extends Cr{static resources;name;enableRender;_renderer;_root;_uniforms;_time;_frame;_frameSetting;_disposed;_cameraEntity;constructor(e){super(),this.name=`OREngine`,this._disposed=!1,this._uniforms={uEnvMapIntensity:{value:1,type:`1f`}},this._renderer=e(this),this._renderer.globalUniforms={uTime:{value:0,type:`1f`},uTimeF:{value:0,type:`1f`},uTimeE:{value:0,type:`1f`},uTimeEF:{value:0,type:`1f`},uDeltaTime:{value:0,type:`1f`},uResolution:{value:new k,type:`2fv`},uAspectRatio:{value:1,type:`1f`}},this._time={current:new Date().getTime(),engine:0,delta:0,code:0},this._frameSetting={duration:600,fps:30},this._frame={current:0,playing:!1},this.seek(0),this.enableRender=!0,this._cameraEntity=null,this._root=this.createEntity({name:`root`}),this._root.initiator=`god`,this.field(`name`,()=>this.name,e=>this.name=e),this.field(`scene`,()=>Ra.serializeEntity(this._root,this._createComponentResolver()),e=>{Ra.deserializeEntity(e,this._root,this._createComponentResolver(),this)}),this.field(`renderer`,()=>this._renderer.serialize({mode:`export`}),e=>this._renderer.deserialize(e));let t=this.fieldDir(`timeline`);t.field(`duration`,()=>this._frameSetting.duration,e=>this._frameSetting.duration=e),t.field(`fps`,()=>this._frameSetting.fps,e=>this._frameSetting.fps=e)}createEntity(e){return new Jr({engine:this,...e})}get canvas(){return this._renderer.canvas}get renderer(){return this._renderer}get root(){return this._root}get frame(){return this._frame}get time(){return this._time}get frameSetting(){return this._frameSetting}get uniforms(){return this._uniforms}get disposed(){return this._disposed}set cameraEntity(e){this._cameraEntity=e}get cameraEntity(){return this._cameraEntity}resolveCameraEntity(){return this._cameraEntity||this.findSceneCameraEntity()}_createComponentResolver(){return{resolve:t=>e.resources.getComponent(t),getName:t=>{let n=e.resources.componentList.find(e=>t instanceof e.component);return n?n.name:t.constructor.name}}}init(){this._root.disposeRecursive(),this._root.position.set(0,0,0),this._root.euler.set(0,0,0),this._root.scale.set(1,1,1),this.name=`New Project`}async load(e){this.init(),this.deserialize(e),this.emit(`update/graph`),this.emit(`loaded`)}update(t){let n=new Date().getTime();this._time.delta=(n-this._time.current)/1e3,this._time.current=n,this._time.engine+=this._time.delta,this._time.code+=this._time.delta*+!!this._frame.playing,this._frame.current=this._time.code*60;let r=this.createEntityUpdateEvent({forceDraw:t?.forceDraw});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1,this._renderer.globalUniforms.uDeltaTime.value=Math.min(this._time.delta,1/60);let i=e.resources.updateEveryFrameTextures;for(let e=0;e<i.length;e++)i[e].render();if(this._root.update(r),this._root.postUpdate(r),this._root.updateMatrixRecursive(),this._root.prepareRender(r),this.enableRender){let e=this.resolveCameraEntity();e&&this._renderer.render(this._root,e,r)}return this._root.commitFrame(r),this._frame.playing&&this.emit(`update/frame/play`,[this._frame]),this._time.delta}createEntityUpdateEvent(e){let t={playing:this._frame.playing,timeElapsed:this._time.engine,timeDelta:this._time.delta,timeCode:this._time.code,timeCodeFrame:this._frame.current,resolution:this.renderer.resolution,renderer:this.renderer,forceDraw:!1};return e?{...t,...e}:t}setSize(e){this._renderer.resize(e),this._renderer.canvas.width=e.x,this._renderer.canvas.height=e.y,this._renderer.globalUniforms.uResolution.value.copy(e),this._renderer.globalUniforms.uAspectRatio.value=e.x/Math.max(e.y,1)}play(){this._frame.playing=!0,this._time.current=new Date().getTime()}stop(){this._frame.playing=!1}seek(e){this._time.code=e/60,this._frame.current=e,this.emit(`update/frame/play`,[this._frame])}updateOffline(t,n){let r=t/n,i=1/n;this._time.delta=i,this._time.current=new Date().getTime(),this._time.engine+=i,this._time.code=r,this._frame.current=r*60,this._frame.playing=!0;let a=this.createEntityUpdateEvent({forceDraw:!0});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1;let o=e.resources.updateEveryFrameTextures;for(let e=0;e<o.length;e++)o[e].render();if(this._root.update(a),this._root.postUpdate(a),this._root.updateMatrixRecursive(),this._root.prepareRender(a),this.enableRender){let e=this.resolveCameraEntity();e&&this._renderer.render(this._root,e,a)}this._root.commitFrame(a)}compileShaders(e){let t=this.createEntityUpdateEvent({forceDraw:!0}),n=this.resolveCameraEntity();return n?this.renderer.compileShaders(this._root,n,t,e):Promise.resolve()}findSceneCameraEntity(){let e=null;return this._root.traverse(t=>{if(e)return;let n=t.getComponentsByTag(`camera`);for(let r=0;r<n.length;r++)if(n[r].displayOut){e=t;return}}),e}dispose(){this._disposed=!0,this._root.disposeRecursive()}},Wa.resources=new Ha})))()}var Ka;function qa(){return(qa=t((()=>{N(),Ka=class extends ir{_pressedKeys;constructor(){super(),this._pressedKeys={};let e=this._onKeyDown.bind(this),t=this._onKeyUp.bind(this);window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,t),this.once(`dispose`,()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,t)})}get pressedKeys(){return this._pressedKeys}_onKeyDown(e){this._pressedKeys[e.key]=!0,this.emit(`keydown`,[e,this._pressedKeys])}_onKeyUp(e){if(this._pressedKeys[e.key]=!1,e.key==`Meta`||e.key==`Control`){let e=Object.keys(this._pressedKeys);for(let t=0;t<e.length;t++)this._pressedKeys[e[t]]=!1}this.emit(`keyup`,[e,this._pressedKeys])}dispose(){this.emit(`dispose`)}}})))()}var Ja;function Ya(){return(Ya=t((()=>{N(),j(),Ja=class extends ir{_isTouching;element=null;position;delta;constructor(){super(),this.position=new k(NaN,NaN),this.delta=new k(NaN,NaN),this._isTouching=!1;let e=this._onPointer.bind(this,`move`),t=this._onPointer.bind(this,`end`);window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`dragend`,t);let n=()=>{this.element&&this.removeElement(this.element),window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`dragend`,t),this.off(`dispose`,n)};this.on(`dispose`,n)}setElement(e){this.element&&this.removeElement(this.element),this.element=e;let t=this._onPointer.bind(this,`start`);e.addEventListener(`pointerdown`,t);let n=r=>{e.isEqualNode(r.elm)&&(e.removeEventListener(`pointerdown`,t),this.off(`unregister`,n))};this.on(`unregister`,n)}removeElement(e){this.emit(`unregister`,[e])}getScreenPosition(e){if(this.position.x!=this.position.x)return new k(NaN,NaN);let t=this.position.clone().divide(e).multiply(2).sub(1);return t.y*=-1,t}getRelativePosition(e,t){let n=e.getClientRects()[0],r=this.position.x-n.left,i=this.position.y-n.top;return t&&(r/=n.width,i/=n.height),new k(r,i)}_setPos(e,t){this.position.x!==this.position.x||this.position.y!==this.position.y?this.delta.set(0,0):this.delta.set(e-this.position.x,t-this.position.y),this.position.set(e,t)}_onPointer(e,t){let n=t.pointerType;(n==null||n==`mouse`&&(t.button==-1||t.button==0)||n==`touch`)&&this._touchEventHandler(t.pageX,t.pageY,e,t)}_touchEventHandler(e,t,n,r){let i=!1,a=e-window.pageXOffset,o=t-window.pageYOffset;n==`start`?(this._isTouching=!0,this._setPos(a,o),this.delta.set(0,0),i=!0):n==`move`?(this._setPos(a,o),this._isTouching&&(i=!0)):n==`end`&&(`targetTouches`in r?r.targetTouches.length==0&&(this._isTouching=!1):this._isTouching=!1,i=!0),i&&this.emit(n,[{pointerEvent:r,position:this.position.clone(),delta:this.delta.clone()}])}dispose(){this.emit(`dispose`)}}})))()}function Xa(){return(Xa=t((()=>{Ga(),Ua(),qa(),Ya()})))()}function Za(){return(Za=t((()=>{Xa()})))()}var Qa,$a;function eo(){return(eo=t((()=>{Qa=i(),$a=(0,Qa.createContext)(null)})))()}var to,no;function ro(){return(ro=t((()=>{to=i(),eo(),no=()=>{let e=(0,to.useContext)($a);if(e===null)throw Error(`useMouseMenu must be used within a MouseMenuProvider`);return e}})))()}var io,ao;function oo(){return(oo=t((()=>{io=i(),ao=(0,io.createContext)(void 0)})))()}var so,co;function lo(){return(lo=t((()=>{so=i(),oo(),co=()=>(0,so.useContext)(ao)})))()}var uo,fo,po,mo,ho;function go(){return(go=t((()=>{uo=`ComponentAdd__compoAdd___LmNvb`,fo=`ComponentAdd__directory___LmNvb`,po=`ComponentAdd__subDirectory___LmNvb`,mo=`ComponentAdd__picker___LmNvb`,ho={compoAdd:uo,directory:fo,subDirectory:po,picker:mo}})))()}var _o,vo,yo,bo;function xo(){return(xo=t((()=>{_o=e(i(),1),Za(),u(),E(),ro(),lo(),go(),vo=s(),yo=({group:e,onClickAdd:t})=>{let n=co(),[r,i]=(0,_o.useState)(!1),a=null,o,s=`dir`,c=e.name.startsWith(`_`)?e.name.slice(1):e.name;`child`in e?a=(0,vo.jsx)(vo.Fragment,{children:e.child.map((e,n)=>(0,vo.jsx)(yo,{group:e,onClickAdd:t},n))}):(o=()=>t(e),s=`item`);let l=window.matchMedia(`(hover: hover)`).matches;return(0,vo.jsxs)(`div`,{className:ho.directory,onPointerEnter:l?()=>i(!0):void 0,onPointerLeave:l?()=>i(!1):void 0,onClick:e=>{o?o():(e.stopPropagation(),i(!r))},"data-type":s,"data-direction":n?.direction,children:[c,r&&(0,vo.jsx)(`div`,{className:ho.subDirectory,children:a})]})},bo=e=>{let{editor:t}=T(),{pushContent:n,closeAll:r}=no(),i=Wa.resources,a=(0,_o.useCallback)(a=>{if(!i||!n||!r)return;let o=[],s=n=>{t.api.addComponent(e.entity,n.component),r()};i.componentGroups.forEach((e,t)=>{o.push((0,vo.jsx)(yo,{group:e,onClickAdd:s},t))}),n((0,vo.jsx)(`div`,{className:ho.picker,children:o}))},[n,i,e.entity,r,t]);return(0,vo.jsx)(`div`,{className:ho.compAdd,children:(0,vo.jsx)(d,{onClick:a,children:`Add Component`})})},bo.__docgenInfo={description:``,methods:[],displayName:`ComponentAdd`,props:{entity:{required:!0,tsType:{name:`MXP.Entity`},description:``}}}})))()}var So,Co,wo,To,Eo,Do;function Oo(){return(Oo=t((()=>{So=`ComponentView__compoView___LmNvb`,Co=`ComponentView__head___LmNvb`,wo=`ComponentView__name___LmNvb`,To=`ComponentView__check___LmNvb`,Eo=`ComponentView__propertyBlock___LmNvb`,Do={compoView:So,head:Co,name:wo,check:To,delete:`ComponentView__delete___LmNvb`,propertyBlock:Eo}})))()}var ko,Ao,jo,Mo;function No(){return(No=t((()=>{ko=i(),c(),ee(),E(),Tn(),En(),Oo(),Ao=s(),jo=e=>{let t=Object.keys(e.childs);for(let n=0;n<t.length;n++){let r=e.childs[t[n]],{opt:i}=r,a=!1;if(i&&(a=typeof i.hidden==`function`?i.hidden(r.type===`value`?r.value:null):i.hidden||!1),!a&&(r.type===`value`||jo(r)))return!0}return!1},Mo=({component:e})=>{let{editor:t}=T(),[n,r]=O(e,`enabled`),i=e.initiator!==`user`,a=jo(e.serializeToDirectory()),o=(0,ko.useCallback)(n=>{n.stopPropagation();let r=e.entity;if(r){for(let[n,i]of r.components)if(i.uuid===e.uuid){t.api.removeComponent(r,n,e);break}}},[e,t]),s=(0,Ao.jsxs)(`div`,{className:Do.head,children:[(0,Ao.jsx)(`div`,{className:Do.name,children:e.constructor.name}),(0,Ao.jsx)(`div`,{className:Do.delete,children:(0,Ao.jsx)(`button`,{onClick:o,children:(0,Ao.jsx)(C,{})})})]});return(0,Ao.jsx)(`div`,{className:Do.compoView,"data-disable_component":i,children:(0,Ao.jsx)(`div`,{className:Do.content,children:(0,Ao.jsx)(l,{label:s,accordion:a,bg:!0,defaultClose:!1,children:a&&(0,Ao.jsx)(wn,{target:e})})})})},Mo.__docgenInfo={description:``,methods:[],displayName:`ComponentView`,props:{component:{required:!0,tsType:{name:`MXP.Component`},description:``}}}})))()}var Po,Fo;function Io(){return(Io=t((()=>{Po=`ComponentList__container___LmNvb`,Fo={container:Po}})))()}var Lo,Ro,zo;function Bo(){return(Bo=t((()=>{Lo=i(),En(),No(),Io(),Ro=s(),zo=({entity:e})=>{let[t]=O(e,`components`),n=(0,Lo.useMemo)(()=>{let n=[];return t?(t.forEach(t=>{let r=e.getComponentByUUID(t);r&&n.push((0,Ro.jsx)(Mo,{component:r},r.uuid))}),n):null},[t,e]);return(0,Ro.jsx)(`div`,{className:Fo.container,children:n})},zo.__docgenInfo={description:``,methods:[],displayName:`ComponentList`}})))()}var Vo,Ho,Uo;function Wo(){return(Wo=t((()=>{Vo=i(),c(),E(),Tn(),En(),xo(),Bo(),Ho=s(),Uo=()=>{let{editor:e,engine:t}=T(),[n]=O(e,`selectedEntityId`),r=(0,Vo.useMemo)(()=>{if(n)return t.root.findEntityByUUID(n)},[t,n]);return r?(0,Ho.jsxs)(Ho.Fragment,{children:[(0,Ho.jsx)(l,{label:`Fields`,accordion:!0,children:(0,Ho.jsx)(wn,{target:r})}),(0,Ho.jsxs)(l,{label:`Components`,accordion:!0,children:[(0,Ho.jsx)(zo,{entity:r}),(0,Ho.jsx)(bo,{entity:r})]})]}):null},Uo.__docgenInfo={description:``,methods:[],displayName:`EntityProperty`}})))()}var Go,Ko;function qo(){return(qo=t((()=>{Go=i(),Ko=(0,Go.createContext)(null)})))()}var Jo,Yo;function Xo(){return(Xo=t((()=>{Jo=i(),qo(),Yo=()=>{let e=(0,Jo.useContext)(Ko);if(e===null)throw Error(`useOREngine must be used within a OREngineProvider`);return e}})))()}var Zo,Qo,$o,es,ts,ns,rs,is,as,os,ss,cs,ls,us,ds,fs,ps,ms,R;function hs(){return(hs=t((()=>{Zo=`GPUTimer__container___LmNvb`,Qo=`GPUTimer__headerRow___LmNvb`,$o=`GPUTimer__totalTime___LmNvb`,es=`GPUTimer__toggleButton___LmNvb`,ts=`GPUTimer__controls___LmNvb`,ns=`GPUTimer__control___LmNvb`,rs=`GPUTimer__controlLabel___LmNvb`,is=`GPUTimer__select___LmNvb`,as=`GPUTimer__input___LmNvb`,os=`GPUTimer__group___LmNvb`,ss=`GPUTimer__item___LmNvb`,cs=`GPUTimer__clickable___LmNvb`,ls=`GPUTimer__itemRow___LmNvb`,us=`GPUTimer__itemName___LmNvb`,ds=`GPUTimer__itemTime___LmNvb`,fs=`GPUTimer__itemStats___LmNvb`,ps=`GPUTimer__progressBar___LmNvb`,ms=`GPUTimer__progressFill___LmNvb`,R={container:Zo,headerRow:Qo,totalTime:$o,toggleButton:es,controls:ts,control:ns,controlLabel:rs,select:is,input:as,group:os,item:ss,clickable:cs,itemRow:ls,itemName:us,itemTime:ds,itemStats:fs,progressBar:ps,progressFill:ms}})))()}var gs,_s;function vs(){return(vs=t((()=>{gs=class{buffer;index;size;filled;constructor(e){this.size=e,this.buffer=Array(e),this.index=0,this.filled=!1}push(e){this.buffer[this.index]=e,this.index=(this.index+1)%this.size,!this.filled&&this.index===0&&(this.filled=!0)}getAverage(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=0;for(let n=0;n<e;n++)t+=this.buffer[n];return t/e}getMax(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]>t&&(t=this.buffer[n]);return t}getMin(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]<t&&(t=this.buffer[n]);return t}getCount(){return this.filled?this.size:this.index}},_s=class{buffers;windowSize;currentData;constructor(e=30){this.windowSize=e,this.buffers=new Map,this.currentData=new Map}update(e){let t=performance.now();for(let n=0;n<e.length;n++){let r=e[n],i=r.name.split(`/`),a=i[0]||`unknown`,o,s=i[i.length-1],c=s&&s.match(/\[([^\]]+)\]/);c&&(o=c[1]);let l={name:r.name,duration:r.duration,timestamp:t,renderType:a},u=this.buffers.get(r.name);u||(u=new gs(this.windowSize),this.buffers.set(r.name,u)),u.push(r.duration),this.currentData.set(r.name,{...l,entityId:o})}}getStatistics(){let e=[],t=0,n=performance.now(),r=[];return this.currentData.forEach((e,t)=>{n-e.timestamp>1e3&&r.push(t)}),r.forEach(e=>{this.currentData.delete(e)}),this.currentData.forEach(e=>{t+=e.duration}),this.currentData.forEach(n=>{let r=this.buffers.get(n.name);r&&e.push({name:n.name,renderType:n.renderType,entityId:n.entityId,current:n.duration,avg:r.getAverage(),max:r.getMax(),min:r.getMin(),samples:r.getCount(),percentage:t>0?n.duration/t*100:0})}),e}getTotalTime(){let e=0;return this.currentData.forEach(t=>{e+=t.duration}),e}}})))()}var ys,z,bs,xs,Ss,Cs;function ws(){return(ws=t((()=>{ys=i(),Xo(),E(),hs(),vs(),z=s(),bs=e=>{if(e<2){let t=e/2;return`rgb(${Math.floor(100+t*100)}, 200, 100)`}if(e<5){let t=(e-2)/3;return`rgb(200, ${Math.floor(200-t*50)}, 100)`}if(e<10){let t=(e-5)/5;return`rgb(200, ${Math.floor(150-t*80)}, ${Math.floor(100-t*50)})`}return`rgb(200, 70, 50)`},xs=e=>e>=10?e.toFixed(1):e>=1?e.toFixed(2):e.toFixed(3),Ss=e=>e.replace(/\[([^\]]{4,})\]/g,(e,t)=>`[${t.slice(0,3)}]`),Cs=()=>{let{editor:e}=T(),{engine:t}=Yo(),[n,r]=(0,ys.useState)([]),[i,a]=(0,ys.useState)(0),[o,s]=(0,ys.useState)(`all`),[c,l]=(0,ys.useState)(0),[u,d]=(0,ys.useState)(`time`),[f,p]=(0,ys.useState)(!1),m=(0,ys.useRef)(new _s(30)),h=(0,ys.useRef)(0),g=(0,ys.useRef)(!1),_=(0,ys.useRef)(0),v=(0,ys.useCallback)(n=>{if(!n)return;let r=t.root.findEntityByUUID(n);r&&e.selectEntity(r)},[t,e]);(0,ys.useEffect)(()=>{let e=t.renderer,n=m.current,i=e=>{f&&(n.update(e),g.current=!0)},o=e=>{g.current&&e-_.current>=300&&(r(n.getStatistics()),a(n.getTotalTime()),g.current=!1,_.current=e),h.current=requestAnimationFrame(o)};return e.on(`timer`,i),h.current=requestAnimationFrame(o),()=>{e.off(`timer`,i),cancelAnimationFrame(h.current)}},[t,f]);let y=n.filter(e=>!(o!==`all`&&e.renderType!==o||e.avg<c)),b=Array.from(new Set(n.map(e=>e.renderType))),x=[...y].sort((e,t)=>u===`time`?t.avg-e.avg:e.name.localeCompare(t.name)),S=i>0?Math.floor(1e3/i):0;return(0,z.jsxs)(`div`,{className:R.container,children:[(0,z.jsxs)(`div`,{className:R.headerRow,children:[(0,z.jsxs)(`span`,{className:R.totalTime,children:[xs(i),`ms (`,S,`fps)`]}),(0,z.jsx)(`button`,{className:R.toggleButton,onClick:()=>p(!f),title:f?`Stop timer`:`Start timer`,children:f?`⏸`:`▶`})]}),(0,z.jsxs)(`div`,{className:R.controls,children:[(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Type`}),(0,z.jsxs)(`select`,{className:R.select,value:o,onChange:e=>s(e.target.value),children:[(0,z.jsx)(`option`,{value:`all`,children:`All`}),b.map(e=>(0,z.jsx)(`option`,{value:e,children:e},e))]})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Min`}),(0,z.jsx)(`input`,{className:R.input,type:`number`,min:`0`,step:`0.1`,value:c,onChange:e=>l(parseFloat(e.target.value)||0)})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Sort`}),(0,z.jsxs)(`select`,{className:R.select,value:u,onChange:e=>d(e.target.value),children:[(0,z.jsx)(`option`,{value:`time`,children:`Time`}),(0,z.jsx)(`option`,{value:`name`,children:`Name`})]})]})]}),(0,z.jsx)(`div`,{className:R.group,children:x.map((e,t)=>{let n=bs(e.avg),r=i>0?e.avg/i*100:0,a=!!e.entityId;return(0,z.jsxs)(`div`,{className:`${R.item} ${a?R.clickable:``}`,onClick:()=>v(e.entityId),children:[(0,z.jsxs)(`div`,{className:R.itemRow,children:[(0,z.jsx)(`span`,{className:R.itemName,title:e.name,children:Ss(e.name)}),(0,z.jsx)(`span`,{className:R.itemTime,style:{color:n},children:xs(e.avg)}),(0,z.jsx)(`span`,{className:R.itemStats,children:xs(e.max)})]}),(0,z.jsx)(`div`,{className:R.progressBar,children:(0,z.jsx)(`div`,{className:R.progressFill,style:{width:`${r}%`,backgroundColor:n}})})]},e.name+t)})})]})},Cs.__docgenInfo={description:``,methods:[],displayName:`Timer`}})))()}var Ts,Es,Ds,Os,ks,As;function js(){return(js=t((()=>{Ts=`Picker__picker___LnBpY`,Es=`Picker__picker_label___LnBpY`,Ds=`Picker__picker_list___LnBpY`,Os=`Picker__picker_list_inner___LnBpY`,ks=`Picker__item___LnBpY`,As={picker:Ts,picker_label:Es,picker_list:Ds,picker_list_inner:Os,item:ks}})))()}var Ms,Ns;function Ps(){return(Ps=t((()=>{js(),Ms=s(),Ns=e=>(0,Ms.jsxs)(`div`,{className:As.picker,"data-no_bg":e.noBg,children:[e.label&&(0,Ms.jsx)(`div`,{className:As.picker_label,children:e.label}),(0,Ms.jsx)(`div`,{className:As.picker_list,children:(0,Ms.jsx)(`div`,{className:As.picker_list_inner,children:e.list.map((e,t)=>(0,Ms.jsx)(`div`,{className:As.item,onClick:e.onClick,children:e.label},t))})})]}),Ns.__docgenInfo={description:``,methods:[],displayName:`Picker`,props:{label:{required:!1,tsType:{name:`string`},description:``},list:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
	label: string,
	onClick?: () => void
}`,signature:{properties:[{key:`label`,value:{name:`string`,required:!0}},{key:`onClick`,value:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}},required:!1}}]}}],raw:`SelectListItem[]`},description:``},noBg:{required:!1,tsType:{name:`boolean`},description:``}}}})))()}var Fs,Is,Ls;function Rs(){return(Rs=t((()=>{Fs=`InputGroup__group___Lmdyb`,Is=`InputGroup__submit___Lmdyb`,Ls={group:Fs,submit:Is}})))()}var zs,Bs,Vs;function Hs(){return(Hs=t((()=>{zs=i(),c(),u(),jt(),Rs(),Bs=s(),Vs=e=>{let t=e.initialValues,n=[],[r,i]=(0,zs.useState)(t);(0,zs.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,Bs.jsx)(D,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,zs.useRef)(null);return(0,zs.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,Bs.jsx)(`div`,{className:Ls.group,ref:o,children:(0,Bs.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,Bs.jsx)(l,{label:e.title,noMargin:!0,children:n}),(0,Bs.jsx)(`div`,{className:Ls.submit,children:(0,Bs.jsx)(d,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},Vs.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}var Us,Ws,Gs,Ks,qs,Js,Ys,Xs,Zs,Qs,$s,ec;function tc(){return(tc=t((()=>{Us=`HierarchyNode__node___Lm5vZ`,Ws=`HierarchyNode__self___Lm5vZ`,Gs=`HierarchyNode__self_name___Lm5vZ`,Ks=`HierarchyNode__icon___Lm5vZ`,qs=`HierarchyNode__selectable___Lm5vZ`,Js=`HierarchyNode__visibility___Lm5vZ`,Ys=`HierarchyNode__menu___Lm5vZ`,Xs=`HierarchyNode__fold___Lm5vZ`,Zs=`HierarchyNode__fold_button___Lm5vZ`,Qs=`HierarchyNode__child___Lm5vZ`,$s=`HierarchyNode__child_line___Lm5vZ`,ec={node:Us,self:Ws,self_name:Gs,icon:Ks,selectable:qs,visibility:Js,menu:Ys,fold:Xs,fold_button:Zs,child:Qs,child_line:$s}})))()}var nc,B,rc;function ic(){return(ic=t((()=>{nc=i(),L(),a(),f(),m(),_(),h(),b(),E(),Ps(),ro(),Hs(),En(),tc(),B=s(),rc=e=>{let{editor:t,engine:n}=T(),[r]=O(t,`selectedEntityId`),i=r!==void 0&&n.root.findEntityByUUID(r),[a,s]=O(e.entity,`visible`),[c,l]=O(t,`unselectableEntityIds`),[u]=O(e.entity,`children`),d=!(c||[]).includes(e.entity.uuid),f=(u||[]).map(e=>n.root.findEntityByUUID(e)).filter(e=>e!==void 0),m=e.depth||0,h=f&&f.concat().sort((e,t)=>e.name.localeCompare(t.name))||[],_=h.length>0,b=m*20,x=e.entity.initiator==`script`,C=(0,nc.useMemo)(()=>e.entity.getComponent(Br)?(0,B.jsx)(S,{size:14}):e.entity.getComponent(Ir)?(0,B.jsx)(p,{size:14}):e.entity.getComponent(F)?(0,B.jsx)(y,{size:14}):null,[e.entity]),ee=e.openNodes.has(e.entity.uuid),te=(0,nc.useCallback)(t=>{e.setNodeOpen(e.entity.uuid,!ee),t.stopPropagation()},[ee,e]),ne=(0,nc.useCallback)(()=>{t&&t.selectEntity(e.entity)},[t,e.entity]),re=(0,nc.useCallback)(e=>{e.stopPropagation(),s&&s(!a)},[a,s]),ie=(0,nc.useCallback)(t=>{t.stopPropagation();let n=new Set(c||[]);d?n.add(e.entity.uuid):n.delete(e.entity.uuid),l(Array.from(n))},[d,c,l,e.entity.uuid]),{pushContent:w,closeAll:ae}=no(),oe=(0,nc.useCallback)(n=>{n.preventDefault(),!(!t||!w||!ae||x)&&(t.selectEntity(e.entity),w((0,B.jsx)(Ns,{label:e.entity.name,list:[{label:`Add Entity`,onClick:()=>{w((0,B.jsx)(Vs,{initialValues:{name:``},onSubmit:n=>{let r=t.api.createEntity(e.entity,n.name);t.api.selectEntity(r),ae()}}))}},{label:`Delete Entity`,onClick:()=>{t.api.deleteEntity(e.entity),ae()}}]})))},[t,e.entity,w,ae,x]);return(0,B.jsxs)(`div`,{className:ec.node,"data-no_export":x,children:[(0,B.jsxs)(`div`,{className:ec.self,style:{paddingLeft:b},onClick:ne,onContextMenu:oe,"data-selected":i&&i.uuid==e.entity.uuid,children:[(0,B.jsx)(`div`,{className:ec.fold,"data-hnode_open":ee,children:_&&(0,B.jsx)(`button`,{className:ec.fold_button,onClick:te,children:(0,B.jsx)(o,{open:ee})})}),C&&(0,B.jsx)(`div`,{className:ec.icon,children:C}),(0,B.jsx)(`div`,{className:ec.self_name,children:(0,B.jsx)(`p`,{children:e.entity.name||`-`})}),(0,B.jsx)(`button`,{className:ec.selectable,onClick:ie,"data-selectable":d,children:(0,B.jsx)(g,{size:14,selectable:d})}),(0,B.jsx)(`button`,{className:ec.visibility,onClick:re,"data-visible":a!==!1,children:(0,B.jsx)(v,{size:14,visible:a!==!1})}),!x&&(0,B.jsx)(`button`,{className:ec.menu,onClick:oe,children:`⋯`})]}),_&&(0,B.jsxs)(`div`,{className:ec.child,"data-open":ee,children:[h.map(t=>(0,B.jsx)(rc,{entity:t,depth:m+1,openNodes:e.openNodes,setNodeOpen:e.setNodeOpen},t.uuid)),(0,B.jsx)(`div`,{className:ec.child_line,style:{marginLeft:b+4}})]})]})},rc.__docgenInfo={description:``,methods:[],displayName:`HierarchyNode`,props:{depth:{required:!1,tsType:{name:`number`},description:``},entity:{required:!0,tsType:{name:`MXP.Entity`},description:``},openNodes:{required:!0,tsType:{name:`Set`,elements:[{name:`string`}],raw:`Set<string>`},description:``},setNodeOpen:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( uuid: string, open: boolean ) => void`,signature:{arguments:[{type:{name:`string`},name:`uuid`},{type:{name:`boolean`},name:`open`}],return:{name:`void`}}},description:``}}}})))()}var ac;function oc(){return(oc=t((()=>{ac={}})))()}var sc,cc,lc,uc,dc,fc;function pc(){return(pc=t((()=>{sc=i(),E(),En(),ic(),oc(),cc=s(),lc=`hierarchyOpenNodes`,uc=()=>{try{let e=localStorage.getItem(lc);if(e)return new Set(JSON.parse(e))}catch{}return new Set},dc=e=>{localStorage.setItem(lc,JSON.stringify(Array.from(e)))},fc=()=>{let{editor:e,engine:t}=T(),[n]=O(e,`selectedEntityId`),r=t.root,[i,a]=(0,sc.useState)(uc),o=(0,sc.useCallback)((e,t)=>{a(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),dc(r),r})},[]);return(0,sc.useEffect)(()=>{if(!n)return;let e=r.findEntityByUUID(n);if(!e)return;let t=[],i=e.parent;for(;i;)t.push(i.uuid),i=i.parent;a(e=>{if(t.every(t=>e.has(t)))return e;let n=new Set(e);return t.forEach(e=>n.add(e)),dc(n),n})},[n,r]),(0,cc.jsx)(`div`,{className:ac.hierarchy,children:r&&(0,cc.jsx)(rc,{entity:r,openNodes:i,setNodeOpen:o})})},fc.__docgenInfo={description:``,methods:[],displayName:`Hierarchy`}})))()}var mc,hc,gc,_c,vc,yc,bc,xc,Sc;function Cc(){return(Cc=t((()=>{mc=`InputWindow__inputWindow___Lmluc`,hc=`InputWindow__overlay___Lmluc`,gc=`InputWindow__window___Lmluc`,_c=`InputWindow__label___Lmluc`,vc=`InputWindow__input___Lmluc`,yc=`InputWindow__buttons___Lmluc`,bc=`InputWindow__cancelBtn___Lmluc`,xc=`InputWindow__okBtn___Lmluc`,Sc={inputWindow:mc,overlay:hc,window:gc,label:_c,input:vc,buttons:yc,cancelBtn:bc,okBtn:xc}})))()}var wc,Tc,Ec;function Dc(){return(Dc=t((()=>{wc=i(),Ie(),Cc(),Tc=s(),Ec=()=>{let{config:e,close:t}=Fe(),n=(0,wc.useRef)(null),[r,i]=(0,wc.useState)(``),a=(0,wc.useRef)(!1);(0,wc.useEffect)(()=>{e&&(i(String(e.value)),a.current=!0)},[e]),(0,wc.useEffect)(()=>{a.current&&(a.current=!1,n.current?.focus(),n.current?.select())},[r]);let o=(0,wc.useCallback)(()=>{e&&(e.type===`number`?e.onChange(Number(r)):e.onChange(r),t())},[e,r,t]),s=(0,wc.useCallback)(()=>{t()},[t]);return e?(0,Tc.jsxs)(`div`,{className:Sc.inputWindow,children:[(0,Tc.jsx)(`div`,{className:Sc.overlay,onClick:s}),(0,Tc.jsxs)(`div`,{className:Sc.window,children:[e.label&&(0,Tc.jsx)(`div`,{className:Sc.label,children:e.label}),(0,Tc.jsxs)(`form`,{onSubmit:e=>{e.preventDefault(),o()},children:[(0,Tc.jsx)(`input`,{ref:n,className:Sc.input,type:`text`,inputMode:e.type===`number`?`decimal`:`text`,value:r,step:e.step,min:e.min,max:e.max,onChange:e=>i(e.target.value),onKeyDown:e=>{e.key===`Escape`&&s()}}),(0,Tc.jsxs)(`div`,{className:Sc.buttons,children:[(0,Tc.jsx)(`button`,{type:`button`,className:Sc.cancelBtn,onClick:s,children:`Cancel`}),(0,Tc.jsx)(`button`,{type:`submit`,className:Sc.okBtn,children:`OK`})]})]})]})]}):null},Ec.__docgenInfo={description:``,methods:[],displayName:`InputWindow`}})))()}var Oc,kc;function Ac(){return(Ac=t((()=>{Oc=i(),kc=()=>{let[e,t]=(0,Oc.useState)(null);return{config:e,open:(0,Oc.useCallback)(e=>{t(e)},[]),close:(0,Oc.useCallback)(()=>{t(null)},[])}}})))()}var jc,Mc;function Nc(){return(Nc=t((()=>{Ne(),Ac(),jc=s(),Mc=e=>{let t=kc();return(0,jc.jsx)(Me.Provider,{value:t,children:e.children})},Mc.__docgenInfo={description:``,methods:[],displayName:`InputWindowProvider`}})))()}var Pc,Fc,Ic,Lc,Rc,zc;function Bc(){return(Bc=t((()=>{Pc=`MouseMenu__mouseMenu___Lm1vd`,Fc=`MouseMenu__hide___Lm1vd`,Ic=`MouseMenu__menuItem___Lm1vd`,Lc=`MouseMenu__menuItem_inner___Lm1vd`,Rc=`MouseMenu__menuItem_inner_inner___Lm1vd`,zc={mouseMenu:Pc,hide:Fc,menuItem:Ic,menuItem_inner:Lc,menuItem_inner_inner:Rc}})))()}var Vc,Hc;function Uc(){return(Uc=t((()=>{oo(),ro(),Bc(),Vc=s(),Hc=()=>{let{itemList:e,containerRef:t,closeAll:n}=no();return(0,Vc.jsxs)(`div`,{className:zc.mouseMenu,ref:t,children:[e&&e.length>0&&(0,Vc.jsx)(`div`,{className:zc.hide,onClick:()=>{n&&n()}}),e&&e.map(e=>{let t=e.pos;return(0,Vc.jsx)(ao.Provider,{value:e,children:(0,Vc.jsx)(`div`,{className:zc.menuItem,style:{left:0,top:0,transform:`translate(${t.x}px, ${t.y}px)`},children:(0,Vc.jsx)(`div`,{className:zc.menuItem_inner,children:(0,Vc.jsx)(`div`,{className:zc.menuItem_inner_inner,"data-direction":e.direction,children:e.elm})})})},e.id)})]})},Hc.__docgenInfo={description:``,methods:[],displayName:`MouseMenu`}})))()}var Wc,Gc,Kc;function qc(){return(qc=t((()=>{Wc=i(),Gc=0,Kc=()=>{let e=(0,Wc.useRef)(null),t=(0,Wc.useRef)({x:0,y:0}),n=(0,Wc.useCallback)(e=>{t.current.x=e.clientX,t.current.y=e.clientY},[]);(0,Wc.useEffect)(()=>(window.addEventListener(`pointermove`,n),()=>{window.removeEventListener(`pointermove`,n)}),[n]);let[r,i]=(0,Wc.useState)([]),a=(0,Wc.useRef)(r);a.current=r;let o=(0,Wc.useCallback)(e=>{a.current=a.current.filter(t=>t.id!==e),i(a.current)},[]),s=(0,Wc.useCallback)(()=>{i([])},[]);return{itemList:r,pushContent:(0,Wc.useCallback)(e=>{let n=Gc++,r={x:t.current.x,y:t.current.y},s={id:n,elm:e,pos:r,direction:(r.x<window.innerWidth/2?`right`:`left`)+`-`+(r.y<window.innerHeight/2?`bottom`:`top`),close:()=>o(n)};return i([...a.current,s]),s},[o]),closeAll:s,containerRef:e}}})))()}var Jc,Yc;function Xc(){return(Xc=t((()=>{eo(),qc(),Jc=s(),Yc=e=>{let t=Kc();return(0,Jc.jsx)($a.Provider,{value:t,children:e.children})},Yc.__docgenInfo={description:``,methods:[],displayName:`MouseMenuProvider`}})))()}function Zc(e={}){let t=sl([`screen`]),n=e.mainBottom,r=n?ol(`vertical`,[{ratio:712/912,node:t},{ratio:200/912,node:sl(n.tabs,n.active)}]):t;return ol(`vertical`,[{ratio:916/1076,node:ol(`horizontal`,[{ratio:300/1912,node:ol(`vertical`,[{ratio:696/912,node:cl([`scene`],e.leftTop)},{ratio:216/912,node:cl([`timer`],e.leftBottom)}])},{ratio:1312/1912,node:r},{ratio:300/1912,node:cl([`property`,`textures`,`project`,`renderer`,`editor-settings`],e.rightTop)}])},{ratio:160/1076,node:cl([`timeline`],e.footer)}])}function Qc(e){return e.type===`pane`?[e]:e.children.flatMap(e=>Qc(e.node))}function $c(e,t,n=new Set){let r=new Set,i=new Set,a=e=>{let t=typeof e==`string`&&e!==``&&!r.has(e)?e:crypto.randomUUID();return r.add(t),t},o=e=>{if(typeof e!=`object`||!e)return null;let r=e;if(r.type===`pane`){if(!Array.isArray(r.tabs))return null;let e=[...new Set(r.tabs.filter(e=>typeof e==`string`&&t.has(e)))].filter(e=>!n.has(e)||!i.has(e)&&(i.add(e),!0));if(e.length===0)return null;let o=typeof r.active==`string`&&e.includes(r.active)?r.active:e[0];return{type:`pane`,id:a(r.id),tabs:e,active:o}}if(r.type===`split`){if(r.direction!==`horizontal`&&r.direction!==`vertical`||!Array.isArray(r.children))return null;let e=[];return r.children.forEach(t=>{if(typeof t!=`object`||!t)return;let n=t,r=o(n.node);if(!r)return;let i=typeof n.ratio==`number`&&isFinite(n.ratio)&&n.ratio>0?n.ratio:1;e.push({ratio:i,node:r})}),e.length===0?null:e.length===1?e[0].node:{type:`split`,id:a(r.id),direction:r.direction,children:e}}return null},s=o(e);return s?ll(s):null}function el(e,t,n){return ul(e,t,e=>e.type!==`pane`||!e.tabs.includes(n)?e:{...e,active:n})}function tl(e,t,n,r){return ul(e,t,e=>{if(e.type!==`pane`||e.tabs.includes(n))return e;let t=[...e.tabs];return t.splice(Math.max(0,Math.min(r??t.length,t.length)),0,n),{...e,tabs:t,active:n}})}function nl(e,t,n,r,i){if(t===r)return ul(e,t,e=>{if(e.type!==`pane`)return e;let t=e.tabs.indexOf(n);if(t===-1)return e;let r=e.tabs.filter(e=>e!==n),a=i??e.tabs.length,o=Math.max(0,Math.min(t<a?a-1:a,r.length));return o===t?e:(r.splice(o,0,n),{...e,tabs:r,active:n})});let a=Qc(e),o=a.find(e=>e.id===t),s=a.find(e=>e.id===r);return!o||!s||!o.tabs.includes(n)||s.tabs.includes(n)?e:tl(il(e,t,n),r,n,i)}function rl(e,t,n,r,i){let a=Qc(e),o=a.find(e=>e.id===r);if(!o||!o.tabs.includes(i)||!a.some(e=>e.id===t)||r===t&&o.tabs.length===1)return e;let s=il(e,r,i),c={type:`pane`,id:crypto.randomUUID(),tabs:[i],active:i},l=ul(s,t,e=>{let t=[{ratio:.5,node:c},{ratio:.5,node:e}];return(n===`right`||n===`bottom`)&&t.reverse(),{type:`split`,id:crypto.randomUUID(),direction:n===`left`||n===`right`?`horizontal`:`vertical`,children:t}});return l===s?e:ll(l)??e}function il(e,t,n){let r=ul(e,t,e=>{if(e.type!==`pane`||!e.tabs.includes(n))return e;let t=e.tabs.indexOf(n),r=e.tabs.filter(e=>e!==n),i=e.active!==n||r.length===0?e.active:r[Math.min(t,r.length-1)];return{...e,tabs:r,active:i}});return r===e?e:ll(r)??e}function al(e,t,n){return ul(e,t,e=>e.type!==`split`||e.children.length!==n.length?e:{...e,children:e.children.map((e,t)=>({...e,ratio:n[t]}))})}var ol,sl,cl,ll,ul;function dl(){return(dl=t((()=>{ol=(e,t)=>({type:`split`,id:crypto.randomUUID(),direction:e,children:t}),sl=(e,t)=>({type:`pane`,id:crypto.randomUUID(),tabs:e,active:t??e[0]}),cl=(e,t)=>sl([...e,...t?.tabs??[]],t?.active),ll=e=>{if(e.type===`pane`)return e.tabs.length>0?e:null;let t=[];if(e.children.forEach(n=>{let r=ll(n.node);r&&(r.type===`split`&&r.direction===e.direction?r.children.forEach(e=>t.push({ratio:n.ratio*e.ratio,node:e.node})):t.push(r===n.node?n:{...n,node:r}))}),t.length===0)return null;if(t.length===1)return t[0].node;let n=t.reduce((e,t)=>e+t.ratio,0);return Math.abs(n-1)>1e-6?{...e,children:t.map(e=>({...e,ratio:e.ratio/n}))}:t.length!==e.children.length||t.some((t,n)=>t!==e.children[n])?{...e,children:t}:e},ul=(e,t,n)=>{if(e.id===t)return n(e);if(e.type===`split`){let r=!1,i=e.children.map(e=>{let i=ul(e.node,t,n);return i===e.node?e:(r=!0,{...e,node:i})});if(r)return{...e,children:i}}return e}})))()}function fl(e,t,n){let[r,i]=(0,pl.useState)(null),a=(0,pl.useRef)(e);a.current=e;let o=(0,pl.useRef)(t);o.current=t;let s=(0,pl.useRef)(null);return(0,pl.useEffect)(()=>()=>s.current?.(),[]),{dragState:r,onTabPointerDown:(e,t,r)=>{if(r.button!==0||s.current)return;let c=r.clientX,l=r.clientY,u=!1,d=null,f=r=>{if(r.buttons===0){p(!1);return}if(!u){if(Math.hypot(r.clientX-c,r.clientY-l)<ml)return;u=!0,i({panelId:t,title:n.get(t)?.title??t,startX:r.clientX,startY:r.clientY,target:null})}let o=vl(r.clientX,r.clientY,a.current,e,t);yl(o,d)||(d=o,i(e=>e&&{...e,target:o}))},p=n=>{if(g(),n&&u&&d){let n=a.current;d.kind===`tabs`?o.current(nl(n,e,t,d.paneId,d.index)):d.zone===`center`?o.current(nl(n,e,t,d.paneId)):o.current(rl(n,d.paneId,d.zone,e,t))}u&&i(null)},m=()=>p(!0),h=()=>p(!1),g=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),s.current=null};s.current=g,window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h)}}}var pl,ml,hl,gl,_l,vl,yl;function bl(){return(bl=t((()=>{pl=i(),dl(),ml=4,hl=.25,gl=(e,t)=>{let n={left:e.left,top:e.top,width:e.width,height:e.height};return(t===`left`||t===`right`)&&(n.width/=2),t===`right`&&(n.left+=n.width),(t===`top`||t===`bottom`)&&(n.height/=2),t===`bottom`&&(n.top+=n.height),n},_l=(e,t,n,r,i)=>{if(n.id!==r&&n.tabs.includes(i))return null;let a=[...t.querySelectorAll(`[data-panel-tab-id]`)].filter(e=>e instanceof HTMLElement),o=a.length;for(let t=0;t<a.length;t++){let n=a[t].getBoundingClientRect();if(e<n.left+n.width/2){o=t;break}}let s=t.getBoundingClientRect(),c=o<a.length?a[o].getBoundingClientRect().left:a.length>0?a[a.length-1].getBoundingClientRect().right:s.left;return{kind:`tabs`,paneId:n.id,index:o,rect:{left:c-1,top:s.top,width:2,height:s.height}}},vl=(e,t,n,r,i)=>{let a=document.elementFromPoint(e,t);if(!a)return null;let o=a.closest(`[data-pane-id]`);if(!(o instanceof HTMLElement))return null;let s=Qc(n).find(e=>e.id===o.dataset.paneId);if(!s)return null;let c=a.closest(`[data-panel-tab-header]`);if(c instanceof HTMLElement)return _l(e,c,s,r,i);let l=o.querySelector(`[data-panel-content]`);if(!(l instanceof HTMLElement))return null;let u=l.getBoundingClientRect();if(u.width<=0||u.height<=0)return null;let d=(e-u.left)/u.width,f=(t-u.top)/u.height;if(d<0||d>1||f<0||f>1)return null;if(Math.min(d,1-d)>hl&&Math.min(f,1-f)>hl)return s.id===r||s.tabs.includes(i)?null:{kind:`zone`,paneId:s.id,zone:`center`,rect:gl(u,`center`)};if(s.id===r&&s.tabs.length===1)return null;let p=d-.5,m=f-.5,h=Math.abs(p)>=Math.abs(m)?p<0?`left`:`right`:m<0?`top`:`bottom`;return{kind:`zone`,paneId:s.id,zone:h,rect:gl(u,h)}},yl=(e,t)=>e===null||t===null?e===t:e.paneId===t.paneId?e.kind===`tabs`&&t.kind===`tabs`?e.index===t.index:e.kind===`zone`&&t.kind===`zone`&&e.zone===t.zone:!1})))()}var xl,Sl;function Cl(){return(Cl=t((()=>{xl=`PanelLayout__pane___LnBhb`,Sl={pane:xl}})))()}var wl,Tl,El,Dl,Ol;function kl(){return(kl=t((()=>{wl=i(),w(),oe(),ce(),E(),Ps(),ro(),En(),ye(),bl(),Cl(),dl(),Tl=s(),El=e=>{let t=[],n={};if(!e)return{definitions:t,slots:n};let r=new Set;return Object.keys(e).forEach(i=>{let a=e[i];if(!a||a.length===0)return;let o=[],s;a.forEach(e=>{let n=`custom/${i}/${e.title}`;for(let t=2;r.has(n);t++)n=`custom/${i}/${e.title}-${t}`;r.add(n),o.push(n),t.push({id:n,title:e.title,content:(0,Tl.jsx)(se,{children:e.content})}),e.default&&s===void 0&&(s=n)}),n[i]={tabs:o,active:s}}),{definitions:t,slots:n}},Dl=e=>{let t=e.node;if(t.type===`split`)return(0,Tl.jsx)(ae,{direction:t.direction,ratios:t.children.map(e=>e.ratio),onRatiosChange:n=>e.onRatiosChange(t.id,n),children:t.children.map(t=>(0,Tl.jsx)(ae.Item,{children:(0,Tl.jsx)(Dl,{...e,node:t.node})},t.node.id))});let n=t.tabs.map(t=>e.panels.get(t)).filter(e=>e!==void 0);if(n.length===0)return null;let r=e.hasAddable(t);return(0,Tl.jsx)(`div`,{className:Sl.pane,"data-pane-id":t.id,children:(0,Tl.jsx)(le,{tabs:n.map(e=>({id:e.id,title:e.title,content:e.content})),active:t.active,onSelect:n=>e.onSelectTab(t.id,n),onTabContextMenu:(n,r)=>e.onTabContextMenu(t.id,n,r),onTabPointerDown:(n,r)=>e.onTabPointerDown(t.id,n,r),onAddClick:r?()=>e.onAddTab(t.id):void 0})})},Ol=e=>{let{editor:t}=T(),{pushContent:n,closeAll:r}=no(),i=(0,wl.useMemo)(()=>El(e.customTabs),[e.customTabs]),a=(0,wl.useMemo)(()=>{let t=new Map;return[...e.panels,...i.definitions].forEach(e=>t.set(e.id,e)),t},[e.panels,i]),[o,s]=O(t,`panelLayout`),c=(0,wl.useMemo)(()=>{let e=new Set([...a.values()].filter(e=>e.unique).map(e=>e.id));return $c(o,new Set(a.keys()),e)??Zc(i.slots)},[o,a,i]),l=e=>{e!==c&&s(e)},u=(e,t)=>l(el(c,e,t)),d=(e,t)=>l(al(c,e,t)),{dragState:f,onTabPointerDown:p}=fl(c,l,a),m=e=>[...a.values()].filter(t=>!e.tabs.includes(t.id));return(0,Tl.jsxs)(Tl.Fragment,{children:[(0,Tl.jsx)(Dl,{node:c,panels:a,onSelectTab:u,onRatiosChange:d,onTabContextMenu:(e,t,i)=>{i.preventDefault(),Qc(c).reduce((e,t)=>e+t.tabs.length,0)>1&&n((0,Tl.jsx)(Ns,{label:a.get(t)?.title,list:[{label:`Close Tab`,onClick:()=>{l(il(c,e,t)),r()}}]}))},onTabPointerDown:p,onAddTab:e=>{let t=Qc(c).find(t=>t.id===e);if(!t)return;let i=m(t);i.length!==0&&n((0,Tl.jsx)(Ns,{list:i.map(t=>({label:t.title,onClick:()=>{let n=t.unique?Qc(c).find(e=>e.tabs.includes(t.id)):void 0;l(tl(n?il(c,n.id,t.id):c,e,t.id)),r()}}))}))},hasAddable:e=>m(e).length>0}),f&&(0,Tl.jsx)(be,{drag:f})]})},Ol.__docgenInfo={description:``,methods:[],displayName:`PanelLayout`,props:{panels:{required:!0,tsType:{name:`Array`,elements:[{name:`PanelDefinition`}],raw:`PanelDefinition[]`},description:``},customTabs:{required:!1,tsType:{name:`Partial`,elements:[{name:`Record`,elements:[{name:`union`,raw:`"leftTop" | "leftBottom" | "mainBottom" | "rightTop" | "footer"`,elements:[{name:`literal`,value:`"leftTop"`},{name:`literal`,value:`"leftBottom"`},{name:`literal`,value:`"mainBottom"`},{name:`literal`,value:`"rightTop"`},{name:`literal`,value:`"footer"`}]},{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
	title: string;
	content: React.ReactNode;
	default?: boolean;
}`,signature:{properties:[{key:`title`,value:{name:`string`,required:!0}},{key:`content`,value:{name:`ReactReactNode`,raw:`React.ReactNode`,required:!0}},{key:`default`,value:{name:`boolean`,required:!1}}]}}],raw:`CustomTab[]`}],raw:`Record<PanelSlot, CustomTab[]>`}],raw:`Partial<Record<PanelSlot, CustomTab[]>>`},description:``}}}})))()}var Al,jl,Ml,Nl,Pl,Fl;function Il(){return(Il=t((()=>{Al=`ProjectControl__project___LnByb`,jl=`ProjectControl__project_inner___LnByb`,Ml=`ProjectControl__projectSelector___LnByb`,Nl=`ProjectControl__row___LnByb`,Pl=`ProjectControl__rowItem___LnByb`,Fl={project:Al,project_inner:jl,projectSelector:Ml,row:Nl,rowItem:Pl,export:`ProjectControl__export___LnByb`}})))()}var Ll,Rl,zl,Bl;function Vl(){return(Vl=t((()=>{Ll=i(),c(),u(),a(),E(),Il(),Rl=s(),zl=new URLSearchParams(location.search).get(`project`)||`default`,Bl=()=>{let{editor:e}=T(),[t,n]=(0,Ll.useState)(null);if((0,Ll.useEffect)(()=>{if(!e)return;let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),!e)return null;let r=e.isExporting;return(0,Rl.jsx)(`div`,{className:Fl.project,children:(0,Rl.jsx)(`div`,{className:Fl.project_inner,children:(0,Rl.jsxs)(l,{label:zl,accordion:!0,children:[(0,Rl.jsx)(d,{onClick:()=>{e&&e.save()},children:`Save`}),(0,Rl.jsx)(d,{onClick:()=>{window.location.href=`/`},children:`Projects`}),(0,Rl.jsxs)(`div`,{className:Fl.export,children:[(0,Rl.jsxs)(d,{onClick:()=>{e&&(e.save(),window.open(`/player`,`_blank`))},children:[`Play `,(0,Rl.jsx)(o,{})]}),(0,Rl.jsx)(d,{onClick:()=>{e&&!r&&e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})]})]})})})},Bl.__docgenInfo={description:``,methods:[],displayName:`ProjectControl`}})))()}var Hl,Ul,Wl;function Gl(){return(Gl=t((()=>{Hl=`RendererSettings__renderer___LnJlb`,Ul=`RendererSettings__renderer_inner___LnJlb`,Wl={renderer:Hl,renderer_inner:Ul}})))()}var Kl,ql;function Jl(){return(Jl=t((()=>{c(),E(),Tn(),Gl(),Kl=s(),ql=()=>{let{editor:e}=T(),t=e.engine.renderer;return(0,Kl.jsx)(`div`,{className:Wl.renderer,children:(0,Kl.jsxs)(`div`,{className:Wl.renderer_inner,children:[(0,Kl.jsx)(l,{label:`Resolution`,accordion:!0,children:(0,Kl.jsx)(wn,{target:e,filter:`resolution`})}),(0,Kl.jsx)(l,{label:`Pipeline`,accordion:!0,children:(0,Kl.jsx)(wn,{target:t,filter:`pipeline`})}),(0,Kl.jsx)(l,{label:`Sky`,accordion:!0,children:(0,Kl.jsx)(wn,{target:t,filter:`sky`})})]})})},ql.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var Yl,Xl;function Zl(){return(Zl=t((()=>{Yl=`Canvas__container___LmNvb`,Xl={container:Yl}})))()}var Ql,$l,eu;function tu(){return(tu=t((()=>{Ql=i(),E(),Zl(),$l=s(),eu=()=>{let{engine:e}=T(),t=(0,Ql.useRef)(null);return(0,Ql.useEffect)(()=>{let n=t.current;if(!e||!n)return;let r=e.canvas;if(!r){console.error(`Canvas element not found in engine`);return}return n.appendChild(r),()=>{n.contains(r)&&n.removeChild(r)}},[e]),(0,$l.jsx)(`div`,{className:Xl.container,ref:t,role:`presentation`,"aria-label":`3D Canvas`})},eu.__docgenInfo={description:``,methods:[],displayName:`Canvas`}})))()}var nu,ru;function iu(){return(iu=t((()=>{nu=`AudioView__audioView___LmF1Z`,ru={audioView:nu}})))()}var au;function ou(){return(ou=t((()=>{N(),j(),au=class extends ir{wrapperElm;canvas;canvasCtx;viewRangeFrame;viewPort;viewPortRange;musicBuffer;resizeObserver;frameSetting;framePlay;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0];let e=window.localStorage.getItem(`audioViweRange`);this.viewRangeFrame=e?Number(e):2,this.frameSetting={duration:0,fps:60},this.framePlay={current:0,playing:!1},this.musicBuffer=null,this.resizeObserver=new ResizeObserver(this.onResize.bind(this))}onResize(){if(this.wrapperElm){let e=new k(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);this.canvas.width=e.x,this.canvas.height=e.y}this.render()}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.musicBuffer){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)]*1,s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]*1+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}this.canvasCtx.fillStyle=`#555`,this.canvasCtx.fillRect(this.canvas.width/2,0,1,this.canvas.height)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.canvas),this.onResize()}setFramePlaying(e){this.framePlay=e,this.viewPort=[this.framePlay.current-this.viewRangeFrame,0,this.framePlay.current+this.viewRangeFrame,0],this.viewPortRange=[this.viewPort[2]-this.viewPort[0],this.viewPort[3]-this.viewPort[1]],this.render()}setViewRangeFrame(e){this.viewRangeFrame=e,this.setFramePlaying(this.framePlay),localStorage.setItem(`audioViweRange`,String(this.viewRangeFrame))}setFrameSetting(e){this.frameSetting=e,this.render()}setMusicBuffer(e){this.musicBuffer=e,this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.canvas),this.resizeObserver.disconnect()}},au.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setFramePlaying`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`FramePlay`,alias:`FramePlay`}}],returns:null},{name:`setViewRangeFrame`,docblock:null,modifiers:[],params:[{name:`rangeFrame`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frameSetting`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`AudioViewRenderer`}})))()}var su,cu,lu;function uu(){return(uu=t((()=>{su=i(),E(),iu(),ou(),cu=s(),lu=()=>{let{editor:e}=T(),t=(0,su.useRef)(null),[n,r]=(0,su.useState)();(0,su.useEffect)(()=>{let e=new au;if(r(e),t.current)return e.setWrapperElm(t.current),()=>{e.dispose()}},[]);let i=e&&e.audioBuffer,[a,o]=(0,su.useState)(),[s,c]=(0,su.useState)({duration:0,fps:0}),[l,u]=(0,su.useState)({current:0,playing:!1});(0,su.useEffect)(()=>{if(!e)return;let t=e.engine,n=e=>{c({duration:e[`timeline/duration`],fps:e[`timeline/fps`]})},r=0,i=()=>{o(r++)},a=e=>{u({...e})};return n(t.serialize()),a(t.frame),t.on(`fields/update`,n),t.on(`update/music`,i),t.on(`update/frame/play`,a),()=>{t.off(`update/frame/setting`,n),t.off(`update/music`,i),t.off(`update/frame/play`,a)}},[e]),(0,su.useEffect)(()=>{n&&i&&n.setMusicBuffer(i)},[n,i,a]),(0,su.useEffect)(()=>{n&&l&&n.setFramePlaying(l)},[n,l]),(0,su.useEffect)(()=>{n&&s&&n.setFrameSetting(s)},[n,s]);let d=(0,su.useCallback)(e=>{if(n){let t=e.deltaY>0?1.1:.9;n.setViewRangeFrame(n.viewRangeFrame*t)}e.preventDefault()},[n]);return(0,su.useEffect)(()=>{let e=t.current;return e&&e.addEventListener(`wheel`,d,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,d)}},[d]),(0,cu.jsx)(`div`,{className:ru.audioView,ref:t})},lu.__docgenInfo={description:``,methods:[],displayName:`AudioView`}})))()}var du,fu,pu;function mu(){return(mu=t((()=>{du=`CameraPad__cameraPad___LmNhb`,fu=`CameraPad__btn___LmNhb`,pu={cameraPad:du,btn:fu}})))()}var hu,gu;function _u(){return(_u=t((()=>{E(),En(),mu(),hu=s(),gu=()=>{let{editor:e}=T(),[t]=O(e,`selectedEntityId`);return(0,hu.jsxs)(`div`,{className:pu.cameraPad,children:[(0,hu.jsx)(`div`,{className:pu.btn,"data-disabled":!t,onClick:()=>{t&&e.focusSelected()},title:`Focus selected ( . )`,children:`Focus`}),(0,hu.jsx)(`div`,{className:pu.btn,onClick:()=>{e.syncToSceneCamera()},title:`Move to scene camera ( Esc )`,children:`Scene Cam`})]})},gu.__docgenInfo={description:``,methods:[],displayName:`CameraPad`}})))()}var vu,yu,bu,xu,Su,Cu,wu,Tu,Eu,Du,Ou,ku,Au,ju,Mu,Nu,Pu,Fu,Iu,Lu,Ru,V;function zu(){return(zu=t((()=>{vu=`Screen__screen___LnNjc`,yu=`Screen__header___LnNjc`,bu=`Screen__header_tabs___LnNjc`,xu=`Screen__header_tab___LnNjc`,Su=`Screen__header_right___LnNjc`,Cu=`Screen__header_item___LnNjc`,wu=`Screen__content___LnNjc`,Tu=`Screen__gizmoMode___LnNjc`,Eu=`Screen__gizmoMode_btn___LnNjc`,Du=`Screen__gizmoMode_separator___LnNjc`,Ou=`Screen__modalStatus___LnNjc`,ku=`Screen__canvas___LnNjc`,Au=`Screen__audioViewHandle___LnNjc`,ju=`Screen__audioView___LnNjc`,Mu=`Screen__displayOptions___LnNjc`,Nu=`Screen__displayOptions_btn___LnNjc`,Pu=`Screen__overlay___LnNjc`,Fu=`Screen__overlay_field___LnNjc`,Iu=`Screen__overlay_label___LnNjc`,Lu=`Screen__overlay_separator___LnNjc`,Ru=`Screen__externalBtn___LnNjc`,V={screen:vu,header:yu,header_tabs:bu,header_tab:xu,header_right:Su,header_item:Cu,content:wu,gizmoMode:Tu,gizmoMode_btn:Eu,gizmoMode_separator:Du,modalStatus:Ou,canvas:ku,audioViewHandle:Au,audioView:ju,displayOptions:Mu,displayOptions_btn:Nu,overlay:Pu,overlay_field:Fu,overlay_label:Iu,overlay_separator:Lu,externalBtn:Ru}})))()}var Bu,H,Vu;function Hu(){return(Hu=t((()=>{Bu=i(),u(),ue(),Ae(),E(),Bt(),tu(),jt(),En(),uu(),_u(),zu(),H=s(),Vu=()=>{let{editor:e}=T(),t=ke(),[n,r]=O(e,`enableRender`),[i,a]=O(e,`preview`),[o,s]=O(e,`viewType`),[c,l]=O(e,`resolutionScale`),[u,f]=O(e,`gizmoMode`),[p,m]=O(e,`transformOrientation`),[h]=O(e,`modalStatus`),[g,_]=O(e,`helpers/show`),[v,y]=O(e,`helpers/empty`),[b,x]=O(e,`helpers/camera`),[S,C]=O(e,`helpers/light`),[ee,te]=O(e,`helpers/grid`),[ne,re]=O(e,`helpers/wireframe`),[ie,w]=O(e,`helpers/gizmo`),[ae,oe]=O(e,`helpers/outline`),[se]=zt(`showAudioView`),[ce,le]=(0,Bu.useState)(50),ue=(0,Bu.useRef)(null),[fe,pe]=(0,Bu.useState)(!1),me=(0,Bu.useRef)(null),he=(0,Bu.useCallback)(e=>{me.current&&!me.current.contains(e.target)&&pe(!1)},[]);return(0,Bu.useEffect)(()=>(fe&&document.addEventListener(`pointerdown`,he),()=>{document.removeEventListener(`pointerdown`,he)}),[fe,he]),(0,H.jsxs)(`div`,{className:V.screen,children:[(0,H.jsxs)(`div`,{className:V.header,children:[(0,H.jsx)(`div`,{className:V.header_tabs,children:(0,H.jsx)(`div`,{className:V.header_tab,"data-active":!!i,onClick:()=>a&&a(!i),title:`Camera Render`,children:(0,H.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 512 512`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,H.jsx)(`path`,{d:`M32 144 H336 V368 H32 Z M368 224 L480 152 V360 L368 288 Z`})})})}),(0,H.jsxs)(`div`,{className:V.header_right,children:[(0,H.jsx)(`div`,{className:V.header_item,children:(0,H.jsx)(de,{title:`View`,children:(0,H.jsx)(D,{value:o,format:{type:`select`,list:[`render`,`debug`]},onChange:e=>s&&s(e)})})}),(0,H.jsx)(`div`,{className:V.header_item,children:(0,H.jsx)(de,{title:`Res`,children:(0,H.jsx)(D,{value:c,format:{type:`select`,list:[,,,,,,].fill(0).map((e,t)=>{let n=2**t,r=1/n;return{value:r,label:r==1?`1`:`1/`+n}})},onChange:e=>l&&l(e)})})}),t.isPC&&(0,H.jsx)(`div`,{className:V.externalBtn,children:(0,H.jsx)(d,{onClick:()=>{e.openInExternalWindow()},children:(0,H.jsxs)(`svg`,{width:`32`,height:`12`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,H.jsxs)(`g`,{clipPath:`url(#clip0_224_2)`,children:[(0,H.jsx)(`path`,{d:`M96 0V416H512V0H96ZM472 376H136V40H472V376Z`,fill:`#aaa`}),(0,H.jsx)(`path`,{d:`M40 472V296V136V96H0V512H416V472H376H40Z`,fill:`#aaa`}),(0,H.jsx)(`path`,{d:`M232.812 312.829L350.671 194.969V279.766H390.671V126.688H237.594V166.688H322.39L204.531 284.547L232.812 312.829Z`,fill:`#aaa`})]}),(0,H.jsx)(`defs`,{children:(0,H.jsx)(`clipPath`,{id:`clip0_224_2`,children:(0,H.jsx)(`rect`,{width:`512`,height:`512`,fill:`white`})})})]})})})]})]}),(0,H.jsxs)(`div`,{className:V.content,children:[(0,H.jsxs)(`div`,{className:V.displayOptions,ref:me,children:[(0,H.jsx)(`div`,{className:V.displayOptions_btn,"data-active":fe,onClick:()=>pe(!fe),title:`Display Options`,children:`⚙`}),fe&&(0,H.jsxs)(`div`,{className:V.overlay,children:[(0,H.jsx)(`div`,{className:V.overlay_label,children:`Rendering`}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(de,{title:`Render`,children:(0,H.jsx)(D,{value:n,onChange:e=>r&&r(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_separator}),(0,H.jsx)(`div`,{className:V.overlay_label,children:`Helpers`}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(de,{title:`Show`,children:(0,H.jsx)(D,{value:g,onChange:e=>_&&_(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(de,{title:`Empty`,children:(0,H.jsx)(D,{value:v,onChange:e=>y&&y(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(de,{title:`Camera`,children:(0,H.jsx)(D,{value:b,onChange:e=>x&&x(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(de,{title:`Light`,children:(0,H.jsx)(D,{value:S,onChange:e=>C&&C(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_separator}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(de,{title:`Grid`,children:(0,H.jsx)(D,{value:ee,onChange:e=>te&&te(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(de,{title:`Wireframe`,children:(0,H.jsx)(D,{value:ne,onChange:e=>re&&re(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(de,{title:`Gizmo`,children:(0,H.jsx)(D,{value:ie,onChange:e=>w&&w(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(de,{title:`Outline`,children:(0,H.jsx)(D,{value:ae,onChange:e=>oe&&oe(e)})})})]})]}),(0,H.jsxs)(`div`,{className:V.gizmoMode,children:[[`select`,`translate`,`rotate`,`scale`].map(e=>(0,H.jsx)(`div`,{className:V.gizmoMode_btn,"data-active":u===e,onClick:()=>f&&f(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`select`?`↖`:e===`translate`?`T`:e===`rotate`?`R`:`S`},e)),(0,H.jsx)(`div`,{className:V.gizmoMode_separator}),[`global`,`local`].map(e=>(0,H.jsx)(`div`,{className:V.gizmoMode_btn,"data-active":p===e,onClick:()=>m&&m(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`global`?`G`:`L`},e))]}),h&&(0,H.jsx)(`div`,{className:V.modalStatus,children:h}),(0,H.jsx)(`div`,{className:V.canvas,children:(0,H.jsx)(eu,{})}),t.isSP&&(0,H.jsx)(gu,{}),t.isPC&&se&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{className:V.audioViewHandle,onPointerDown:e=>{e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),ue.current={startY:e.clientY,startHeight:ce}},onPointerMove:e=>{if(!ue.current)return;let t=ue.current.startY-e.clientY,n=Math.max(20,Math.min(400,ue.current.startHeight+t));le(n)},onPointerUp:()=>{ue.current=null}}),(0,H.jsx)(`div`,{className:V.audioView,style:{height:ce},children:(0,H.jsx)(lu,{})})]})]})]})},Vu.__docgenInfo={description:``,methods:[],displayName:`Screen`}})))()}var Uu,Wu,Gu,Ku,qu,Ju,Yu;function Xu(){return(Xu=t((()=>{Uu=`Textures__textures___LnRle`,Wu=`Textures__item___LnRle`,Gu=`Textures__preview___LnRle`,Ku=`Textures__img___LnRle`,qu=`Textures__placeholder___LnRle`,Ju=`Textures__name___LnRle`,Yu={textures:Uu,item:Wu,preview:Gu,img:Ku,placeholder:qu,name:Ju}})))()}var Zu,Qu,$u;function ed(){return(ed=t((()=>{Zu=i(),Za(),E(),Xu(),Qu=s(),$u=()=>{let{engine:e,editor:t}=T(),[,n]=(0,Zu.useState)(0);(0,Zu.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return Wa.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{Wa.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=Wa.resources.textureList;return(0,Qu.jsx)(`div`,{className:Yu.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,Qu.jsxs)(`div`,{className:Yu.item,children:[(0,Qu.jsx)(`div`,{className:Yu.preview,children:n?(0,Qu.jsx)(`img`,{src:n,className:Yu.img}):(0,Qu.jsx)(`div`,{className:Yu.placeholder})}),(0,Qu.jsx)(`div`,{className:Yu.name,children:e.name})]},e.name)})})},$u.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var td,nd;function rd(){return(rd=t((()=>{td=i(),nd=(0,td.createContext)(null)})))()}var id,ad;function od(){return(od=t((()=>{id=i(),rd(),ad=()=>{let e=(0,id.useContext)(nd);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var sd;function cd(){return(cd=t((()=>{sd=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
