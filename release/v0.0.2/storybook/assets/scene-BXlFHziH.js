...
#endif\r
\r
}`,this.defines=e.defines||{},this.uniforms=e.uniforms||{},this.programCache={}}setVisibility(e){this.visibilityFlag={shadowMap:e.indexOf(`shadowMap`)>-1,deferred:e.indexOf(`deferred`)>-1,forward:e.indexOf(`forward`)>-1,ui:e.indexOf(`ui`)>-1,envMap:e.indexOf(`envMap`)>-1,postprocess:e.indexOf(`postprocess`)>-1}}requestUpdate(){this.programCache={}}}})))()}var sn;function cn(){return(cn=t((()=>{ht(),sn=class extends mt{name;enabled;_passes;constructor(e){super();let t=e||{};this.name=t.name||``,this.enabled=!0,this._passes=e&&e.passes||[]}get passes(){return this._passes}get hasOutput(){return this._passes.length>0&&this._passes.some(e=>e.enabled)}get output(){for(let e=this._passes.length-1;e>=0;e--){let t=this._passes[e];if(!t.passThrough&&t.enabled)return t.renderTarget}return null}resize(e){if(this._passes)for(let t=0;t<this._passes.length;t++)this._passes[t].resize(e)}dispose(){this.emit(`dispose`)}}})))()}function ln(){return(ln=t((()=>{})))()}function un(){return(un=t((()=>{})))()}var dn;function fn(){return(fn=t((()=>{O(),He(),on(),ln(),un(),dn=class extends an{enabled;renderTarget;backBufferOverride;clearColor;clearDepth;resolutionRatio;passThrough;resolution;resolutionInv;viewPort;_fixedResolution;constructor(e,t){super({...t,frag:t.frag||`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var _n;function vn(){return(vn=t((()=>{Qe(),O(),N(),He(),gn(),_n=class extends Je{postprocess;resolution;renderTarget;pmremPasses;swapBuffers;timeUniforms;constructor(e,t){super();let n=t.resolution,r={uTimeEF:{value:0,type:`1f`}},i=e.createFrameBuffer().setTexture([e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA16F,format:k.RGBA,magFilter:k.LINEAR,minFilter:k.LINEAR,wrapS:k.CLAMP_TO_EDGE,wrapT:k.CLAMP_TO_EDGE})]),a=[],o=[],s=[],c=0;for(let l=0;l<5;l++){let u=1/2**l,d=n.x*u,f=n.y*u*.5,p=new E(0,c,d,f);c+=f,s.push({rt1:e.createFrameBuffer().setTexture([e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA16F,format:k.RGBA})]),rt2:e.createFrameBuffer().setTexture([e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA16F,format:k.RGBA})])});let m=1/4*l,h=new dn(e,{renderTarget:s[l].rt1,frag:hn,uniforms:M.merge(r,{uRoughness:{value:m,type:`1f`},uEnvMap:{value:t.input,type:`1i`},uPMREMBackBuffer:{value:s[l].rt2.textures,type:`1i`},uRenderCount:{value:1,type:`1f`}}),defines:{NUM_SAMPLES:Math.floor(2**(l+1))}});h.resize(new E(d,f));let g=new dn(e,{renderTarget:i,viewPort:p,passThrough:!0});g.resize(n),a.push(h,g),o.push(h)}this.postprocess=new sn({passes:a}),this.postprocess.passes[0].backBufferOverride=i.textures,this.resolution=n,this.renderTarget=i,this.pmremPasses=o,this.swapBuffers=s,this.timeUniforms=r}swap(){this.timeUniforms.uTimeEF.value=(this.timeUniforms.uTimeEF.value+.016)%1;for(let e=0;e<this.pmremPasses.length;e++){let t=this.pmremPasses[e],n=this.swapBuffers[e],r=n.rt1;n.rt1=n.rt2,n.rt2=r,t.setRendertarget(n.rt1),t.uniforms.uPMREMBackBuffer.value=n.rt2.textures}}resize(e){}}})))()}var yn;function bn(){return(bn=t((()=>{yn=class{backend;pool;constructor(e){this.backend=e,this.pool=new Map}get(e,t,n){let r=e+t,i=this.pool.get(r);if(i!==void 0&&i.program)return i;let a=this.backend.createProgram();return n&&(a.name=n),a.setShader(e,t),this.pool.set(r,a),a}}})))()}var xn;function Sn(){return(Sn=t((()=>{xn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
}`})))()}var Cn;function wn(){return(wn=t((()=>{Cn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Tn;function En(){return(En=t((()=>{Tn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Dn;function On(){return(On=t((()=>{Dn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var kn;function An(){return(An=t((()=>{kn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var jn,Mn;function Nn(){return(Nn=t((()=>{Qe(),O(),N(),He(),Sn(),wn(),En(),On(),An(),jn=e=>{let t=[];for(let n=0;n<e;n++){let r=new E;r.x=Math.random()*2-1,r.y=Math.random()*2-1,r.z=n/e*.95+.05,r.normalize(),r.multiply(n/e*.95+.05),t.push(...r.getElm(`vec3`))}return t},Mn=class extends Je{postprocess;normalSelector_;lightShaft;rtLightShaft1;rtLightShaft2;ssao;rtSSAO1;rtSSAO2;ssaoBlur;ssaoBlurV;shading;constructor(e){super();let t=e.backend,n=new dn(t,{name:`normalSelector`,frag:Tn,renderTarget:null,uniforms:M.merge({uNormalTexture:{value:null,type:`1i`},uPosTexture:{value:null,type:`1i`},uSelectorTexture:{value:null,type:`1i`}}),passThrough:!0}),r=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:k.LINEAR,minFilter:k.LINEAR})]),i=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:k.LINEAR,minFilter:k.LINEAR})]),a=new dn(t,{name:`lightShaft`,frag:Cn,renderTarget:r,uniforms:M.merge({uLightShaftBackBuffer:{value:i.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:k.LINEAR,minFilter:k.LINEAR})]),s=t.createFrameBuffer().setTexture([t.createTexture().setting({magFilter:k.LINEAR,minFilter:k.LINEAR})]),c=new dn(t,{name:`ssao`,frag:Dn,renderTarget:Kt(`ssao`,o),uniforms:M.merge({uSSAOBackBuffer:{value:s.textures[0],type:`1i`},uSSAOKernel:{value:jn(16),type:`3fv`}}),resolutionRatio:.5,passThrough:!0}),l=M.merge({uSSAOTexture:{value:s.textures[0],type:`1i`},uDepthTexture:{value:null,type:`1i`},uNormalTexture:{value:null,type:`1i`},uWeights:{type:`1fv`,value:Ce.gaussWeights(8)}}),u=new dn(t,{name:`ssaoBlur/h`,frag:Kt(`ssaoBlur`,kn),uniforms:l,resolutionRatio:1,passThrough:!0,defines:{SSAOSAMPLE:8}}),d=new dn(t,{name:`ssaoBlur/v`,frag:Kt(`ssaoBlur`,kn),uniforms:M.merge(l,{uSSAOTexture:{value:u.renderTarget.textures[0],type:`1i`}}),defines:{SSAOSAMPLE:8,IS_VIRT:``},resolutionRatio:1,passThrough:!0}),f=new dn(t,{name:`deferredShading`,frag:Kt(`deferredShading`,xn),uniforms:M.merge({uLightShaftTexture:{value:null,type:`1i`},uSSAOTexture:{value:d.renderTarget.textures[0],type:`1i`},uSSAOResolutionInv:{value:c.resolutionInv,type:`2fv`},uEnvMap:{value:e.envMap,type:`1i`}})});this.postprocess=new sn({passes:[n,a,c,u,d,f]}),this.shading=f,this.lightShaft=a,this.ssao=c,this.rtSSAO1=o,this.rtSSAO2=s,this.ssaoBlur=u,this.ssaoBlurV=d,this.rtLightShaft1=r,this.rtLightShaft2=i,this.normalSelector_=n;let p=e.renderTarget;for(let e=0;e<p.gBuffer.textures.length;e++){let t=p.gBuffer.textures[e];e===1&&(t=p.normalBuffer.textures[0]),f.uniforms[`sampler`+e]=c.uniforms[`sampler`+e]={type:`1i`,value:t}}u.uniforms.uDepthTexture.value=p.gBuffer.textures[0],a.uniforms.uDepthTexture.value=p.gBuffer.depthTexture,f.renderTarget=p.shadingBuffer,n.renderTarget=p.normalBuffer,n.uniforms.uNormalTexture.value=p.gBuffer.textures[1],n.uniforms.uPosTexture.value=p.gBuffer.textures[0],n.uniforms.uSelectorTexture.value=p.gBuffer.textures[3],l.uNormalTexture.value=p.normalBuffer.textures[0]}update(){let e=this.rtLightShaft1;this.rtLightShaft1=this.rtLightShaft2,this.rtLightShaft2=e,this.lightShaft.setRendertarget(this.rtLightShaft1),this.shading.uniforms.uLightShaftTexture.value=this.rtLightShaft1.textures[0],this.lightShaft.uniforms.uLightShaftBackBuffer.value=this.rtLightShaft2.textures[0],e=this.rtSSAO1,this.rtSSAO1=this.rtSSAO2,this.rtSSAO2=e,this.ssao.setRendertarget(this.rtSSAO1),this.ssaoBlur.uniforms.uSSAOTexture.value=this.rtSSAO1.textures[0],this.ssao.uniforms.uSSAOBackBuffer.value=this.rtSSAO2.textures[0]}setPassEnabled(e){e.ssao!==void 0&&(this.ssao.enabled=e.ssao,this.ssaoBlur.enabled=e.ssao,this.ssaoBlurV.enabled=e.ssao,e.ssao||(this.rtSSAO1.clear(),this.rtSSAO2.clear(),this.ssaoBlur.renderTarget&&this.ssaoBlur.renderTarget.clear(),this.ssaoBlurV.renderTarget&&this.ssaoBlurV.renderTarget.clear())),e.lightShaft!==void 0&&(this.lightShaft.enabled=e.lightShaft,e.lightShaft||(this.rtLightShaft1.clear(),this.rtLightShaft2.clear()))}resize(e){this.postprocess.resize(e)}dispose(){this.postprocess.dispose(),this.rtLightShaft1.dispose(),this.rtLightShaft2.dispose(),this.rtSSAO1.dispose(),this.rtSSAO2.dispose()}}})))()}var Pn;function Fn(){return(Fn=t((()=>{Pn=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Hn;function Un(){return(Un=t((()=>{Hn=`in vec2 vUv;
...
}`})))()}var Wn;function Gn(){return(Gn=t((()=>{Wn=`in vec2 vUv;
uniform sampler2D uBackBuffer0;
uniform sampler2D uVelTex;
uniform vec2 uPPPixelSize;
...
}`})))()}var Kn;function qn(){return(qn=t((()=>{Kn=`in vec2 vUv;
uniform sampler2D uBackBuffer0;
uniform sampler2D uVelTex;
uniform vec2 uPPPixelSize;
...
}`})))()}var Qn;function $n(){return($n=t((()=>{O(),N(),He(),Fn(),Ln(),zn(),Vn(),Un(),Gn(),qn(),Yn(),Zn(),Qn=class{dofCoc;dofBokeh;dofComposite;rtSSR1;rtSSR2;postprocess;_ssr;_ssComposite;_dofParams;_motionBlur;_motionBlurTile;_motionBlurNeighbor;constructor(e,t){let n=new dn(e,{name:`collection`,frag:Pn}),r=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:k.LINEAR,minFilter:k.LINEAR})]),i=e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:k.LINEAR,minFilter:k.LINEAR})]),a=new dn(e,{name:`ssr`,frag:Kt(`ssr`,Xn),renderTarget:r,uniforms:M.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSceneTex:{value:null,type:`1i`},uSSRBackBuffer:{value:i.textures[0],type:`1i`}}),resolutionRatio:.5,passThrough:!0}),o=new dn(e,{name:`ssComposite`,frag:Kt(`ssComposite`,Jn),uniforms:M.merge({uGbufferPos:{value:null,type:`1i`},uGbufferNormal:{value:null,type:`1i`},uSSRTexture:{value:i.textures[0],type:`1i`}})}),s=new E(10,.05,20,.05),c=new dn(e,{name:`dof/coc`,frag:Rn,uniforms:M.merge({uGbufferPos:{value:null,type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:k.LINEAR,minFilter:k.LINEAR,internalFormat:k.RGBA16F,type:k.HALF_FLOAT,format:k.RGBA})]),passThrough:!0,resolutionRatio:.5}),l=new dn(e,{name:`dof/bokeh`,frag:In,uniforms:M.merge({uCocTex:{value:c.renderTarget.textures[0],type:`1i`},uParams:{value:s,type:`4f`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:k.LINEAR,minFilter:k.LINEAR})]),passThrough:!0,resolutionRatio:.5}),u=new dn(e,{name:`dof/composite`,frag:Bn,uniforms:M.merge({uBokeTex:{value:l.renderTarget.textures[0],type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:k.LINEAR,minFilter:k.LINEAR,internalFormat:k.RGBA16F,type:k.HALF_FLOAT,format:k.RGBA})])}),d=new dn(e,{name:`motionBlurTile`,frag:Kn,uniforms:M.merge({uVelTex:{value:null,type:`1i`}}),renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA32F,format:k.RGBA})]),defines:{TILE:16},resolutionRatio:1/16,passThrough:!0}),f=new dn(e,{name:`motionBlurNeighbor`,frag:Wn,uniforms:M.merge({uVelTex:{value:d.renderTarget.textures[0],type:`1i`}}),defines:{TILE:16},renderTarget:e.createFrameBuffer().setTexture([e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA32F,format:k.RGBA})]),resolutionRatio:1/16,passThrough:!0}),p=new dn(e,{name:`motionBlur`,frag:Hn,uniforms:M.merge({uVelNeighborTex:{value:f.renderTarget.textures[0],type:`1i`},uVelTex:{value:null,type:`1i`},uDepthTexture:{value:null,type:`1i`},uPower:{value:1,type:`1f`}}),defines:{TILE:16}});this.postprocess=new sn({passes:[n,a,o,c,l,u,d,f,p]}),this._ssr=a,this._ssComposite=o,this.dofCoc=c,this.dofBokeh=l,this.dofComposite=u,this._motionBlur=p,this._motionBlurTile=d,this._motionBlurNeighbor=f,this._dofParams=s,this.rtSSR1=r,this.rtSSR2=i,n.backBufferOverride=t.shadingBuffer.textures,a.uniforms.uGbufferPos.value=t.gBuffer.textures[0],a.uniforms.uGbufferNormal.value=t.normalBuffer.textures[0],a.uniforms.uSceneTex.value=t.forwardBuffer.textures[0],o.uniforms.uGbufferPos.value=t.gBuffer.textures[0],o.uniforms.uGbufferNormal.value=t.gBuffer.textures[1],c.uniforms.uGbufferPos.value=t.gBuffer.textures[0],d.uniforms.uVelTex.value=t.gBuffer.textures[4],p.uniforms.uVelTex.value=t.gBuffer.textures[4],p.uniforms.uDepthTexture.value=t.gBuffer.depthTexture}update(e){let t=e.fov,n=e.dofParams.focusDistance,r=e.dofParams.kFilmHeight,i=r/Math.tan(.5*(t/180*Math.PI)),a=1/this.dofBokeh.renderTarget.size.y*5,o=1/a,s=i*i/(e.dofParams.fNumber*(n-i)*r*2);this._dofParams.set(n,a,o,s);let c=this.rtSSR1;this.rtSSR1=this.rtSSR2,this.rtSSR2=c,this._ssr.setRendertarget(this.rtSSR1),this._ssComposite.uniforms.uSSRTexture.value=this.rtSSR1.textures[0],this._ssr.uniforms.uSSRBackBuffer.value=this.rtSSR2.textures[0]}resize(e){this.postprocess.resize(e)}setPassEnabled(e){e.motionBlur!==void 0&&(this._motionBlurTile.enabled=e.motionBlur,this._motionBlurNeighbor.enabled=e.motionBlur,this._motionBlur.enabled=e.motionBlur,e.motionBlur||(this._motionBlurTile.renderTarget&&this._motionBlurTile.renderTarget.clear(),this._motionBlurNeighbor.renderTarget&&this._motionBlurNeighbor.renderTarget.clear())),e.ssr!==void 0&&(this._ssr.enabled=e.ssr,this._ssComposite.enabled=e.ssr,e.ssr||(this.rtSSR1.clear(),this.rtSSR2.clear())),e.dof!==void 0&&(this.dofCoc.enabled=e.dof,this.dofBokeh.enabled=e.dof,this.dofComposite.enabled=e.dof,e.dof||(this.dofBokeh.renderTarget&&this.dofBokeh.renderTarget.clear(),this.dofComposite.renderTarget&&this.dofComposite.renderTarget.clear()))}setMotionBlurPower(e){this._motionBlur.uniforms.uPower.value=e}dispose(){this.postprocess.dispose(),this.rtSSR1.dispose(),this.rtSSR2.dispose()}}})))()}var er,tr;function nr(){return(nr=t((()=>{He(),Nn(),$n(),er=e=>{let t=e.createFrameBuffer();t.setTexture([e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA32F,format:k.RGBA,magFilter:k.NEAREST,minFilter:k.NEAREST}),e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA32F,format:k.RGBA}),e.createTexture(),e.createTexture(),e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA32F,format:k.RGBA})]);let n=e.createFrameBuffer({disableDepthBuffer:!0});n.setTexture([e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA16F,format:k.RGBA}),e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA16F,format:k.RGBA})]);let r=e.createFrameBuffer({disableDepthBuffer:!0});r.setDepthTexture(t.depthTexture),r.setTexture([n.textures[0],t.textures[0],t.textures[4]]);let i=e.createFrameBuffer({disableDepthBuffer:!0});i.setTexture([e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA16F,format:k.RGBA,magFilter:k.LINEAR,minFilter:k.LINEAR})]);let a=e.createFrameBuffer({disableDepthBuffer:!0});a.setDepthTexture(t.depthTexture),a.setTexture([e.createTexture()]);let o=e.createFrameBuffer();return o.setTexture([e.createTexture().setting({type:k.FLOAT,internalFormat:k.RGBA32F,format:k.RGBA,magFilter:k.NEAREST,minFilter:k.NEAREST})]),{gBuffer:t,shadingBuffer:n,forwardBuffer:r,refractionBuffer:i,uiBuffer:a,normalBuffer:o}},tr=class{camera;offscreen;renderTarget;deferredRenderer;pipelinePostProcess;_pipelineOverride;_sceneConfig;_onDispose;constructor(e){this.camera=null,this.offscreen=e.offscreen,this._pipelineOverride=null,this._sceneConfig=e.sceneConfig,this._onDispose=e.onDispose,this.renderTarget=er(e.backend),this.deferredRenderer=new Mn({backend:e.backend,envMap:e.envMap,envMapCube:e.envMapCube,renderTarget:this.renderTarget}),this.pipelinePostProcess=new Qn(e.backend,this.renderTarget),e.resolution.x>0&&e.resolution.y>0&&this.resize(e.resolution),this.applyPipelineConfig()}get pipelineOverride(){return this._pipelineOverride}set pipelineOverride(e){this._pipelineOverride=e,this.applyPipelineConfig()}applyPipelineConfig(){let e={...this._sceneConfig,...this._pipelineOverride};this.deferredRenderer.setPassEnabled({ssao:e.ssao,lightShaft:e.lightShaft}),this.pipelinePostProcess.setPassEnabled({motionBlur:e.motionBlur,ssr:e.ssr,dof:e.dof}),this.pipelinePostProcess.setMotionBlurPower(e.motionBlurPower??1)}resize(e){let t=this.renderTarget;t.gBuffer.setSize(e),t.shadingBuffer.setSize(e),t.forwardBuffer.setSize(e),t.refractionBuffer.setSize(e),t.uiBuffer.setSize(e),t.normalBuffer.setSize(e),this.deferredRenderer.resize(e),this.pipelinePostProcess.resize(e)}dispose(){this._onDispose(this);let e=this.renderTarget;e.forwardBuffer.dispose();let t=[e.gBuffer,e.shadingBuffer,e.refractionBuffer,e.uiBuffer,e.normalBuffer];for(let e=0;e<t.length;e++){let n=t[e];for(let e=0;e<n.textures.length;e++)n.textures[e].dispose();n.dispose()}e.gBuffer.depthTexture&&e.gBuffer.depthTexture.dispose(),this.deferredRenderer.dispose(),this.pipelinePostProcess.dispose()}}})))()}var rr;function ir(){return(ir=t((()=>{rr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	vUv = uv;\r
\r
}`,renderTarget:r,uniforms:M.merge(t.uniforms,a,{uDeltaTime:{value:0,type:`1f`}})}),this.size=t.size,this.layerCnt=t.dataLayerCount,this.rt1=r,this.rt2=i,this.renderTarget=this.rt1,this.clearColor=t.clearColor??null,this.outputUniforms=a}onAfterRender(){super.onAfterRender();for(let e=0;e<this.layerCnt;e++)this.outputUniforms[`uGPUSampler`+e].value=this.renderTarget.textures[e];let e=this.rt1;this.rt1=this.rt2,this.rt2=e,this.renderTarget=this.rt1}initTexture(e){for(let t=0;t<this.layerCnt;t++){let n=[];for(let r=0;r<this.size.y;r++)for(let i=0;i<this.size.x;i++){let a=i,o=r;n.push(...e(t,a,o))}this.rt2.textures[t].subImage(new Float32Array(n),this.size.x,this.size.y)}}}})))()}function Dr(){return(Dr=t((()=>{Be(),O(),Pt(),He(),on(),cn(),fn()})))()}function Or(){return(Or=t((()=>{Qe(),Pt(),vt(),on()})))()}function kr(){return(kr=t((()=>{O(),cn(),He(),fn()})))()}function Ar(){return(Ar=t((()=>{cn(),fn()})))()}function jr(){return(jr=t((()=>{cn(),fn()})))()}function Mr(){return(Mr=t((()=>{cn(),fn()})))()}function Nr(){return(Nr=t((()=>{tn(),kr(),Ar(),jr(),Mr()})))()}function N(){return(N=t((()=>{He(),$t(),xr(),on(),Cr(),Er(),tn(),Nn(),nr(),Dr(),Or(),cn(),fn(),Nr(),mn()})))()}var Pr;function Fr(){return(Fr=t((()=>{Pr=class{static serializeEntity(e,t){let n=e=>{let r=[];e.children.forEach(e=>{e.initiator!=`script`&&r.push(n(e))});let i=[];e.components.forEach(e=>{let n=e.serialize({mode:`export`}),r=Object.keys(n).length>0;if(e.initiator!==`user`)return;let a={name:t.getName(e),uuid:e.uuid};r&&(a.props=n),i.push(a)});for(let t of e.unresolvedComponents)i.push({name:t.name,uuid:t.uuid,props:t.props});return{name:e.name,uuid:e.uuid,pos:e.position.x==0&&e.position.y==0&&e.position.z==0?void 0:e.position.getElm(`vec3`),rot:e.euler.x==0&&e.euler.y==0&&e.euler.z==0?void 0:e.euler.getElm(`vec3`),scale:e.scale.x==1&&e.scale.y==1&&e.scale.z==1?void 0:e.scale.getElm(`vec3`),components:i.length>0?i:void 0,childs:r.length>0?r:void 0}};return n(e)}static deserializeEntity(e,t,n,r){let i=(e,t)=>{let a=t||r.createEntity();a.initiator=`user`,a.name=e.name,a.restoreUUID(e.uuid);let o=e.pos||[0,0,0];a.position.x=o[0],a.position.y=o[1],a.position.z=o[2];let s=e.rot||[0,0,0];a.euler.x=s[0],a.euler.y=s[1],a.euler.z=s[2];let c=e.scale||[1,1,1];return a.scale.x=c[0],a.scale.y=c[1],a.scale.z=c[2],a.unresolvedComponents=[],e.components&&e.components.forEach(e=>{let t=n.resolve(e.name);if(t){let n=a.getComponent(t.component);n||(n=a.addComponent(t.component),n.initiator=`user`),n.restoreUUID(e.uuid),e.props&&n.deserialize(e.props)}else console.warn(`[ProjectSerializer] Component "${e.name}" not found in resolver. Preserving data for round-trip.`),a.unresolvedComponents.push({name:e.name,uuid:e.uuid,props:e.props})}),e.childs&&([...a.children].forEach(e=>{e.initiator!==`script`&&a.remove(e)}),e.childs.forEach(e=>{a.add(i(e))})),a};e&&i(e,t),t.initiator=`god`}}})))()}var Ir;function Lr(){return(Lr=t((()=>{N(),Ir=class extends mt{name;_frag;_resolution;_filter;_updateEveryFrame;_textures;constructor(e,t){super(),this.name=e;let n=t.data;this._frag=n?.frag||``,this._resolution=n?.resolution||[1024,1024],this._filter=n?.filter||`linear`,this._updateEveryFrame=n?.updateEveryFrame??!1,this._textures=n?.textures||{}}get frag(){return this._frag}get resolution(){return this._resolution}get filter(){return this._filter}get updateEveryFrame(){return this._updateEveryFrame}get textures(){return this._textures}}})))()}var Rr;function zr(){return(zr=t((()=>{Rr=(e,t)=>{let n={},r=`/${t}/`;for(let[t,i]of Object.entries(e)){let e=t.slice(t.lastIndexOf(r)+r.length).split(`/`).slice(0,-2),a=Object.entries(i).find(([e,t])=>typeof t==`function`&&/^[A-Z]/.test(e));if(!a)continue;let o=n;for(let t of e)o=o[t]=o[t]||{};o[a[0]]=a[1]}return n}})))()}var Br;function Vr(){return(Vr=t((()=>{Qe(),O(),Lr(),zr(),Br=class extends Je{_componentList;_componentGroups;_geometryList;_geometryGroups;_textureResources;_textures;_updateEveryFrameTextures;constructor(){super(),this._componentList=[],this._textures=new Map,this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources=new Map,this._updateEveryFrameTextures=[]}get componentList(){return this._componentList}get componentGroups(){return this._componentGroups}get geometryList(){return this._geometryList}get geometryGroups(){return this._geometryGroups}get textureList(){return Array.from(this._textureResources.values())}get textures(){return this._textures}get updateEveryFrameTextures(){return this._updateEveryFrameTextures}clear(){this._componentList=[],this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources.clear(),this._textures.clear(),this._updateEveryFrameTextures=[],this.emit(`update`)}getComponent(e){return this._componentList.find(t=>t.name==e)}getComponentName(e){let t=this._componentList.find(t=>e instanceof t.component);return t?t.name:e.constructor.name}addComponentGroup(e){let t=this._componentGroups.find(t=>t.name==e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addComponent:(e,n)=>{let r={name:e,component:n};t.push(r),this._componentList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._componentGroups.push(t),this.emit(`update`),t}getGeometry(e){return this._geometryList.find(t=>t.name===e)}addGeometryGroup(e){let t=this._geometryGroups.find(t=>t.name===e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addGeometry:(e,n)=>{let r={name:e,geometryClass:n};t.push(r),this._geometryList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._geometryGroups.push(t),this.emit(`update`),t}addTextureResource(e,t){let n=new Ir(e,{data:t});this._textureResources.set(e,n),this.emit(`update`)}getTextureResource(e){return this._textureResources.get(e)}removeTextureResource(e){this._textureResources.delete(e);let t=this._textures.get(e);t&&(t.dispose(),this._textures.delete(e)),this.emit(`update`)}addTexture(e,t){return this._textures.set(e,t),t}getTexture(e){return this._textures.get(e)}_buildTexture(e,t,n,r){let i=e.frag;return i?t.createTexProcedural({name:e.name,frag:i,resolution:new E(e.resolution[0]||1024,e.resolution[1]||1024),filter:e.filter,textures:n,uniforms:e.updateEveryFrame?r:void 0}):null}_ensureTexture(e,t,n,r){let i=this._textures.get(e.name);if(i)return i;if(r.has(e.name))return null;r.add(e.name);let a={},o=e.textures,s=Object.keys(o);for(let e=0;e<s.length;e++){let i=s[e],c=o[i],l=this._textureResources.get(c),u=l?this._ensureTexture(l,t,n,r):this._textures.get(c);u&&(a[i]=u)}let c=this._buildTexture(e,t,a,n);return c?(this._textures.set(e.name,c),e.updateEveryFrame&&this._updateEveryFrameTextures.push(c),c):null}buildTextureInstances(e,t){this._updateEveryFrameTextures=[];let n=new Set;this._textureResources.forEach(r=>{this._ensureTexture(r,e,t,n)}),this.emit(`update`)}}})))()}var Hr,P;function Ur(){return(Ur=t((()=>{O(),N(),Fr(),Vr(),Hr={duration:600,fps:30},P=class e extends mt{static resources;name;_renderer;_root;_uniforms;_time;_frame;_frameSetting;_disposed;_frameEvent;constructor(e){super(),this.name=`OREngine`,this._disposed=!1,this._uniforms={uEnvMapIntensity:{value:1,type:`1f`}},this._renderer=e(this),this._renderer.globalUniforms={uTime:{value:0,type:`1f`},uTimeF:{value:0,type:`1f`},uTimeE:{value:0,type:`1f`},uTimeEF:{value:0,type:`1f`},uDeltaTime:{value:0,type:`1f`},uResolution:{value:new E,type:`2fv`},uAspectRatio:{value:1,type:`1f`}},this._time={current:new Date().getTime(),engine:0,delta:0,code:0},this._frameSetting={...Hr},this._frame={current:0,playing:!1},this.seek(0),this._frameEvent=null,this._root=this.createEntity({name:`root`}),this._root.initiator=`god`,this.field(`name`,()=>this.name,e=>this.name=e),this.field(`scene`,()=>Pr.serializeEntity(this._root,this._createComponentResolver()),e=>{Pr.deserializeEntity(e,this._root,this._createComponentResolver(),this)}),this.field(`renderer`,()=>this._renderer.serialize({mode:`export`}),e=>this._renderer.deserialize(e));let t=this.fieldDir(`timeline`);t.field(`duration`,()=>this._frameSetting.duration,e=>this._frameSetting.duration=e),t.field(`fps`,()=>this._frameSetting.fps,e=>this._frameSetting.fps=e)}createEntity(e){return new zt({engine:this,...e})}get canvas(){return this._renderer.canvas}get renderer(){return this._renderer}get root(){return this._root}get frame(){return this._frame}get time(){return this._time}get frameSetting(){return this._frameSetting}get uniforms(){return this._uniforms}get disposed(){return this._disposed}createView(e){return this._renderer.createView(e)}_createComponentResolver(){return{resolve:t=>e.resources.getComponent(t),getName:t=>e.resources.getComponentName(t)}}init(){this._root.disposeRecursive(),this._root.position.set(0,0,0),this._root.euler.set(0,0,0),this._root.scale.set(1,1,1),this.name=`New Project`,this._renderer.reset(),Object.assign(this._frameSetting,Hr),this.stop(),this.seek(0)}async load(e){this.init(),this.deserialize(e),this.emit(`update/graph`),this.emit(`loaded`)}update(t){let n=new Date().getTime();this._time.delta=(n-this._time.current)/1e3,this._time.current=n,this._time.engine+=this._time.delta,this._time.code+=this._time.delta*+!!this._frame.playing,this._frame.current=this._time.code*60;let r=this.createEntityUpdateEvent({forceDraw:t?.forceDraw});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1,this._renderer.globalUniforms.uDeltaTime.value=Math.min(this._time.delta,1/60);let i=e.resources.updateEveryFrameTextures;for(let e=0;e<i.length;e++)i[e].render();return this._step(r),this._frame.playing&&this.emit(`update/frame/play`,[this._frame]),this._time.delta}_step(e){this._root.commitFrame(e),this._root.update(e),this._root.postUpdate(e),this._root.updateMatrixRecursive(),this._root.prepareRender(e),this._renderer.prepareScene(this._root,e),this._frameEvent=e}render(e){this._frameEvent&&this._renderer.render(e,this._frameEvent)}createEntityUpdateEvent(e){let t={playing:this._frame.playing,timeElapsed:this._time.engine,timeDelta:this._time.delta,timeCode:this._time.code,timeCodeFrame:this._frame.current,resolution:this.renderer.resolution,renderer:this.renderer,forceDraw:!1};return e?{...t,...e}:t}setSize(e){this._renderer.resize(e),this._renderer.canvas.width=e.x,this._renderer.canvas.height=e.y,this._renderer.globalUniforms.uResolution.value.copy(e),this._renderer.globalUniforms.uAspectRatio.value=e.x/Math.max(e.y,1)}play(){this._frame.playing=!0,this._time.current=new Date().getTime()}stop(){this._frame.playing=!1}seek(e){this._time.code=e/60,this._frame.current=e,this.emit(`update/frame/play`,[this._frame])}updateOffline(t,n){let r=t/n,i=1/n;this._time.delta=i,this._time.current=new Date().getTime(),this._time.engine+=i,this._time.code=r,this._frame.current=r*60,this._frame.playing=!0;let a=this.createEntityUpdateEvent({forceDraw:!0});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1;let o=e.resources.updateEveryFrameTextures;for(let e=0;e<o.length;e++)o[e].render();this._step(a)}compileShaders(e,t){let n=this.createEntityUpdateEvent({forceDraw:!0});return this.renderer.compileShaders(this._root,e,n,t)}dispose(){this._disposed=!0,this._root.disposeRecursive()}},P.resources=new Br,P.__docgenInfo={description:``,methods:[{name:`createEntity`,docblock:null,modifiers:[],params:[{name:`params`,optional:!0,type:{name:`Omit`,elements:[{name:`MXP.EntityParams`},{name:`literal`,value:`'engine'`}],raw:`Omit<MXP.EntityParams, 'engine'>`,alias:`Omit`}}],returns:{type:{name:`MXP.Entity`}}},{name:`canvas`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`renderer`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`root`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`frame`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`time`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`frameSetting`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`uniforms`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`disposed`,docblock:null,modifiers:[`get`],params:[],returns:null},{name:`createView`,docblock:null,modifiers:[],params:[{name:`opt`,optional:!0,type:{name:`MXP.RenderViewOptions`,alias:`MXP.RenderViewOptions`}}],returns:null},{name:`init`,docblock:null,modifiers:[],params:[],returns:null},{name:`load`,docblock:null,modifiers:[`async`],params:[{name:`project`,optional:!1,type:{name:`OREngineProjectData`,alias:`OREngineProjectData`}}],returns:null},{name:`update`,docblock:null,modifiers:[],params:[{name:`param`,optional:!0,type:{name:`Partial`,elements:[{name:`MXP.EntityUpdateEvent`}],raw:`Partial<MXP.EntityUpdateEvent>`,alias:`Partial`}}],returns:null},{name:`createEntityUpdateEvent`,docblock:null,modifiers:[],params:[{name:`overrideParams`,optional:!0,type:{name:`Partial`,elements:[{name:`MXP.EntityUpdateEvent`}],raw:`Partial<MXP.EntityUpdateEvent>`,alias:`Partial`}}],returns:{type:{name:`MXP.EntityUpdateEvent`}}},{name:`setSize`,docblock:null,modifiers:[],params:[{name:`resolution`,optional:!1,type:{name:`MTP.Vector`,alias:`MTP.Vector`}}],returns:null},{name:`play`,docblock:null,modifiers:[],params:[],returns:null},{name:`stop`,docblock:null,modifiers:[],params:[],returns:null},{name:`seek`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`number`}}],returns:null},{name:`updateOffline`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`number`}},{name:`fps`,optional:!1,type:{name:`number`}}],returns:null},{name:`compileShaders`,docblock:null,modifiers:[],params:[{name:`view`,optional:!1,type:{name:`MXP.RenderViewContract`,alias:`MXP.RenderViewContract`}},{name:`onProgress`,optional:!0,type:{name:`signature`,type:`function`,raw:`( label: string, loaded: number, total: number ) => void`,signature:{arguments:[{type:{name:`string`},name:`label`},{type:{name:`number`},name:`loaded`},{type:{name:`number`},name:`total`}],return:{name:`void`}}}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`Engine`}})))()}var Wr;function Gr(){return(Gr=t((()=>{Qe(),Wr=class extends Je{_pressedKeys;constructor(){super(),this._pressedKeys={};let e=this._onKeyDown.bind(this),t=this._onKeyUp.bind(this);window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,t),this.once(`dispose`,()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,t)})}get pressedKeys(){return this._pressedKeys}_onKeyDown(e){this._pressedKeys[e.key]=!0,this.emit(`keydown`,[e,this._pressedKeys])}_onKeyUp(e){if(this._pressedKeys[e.key]=!1,e.key==`Meta`||e.key==`Control`){let e=Object.keys(this._pressedKeys);for(let t=0;t<e.length;t++)this._pressedKeys[e[t]]=!1}this.emit(`keyup`,[e,this._pressedKeys])}dispose(){this.emit(`dispose`)}}})))()}var Kr;function qr(){return(qr=t((()=>{Qe(),O(),Kr=class extends Je{_isTouching;element=null;position;delta;constructor(){super(),this.position=new E(NaN,NaN),this.delta=new E(NaN,NaN),this._isTouching=!1;let e=this._onPointer.bind(this,`move`),t=this._onPointer.bind(this,`end`);window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`dragend`,t);let n=()=>{this.element&&this.removeElement(this.element),window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`dragend`,t),this.off(`dispose`,n)};this.on(`dispose`,n)}setElement(e){this.element&&this.removeElement(this.element),this.element=e;let t=this._onPointer.bind(this,`start`);e.addEventListener(`pointerdown`,t);let n=r=>{e.isEqualNode(r.elm)&&(e.removeEventListener(`pointerdown`,t),this.off(`unregister`,n))};this.on(`unregister`,n)}removeElement(e){this.emit(`unregister`,[e])}getScreenPosition(e){if(this.position.x!=this.position.x)return new E(NaN,NaN);let t=this.position.clone().divide(e).multiply(2).sub(1);return t.y*=-1,t}getRelativePosition(e,t){let n=e.getClientRects()[0],r=this.position.x-n.left,i=this.position.y-n.top;return t&&(r/=n.width,i/=n.height),new E(r,i)}_setPos(e,t){this.position.x!==this.position.x||this.position.y!==this.position.y?this.delta.set(0,0):this.delta.set(e-this.position.x,t-this.position.y),this.position.set(e,t)}_onPointer(e,t){let n=t.pointerType;(n==null||n==`mouse`&&(t.button==-1||t.button==0)||n==`touch`)&&this._touchEventHandler(t.pageX,t.pageY,e,t)}_touchEventHandler(e,t,n,r){let i=!1,a=e-window.pageXOffset,o=t-window.pageYOffset;n==`start`?(this._isTouching=!0,this._setPos(a,o),this.delta.set(0,0),i=!0):n==`move`?(this._setPos(a,o),this._isTouching&&(i=!0)):n==`end`&&(`targetTouches`in r?r.targetTouches.length==0&&(this._isTouching=!1):this._isTouching=!1,i=!0),i&&this.emit(n,[{pointerEvent:r,position:this.position.clone(),delta:this.delta.clone()}])}dispose(){this.emit(`dispose`)}}})))()}function Jr(){return(Jr=t((()=>{Ur(),Vr(),Gr(),qr()})))()}function Yr(){return(Yr=t((()=>{Jr()})))()}var Xr,Zr;function Qr(){return(Qr=t((()=>{Xr=i(),Zr=(0,Xr.createContext)(null)})))()}var $r,F;function I(){return(I=t((()=>{$r=i(),Qr(),F=()=>{let e=(0,$r.useContext)(Zr);if(e===null)throw Error(`useEditor must be used within a EditorProvider`);return e}})))()}var ei,ti,ni;function ri(){return(ri=t((()=>{ei=i(),Yr(),x(),I(),ti=o(),ni=e=>{let{engine:t}=F(),n=(0,ei.useCallback)(()=>{let e=[{label:`(None)`,value:``}];return t.root.traverse(n=>{n.components.forEach(r=>{e.push({label:`${n.getScenePath(t.root)} > ${P.resources.getComponentName(r)}`,value:r.uuid})})}),e},[t]),[r,i]=(0,ei.useState)(n);return(0,ei.useEffect)(()=>{let e=()=>i(n());return t.on(`update/graph`,e),()=>{t.off(`update/graph`,e)}},[t,n]),(0,ti.jsx)(C,{value:e.value||``,selectList:r,onChange:t=>{e.onChange&&e.onChange(t||null)}})},ni.__docgenInfo={description:``,methods:[],displayName:`InputComponentRef`,props:{value:{required:!0,tsType:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: string | null ) => void`,signature:{arguments:[{type:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},name:`value`}],return:{name:`void`}}},description:``}}}})))()}var ii,ai,oi;function si(){return(si=t((()=>{ii=i(),x(),I(),ai=o(),oi=e=>{let{engine:t}=F(),n=(0,ii.useCallback)(()=>{let e=[{label:`(None)`,value:``}];return t.root.traverse(n=>{e.push({label:n.getScenePath(t.root),value:n.uuid})}),e},[t]),[r,i]=(0,ii.useState)(n);return(0,ii.useEffect)(()=>{let e=()=>i(n());return t.on(`update/graph`,e),()=>{t.off(`update/graph`,e)}},[t,n]),(0,ai.jsx)(C,{value:e.value||``,selectList:r,onChange:t=>{e.onChange&&e.onChange(t||null)}})},oi.__docgenInfo={description:``,methods:[],displayName:`InputEntityRef`,props:{value:{required:!0,tsType:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: string | null ) => void`,signature:{arguments:[{type:{name:`union`,raw:`string | null`,elements:[{name:`string`},{name:`null`}]},name:`value`}],return:{name:`void`}}},description:``}}}})))()}var ci,li,ui,di;function fi(){return(fi=t((()=>{ci=`InputResourceSelect__inputResourceSelect___Lmluc`,li=`InputResourceSelect__select___Lmluc`,ui=`InputResourceSelect__editButton___Lmluc`,di={inputResourceSelect:ci,select:li,editButton:ui}})))()}var pi,mi,hi;function gi(){return(gi=t((()=>{pi=i(),x(),I(),fi(),mi=o(),hi=e=>{let{editor:t}=F(),n=(0,pi.useCallback)(()=>{e.value&&(t.setField(`navigateAsset`,{assetType:e.resourceType,name:String(e.value)}),t.setField(`selectedAsset`,{name:String(e.value),assetType:e.resourceType}))},[t,e.value,e.resourceType]);return(0,mi.jsxs)(`div`,{className:di.inputResourceSelect,children:[(0,mi.jsx)(`div`,{className:di.select,children:(0,mi.jsx)(C,{value:e.value,selectList:e.selectList,onChange:e.onChange})}),e.value&&(0,mi.jsx)(`button`,{className:di.editButton,onClick:n,title:`Edit resource`,children:`✎`})]})},hi.__docgenInfo={description:``,methods:[],displayName:`InputResourceSelect`,props:{value:{required:!0,tsType:{name:`T`},description:``},selectList:{required:!0,tsType:{name:`union`,raw:`SelectList | ( () => SelectList )`,elements:[{name:`SelectList`},{name:`unknown`}]},description:``},resourceType:{required:!0,tsType:{name:`union`,raw:`"material" | "texture" | "shader"`,elements:[{name:`literal`,value:`"material"`},{name:`literal`,value:`"texture"`},{name:`literal`,value:`"shader"`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}}},description:``}}}})))()}var _i,vi;function yi(){return(yi=t((()=>{i(),x(),ri(),si(),gi(),_i=o(),vi=e=>{let t=null,n=e.onChange,r=e.value,i=e.format,a=e=>{n&&n(e)};if(i&&(i.type==`entity`?t=(0,_i.jsx)(oi,{value:r,onChange:a}):i.type==`component`?t=(0,_i.jsx)(ni,{value:r,onChange:a}):i.type==`vector`&&Array.isArray(r)?t=(0,_i.jsx)(y,{value:r,onChange:a}):i.type==`color`&&Array.isArray(r)?t=(0,_i.jsx)(g,{value:r,onChange:a}):i.type==`select`?t=(0,_i.jsx)(C,{value:r,onChange:a,selectList:i.list}):i.type==`resource`&&(t=(0,_i.jsx)(hi,{value:r,onChange:a,selectList:i.list,resourceType:i.resourceType}))),r==null)return t;if(!t){if(typeof r==`number`)t=(0,_i.jsx)(S,{...e,value:r,onChange:a});else if(typeof r==`string`)t=(0,_i.jsx)(_,{...e,value:r,onChange:a});else if(typeof r==`boolean`)t=(0,_i.jsx)(h,{...e,checked:r,onChange:a});else if(typeof r==`function`){let n=e.label||`Run`;t=(0,_i.jsx)(c,{onClick:()=>{r()},children:n})}else t=(0,_i.jsx)(_,{...e,value:JSON.stringify(r),onChange:()=>{}})}return t}})))()}var bi,xi,Si,Ci,wi,Ti,Ei,Di;function Oi(){return(Oi=t((()=>{bi=i(),xi={showAudioView:!0},Si=`orengine-editor-ui-settings`,Ci=()=>{try{let e=localStorage.getItem(Si);if(e)return{...xi,...JSON.parse(e)}}catch{}return{...xi}},wi=Ci(),Ti=new Set,Ei=e=>(Ti.add(e),()=>{Ti.delete(e)}),Di=e=>[(0,bi.useSyncExternalStore)(Ei,()=>wi[e]),(0,bi.useCallback)(t=>{wi={...wi,[e]:t};try{localStorage.setItem(Si,JSON.stringify(wi))}catch{}Ti.forEach(e=>e())},[e])]})))()}var ki,Ai,ji;function Mi(){return(Mi=t((()=>{ki=`EditorSettings__editorSettings___LmVka`,Ai=`EditorSettings__editorSettings_inner___LmVka`,ji={editorSettings:ki,editorSettings_inner:Ai}})))()}var Ni,Pi;function Fi(){return(Fi=t((()=>{x(),yi(),Oi(),Mi(),Ni=o(),Pi=()=>{let[e,t]=Di(`showAudioView`);return(0,Ni.jsx)(`div`,{className:ji.editorSettings,children:(0,Ni.jsx)(`div`,{className:ji.editorSettings_inner,children:(0,Ni.jsx)(s,{label:`View`,accordion:!0,children:(0,Ni.jsx)(w,{title:`AudioView`,children:(0,Ni.jsx)(vi,{value:e,onChange:e=>t(e)})})})})})},Pi.__docgenInfo={description:``,methods:[],displayName:`EditorSettings`}})))()}var Ii,Li;function Ri(){return(Ri=t((()=>{Ii=i(),Li=(0,Ii.createContext)(void 0)})))()}var zi,Bi;function Vi(){return(Vi=t((()=>{zi=i(),Bi=(e,t)=>{let[n,r]=(0,zi.useState)(()=>e?e.serialize():{}),i=t?[...t]:[],a=(0,zi.useMemo)(()=>i,i);return(0,zi.useEffect)(()=>{if(e===void 0)return;r(e.serialize());let t=t=>{let n=a.length==0;for(let e=0;e<a.length;e++)if(t.find(t=>t==a[e])){n=!0;break}n&&r(e.serialize())};return e.on(`fields/update`,t),()=>{e.off(`fields/update`,t)}},[e,a]),{fields:n}}})))()}var Hi;function Ui(){return(Ui=t((()=>{Vi(),Hi=e=>(Bi(e.target),{target:e.target})})))()}var Wi,Gi;function Ki(){return(Ki=t((()=>{Wi=i(),Ri(),Gi=()=>{let e=(0,Wi.useContext)(Li);if(!e)throw Error(`SerializeFieldViewContext is not defined`);return e}})))()}var qi,Ji;function Yi(){return(Yi=t((()=>{qi=`ValueArray__container___LmNvb`,Ji={container:qi}})))()}var Xi,Zi;function Qi(){return(Qi=t((()=>{i(),x(),yi(),Yi(),Xi=o(),Zi=e=>{let t=[],n=e.value,r=e.format,i=r?.type==`array`?r.labels:void 0;if(n===void 0)return null;for(let r=0;r<n.length;r++){let a=n[r],o=r.toString();i&&(o+=`/ `+i(a,r)),t.push((0,Xi.jsx)(w,{title:o,children:(0,Xi.jsx)(vi,{...e,value:a,onChange:t=>{let i=n.concat();i[r]=t,e.onChange&&e.onChange(i)}})},r))}return(0,Xi.jsx)(`div`,{className:Ji.container,children:t})},Zi.__docgenInfo={description:``,methods:[],displayName:`ValueArray`,props:{value:{required:!0,tsType:{name:`union`,raw:`T | undefined`,elements:[{name:`T`},{name:`undefined`}]},description:``},onChange:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( value: T ) => void`,signature:{arguments:[{type:{name:`T`},name:`value`}],return:{name:`void`}}},description:``},format:{required:!1,tsType:{name:`SerializableFieldFormat`},description:``},label:{required:!1,tsType:{name:`union`,raw:`string | React.ReactNode`,elements:[{name:`string`},{name:`ReactReactNode`,raw:`React.ReactNode`}]},description:``},readOnly:{required:!1,tsType:{name:`boolean`},description:``},step:{required:!1,tsType:{name:`number`},description:``},disabled:{required:!1,tsType:{name:`boolean`},description:``}}}})))()}var $i,ea;function ta(){return(ta=t((()=>{$i=`SerializeFieldViewValue__action___LmFjd`,ea={action:$i}})))()}var na,ra;function ia(){return(ia=t((()=>{i(),x(),I(),Ki(),yi(),Qi(),ta(),na=o(),ra=e=>{let{editor:t}=F(),{target:n}=Gi(),r=e.field.value,i=typeof r,a=e.field.opt,o=a?.format,s=a?.label||e.path.split(`/`).pop(),c=o&&o.type==`vector`,l=null;if(Array.isArray(r))l=o?.type==`vector`?(0,na.jsx)(y,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}}):o?.type==`color`?(0,na.jsx)(g,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}}):(0,na.jsx)(Zi,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}});else if(l=(0,na.jsx)(vi,{value:r,...a,onChange:r=>{t.api.setField(n,e.path,r)}}),i===`function`)return(0,na.jsx)(`div`,{className:ea.action,children:l});return(0,na.jsx)(w,{title:s,vertical:c,children:l})},ra.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldViewValue`,props:{path:{required:!0,tsType:{name:`string`},description:``},field:{required:!0,tsType:{name:`SerializeFieldDirectoryValue`},description:``}}}})))()}var aa,oa,sa,ca;function la(){return(la=t((()=>{aa=`SerializeFieldViewDir__container___LmNvb`,oa=`SerializeFieldViewDir__field___LmNvb`,sa=`SerializeFieldViewDir__block___LmNvb`,ca={container:aa,field:oa,block:sa}})))()}var ua,da;function fa(){return(fa=t((()=>{i(),x(),ia(),la(),ua=o(),da=e=>{let t=[],n=Object.keys(e.fields.childs);for(let r=0;r<n.length;r++){let i=n[r],a=e.fields.childs[i],{opt:o}=a,c=!1;if(o&&(c=typeof o.hidden==`function`?o.hidden(a.type==`value`?a.value:null):o.hidden||!1),c)continue;let l=`field`+i,u=(e.basePath?e.basePath+`/`:``)+i,d=null;d=a.type===`value`?(0,ua.jsx)(ra,{path:u,field:a},l):(0,ua.jsx)(`div`,{className:ca.block,children:(0,ua.jsx)(s,{accordion:!0,label:i,children:(0,ua.jsx)(da,{fields:a,basePath:u})},l)},l),d&&t.push(d)}return(0,ua.jsx)(`div`,{className:ca.container,children:t})},da.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldViewDir`,props:{fields:{required:!0,tsType:{name:`MXP.SerializeFieldDirectoryFolder`},description:``},basePath:{required:!1,tsType:{name:`string`},description:``}}}})))()}var pa,ma;function ha(){return(ha=t((()=>{Ri(),Ui(),fa(),pa=o(),ma=e=>{let t=Hi(e),n=t.target.serializeToDirectory();if(e.filter){let t=n.childs[e.filter];t&&t.type===`folder`&&(n=t)}return(0,pa.jsx)(Li.Provider,{value:t,children:(0,pa.jsx)(da,{fields:n,basePath:e.filter})})},ma.__docgenInfo={description:``,methods:[],displayName:`SerializeFieldView`}})))()}var L;function ga(){return(ga=t((()=>{Vi(),L=(e,t)=>{let n=n=>{e?.setField(t,n)},{fields:r}=Bi(e,[t]);return[r&&r[t],n]}})))()}var _a,va;function ya(){return(ya=t((()=>{_a=i(),va=(0,_a.createContext)(void 0)})))()}var ba,xa;function Sa(){return(Sa=t((()=>{ba=i(),ya(),xa=()=>(0,ba.useContext)(va)})))()}var Ca,wa,Ta,Ea;function Da(){return(Da=t((()=>{Ca=`TreeMenu__directory___LmRpc`,wa=`TreeMenu__subDirectory___LmRpc`,Ta=`TreeMenu__treeMenu___LmRpc`,Ea={directory:Ca,subDirectory:wa,treeMenu:Ta}})))()}var Oa,ka,Aa,ja;function Ma(){return(Ma=t((()=>{Oa=i(),Sa(),Da(),ka=o(),Aa=e=>{let t=xa(),[n,r]=(0,Oa.useState)(!1),i=e.item,a=null,o=`item`;if(`children`in i){o=`dir`,a=[];for(let e=0;e<i.children.length;e++)a.push((0,ka.jsx)(Aa,{item:i.children[e]},e))}let s=e=>{if(`onClick`in i){i.onClick();return}e.stopPropagation(),r(!n)},c=window.matchMedia(`(hover: hover)`).matches,l,u;return c&&(l=()=>r(!0),u=()=>r(!1)),(0,ka.jsxs)(`div`,{className:Ea.directory,onPointerEnter:l,onPointerLeave:u,onClick:s,"data-type":o,"data-direction":t?.direction,children:[i.label,n&&a&&(0,ka.jsx)(`div`,{className:Ea.subDirectory,children:a})]})},ja=e=>{let t=[];for(let n=0;n<e.items.length;n++)t.push((0,ka.jsx)(Aa,{item:e.items[n]},n));return(0,ka.jsx)(`div`,{className:Ea.treeMenu,children:t})},ja.__docgenInfo={description:``,methods:[],displayName:`TreeMenu`,props:{items:{required:!0,tsType:{name:`Array`,elements:[{name:`union`,raw:`TreeMenuBranch | TreeMenuLeaf`,elements:[{name:`signature`,type:`object`,raw:`{
	label: string;
	children: TreeMenuItem[];
}`,signature:{properties:[{key:`label`,value:{name:`string`,required:!0}},{key:`children`,value:{name:`Array`,elements:[{name:`TreeMenuItem`}],raw:`TreeMenuItem[]`,required:!0}}]}},{name:`signature`,type:`object`,raw:`{
	label: string;
	onClick: () => void;
}`,signature:{properties:[{key:`label`,value:{name:`string`,required:!0}},{key:`onClick`,value:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}},required:!0}}]}}]}],raw:`TreeMenuItem[]`},description:``}}}})))()}var Na,Pa;function Fa(){return(Fa=t((()=>{Na=i(),Pa=(0,Na.createContext)(null)})))()}var Ia,La;function Ra(){return(Ra=t((()=>{Ia=i(),Fa(),La=()=>{let e=(0,Ia.useContext)(Pa);if(e===null)throw Error(`useMouseMenu must be used within a MouseMenuProvider`);return e}})))()}var za,Ba;function Va(){return(Va=t((()=>{za=`ComponentAdd__compAdd___LmNvb`,Ba={compAdd:za}})))()}var Ha,Ua,Wa,Ga;function Ka(){return(Ka=t((()=>{Ha=i(),Yr(),x(),I(),Ma(),Ra(),Va(),Ua=o(),Wa=(e,t)=>{let n=e.name;if(n.startsWith(`_`)&&(n=n.slice(1)),`child`in e){let r=[];for(let n of e.child)r.push(Wa(n,t));return{label:n,children:r}}return{label:n,onClick:()=>t(e)}},Ga=e=>{let{editor:t}=F(),{pushContent:n,closeAll:r}=La(),i=P.resources,a=(0,Ha.useCallback)(a=>{if(!i)return;let o=n=>{t.api.addComponent(e.entity,n.component),r()},s=[];for(let e of i.componentGroups)s.push(Wa(e,o));n((0,Ua.jsx)(ja,{items:s}))},[n,i,e.entity,r,t]);return(0,Ua.jsx)(`div`,{className:Ba.compAdd,children:(0,Ua.jsx)(c,{onClick:a,children:`Add Component`})})},Ga.__docgenInfo={description:``,methods:[],displayName:`ComponentAdd`,props:{entity:{required:!0,tsType:{name:`MXP.Entity`},description:``}}}})))()}var qa,Ja,Ya,Xa,Za,Qa;function $a(){return($a=t((()=>{qa=`ComponentView__compoView___LmNvb`,Ja=`ComponentView__head___LmNvb`,Ya=`ComponentView__name___LmNvb`,Xa=`ComponentView__check___LmNvb`,Za=`ComponentView__propertyBlock___LmNvb`,Qa={compoView:qa,head:Ja,name:Ya,check:Xa,delete:`ComponentView__delete___LmNvb`,propertyBlock:Za}})))()}var eo,to,no,ro;function io(){return(io=t((()=>{eo=i(),Yr(),x(),I(),ha(),ga(),$a(),to=o(),no=e=>{let t=Object.keys(e.childs);for(let n=0;n<t.length;n++){let r=e.childs[t[n]],{opt:i}=r,a=!1;if(i&&(a=typeof i.hidden==`function`?i.hidden(r.type===`value`?r.value:null):i.hidden||!1),!a&&(r.type===`value`||no(r)))return!0}return!1},ro=({component:e})=>{let{editor:t}=F(),[n,r]=L(e,`enabled`),i=e.initiator!==`user`,a=no(e.serializeToDirectory()),o=(0,eo.useCallback)(n=>{n.stopPropagation();let r=e.entity;if(r){for(let[n,i]of r.components)if(i.uuid===e.uuid){t.api.removeComponent(r,n,e);break}}},[e,t]),c=(0,to.jsxs)(`div`,{className:Qa.head,children:[(0,to.jsx)(`div`,{className:Qa.name,children:P.resources.getComponentName(e)}),(0,to.jsx)(`div`,{className:Qa.delete,children:(0,to.jsx)(`button`,{onClick:o,children:(0,to.jsx)(m,{})})})]});return(0,to.jsx)(`div`,{className:Qa.compoView,"data-disable_component":i,children:(0,to.jsx)(`div`,{className:Qa.content,children:(0,to.jsx)(s,{label:c,accordion:a,bg:!0,defaultClose:!1,children:a&&(0,to.jsx)(ma,{target:e})})})})},ro.__docgenInfo={description:``,methods:[],displayName:`ComponentView`,props:{component:{required:!0,tsType:{name:`MXP.Component`},description:``}}}})))()}var ao,oo;function so(){return(so=t((()=>{ao=`ComponentList__container___LmNvb`,oo={container:ao}})))()}var co,lo,uo;function fo(){return(fo=t((()=>{co=i(),ga(),io(),so(),lo=o(),uo=({entity:e})=>{let[t]=L(e,`components`),n=(0,co.useMemo)(()=>{let n=[];return t?(t.forEach(t=>{let r=e.getComponentByUUID(t);r&&n.push((0,lo.jsx)(ro,{component:r},r.uuid))}),n):null},[t,e]);return(0,lo.jsx)(`div`,{className:oo.container,children:n})},uo.__docgenInfo={description:``,methods:[],displayName:`ComponentList`}})))()}var po,mo,ho;function go(){return(go=t((()=>{po=i(),x(),I(),ha(),ga(),Ka(),fo(),mo=o(),ho=()=>{let{editor:e,engine:t}=F(),[n]=L(e,`selectedEntityId`),r=(0,po.useMemo)(()=>{if(n)return t.root.findEntityByUUID(n)},[t,n]);return r?(0,mo.jsxs)(mo.Fragment,{children:[(0,mo.jsx)(s,{label:`Fields`,accordion:!0,children:(0,mo.jsx)(ma,{target:r})}),(0,mo.jsxs)(s,{label:`Components`,accordion:!0,children:[(0,mo.jsx)(uo,{entity:r}),(0,mo.jsx)(Ga,{entity:r})]})]}):null},ho.__docgenInfo={description:``,methods:[],displayName:`EntityProperty`}})))()}var _o,vo,yo;function bo(){return(bo=t((()=>{_o=`ExportControl__exportControl___LmV4c`,vo=`ExportControl__exportControl_inner___LmV4c`,yo={exportControl:_o,exportControl_inner:vo,export:`ExportControl__export___LmV4c`}})))()}var xo,So,Co;function wo(){return(wo=t((()=>{xo=i(),x(),I(),bo(),So=o(),Co=()=>{let{editor:e}=F(),[t,n]=(0,xo.useState)(null);return(0,xo.useEffect)(()=>{let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),(0,So.jsx)(`div`,{className:yo.exportControl,children:(0,So.jsx)(`div`,{className:yo.exportControl_inner,children:(0,So.jsx)(s,{label:`MP4`,accordion:!0,children:(0,So.jsx)(`div`,{className:yo.export,children:(0,So.jsx)(c,{onClick:()=>{e.isExporting||e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})})})})})},Co.__docgenInfo={description:``,methods:[],displayName:`ExportControl`}})))()}var To,Eo;function Do(){return(Do=t((()=>{To=i(),Eo=(0,To.createContext)(null)})))()}var Oo,ko;function Ao(){return(Ao=t((()=>{Oo=i(),Do(),ko=()=>{let e=(0,Oo.useContext)(Eo);if(e===null)throw Error(`useOREngine must be used within a OREngineProvider`);return e}})))()}var jo,Mo,No,Po,Fo,Io,Lo,Ro,zo,Bo,Vo,Ho,Uo,Wo,Go,Ko,qo,Jo,R;function Yo(){return(Yo=t((()=>{jo=`GPUTimer__container___LmNvb`,Mo=`GPUTimer__headerRow___LmNvb`,No=`GPUTimer__totalTime___LmNvb`,Po=`GPUTimer__toggleButton___LmNvb`,Fo=`GPUTimer__controls___LmNvb`,Io=`GPUTimer__control___LmNvb`,Lo=`GPUTimer__controlLabel___LmNvb`,Ro=`GPUTimer__select___LmNvb`,zo=`GPUTimer__input___LmNvb`,Bo=`GPUTimer__group___LmNvb`,Vo=`GPUTimer__item___LmNvb`,Ho=`GPUTimer__clickable___LmNvb`,Uo=`GPUTimer__itemRow___LmNvb`,Wo=`GPUTimer__itemName___LmNvb`,Go=`GPUTimer__itemTime___LmNvb`,Ko=`GPUTimer__itemStats___LmNvb`,qo=`GPUTimer__progressBar___LmNvb`,Jo=`GPUTimer__progressFill___LmNvb`,R={container:jo,headerRow:Mo,totalTime:No,toggleButton:Po,controls:Fo,control:Io,controlLabel:Lo,select:Ro,input:zo,group:Bo,item:Vo,clickable:Ho,itemRow:Uo,itemName:Wo,itemTime:Go,itemStats:Ko,progressBar:qo,progressFill:Jo}})))()}var Xo,Zo;function Qo(){return(Qo=t((()=>{Xo=class{buffer;index;size;filled;constructor(e){this.size=e,this.buffer=Array(e),this.index=0,this.filled=!1}push(e){this.buffer[this.index]=e,this.index=(this.index+1)%this.size,!this.filled&&this.index===0&&(this.filled=!0)}getAverage(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=0;for(let n=0;n<e;n++)t+=this.buffer[n];return t/e}getMax(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]>t&&(t=this.buffer[n]);return t}getMin(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]<t&&(t=this.buffer[n]);return t}getCount(){return this.filled?this.size:this.index}},Zo=class{buffers;windowSize;currentData;constructor(e=30){this.windowSize=e,this.buffers=new Map,this.currentData=new Map}update(e){let t=performance.now();for(let n=0;n<e.length;n++){let r=e[n],i=r.name.split(`/`),a=i[0]||`unknown`,o,s=i[i.length-1],c=s&&s.match(/\[([^\]]+)\]/);c&&(o=c[1]);let l={name:r.name,duration:r.duration,timestamp:t,renderType:a},u=this.buffers.get(r.name);u||(u=new Xo(this.windowSize),this.buffers.set(r.name,u)),u.push(r.duration),this.currentData.set(r.name,{...l,entityId:o})}}getStatistics(){let e=[],t=0,n=performance.now(),r=[];return this.currentData.forEach((e,t)=>{n-e.timestamp>1e3&&r.push(t)}),r.forEach(e=>{this.currentData.delete(e)}),this.currentData.forEach(e=>{t+=e.duration}),this.currentData.forEach(n=>{let r=this.buffers.get(n.name);r&&e.push({name:n.name,renderType:n.renderType,entityId:n.entityId,current:n.duration,avg:r.getAverage(),max:r.getMax(),min:r.getMin(),samples:r.getCount(),percentage:t>0?n.duration/t*100:0})}),e}getTotalTime(){let e=0;return this.currentData.forEach(t=>{e+=t.duration}),e}}})))()}var $o,z,es,ts,ns,rs;function is(){return(is=t((()=>{$o=i(),Ao(),I(),Yo(),Qo(),z=o(),es=e=>{if(e<2){let t=e/2;return`rgb(${Math.floor(100+t*100)}, 200, 100)`}if(e<5){let t=(e-2)/3;return`rgb(200, ${Math.floor(200-t*50)}, 100)`}if(e<10){let t=(e-5)/5;return`rgb(200, ${Math.floor(150-t*80)}, ${Math.floor(100-t*50)})`}return`rgb(200, 70, 50)`},ts=e=>e>=10?e.toFixed(1):e>=1?e.toFixed(2):e.toFixed(3),ns=e=>e.replace(/\[([^\]]{4,})\]/g,(e,t)=>`[${t.slice(0,3)}]`),rs=()=>{let{editor:e}=F(),{engine:t}=ko(),[n,r]=(0,$o.useState)([]),[i,a]=(0,$o.useState)(0),[o,s]=(0,$o.useState)(`all`),[c,l]=(0,$o.useState)(0),[u,d]=(0,$o.useState)(`time`),[f,p]=(0,$o.useState)(!1),m=(0,$o.useRef)(new Zo(30)),h=(0,$o.useRef)(0),g=(0,$o.useRef)(!1),_=(0,$o.useRef)(0),v=(0,$o.useCallback)(n=>{if(!n)return;let r=t.root.findEntityByUUID(n);r&&e.selectEntity(r)},[t,e]);(0,$o.useEffect)(()=>{let e=t.renderer,n=m.current,i=e=>{f&&(n.update(e),g.current=!0)},o=e=>{g.current&&e-_.current>=300&&(r(n.getStatistics()),a(n.getTotalTime()),g.current=!1,_.current=e),h.current=requestAnimationFrame(o)};return e.on(`timer`,i),h.current=requestAnimationFrame(o),()=>{e.off(`timer`,i),cancelAnimationFrame(h.current)}},[t,f]);let y=n.filter(e=>!(o!==`all`&&e.renderType!==o||e.avg<c)),b=Array.from(new Set(n.map(e=>e.renderType))),x=[...y].sort((e,t)=>u===`time`?t.avg-e.avg:e.name.localeCompare(t.name)),S=i>0?Math.floor(1e3/i):0;return(0,z.jsxs)(`div`,{className:R.container,children:[(0,z.jsxs)(`div`,{className:R.headerRow,children:[(0,z.jsxs)(`span`,{className:R.totalTime,children:[ts(i),`ms (`,S,`fps)`]}),(0,z.jsx)(`button`,{className:R.toggleButton,onClick:()=>p(!f),title:f?`Stop timer`:`Start timer`,children:f?`⏸`:`▶`})]}),(0,z.jsxs)(`div`,{className:R.controls,children:[(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Type`}),(0,z.jsxs)(`select`,{className:R.select,value:o,onChange:e=>s(e.target.value),children:[(0,z.jsx)(`option`,{value:`all`,children:`All`}),b.map(e=>(0,z.jsx)(`option`,{value:e,children:e},e))]})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Min`}),(0,z.jsx)(`input`,{className:R.input,type:`number`,min:`0`,step:`0.1`,value:c,onChange:e=>l(parseFloat(e.target.value)||0)})]}),(0,z.jsxs)(`div`,{className:R.control,children:[(0,z.jsx)(`span`,{className:R.controlLabel,children:`Sort`}),(0,z.jsxs)(`select`,{className:R.select,value:u,onChange:e=>d(e.target.value),children:[(0,z.jsx)(`option`,{value:`time`,children:`Time`}),(0,z.jsx)(`option`,{value:`name`,children:`Name`})]})]})]}),(0,z.jsx)(`div`,{className:R.group,children:x.map((e,t)=>{let n=es(e.avg),r=i>0?e.avg/i*100:0,a=!!e.entityId;return(0,z.jsxs)(`div`,{className:`${R.item} ${a?R.clickable:``}`,onClick:()=>v(e.entityId),children:[(0,z.jsxs)(`div`,{className:R.itemRow,children:[(0,z.jsx)(`span`,{className:R.itemName,title:e.name,children:ns(e.name)}),(0,z.jsx)(`span`,{className:R.itemTime,style:{color:n},children:ts(e.avg)}),(0,z.jsx)(`span`,{className:R.itemStats,children:ts(e.max)})]}),(0,z.jsx)(`div`,{className:R.progressBar,children:(0,z.jsx)(`div`,{className:R.progressFill,style:{width:`${r}%`,backgroundColor:n}})})]},e.name+t)})})]})},rs.__docgenInfo={description:``,methods:[],displayName:`Timer`}})))()}var as,os,ss,cs,ls,us;function ds(){return(ds=t((()=>{as=`Picker__picker___LnBpY`,os=`Picker__picker_label___LnBpY`,ss=`Picker__picker_list___LnBpY`,cs=`Picker__picker_list_inner___LnBpY`,ls=`Picker__item___LnBpY`,us={picker:as,picker_label:os,picker_list:ss,picker_list_inner:cs,item:ls}})))()}var fs,ps;function ms(){return(ms=t((()=>{x(),ds(),fs=o(),ps=e=>(0,fs.jsxs)(`div`,{className:us.picker,"data-no_bg":e.noBg,children:[e.label&&(0,fs.jsx)(`div`,{className:us.picker_label,children:e.label}),(0,fs.jsx)(`div`,{className:us.picker_list,children:(0,fs.jsx)(`div`,{className:us.picker_list_inner,children:e.list.map((e,t)=>(0,fs.jsx)(ee,{className:us.item,onClick:e.onClick,children:e.label},t))})})]}),ps.__docgenInfo={description:``,methods:[],displayName:`Picker`,props:{label:{required:!1,tsType:{name:`string`},description:``},list:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
	label: string,
	onClick?: () => void
}`,signature:{properties:[{key:`label`,value:{name:`string`,required:!0}},{key:`onClick`,value:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}},required:!1}}]}}],raw:`SelectListItem[]`},description:``},noBg:{required:!1,tsType:{name:`boolean`},description:``}}}})))()}var hs,gs,_s;function vs(){return(vs=t((()=>{hs=`InputGroup__group___Lmdyb`,gs=`InputGroup__submit___Lmdyb`,_s={group:hs,submit:gs}})))()}var ys,bs,xs;function Ss(){return(Ss=t((()=>{ys=i(),x(),yi(),vs(),bs=o(),xs=e=>{let t=e.initialValues,n=[],[r,i]=(0,ys.useState)(t);(0,ys.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,bs.jsx)(vi,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,ys.useRef)(null);return(0,ys.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,bs.jsx)(`div`,{className:_s.group,ref:o,children:(0,bs.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,bs.jsx)(s,{label:e.title,noMargin:!0,children:n}),(0,bs.jsx)(`div`,{className:_s.submit,children:(0,bs.jsx)(c,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},xs.__docgenInfo={description:``,methods:[],displayName:`InputGroup`,props:{title:{required:!1,tsType:{name:`string`},description:``},initialValues:{required:!0,tsType:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},description:``},onSubmit:{required:!1,tsType:{name:`signature`,type:`function`,raw:`( values: {[key: string]:ValueType} ) => void`,signature:{arguments:[{type:{name:`signature`,type:`object`,raw:`{[key: string]:ValueType}`,signature:{properties:[{key:{name:`string`},value:{name:`SerializeFieldObjective`,required:!0}}]}},name:`values`}],return:{name:`void`}}},description:``}}}})))()}var Cs,ws,Ts,Es,Ds,Os,ks,As,js,Ms,Ns,Ps;function Fs(){return(Fs=t((()=>{Cs=`HierarchyNode__node___Lm5vZ`,ws=`HierarchyNode__self_name___Lm5vZ`,Ts=`HierarchyNode__icon___Lm5vZ`,Es=`HierarchyNode__selectable___Lm5vZ`,Ds=`HierarchyNode__self___Lm5vZ`,Os=`HierarchyNode__visibility___Lm5vZ`,ks=`HierarchyNode__menu___Lm5vZ`,As=`HierarchyNode__fold___Lm5vZ`,js=`HierarchyNode__fold_button___Lm5vZ`,Ms=`HierarchyNode__child___Lm5vZ`,Ns=`HierarchyNode__child_line___Lm5vZ`,Ps={node:Cs,self_name:ws,icon:Ts,selectable:Es,self:Ds,visibility:Os,menu:ks,fold:As,fold_button:js,child:Ms,child_line:Ns}})))()}var Is,B,Ls;function Rs(){return(Rs=t((()=>{Is=i(),N(),x(),I(),ms(),Ra(),Ss(),ga(),Fs(),B=o(),Ls=e=>{let{editor:t,engine:n}=F(),[r]=L(t,`selectedEntityId`),i=r!==void 0&&n.root.findEntityByUUID(r),o=!!(i&&i.uuid==e.entity.uuid),[s,c]=L(e.entity,`visible`),[m,h]=L(t,`unselectableEntityIds`),[g]=L(e.entity,`children`),_=!(m||[]).includes(e.entity.uuid),v=(g||[]).map(e=>n.root.findEntityByUUID(e)).filter(e=>e!==void 0),y=e.depth||0,b=v&&v.concat().sort((e,t)=>e.name.localeCompare(t.name))||[],x=b.length>0,S=y*20,C=e.entity.initiator==`script`,w=(0,Is.useMemo)(()=>e.entity.getComponent(jt)?(0,B.jsx)(p,{size:14}):e.entity.getComponent(Dt)?(0,B.jsx)(l,{size:14}):e.entity.getComponent(j)?(0,B.jsx)(f,{size:14}):null,[e.entity]),T=e.openNodes.has(e.entity.uuid),te=(0,Is.useCallback)(t=>{e.setNodeOpen(e.entity.uuid,!T),t.stopPropagation()},[T,e]),ne=(0,Is.useCallback)(()=>{t&&t.selectEntity(e.entity)},[t,e.entity]),re=(0,Is.useCallback)(e=>{e.stopPropagation(),c&&c(!s)},[s,c]),ie=(0,Is.useCallback)(t=>{t.stopPropagation();let n=new Set(m||[]);_?n.add(e.entity.uuid):n.delete(e.entity.uuid),h(Array.from(n))},[_,m,h,e.entity.uuid]),{pushContent:ae,closeAll:oe}=La(),se=(0,Is.useCallback)(n=>{n.preventDefault(),!(!t||!ae||!oe||C)&&(t.selectEntity(e.entity),ae((0,B.jsx)(ps,{label:e.entity.name,list:[{label:`Add Entity`,onClick:()=>{ae((0,B.jsx)(xs,{initialValues:{name:``},onSubmit:n=>{let r=t.api.createEntity(e.entity,n.name);t.api.selectEntity(r),oe()}}))}},{label:`Delete Entity`,onClick:()=>{t.api.deleteEntity(e.entity),oe()}}]})))},[t,e.entity,ae,oe,C]);return(0,B.jsxs)(`div`,{className:Ps.node,"data-no_export":C,children:[(0,B.jsxs)(ee,{className:Ps.self,style:{paddingLeft:S},onClick:ne,onContextMenu:se,selected:o,children:[(0,B.jsx)(`div`,{className:Ps.fold,"data-hnode_open":T,children:x&&(0,B.jsx)(`button`,{className:Ps.fold_button,onClick:te,children:(0,B.jsx)(a,{open:T})})}),w&&(0,B.jsx)(`div`,{className:Ps.icon,children:w}),(0,B.jsx)(`div`,{className:Ps.self_name,children:(0,B.jsx)(`p`,{children:e.entity.name||`-`})}),(0,B.jsx)(`button`,{className:Ps.selectable,onClick:ie,"data-selectable":_,children:(0,B.jsx)(u,{size:14,selectable:_})}),(0,B.jsx)(`button`,{className:Ps.visibility,onClick:re,"data-visible":s!==!1,children:(0,B.jsx)(d,{size:14,visible:s!==!1})}),!C&&(0,B.jsx)(`button`,{className:Ps.menu,onClick:se,children:`⋯`})]}),x&&(0,B.jsxs)(`div`,{className:Ps.child,"data-open":T,children:[b.map(t=>(0,B.jsx)(Ls,{entity:t,depth:y+1,openNodes:e.openNodes,setNodeOpen:e.setNodeOpen},t.uuid)),(0,B.jsx)(`div`,{className:Ps.child_line,style:{marginLeft:S+4}})]})]})},Ls.__docgenInfo={description:``,methods:[],displayName:`HierarchyNode`,props:{depth:{required:!1,tsType:{name:`number`},description:``},entity:{required:!0,tsType:{name:`MXP.Entity`},description:``},openNodes:{required:!0,tsType:{name:`Set`,elements:[{name:`string`}],raw:`Set<string>`},description:``},setNodeOpen:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( uuid: string, open: boolean ) => void`,signature:{arguments:[{type:{name:`string`},name:`uuid`},{type:{name:`boolean`},name:`open`}],return:{name:`void`}}},description:``}}}})))()}var zs;function Bs(){return(Bs=t((()=>{zs={}})))()}var Vs,Hs,Us,Ws,Gs,Ks;function qs(){return(qs=t((()=>{Vs=i(),I(),ga(),Rs(),Bs(),Hs=o(),Us=`hierarchyOpenNodes`,Ws=()=>{try{let e=localStorage.getItem(Us);if(e)return new Set(JSON.parse(e))}catch{}return new Set},Gs=e=>{localStorage.setItem(Us,JSON.stringify(Array.from(e)))},Ks=()=>{let{editor:e,engine:t}=F(),[n]=L(e,`selectedEntityId`),r=t.root,[i,a]=(0,Vs.useState)(Ws),o=(0,Vs.useCallback)((e,t)=>{a(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),Gs(r),r})},[]);return(0,Vs.useEffect)(()=>{if(!n)return;let e=r.findEntityByUUID(n);if(!e)return;let t=[],i=e.parent;for(;i;)t.push(i.uuid),i=i.parent;a(e=>{if(t.every(t=>e.has(t)))return e;let n=new Set(e);return t.forEach(e=>n.add(e)),Gs(n),n})},[n,r]),(0,Hs.jsx)(`div`,{className:zs.hierarchy,children:r&&(0,Hs.jsx)(Ls,{entity:r,openNodes:i,setNodeOpen:o})})},Ks.__docgenInfo={description:``,methods:[],displayName:`Hierarchy`}})))()}var Js,Ys,Xs,Zs,Qs,$s;function ec(){return(ec=t((()=>{Js=`MouseMenu__mouseMenu___Lm1vd`,Ys=`MouseMenu__hide___Lm1vd`,Xs=`MouseMenu__menuItem___Lm1vd`,Zs=`MouseMenu__menuItem_inner___Lm1vd`,Qs=`MouseMenu__menuItem_inner_inner___Lm1vd`,$s={mouseMenu:Js,hide:Ys,menuItem:Xs,menuItem_inner:Zs,menuItem_inner_inner:Qs}})))()}var tc,nc;function rc(){return(rc=t((()=>{ya(),Ra(),ec(),tc=o(),nc=()=>{let{itemList:e,containerRef:t,closeAll:n}=La();return(0,tc.jsxs)(`div`,{className:$s.mouseMenu,ref:t,children:[e&&e.length>0&&(0,tc.jsx)(`div`,{className:$s.hide,onClick:()=>{n&&n()}}),e&&e.map(e=>{let t=e.pos;return(0,tc.jsx)(va.Provider,{value:e,children:(0,tc.jsx)(`div`,{className:$s.menuItem,style:{left:0,top:0,transform:`translate(${t.x}px, ${t.y}px)`},children:(0,tc.jsx)(`div`,{className:$s.menuItem_inner,children:(0,tc.jsx)(`div`,{className:$s.menuItem_inner_inner,"data-direction":e.direction,children:e.elm})})})},e.id)})]})},nc.__docgenInfo={description:``,methods:[],displayName:`MouseMenu`}})))()}var ic,ac,oc;function sc(){return(sc=t((()=>{ic=i(),ac=0,oc=()=>{let e=(0,ic.useRef)(null),t=(0,ic.useRef)({x:0,y:0}),n=(0,ic.useCallback)(e=>{t.current.x=e.clientX,t.current.y=e.clientY},[]);(0,ic.useEffect)(()=>(window.addEventListener(`pointermove`,n),()=>{window.removeEventListener(`pointermove`,n)}),[n]);let[r,i]=(0,ic.useState)([]),a=(0,ic.useRef)(r);a.current=r;let o=(0,ic.useCallback)(e=>{a.current=a.current.filter(t=>t.id!==e),i(a.current)},[]),s=(0,ic.useCallback)(()=>{i([])},[]);return{itemList:r,pushContent:(0,ic.useCallback)(e=>{let n=ac++,r={x:t.current.x,y:t.current.y},s={id:n,elm:e,pos:r,direction:(r.x<window.innerWidth/2?`right`:`left`)+`-`+(r.y<window.innerHeight/2?`bottom`:`top`),close:()=>o(n)};return i([...a.current,s]),s},[o]),closeAll:s,containerRef:e}}})))()}var cc,lc;function uc(){return(uc=t((()=>{Fa(),sc(),cc=o(),lc=e=>{let t=oc();return(0,cc.jsx)(Pa.Provider,{value:t,children:e.children})},lc.__docgenInfo={description:``,methods:[],displayName:`MouseMenuProvider`}})))()}var dc,fc;function pc(){return(pc=t((()=>{dc=`Canvas__container___LmNvb`,fc={container:dc}})))()}var mc,hc,gc;function _c(){return(_c=t((()=>{mc=i(),I(),pc(),hc=o(),gc=({viewportId:e})=>{let{engine:t,editor:n}=F(),r=(0,mc.useRef)(null);return(0,mc.useEffect)(()=>{let i=r.current;if(!t||!i)return;let a=n.createViewport(e,i);return()=>{a.dispose()}},[t,n,e]),(0,hc.jsx)(`div`,{className:fc.container,role:`presentation`,"aria-label":`3D Canvas`,children:(0,hc.jsx)(`canvas`,{ref:r})})},gc.__docgenInfo={description:``,methods:[],displayName:`Canvas`}})))()}var vc,yc;function bc(){return(bc=t((()=>{vc=`AudioView__audioView___LmF1Z`,yc={audioView:vc}})))()}var xc;function Sc(){return(Sc=t((()=>{Qe(),O(),xc=class extends Je{wrapperElm;canvas;canvasCtx;viewRangeFrame;viewPort;viewPortRange;musicBuffer;resizeObserver;frameSetting;framePlay;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0];let e=window.localStorage.getItem(`audioViweRange`);this.viewRangeFrame=e?Number(e):2,this.frameSetting={duration:0,fps:60},this.framePlay={current:0,playing:!1},this.musicBuffer=null,this.resizeObserver=new ResizeObserver(this.onResize.bind(this))}onResize(){if(this.wrapperElm){let e=new E(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);this.canvas.width=e.x,this.canvas.height=e.y}this.render()}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.musicBuffer){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)]*1,s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]*1+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}this.canvasCtx.fillStyle=`#555`,this.canvasCtx.fillRect(this.canvas.width/2,0,1,this.canvas.height)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.canvas),this.onResize()}setFramePlaying(e){this.framePlay=e,this.viewPort=[this.framePlay.current-this.viewRangeFrame,0,this.framePlay.current+this.viewRangeFrame,0],this.viewPortRange=[this.viewPort[2]-this.viewPort[0],this.viewPort[3]-this.viewPort[1]],this.render()}setViewRangeFrame(e){this.viewRangeFrame=e,this.setFramePlaying(this.framePlay),localStorage.setItem(`audioViweRange`,String(this.viewRangeFrame))}setFrameSetting(e){this.frameSetting=e,this.render()}setMusicBuffer(e){this.musicBuffer=e,this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.canvas),this.resizeObserver.disconnect()}},xc.__docgenInfo={description:``,methods:[{name:`setWrapperElm`,docblock:null,modifiers:[],params:[{name:`elm`,optional:!1,type:{name:`HTMLElement`,alias:`HTMLElement`}}],returns:null},{name:`setFramePlaying`,docblock:null,modifiers:[],params:[{name:`frame`,optional:!1,type:{name:`FramePlay`,alias:`FramePlay`}}],returns:null},{name:`setViewRangeFrame`,docblock:null,modifiers:[],params:[{name:`rangeFrame`,optional:!1,type:{name:`number`}}],returns:null},{name:`setFrameSetting`,docblock:null,modifiers:[],params:[{name:`frameSetting`,optional:!1,type:{name:`OREngineProjectFrame`,alias:`OREngineProjectFrame`}}],returns:null},{name:`setMusicBuffer`,docblock:null,modifiers:[],params:[{name:`buffer`,optional:!1,type:{name:`AudioBuffer`,alias:`AudioBuffer`}}],returns:null},{name:`dispose`,docblock:null,modifiers:[],params:[],returns:null}],displayName:`AudioViewRenderer`}})))()}var Cc,wc,Tc;function Ec(){return(Ec=t((()=>{Cc=i(),I(),bc(),Sc(),wc=o(),Tc=()=>{let{editor:e}=F(),t=(0,Cc.useRef)(null),[n,r]=(0,Cc.useState)();(0,Cc.useEffect)(()=>{let e=new xc;if(r(e),t.current)return e.setWrapperElm(t.current),()=>{e.dispose()}},[]);let i=e&&e.audioBuffer,[a,o]=(0,Cc.useState)(),[s,c]=(0,Cc.useState)({duration:0,fps:0}),[l,u]=(0,Cc.useState)({current:0,playing:!1});(0,Cc.useEffect)(()=>{if(!e)return;let t=e.engine,n=e=>{c({duration:e[`timeline/duration`],fps:e[`timeline/fps`]})},r=0,i=()=>{o(r++)},a=e=>{u({...e})};return n(t.serialize()),a(t.frame),t.on(`fields/update`,n),t.on(`update/music`,i),t.on(`update/frame/play`,a),()=>{t.off(`update/frame/setting`,n),t.off(`update/music`,i),t.off(`update/frame/play`,a)}},[e]),(0,Cc.useEffect)(()=>{n&&i&&n.setMusicBuffer(i)},[n,i,a]),(0,Cc.useEffect)(()=>{n&&l&&n.setFramePlaying(l)},[n,l]),(0,Cc.useEffect)(()=>{n&&s&&n.setFrameSetting(s)},[n,s]);let d=(0,Cc.useCallback)(e=>{if(n){let t=e.deltaY>0?1.1:.9;n.setViewRangeFrame(n.viewRangeFrame*t)}e.preventDefault()},[n]);return(0,Cc.useEffect)(()=>{let e=t.current;return e&&e.addEventListener(`wheel`,d,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,d)}},[d]),(0,wc.jsx)(`div`,{className:yc.audioView,ref:t})},Tc.__docgenInfo={description:``,methods:[],displayName:`AudioView`}})))()}var Dc,Oc,kc;function Ac(){return(Ac=t((()=>{Dc=`CameraPad__cameraPad___LmNhb`,Oc=`CameraPad__btn___LmNhb`,kc={cameraPad:Dc,btn:Oc}})))()}var jc,Mc;function Nc(){return(Nc=t((()=>{I(),ga(),Ac(),jc=o(),Mc=()=>{let{editor:e}=F(),[t]=L(e,`selectedEntityId`);return(0,jc.jsxs)(`div`,{className:kc.cameraPad,children:[(0,jc.jsx)(`div`,{className:kc.btn,"data-disabled":!t,onClick:()=>{t&&e.focusSelected()},title:`Focus selected ( . )`,children:`Focus`}),(0,jc.jsx)(`div`,{className:kc.btn,onClick:()=>{e.syncToSceneCamera()},title:`Move to scene camera ( Esc )`,children:`Scene Cam`})]})},Mc.__docgenInfo={description:``,methods:[],displayName:`CameraPad`}})))()}var Pc,Fc,Ic,Lc,Rc,zc,Bc,Vc,Hc,Uc,Wc,Gc,Kc,qc,Jc,Yc,Xc,Zc,Qc,$c,el,V;function tl(){return(tl=t((()=>{Pc=`Screen__screen___LnNjc`,Fc=`Screen__header___LnNjc`,Ic=`Screen__header_tabs___LnNjc`,Lc=`Screen__header_tab___LnNjc`,Rc=`Screen__header_right___LnNjc`,zc=`Screen__header_item___LnNjc`,Bc=`Screen__content___LnNjc`,Vc=`Screen__gizmoMode___LnNjc`,Hc=`Screen__gizmoMode_btn___LnNjc`,Uc=`Screen__gizmoMode_separator___LnNjc`,Wc=`Screen__modalStatus___LnNjc`,Gc=`Screen__canvas___LnNjc`,Kc=`Screen__audioViewHandle___LnNjc`,qc=`Screen__audioView___LnNjc`,Jc=`Screen__displayOptions___LnNjc`,Yc=`Screen__displayOptions_btn___LnNjc`,Xc=`Screen__overlay___LnNjc`,Zc=`Screen__overlay_field___LnNjc`,Qc=`Screen__overlay_label___LnNjc`,$c=`Screen__overlay_separator___LnNjc`,el=`Screen__externalBtn___LnNjc`,V={screen:Pc,header:Fc,header_tabs:Ic,header_tab:Lc,header_right:Rc,header_item:zc,content:Bc,gizmoMode:Vc,gizmoMode_btn:Hc,gizmoMode_separator:Uc,modalStatus:Wc,canvas:Gc,audioViewHandle:Kc,audioView:qc,displayOptions:Jc,displayOptions_btn:Yc,overlay:Xc,overlay_field:Zc,overlay_label:Qc,overlay_separator:$c,externalBtn:el}})))()}var nl,H,rl,il;function al(){return(al=t((()=>{nl=i(),x(),ge(),I(),Oi(),_c(),yi(),ga(),Ec(),Nc(),tl(),H=o(),rl=`viewport`,il=({viewportId:e})=>{let{editor:t}=F(),n=he(),[r,i]=L(t,`enableRender`),[a,o]=L(t,`viewports/${e}/preview`),[s,l]=L(t,`viewType`),[u,d]=L(t,`resolutionScale`),[f,p]=L(t,`gizmoMode`),[m,h]=L(t,`transformOrientation`),[g]=L(t,`modalStatus`),[_,v]=L(t,`helpers/show`),[y,b]=L(t,`helpers/empty`),[x,S]=L(t,`helpers/camera`),[C,T]=L(t,`helpers/light`),[ee,te]=L(t,`helpers/grid`),[ne,re]=L(t,`helpers/wireframe`),[ie,ae]=L(t,`helpers/gizmo`),[oe,se]=L(t,`helpers/outline`),[ce]=Di(`showAudioView`),[le,ue]=(0,nl.useState)(50),de=(0,nl.useRef)(null),[fe,pe]=(0,nl.useState)(!1),me=(0,nl.useRef)(null),ge=(0,nl.useCallback)(e=>{me.current&&!me.current.contains(e.target)&&pe(!1)},[]);return(0,nl.useEffect)(()=>(fe&&document.addEventListener(`pointerdown`,ge),()=>{document.removeEventListener(`pointerdown`,ge)}),[fe,ge]),(0,H.jsxs)(`div`,{className:V.screen,children:[(0,H.jsxs)(`div`,{className:V.header,children:[(0,H.jsx)(`div`,{className:V.header_tabs,children:(0,H.jsx)(`div`,{className:V.header_tab,"data-active":!!a,onClick:()=>o&&o(!a),title:`Camera Render`,children:(0,H.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 512 512`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,H.jsx)(`path`,{d:`M32 144 H336 V368 H32 Z M368 224 L480 152 V360 L368 288 Z`})})})}),(0,H.jsxs)(`div`,{className:V.header_right,children:[(0,H.jsx)(`div`,{className:V.header_item,children:(0,H.jsx)(w,{title:`View`,children:(0,H.jsx)(vi,{value:s,format:{type:`select`,list:[`render`,`debug`]},onChange:e=>l&&l(e)})})}),(0,H.jsx)(`div`,{className:V.header_item,children:(0,H.jsx)(w,{title:`Res`,children:(0,H.jsx)(vi,{value:u,format:{type:`select`,list:[,,,,,,].fill(0).map((e,t)=>{let n=2**t,r=1/n;return{value:r,label:r==1?`1`:`1/`+n}})},onChange:e=>d&&d(e)})})}),n.isPC&&(0,H.jsx)(`div`,{className:V.externalBtn,children:(0,H.jsx)(c,{onClick:()=>{t.openInExternalWindow()},children:(0,H.jsxs)(`svg`,{width:`32`,height:`12`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,H.jsxs)(`g`,{clipPath:`url(#clip0_224_2)`,children:[(0,H.jsx)(`path`,{d:`M96 0V416H512V0H96ZM472 376H136V40H472V376Z`,fill:`#aaa`}),(0,H.jsx)(`path`,{d:`M40 472V296V136V96H0V512H416V472H376H40Z`,fill:`#aaa`}),(0,H.jsx)(`path`,{d:`M232.812 312.829L350.671 194.969V279.766H390.671V126.688H237.594V166.688H322.39L204.531 284.547L232.812 312.829Z`,fill:`#aaa`})]}),(0,H.jsx)(`defs`,{children:(0,H.jsx)(`clipPath`,{id:`clip0_224_2`,children:(0,H.jsx)(`rect`,{width:`512`,height:`512`,fill:`white`})})})]})})})]})]}),(0,H.jsxs)(`div`,{className:V.content,children:[(0,H.jsxs)(`div`,{className:V.displayOptions,ref:me,children:[(0,H.jsx)(`div`,{className:V.displayOptions_btn,"data-active":fe,onClick:()=>pe(!fe),title:`Display Options`,children:`⚙`}),fe&&(0,H.jsxs)(`div`,{className:V.overlay,children:[(0,H.jsx)(`div`,{className:V.overlay_label,children:`Rendering`}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(w,{title:`Render`,children:(0,H.jsx)(vi,{value:r,onChange:e=>i&&i(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_separator}),(0,H.jsx)(`div`,{className:V.overlay_label,children:`Helpers`}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(w,{title:`Show`,children:(0,H.jsx)(vi,{value:_,onChange:e=>v&&v(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(w,{title:`Empty`,children:(0,H.jsx)(vi,{value:y,onChange:e=>b&&b(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(w,{title:`Camera`,children:(0,H.jsx)(vi,{value:x,onChange:e=>S&&S(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,"data-indent":`true`,children:(0,H.jsx)(w,{title:`Light`,children:(0,H.jsx)(vi,{value:C,onChange:e=>T&&T(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_separator}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(w,{title:`Grid`,children:(0,H.jsx)(vi,{value:ee,onChange:e=>te&&te(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(w,{title:`Wireframe`,children:(0,H.jsx)(vi,{value:ne,onChange:e=>re&&re(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(w,{title:`Gizmo`,children:(0,H.jsx)(vi,{value:ie,onChange:e=>ae&&ae(e)})})}),(0,H.jsx)(`div`,{className:V.overlay_field,children:(0,H.jsx)(w,{title:`Outline`,children:(0,H.jsx)(vi,{value:oe,onChange:e=>se&&se(e)})})})]})]}),(0,H.jsxs)(`div`,{className:V.gizmoMode,children:[[`select`,`translate`,`rotate`,`scale`].map(e=>(0,H.jsx)(`div`,{className:V.gizmoMode_btn,"data-active":f===e,onClick:()=>p&&p(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`select`?`↖`:e===`translate`?`T`:e===`rotate`?`R`:`S`},e)),(0,H.jsx)(`div`,{className:V.gizmoMode_separator}),[`global`,`local`].map(e=>(0,H.jsx)(`div`,{className:V.gizmoMode_btn,"data-active":m===e,onClick:()=>h&&h(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`global`?`G`:`L`},e))]}),g&&(0,H.jsx)(`div`,{className:V.modalStatus,children:g}),(0,H.jsx)(`div`,{className:V.canvas,children:(0,H.jsx)(gc,{viewportId:e})}),n.isSP&&(0,H.jsx)(Mc,{}),n.isPC&&ce&&(0,H.jsxs)(H.Fragment,{children:[(0,H.jsx)(`div`,{className:V.audioViewHandle,onPointerDown:e=>{e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),de.current={startY:e.clientY,startHeight:le}},onPointerMove:e=>{if(!de.current)return;let t=de.current.startY-e.clientY,n=Math.max(20,Math.min(400,de.current.startHeight+t));ue(n)},onPointerUp:()=>{de.current=null}}),(0,H.jsx)(`div`,{className:V.audioView,style:{height:le},children:(0,H.jsx)(Tc,{})})]})]})]})},il.__docgenInfo={description:``,methods:[],displayName:`Screen`}})))()}function ol(e,t){let n=e.get(t);if(n)return n;let r=t.indexOf(`:`);if(r===-1)return;let i=e.get(t.slice(0,r));return i?.multiple?i:void 0}function sl(e){return e.slice(e.indexOf(`:`)+1)}function cl(e){return e.multiple?`${e.id}:${Xe.genUUID()}`:e.id}function ll(e,t){return e.multiple?e.content(sl(t)):e.content}function ul(){return yl(`vertical`,[{ratio:916/1076,node:yl(`horizontal`,[{ratio:300/1912,node:yl(`vertical`,[{ratio:696/912,node:bl([`hierarchy`,`scene`])},{ratio:216/912,node:bl([`timer`])}])},{ratio:1312/1912,node:bl([`viewport:main`])},{ratio:300/1912,node:bl([`property`,`textures`,`renderer`,`editor-settings`])}])},{ratio:160/1076,node:bl([`timeline`,`export`])}])}function dl(e){return e.type===`pane`?[e]:e.children.flatMap(e=>dl(e.node))}function fl(e,t){let n=new Set,r=new Set,i=e=>{let t=typeof e==`string`&&e!==``&&!n.has(e)?e:Xe.genUUID();return n.add(t),t},a=e=>{if(typeof e!=`object`||!e)return null;let n=e;if(n.type===`pane`){if(!Array.isArray(n.tabs))return null;let e=[...new Set(n.tabs.filter(e=>typeof e==`string`))].filter(e=>{let n=t(e);return n?!n.multiple||!r.has(e)&&(r.add(e),!0):!1});if(e.length===0)return null;let a=typeof n.active==`string`&&e.includes(n.active)?n.active:e[0];return{type:`pane`,id:i(n.id),tabs:e,active:a}}if(n.type===`split`){if(n.direction!==`horizontal`&&n.direction!==`vertical`||!Array.isArray(n.children))return null;let e=[];return n.children.forEach(t=>{if(typeof t!=`object`||!t)return;let n=t,r=a(n.node);if(!r)return;let i=typeof n.ratio==`number`&&isFinite(n.ratio)&&n.ratio>0?n.ratio:1;e.push({ratio:i,node:r})}),e.length===0?null:e.length===1?e[0].node:{type:`split`,id:i(n.id),direction:n.direction,children:e}}return null},o=a(e);return o?xl(o):null}function pl(e,t,n){return Sl(e,t,e=>e.type!==`pane`||!e.tabs.includes(n)?e:{...e,active:n})}function ml(e,t,n,r){return Sl(e,t,e=>{if(e.type!==`pane`||e.tabs.includes(n))return e;let t=[...e.tabs];return t.splice(Math.max(0,Math.min(r??t.length,t.length)),0,n),{...e,tabs:t,active:n}})}function hl(e,t,n,r,i){if(t===r)return Sl(e,t,e=>{if(e.type!==`pane`)return e;let t=e.tabs.indexOf(n);if(t===-1)return e;let r=e.tabs.filter(e=>e!==n),a=i??e.tabs.length,o=Math.max(0,Math.min(t<a?a-1:a,r.length));return o===t?e:(r.splice(o,0,n),{...e,tabs:r,active:n})});let a=dl(e),o=a.find(e=>e.id===t),s=a.find(e=>e.id===r);return!o||!s||!o.tabs.includes(n)||s.tabs.includes(n)?e:ml(_l(e,t,n),r,n,i)}function gl(e,t,n,r,i){let a=dl(e),o=a.find(e=>e.id===r);if(!o||!o.tabs.includes(i)||!a.some(e=>e.id===t)||r===t&&o.tabs.length===1)return e;let s=_l(e,r,i),c={type:`pane`,id:Xe.genUUID(),tabs:[i],active:i},l=Sl(s,t,e=>{let t=[{ratio:.5,node:c},{ratio:.5,node:e}];return(n===`right`||n===`bottom`)&&t.reverse(),{type:`split`,id:Xe.genUUID(),direction:n===`left`||n===`right`?`horizontal`:`vertical`,children:t}});return l===s?e:xl(l)??e}function _l(e,t,n){let r=Sl(e,t,e=>{if(e.type!==`pane`||!e.tabs.includes(n))return e;let t=e.tabs.indexOf(n),r=e.tabs.filter(e=>e!==n),i=e.active!==n||r.length===0?e.active:r[Math.min(t,r.length-1)];return{...e,tabs:r,active:i}});return r===e?e:xl(r)??e}function vl(e,t,n){return Sl(e,t,e=>e.type!==`split`||e.children.length!==n.length?e:{...e,children:e.children.map((e,t)=>({...e,ratio:n[t]}))})}var yl,bl,xl,Sl;function Cl(){return(Cl=t((()=>{Qe(),yl=(e,t)=>({type:`split`,id:Xe.genUUID(),direction:e,children:t}),bl=e=>({type:`pane`,id:Xe.genUUID(),tabs:e,active:e[0]}),xl=e=>{if(e.type===`pane`)return e.tabs.length>0?e:null;let t=[];if(e.children.forEach(n=>{let r=xl(n.node);r&&(r.type===`split`&&r.direction===e.direction?r.children.forEach(e=>t.push({ratio:n.ratio*e.ratio,node:e.node})):t.push(r===n.node?n:{...n,node:r}))}),t.length===0)return null;if(t.length===1)return t[0].node;let n=t.reduce((e,t)=>e+t.ratio,0);return Math.abs(n-1)>1e-6?{...e,children:t.map(e=>({...e,ratio:e.ratio/n}))}:t.length!==e.children.length||t.some((t,n)=>t!==e.children[n])?{...e,children:t}:e},Sl=(e,t,n)=>{if(e.id===t)return n(e);if(e.type===`split`){let r=!1,i=e.children.map(e=>{let i=Sl(e.node,t,n);return i===e.node?e:(r=!0,{...e,node:i})});if(r)return{...e,children:i}}return e}})))()}function wl(e,t,n){let[r,i]=(0,Tl.useState)(null),a=(0,Tl.useRef)(e);a.current=e;let o=(0,Tl.useRef)(t);o.current=t;let s=(0,Tl.useRef)(null);return(0,Tl.useEffect)(()=>()=>s.current?.(),[]),{dragState:r,onTabPointerDown:(e,t,r)=>{if(r.button!==0||s.current)return;let c=r.clientX,l=r.clientY,u=!1,d=null,f=r=>{if(r.buttons===0){p(!1);return}if(!u){if(Math.hypot(r.clientX-c,r.clientY-l)<El)return;u=!0,i({panelId:t,title:n(t)?.title??t,startX:r.clientX,startY:r.clientY,target:null})}let o=Al(r.clientX,r.clientY,a.current,e,t);jl(o,d)||(d=o,i(e=>e&&{...e,target:o}))},p=n=>{if(g(),n&&u&&d){let n=a.current;d.kind===`tabs`?o.current(hl(n,e,t,d.paneId,d.index)):d.zone===`center`?o.current(hl(n,e,t,d.paneId)):o.current(gl(n,d.paneId,d.zone,e,t))}u&&i(null)},m=()=>p(!0),h=()=>p(!1),g=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),s.current=null};s.current=g,window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h)}}}var Tl,El,Dl,Ol,kl,Al,jl;function Ml(){return(Ml=t((()=>{Tl=i(),Cl(),El=4,Dl=.25,Ol=(e,t)=>{let n={left:e.left,top:e.top,width:e.width,height:e.height};return(t===`left`||t===`right`)&&(n.width/=2),t===`right`&&(n.left+=n.width),(t===`top`||t===`bottom`)&&(n.height/=2),t===`bottom`&&(n.top+=n.height),n},kl=(e,t,n,r,i)=>{if(n.id!==r&&n.tabs.includes(i))return null;let a=[...t.querySelectorAll(`[data-panel-tab-id]`)].filter(e=>e instanceof HTMLElement),o=a.length;for(let t=0;t<a.length;t++){let n=a[t].getBoundingClientRect();if(e<n.left+n.width/2){o=t;break}}let s=t.getBoundingClientRect(),c=o<a.length?a[o].getBoundingClientRect().left:a.length>0?a[a.length-1].getBoundingClientRect().right:s.left;return{kind:`tabs`,paneId:n.id,index:o,rect:{left:c-1,top:s.top,width:2,height:s.height}}},Al=(e,t,n,r,i)=>{let a=document.elementFromPoint(e,t);if(!a)return null;let o=a.closest(`[data-pane-id]`);if(!(o instanceof HTMLElement))return null;let s=dl(n).find(e=>e.id===o.dataset.paneId);if(!s)return null;let c=a.closest(`[data-panel-tab-header]`);if(c instanceof HTMLElement)return kl(e,c,s,r,i);let l=o.querySelector(`[data-panel-content]`);if(!(l instanceof HTMLElement))return null;let u=l.getBoundingClientRect();if(u.width<=0||u.height<=0)return null;let d=(e-u.left)/u.width,f=(t-u.top)/u.height;if(d<0||d>1||f<0||f>1)return null;if(Math.min(d,1-d)>Dl&&Math.min(f,1-f)>Dl)return s.id===r||s.tabs.includes(i)?null:{kind:`zone`,paneId:s.id,zone:`center`,rect:Ol(u,`center`)};if(s.id===r&&s.tabs.length===1)return null;let p=d-.5,m=f-.5,h=Math.abs(p)>=Math.abs(m)?p<0?`left`:`right`:m<0?`top`:`bottom`;return{kind:`zone`,paneId:s.id,zone:h,rect:Ol(u,h)}},jl=(e,t)=>e===null||t===null?e===t:e.paneId===t.paneId?e.kind===`tabs`&&t.kind===`tabs`?e.index===t.index:e.kind===`zone`&&t.kind===`zone`&&e.zone===t.zone:!1})))()}var Nl,Pl;function Fl(){return(Fl=t((()=>{Nl=`PanelLayout__pane___LnBhb`,Pl={pane:Nl}})))()}function Il(e,t){let n=[];for(let r of e){let e=n;if(r.category)for(let t of r.category.split(`/`)){if(t===``)continue;let n;for(let r of e)if(r.label===t&&`children`in r){n=r;break}n||(n={label:t,children:[]},e.push(n)),e=n.children}e.push({label:r.title,onClick:()=>t(r)})}return n}var Ll,Rl,zl,Bl;function Vl(){return(Vl=t((()=>{Ll=i(),x(),I(),ms(),Ma(),Ra(),al(),ga(),re(),Ml(),Fl(),Cl(),Rl=o(),zl=e=>{let t=e.node;if(t.type===`split`)return(0,Rl.jsx)(T,{direction:t.direction,ratios:t.children.map(e=>e.ratio),onRatiosChange:n=>e.onRatiosChange(t.id,n),children:t.children.map(t=>(0,Rl.jsx)(T.Item,{children:(0,Rl.jsx)(zl,{...e,node:t.node})},t.node.id))});let n=t.tabs.flatMap(t=>{let n=e.resolve(t);return n?[{id:t,title:n.title,content:ll(n,t)}]:[]});if(n.length===0)return null;let r=e.hasAddable(t);return(0,Rl.jsx)(`div`,{className:Pl.pane,"data-pane-id":t.id,children:(0,Rl.jsx)(ne,{tabs:n,active:t.active,onSelect:n=>e.onSelectTab(t.id,n),onTabContextMenu:(n,r)=>e.onTabContextMenu(t.id,n,r),onTabPointerDown:(n,r)=>e.onTabPointerDown(t.id,n,r),onAddClick:r?()=>e.onAddTab(t.id):void 0})})},Bl=e=>{let{editor:t}=F(),{pushContent:n,closeAll:r}=La(),i=(0,Ll.useMemo)(()=>{let t=new Map;return e.panels.forEach(e=>t.set(e.id,e)),t},[e.panels]),a=(0,Ll.useMemo)(()=>e=>ol(i,e),[i]),[o,s]=L(t,`panelLayout`),c=(0,Ll.useMemo)(()=>fl(o,a)??ul(),[o,a]);(0,Ll.useEffect)(()=>{let e=new Set(dl(c).flatMap(e=>e.tabs).filter(e=>a(e)?.id===rl).map(sl));t.pruneViewportSettings(e)},[c,a,t]);let l=e=>{e!==c&&s(e)},u=(e,t)=>l(pl(c,e,t)),d=(e,t)=>l(vl(c,e,t)),{dragState:f,onTabPointerDown:p}=wl(c,l,a),m=e=>[...i.values()].filter(t=>t.multiple||!e.tabs.includes(t.id));return(0,Rl.jsxs)(Rl.Fragment,{children:[(0,Rl.jsx)(zl,{node:c,resolve:a,onSelectTab:u,onRatiosChange:d,onTabContextMenu:(e,t,i)=>{i.preventDefault(),dl(c).reduce((e,t)=>e+t.tabs.length,0)>1&&n((0,Rl.jsx)(ps,{label:a(t)?.title,list:[{label:`Close Tab`,onClick:()=>{l(_l(c,e,t)),r()}}]}))},onTabPointerDown:p,onAddTab:e=>{let t=dl(c).find(t=>t.id===e);if(!t)return;let i=m(t);if(i.length===0)return;let a=Il(i,t=>{l(ml(c,e,cl(t))),r()});n((0,Rl.jsx)(ja,{items:a}))},hasAddable:e=>m(e).length>0}),f&&(0,Rl.jsx)(ie,{drag:f})]})},Bl.__docgenInfo={description:``,methods:[],displayName:`PanelLayout`,props:{panels:{required:!0,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}var Hl,Ul,Wl;function Gl(){return(Gl=t((()=>{Hl=`RendererSettings__renderer___LnJlb`,Ul=`RendererSettings__renderer_inner___LnJlb`,Wl={renderer:Hl,renderer_inner:Ul}})))()}var Kl,ql;function Jl(){return(Jl=t((()=>{x(),I(),ha(),Gl(),Kl=o(),ql=()=>{let{editor:e}=F(),t=e.engine.renderer;return(0,Kl.jsx)(`div`,{className:Wl.renderer,children:(0,Kl.jsxs)(`div`,{className:Wl.renderer_inner,children:[(0,Kl.jsx)(s,{label:`Resolution`,accordion:!0,children:(0,Kl.jsx)(ma,{target:e,filter:`resolution`})}),(0,Kl.jsx)(s,{label:`Pipeline`,accordion:!0,children:(0,Kl.jsx)(ma,{target:t,filter:`pipeline`})}),(0,Kl.jsx)(s,{label:`Sky`,accordion:!0,children:(0,Kl.jsx)(ma,{target:t,filter:`sky`})})]})})},ql.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var Yl,Xl,Zl,Ql,$l,eu;function tu(){return(tu=t((()=>{Yl=`SceneControl__sceneControl___LnNjZ`,Xl=`SceneControl__sceneControl_inner___LnNjZ`,Zl=`SceneControl__select___LnNjZ`,Ql=`SceneControl__select_name___LnNjZ`,$l=`SceneControl__save___LnNjZ`,eu={sceneControl:Yl,sceneControl_inner:Xl,select:Zl,select_name:Ql,save:$l}})))()}var nu,ru,iu;function au(){return(au=t((()=>{nu=i(),x(),I(),ae(),tu(),ru=o(),iu=()=>{let{editor:e,projectName:t,scenes:n}=F(),[r,i]=(0,nu.useState)(!1),o=null;return n&&(o=(0,ru.jsx)(w,{title:`scene`,children:(0,ru.jsxs)(`button`,{className:eu.select,onClick:()=>{i(!0)},children:[(0,ru.jsx)(`span`,{className:eu.select_name,children:n.current??`-`}),(0,ru.jsx)(a,{open:!0})]})})),(0,ru.jsxs)(`div`,{className:eu.sceneControl,children:[(0,ru.jsx)(`div`,{className:eu.sceneControl_inner,children:(0,ru.jsxs)(s,{label:t,accordion:!0,children:[o,(0,ru.jsx)(`div`,{className:eu.save,children:(0,ru.jsx)(c,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,ru.jsx)(oe,{scenes:n,projectName:t,onClose:()=>{i(!1)}})]})},iu.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var ou,su,cu,lu,uu,du,fu;function pu(){return(pu=t((()=>{ou=`Textures__textures___LnRle`,su=`Textures__item___LnRle`,cu=`Textures__preview___LnRle`,lu=`Textures__img___LnRle`,uu=`Textures__placeholder___LnRle`,du=`Textures__name___LnRle`,fu={textures:ou,item:su,preview:cu,img:lu,placeholder:uu,name:du}})))()}var mu,hu,gu;function _u(){return(_u=t((()=>{mu=i(),Yr(),I(),pu(),hu=o(),gu=()=>{let{engine:e,editor:t}=F(),[,n]=(0,mu.useState)(0);(0,mu.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return P.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{P.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=P.resources.textureList;return(0,hu.jsx)(`div`,{className:fu.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,hu.jsxs)(`div`,{className:fu.item,children:[(0,hu.jsx)(`div`,{className:fu.preview,children:n?(0,hu.jsx)(`img`,{src:n,className:fu.img}):(0,hu.jsx)(`div`,{className:fu.placeholder})}),(0,hu.jsx)(`div`,{className:fu.name,children:e.name})]},e.name)})})},gu.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var vu,yu;function bu(){return(bu=t((()=>{vu=i(),yu=(0,vu.createContext)(null)})))()}var xu,Su;function Cu(){return(Cu=t((()=>{xu=i(),bu(),Su=()=>{let e=(0,xu.useContext)(yu);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var wu;function Tu(){return(Tu=t((()=>{wu=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},scenes:{required:!1,tsType:{name:`SceneSelection`},description:``}}}})))()}var Ib,Lb;function Rb(){return(Rb=t((()=>{Ib=e(i(),1),lf(),Ur(),Lb=()=>{let[e,t]=Ib.useState(()=>new P(sf)),n=Ib.useRef(e);return n.current=e,(0,Ib.useEffect)(()=>{n.current.disposed&&t(new P(sf))},[]),(0,Ib.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,Ib.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var zb,Bb,Vb;function Hb(){return(Hb=t((()=>{zb=i(),Do(),Rb(),Bb=o(),Vb=e=>{let t=Lb(),{engine:n}=t,r=(0,zb.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,zb.useEffect)(()=>{r.current?.(n)},[n]),(0,zb.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,Bb.jsx)(Eo.Provider,{value:t,children:e.children})},Vb.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var Ub,Wb,Gb,Kb,qb,Jb,Yb;function Xb(){return(Xb=t((()=>{Ub=i(),Fb(),Hb(),Wb=o(),Gb=`scene`,Kb=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},qb=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),Jb=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),Yb=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,Ub.useState)(e.sceneData),[a,o]=(0,Ub.useState)(e.editorData),[s,c]=(0,Ub.useState)([]),[l,u]=(0,Ub.useState)(null),d=(0,Ub.useCallback)(async e=>{let t=await Kb(`${n}/scenes/${e}`);t&&(u(e),i(t))},[n]);(0,Ub.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([Kb(`${n}/editor`),Kb(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[Gb]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]);let f={names:s,current:l,onSelect:d,onCreate:(0,Ub.useCallback)(async e=>{if(!(await qb(`${n}/scenes/${e}`,Jb(e))).ok)return;let t=await Kb(`${n}/scenes`);t&&c(t),await d(e)},[n,d]),onDelete:(0,Ub.useCallback)(async e=>{if(!(await fetch(`${n}/scenes/${e}`,{method:`DELETE`})).ok)return;let t=await Kb(`${n}/scenes`)??[];c(t),e===l&&t.length>0&&await d(t[0])},[n,l,d])};return(0,Wb.jsx)(Vb,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,Wb.jsx)(Pb,{editorData:a,projectName:t,panels:e.panels,scenes:f,onSave:(t,r)=>{e.onBeforeSave?.(),l&&qb(`${n}/scenes/${l}`,t),qb(`${n}/editor`,{...r,[Gb]:l})}})})},Yb.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var Zb,Qb;function $b(){return($b=t((()=>{Fb(),Hb(),Zb=o(),Qb=e=>(0,Zb.jsx)(Vb,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,Zb.jsx)(Pb,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),Qb.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}function ex(){return(ex=t((()=>{Xb(),$b(),Fb(),Ab(),I(),Hb(),Ao(),qs(),go(),al(),Ec(),Nc(),Ud(),Cu(),au(),wo(),is(),Jl(),Fi(),Oi(),_u(),ha(),_c(),yi(),Qi(),Ss(),ri(),si(),gi(),ga(),Vi(),Ki(),rc(),uc(),ms(),Ra(),Sa(),ge()})))()}var tx;function nx(){return(nx=t((()=>{tx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var rx;function ix(){return(ix=t((()=>{rx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ax=n({EyeRings:()=>ox}),ox;function sx(){return(sx=t((()=>{N(),nx(),ix(),ox=class extends A{constructor(e){super(e);let t=this.engine,n=new Ut({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new an({phase:[`deferred`,`shadowMap`],frag:tx,vert:rx,uniforms:t.uniforms});this.entity.addComponent(j,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(j)}}})))()}var cx;function lx(){return(lx=t((()=>{cx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ux;function dx(){return(dx=t((()=>{ux=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var fx=n({FlashLine:()=>px}),px;function mx(){return(mx=t((()=>{O(),N(),lx(),dx(),px=class extends A{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new xt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=Ce.randomVector().multiply(new E(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new an({phase:[`forward`,`envMap`],frag:Kt(`flFrag`,cx),vert:Kt(`flVert`,ux),uniforms:M.merge(t.uniforms)}),this.entity.addComponent(j,{material:this.material,geometry:this.geometry})}}})))()}var hx;function gx(){return(gx=t((()=>{hx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var _x=n({SkyBox:()=>vx}),vx;function yx(){return(yx=t((()=>{N(),gx(),vx=class extends A{material;constructor(e){super(e);let t=this.engine;this.material=new an({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:Kt(`SkyBoxFrag`,hx),uniforms:M.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}}})))()}var bx;function xx(){return(xx=t((()=>{bx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Sx;function Cx(){return(Cx=t((()=>{Sx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var wx=n({GridCross:()=>Tx}),Tx;function Ex(){return(Ex=t((()=>{O(),N(),xx(),Cx(),Tx=class extends A{constructor(e){super(e);let t=new yt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new E(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new an({frag:Kt(`gridCrossFrag`,bx),vert:Kt(`gridCrossVert`,Sx),phase:[`forward`]});this.entity.addComponent(j,{geometry:t,material:a})}}})))()}var Dx;function Ox(){return(Ox=t((()=>{Dx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var kx;function Ax(){return(Ax=t((()=>{kx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var jx=n({GridDots:()=>Mx}),Mx;function Nx(){return(Nx=t((()=>{O(),N(),Ox(),Ax(),Mx=class extends A{constructor(e){super(e);let t=new Tt({radius:.1}),n=[],r=[],i=new E(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new an({frag:Kt(`gridDotsFrag`,Dx),vert:Kt(`gridDotsVert`,kx),phase:[`forward`]});this.entity.addComponent(j,{geometry:t,material:a})}}})))()}var Px;function Fx(){return(Fx=t((()=>{Px=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
#endif\r
\r
}`})))()}var Ix;function Lx(){return(Lx=t((()=>{Ix=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var Rx=n({WireCube:()=>zx}),zx;function Bx(){return(Bx=t((()=>{N(),Fx(),Lx(),zx=class extends A{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new yt({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new an({phase:[`deferred`],frag:Px,vert:Ix,uniforms:M.merge(t.uniforms)});this.entity.addComponent(j,{geometry:i,material:s})}}})))()}var Vx;function Hx(){return(Hx=t((()=>{Vx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Ux;function Wx(){return(Wx=t((()=>{Ux=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Gx=n({OREngineCube:()=>Kx}),Kx;function qx(){return(qx=t((()=>{N(),Yr(),Hx(),Wx(),Kx=class extends A{material;constructor(e){super(e);let t=this.engine;this.material=new an({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:Kt(`OREngineCubeVert`,Ux),frag:Kt(`OREngineCubeFrag`,Vx),uniforms:M.merge(t.uniforms,{uNoiseTex:{value:P.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(j);n&&(n.material=this.material)}}})))()}var Jx;function Yx(){return(Yx=t((()=>{Jx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Xx;function Zx(){return(Zx=t((()=>{Xx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Qx=n({OREngineLogo:()=>$x}),$x;function eS(){return(eS=t((()=>{N(),Yx(),Zx(),$x=class extends A{material;constructor(e){super(e);let t=this.engine;this.material=new an({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:Kt(`OREngineLogoVert`,Xx),frag:Kt(`OREngineLogoFrag`,Jx),uniforms:M.merge(t.uniforms)});let n=this.entity.getComponent(j);n&&(n.material=this.material)}}})))()}var tS;function nS(){return(nS=t((()=>{tS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var rS;function iS(){return(iS=t((()=>{rS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var aS=n({Dust:()=>oS}),oS;function sS(){return(sS=t((()=>{O(),N(),nS(),iS(),oS=class extends A{constructor(e){super(e);let t=this.engine,n=new _t,r=e.args?.num||2048,i=new E(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new an({phase:[`forward`],drawType:`POINTS`,frag:tS,vert:rS,uniforms:M.merge(t.uniforms)});this.entity.addComponent(j,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(j)}}})))()}var cS;function lS(){return(lS=t((()=>{cS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var uS;function dS(){return(dS=t((()=>{uS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var fS;function pS(){return(pS=t((()=>{fS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var YS;function XS(){return(XS=t((()=>{JS(),YS={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:qS}})))()}var ZS;function QS(){return(QS=t((()=>{ZS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var $S;function eC(){return(eC=t((()=>{QS(),$S={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:ZS}})))()}var tC;function nC(){return(nC=t((()=>{tC=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var rC;function iC(){return(iC=t((()=>{nC(),rC={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:tC}})))()}var aC;function oC(){return(oC=t((()=>{nC(),aC={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:tC}})))()}var sC,cC,lC;function uC(){return(uC=t((()=>{XS(),eC(),iC(),oC(),Yr(),sC=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":YS,"/demo-webgl/Resources/Textures/noise.tex":$S,"/demo-webgl/Resources/Textures/noiseCyclic.tex":rC,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":aC}),cC=()=>{for(let e of Object.values(sC))e&&P.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},lC=e=>{P.resources.buildTextureInstances(e.renderer,e.uniforms)}})))()}var dC,fC,pC,mC,hC;function gC(){return(gC=t((()=>{sx(),mx(),yx(),Ex(),Nx(),Bx(),qx(),eS(),sS(),gS(),lf(),Yr(),KS(),uC(),dC=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":ax,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":fx,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":_x,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":wx,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":jx,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":Rx,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":Gx,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":Qx,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":aS,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":mS}),fC=Object.assign({}),pC=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);pC(a,e)}}},mC=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);mC(a,e)}}},hC=()=>{ft.gltfLoaderFactory=e=>new ef(e),P.resources.clear();let e=P.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,jt),e.addComponent(`Camera`,Dt),e.addComponent(`Mesh`,j);let t=Object.keys(WS);for(let e=0;e<t.length;e++){let n=t[e],r=WS[n],i=P.resources.addComponentGroup(n);pC(r,i)}let n=Object.keys(GS);for(let e=0;e<n.length;e++){let t=n[e],r=GS[t],i=P.resources.addGeometryGroup(t);mC(r,i)}let r=Rr(dC,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=P.resources.addComponentGroup(t);pC(n,a)}let a=Rr(fC,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=P.resources.addGeometryGroup(t);mC(n,r)}cC()}})))()}var _C,vC,yC,bC,xC,SC;function CC(){return(CC=t((()=>{_C=i(),ex(),x(),gC(),vC=o(),hC(),yC=({setup:e})=>{let{editor:t}=F();return(0,_C.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},bC=e=>(0,vC.jsx)(Vb,{project:e.fixture.scene,onEngineInit:lC,children:(0,vC.jsx)(kb,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,vC.jsx)(lc,{children:(0,vC.jsxs)(v,{children:[e.children,e.fixture.setup&&(0,vC.jsx)(yC,{setup:e.fixture.setup}),(0,vC.jsx)(b,{}),(0,vC.jsx)(nc,{})]})})})}),xC=e=>t=>(0,vC.jsx)(bC,{fixture:e,children:(0,vC.jsx)(t,{})}),SC=e=>t=>(0,vC.jsx)(Vb,{project:e,onEngineInit:lC,children:(0,vC.jsx)(t,{})}),bC.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var wC,TC,EC,DC,OC;function kC(){return(kC=t((()=>{wC={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`CameraController`,uuid:`sb-camera-controller`}]},TC={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[wC,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},EC={...TC,scene:{name:`root`,uuid:`0`,childs:[wC]}},DC={enableRender:!0,resolutionScale:.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},OC={scene:TC,editorData:DC}})))()}export{Ra as A,hi as B,Ss as C,wo as D,Co as E,Qi as F,ri as G,oi as H,Pi as I,Yr as J,I as K,Fi as L,ma as M,ha as N,ho as O,Zi as P,vi as R,xs as S,ms as T,si as U,gi as V,ni as W,Ur as X,P as Y,Jl as _,TC as a,Ks as b,xC as c,Fb as d,Hd as f,ql as g,au as h,OC as i,La as j,go as k,SC as l,iu as m,DC as n,bC as o,Ud as p,F as q,EC as r,CC as s,kC as t,Pb as u,nc as v,ps as w,qs as x,rc as y,yi as z};