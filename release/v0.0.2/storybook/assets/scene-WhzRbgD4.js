...
\r
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}var Qc,$c,el;function tl(){return(tl=t((()=>{Qc=`RendererSettings__renderer___LnJlb`,$c=`RendererSettings__renderer_inner___LnJlb`,el={renderer:Qc,renderer_inner:$c}})))()}var nl,rl;function il(){return(il=t((()=>{w(),I(),ba(),tl(),nl=o(),rl=()=>{let{editor:e}=F(),t=e.engine.renderer;return(0,nl.jsx)(`div`,{className:el.renderer,children:(0,nl.jsxs)(`div`,{className:el.renderer_inner,children:[(0,nl.jsx)(s,{label:`Resolution`,accordion:!0,children:(0,nl.jsx)(ya,{target:e,filter:`resolution`})}),(0,nl.jsx)(s,{label:`Pipeline`,accordion:!0,children:(0,nl.jsx)(ya,{target:t,filter:`pipeline`})}),(0,nl.jsx)(s,{label:`Sky`,accordion:!0,children:(0,nl.jsx)(ya,{target:t,filter:`sky`})})]})})},rl.__docgenInfo={description:``,methods:[],displayName:`RendererSettings`}})))()}var al,ol,sl,cl,ll,ul;function dl(){return(dl=t((()=>{al=`SceneControl__sceneControl___LnNjZ`,ol=`SceneControl__sceneControl_inner___LnNjZ`,sl=`SceneControl__select___LnNjZ`,cl=`SceneControl__select_name___LnNjZ`,ll=`SceneControl__save___LnNjZ`,ul={sceneControl:al,sceneControl_inner:ol,select:sl,select_name:cl,save:ll}})))()}var fl,pl,ml;function hl(){return(hl=t((()=>{fl=i(),w(),I(),le(),dl(),pl=o(),ml=()=>{let{editor:e,projectName:t,scenes:n}=F(),[r,i]=(0,fl.useState)(null),o=null;return n&&(o=(0,pl.jsx)(T,{title:`scene`,children:(0,pl.jsxs)(`button`,{className:ul.select,onClick:e=>{i(ne(e.clientX,e.clientY))},children:[(0,pl.jsx)(`span`,{className:ul.select_name,children:n.current??`-`}),(0,pl.jsx)(a,{open:!0})]})})),(0,pl.jsxs)(`div`,{className:ul.sceneControl,children:[(0,pl.jsx)(`div`,{className:ul.sceneControl_inner,children:(0,pl.jsxs)(s,{label:t,accordion:!0,children:[o,(0,pl.jsx)(`div`,{className:ul.save,children:(0,pl.jsx)(c,{onClick:()=>{e.save()},children:`Save`})})]})}),r&&n&&(0,pl.jsx)(ue,{scenes:n,projectName:t,anchor:r,onClose:()=>{i(null)}})]})},ml.__docgenInfo={description:``,methods:[],displayName:`SceneControl`}})))()}var gl,_l,vl,yl,bl,xl,Sl;function Cl(){return(Cl=t((()=>{gl=`Textures__textures___LnRle`,_l=`Textures__item___LnRle`,vl=`Textures__preview___LnRle`,yl=`Textures__img___LnRle`,bl=`Textures__placeholder___LnRle`,xl=`Textures__name___LnRle`,Sl={textures:gl,item:_l,preview:vl,img:yl,placeholder:bl,name:xl}})))()}var wl,Tl,El;function Dl(){return(Dl=t((()=>{wl=i(),ei(),I(),Cl(),Tl=o(),El=()=>{let{engine:e,editor:t}=F(),[,n]=(0,wl.useState)(0);(0,wl.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return P.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{P.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=P.resources.textureList;return(0,Tl.jsx)(`div`,{className:Sl.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,Tl.jsxs)(`div`,{className:Sl.item,children:[(0,Tl.jsx)(`div`,{className:Sl.preview,children:n?(0,Tl.jsx)(`img`,{src:n,className:Sl.img}):(0,Tl.jsx)(`div`,{className:Sl.placeholder})}),(0,Tl.jsx)(`div`,{className:Sl.name,children:e.name})]},e.name)})})},El.__docgenInfo={description:``,methods:[],displayName:`Textures`}})))()}var Ol,kl;function Al(){return(Al=t((()=>{Ol=i(),kl=(0,Ol.createContext)(null)})))()}var jl,Ml;function Nl(){return(Nl=t((()=>{jl=i(),Al(),Ml=()=>{let e=(0,jl.useContext)(kl);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e}})))()}var Pl;function Fl(){return(Fl=t((()=>{Pl=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
void main( void ) {
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},scenes:{required:!1,tsType:{name:`SceneSelection`},description:``}}}})))()}var Ky,qy;function Jy(){return(Jy=t((()=>{Ky=e(i(),1),vd(),Jr(),qy=()=>{let[e,t]=Ky.useState(()=>new P(gd)),n=Ky.useRef(e);return n.current=e,(0,Ky.useEffect)(()=>{n.current.disposed&&t(new P(gd))},[]),(0,Ky.useEffect)(()=>()=>{e.dispose()},[e]),{engine:e,load:(0,Ky.useCallback)(t=>{t&&e.load(t)},[e])}}})))()}var Yy,Xy,Zy;function Qy(){return(Qy=t((()=>{Yy=i(),lo(),Jy(),Xy=o(),Zy=e=>{let t=qy(),{engine:n}=t,r=(0,Yy.useRef)(e.onEngineInit);return r.current=e.onEngineInit,(0,Yy.useEffect)(()=>{r.current?.(n)},[n]),(0,Yy.useEffect)(()=>{e.project?n.load(e.project):n.init()},[n,e.project]),(0,Xy.jsx)(co.Provider,{value:t,children:e.children})},Zy.__docgenInfo={description:``,methods:[],displayName:`OREngineProvider`}})))()}var $y,eb,tb,nb,rb,ib,ab;function ob(){return(ob=t((()=>{$y=i(),Gy(),Qy(),eb=o(),tb=`scene`,nb=async e=>{try{let t=await fetch(e);return t.ok?await t.json():null}catch{return null}},rb=(e,t)=>fetch(e,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(t)}),ib=e=>({name:e,scene:{name:`Root`,uuid:`0`}}),ab=e=>{let t=e.projectName??`DefaultProject`,n=`/api/projects/${t}`,[r,i]=(0,$y.useState)(e.sceneData),[a,o]=(0,$y.useState)(e.editorData),[s,c]=(0,$y.useState)([]),[l,u]=(0,$y.useState)(null),d=(0,$y.useCallback)(async e=>{let t=await nb(`${n}/scenes/${e}`);t&&(u(e),i(t))},[n]);(0,$y.useEffect)(()=>{e.sceneData||(async()=>{let[e,t]=await Promise.all([nb(`${n}/editor`),nb(`${n}/scenes`)]);e&&o(e);let r=t??[];if(c(r),r.length===0)return;let i=r[0],a=e?e[tb]:void 0;typeof a==`string`&&r.includes(a)&&(i=a),await d(i)})()},[e.sceneData,n,d]);let f={names:s,current:l,onSelect:d,onCreate:(0,$y.useCallback)(async e=>{if(!(await rb(`${n}/scenes/${e}`,ib(e))).ok)return;let t=await nb(`${n}/scenes`);t&&c(t),await d(e)},[n,d]),onDelete:(0,$y.useCallback)(async e=>{if(!(await fetch(`${n}/scenes/${e}`,{method:`DELETE`})).ok)return;let t=await nb(`${n}/scenes`)??[];c(t),e===l&&t.length>0&&await d(t[0])},[n,l,d])};return(0,eb.jsx)(Zy,{project:r,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,eb.jsx)(Wy,{editorData:a,projectName:t,panels:e.panels,scenes:f,onSave:(t,r)=>{e.onBeforeSave?.(),l&&rb(`${n}/scenes/${l}`,t),rb(`${n}/editor`,{...r,[tb]:l})}})})},ab.__docgenInfo={description:``,methods:[],displayName:`EditorPage`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!1,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``},onBeforeSave:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:``}}}})))()}var sb,cb;function lb(){return(lb=t((()=>{Gy(),Qy(),sb=o(),cb=e=>(0,sb.jsx)(Zy,{project:e.sceneData,onEngineInit:t=>{e.initResourceInstances(t)},children:(0,sb.jsx)(Wy,{editorData:e.editorData,projectName:e.projectName??`Static`,panels:e.panels,onSave:()=>{}})}),cb.__docgenInfo={description:``,methods:[],displayName:`EditorPageStatic`,props:{projectName:{required:!1,tsType:{name:`string`},description:``},sceneData:{required:!0,tsType:{name:`OREngineProjectData`},description:``},editorData:{required:!1,tsType:{name:`MXP.SerializeField`},description:``},initResourceInstances:{required:!0,tsType:{name:`signature`,type:`function`,raw:`( engine: Engine ) => void`,signature:{arguments:[{type:{name:`Engine`},name:`engine`}],return:{name:`void`}}},description:``},panels:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`{
	id: PanelId;
	title: string;
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
	...
	// タブ追加メニュー上の階層。"/" 区切りで、省略時はルート直下に出る。タブ名は title のまま
	category?: string;
}`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`title`,value:{name:`string`,required:!0}},{key:`category`,value:{name:`string`,required:!1}}]}},{name:`unknown`}]}],raw:`PanelDefinition[]`},description:``}}}})))()}function ub(){return(ub=t((()=>{ob(),lb(),Gy(),By(),I(),Qy(),po(),bs(),Qa(),hc(),Is(),Us(),$u(),Nl(),hl(),oo(),Vo(),il(),Bi(),Ni(),Dl(),ba(),Ds(),wi(),ra(),Yo(),ci(),fi(),xi(),xa(),Ki(),Zi(),be()})))()}var db;function fb(){return(fb=t((()=>{db=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var pb;function mb(){return(mb=t((()=>{pb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var hb=n({EyeRings:()=>gb}),gb;function _b(){return(_b=t((()=>{N(),fb(),mb(),gb=class extends bt{constructor(e){super(e);let t=this.engine,n=new Jt({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new un({phase:[`deferred`,`shadowMap`],frag:db,vert:pb,uniforms:t.uniforms});this.entity.addComponent(j,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(j)}}})))()}var vb;function yb(){return(yb=t((()=>{vb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var bb;function xb(){return(xb=t((()=>{bb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Sb=n({FlashLine:()=>Cb}),Cb;function wb(){return(wb=t((()=>{k(),N(),yb(),xb(),Cb=class extends bt{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new Et({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=De.randomVector().multiply(new D(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new un({phase:[`forward`,`envMap`],frag:Zt(`flFrag`,vb),vert:Zt(`flVert`,bb),uniforms:M.merge(t.uniforms)}),this.entity.addComponent(j,{material:this.material,geometry:this.geometry})}}})))()}var Tb;function Eb(){return(Eb=t((()=>{Tb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Db=n({SkyBox:()=>Ob}),Ob;function kb(){return(kb=t((()=>{N(),Eb(),Ob=class extends bt{material;constructor(e){super(e);let t=this.engine;this.material=new un({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:Zt(`SkyBoxFrag`,Tb),uniforms:M.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}}})))()}var Ab;function jb(){return(jb=t((()=>{Ab=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Mb;function Nb(){return(Nb=t((()=>{Mb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Pb=n({GridCross:()=>Fb}),Fb;function Ib(){return(Ib=t((()=>{k(),N(),jb(),Nb(),Fb=class extends bt{constructor(e){super(e);let t=new wt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new D(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new un({frag:Zt(`gridCrossFrag`,Ab),vert:Zt(`gridCrossVert`,Mb),phase:[`forward`]});this.entity.addComponent(j,{geometry:t,material:a})}}})))()}var Lb;function Rb(){return(Rb=t((()=>{Lb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var zb;function Bb(){return(Bb=t((()=>{zb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var Vb=n({GridDots:()=>Hb}),Hb;function Ub(){return(Ub=t((()=>{k(),N(),Rb(),Bb(),Hb=class extends bt{constructor(e){super(e);let t=new At({radius:.1}),n=[],r=[],i=new D(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new un({frag:Zt(`gridDotsFrag`,Lb),vert:Zt(`gridDotsVert`,zb),phase:[`forward`]});this.entity.addComponent(j,{geometry:t,material:a})}}})))()}var Wb;function Gb(){return(Gb=t((()=>{Wb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
#endif\r
\r
}`})))()}var Kb;function qb(){return(qb=t((()=>{Kb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`})))()}var Jb=n({WireCube:()=>Yb}),Yb;function Xb(){return(Xb=t((()=>{N(),Gb(),qb(),Yb=class extends bt{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new wt({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new un({phase:[`deferred`],frag:Wb,vert:Kb,uniforms:M.merge(t.uniforms)});this.entity.addComponent(j,{geometry:i,material:s})}}})))()}var Zb;function Qb(){return(Qb=t((()=>{Zb=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var $b;function ex(){return(ex=t((()=>{$b=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var tx=n({OREngineCube:()=>nx}),nx;function rx(){return(rx=t((()=>{N(),ei(),Qb(),ex(),nx=class extends bt{material;constructor(e){super(e);let t=this.engine;this.material=new un({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:Zt(`OREngineCubeVert`,$b),frag:Zt(`OREngineCubeFrag`,Zb),uniforms:M.merge(t.uniforms,{uNoiseTex:{value:P.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(j);n&&(n.material=this.material)}}})))()}var ix;function ax(){return(ax=t((()=>{ix=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var ox;function sx(){return(sx=t((()=>{ox=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var cx=n({OREngineLogo:()=>lx}),lx;function ux(){return(ux=t((()=>{N(),ax(),sx(),lx=class extends bt{material;constructor(e){super(e);let t=this.engine;this.material=new un({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:Zt(`OREngineLogoVert`,ox),frag:Zt(`OREngineLogoFrag`,ix),uniforms:M.merge(t.uniforms)});let n=this.entity.getComponent(j);n&&(n.material=this.material)}}})))()}var dx;function fx(){return(fx=t((()=>{dx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var px;function mx(){return(mx=t((()=>{px=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var hx=n({Dust:()=>gx}),gx;function _x(){return(_x=t((()=>{k(),N(),fx(),mx(),gx=class extends bt{constructor(e){super(e);let t=this.engine,n=new St,r=e.args?.num||2048,i=new D(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new un({phase:[`forward`],drawType:`POINTS`,frag:dx,vert:px,uniforms:M.merge(t.uniforms)});this.entity.addComponent(j,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(j)}}})))()}var vx;function yx(){return(yx=t((()=>{vx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`})))()}var bx;function xx(){return(xx=t((()=>{bx=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var aS;function oS(){return(oS=t((()=>{iS(),aS={name:`hash`,resolution:[512,512],filter:`nearest`,updateEveryFrame:!1,frag:rS}})))()}var sS;function cS(){return(cS=t((()=>{sS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `})))()}var lS;function uS(){return(uS=t((()=>{cS(),lS={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:sS}})))()}var dS;function fS(){return(fS=t((()=>{dS=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `})))()}var pS;function mS(){return(mS=t((()=>{fS(),pS={name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:dS}})))()}var hS;function gS(){return(gS=t((()=>{fS(),hS={name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:dS}})))()}var _S,vS,yS;function bS(){return(bS=t((()=>{oS(),uS(),mS(),gS(),ei(),_S=Object.assign({"/demo-webgl/Resources/Textures/hash.tex":aS,"/demo-webgl/Resources/Textures/noise.tex":lS,"/demo-webgl/Resources/Textures/noiseCyclic.tex":pS,"/demo-webgl/Resources/Textures/noiseCyclicAnime.tex":hS}),vS=()=>{for(let e of Object.values(_S))e&&P.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},yS=e=>{P.resources.buildTextureInstances(e.renderer,e.uniforms)}})))()}var xS,SS,CS,wS,TS;function ES(){return(ES=t((()=>{_b(),wb(),kb(),Ib(),Ub(),Xb(),rx(),ux(),_x(),Ex(),vd(),ei(),nS(),bS(),xS=Object.assign({"/demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":hb,"/demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":Sb,"/demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":Db,"/demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":Pb,"/demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":Vb,"/demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":Jb,"/demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":tx,"/demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":cx,"/demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":hx,"/demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":wx}),SS=Object.assign({}),CS=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addComponent(i,a);else{let e=t.createGroup(i);CS(a,e)}}},wS=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];if(typeof a==`function`)t.addGeometry(i,a);else{let e=t.createGroup(i);wS(a,e)}}},TS=()=>{gt.gltfLoaderFactory=e=>new ud(e),P.resources.clear();let e=P.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,It),e.addComponent(`Camera`,Mt),e.addComponent(`Mesh`,j);let t=Object.keys(eS);for(let e=0;e<t.length;e++){let n=t[e],r=eS[n],i=P.resources.addComponentGroup(n);CS(r,i)}let n=Object.keys(tS);for(let e=0;e<n.length;e++){let t=n[e],r=tS[t],i=P.resources.addGeometryGroup(t);wS(r,i)}let r=Ur(xS,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t],a=P.resources.addComponentGroup(t);CS(n,a)}let a=Ur(SS,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t],r=P.resources.addGeometryGroup(t);wS(n,r)}vS()}})))()}var DS,OS,kS,AS,jS,MS;function NS(){return(NS=t((()=>{DS=i(),ub(),w(),ES(),OS=o(),TS(),kS=({setup:e})=>{let{editor:t}=F();return(0,DS.useEffect)(()=>{let n=t.engine,r=()=>e(t);return n.on(`loaded`,r),()=>{n.off(`loaded`,r)}},[t,e]),null},AS=e=>(0,OS.jsx)(Zy,{project:e.fixture.scene,onEngineInit:yS,children:(0,OS.jsx)(zy,{projectName:`storybook`,editorData:e.fixture.editorData,scenes:e.fixture.scenes,children:(0,OS.jsx)(y,{children:(0,OS.jsxs)(ee,{children:[e.children,e.fixture.setup&&(0,OS.jsx)(kS,{setup:e.fixture.setup}),(0,OS.jsx)(_,{}),(0,OS.jsx)(C,{})]})})})}),jS=e=>t=>(0,OS.jsx)(AS,{fixture:e,children:(0,OS.jsx)(t,{})}),MS=e=>t=>(0,OS.jsx)(Zy,{project:e,onEngineInit:yS,children:(0,OS.jsx)(t,{})}),AS.__docgenInfo={description:``,methods:[],displayName:`OREditorFixtureHost`}})))()}var PS,FS,IS,LS,RS;function zS(){return(zS=t((()=>{PS={name:`Camera`,uuid:`sb-camera`,pos:[0,2,12],components:[{name:`Camera`,uuid:`sb-camera-lens`},{name:`CameraController`,uuid:`sb-camera-controller`}]},FS={name:`storybook`,scene:{name:`root`,uuid:`0`,childs:[PS,{name:`OREngineCube`,uuid:`sb-cube`,components:[{name:`OREngineCube`,uuid:`sb-cube-body`}]},{name:`OREngineLogo`,uuid:`sb-logo`,components:[{name:`OREngineLogo`,uuid:`sb-logo-body`}]}]},"timeline/duration":600,"timeline/fps":60},IS={...FS,scene:{name:`root`,uuid:`0`,childs:[PS]}},LS={enableRender:!0,resolutionScale:.5,"resolution/width":1920,"resolution/height":1080,viewType:`render`,"frameLoop/enabled":!1,"frameLoop/start":0,"frameLoop/end":0,cameraMode:`preview`,gizmoMode:`translate`},RS={scene:FS,editorData:LS}})))()}export{zi as A,I as B,oo as C,ba as D,ya as E,xi as F,ei as H,di as I,fi as L,Ci as M,wi as N,na as O,bi as P,si as R,ao as S,Qa as T,P as U,F as V,Jr as W,il as _,FS as a,Jo as b,jS as c,Gy as d,Qu as f,rl as g,hl as h,RS as i,Bi as j,ra as k,MS as l,ml as m,LS as n,AS as o,$u as p,IS as r,NS as s,zS as t,Wy as u,ys as v,Za as w,Yo as x,bs as y,ci as z};