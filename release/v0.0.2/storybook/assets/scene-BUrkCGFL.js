...
}`,signature:{properties:[{key:`motionBlur`,value:{name:`boolean`,required:!1}},{key:`motionBlurPower`,value:{name:`number`,required:!1}},{key:`ssr`,value:{name:`boolean`,required:!1}},{key:`ssao`,value:{name:`boolean`,required:!1}},{key:`lightShaft`,value:{name:`boolean`,required:!1}},{key:`dof`,value:{name:`boolean`,required:!1}},{key:`toneMap`,value:{name:`boolean`,required:!1}},{key:`exposure`,value:{name:`number`,required:!1}},{key:`bloom`,value:{name:`boolean`,required:!1}},{key:`bloomThreshold`,value:{name:`number`,required:!1}},{key:`bloomBrightness`,value:{name:`number`,required:!1}},{key:`lightShaftIntensity`,value:{name:`number`,required:!1}},{key:`lightShaftBlur`,value:{name:`boolean`,required:!1}},{key:`lightShaftTemporal`,value:{name:`boolean`,required:!1}},{key:`lightShaftTemporalBlend`,value:{name:`number`,required:!1}},{key:`ssaoIntensity`,value:{name:`number`,required:!1}},{key:`ssaoBlur`,value:{name:`boolean`,required:!1}},{key:`ssaoTemporal`,value:{name:`boolean`,required:!1}},{key:`ssaoTemporalBlend`,value:{name:`number`,required:!1}}]},alias:`PipelineConfig`}}],returns:{type:{name:`void`}}},{name:`pipelineConfig`,docblock:null,modifiers:[`get`],params:[],returns:{type:{name:`signature`,type:`object`,raw:`{
	motionBlur?: boolean;
	motionBlurPower?: number;
	ssr?: boolean;
	ssao?: boolean;
