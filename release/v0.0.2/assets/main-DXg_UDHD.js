...
`,lr=class{isEditorFrame=!0;texture;textarget;constructor(e,t){this.texture=e,this.textarget=t}},ur=class extends lr{isEditorTarget=!0;frameBuffer;autoResize;constructor(e,t){super(e.textures[0],N.TEXTURE_2D),this.frameBuffer=e,this.autoResize=t}},dr=class{isEditorRecipe=!0;postprocess;pass;constructor(e,t){this.pass=t,this.postprocess=new pn({name:e,passes:[t]})}},fr=class{_renderer;_gl;_targets;_recipes;_readFrameBuffer;_fullscreenBuffer;_texturePass;_texturePostProcess;constructor(e){this._renderer=e,this._gl=e.backend.gl,this._targets=[],this._recipes=[],this._readFrameBuffer=new Ot(this._gl,{disableDepthBuffer:!0}),this._fullscreenBuffer=new Ot(this._gl,{disableDepthBuffer:!0}).setTexture([new Dt(this._gl).setting({magFilter:N.LINEAR,minFilter:N.LINEAR})]),this._fullscreenBuffer.setSize(e.resolution),this._texturePass=new F(e.backend,{frag:cr,renderTarget:null}),this._texturePostProcess=new pn({name:`editorTexture`,passes:[this._texturePass]})}renderEntities(e){let t=this._renderer,n=e.view,r=e.target?e.target.frameBuffer:n.renderTarget.uiBuffer,i=e.materialOverride,a=[];if(e.target&&e.useSceneDepth&&r.setDepthTexture(n.renderTarget.gBuffer.depthTexture),i)for(let t=0;t<e.entities.length;t++){let n=e.entities[t].getComponent(P);a.push(n?n.material:null),n&&(n.material=i)}if(e.depthCompare===`lequal`&&this._gl.depthFunc(N.LEQUAL),t.renderCamera(`forward`,e.camera,e.entities,r,t.resolution,{disableClear:e.target===null}),e.depthCompare===`lequal`&&this._gl.depthFunc(N.LESS),i)for(let t=0;t<e.entities.length;t++){let n=e.entities[t].getComponent(P);n&&(n.material=a[t])}}renderFullscreen(e,t,n){let r=t,i=this._renderer;if(n){let e=n.frameBuffer;r.pass.renderTarget=e,i.renderPostProcess(r.postprocess,void 0,e.size);return}let a=e.renderTarget.uiBuffer,o=i.resolution;r.pass.renderTarget=this._fullscreenBuffer,i.renderPostProcess(r.postprocess,a,o),i.backend.blit(this._fullscreenBuffer,a,o.x,o.y)}blit(e,t,n,r){let i=this._gl,a=t,o=n?n.frameBuffer:e.renderTarget.uiBuffer,s=o.size,c=r||{x:0,y:0,width:s.x,height:s.y};this._readFrameBuffer.setSize(a.texture.size),i.bindFramebuffer(i.FRAMEBUFFER,this._readFrameBuffer.getFrameBuffer()),i.framebufferTexture2D(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0,a.textarget,a.texture.getTexture(),0),i.bindFramebuffer(i.READ_FRAMEBUFFER,this._readFrameBuffer.getFrameBuffer()),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,o.getFrameBuffer()),i.blitFramebuffer(0,0,a.texture.size.x,a.texture.size.y,c.x,s.y-c.y-c.height,c.x+c.width,s.y-c.y,i.COLOR_BUFFER_BIT,i.NEAREST),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null)}drawToCanvas(e,t){let n=this._renderer,r=n.resolution;n.backend.blit(e.renderTarget.uiBuffer,null,r.x,r.y),t!==n.canvas&&t.getContext(`2d`).drawImage(n.canvas,0,0)}drawTexture(e,t){let n=t.frameBuffer;this._texturePass.uniforms.uSrcTexture={value:e,type:`1i`},this._texturePass.renderTarget=n,this._renderer.renderPostProcess(this._texturePostProcess,void 0,n.size)}async readPixels(e){let t=this._gl,n=e.frameBuffer,r=n.size,i=new Uint8Array(r.x*r.y*4);return t.bindFramebuffer(t.FRAMEBUFFER,n.getFrameBuffer()),t.readPixels(0,0,r.x,r.y,t.RGBA,t.UNSIGNED_BYTE,i),t.bindFramebuffer(t.FRAMEBUFFER,null),i}createTarget(e){let t=new Ot(this._gl,{disableDepthBuffer:!0}).setTexture([new Dt(this._gl).setting({magFilter:N.LINEAR,minFilter:N.LINEAR})]);t.setSize(e&&e.size||this._renderer.resolution);let n=new ur(t,!(e&&e.size));return this._targets.push(n),n}resize(e){this._fullscreenBuffer.setSize(e);for(let t=0;t<this._targets.length;t++){let n=this._targets[t];n.autoResize&&n.frameBuffer.setSize(e)}for(let t=0;t<this._recipes.length;t++)this._recipes[t].postprocess.resize(e)}onDrawPass(e){let t=(t,n)=>{if(!t)return;let r=t.textures,i=`currentFace`in t?t.currentFace:N.TEXTURE_2D;for(let t=0;t<r.length;t++){let a=n?n+(r.length>1?`_`+t:``):``;e(new lr(r[t],i),a)}};return this._renderer.on(`drawPass`,t),()=>this._renderer.off(`drawPass`,t)}materials={flat:e=>new fn({vert:rr,frag:nr,phase:[`forward`],drawType:e.lines?`LINES`:`TRIANGLES`,depthTest:e.depthTest??!0,depthWrite:e.depthWrite??!0,uniforms:{uColor:{value:e.color,type:`3fv`}}}),mask:()=>new fn({vert:or,frag:ar,phase:[`forward`],depthTest:!1}),grid:e=>new fn({vert:rr,frag:ir,phase:[`forward`],depthWrite:!1,uniforms:{uColor:{value:e.color,type:`3fv`},uParams:{value:e.params,type:`3fv`}}})};recipes={outline:(e,t)=>{let n=new dr(`editorOutline`,new F(this._renderer.backend,{frag:sr,renderTarget:null,uniforms:{uMaskTexture:{value:e.texture,type:`1i`},uOutlineColor:{value:new j(t[0],t[1],t[2]),type:`3fv`}}}));return this._recipes.push(n),n}}},pr=e=>new fr(e.renderer),mr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Sr=`uniform sampler2D uShadingTexture;
...
}`,wr=class extends pn{constructor(e){let t=[],n=[];for(let r=0;r<4;r++)t.push(e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:N.LINEAR,minFilter:N.LINEAR})])),n.push(e.createFrameBuffer().setTexture([e.createTexture().setting({magFilter:N.LINEAR,minFilter:N.LINEAR})]));let r=2,i=new F(e,{name:`bloom/bright/`,frag:Sr,passThrough:!0,uniforms:{uThreshold:{value:1.8,type:`1f`},uBrightness:{value:1,type:`1f`}},resolutionRatio:1/r}),a=[],o=i.renderTarget.textures;for(let i=0;i<4;i++){let s=t[i],c=n[i],l={name:`bloom/blur/`+i+`/v`,renderTarget:s,frag:xr,uniforms:{uBackBlurTex:{value:o,type:`1i`},uIsVertical:{type:`1i`,value:!0},uWeights:{type:`1fv`,value:St.gaussWeights(8)},uBlurRange:{value:2,type:`1f`}},defines:{GAUSS_WEIGHTS:`8`,USE_BACKBLURTEX:``},passThrough:!0,resolutionRatio:1/r};a.push(new F(e,l)),a.push(new F(e,{...l,name:`bloom/blur/`+i+`/h`,renderTarget:c,uniforms:{...l.uniforms,uBackBlurTex:{value:s.textures[0],type:`1i`},uIsVertical:{type:`1i`,value:!1}}})),o=c.textures,r*=2}let s=new F(e,{name:`bloom/composite/`,frag:Cr,uniforms:{uBloomTexture:{value:n.map(e=>e.textures[0]),type:`1iv`}}});super({name:`Bloom`,passes:[i,...a,s]})}get threshold(){return this.passes[0].uniforms.uThreshold.value}set threshold(e){this.passes[0].uniforms.uThreshold.value=e}get brightness(){return this.passes[0].uniforms.uBrightness.value}set brightness(e){this.passes[0].uniforms.uBrightness.value=e}},Tr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor = vec4( col, 1.0 );\r
\r
}`,Er=class extends pn{constructor(e){super({name:`ColorGrading`,passes:[new F(e,{frag:Tr})]})}},Dr=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor = vec4( col, 1.0 );\r
\r
}`,Or=class extends pn{constructor(e){super({name:`Finalize`,passes:[new F(e,{frag:Dr})]})}},kr=`uniform sampler2D uBackBuffer0;\r
...
\r
    // outColor = vec4( 0.0 );\r
\r
}`,Ar=class extends pn{constructor(e){super({name:`FXAA`,passes:[new F(e,{name:`fxaa`,frag:kr})]})}},jr=(e,t)=>{let n=t.addComponent(dn),r=e.renderer.backend,i=new wr(r);return i.threshold=1,i.brightness=1,n.add(new Ar(r)),n.add(i),n.add(new Er(r)),n.add(new Or(r)),()=>{t.removeComponent(dn)}},Mr=class{static serializeEntity(e,t){let n=e=>{let r=[];e.children.forEach(e=>{e.initiator!=`script`&&r.push(n(e))});let i=[];e.components.forEach(e=>{let n=e.serialize({mode:`export`}),r=Object.keys(n).length>0;if(e.initiator!==`user`)return;let a={name:t.getName(e),uuid:e.uuid};r&&(a.props=n),i.push(a)});for(let t of e.unresolvedComponents)i.push({name:t.name,uuid:t.uuid,props:t.props});return{name:e.name,uuid:e.uuid,pos:e.position.x==0&&e.position.y==0&&e.position.z==0?void 0:e.position.getElm(`vec3`),rot:e.euler.x==0&&e.euler.y==0&&e.euler.z==0?void 0:e.euler.getElm(`vec3`),scale:e.scale.x==1&&e.scale.y==1&&e.scale.z==1?void 0:e.scale.getElm(`vec3`),components:i.length>0?i:void 0,childs:r.length>0?r:void 0}};return n(e)}static deserializeEntity(e,t,n,r){let i=(e,t)=>{let a=t||r.createEntity();a.initiator=`user`,a.name=e.name,a.restoreUUID(e.uuid);let o=e.pos||[0,0,0];a.position.x=o[0],a.position.y=o[1],a.position.z=o[2];let s=e.rot||[0,0,0];a.euler.x=s[0],a.euler.y=s[1],a.euler.z=s[2];let c=e.scale||[1,1,1];return a.scale.x=c[0],a.scale.y=c[1],a.scale.z=c[2],a.unresolvedComponents=[],e.components&&e.components.forEach(e=>{let t=n.resolve(e.name);if(t){let n=a.getComponent(t.component);n||(n=a.addComponent(t.component),n.initiator=`user`),n.restoreUUID(e.uuid),e.props&&n.deserialize(e.props)}else console.warn(`[ProjectSerializer] Component "${e.name}" not found in resolver. Preserving data for round-trip.`),a.unresolvedComponents.push({name:e.name,uuid:e.uuid,props:e.props})}),e.childs&&([...a.children].forEach(e=>{e.initiator!==`script`&&a.remove(e)}),e.childs.forEach(e=>{a.add(i(e))})),a};e&&i(e,t),t.initiator=`god`}},Nr=class extends Gt{name;_frag;_resolution;_filter;_updateEveryFrame;_textures;constructor(e,t){super(),this.name=e;let n=t.data;this._frag=n?.frag||``,this._resolution=n?.resolution||[1024,1024],this._filter=n?.filter||`linear`,this._updateEveryFrame=n?.updateEveryFrame??!1,this._textures=n?.textures||{}}get frag(){return this._frag}get resolution(){return this._resolution}get filter(){return this._filter}get updateEveryFrame(){return this._updateEveryFrame}get textures(){return this._textures}},Pr=(e,t)=>{let n={},r=`/${t}/`;for(let[t,i]of Object.entries(e)){let e=t.slice(t.lastIndexOf(r)+r.length).split(`/`).slice(0,-2),a=Object.entries(i).find(([e,t])=>typeof t==`function`&&/^[A-Z]/.test(e));if(!a)continue;let o=n;for(let t of e)o=o[t]=o[t]||{};o[a[0]]=a[1]}return n},Fr=class extends It{_componentList;_componentGroups;_geometryList;_geometryGroups;_textureResources;_textures;_updateEveryFrameTextures;constructor(){super(),this._componentList=[],this._textures=new Map,this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources=new Map,this._updateEveryFrameTextures=[]}get componentList(){return this._componentList}get componentGroups(){return this._componentGroups}get geometryList(){return this._geometryList}get geometryGroups(){return this._geometryGroups}get textureList(){return Array.from(this._textureResources.values())}get textures(){return this._textures}get updateEveryFrameTextures(){return this._updateEveryFrameTextures}clear(){this._componentList=[],this._componentGroups=[],this._geometryList=[],this._geometryGroups=[],this._textureResources.clear(),this._textures.clear(),this._updateEveryFrameTextures=[],this.emit(`update`)}getComponent(e){return this._componentList.find(t=>t.name==e)}addComponentGroup(e){let t=this._componentGroups.find(t=>t.name==e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addComponent:(e,n)=>{let r={name:e,component:n};t.push(r),this._componentList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._componentGroups.push(t),this.emit(`update`),t}getGeometry(e){return this._geometryList.find(t=>t.name===e)}addGeometryGroup(e){let t=this._geometryGroups.find(t=>t.name===e);if(t)return t;let n=e=>{let t=[];return{child:t,name:e,addGeometry:(e,n)=>{let r={name:e,geometryClass:n};t.push(r),this._geometryList.push(r)},createGroup:e=>{let r=n(e);return t.push(r),r}}};return t=n(e),this._geometryGroups.push(t),this.emit(`update`),t}addTextureResource(e,t){let n=new Nr(e,{data:t});this._textureResources.set(e,n),this.emit(`update`)}getTextureResource(e){return this._textureResources.get(e)}removeTextureResource(e){this._textureResources.delete(e);let t=this._textures.get(e);t&&(t.dispose(),this._textures.delete(e)),this.emit(`update`)}addTexture(e,t){return this._textures.set(e,t),t}getTexture(e){return this._textures.get(e)}_buildTexture(e,t,n,r){let i=e.frag;return i?t.createTexProcedural({name:e.name,frag:i,resolution:new j(e.resolution[0]||1024,e.resolution[1]||1024),filter:e.filter,textures:n,uniforms:e.updateEveryFrame?r:void 0}):null}_ensureTexture(e,t,n,r){let i=this._textures.get(e.name);if(i)return i;if(r.has(e.name))return null;r.add(e.name);let a={},o=e.textures,s=Object.keys(o);for(let e=0;e<s.length;e++){let i=s[e],c=o[i],l=this._textureResources.get(c),u=l?this._ensureTexture(l,t,n,r):this._textures.get(c);u&&(a[i]=u)}let c=this._buildTexture(e,t,a,n);return c?(this._textures.set(e.name,c),e.updateEveryFrame&&this._updateEveryFrameTextures.push(c),c):null}buildTextureInstances(e,t){this._updateEveryFrameTextures=[];let n=new Set;this._textureResources.forEach(r=>{this._ensureTexture(r,e,t,n)}),this.emit(`update`)}},Ir={duration:600,fps:30},Lr=class e extends Gt{static resources;name;_renderer;_root;_uniforms;_time;_frame;_frameSetting;_disposed;_frameEvent;constructor(e){super(),this.name=`OREngine`,this._disposed=!1,this._uniforms={uEnvMapIntensity:{value:1,type:`1f`}},this._renderer=e(this),this._renderer.globalUniforms={uTime:{value:0,type:`1f`},uTimeF:{value:0,type:`1f`},uTimeE:{value:0,type:`1f`},uTimeEF:{value:0,type:`1f`},uDeltaTime:{value:0,type:`1f`},uResolution:{value:new j,type:`2fv`},uAspectRatio:{value:1,type:`1f`}},this._time={current:new Date().getTime(),engine:0,delta:0,code:0},this._frameSetting={...Ir},this._frame={current:0,playing:!1},this.seek(0),this._frameEvent=null,this._root=this.createEntity({name:`root`}),this._root.initiator=`god`,this.field(`name`,()=>this.name,e=>this.name=e),this.field(`scene`,()=>Mr.serializeEntity(this._root,this._createComponentResolver()),e=>{Mr.deserializeEntity(e,this._root,this._createComponentResolver(),this)}),this.field(`renderer`,()=>this._renderer.serialize({mode:`export`}),e=>this._renderer.deserialize(e));let t=this.fieldDir(`timeline`);t.field(`duration`,()=>this._frameSetting.duration,e=>this._frameSetting.duration=e),t.field(`fps`,()=>this._frameSetting.fps,e=>this._frameSetting.fps=e)}createEntity(e){return new rn({engine:this,...e})}get canvas(){return this._renderer.canvas}get renderer(){return this._renderer}get root(){return this._root}get frame(){return this._frame}get time(){return this._time}get frameSetting(){return this._frameSetting}get uniforms(){return this._uniforms}get disposed(){return this._disposed}createView(e){return this._renderer.createView(e)}_createComponentResolver(){return{resolve:t=>e.resources.getComponent(t),getName:t=>{let n=e.resources.componentList.find(e=>t instanceof e.component);return n?n.name:t.constructor.name}}}init(){this._root.disposeRecursive(),this._root.position.set(0,0,0),this._root.euler.set(0,0,0),this._root.scale.set(1,1,1),this.name=`New Project`,this._renderer.reset(),Object.assign(this._frameSetting,Ir),this.stop(),this.seek(0)}async load(e){this.init(),this.deserialize(e),this.emit(`update/graph`),this.emit(`loaded`)}update(t){let n=new Date().getTime();this._time.delta=(n-this._time.current)/1e3,this._time.current=n,this._time.engine+=this._time.delta,this._time.code+=this._time.delta*+!!this._frame.playing,this._frame.current=this._time.code*60;let r=this.createEntityUpdateEvent({forceDraw:t?.forceDraw});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1,this._renderer.globalUniforms.uDeltaTime.value=Math.min(this._time.delta,1/60);let i=e.resources.updateEveryFrameTextures;for(let e=0;e<i.length;e++)i[e].render();return this._step(r),this._frame.playing&&this.emit(`update/frame/play`,[this._frame]),this._time.delta}_step(e){this._root.commitFrame(e),this._root.update(e),this._root.postUpdate(e),this._root.updateMatrixRecursive(),this._root.prepareRender(e),this._renderer.prepareScene(this._root,e),this._frameEvent=e}render(e){this._frameEvent&&this._renderer.render(e,this._frameEvent)}createEntityUpdateEvent(e){let t={playing:this._frame.playing,timeElapsed:this._time.engine,timeDelta:this._time.delta,timeCode:this._time.code,timeCodeFrame:this._frame.current,resolution:this.renderer.resolution,renderer:this.renderer,forceDraw:!1};return e?{...t,...e}:t}setSize(e){this._renderer.resize(e),this._renderer.canvas.width=e.x,this._renderer.canvas.height=e.y,this._renderer.globalUniforms.uResolution.value.copy(e),this._renderer.globalUniforms.uAspectRatio.value=e.x/Math.max(e.y,1)}play(){this._frame.playing=!0,this._time.current=new Date().getTime()}stop(){this._frame.playing=!1}seek(e){this._time.code=e/60,this._frame.current=e,this.emit(`update/frame/play`,[this._frame])}updateOffline(t,n){let r=t/n,i=1/n;this._time.delta=i,this._time.current=new Date().getTime(),this._time.engine+=i,this._time.code=r,this._frame.current=r*60,this._frame.playing=!0;let a=this.createEntityUpdateEvent({forceDraw:!0});this._renderer.globalUniforms.uTime.value=this._time.code,this._renderer.globalUniforms.uTimeF.value=this._time.code%1,this._renderer.globalUniforms.uTimeE.value=this._time.engine,this._renderer.globalUniforms.uTimeEF.value=this._time.engine%1;let o=e.resources.updateEveryFrameTextures;for(let e=0;e<o.length;e++)o[e].render();this._step(a)}compileShaders(e,t){let n=this.createEntityUpdateEvent({forceDraw:!0});return this.renderer.compileShaders(this._root,e,n,t)}dispose(){this._disposed=!0,this._root.disposeRecursive()}};Lr.resources=new Fr;var Rr=class extends It{_pressedKeys;constructor(){super(),this._pressedKeys={};let e=this._onKeyDown.bind(this),t=this._onKeyUp.bind(this);window.addEventListener(`keydown`,e),window.addEventListener(`keyup`,t),this.once(`dispose`,()=>{window.removeEventListener(`keydown`,e),window.removeEventListener(`keyup`,t)})}get pressedKeys(){return this._pressedKeys}_onKeyDown(e){this._pressedKeys[e.key]=!0,this.emit(`keydown`,[e,this._pressedKeys])}_onKeyUp(e){if(this._pressedKeys[e.key]=!1,e.key==`Meta`||e.key==`Control`){let e=Object.keys(this._pressedKeys);for(let t=0;t<e.length;t++)this._pressedKeys[e[t]]=!1}this.emit(`keyup`,[e,this._pressedKeys])}dispose(){this.emit(`dispose`)}},zr=class extends It{_isTouching;element=null;position;delta;constructor(){super(),this.position=new j(NaN,NaN),this.delta=new j(NaN,NaN),this._isTouching=!1;let e=this._onPointer.bind(this,`move`),t=this._onPointer.bind(this,`end`);window.addEventListener(`pointermove`,e),window.addEventListener(`pointerup`,t),window.addEventListener(`dragend`,t);let n=()=>{this.element&&this.removeElement(this.element),window.removeEventListener(`pointermove`,e),window.removeEventListener(`pointerup`,t),window.removeEventListener(`dragend`,t),this.off(`dispose`,n)};this.on(`dispose`,n)}setElement(e){this.element&&this.removeElement(this.element),this.element=e;let t=this._onPointer.bind(this,`start`);e.addEventListener(`pointerdown`,t);let n=r=>{e.isEqualNode(r.elm)&&(e.removeEventListener(`pointerdown`,t),this.off(`unregister`,n))};this.on(`unregister`,n)}removeElement(e){this.emit(`unregister`,[e])}getScreenPosition(e){if(this.position.x!=this.position.x)return new j(NaN,NaN);let t=this.position.clone().divide(e).multiply(2).sub(1);return t.y*=-1,t}getRelativePosition(e,t){let n=e.getClientRects()[0],r=this.position.x-n.left,i=this.position.y-n.top;return t&&(r/=n.width,i/=n.height),new j(r,i)}_setPos(e,t){this.position.x!==this.position.x||this.position.y!==this.position.y?this.delta.set(0,0):this.delta.set(e-this.position.x,t-this.position.y),this.position.set(e,t)}_onPointer(e,t){let n=t.pointerType;(n==null||n==`mouse`&&(t.button==-1||t.button==0)||n==`touch`)&&this._touchEventHandler(t.pageX,t.pageY,e,t)}_touchEventHandler(e,t,n,r){let i=!1,a=e-window.pageXOffset,o=t-window.pageYOffset;n==`start`?(this._isTouching=!0,this._setPos(a,o),this.delta.set(0,0),i=!0):n==`move`?(this._setPos(a,o),this._isTouching&&(i=!0)):n==`end`&&(`targetTouches`in r?r.targetTouches.length==0&&(this._isTouching=!1):this._isTouching=!1,i=!0),i&&this.emit(n,[{pointerEvent:r,position:this.position.clone(),delta:this.delta.clone()}])}dispose(){this.emit(`dispose`)}},Br=(0,b.createContext)(null),Vr=()=>{let e=(0,b.useContext)(Br);if(e===null)throw Error(`useMouseMenu must be used within a MouseMenuProvider`);return e},Hr=(0,b.createContext)(void 0),Ur=()=>(0,b.useContext)(Hr),Wr={compoAdd:`ComponentAdd__compoAdd___LmNvb`,directory:`ComponentAdd__directory___LmNvb`,subDirectory:`ComponentAdd__subDirectory___LmNvb`,picker:`ComponentAdd__picker___LmNvb`},Gr=({group:e,onClickAdd:t})=>{let n=Ur(),[r,i]=(0,b.useState)(!1),a=null,o,s=`dir`,c=e.name.startsWith(`_`)?e.name.slice(1):e.name;`child`in e?a=(0,E.jsx)(E.Fragment,{children:e.child.map((e,n)=>(0,E.jsx)(Gr,{group:e,onClickAdd:t},n))}):(o=()=>t(e),s=`item`);let l=window.matchMedia(`(hover: hover)`).matches;return(0,E.jsxs)(`div`,{className:Wr.directory,onPointerEnter:l?()=>i(!0):void 0,onPointerLeave:l?()=>i(!1):void 0,onClick:e=>{o?o():(e.stopPropagation(),i(!r))},"data-type":s,"data-direction":n?.direction,children:[c,r&&(0,E.jsx)(`div`,{className:Wr.subDirectory,children:a})]})},Kr=e=>{let{editor:t}=Xe(),{pushContent:n,closeAll:r}=Vr(),i=Lr.resources,a=(0,b.useCallback)(a=>{if(!i||!n||!r)return;let o=[],s=n=>{t.api.addComponent(e.entity,n.component),r()};i.componentGroups.forEach((e,t)=>{o.push((0,E.jsx)(Gr,{group:e,onClickAdd:s},t))}),n((0,E.jsx)(`div`,{className:Wr.picker,children:o}))},[n,i,e.entity,r,t]);return(0,E.jsx)(`div`,{className:Wr.compAdd,children:(0,E.jsx)(ie,{onClick:a,children:`Add Component`})})},qr={compoView:`ComponentView__compoView___LmNvb`,head:`ComponentView__head___LmNvb`,name:`ComponentView__name___LmNvb`,check:`ComponentView__check___LmNvb`,delete:`ComponentView__delete___LmNvb`,propertyBlock:`ComponentView__propertyBlock___LmNvb`},Jr=e=>{let t=Object.keys(e.childs);for(let n=0;n<t.length;n++){let r=e.childs[t[n]],{opt:i}=r,a=!1;if(i&&(a=typeof i.hidden==`function`?i.hidden(r.type===`value`?r.value:null):i.hidden||!1),!a&&(r.type===`value`||Jr(r)))return!0}return!1},Yr=({component:e})=>{let{editor:t}=Xe(),[n,r]=A(e,`enabled`),i=e.initiator!==`user`,a=Jr(e.serializeToDirectory()),o=(0,b.useCallback)(n=>{n.stopPropagation();let r=e.entity;if(r){for(let[n,i]of r.components)if(i.uuid===e.uuid){t.api.removeComponent(r,n,e);break}}},[e,t]),s=(0,E.jsxs)(`div`,{className:qr.head,children:[(0,E.jsx)(`div`,{className:qr.name,children:e.constructor.name}),(0,E.jsx)(`div`,{className:qr.delete,children:(0,E.jsx)(`button`,{onClick:o,children:(0,E.jsx)(O,{})})})]});return(0,E.jsx)(`div`,{className:qr.compoView,"data-disable_component":i,children:(0,E.jsx)(`div`,{className:qr.content,children:(0,E.jsx)(ne,{label:s,accordion:a,bg:!0,defaultClose:!1,children:a&&(0,E.jsx)(yt,{target:e})})})})},Xr={container:`ComponentList__container___LmNvb`},Zr=({entity:e})=>{let[t]=A(e,`components`),n=(0,b.useMemo)(()=>{let n=[];return t?(t.forEach(t=>{let r=e.getComponentByUUID(t);r&&n.push((0,E.jsx)(Yr,{component:r},r.uuid))}),n):null},[t,e]);return(0,E.jsx)(`div`,{className:Xr.container,children:n})},Qr=()=>{let{editor:e,engine:t}=Xe(),[n]=A(e,`selectedEntityId`),r=(0,b.useMemo)(()=>{if(n)return t.root.findEntityByUUID(n)},[t,n]);return r?(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(ne,{label:`Fields`,accordion:!0,children:(0,E.jsx)(yt,{target:r})}),(0,E.jsxs)(ne,{label:`Components`,accordion:!0,children:[(0,E.jsx)(Zr,{entity:r}),(0,E.jsx)(Kr,{entity:r})]})]}):null},$r={exportControl:`ExportControl__exportControl___LmV4c`,exportControl_inner:`ExportControl__exportControl_inner___LmV4c`},ei=()=>{let{editor:e}=Xe(),[t,n]=(0,b.useState)(null);return(0,b.useEffect)(()=>{let t=()=>{n(e.exportProgress?{...e.exportProgress}:null)};return e.on(`update/export`,t),()=>{e.off(`update/export`,t)}},[e]),(0,E.jsx)(`div`,{className:$r.exportControl,children:(0,E.jsx)(`div`,{className:$r.exportControl_inner,children:(0,E.jsx)(ne,{label:`MP4`,accordion:!0,children:(0,E.jsx)(ie,{onClick:()=>{e.isExporting||e.exportMP4()},children:t?`Exporting... ${Math.floor(t.current/t.total*100)}%`:`Export MP4`})})})})},ti=(0,b.createContext)(null),ni=()=>{let e=(0,b.useContext)(ti);if(e===null)throw Error(`useOREngine must be used within a OREngineProvider`);return e},ri={container:`GPUTimer__container___LmNvb`,headerRow:`GPUTimer__headerRow___LmNvb`,totalTime:`GPUTimer__totalTime___LmNvb`,toggleButton:`GPUTimer__toggleButton___LmNvb`,controls:`GPUTimer__controls___LmNvb`,control:`GPUTimer__control___LmNvb`,controlLabel:`GPUTimer__controlLabel___LmNvb`,select:`GPUTimer__select___LmNvb`,input:`GPUTimer__input___LmNvb`,group:`GPUTimer__group___LmNvb`,item:`GPUTimer__item___LmNvb`,clickable:`GPUTimer__clickable___LmNvb`,itemRow:`GPUTimer__itemRow___LmNvb`,itemName:`GPUTimer__itemName___LmNvb`,itemTime:`GPUTimer__itemTime___LmNvb`,itemStats:`GPUTimer__itemStats___LmNvb`,progressBar:`GPUTimer__progressBar___LmNvb`,progressFill:`GPUTimer__progressFill___LmNvb`},ii=class{buffer;index;size;filled;constructor(e){this.size=e,this.buffer=Array(e),this.index=0,this.filled=!1}push(e){this.buffer[this.index]=e,this.index=(this.index+1)%this.size,!this.filled&&this.index===0&&(this.filled=!0)}getAverage(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=0;for(let n=0;n<e;n++)t+=this.buffer[n];return t/e}getMax(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]>t&&(t=this.buffer[n]);return t}getMin(){let e=this.filled?this.size:this.index;if(e===0)return 0;let t=this.buffer[0];for(let n=1;n<e;n++)this.buffer[n]<t&&(t=this.buffer[n]);return t}getCount(){return this.filled?this.size:this.index}},ai=class{buffers;windowSize;currentData;constructor(e=30){this.windowSize=e,this.buffers=new Map,this.currentData=new Map}update(e){let t=performance.now();for(let n=0;n<e.length;n++){let r=e[n],i=r.name.split(`/`),a=i[0]||`unknown`,o,s=i[i.length-1],c=s&&s.match(/\[([^\]]+)\]/);c&&(o=c[1]);let l={name:r.name,duration:r.duration,timestamp:t,renderType:a},u=this.buffers.get(r.name);u||(u=new ii(this.windowSize),this.buffers.set(r.name,u)),u.push(r.duration),this.currentData.set(r.name,{...l,entityId:o})}}getStatistics(){let e=[],t=0,n=performance.now(),r=[];return this.currentData.forEach((e,t)=>{n-e.timestamp>1e3&&r.push(t)}),r.forEach(e=>{this.currentData.delete(e)}),this.currentData.forEach(e=>{t+=e.duration}),this.currentData.forEach(n=>{let r=this.buffers.get(n.name);r&&e.push({name:n.name,renderType:n.renderType,entityId:n.entityId,current:n.duration,avg:r.getAverage(),max:r.getMax(),min:r.getMin(),samples:r.getCount(),percentage:t>0?n.duration/t*100:0})}),e}getTotalTime(){let e=0;return this.currentData.forEach(t=>{e+=t.duration}),e}},oi=e=>{if(e<2){let t=e/2;return`rgb(${Math.floor(100+t*100)}, 200, 100)`}if(e<5){let t=(e-2)/3;return`rgb(200, ${Math.floor(200-t*50)}, 100)`}if(e<10){let t=(e-5)/5;return`rgb(200, ${Math.floor(150-t*80)}, ${Math.floor(100-t*50)})`}return`rgb(200, 70, 50)`},si=e=>e>=10?e.toFixed(1):e>=1?e.toFixed(2):e.toFixed(3),ci=e=>e.replace(/\[([^\]]{4,})\]/g,(e,t)=>`[${t.slice(0,3)}]`),li=()=>{let{editor:e}=Xe(),{engine:t}=ni(),[n,r]=(0,b.useState)([]),[i,a]=(0,b.useState)(0),[o,s]=(0,b.useState)(`all`),[c,l]=(0,b.useState)(0),[u,d]=(0,b.useState)(`time`),[f,p]=(0,b.useState)(!1),m=(0,b.useRef)(new ai(30)),h=(0,b.useRef)(0),g=(0,b.useRef)(!1),_=(0,b.useRef)(0),v=(0,b.useCallback)(n=>{if(!n)return;let r=t.root.findEntityByUUID(n);r&&e.selectEntity(r)},[t,e]);(0,b.useEffect)(()=>{let e=t.renderer,n=m.current,i=e=>{f&&(n.update(e),g.current=!0)},o=e=>{g.current&&e-_.current>=300&&(r(n.getStatistics()),a(n.getTotalTime()),g.current=!1,_.current=e),h.current=requestAnimationFrame(o)};return e.on(`timer`,i),h.current=requestAnimationFrame(o),()=>{e.off(`timer`,i),cancelAnimationFrame(h.current)}},[t,f]);let y=n.filter(e=>!(o!==`all`&&e.renderType!==o||e.avg<c)),x=Array.from(new Set(n.map(e=>e.renderType))),S=[...y].sort((e,t)=>u===`time`?t.avg-e.avg:e.name.localeCompare(t.name)),C=i>0?Math.floor(1e3/i):0;return(0,E.jsxs)(`div`,{className:ri.container,children:[(0,E.jsxs)(`div`,{className:ri.headerRow,children:[(0,E.jsxs)(`span`,{className:ri.totalTime,children:[si(i),`ms (`,C,`fps)`]}),(0,E.jsx)(`button`,{className:ri.toggleButton,onClick:()=>p(!f),title:f?`Stop timer`:`Start timer`,children:f?`⏸`:`▶`})]}),(0,E.jsxs)(`div`,{className:ri.controls,children:[(0,E.jsxs)(`div`,{className:ri.control,children:[(0,E.jsx)(`span`,{className:ri.controlLabel,children:`Type`}),(0,E.jsxs)(`select`,{className:ri.select,value:o,onChange:e=>s(e.target.value),children:[(0,E.jsx)(`option`,{value:`all`,children:`All`}),x.map(e=>(0,E.jsx)(`option`,{value:e,children:e},e))]})]}),(0,E.jsxs)(`div`,{className:ri.control,children:[(0,E.jsx)(`span`,{className:ri.controlLabel,children:`Min`}),(0,E.jsx)(`input`,{className:ri.input,type:`number`,min:`0`,step:`0.1`,value:c,onChange:e=>l(parseFloat(e.target.value)||0)})]}),(0,E.jsxs)(`div`,{className:ri.control,children:[(0,E.jsx)(`span`,{className:ri.controlLabel,children:`Sort`}),(0,E.jsxs)(`select`,{className:ri.select,value:u,onChange:e=>d(e.target.value),children:[(0,E.jsx)(`option`,{value:`time`,children:`Time`}),(0,E.jsx)(`option`,{value:`name`,children:`Name`})]})]})]}),(0,E.jsx)(`div`,{className:ri.group,children:S.map((e,t)=>{let n=oi(e.avg),r=i>0?e.avg/i*100:0,a=!!e.entityId;return(0,E.jsxs)(`div`,{className:`${ri.item} ${a?ri.clickable:``}`,onClick:()=>v(e.entityId),children:[(0,E.jsxs)(`div`,{className:ri.itemRow,children:[(0,E.jsx)(`span`,{className:ri.itemName,title:e.name,children:ci(e.name)}),(0,E.jsx)(`span`,{className:ri.itemTime,style:{color:n},children:si(e.avg)}),(0,E.jsx)(`span`,{className:ri.itemStats,children:si(e.max)})]}),(0,E.jsx)(`div`,{className:ri.progressBar,children:(0,E.jsx)(`div`,{className:ri.progressFill,style:{width:`${r}%`,backgroundColor:n}})})]},e.name+t)})})]})},ui={picker:`Picker__picker___LnBpY`,picker_label:`Picker__picker_label___LnBpY`,picker_list:`Picker__picker_list___LnBpY`,picker_list_inner:`Picker__picker_list_inner___LnBpY`,item:`Picker__item___LnBpY`},di=e=>(0,E.jsxs)(`div`,{className:ui.picker,"data-no_bg":e.noBg,children:[e.label&&(0,E.jsx)(`div`,{className:ui.picker_label,children:e.label}),(0,E.jsx)(`div`,{className:ui.picker_list,children:(0,E.jsx)(`div`,{className:ui.picker_list_inner,children:e.list.map((e,t)=>(0,E.jsx)(`div`,{className:ui.item,onClick:e.onClick,children:e.label},t))})})]}),fi={group:`InputGroup__group___Lmdyb`,submit:`InputGroup__submit___Lmdyb`},pi=e=>{let t=e.initialValues,n=[],[r,i]=(0,b.useState)(t);(0,b.useEffect)(()=>{i(t)},[t]);let a=Object.keys(r);for(let e=0;e<a.length;e++){let t=a[e],o=r[t];n.push((0,E.jsx)(tt,{label:t,value:o,onChange:e=>{i({...r,[t]:e})}},e))}let o=(0,b.useRef)(null);return(0,b.useEffect)(()=>{setTimeout(()=>{o.current&&o.current.querySelector(`input`)?.focus()},0)},[]),(0,E.jsx)(`div`,{className:fi.group,ref:o,children:(0,E.jsxs)(`form`,{onSubmit:e=>{e.preventDefault()},children:[(0,E.jsx)(ne,{label:e.title,noMargin:!0,children:n}),(0,E.jsx)(`div`,{className:fi.submit,children:(0,E.jsx)(ie,{type:`submit`,onClick:()=>{e.onSubmit&&e.onSubmit(r)},children:`OK`})})]})})},mi={node:`HierarchyNode__node___Lm5vZ`,self:`HierarchyNode__self___Lm5vZ`,self_name:`HierarchyNode__self_name___Lm5vZ`,icon:`HierarchyNode__icon___Lm5vZ`,selectable:`HierarchyNode__selectable___Lm5vZ`,visibility:`HierarchyNode__visibility___Lm5vZ`,menu:`HierarchyNode__menu___Lm5vZ`,fold:`HierarchyNode__fold___Lm5vZ`,fold_button:`HierarchyNode__fold_button___Lm5vZ`,child:`HierarchyNode__child___Lm5vZ`,child_line:`HierarchyNode__child_line___Lm5vZ`},hi=e=>{let{editor:t,engine:n}=Xe(),[r]=A(t,`selectedEntityId`),i=r!==void 0&&n.root.findEntityByUUID(r),[a,o]=A(e.entity,`visible`),[s,c]=A(t,`unselectableEntityIds`),[l]=A(e.entity,`children`),u=!(s||[]).includes(e.entity.uuid),d=(l||[]).map(e=>n.root.findEntityByUUID(e)).filter(e=>e!==void 0),f=e.depth||0,p=d&&d.concat().sort((e,t)=>e.name.localeCompare(t.name))||[],m=p.length>0,h=f*20,g=e.entity.initiator==`script`,_=(0,b.useMemo)(()=>e.entity.getComponent(en)?(0,E.jsx)(le,{size:14}):e.entity.getComponent(Qt)?(0,E.jsx)(ae,{size:14}):e.entity.getComponent(P)?(0,E.jsx)(ue,{size:14}):null,[e.entity]),v=e.openNodes.has(e.entity.uuid),y=(0,b.useCallback)(t=>{e.setNodeOpen(e.entity.uuid,!v),t.stopPropagation()},[v,e]),x=(0,b.useCallback)(()=>{t&&t.selectEntity(e.entity)},[t,e.entity]),S=(0,b.useCallback)(e=>{e.stopPropagation(),o&&o(!a)},[a,o]),C=(0,b.useCallback)(t=>{t.stopPropagation();let n=new Set(s||[]);u?n.add(e.entity.uuid):n.delete(e.entity.uuid),c(Array.from(n))},[u,s,c,e.entity.uuid]),{pushContent:w,closeAll:T}=Vr(),ee=(0,b.useCallback)(n=>{n.preventDefault(),!(!t||!w||!T||g)&&(t.selectEntity(e.entity),w((0,E.jsx)(di,{label:e.entity.name,list:[{label:`Add Entity`,onClick:()=>{w((0,E.jsx)(pi,{initialValues:{name:``},onSubmit:n=>{let r=t.api.createEntity(e.entity,n.name);t.api.selectEntity(r),T()}}))}},{label:`Delete Entity`,onClick:()=>{t.api.deleteEntity(e.entity),T()}}]})))},[t,e.entity,w,T,g]);return(0,E.jsxs)(`div`,{className:mi.node,"data-no_export":g,children:[(0,E.jsxs)(`div`,{className:mi.self,style:{paddingLeft:h},onClick:x,onContextMenu:ee,"data-selected":i&&i.uuid==e.entity.uuid,children:[(0,E.jsx)(`div`,{className:mi.fold,"data-hnode_open":v,children:m&&(0,E.jsx)(`button`,{className:mi.fold_button,onClick:y,children:(0,E.jsx)(te,{open:v})})}),_&&(0,E.jsx)(`div`,{className:mi.icon,children:_}),(0,E.jsx)(`div`,{className:mi.self_name,children:(0,E.jsx)(`p`,{children:e.entity.name||`-`})}),(0,E.jsx)(`button`,{className:mi.selectable,onClick:C,"data-selectable":u,children:(0,E.jsx)(k,{size:14,selectable:u})}),(0,E.jsx)(`button`,{className:mi.visibility,onClick:S,"data-visible":a!==!1,children:(0,E.jsx)(ce,{size:14,visible:a!==!1})}),!g&&(0,E.jsx)(`button`,{className:mi.menu,onClick:ee,children:`⋯`})]}),m&&(0,E.jsxs)(`div`,{className:mi.child,"data-open":v,children:[p.map(t=>(0,E.jsx)(hi,{entity:t,depth:f+1,openNodes:e.openNodes,setNodeOpen:e.setNodeOpen},t.uuid)),(0,E.jsx)(`div`,{className:mi.child_line,style:{marginLeft:h+4}})]})]})},gi={},_i=`hierarchyOpenNodes`,vi=()=>{try{let e=localStorage.getItem(_i);if(e)return new Set(JSON.parse(e))}catch{}return new Set},yi=e=>{localStorage.setItem(_i,JSON.stringify(Array.from(e)))},bi=()=>{let{editor:e,engine:t}=Xe(),[n]=A(e,`selectedEntityId`),r=t.root,[i,a]=(0,b.useState)(vi),o=(0,b.useCallback)((e,t)=>{a(n=>{let r=new Set(n);return t?r.add(e):r.delete(e),yi(r),r})},[]);return(0,b.useEffect)(()=>{if(!n)return;let e=r.findEntityByUUID(n);if(!e)return;let t=[],i=e.parent;for(;i;)t.push(i.uuid),i=i.parent;a(e=>{if(t.every(t=>e.has(t)))return e;let n=new Set(e);return t.forEach(e=>n.add(e)),yi(n),n})},[n,r]),(0,E.jsx)(`div`,{className:gi.hierarchy,children:r&&(0,E.jsx)(hi,{entity:r,openNodes:i,setNodeOpen:o})})},xi={mouseMenu:`MouseMenu__mouseMenu___Lm1vd`,hide:`MouseMenu__hide___Lm1vd`,menuItem:`MouseMenu__menuItem___Lm1vd`,menuItem_inner:`MouseMenu__menuItem_inner___Lm1vd`,menuItem_inner_inner:`MouseMenu__menuItem_inner_inner___Lm1vd`},Si=()=>{let{itemList:e,containerRef:t,closeAll:n}=Vr();return(0,E.jsxs)(`div`,{className:xi.mouseMenu,ref:t,children:[e&&e.length>0&&(0,E.jsx)(`div`,{className:xi.hide,onClick:()=>{n&&n()}}),e&&e.map(e=>{let t=e.pos;return(0,E.jsx)(Hr.Provider,{value:e,children:(0,E.jsx)(`div`,{className:xi.menuItem,style:{left:0,top:0,transform:`translate(${t.x}px, ${t.y}px)`},children:(0,E.jsx)(`div`,{className:xi.menuItem_inner,children:(0,E.jsx)(`div`,{className:xi.menuItem_inner_inner,"data-direction":e.direction,children:e.elm})})})},e.id)})]})},Ci=0,wi=()=>{let e=(0,b.useRef)(null),t=(0,b.useRef)({x:0,y:0}),n=(0,b.useCallback)(e=>{t.current.x=e.clientX,t.current.y=e.clientY},[]);(0,b.useEffect)(()=>(window.addEventListener(`pointermove`,n),()=>{window.removeEventListener(`pointermove`,n)}),[n]);let[r,i]=(0,b.useState)([]),a=(0,b.useRef)(r);a.current=r;let o=(0,b.useCallback)(e=>{a.current=a.current.filter(t=>t.id!==e),i(a.current)},[]),s=(0,b.useCallback)(()=>{i([])},[]);return{itemList:r,pushContent:(0,b.useCallback)(e=>{let n=Ci++,r={x:t.current.x,y:t.current.y},s={id:n,elm:e,pos:r,direction:(r.x<window.innerWidth/2?`right`:`left`)+`-`+(r.y<window.innerHeight/2?`bottom`:`top`),close:()=>o(n)};return i([...a.current,s]),s},[o]),closeAll:s,containerRef:e}},Ti=e=>{let t=wi();return(0,E.jsx)(Br.Provider,{value:t,children:e.children})},Ei={container:`Canvas__container___LmNvb`},Di=({viewportId:e})=>{let{engine:t,editor:n}=Xe(),r=(0,b.useRef)(null);return(0,b.useEffect)(()=>{let i=r.current;if(!t||!i)return;let a=n.createViewport(e,i);return()=>{a.dispose()}},[t,n,e]),(0,E.jsx)(`div`,{className:Ei.container,role:`presentation`,"aria-label":`3D Canvas`,children:(0,E.jsx)(`canvas`,{ref:r})})},Oi={audioView:`AudioView__audioView___LmF1Z`},ki=class extends It{wrapperElm;canvas;canvasCtx;viewRangeFrame;viewPort;viewPortRange;musicBuffer;resizeObserver;frameSetting;framePlay;constructor(){super(),this.wrapperElm=null,this.canvas=document.createElement(`canvas`),this.canvasCtx=this.canvas.getContext(`2d`),this.viewPort=[0,0,0,0],this.viewPortRange=[0,0];let e=window.localStorage.getItem(`audioViweRange`);this.viewRangeFrame=e?Number(e):2,this.frameSetting={duration:0,fps:60},this.framePlay={current:0,playing:!1},this.musicBuffer=null,this.resizeObserver=new ResizeObserver(this.onResize.bind(this))}onResize(){if(this.wrapperElm){let e=new j(this.wrapperElm.clientWidth,this.wrapperElm.clientHeight);this.canvas.width=e.x,this.canvas.height=e.y}this.render()}render(){if(this.canvasCtx.fillStyle=`#000`,this.canvasCtx.fillRect(0,0,this.canvas.width,this.canvas.height),this.musicBuffer){this.canvasCtx.strokeStyle=`#888`,this.canvasCtx.fillStyle=`#888`;let e=this.musicBuffer.getChannelData(0),t=this.viewPortRange[0]/this.frameSetting.fps,n=this.musicBuffer.sampleRate*t,r=n/this.canvas.width,i=this.frameToPx(0);this.canvasCtx.beginPath();for(let t=0;t<n;t+=r){let a=Math.floor(t-i*r),o=e[Math.round(a)]*1,s=t/n*this.canvas.width,c=(o+1)*(this.canvas.height/2),l=c,u=c;for(let t=0;t<16;t++){let n=(e[Math.round(a+t/16*r)]*1+1)*(this.canvas.height/2);l>n&&(l=n),u<n&&(u=n)}let d=u-l;d>3&&this.canvasCtx.fillRect(s,l,1,d),t==0?this.canvasCtx.moveTo(s,c):this.canvasCtx.lineTo(s,c)}this.canvasCtx.stroke()}this.canvasCtx.fillStyle=`#555`,this.canvasCtx.fillRect(this.canvas.width/2,0,1,this.canvas.height)}setWrapperElm(e){this.wrapperElm&&this.resizeObserver.observe(this.wrapperElm),this.wrapperElm=e,this.resizeObserver.observe(e),this.wrapperElm.appendChild(this.canvas),this.onResize()}setFramePlaying(e){this.framePlay=e,this.viewPort=[this.framePlay.current-this.viewRangeFrame,0,this.framePlay.current+this.viewRangeFrame,0],this.viewPortRange=[this.viewPort[2]-this.viewPort[0],this.viewPort[3]-this.viewPort[1]],this.render()}setViewRangeFrame(e){this.viewRangeFrame=e,this.setFramePlaying(this.framePlay),localStorage.setItem(`audioViweRange`,String(this.viewRangeFrame))}setFrameSetting(e){this.frameSetting=e,this.render()}setMusicBuffer(e){this.musicBuffer=e,this.render()}frameToPx(e){return(e-this.viewPort[0])/this.viewPortRange[0]*this.canvas.width}dispose(){this.wrapperElm&&this.wrapperElm.removeChild(this.canvas),this.resizeObserver.disconnect()}},Ai=()=>{let{editor:e}=Xe(),t=(0,b.useRef)(null),[n,r]=(0,b.useState)();(0,b.useEffect)(()=>{let e=new ki;if(r(e),t.current)return e.setWrapperElm(t.current),()=>{e.dispose()}},[]);let i=e&&e.audioBuffer,[a,o]=(0,b.useState)(),[s,c]=(0,b.useState)({duration:0,fps:0}),[l,u]=(0,b.useState)({current:0,playing:!1});(0,b.useEffect)(()=>{if(!e)return;let t=e.engine,n=e=>{c({duration:e[`timeline/duration`],fps:e[`timeline/fps`]})},r=0,i=()=>{o(r++)},a=e=>{u({...e})};return n(t.serialize()),a(t.frame),t.on(`fields/update`,n),t.on(`update/music`,i),t.on(`update/frame/play`,a),()=>{t.off(`update/frame/setting`,n),t.off(`update/music`,i),t.off(`update/frame/play`,a)}},[e]),(0,b.useEffect)(()=>{n&&i&&n.setMusicBuffer(i)},[n,i,a]),(0,b.useEffect)(()=>{n&&l&&n.setFramePlaying(l)},[n,l]),(0,b.useEffect)(()=>{n&&s&&n.setFrameSetting(s)},[n,s]);let d=(0,b.useCallback)(e=>{if(n){let t=e.deltaY>0?1.1:.9;n.setViewRangeFrame(n.viewRangeFrame*t)}e.preventDefault()},[n]);return(0,b.useEffect)(()=>{let e=t.current;return e&&e.addEventListener(`wheel`,d,{passive:!1}),()=>{e&&e.removeEventListener(`wheel`,d)}},[d]),(0,E.jsx)(`div`,{className:Oi.audioView,ref:t})},ji={cameraPad:`CameraPad__cameraPad___LmNhb`,btn:`CameraPad__btn___LmNhb`},Mi=()=>{let{editor:e}=Xe(),[t]=A(e,`selectedEntityId`);return(0,E.jsxs)(`div`,{className:ji.cameraPad,children:[(0,E.jsx)(`div`,{className:ji.btn,"data-disabled":!t,onClick:()=>{t&&e.focusSelected()},title:`Focus selected ( . )`,children:`Focus`}),(0,E.jsx)(`div`,{className:ji.btn,onClick:()=>{e.syncToSceneCamera()},title:`Move to scene camera ( Esc )`,children:`Scene Cam`})]})},I={screen:`Screen__screen___LnNjc`,header:`Screen__header___LnNjc`,header_tabs:`Screen__header_tabs___LnNjc`,header_tab:`Screen__header_tab___LnNjc`,header_right:`Screen__header_right___LnNjc`,header_item:`Screen__header_item___LnNjc`,content:`Screen__content___LnNjc`,gizmoMode:`Screen__gizmoMode___LnNjc`,gizmoMode_btn:`Screen__gizmoMode_btn___LnNjc`,gizmoMode_separator:`Screen__gizmoMode_separator___LnNjc`,modalStatus:`Screen__modalStatus___LnNjc`,canvas:`Screen__canvas___LnNjc`,audioViewHandle:`Screen__audioViewHandle___LnNjc`,audioView:`Screen__audioView___LnNjc`,displayOptions:`Screen__displayOptions___LnNjc`,displayOptions_btn:`Screen__displayOptions_btn___LnNjc`,overlay:`Screen__overlay___LnNjc`,overlay_field:`Screen__overlay_field___LnNjc`,overlay_label:`Screen__overlay_label___LnNjc`,overlay_separator:`Screen__overlay_separator___LnNjc`,externalBtn:`Screen__externalBtn___LnNjc`},Ni=`viewport`,Pi=({viewportId:e})=>{let{editor:t}=Xe(),n=Je(),[r,i]=A(t,`enableRender`),[a,o]=A(t,`viewports/${e}/preview`),[s,c]=A(t,`viewType`),[l,u]=A(t,`resolutionScale`),[d,f]=A(t,`gizmoMode`),[p,m]=A(t,`transformOrientation`),[h]=A(t,`modalStatus`),[g,_]=A(t,`helpers/show`),[v,y]=A(t,`helpers/empty`),[x,S]=A(t,`helpers/camera`),[C,w]=A(t,`helpers/light`),[T,ee]=A(t,`helpers/grid`),[te,D]=A(t,`helpers/wireframe`),[ne,re]=A(t,`helpers/gizmo`),[ae,oe]=A(t,`helpers/outline`),[se]=st(`showAudioView`),[O,k]=(0,b.useState)(50),ce=(0,b.useRef)(null),[le,ue]=(0,b.useState)(!1),de=(0,b.useRef)(null),fe=(0,b.useCallback)(e=>{de.current&&!de.current.contains(e.target)&&ue(!1)},[]);return(0,b.useEffect)(()=>(le&&document.addEventListener(`pointerdown`,fe),()=>{document.removeEventListener(`pointerdown`,fe)}),[le,fe]),(0,E.jsxs)(`div`,{className:I.screen,children:[(0,E.jsxs)(`div`,{className:I.header,children:[(0,E.jsx)(`div`,{className:I.header_tabs,children:(0,E.jsx)(`div`,{className:I.header_tab,"data-active":!!a,onClick:()=>o&&o(!a),title:`Camera Render`,children:(0,E.jsx)(`svg`,{width:`14`,height:`14`,viewBox:`0 0 512 512`,fill:`currentColor`,xmlns:`http://www.w3.org/2000/svg`,children:(0,E.jsx)(`path`,{d:`M32 144 H336 V368 H32 Z M368 224 L480 152 V360 L368 288 Z`})})})}),(0,E.jsxs)(`div`,{className:I.header_right,children:[(0,E.jsx)(`div`,{className:I.header_item,children:(0,E.jsx)(Ne,{title:`View`,children:(0,E.jsx)(tt,{value:s,format:{type:`select`,list:[`render`,`debug`]},onChange:e=>c&&c(e)})})}),(0,E.jsx)(`div`,{className:I.header_item,children:(0,E.jsx)(Ne,{title:`Res`,children:(0,E.jsx)(tt,{value:l,format:{type:`select`,list:[,,,,,,].fill(0).map((e,t)=>{let n=2**t,r=1/n;return{value:r,label:r==1?`1`:`1/`+n}})},onChange:e=>u&&u(e)})})}),n.isPC&&(0,E.jsx)(`div`,{className:I.externalBtn,children:(0,E.jsx)(ie,{onClick:()=>{t.openInExternalWindow()},children:(0,E.jsxs)(`svg`,{width:`32`,height:`12`,viewBox:`0 0 512 512`,fill:`none`,xmlns:`http://www.w3.org/2000/svg`,children:[(0,E.jsxs)(`g`,{clipPath:`url(#clip0_224_2)`,children:[(0,E.jsx)(`path`,{d:`M96 0V416H512V0H96ZM472 376H136V40H472V376Z`,fill:`#aaa`}),(0,E.jsx)(`path`,{d:`M40 472V296V136V96H0V512H416V472H376H40Z`,fill:`#aaa`}),(0,E.jsx)(`path`,{d:`M232.812 312.829L350.671 194.969V279.766H390.671V126.688H237.594V166.688H322.39L204.531 284.547L232.812 312.829Z`,fill:`#aaa`})]}),(0,E.jsx)(`defs`,{children:(0,E.jsx)(`clipPath`,{id:`clip0_224_2`,children:(0,E.jsx)(`rect`,{width:`512`,height:`512`,fill:`white`})})})]})})})]})]}),(0,E.jsxs)(`div`,{className:I.content,children:[(0,E.jsxs)(`div`,{className:I.displayOptions,ref:de,children:[(0,E.jsx)(`div`,{className:I.displayOptions_btn,"data-active":le,onClick:()=>ue(!le),title:`Display Options`,children:`⚙`}),le&&(0,E.jsxs)(`div`,{className:I.overlay,children:[(0,E.jsx)(`div`,{className:I.overlay_label,children:`Rendering`}),(0,E.jsx)(`div`,{className:I.overlay_field,children:(0,E.jsx)(Ne,{title:`Render`,children:(0,E.jsx)(tt,{value:r,onChange:e=>i&&i(e)})})}),(0,E.jsx)(`div`,{className:I.overlay_separator}),(0,E.jsx)(`div`,{className:I.overlay_label,children:`Helpers`}),(0,E.jsx)(`div`,{className:I.overlay_field,children:(0,E.jsx)(Ne,{title:`Show`,children:(0,E.jsx)(tt,{value:g,onChange:e=>_&&_(e)})})}),(0,E.jsx)(`div`,{className:I.overlay_field,"data-indent":`true`,children:(0,E.jsx)(Ne,{title:`Empty`,children:(0,E.jsx)(tt,{value:v,onChange:e=>y&&y(e)})})}),(0,E.jsx)(`div`,{className:I.overlay_field,"data-indent":`true`,children:(0,E.jsx)(Ne,{title:`Camera`,children:(0,E.jsx)(tt,{value:x,onChange:e=>S&&S(e)})})}),(0,E.jsx)(`div`,{className:I.overlay_field,"data-indent":`true`,children:(0,E.jsx)(Ne,{title:`Light`,children:(0,E.jsx)(tt,{value:C,onChange:e=>w&&w(e)})})}),(0,E.jsx)(`div`,{className:I.overlay_separator}),(0,E.jsx)(`div`,{className:I.overlay_field,children:(0,E.jsx)(Ne,{title:`Grid`,children:(0,E.jsx)(tt,{value:T,onChange:e=>ee&&ee(e)})})}),(0,E.jsx)(`div`,{className:I.overlay_field,children:(0,E.jsx)(Ne,{title:`Wireframe`,children:(0,E.jsx)(tt,{value:te,onChange:e=>D&&D(e)})})}),(0,E.jsx)(`div`,{className:I.overlay_field,children:(0,E.jsx)(Ne,{title:`Gizmo`,children:(0,E.jsx)(tt,{value:ne,onChange:e=>re&&re(e)})})}),(0,E.jsx)(`div`,{className:I.overlay_field,children:(0,E.jsx)(Ne,{title:`Outline`,children:(0,E.jsx)(tt,{value:ae,onChange:e=>oe&&oe(e)})})})]})]}),(0,E.jsxs)(`div`,{className:I.gizmoMode,children:[[`select`,`translate`,`rotate`,`scale`].map(e=>(0,E.jsx)(`div`,{className:I.gizmoMode_btn,"data-active":d===e,onClick:()=>f&&f(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`select`?`↖`:e===`translate`?`T`:e===`rotate`?`R`:`S`},e)),(0,E.jsx)(`div`,{className:I.gizmoMode_separator}),[`global`,`local`].map(e=>(0,E.jsx)(`div`,{className:I.gizmoMode_btn,"data-active":p===e,onClick:()=>m&&m(e),title:e.charAt(0).toUpperCase()+e.slice(1),children:e===`global`?`G`:`L`},e))]}),h&&(0,E.jsx)(`div`,{className:I.modalStatus,children:h}),(0,E.jsx)(`div`,{className:I.canvas,children:(0,E.jsx)(Di,{viewportId:e})}),n.isSP&&(0,E.jsx)(Mi,{}),n.isPC&&se&&(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(`div`,{className:I.audioViewHandle,onPointerDown:e=>{e.preventDefault(),e.currentTarget.setPointerCapture(e.pointerId),ce.current={startY:e.clientY,startHeight:O}},onPointerMove:e=>{if(!ce.current)return;let t=ce.current.startY-e.clientY,n=Math.max(20,Math.min(400,ce.current.startHeight+t));k(n)},onPointerUp:()=>{ce.current=null}}),(0,E.jsx)(`div`,{className:I.audioView,style:{height:O},children:(0,E.jsx)(Ai,{})})]})]})]})},Fi={overlay:`DragOverlay__overlay___Lm92Z`,zone:`DragOverlay__zone___Lm92Z`,insert:`DragOverlay__insert___Lm92Z`,ghost:`DragOverlay__ghost___Lm92Z`},Ii=12,L=e=>{let t=(0,b.useRef)(null),n=e.drag.startX,r=e.drag.startY;(0,b.useEffect)(()=>{let e=(e,n)=>{let r=t.current;r&&(r.style.transform=`translate(${e+Ii}px, ${n+Ii}px)`)};e(n,r);let i=t=>e(t.clientX,t.clientY);window.addEventListener(`pointermove`,i);let a=document.body.style.userSelect;return document.body.style.userSelect=`none`,()=>{window.removeEventListener(`pointermove`,i),document.body.style.userSelect=a}},[n,r]);let i=e.drag.target;return(0,E.jsxs)(`div`,{className:Fi.overlay,children:[i&&(0,E.jsx)(`div`,{className:i.kind===`tabs`?Fi.insert:Fi.zone,style:{left:`${i.rect.left}px`,top:`${i.rect.top}px`,width:`${i.rect.width}px`,height:`${i.rect.height}px`}}),(0,E.jsx)(`div`,{className:Fi.ghost,ref:t,children:e.drag.title})]})};function Li(e,t){let n=e.get(t);if(n)return n;let r=t.indexOf(`:`);if(r===-1)return;let i=e.get(t.slice(0,r));return i?.multiple?i:void 0}function Ri(e){return e.slice(e.indexOf(`:`)+1)}function zi(e){return e.multiple?`${e.id}:${crypto.randomUUID()}`:e.id}function Bi(e,t){return e.multiple?e.content(Ri(t)):e.content}var Vi=(e,t)=>({type:`split`,id:crypto.randomUUID(),direction:e,children:t}),Hi=e=>({type:`pane`,id:crypto.randomUUID(),tabs:e,active:e[0]});function Ui(){return Vi(`vertical`,[{ratio:916/1076,node:Vi(`horizontal`,[{ratio:300/1912,node:Vi(`vertical`,[{ratio:696/912,node:Hi([`hierarchy`,`scene`])},{ratio:216/912,node:Hi([`timer`])}])},{ratio:1312/1912,node:Hi([`viewport:main`])},{ratio:300/1912,node:Hi([`property`,`textures`,`renderer`,`editor-settings`])}])},{ratio:160/1076,node:Hi([`timeline`,`export`])}])}function Wi(e){return e.type===`pane`?[e]:e.children.flatMap(e=>Wi(e.node))}var Gi=e=>{if(e.type===`pane`)return e.tabs.length>0?e:null;let t=[];if(e.children.forEach(n=>{let r=Gi(n.node);r&&(r.type===`split`&&r.direction===e.direction?r.children.forEach(e=>t.push({ratio:n.ratio*e.ratio,node:e.node})):t.push(r===n.node?n:{...n,node:r}))}),t.length===0)return null;if(t.length===1)return t[0].node;let n=t.reduce((e,t)=>e+t.ratio,0);return Math.abs(n-1)>1e-6?{...e,children:t.map(e=>({...e,ratio:e.ratio/n}))}:t.length!==e.children.length||t.some((t,n)=>t!==e.children[n])?{...e,children:t}:e};function Ki(e,t){let n=new Set,r=new Set,i=e=>{let t=typeof e==`string`&&e!==``&&!n.has(e)?e:crypto.randomUUID();return n.add(t),t},a=e=>{if(typeof e!=`object`||!e)return null;let n=e;if(n.type===`pane`){if(!Array.isArray(n.tabs))return null;let e=[...new Set(n.tabs.filter(e=>typeof e==`string`))].filter(e=>{let n=t(e);return n?!n.multiple||!r.has(e)&&(r.add(e),!0):!1});if(e.length===0)return null;let a=typeof n.active==`string`&&e.includes(n.active)?n.active:e[0];return{type:`pane`,id:i(n.id),tabs:e,active:a}}if(n.type===`split`){if(n.direction!==`horizontal`&&n.direction!==`vertical`||!Array.isArray(n.children))return null;let e=[];return n.children.forEach(t=>{if(typeof t!=`object`||!t)return;let n=t,r=a(n.node);if(!r)return;let i=typeof n.ratio==`number`&&isFinite(n.ratio)&&n.ratio>0?n.ratio:1;e.push({ratio:i,node:r})}),e.length===0?null:e.length===1?e[0].node:{type:`split`,id:i(n.id),direction:n.direction,children:e}}return null},o=a(e);return o?Gi(o):null}var qi=(e,t,n)=>{if(e.id===t)return n(e);if(e.type===`split`){let r=!1,i=e.children.map(e=>{let i=qi(e.node,t,n);return i===e.node?e:(r=!0,{...e,node:i})});if(r)return{...e,children:i}}return e};function Ji(e,t,n){return qi(e,t,e=>e.type!==`pane`||!e.tabs.includes(n)?e:{...e,active:n})}function Yi(e,t,n,r){return qi(e,t,e=>{if(e.type!==`pane`||e.tabs.includes(n))return e;let t=[...e.tabs];return t.splice(Math.max(0,Math.min(r??t.length,t.length)),0,n),{...e,tabs:t,active:n}})}function Xi(e,t,n,r,i){if(t===r)return qi(e,t,e=>{if(e.type!==`pane`)return e;let t=e.tabs.indexOf(n);if(t===-1)return e;let r=e.tabs.filter(e=>e!==n),a=i??e.tabs.length,o=Math.max(0,Math.min(t<a?a-1:a,r.length));return o===t?e:(r.splice(o,0,n),{...e,tabs:r,active:n})});let a=Wi(e),o=a.find(e=>e.id===t),s=a.find(e=>e.id===r);return!o||!s||!o.tabs.includes(n)||s.tabs.includes(n)?e:Yi(Qi(e,t,n),r,n,i)}function Zi(e,t,n,r,i){let a=Wi(e),o=a.find(e=>e.id===r);if(!o||!o.tabs.includes(i)||!a.some(e=>e.id===t)||r===t&&o.tabs.length===1)return e;let s=Qi(e,r,i),c={type:`pane`,id:crypto.randomUUID(),tabs:[i],active:i},l=qi(s,t,e=>{let t=[{ratio:.5,node:c},{ratio:.5,node:e}];return(n===`right`||n===`bottom`)&&t.reverse(),{type:`split`,id:crypto.randomUUID(),direction:n===`left`||n===`right`?`horizontal`:`vertical`,children:t}});return l===s?e:Gi(l)??e}function Qi(e,t,n){let r=qi(e,t,e=>{if(e.type!==`pane`||!e.tabs.includes(n))return e;let t=e.tabs.indexOf(n),r=e.tabs.filter(e=>e!==n),i=e.active!==n||r.length===0?e.active:r[Math.min(t,r.length-1)];return{...e,tabs:r,active:i}});return r===e?e:Gi(r)??e}function $i(e,t,n){return qi(e,t,e=>e.type!==`split`||e.children.length!==n.length?e:{...e,children:e.children.map((e,t)=>({...e,ratio:n[t]}))})}var ea=4,ta=.25,na=(e,t)=>{let n={left:e.left,top:e.top,width:e.width,height:e.height};return(t===`left`||t===`right`)&&(n.width/=2),t===`right`&&(n.left+=n.width),(t===`top`||t===`bottom`)&&(n.height/=2),t===`bottom`&&(n.top+=n.height),n},ra=(e,t,n,r,i)=>{if(n.id!==r&&n.tabs.includes(i))return null;let a=[...t.querySelectorAll(`[data-panel-tab-id]`)].filter(e=>e instanceof HTMLElement),o=a.length;for(let t=0;t<a.length;t++){let n=a[t].getBoundingClientRect();if(e<n.left+n.width/2){o=t;break}}let s=t.getBoundingClientRect(),c=o<a.length?a[o].getBoundingClientRect().left:a.length>0?a[a.length-1].getBoundingClientRect().right:s.left;return{kind:`tabs`,paneId:n.id,index:o,rect:{left:c-1,top:s.top,width:2,height:s.height}}},ia=(e,t,n,r,i)=>{let a=document.elementFromPoint(e,t);if(!a)return null;let o=a.closest(`[data-pane-id]`);if(!(o instanceof HTMLElement))return null;let s=Wi(n).find(e=>e.id===o.dataset.paneId);if(!s)return null;let c=a.closest(`[data-panel-tab-header]`);if(c instanceof HTMLElement)return ra(e,c,s,r,i);let l=o.querySelector(`[data-panel-content]`);if(!(l instanceof HTMLElement))return null;let u=l.getBoundingClientRect();if(u.width<=0||u.height<=0)return null;let d=(e-u.left)/u.width,f=(t-u.top)/u.height;if(d<0||d>1||f<0||f>1)return null;if(Math.min(d,1-d)>ta&&Math.min(f,1-f)>ta)return s.id===r||s.tabs.includes(i)?null:{kind:`zone`,paneId:s.id,zone:`center`,rect:na(u,`center`)};if(s.id===r&&s.tabs.length===1)return null;let p=d-.5,m=f-.5,h=Math.abs(p)>=Math.abs(m)?p<0?`left`:`right`:m<0?`top`:`bottom`;return{kind:`zone`,paneId:s.id,zone:h,rect:na(u,h)}},aa=(e,t)=>e===null||t===null?e===t:e.paneId===t.paneId?e.kind===`tabs`&&t.kind===`tabs`?e.index===t.index:e.kind===`zone`&&t.kind===`zone`&&e.zone===t.zone:!1;function oa(e,t,n){let[r,i]=(0,b.useState)(null),a=(0,b.useRef)(e);a.current=e;let o=(0,b.useRef)(t);o.current=t;let s=(0,b.useRef)(null);return(0,b.useEffect)(()=>()=>s.current?.(),[]),{dragState:r,onTabPointerDown:(e,t,r)=>{if(r.button!==0||s.current)return;let c=r.clientX,l=r.clientY,u=!1,d=null,f=r=>{if(r.buttons===0){p(!1);return}if(!u){if(Math.hypot(r.clientX-c,r.clientY-l)<ea)return;u=!0,i({panelId:t,title:n(t)?.title??t,startX:r.clientX,startY:r.clientY,target:null})}let o=ia(r.clientX,r.clientY,a.current,e,t);aa(o,d)||(d=o,i(e=>e&&{...e,target:o}))},p=n=>{if(g(),n&&u&&d){let n=a.current;d.kind===`tabs`?o.current(Xi(n,e,t,d.paneId,d.index)):d.zone===`center`?o.current(Xi(n,e,t,d.paneId)):o.current(Zi(n,d.paneId,d.zone,e,t))}u&&i(null)},m=()=>p(!0),h=()=>p(!1),g=()=>{window.removeEventListener(`pointermove`,f),window.removeEventListener(`pointerup`,m),window.removeEventListener(`pointercancel`,h),s.current=null};s.current=g,window.addEventListener(`pointermove`,f),window.addEventListener(`pointerup`,m),window.addEventListener(`pointercancel`,h)}}}var sa={pane:`PanelLayout__pane___LnBhb`},ca=e=>{let t=e.node;if(t.type===`split`)return(0,E.jsx)(Re,{direction:t.direction,ratios:t.children.map(e=>e.ratio),onRatiosChange:n=>e.onRatiosChange(t.id,n),children:t.children.map(t=>(0,E.jsx)(Re.Item,{children:(0,E.jsx)(ca,{...e,node:t.node})},t.node.id))});let n=t.tabs.flatMap(t=>{let n=e.resolve(t);return n?[{id:t,title:n.title,content:Bi(n,t)}]:[]});if(n.length===0)return null;let r=e.hasAddable(t);return(0,E.jsx)(`div`,{className:sa.pane,"data-pane-id":t.id,children:(0,E.jsx)(Ue,{tabs:n,active:t.active,onSelect:n=>e.onSelectTab(t.id,n),onTabContextMenu:(n,r)=>e.onTabContextMenu(t.id,n,r),onTabPointerDown:(n,r)=>e.onTabPointerDown(t.id,n,r),onAddClick:r?()=>e.onAddTab(t.id):void 0})})},la=e=>{let{editor:t}=Xe(),{pushContent:n,closeAll:r}=Vr(),i=(0,b.useMemo)(()=>{let t=new Map;return e.panels.forEach(e=>t.set(e.id,e)),t},[e.panels]),a=(0,b.useMemo)(()=>e=>Li(i,e),[i]),[o,s]=A(t,`panelLayout`),c=(0,b.useMemo)(()=>Ki(o,a)??Ui(),[o,a]);(0,b.useEffect)(()=>{let e=new Set(Wi(c).flatMap(e=>e.tabs).filter(e=>a(e)?.id===Ni).map(Ri));t.pruneViewportSettings(e)},[c,a,t]);let l=e=>{e!==c&&s(e)},u=(e,t)=>l(Ji(c,e,t)),d=(e,t)=>l($i(c,e,t)),{dragState:f,onTabPointerDown:p}=oa(c,l,a),m=e=>[...i.values()].filter(t=>t.multiple||!e.tabs.includes(t.id));return(0,E.jsxs)(E.Fragment,{children:[(0,E.jsx)(ca,{node:c,resolve:a,onSelectTab:u,onRatiosChange:d,onTabContextMenu:(e,t,i)=>{i.preventDefault(),Wi(c).reduce((e,t)=>e+t.tabs.length,0)>1&&n((0,E.jsx)(di,{label:a(t)?.title,list:[{label:`Close Tab`,onClick:()=>{l(Qi(c,e,t)),r()}}]}))},onTabPointerDown:p,onAddTab:e=>{let t=Wi(c).find(t=>t.id===e);if(!t)return;let i=m(t);i.length!==0&&n((0,E.jsx)(di,{list:i.map(t=>({label:t.title,onClick:()=>{l(Yi(c,e,zi(t))),r()}}))}))},hasAddable:e=>m(e).length>0}),f&&(0,E.jsx)(L,{drag:f})]})},ua={renderer:`RendererSettings__renderer___LnJlb`,renderer_inner:`RendererSettings__renderer_inner___LnJlb`},da=()=>{let{editor:e}=Xe(),t=e.engine.renderer;return(0,E.jsx)(`div`,{className:ua.renderer,children:(0,E.jsxs)(`div`,{className:ua.renderer_inner,children:[(0,E.jsx)(ne,{label:`Resolution`,accordion:!0,children:(0,E.jsx)(yt,{target:e,filter:`resolution`})}),(0,E.jsx)(ne,{label:`Pipeline`,accordion:!0,children:(0,E.jsx)(yt,{target:t,filter:`pipeline`})}),(0,E.jsx)(ne,{label:`Sky`,accordion:!0,children:(0,E.jsx)(yt,{target:t,filter:`sky`})})]})})},fa={sceneWindow:`SceneWindow__sceneWindow___LnNjZ`,overlay:`SceneWindow__overlay___LnNjZ`,window:`SceneWindow__window___LnNjZ`,head:`SceneWindow__head___LnNjZ`,head_title:`SceneWindow__head_title___LnNjZ`,head_project:`SceneWindow__head_project___LnNjZ`,head_close:`SceneWindow__head_close___LnNjZ`,list:`SceneWindow__list___LnNjZ`,item:`SceneWindow__item___LnNjZ`,item_name:`SceneWindow__item_name___LnNjZ`,item_badge:`SceneWindow__item_badge___LnNjZ`,newItem:`SceneWindow__newItem___LnNjZ`,newItem_input:`SceneWindow__newItem_input___LnNjZ`,newItem_error:`SceneWindow__newItem_error___LnNjZ`,footer:`SceneWindow__footer___LnNjZ`,footer_message:`SceneWindow__footer_message___LnNjZ`,footer_spacer:`SceneWindow__footer_spacer___LnNjZ`,footer_button:`SceneWindow__footer_button___LnNjZ`},pa=/^[A-Za-z0-9_-]+$/,ma=e=>{let{scenes:t,onClose:n}=e,[r,i]=(0,b.useState)(t.current),[a,o]=(0,b.useState)(null),[s,c]=(0,b.useState)(null),[l,u]=(0,b.useState)(!1),d=(0,b.useCallback)(e=>{e!==t.current&&t.onSelect(e),n()},[t,n]);(0,b.useEffect)(()=>{let e=e=>{if(e.key===`Escape`){if(a!==null){o(null),c(null);return}if(l){u(!1);return}n()}};return window.addEventListener(`keydown`,e),()=>{window.removeEventListener(`keydown`,e)}},[a,l,n]);let f=()=>{let e=(a??``).trim();if(!pa.test(e)){c(`A-Z a-z 0-9 - _ のみ使えます`);return}if(t.names.includes(e)){c(`"${e}" は既にあります`);return}t.onCreate(e),n()},p=()=>{r&&(t.onDelete(r),i(null),u(!1))},m=[];for(let e of t.names){let n=e===t.current;m.push((0,E.jsxs)(`div`,{className:fa.item,"data-selected":e===r,onClick:()=>{i(e),u(!1)},onDoubleClick:()=>{d(e)},children:[(0,E.jsx)(`span`,{className:fa.item_name,children:e}),n&&(0,E.jsx)(`span`,{className:fa.item_badge,children:`opened`})]},e))}let h=null;a!==null&&(h=(0,E.jsxs)(`div`,{className:fa.newItem,children:[(0,E.jsx)(`form`,{onSubmit:e=>{e.preventDefault(),f()},children:(0,E.jsx)(`input`,{className:fa.newItem_input,autoFocus:!0,value:a,placeholder:`scene name`,onChange:e=>{o(e.target.value),c(null)}})}),s&&(0,E.jsx)(`div`,{className:fa.newItem_error,children:s})]}));let g=null;if(l&&r)g=(0,E.jsxs)(`div`,{className:fa.footer,children:[(0,E.jsxs)(`span`,{className:fa.footer_message,children:[`Delete "`,r,`" ?`]}),(0,E.jsx)(`div`,{className:fa.footer_button,children:(0,E.jsx)(ie,{onClick:()=>{u(!1)},children:`Cancel`})}),(0,E.jsx)(`div`,{className:fa.footer_button,children:(0,E.jsx)(ie,{onClick:p,children:`Delete`})})]});else{let e=r!==null&&t.names.length>1,n=r!==null&&r!==t.current;g=(0,E.jsxs)(`div`,{className:fa.footer,children:[(0,E.jsx)(`div`,{className:fa.footer_button,children:(0,E.jsx)(ie,{onClick:()=>{o(``),c(null),u(!1)},children:`+ New`})}),(0,E.jsx)(`div`,{className:fa.footer_spacer}),(0,E.jsx)(`div`,{className:fa.footer_button,children:(0,E.jsx)(ie,{disabled:!e,onClick:()=>{u(!0)},children:`Delete`})}),(0,E.jsx)(`div`,{className:fa.footer_button,children:(0,E.jsx)(ie,{disabled:!n,onClick:()=>{r&&d(r)},children:`Open`})})]})}return(0,E.jsxs)(`div`,{className:fa.sceneWindow,children:[(0,E.jsx)(`div`,{className:fa.overlay,onClick:n}),(0,E.jsxs)(`div`,{className:fa.window,children:[(0,E.jsxs)(`div`,{className:fa.head,children:[(0,E.jsx)(`span`,{className:fa.head_title,children:`Scenes`}),e.projectName&&(0,E.jsx)(`span`,{className:fa.head_project,children:e.projectName}),(0,E.jsx)(`button`,{type:`button`,className:fa.head_close,onClick:n,children:`×`})]}),(0,E.jsxs)(`div`,{className:fa.list,children:[m,h]}),g]})]})},ha={sceneControl:`SceneControl__sceneControl___LnNjZ`,sceneControl_inner:`SceneControl__sceneControl_inner___LnNjZ`,select:`SceneControl__select___LnNjZ`,select_name:`SceneControl__select_name___LnNjZ`},ga=()=>{let{editor:e,projectName:t,scenes:n}=Xe(),[r,i]=(0,b.useState)(!1),a=null;return n&&(a=(0,E.jsx)(Ne,{title:`scene`,children:(0,E.jsxs)(`button`,{className:ha.select,onClick:()=>{i(!0)},children:[(0,E.jsx)(`span`,{className:ha.select_name,children:n.current??`-`}),(0,E.jsx)(te,{open:!0})]})})),(0,E.jsxs)(`div`,{className:ha.sceneControl,children:[(0,E.jsx)(`div`,{className:ha.sceneControl_inner,children:(0,E.jsxs)(ne,{label:t,accordion:!0,children:[a,(0,E.jsx)(ie,{onClick:()=>{e.save()},children:`Save`})]})}),r&&n&&(0,E.jsx)(ma,{scenes:n,projectName:t,onClose:()=>{i(!1)}})]})},_a={textures:`Textures__textures___LnRle`,item:`Textures__item___LnRle`,preview:`Textures__preview___LnRle`,img:`Textures__img___LnRle`,placeholder:`Textures__placeholder___LnRle`,name:`Textures__name___LnRle`},va=()=>{let{engine:e,editor:t}=Xe(),[,n]=(0,b.useState)(0);(0,b.useEffect)(()=>{let e=()=>{t.assetPreviewManager?.invalidateAll(),n(e=>e+1)},r=()=>n(e=>e+1);return Lr.resources.on(`update`,e),t.assetPreviewManager?.on(`update`,r),()=>{Lr.resources.off(`update`,e),t.assetPreviewManager?.off(`update`,r)}},[e,t]);let r=Lr.resources.textureList;return(0,E.jsx)(`div`,{className:_a.textures,children:r.map(e=>{let n=t.assetPreviewManager?.getTexturePreview(e.name);return(0,E.jsxs)(`div`,{className:_a.item,children:[(0,E.jsx)(`div`,{className:_a.preview,children:n?(0,E.jsx)(`img`,{src:n,className:_a.img}):(0,E.jsx)(`div`,{className:_a.placeholder})}),(0,E.jsx)(`div`,{className:_a.name,children:e.name})]},e.name)})})},ya=(0,b.createContext)(null),ba=()=>{let e=(0,b.useContext)(ya);if(e===null)throw Error(`useTimeline must be used within a TimelineProvider`);return e},xa=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Yf=s({EyeRings:()=>Xf}),Xf=class extends Kt{constructor(e){super(e);let t=this.engine,n=new an({thetaSegments:64,innerRadius:4,outerRadius:4.01,extrude:.01}),r=[];for(let e=0;e<8;e++)r.push(-1,e,e/7),r.push(1,e,e/7);n.setAttribute(`instance`,new Float32Array(r),3,{instanceDivisor:1});let i=new fn({phase:[`deferred`,`shadowMap`],frag:qf,vert:Jf,uniforms:t.uniforms});this.entity.addComponent(P,{geometry:n,material:i})}dispose(){super.dispose(),this.entity.removeComponent(P)}},Zf=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,$f=s({FlashLine:()=>ep}),ep=class extends Kt{geometry;material;constructor(e){super(e);let t=this.engine;this.geometry=new Yt({radiusBottom:.02,radiusTop:.02,radSegments:8,height:50});let n=[];for(let e=0;e<32;e++){let e=St.randomVector().multiply(new j(20,1,20));n.push(e.x,e.y,e.z,Math.random())}this.geometry.setAttribute(`oPos`,new Float32Array(n),4,{instanceDivisor:1}),this.material=new fn({phase:[`forward`,`envMap`],frag:sn(`flFrag`,Zf),vert:sn(`flVert`,Qf),uniforms:un.merge(t.uniforms)}),this.entity.addComponent(P,{material:this.material,geometry:this.geometry})}},tp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,np=s({SkyBox:()=>rp}),rp=class extends Kt{material;constructor(e){super(e);let t=this.engine;this.material=new fn({name:`SkyBox`,phase:[`deferred`,`envMap`],frag:sn(`SkyBoxFrag`,tp),uniforms:un.merge(t.uniforms,{uAspectRatio:{value:0,type:`1f`}})}),t.renderer.sky.mesh.material=this.material}},ip=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,op=s({GridCross:()=>sp}),sp=class extends Kt{constructor(e){super(e);let t=new Jt({width:.05,height:.5,depth:.05}),n=[],r=[],i=new j(16,2,16);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(Math.PI/2,0,0),n.push(o,s,c),r.push(0,0,Math.PI/2)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new fn({frag:sn(`gridCrossFrag`,ip),vert:sn(`gridCrossVert`,ap),phase:[`forward`]});this.entity.addComponent(P,{geometry:t,material:a})}},cp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,up=s({GridDots:()=>dp}),dp=class extends Kt{constructor(e){super(e);let t=new Zt({radius:.1}),n=[],r=[],i=new j(32,2,32);for(let e=0;e<i.x;e++)for(let t=0;t<i.y;t++)for(let a=0;a<i.z;a++){let o=(e/(i.x-1)-.5)*1,s=(t/(i.y-1)-.5)*1,c=(a/(i.z-1)-.5)*1;n.push(o,s,c),r.push(0,0,0)}t.setAttribute(`instanceRot`,new Float32Array(r),3,{instanceDivisor:1}),t.setAttribute(`instancePos`,new Float32Array(n),3,{instanceDivisor:1});let a=new fn({frag:sn(`gridDotsFrag`,cp),vert:sn(`gridDotsVert`,lp),phase:[`forward`]});this.entity.addComponent(P,{geometry:t,material:a})}},fp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
vVelocity *= 0.2;\r
\r
}`,mp=s({WireCube:()=>hp}),hp=class extends Kt{constructor(e){super(e);let t=this.engine,n=3.3,r=n/2,i=new Jt({width:.01,height:n,depth:.01,segmentsHeight:16}),a=[],o=[];for(let e=0;e<3;e++)for(let t=0;t<4;t++)[[r,0,r],[r,0,-1.65],[-1.65,0,r],[-1.65,0,-1.65]][t].forEach(e=>{a.push(e)}),[[0,0,0],[Math.PI/2,0,0],[0,0,Math.PI/2]][e].forEach(e=>{o.push(e)});i.setAttribute(`instancePos`,new Float32Array(a),3,{instanceDivisor:1}),i.setAttribute(`instanceRot`,new Float32Array(o),3,{instanceDivisor:1});let s=new fn({phase:[`deferred`],frag:fp,vert:pp,uniforms:un.merge(t.uniforms)});this.entity.addComponent(P,{geometry:i,material:s})}},gp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,vp=s({OREngineCube:()=>yp}),yp=class extends Kt{material;constructor(e){super(e);let t=this.engine;this.material=new fn({name:`OREngineCube`,phase:[`shadowMap`,`deferred`],vert:sn(`OREngineCubeVert`,_p),frag:sn(`OREngineCubeFrag`,gp),uniforms:un.merge(t.uniforms,{uNoiseTex:{value:Lr.resources.getTexture(`noise`),type:`1i`}})});let n=this.entity.getComponent(P);n&&(n.material=this.material)}},bp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Sp=s({OREngineLogo:()=>Cp}),Cp=class extends Kt{material;constructor(e){super(e);let t=this.engine;this.material=new fn({name:`OREngineLogo`,phase:[`deferred`,`shadowMap`],vert:sn(`OREngineLogoVert`,xp),frag:sn(`OREngineLogoFrag`,bp),uniforms:un.merge(t.uniforms)});let n=this.entity.getComponent(P);n&&(n.material=this.material)}},wp=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
}`,Ep=s({Dust:()=>Dp}),Dp=class extends Kt{constructor(e){super(e);let t=this.engine,n=new qt,r=e.args?.num||2048,i=new j(20,5,20),a=[],o=[];for(let e=0;e<r;e++)a.push((Math.random()-.5)*i.x),a.push((Math.random()-.5)*i.y),a.push((Math.random()-.5)*i.z),o.push(Math.random());n.setAttribute(`position`,new Float32Array(a),3);let s=new fn({phase:[`forward`],drawType:`POINTS`,frag:wp,vert:Tp,uniforms:un.merge(t.uniforms)});this.entity.addComponent(P,{geometry:n,material:s})}dispose(){super.dispose(),this.entity.removeComponent(P)}},Op=`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
} `},em={name:`noise`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!0,frag:`#define PI 3.14159265359\r
#define TPI 6.28318530718\r
#define HPI 1.57079632679\r
#define saturate(x) clamp(x,0.,1.)\r
\r
...
\r
	...
	outColor.xyz = n;\r
\r
} `,nm=Object.assign({"../../demo-webgl/Resources/Textures/hash.tex":$p,"../../demo-webgl/Resources/Textures/noise.tex":em,"../../demo-webgl/Resources/Textures/noiseCyclic.tex":{name:`noiseCyclic`,resolution:[1024,1024],filter:`linear`,updateEveryFrame:!1,frag:tm},"../../demo-webgl/Resources/Textures/noiseCyclicAnime.tex":{name:`noiseCyclicAnime`,resolution:[512,512],filter:`linear`,updateEveryFrame:!0,frag:tm}}),rm=()=>{for(let e of Object.values(nm))e&&Lr.resources.addTextureResource(e.name,{frag:e.frag,resolution:e.resolution||[1024,1024],filter:e.filter,updateEveryFrame:e.updateEveryFrame,textures:e.textures})},im=e=>{Lr.resources.buildTextureInstances(e.renderer,e.uniforms)},am=Object.assign({"../../demo-webgl/Resources/Components/Samples/Effects/EyeRings/index.ts":Yf,"../../demo-webgl/Resources/Components/Samples/Effects/FlashLine/index.ts":$f,"../../demo-webgl/Resources/Components/Samples/Environment/SkyBox/index.ts":np,"../../demo-webgl/Resources/Components/Samples/Geometry/GridCross/index.ts":op,"../../demo-webgl/Resources/Components/Samples/Geometry/GridDots/index.ts":up,"../../demo-webgl/Resources/Components/Samples/Geometry/WireCube/index.ts":mp,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineCube/index.ts":vp,"../../demo-webgl/Resources/Components/Samples/Objects/OREngineLogo/index.ts":Sp,"../../demo-webgl/Resources/Components/Samples/Particles/Dust/index.ts":Ep,"../../demo-webgl/Resources/Components/Samples/Particles/YakiSoba/index.ts":jp}),om=Object.assign({}),sm=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addComponent(i,a):sm(a,t.createGroup(i))}},cm=(e,t)=>{let n=Object.keys(e);for(let r=0;r<n.length;r++){let i=n[r],a=e[i];typeof a==`function`?t.addGeometry(i,a):cm(a,t.createGroup(i))}};document.title=`demo-webgl`,(()=>{Wt.gltfLoaderFactory=e=>new br(e),Lr.resources.clear();let e=Lr.resources.addComponentGroup(`_Built-in`);e.addComponent(`Light`,en),e.addComponent(`Camera`,Qt),e.addComponent(`Mesh`,P);let t=Object.keys(Zp);for(let e=0;e<t.length;e++){let n=t[e],r=Zp[n];sm(r,Lr.resources.addComponentGroup(n))}let n=Object.keys(Qp);for(let e=0;e<n.length;e++){let t=n[e],r=Qp[t];cm(r,Lr.resources.addGeometryGroup(t))}let r=Pr(am,`Components`),i=Object.keys(r);for(let e=0;e<i.length;e++){let t=i[e],n=r[t];sm(n,Lr.resources.addComponentGroup(t))}let a=Pr(om,`Geometries`),o=Object.keys(a);for(let e=0;e<o.length;e++){let t=o[e],n=a[t];cm(n,Lr.resources.addGeometryGroup(t))}rm()})(),_.createRoot(document.getElementById(`root`)).render((0,E.jsx)(Kf,{projectName:`demo-webgl`,sceneData:y,editorData:v,initResourceInstances:im}));